...
function CardLayoutRestoreForEndOne_xiaoyikoudian(node, endonepl)
{
...
function SetEndOneUserUI_xiaoyikoudian(node,off)
{
	var sData=MjClient.data.sData;
	var tData=sData.tData;
	...
	if(pl.isTing)
    {
        ...
        if(pl.putCardAfterTing >= 0 && pl.putCardAfterTing != -1 && MjClient.data.sData.tData.areaSelectMode["anting"])
        {
...
var EndOneView_xiaoyikoudian = cc.Layer.extend({
	jsBind:{
		block: {
		...
		head0:{
		   ...
		   _run:function(){ SetEndOneUserUI_xiaoyikoudian(this,0); },
		...
		head1:{
		  ...
		  _run:function(){ SetEndOneUserUI_xiaoyikoudian(this,1); }
		},
		head2:{
		   head:{
			   zhuang:{_visible:false}
		   ...
		   _run:function(){ SetEndOneUserUI_xiaoyikoudian(this,2); }
		},
		head3:{
			 head:
			 {
			...
			_run:function(){ SetEndOneUserUI_xiaoyikoudian(this,3); }
			},
		count_down:{
                _visible :function()
                {
    ...
    ctor:function () {
        this._super();
        var endoneui = ccs.load("endOne_xiaoyikoudian.json");
