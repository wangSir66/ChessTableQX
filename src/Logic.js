...
var AppEnv = {};
AppEnv[MjClient.APP_TYPE.QXJSMJ] = "jiangshu";
...
GameDownloadCfgUrl[MjClient.APP_TYPE.QXJSMJ] = "https://test-project-0.oss-cn-hangzhou.aliyuncs.com/update/yaan/";
...
const HelpUrls = 'http://121.196.214.144:9993/protocol/tips/';
var GameHelpUrl = {};
GameHelpUrl[MjClient.GAME_TYPE.LIAN_YUN_GANG] = HelpUrls + "helpXinPu/helpXinPu.html";
GameHelpUrl[MjClient.GAME_TYPE.SHU_YANG] = HelpUrls + "helpShuYang/helpShuYang.html";
GameHelpUrl[MjClient.GAME_TYPE.GUAN_YUN] = HelpUrls + "helpGuanYun/helpGuanYun.html";
GameHelpUrl[MjClient.GAME_TYPE.DONG_HAI] = HelpUrls + "helpDongHai/helpDongHai.html";
GameHelpUrl[MjClient.GAME_TYPE.NAN_JING] = "helpNanJingUrl";
GameHelpUrl[MjClient.GAME_TYPE.SU_QIAN] = HelpUrls +"helpSuQian/helpSuQian.html";
GameHelpUrl[MjClient.GAME_TYPE.NIU_NIU] = "helpNiuNiuUrl";
GameHelpUrl[MjClient.GAME_TYPE.HUAI_AN] = HelpUrls +"helpHuaiAn/helpHuaiAn.html";
GameHelpUrl[MjClient.GAME_TYPE.HA_HONGZHONG] = HelpUrls +"helpHuaiAnHongZhong/helpHuaiAnHongZhong.html";
GameHelpUrl[MjClient.GAME_TYPE.HA_14DUN] = HelpUrls +"helpHuaiAn14Dun/helpHuaiAn14Dun.html";
GameHelpUrl[MjClient.GAME_TYPE.XU_ZHOU] = HelpUrls +"helpXuZhou/helpXuZhou.html";
GameHelpUrl[MjClient.GAME_TYPE.TUAN_TUAN_ZHUAN] = HelpUrls +"helpTuanTuanZhuan/helpTuanTuanZhuan.html";
GameHelpUrl[MjClient.GAME_TYPE.PAO_HU_ZI] = HelpUrls +"helpPaoHuZi/helpPaoHuZi.html";
GameHelpUrl[MjClient.GAME_TYPE.SI_YANG] = HelpUrls +"helpSiYang/helpSiYang.html";
GameHelpUrl[MjClient.GAME_TYPE.XIN_SI_YANG] = HelpUrls +"helpXinSiYang/helpXinSiYang.html";
GameHelpUrl[MjClient.GAME_TYPE.SI_YANG_HH] = HelpUrls +"helpSiYangHH/helpSiYangHH.html";
GameHelpUrl[MjClient.GAME_TYPE.YAN_CHENG_HH] = HelpUrls +"helpYanChengHHUrl";
GameHelpUrl[MjClient.GAME_TYPE.HUAI_AN_DOU_DI_ZHU] = HelpUrls +"helpHuaiAnDouDiZhu/helpHuaiAnDouDiZhuUrl.html";
GameHelpUrl[MjClient.GAME_TYPE.RU_GAO] = HelpUrls +"helpRuGao/helpRuGao.html";
GameHelpUrl[MjClient.GAME_TYPE.GAN_YU] = HelpUrls +"helpGanYu/helpGanYu.html";
GameHelpUrl[MjClient.GAME_TYPE.HUAI_AN_TTZ] = HelpUrls +"helpHuaiAnTuanTuanZhuan/helpHuaiAnTuanTuanZhuan.html";
GameHelpUrl[MjClient.GAME_TYPE.RU_GAO_MJH] = HelpUrls +"helpRuGaoMJH/helpRuGaoMJH.html";
GameHelpUrl[MjClient.GAME_TYPE.QU_TANG_23_ZHANG] = HelpUrls +"helpQuTang23Zhang/helpQuTang23Zhang.html";
GameHelpUrl[MjClient.GAME_TYPE.HUAI_AN_CC] = HelpUrls +"helpHuaiAnChuChong/helpHuaiAnChuChong.html";
GameHelpUrl[MjClient.GAME_TYPE.HZ_TUI_DAO_HU] = HelpUrls +"helpHongZeTuiDaoHu/helpHongZeTuiDaoHu.html";
GameHelpUrl[MjClient.GAME_TYPE.HUAI_AN_ERZ] = HelpUrls +"helpHuaiAnErRenZhuan/helpHuaiAnErRenZhuan.html";
GameHelpUrl[MjClient.GAME_TYPE.GUAN_NAN] = HelpUrls +"helpGuanNan/helpGuanNan.html";
GameHelpUrl[MjClient.GAME_TYPE.PAO_DE_KUAI] = HelpUrls +"helpPaoDeKuai/helpPaoDeKuai.html";
GameHelpUrl[MjClient.GAME_TYPE.PAO_DE_KUAI_TY] = HelpUrls +"helpPaoDeKuaiTY/helpPaoDeKuaiTY.html";
GameHelpUrl[MjClient.GAME_TYPE.PAO_DE_KUAI_ELEVEN] = HelpUrls +"helpPaoDeKuaiEleven/helpPaoDeKuaiEleven.html";
GameHelpUrl[MjClient.GAME_TYPE.PAO_DE_KUAI_ZERO] =HelpUrls + "helpPaoDeKuaiTY/helpPaoDeKuaiTY.html";
GameHelpUrl[MjClient.GAME_TYPE.PAO_DE_KUAI_JZ] = HelpUrls +"helpPaoDeKuaiJZ/helpPaoDeKuaiJZ.html";
GameHelpUrl[MjClient.GAME_TYPE.PAO_DE_KUAI_HA] = HelpUrls +"helpPaoDeKuaiHuaian/helpPaoDeKuaiHuaian.html";
GameHelpUrl[MjClient.GAME_TYPE.PAO_DE_KUAI_HUAIAN_NEW] = HelpUrls +"helpPaoDeKuaiHuaianNew/helpPaoDeKuaiHuaianNew.html";
GameHelpUrl[MjClient.GAME_TYPE.PAO_DE_KUAI_LYG] = HelpUrls +"helpPaoDeKuaiLYG/helpPaoDeKuaiLYG.html";
GameHelpUrl[MjClient.GAME_TYPE.PAO_DE_KUAI_XIANG_SHUI] = HelpUrls +"helpPaoDeKuaiXiangShui/helpPaoDeKuaiXiangShui.html";
GameHelpUrl[MjClient.GAME_TYPE.PAO_DE_KUAI_NT] = HelpUrls +"helpPaoDeKuaiNT/helpPaoDeKuaiNT.html";
GameHelpUrl[MjClient.GAME_TYPE.PAO_DE_KUAI_HAIAN] = HelpUrls +"helpPaoDeKuaiHaiAn/helpPaoDeKuaiHaiAn.html";
GameHelpUrl[MjClient.GAME_TYPE.PAO_DE_KUAI_XU_ZHOU] = HelpUrls +"helpPaoDeKuaiXuzhou/helpPaoDeKuaiXuzhou.html";
GameHelpUrl[MjClient.GAME_TYPE.XIN_PU_HZ] = HelpUrls +"helpHZMJ/helpHZMJ.html";
GameHelpUrl[MjClient.GAME_TYPE.LUO_DI_SAO] = HelpUrls +"helpLuoDiSao/helpLuoDiSao.html";
GameHelpUrl[MjClient.GAME_TYPE.PAO_HU_ZI_SR] = HelpUrls +"helpPaoHuZiSR/helpPaoHuZiSR.html";
GameHelpUrl[MjClient.GAME_TYPE.DOU_DI_ZHU_NT] = HelpUrls +"helpNTDouDiZhu/helpNTDouDiZhu.html";
GameHelpUrl[MjClient.GAME_TYPE.NTHZ] = HelpUrls +"helpNTHongZhong/helpNTHongZhong.html";
GameHelpUrl[MjClient.GAME_TYPE.TONG_HUA] = "helpTongHuaUrl";
GameHelpUrl[MjClient.GAME_TYPE.CHANG_SHA] = HelpUrls +"helpChangSha/helpChangSha.html";
GameHelpUrl[MjClient.GAME_TYPE.NING_XIANG_MJ] = HelpUrls +"helpNingXiang/helpNingXiang.html";
GameHelpUrl[MjClient.GAME_TYPE.XIANG_YIN_TUI_DAO_HU] =HelpUrls + "helpXiangYinTuiDaoHu/helpXiangYinTuiDaoHu.html";
GameHelpUrl[MjClient.GAME_TYPE.PING_JIANG_ZHA_NIAO] = HelpUrls +"helpPingJiangZhaNiao/helpPingJiangZhaNiao.html";
GameHelpUrl[MjClient.GAME_TYPE.LIAN_SHUI] = HelpUrls +"helpHuanAnLianShui/helpHuanAnLianShui.html";
GameHelpUrl[MjClient.GAME_TYPE.TY_HONGZHONG] = HelpUrls +"helpTYHongZhong/helpTYHongZhong.html";
GameHelpUrl[MjClient.GAME_TYPE.ML_HONGZHONG] = HelpUrls +"helpMiLuoHongZhong/helpMiLuoHongZhong.html";
GameHelpUrl[MjClient.GAME_TYPE.ML_HONGZHONG_ZERO] =HelpUrls + "helpMiLuoHongZhong/helpMiLuoHongZhong.html";
GameHelpUrl[MjClient.GAME_TYPE.CHEN_ZHOU] = HelpUrls +"helpChenZhou/helpChenZhou.html";
GameHelpUrl[MjClient.GAME_TYPE.YUAN_JIANG_MJ] = HelpUrls +"helpYuanJiangUrl/helpYuanJiangMaJiang.html";
GameHelpUrl[MjClient.GAME_TYPE.NAN_XIAN_MJ] = HelpUrls +"helpNanXianUrl/helpNanXianUrl.html";
GameHelpUrl[MjClient.GAME_TYPE.MJ_ZHUO_XIA_ZI] = HelpUrls +"helpZhuoXiaZi/helpZhuoXiaZi.html";
GameHelpUrl[MjClient.GAME_TYPE.CHAO_GU_MJ] = HelpUrls +"helpyueyangchaogu/helpyueyangchaogu.html";
GameHelpUrl[MjClient.GAME_TYPE.DOU_DI_ZHU_TY] = HelpUrls +"helpTYDouDiZhu/helpTYDouDiZhu.html";
GameHelpUrl[MjClient.GAME_TYPE.DOU_DI_ZHU_HBTY] = HelpUrls +"helpTYDouDiZhu/helpTYDouDiZhu.html";
GameHelpUrl[MjClient.GAME_TYPE.DOU_DI_ZHU_QC] = HelpUrls +"helpDouDiZhuQC/helpDouDiZhuQC.html";
GameHelpUrl[MjClient.GAME_TYPE.WU_XUE_GE_BAN] = HelpUrls +"helpWuxuegeban/helpWuxuegeban.html";
GameHelpUrl[MjClient.GAME_TYPE.DIAN_TUO] = HelpUrls +"helpDianTuo/helpDianTuo.html";
GameHelpUrl[MjClient.GAME_TYPE.DOU_DI_ZHU_JZ] = HelpUrls +"helpJZDouDiZhu/helpJZDouDiZhu.html";
GameHelpUrl[MjClient.GAME_TYPE.DOU_DI_ZHU_ZERO] =HelpUrls + "helpJZDouDiZhu/helpJZDouDiZhu.html";
GameHelpUrl[MjClient.GAME_TYPE.DOU_DI_ZHU_DA_TONG] = HelpUrls +"helpJZDouDiZhu/helpJZDouDiZhu.html";
GameHelpUrl[MjClient.GAME_TYPE.DOU_DI_ZHU_LV_LIANG] = HelpUrls +"helpLvLiangDouDiZhu/helpLvLiangDouDiZhu.html";
GameHelpUrl[MjClient.GAME_TYPE.TY_ZHUANZHUAN] = HelpUrls +"helpTYZhuanZhuan/helpTYZhuanZhuan.html";
GameHelpUrl[MjClient.GAME_TYPE.YONG_ZHOU_BAO_PAI] =HelpUrls + "helpYongZhouBaoPai/helpYongZhouBaoPai.html";
GameHelpUrl[MjClient.GAME_TYPE.SAN_DA_HA] = HelpUrls +"helpSanDaHa/helpSanDaHa.html";
GameHelpUrl[MjClient.GAME_TYPE.CHONG_YANG_HUA_QUAN_JIAO] =HelpUrls + "helpChongYangHuaQuanJiao/helpChongYangHuaQuanJiao.html";
GameHelpUrl[MjClient.GAME_TYPE.LV_LIANG_DA_QI] = HelpUrls +"helpLvLiangDaQi/helpLvLiangDaQi.html";
GameHelpUrl[MjClient.GAME_TYPE.BAI_PU_LIN_ZI] = HelpUrls +"helpBaiPuLinZi/helpBaiPuLinZi.html";
GameHelpUrl[MjClient.GAME_TYPE.RU_GAO_SHUANG_JIANG] = HelpUrls +"helpShuangJiangChangPai/helpShuangJiangChangPai.html";
GameHelpUrl[MjClient.GAME_TYPE.RU_DONG_SHUANG_JIANG] = HelpUrls +"helpRuDongShuangJiang/helpRuDongShuangJiang.html";
GameHelpUrl[MjClient.GAME_TYPE.HAI_AN_MJ] =HelpUrls + "helpHaiAn/helpHaiAn.html";
GameHelpUrl[MjClient.GAME_TYPE.XUE_ZHAN] =HelpUrls + "helpXueZhan/helpXueZhan.html";
GameHelpUrl[MjClient.GAME_TYPE.XUE_LIU] =HelpUrls + "helpXueLiu/helpXueLiu.html";
GameHelpUrl[MjClient.GAME_TYPE.HAI_AN_BAI_DA] =HelpUrls + "helpHaiAnBaiDa/helpHaiAnBaiDa.html";
GameHelpUrl[MjClient.GAME_TYPE.JIN_ZHONG_MJ] = HelpUrls +"helpJinZhong/helpJinZhong.html";
GameHelpUrl[MjClient.GAME_TYPE.JIN_ZHONG_CAI_SHEN] = HelpUrls +"helpJinZhong/helpJinZhong.html";
GameHelpUrl[MjClient.GAME_TYPE.DOU_DI_ZHU_HA] = HelpUrls +"helpHADouDiZhu/helpHADouDiZhu.html";
GameHelpUrl[MjClient.GAME_TYPE.JIN_ZHONG_KD] = HelpUrls +"helpJinZhongKouDian/helpJinZhongKouDian.html";
GameHelpUrl[MjClient.GAME_TYPE.YUN_CHENG_TIE_JIN] = HelpUrls +"helpYunChengTieJin/helpYunChengTieJin.html";
GameHelpUrl[MjClient.GAME_TYPE.HE_JIN_KUN_JIN] = HelpUrls +"helpHeJinKunJin/helpHeJinKunJin.html";
GameHelpUrl[MjClient.GAME_TYPE.LV_LIANG_MA_JIANG] =HelpUrls + "helpLvLiangMaJiang/helpLvLiangMaJiang.html";
GameHelpUrl[MjClient.GAME_TYPE.ZHUO_HAO_ZI] = HelpUrls +"helpLvLiangMaJiang/helpLvLiangMaJiang.html";
GameHelpUrl[MjClient.GAME_TYPE.RU_GAO_ER] = HelpUrls +"helpRuGaoER/helpRuGaoER.html";
GameHelpUrl[MjClient.GAME_TYPE.JIN_ZHONG_TUI_DAO_HU] =HelpUrls + "helpJinZhongTuiDaoHu/helpJinZhongTuiDaoHu.html";
GameHelpUrl[MjClient.GAME_TYPE.LING_SHI_BIAN_LONG] = HelpUrls +"helpLingShiMaJiang/helpLingShiMaJiang.html";
GameHelpUrl[MjClient.GAME_TYPE.LING_SHI_BAN_MO] = HelpUrls +"helpLingShiMaJiang/helpLingShiMaJiang.html";
GameHelpUrl[MjClient.GAME_TYPE.PING_YAO_KOU_DIAN] = HelpUrls +"helpPingYaoMaJiang/helpPingYaoMaJiang.html";
GameHelpUrl[MjClient.GAME_TYPE.PING_YAO_MA_JIANG] = HelpUrls +"helpPingYaoMaJiang/helpPingYaoMaJiang.html";
GameHelpUrl[MjClient.GAME_TYPE.JIE_XIU_1_DIAN_3] = HelpUrls +"helpJieXiuMaJiang/helpJieXiuMaJiang.html";
GameHelpUrl[MjClient.GAME_TYPE.JIE_XIU_KOU_DIAN] = HelpUrls +"helpJieXiuMaJiang/helpJieXiuMaJiang.html";
GameHelpUrl[MjClient.GAME_TYPE.JIN_ZHONG_GUAI_SAN_JIAO] = HelpUrls +"helpGuaiSanJiao/helpGuaiSanJiao.html";
GameHelpUrl[MjClient.GAME_TYPE.SHOU_YANG_QUE_KA] =HelpUrls + "helpShouYangQueKa/helpShouYangQueKa.html";
GameHelpUrl[MjClient.GAME_TYPE.JIN_ZHONG_LI_SI] = HelpUrls +"helpLiSiMaJiang/helpLiSiMaJiang.html";
GameHelpUrl[MjClient.GAME_TYPE.LV_LIANG_KOU_DIAN] =HelpUrls + "helplvliangMaJiangUrl";
GameHelpUrl[MjClient.GAME_TYPE.XIAO_YI_KOU_DIAN] = HelpUrls +"helpxiaoyiMaJiang/helpxiaoyiMaJiang.html";
GameHelpUrl[MjClient.GAME_TYPE.HONG_TONG_WANG_PAI] =HelpUrls + "helpHongTongMaJiang/helpHongTongMaJiang.html";
GameHelpUrl[MjClient.GAME_TYPE.LIN_FEN_YING_SAN_ZUI] = HelpUrls +"helplinfenyingsanzuiMaJiang/helplinfenyingsanzuiMaJiang.html";
GameHelpUrl[MjClient.GAME_TYPE.DOU_DI_ZHU_LIN_FEN] = HelpUrls +"helpLinFenDouDiZhu/helpLinFenDouDiZhu.html";
GameHelpUrl[MjClient.GAME_TYPE.LIN_FEN_YI_MEN_ZI] = HelpUrls +"helpLinFenYiMenZi/helpLinFenYiMenZi.html";
GameHelpUrl[MjClient.GAME_TYPE.FEN_XI_YING_KOU] = HelpUrls +"helpLinXiYingKou/helpLinXiYingKou.html";
GameHelpUrl[MjClient.GAME_TYPE.JI_XIAN_1928_JIA_ZHANG] =HelpUrls + "helpJiXianJiaZhang/helpJiXianJiaZhang.html";
GameHelpUrl[MjClient.GAME_TYPE.ML_HONG_ZI] = HelpUrls +"helpMiLuoHongZi/helpMiLuoHongZi.html";
GameHelpUrl[MjClient.GAME_TYPE.XIANG_YIN_ZHUO_HONG_ZI] = HelpUrls + "helpXiangYinHongZi/helpXiangYinHongZi.html";
GameHelpUrl[MjClient.GAME_TYPE.YUE_YANG_WAI_HU_ZI] = HelpUrls + "helpYueYangWaiHuZi/helpYueYangWaiHuZi.html";
GameHelpUrl[MjClient.GAME_TYPE.YI_YANG_WAI_HU_ZI] = HelpUrls + "helpYiYangWaiHuZi/helpYiYangWaiHuZi.html";
GameHelpUrl[MjClient.GAME_TYPE.NAN_XIAN_GUI_HU_ZI] = HelpUrls + "helpNanXianGuiHuZi/helpNanXianGuiHuZi.html";
GameHelpUrl[MjClient.GAME_TYPE.YUAN_JIANG_GUI_HU_ZI] = HelpUrls + "helpYuanJiangGuiHuZi/helpYuanJiangGuiHuZi.html";
GameHelpUrl[MjClient.GAME_TYPE.SHI_MEN_PAO_HU_ZI] = HelpUrls + "helpShiMenPaoHuZi/helpShiMenPaoHuZi.html";
GameHelpUrl[MjClient.GAME_TYPE.FEN_YANG_QUE_MEN] = HelpUrls + "helpFenYangQueMen/helpFenYangQueMen.html";
GameHelpUrl[MjClient.GAME_TYPE.JING_LE_KOU_DIAN] = HelpUrls + "helpJingLeKouDian/helpJingLeKouDian.html";
GameHelpUrl[MjClient.GAME_TYPE.DA_TONG_GUAI_SAN_JIAO] = HelpUrls + "helpDaTongGuaiSanJiao/helpDaTongGuaiSanJiao.html";
GameHelpUrl[MjClient.GAME_TYPE.LUAN_GUA_FENG] = HelpUrls + "helpDaTongLuanGuaFeng/helpDaTongLuanGuaFeng.html";
GameHelpUrl[MjClient.GAME_TYPE.LIN_FEN_XIANG_NING_SHUAI_JIN] = HelpUrls + "helpxiangningshuaijin/helpxiangningshuaijin.html";
GameHelpUrl[MjClient.GAME_TYPE.XU_ZHOU_PEI_XIAN] = HelpUrls + "helpXuZhouPeiXianMJ/helpXuZhouPeiXianMJ.html";
GameHelpUrl[MjClient.GAME_TYPE.LIN_FEN_KOU_DIAN_FENG_ZUI_ZI] = HelpUrls + "helpLinFenKouDianFengZuiZi/helpLinFenKouDianFengZuiZi.html";
GameHelpUrl[MjClient.GAME_TYPE.FAN_SHI_XIA_YU] = HelpUrls + "helpFanShiXiaYuMJ/helpFanShiXiaYuMJ.html";
GameHelpUrl[MjClient.GAME_TYPE.DAI_XIAN_MA_JIANG] = HelpUrls + "helpDaiXianMaJiang/helpDaiXianMaJiang.html";
GameHelpUrl[MjClient.GAME_TYPE.YUE_YANG_HONG_ZHONG] = HelpUrls + "helpYueYangHongZhong/helpYueYangHongZhong.html";
GameHelpUrl[MjClient.GAME_TYPE.YUE_YANG_SAN_DA_HA] = HelpUrls + "helpYueYangSanDaHa/helpYueYangSanDaHa.html";
GameHelpUrl[MjClient.GAME_TYPE.DOU_DI_ZHU_XIN_ZHOU] = HelpUrls + "helpXinZhouDouDiZhu/helpXinZhouDouDiZhu.html";
GameHelpUrl[MjClient.GAME_TYPE.XIN_ZHOU_SAN_DA_ER] = HelpUrls + "helpXinZhouSanDaEr/helpXinZhouSanDaEr.html";
GameHelpUrl[MjClient.GAME_TYPE.AN_HUA_MA_JIANG] = HelpUrls + "helpAnHuaMaJiangUrl/helpAnHuaMaJiang.html";
GameHelpUrl[MjClient.GAME_TYPE.AN_HUA_MA_JIANG_SW] = HelpUrls + "helpAnHuaMaJiangSW/helpAnHuaMaJiangSW.html";
GameHelpUrl[MjClient.GAME_TYPE.TAO_JIANG_MA_JIANG] = HelpUrls + "helpTaoJiangMaJiang/taojiangmajiang.html";
GameHelpUrl[MjClient.GAME_TYPE.WU_TAI_KOU_DIAN] = HelpUrls + "helpWuTaiKouDian/helpWuTaiKouDian.html";
GameHelpUrl[MjClient.GAME_TYPE.YUE_YANG_FU_LU_SHOU] = HelpUrls + "helpFuLuShou/helpFuLuShou.html";
GameHelpUrl[MjClient.GAME_TYPE.FU_LU_SHOU_ER_SHI_ZHANG] = HelpUrls + "helpFuLuShouErShiZhang/helpFuLuShouErShiZhang.html";
GameHelpUrl[MjClient.GAME_TYPE.DA_NING_SHUAI_JIN] = HelpUrls + "helpDaNingShuaiJin/helpDaNingShuaiJin.html";
GameHelpUrl[MjClient.GAME_TYPE.YY_AN_HUA_PAO_HU_ZI] = HelpUrls + "helpYYAnHuaPaoHuZi/helpYYAnHuaPaoHuZi.html";
GameHelpUrl[MjClient.GAME_TYPE.CHEN_ZHOU_ZI_PAI] = HelpUrls + "helpChenZhouZiPai/helpChenZhouZiPai.html";
GameHelpUrl[MjClient.GAME_TYPE.GUI_YANG_ZI_PAI] = HelpUrls + "helpGuiYangZiPai/helpGuiYangZiPai.html";
GameHelpUrl[MjClient.GAME_TYPE.YUE_YANG_NIU_SHI_BIE] = HelpUrls + "helpNiuShiBie/helpNiuShiBie.html";
GameHelpUrl[MjClient.GAME_TYPE.ZHU_ZHOU_DA_MA_ZI] = HelpUrls + "helpDaMaZi/helpDaMaZi.html";
GameHelpUrl[MjClient.GAME_TYPE.CHONG_YANG_DA_GUN] = HelpUrls + "helpChongYangDaGun/helpChongYangDaGun.html";
GameHelpUrl[MjClient.GAME_TYPE.DA_YE_DA_GONG] = HelpUrls + "helpDaYeDaGong/helpDaYeDaGong.html";
GameHelpUrl[MjClient.GAME_TYPE.TONG_SHAN_DA_GONG] = HelpUrls + "helpTongShanDaGong/helpTongShanDaGong.html";
GameHelpUrl[MjClient.GAME_TYPE.DA_YE_510K] = HelpUrls + "helpDaYe510K/helpDaYe510K.html";
GameHelpUrl[MjClient.GAME_TYPE.QIAN_JIANG_QIAN_FEN] = HelpUrls + "helpDaYe510K/helpDaYe510K.html";
GameHelpUrl[MjClient.GAME_TYPE.QI_CHUN_DA_GONG] = HelpUrls + "helpQiChunDaGong/helpQiChunDaGong.html";
GameHelpUrl[MjClient.GAME_TYPE.DA_TONG_ZHA_GU_ZI] = HelpUrls + "helpDaTongZhaGuZi/helpDaTongZhaGuZi.html";
GameHelpUrl[MjClient.GAME_TYPE.NING_XIANG_PAO_HU_ZI] = HelpUrls + "helpNingXiangPaoHuZi/helpNingXiangPaoHuZi.html";
GameHelpUrl[MjClient.GAME_TYPE.NING_XIANG_KAI_WANG] = HelpUrls + "helpNingXiangKaiWang/helpNingXiangKaiWang.html";
GameHelpUrl[MjClient.GAME_TYPE.YUE_YANG_PENG_HU] = HelpUrls + "helpYueYangPengHu/helpYueYangPengHu.html";
GameHelpUrl[MjClient.GAME_TYPE.HY_LIU_HU_QIANG] = HelpUrls + "helpHYLiuHuQiang/helpHYLiuHuQiang.html";
GameHelpUrl[MjClient.GAME_TYPE.YUE_YANG_YI_JIAO_LAI_YOU] = HelpUrls + "helpYueYangYiJiaoLaiYouUrl/helpYueYangYiJiaoLaiYouUrl.html";
GameHelpUrl[MjClient.GAME_TYPE.HU_BEI_JING_SHAN_MJ] = HelpUrls + "helpJingShanMJ/helpJingShanMJ.html";
GameHelpUrl[MjClient.GAME_TYPE.XIAO_GAN_KA_WU_XING] = HelpUrls + "helpXiaoGanKaWuXing/helpXiaoGanKaWuXing.html";
GameHelpUrl[MjClient.GAME_TYPE.SUI_ZHOU_KA_WU_XING] = HelpUrls + "helpSuiZhouKaWuXing/helpSuiZhouKaWuXing.html";
GameHelpUrl[MjClient.GAME_TYPE.DA_YE_KAI_KOU_FAN] = HelpUrls + "helpDaYeKaiKouFan/helpDaYeKaiKouFan.html";
GameHelpUrl[MjClient.GAME_TYPE.HONG_ZHONG_LAI_ZI_GANG] = HelpUrls + "helpHongZhongLaiZiGang/helpHongZhongLaiZiGang.html";
GameHelpUrl[MjClient.GAME_TYPE.HU_BEI_YI_JIAO_LAI_YOU] = HelpUrls + "helpHuBeiYiJiaoLaiYouUrl/helpHuBeiYiJiaoLaiYouUrl.html";
GameHelpUrl[MjClient.GAME_TYPE.CHUO_XIA_ZI] = HelpUrls + "helpChuoXiaZi/helpChuoXiaZi.html";
GameHelpUrl[MjClient.GAME_TYPE.YUE_YANG_DA_ZHA_DAN] = HelpUrls + "helpYueYangDaZhaDan/helpYueYangDaZhaDan.html";
GameHelpUrl[MjClient.GAME_TYPE.YI_YANG_MA_JIANG] = HelpUrls + "helpYiYangMaJiang/helpYiYangMaJiang.html";
GameHelpUrl[MjClient.GAME_TYPE.CHEN_ZHOU_MAO_HU_ZI] = HelpUrls + "helpchenZhouMaoHuZi/chenzhoumaohuzi.html";
GameHelpUrl[MjClient.GAME_TYPE.YUE_YANG_YUAN_JIANG_QIAN_FEN] = HelpUrls + "helpYueYangYuanJiangQianFen/helpYueYangYuanJiangQianFenUrl.html";
GameHelpUrl[MjClient.GAME_TYPE.XIANG_XI_2710] = HelpUrls + "helpXiangXiErQiShi/xiangxierqishi.html";
GameHelpUrl[MjClient.GAME_TYPE.CHANG_DE_PAO_HU_ZI] = HelpUrls + "helpChangDePaoHuZi/helpChangDePaoHuZi.html";
GameHelpUrl[MjClient.GAME_TYPE.YUAN_LING_PAO_HU_ZI] = HelpUrls + "helpYuanLingPaoHuZi/helpYuanLingPaoHuZi.html";
GameHelpUrl[MjClient.GAME_TYPE.ZP_LY_CHZ] = HelpUrls + "helpLYPaoHuZi/helpLYPaoHuZi.html";
GameHelpUrl[MjClient.GAME_TYPE.HAN_SHOU_PAO_HU_ZI] = HelpUrls + "helpHanShouPaoHuZi/helpHanShouPaoHuZi.html";
GameHelpUrl[MjClient.GAME_TYPE.NAN_JING] = HelpUrls + "helpNanJing/helpNanJing.html";
GameHelpUrl[MjClient.GAME_TYPE.YUN_CHENG_FENG_HAO_ZI] = HelpUrls + "helpYunChengFengHaoZi/helpYunChengFengHaoZi.html";
GameHelpUrl[MjClient.GAME_TYPE.JI_SHAN_NIU_YE_ZI] = HelpUrls + "helpJiShanNiuYeZi/helpJiShanNiuYeZi.html";
GameHelpUrl[MjClient.GAME_TYPE.PAO_HU_ZI_SR_King] = HelpUrls + "helpPaoHuZiSRKing/helpPaoHuZiSRKing.html";
GameHelpUrl[MjClient.GAME_TYPE.PAO_HU_ZI_King] = HelpUrls + "helpPaoHuZiKing/helpPaoHuZiKing.html";
GameHelpUrl[MjClient.GAME_TYPE.PAO_HU_ZI_ER] = HelpUrls + "helpPaoHuZi/helpPaoHuZi.html";
GameHelpUrl[MjClient.GAME_TYPE.PAO_HU_ZI_LR_King] = HelpUrls + "helpPaoHuZiKing/helpPaoHuZiKing.html";
GameHelpUrl[MjClient.GAME_TYPE.HY_SHI_HU_KA] = HelpUrls + "helpHYShiHuKa/helpHYShiHuKa.html";
GameHelpUrl[MjClient.GAME_TYPE.JIANG_YONG_15Z] = HelpUrls + "helpJiangYong15Z/helpJiangYong15Z.html";
GameHelpUrl[MjClient.GAME_TYPE.YZ_PAO_DE_KUAI_TY] = HelpUrls + "helpPaoDeKuaiTY/helpPaoDeKuaiTY.html";
GameHelpUrl[MjClient.GAME_TYPE.WANG_DIAO_MA_JIANG] = HelpUrls + "helpWangDiao/helpWangDiao.html";
GameHelpUrl[MjClient.GAME_TYPE.YONG_ZHOU_MJ] = HelpUrls + "helpYongZhouMJ/helpYongZhouMJ.html";
GameHelpUrl[MjClient.GAME_TYPE.JIANG_HUA_MJ] = HelpUrls + "helpJiangHuaMJ/helpJiangHuaMJ.html";
GameHelpUrl[MjClient.GAME_TYPE.DAO_ZHOU_MJ] = HelpUrls + "helpDaoZhouMJ/helpDaoZhouMJ.html";
GameHelpUrl[MjClient.GAME_TYPE.XIANG_XIANG_PAO_HU_ZI] = HelpUrls + "helpXXPaoHuZiUrl/helpXXPaoHuZi.html";
GameHelpUrl[MjClient.GAME_TYPE.XIANG_XIANG_SAN_DA_HA] = HelpUrls + "helpXiangXiangSanDaHa/helpXiangXiangSanDaHaUrl.html";
GameHelpUrl[MjClient.GAME_TYPE.LEI_YANG_GMJ] = HelpUrls + "helpLeiYangGMJ/helpLeiYangGMJ.html";
GameHelpUrl[MjClient.GAME_TYPE.XIANG_XIANG_HONG_ZHONG] = HelpUrls + "helpXiangXiangHongZhongUrl/helpXiangXiangHongZhongUrl.html";
GameHelpUrl[MjClient.GAME_TYPE.SHAO_YANG_MA_JIANG] = HelpUrls + "helpShaoYangMJ/helpShaoYangMJ.html";
GameHelpUrl[MjClient.GAME_TYPE.DA_TONG_ZI_SHAO_YANG] = HelpUrls + "helpDaTongZiShaoYang/helpDaTongZiShaoYang.html";
GameHelpUrl[MjClient.GAME_TYPE.SHAO_YANG_BO_PI] = HelpUrls + "helpShaoYangBoPi/helpShaoYangBoPi.html";
GameHelpUrl[MjClient.GAME_TYPE.SHAO_YANG_ZI_PAI] = HelpUrls + "helpShaoYangZiPai/helpShaoYangZiPai.html";
GameHelpUrl[MjClient.GAME_TYPE.XIANG_XIANG_GAO_HU_ZI] = HelpUrls + "helpXXGaoHuZi/helpXXGaoHuZi.html";
GameHelpUrl[MjClient.GAME_TYPE.LOU_DI_FANG_PAO_FA] = HelpUrls + "helpLDFangPaoFa/helpLDFangPaoFa.html";
GameHelpUrl[MjClient.GAME_TYPE.HENG_YANG_SHIWUHUXI] = HelpUrls + "helpHYShiWuHu/helpHYShiWuHu.html";
GameHelpUrl[MjClient.GAME_TYPE.HUAI_HUA_HONG_GUAI_WAN] = HelpUrls + "helpHuaiHuaHGW/helpHuaiHuaHGW.html";
GameHelpUrl[MjClient.GAME_TYPE.HENG_YANG_CHANG_SHA] = HelpUrls + "helpHengYangChangSha/helpHengYangChangSha.html";
GameHelpUrl[MjClient.GAME_TYPE.XIN_NING_MA_JIANG] = HelpUrls + "helpXinNingMJ/helpXinNingMJ.html";
GameHelpUrl[MjClient.GAME_TYPE.LONG_HUI_BA_ZHA_DAN] = HelpUrls + "helpBaZhaDan/helpBaZhaDan.html";
GameHelpUrl[MjClient.GAME_TYPE.YONG_ZHOU_LAO_CHUO] = HelpUrls + "helpYongZhouLaoChuo/helpYongZhouLaoChuo.html";
GameHelpUrl[MjClient.GAME_TYPE.HY_ER_PAO_HU_ZI] = HelpUrls + "helpHYErRenPaoHuZi/helpHYErRenPaoHuZi.html";
GameHelpUrl[MjClient.GAME_TYPE.SHAO_YANG_FANG_PAO_FA] = HelpUrls + "helpLDFangPaoFa/helpLDFangPaoFa.html";
GameHelpUrl[MjClient.GAME_TYPE.XIANG_TAN_PAO_HU_ZI] = HelpUrls + "helpXTPaoHuZi/xiangtanpaohuzi.html";
GameHelpUrl[MjClient.GAME_TYPE.AN_HUA_PAO_HU_ZI] = HelpUrls + "helpAnHuaPaoHuZi/helpAnHuaPaoHuZi.html";
GameHelpUrl[MjClient.GAME_TYPE.BAN_BIAN_TIAN_ZHA] = HelpUrls + "helpBanBianTianZha/helpBanBianTianZha.html";
GameHelpUrl[MjClient.GAME_TYPE.LENG_SHUI_JIANG_SHI_HU_DAO] = HelpUrls + "helpLengShuiJiangShiHuDao/helpLengShuiJiangShiHuDao.html";
GameHelpUrl[MjClient.GAME_TYPE.HENG_YANG_SAN_DA_HA] = HelpUrls + "helpHengYangSanDaHa/helpHengYangSanDaHa.html";
GameHelpUrl[MjClient.GAME_TYPE.SHAO_YANG_SAN_DA_HA] = HelpUrls + "helpShaoYangSanDaHa/helpShaoYangSanDaHa.html";
GameHelpUrl[MjClient.GAME_TYPE.YONG_LI_SAN_DA_HA] = HelpUrls + "helpShaoYangSanDaHa/helpShaoYangSanDaHa.html";
GameHelpUrl[MjClient.GAME_TYPE.HUAI_HUA_MA_JIANG] = HelpUrls + "helpHuaiHuaMaJiang/helpHuaiHuaMaJiang.html";
GameHelpUrl[MjClient.GAME_TYPE.HENG_YANG_FANG_PAO_FA] = HelpUrls + "helpLDFangPaoFa/helpLDFangPaoFa.html";
GameHelpUrl[MjClient.GAME_TYPE.XIANG_SHUI_MJ] = HelpUrls + "helpXiangShui/helpXiangShuiMaJiang.html";
GameHelpUrl[MjClient.GAME_TYPE.XIANG_TAN_SAN_DA_HA] = HelpUrls + "helpSanDaHa/helpSanDaHa.html";
GameHelpUrl[MjClient.GAME_TYPE.AN_XIANG_WEI_MA_QUE] = HelpUrls + "helpAnXiangWeiMaQue/helpAnXiangWeiMaQue.html";
GameHelpUrl[MjClient.GAME_TYPE.GUI_ZHOU_PU_DING_MJ] = HelpUrls + "helpGuiZhouPuDingMaJiang/helpGuiZhouPuDingMaJiang.html";
GameHelpUrl[MjClient.GAME_TYPE.GUI_ZHOU_AN_SHUN_MJ] = HelpUrls + "helpGuiZhouAnShunMaJiang/helpGuiZhouAnShunMaJiang.html";
GameHelpUrl[MjClient.GAME_TYPE.GUI_ZHOU_SAN_DING_LIANG_FANG] = HelpUrls + "helpGuiZhouSanDingLiangFangMaJiang/helpGuiZhouSanDingLiangFangMaJiang.html";
GameHelpUrl[MjClient.GAME_TYPE.GUI_ZHOU_LIANG_DING_LIANG_FANG] = HelpUrls + "helpGuiZhouLiangDingLiangFangMaJiang/helpGuiZhouLiangDingLiangFangMaJiang.html";
GameHelpUrl[MjClient.GAME_TYPE.GUI_ZHOU_SAN_DING_GUAI] = HelpUrls + "helpGuiZhouSanDingGuaiMaJiang/helpGuiZhouSanDingGuaiMaJiang.html";
GameHelpUrl[MjClient.GAME_TYPE.GUI_ZHOU_ER_DING_GUAI] = HelpUrls + "helpGuiZhouErDingGuaiMaJiang/helpGuiZhouErDingGuaiMaJiang.html";
GameHelpUrl[MjClient.GAME_TYPE.SAN_DA_HA_NEW] = HelpUrls + "helpSanDaHa/helpSanDaHa.html";
GameHelpUrl[MjClient.GAME_TYPE.DOU_DI_ZHU_GZ] = HelpUrls + "helpJZDouDiZhu/helpJZDouDiZhu.html";
GameHelpUrl[MjClient.GAME_TYPE.GUI_ZHOU_XMY_GUI_YANG_ZHUO_JI] = HelpUrls + "helpGuiZhouXMYGuiYangZhuoJi/helpGuiZhouXMYGuiYangZhuoJi.html";
GameHelpUrl[MjClient.GAME_TYPE.GUI_ZHOU_GUI_YANG_ZHUO_JI] = HelpUrls + "helpGuiZhouGuiYangZhuoJi/helpGuiZhouGuiYangZhuoJi.html";
GameHelpUrl[MjClient.GAME_TYPE.GUI_ZHOU_MEN_HU_XUE_LIU] = HelpUrls + "helpMenHuXueLiu/helpMenHuXueLiu.html";
GameHelpUrl[MjClient.GAME_TYPE.XIANG_XI_96POKER] = HelpUrls + "help96Poker/help96Poker.html";
GameHelpUrl[MjClient.GAME_TYPE.XU_PU_LAO_PAI] = HelpUrls + "helpXuPuLaoPai/helpXuPuLaoPai.html";
GameHelpUrl[MjClient.GAME_TYPE.CHANG_SHA_ER_REN] = HelpUrls + "helpChangShaErRen/helpChangShaErRen.html";
GameHelpUrl[MjClient.GAME_TYPE.ER_REN_YI_FANG_MJ] = HelpUrls + "helpErRenYiFang/helpErRenYiFang.html";
GameHelpUrl[MjClient.GAME_TYPE.XU_PU_PAO_HU_ZI] = HelpUrls + "helpXuPuPaoHuZi/helpXuPuPaoHuZi.html";
GameHelpUrl[MjClient.GAME_TYPE.DA_ZI_BO_PI] = HelpUrls + "helpDaZiBoPi/helpDaZiBoPi.html";
GameHelpUrl[MjClient.GAME_TYPE.HONG_ZE_MA_JIANG] = HelpUrls + "helpHongZeMaJiang/helpHongZeMaJiang.html";
GameHelpUrl[MjClient.GAME_TYPE.SHAN_XI_GAN_DENG_YAN] = HelpUrls + "helpGanDengYan/helpGanDengYan.html";
GameHelpUrl[MjClient.GAME_TYPE.YI_CHANG_XUE_LIU_MJ] = HelpUrls + "helpYiChangXueLiu/helpYiChangXueLiu.html";
GameHelpUrl[MjClient.GAME_TYPE.PAO_DE_KUAI_HBTY] = HelpUrls + "helpPaoDeKuaiHBTY/helpPaoDeKuaiHBTY.html";
GameHelpUrl[MjClient.GAME_TYPE.EN_SHI_MA_JIANG] = HelpUrls + "helpYiPiErLai/helpYiPiErLai.html";
GameHelpUrl[MjClient.GAME_TYPE.DANG_YANG_FAN_JING] = HelpUrls + "helpDangYangFanJing/helpDangYangFanJing.html";
GameHelpUrl[MjClient.GAME_TYPE.DA_YE_ZI_PAI] = HelpUrls + "helpDaYeZiPai/helpDaYeZiPai.html";
GameHelpUrl[MjClient.GAME_TYPE.JING_ZHOU_MA_JIANG] = HelpUrls + "helpJingZhouMaJiang/helpJingZhouMaJiang.html";
GameHelpUrl[MjClient.GAME_TYPE.CHONG_YANG_MJ] = HelpUrls + "helpChongYangMJ/helpChongYangMJ.html";
GameHelpUrl[MjClient.GAME_TYPE.QIAN_JIANG_HH_MJ] = HelpUrls + "helpQianJiangHHMJ/helpQianJiangHHMJ.html";
GameHelpUrl[MjClient.GAME_TYPE.HUANG_SHI_HH_MJ] = HelpUrls + "helpHuangShiHHMJ/helpHuangShiHHMJ.html";
GameHelpUrl[MjClient.GAME_TYPE.QI_CHUN_HH_MJ] = HelpUrls + "helpQiChunHHMJ/helpQiChunHHMJ.html";
GameHelpUrl[MjClient.GAME_TYPE.TONG_CHENG_MJ] = HelpUrls + "helpTongChengMJ/helpTongChengMJ.html";
GameHelpUrl[MjClient.GAME_TYPE.YI_CHANG_SHANG_DA_REN] = HelpUrls + "helpYiChangShangDaRen/helpYiChangShangDaRen.html";
GameHelpUrl[MjClient.GAME_TYPE.HU_BEI_HUA_PAI] = HelpUrls + "helpHuBeiHuaPai/helpHuBeiHuaPai.html";
GameHelpUrl[MjClient.GAME_TYPE.YANG_XIN_MA_JIANG] = HelpUrls + "helpYangXin/helpYangXin.html";
GameHelpUrl[MjClient.GAME_TYPE.TONG_SHAN_HH_MJ] = HelpUrls + "helpTongShanHuangHuang/helpTongShanHuangHuang.html";
GameHelpUrl[MjClient.GAME_TYPE.JIANG_LING_HONGZHONG] = HelpUrls + "helpJiangLingHongZhong/helpJiangLingHongZhong.html";
GameHelpUrl[MjClient.GAME_TYPE.QI_CHUN_GD_MJ] = HelpUrls + "helpQIChunGuangDongMJ/helpQIChunGuangDongMJ.html";
GameHelpUrl[MjClient.GAME_TYPE.SHI_SHOU_AI_HUANG] = HelpUrls + "helpShiShouAiHuang/helpShiShouAiHuang.html";
GameHelpUrl[MjClient.GAME_TYPE.GONG_AN_HUA_PAI] = HelpUrls + "helpGongAnHuaPai/helpGongAnHuaPai.html";
GameHelpUrl[MjClient.GAME_TYPE.WU_XUE_MJ] = HelpUrls + "helpWuXueMJ/helpWuXueMJ.html";
GameHelpUrl[MjClient.GAME_TYPE.TONG_CHENG_GE_ZI_PAI] = HelpUrls + "helpTongChengGeZiPai/helpTongChengGeZiPai.html";
GameHelpUrl[MjClient.GAME_TYPE.QI_CHUN_HONG_ZHONG_GANG] = HelpUrls + "helpQiChunHongZhongGang/helpQiChunHongZhongGang.html";
GameHelpUrl[MjClient.GAME_TYPE.EN_SHI_SHAO_HU] = HelpUrls + "helpEnShiShaoHu/helpEnShiShaoHu.html";
GameHelpUrl[MjClient.GAME_TYPE.WU_XUE_510K] = HelpUrls + "helpWuXue510k/helpWuXue510k.html";
