...
function SetEndOneUserUI_paodekuaiNT(node, off) {
...
function CardLayoutRestoreForEndOne_paodekuaiNT(node, plNode) {
...
var EndOneView_paodekuaiNT = cc.Layer.extend({
    jsBind: {
        block: {
        ...
        back: {
            ...
            head0: {
                ...
                _run: function () { SetEndOneUserUI_paodekuaiNT(this, 0); },
    		...
    		, head1: {
    		    ...
    		    _run: function () { SetEndOneUserUI_paodekuaiNT(this, 1); }
    		}
    		...
    		, head2: {
    		    ...
    		    _run: function () { SetEndOneUserUI_paodekuaiNT(this, 2); }
    		}
        }
    },
    ctor: function () {
        this._super();
        var endoneui = ccs.load(res.EndOne_PaoDeKuaiNT_json);
