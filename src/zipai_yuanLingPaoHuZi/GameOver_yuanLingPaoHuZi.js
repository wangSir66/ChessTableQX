function addWxHeadToEndUI_YuanLingPaoHuZi_GO(node, off) {
...
function SetGameOverLayer_YuanLingPaoHuZi(node,off,isNewUi){
    ...
    addWxHeadToEndUI_YuanLingPaoHuZi_GO(wxNode,off);
    ...
    winNum.setProperty(scoreContnet + "", textFileName, 40, 58, _star_text);
...
var GameOverLayer_yuanLingPaoHuZi = cc.Layer.extend({
    sprite:null,
    jsBind:{
        back:{
            close :{
    ...
    ctor:function () {
        this._super();
        var endallui = ccs.load("endAll_yuanLingPaoHuZi.json");
        ...
        for(var i = 0 ; i < playerCount ; i++){
            ...
            SetGameOverLayer_YuanLingPaoHuZi(clone,i, false);
