    ...
    jsBind: {
        ...
        banner: {
            ...
            getRoomNum: {
                ...
                _click: function() {
                    ...
                    var sData = MjClient.data.sData;
                    var str7 = " ";
                    if (Object.keys(sData.players).length > 0 && MjClient.MaxPlayerNum_leiyang > Object.keys(sData.players).length){
                        str7 += ["一","二","三"][Object.keys(sData.players).length - 1] + "缺" + ["一","二","三"][MjClient.MaxPlayerNum_leiyang - Object.keys(sData.players).length - 1];
                    }
        ...
        left: {
            ...
            _event: {
                ...
                initSceneData: function(eD) {
                    SetUserVisible_ahPaoHuZi(this, MjClient.MaxPlayerNum_leiyang-1);
                    InitUserHandUI_ahPaoHuZi(this, MjClient.MaxPlayerNum_leiyang-1);
                ...
                HZPickCard:function (eD) {
                    if(MjClient.rePlayVideo != -1) {
                        MjClient.playui._doPickResetHandCardForPlayBack(eD, MjClient.MaxPlayerNum_leiyang-1);
                    }
                    // RemovePutCardOut_hengYang(true);
