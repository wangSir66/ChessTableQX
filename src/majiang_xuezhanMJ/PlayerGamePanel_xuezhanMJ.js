...
//处理出牌,放一张牌，打牌动作
function DealMJPut_xuezhanMJ(node, msg, off, outNum)
{
    DealMJPut_haian(node, msg, off, outNum);
}


function showShaiziAni_xuezhanMJ(poff)
{
    if(poff == 0) {
        ...
        if(MjClient.rePlayVideo != -1 )//回放
        {
            for (var off = 0; off < 4; off++) {
                ...
                InitUserHandUI_xuezhanMJ(_node, off);
            }
            playEffect("shuffle");
...
//
// function setRoomInfo_xuezhanMJ()
// {
...
function updateHeadUI_xuezhanMJ(node, off , actionType)
{
    cc.log('updateHeadUI_xuezhanMJ', off)
    var pl = getUIPlayer(off);
    if(!pl) return;
    // showHandCard_MLHZ(node, off);
    showHandCard_xuezhanMJ(node,off);
    MjClient.playui.CardLayoutRestore(node, off);
    cc.log('updateHeadUI_xuezhanMJ update success', off)
...
function SetUserVisible_xuezhanMJ(node, off)
{
    /*摇色子，断网重连手牌异常bug*/
    var _AniNode = MjClient.playui._AniNode;
...
function showHandCard_xuezhanMJ(node, off)
{
    var sData = MjClient.data.sData;
    var tData = sData.tData;
    cc.log("bug-------------------");
...
function InitUserHandUI_xuezhanMJ(node, off)
{
    var sData = MjClient.data.sData;
    var tData = sData.tData;
    var pl = getUIPlayer(off);
    cc.log("--------InitUserHandUI_xuezhanMJ  off = " + off);
    if(!pl)
    {
        return;
    }
    cc.log("--------InitUserHandUI_xuezhanMJ  pl = " + JSON.stringify(pl));
    //初始化玩家金币和名称
    ...
    for(var i = 0; i < pl.mjput.length; i++)
    {
        ...
        DealMJPut_xuezhanMJ(node, msg, off, i);
    }
...
var PlayLayer_xuezhanMJ = cc.Layer.extend({
    jsBind: {
        _event: {
            mjhand: function() {
            ...
            roundEnd: function() {
                ...
                function delayExe()
                {
                    ...
                    self.addChild(new EndOneView_xuezhanMJ(),500);
                }
        ...
        down: {
                ...
                maizhuang: {
                    ...
                    _event: {
                        ...
                        MJJiazhu: function(msg) {
                            //setMaizhuangTag_xuezhanMJ(msg,0)
                        },
                        mjhand:function()
                        {
                            this.visible = false;
            ...
            _event: {
                ...
                initSceneData: function(eD) {
                    SetUserVisible_xuezhanMJ(this, 0);
                    var pl = getUIPlayer(0);
                    if ( pl && pl.que != -1)
                    {
                ...
                mjhand: function(eD) {
                    //showShaiziAni_xuezhanMJ(0);
                    InitUserHandUI_xuezhanMJ(this, 0);
                ...
                MJChi: function(eD) {
                    ...
                    if (MjClient.rePlayVideo != -1) {
                        ...
                        updateHeadUI_xuezhanMJ(this, 0, ActionType.CHI);
                    }
                    setUserOffline(this, 0);
                },
                MJGang: function(eD) {
                ...
                MJPeng: function(eD) {
                    ...
                    if (MjClient.rePlayVideo != -1){
                        ...
                        updateHeadUI_xuezhanMJ(this, 0, ActionType.PENG);
                    }
                    var pl = getUIPlayer(0);
                    var _tingCards = this.getChildByName("tingCardsNode");
                    var tingSet = calTingSet(pl.mjhand);
        ...
        right: {
            ...
            head: {
                ...
                maizhuang: {
                    ...
                    _event: {
                        ...
                        MJJiazhu: function(msg) {
                            //setMaizhuangTag_xuezhanMJ(msg,1)
                        },
                        mjhand:function()
                        {
                            this.visible = false;
            ...
            _event: {
                ...
                initSceneData: function(eD) {
                    SetUserVisible_xuezhanMJ(this, 1);
                },
                addPlayer: function(eD) {
                    SetUserVisible_xuezhanMJ(this, 1);
                },
                ...
                mjhand: function(eD) {
                    //showShaiziAni_xuezhanMJ(1);
                    InitUserHandUI_xuezhanMJ(this, 1);
                ...
                MJChi: function(eD) {
                    ...
                    if (MjClient.rePlayVideo != -1) {
                        ...
                        updateHeadUI_xuezhanMJ(this, 1, ActionType.CHI);
                    }
                    setUserOffline(this, 1);
                },
                MJGang: function(eD) {
                ...
                MJPeng: function(eD) {
                    ...
                    if (MjClient.rePlayVideo != -1) {
                        ...
                        updateHeadUI_xuezhanMJ(this, 1, ActionType.PENG);
                    }
                    setUserOffline(this, 1);
                },
                MJHu: function(eD) {
        ...
        top: {
            ...
            head: {
                ...
                maizhuang: {
                    ...
                    _event: {
                        ...
                        MJJiazhu: function(msg) {
                            //setMaizhuangTag_xuezhanMJ(msg,2)
                        },
                        mjhand:function()
                        {
                            this.visible = false;
            ...
            _event: {
                ...
                initSceneData: function(eD) {
                    SetUserVisible_xuezhanMJ(this, 2);
                ...
                mjhand: function(eD) {
                    //showShaiziAni_xuezhanMJ(2);
                    InitUserHandUI_xuezhanMJ(this, 2);
                ...
                MJChi: function(eD) {
                    ...
                    if (MjClient.rePlayVideo != -1) {
                        ...
                        updateHeadUI_xuezhanMJ(this, 2, ActionType.CHI);
                    }
                    setUserOffline(this, 2);
                },
                MJGang: function(eD) {
                ...
                MJPeng: function(eD) {
                    ...
                    if (MjClient.rePlayVideo != -1) {
                        ...
                        updateHeadUI_xuezhanMJ(this, 2, ActionType.PENG);
                    }
                    setUserOffline(this, 2);
                },
                MJHu: function(eD) {
        ...
        left: {
            ...
            head: {
                ...
                maizhuang: {
                    ...
                    _event: {
                        ...
                        MJJiazhu: function(msg) {
                            //setMaizhuangTag_xuezhanMJ(msg,3)
                        },
                        mjhand:function()
                        {
                            this.visible = false;
            ...
            _event: {
                ...
                initSceneData: function(eD) {
                    SetUserVisible_xuezhanMJ(this, 3);
                },
                addPlayer: function(eD) {
                    SetUserVisible_xuezhanMJ(this, 3);
                },
                ...
                MJChi: function(eD) {
                    ...
                    if (MjClient.rePlayVideo != -1) {
                        ...
                        updateHeadUI_xuezhanMJ(this, 3, ActionType.CHI);
                    }
                    setUserOffline(this, 3);
                },
                MJGang: function(eD) {
                ...
                MJPeng: function(eD) {
                    ...
                    if (MjClient.rePlayVideo != -1) {
                        ...
                        updateHeadUI_xuezhanMJ(this, 3, ActionType.PENG);
                    }
                    setUserOffline(this, 3);
                },
                MJHu: function(eD) {
    ...
    ctor: function() {
        ...
        var playui = ccs.load("Play_xuezhanMJ.json");
        playMusic("bgFight");
...
PlayLayer_xuezhanMJ.prototype.CardLayoutRestore = function(node, off)
{
...
// 判断吃碰杠胡的状态
PlayLayer_xuezhanMJ.prototype.EatVisibleCheck = function()
{
    if(_isAniShow_xuezhanMJ) return;
    var eat = MjClient.playui.jsBind.eat;
...
PlayLayer_xuezhanMJ.prototype.resetCardcolor = function(off)
{
...
PlayLayer_xuezhanMJ.prototype.playSignAnimation = function(node,off,dir)
{
...
PlayLayer_xuezhanMJ.prototype.clearSign = function(off)
{
    var node = getNode(off);
    if (!node)
    {
...
PlayLayer_xuezhanMJ.prototype.resetCardAfterHu = function(node,off)
{
...
/*    if (pl.mjpeng.length > 0)
    {
        AllCard += pl.mjpeng.length * 3;
    }
    if (pl.mjgang0.length > 0)
    {
        AllCard += pl.mjgang0.length * 4;
    }
    if (pl.mjgang1.length > 0)
    {
        AllCard += pl.mjgang1.length * 4;
    }

    if (AllCard > 13)
    {
        if (off == 0 && (pl.mjgang1.length <= 0 && pl.mjgang0.length <= 0))
        {
            cc.log("删掉最后一张");
            RemoveNodeBack(node, cardname, 1);
        }
        if (huCardsarry.length > 13 && off != 0)
        {
            RemoveNodeBack(node, cardname, 1);
            getNewCard(node, "up", cardname, pl.huCards[pl.huCards.length - 1], off);
        }
        var newcc = (13 + pl.mjgang1.length + pl.mjgang0.length);
