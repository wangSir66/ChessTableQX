 ...
 * @type {void | Class | *}
 */
var majiang_winGamePanel_suiZhouKaiWuXing = majiang_winGamePanel_hubei.extend({
    ctor: function(){
        this._super("endOne_suiZhouKaWuXing.json");
...
// 显示抓鸟内容
majiang_winGamePanel_suiZhouKaiWuXing.prototype.showAddBird = function(back, tData){
    //显示抓鸟的牌
...
//获取小结算中单个玩家的牌型描述
majiang_winGamePanel_suiZhouKaiWuXing.prototype.getCardTypeDesc = function(pl,sData){
...
// 设置单个玩家面板数据
majiang_winGamePanel_suiZhouKaiWuXing.prototype.setEndOneUserUI = function (infoImg, off) {
