...
(function() {
    ...
    majiang.canTing = function (cds,hunCard) {
        ...
        var tData = MjClient.data.sData.tData;
        if (this.getAllCardsTotal() - tData.cardNext <= 12 && tData.areaSelectMode.buKeLiang12 == 1) return false;
    ...
    majiang.getAllCardsTotal = function (tData) {
        var tData = MjClient.data.sData.tData;
        var cardNum = 56;
        if (tData.areaSelectMode.maxPlayer == 2){
    ...
    {
        MjClient.majiang_suiZhouKaWuXing = majiang;
    }
    else
    {
