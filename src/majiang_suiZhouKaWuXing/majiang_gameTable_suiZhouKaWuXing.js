...
/****************************************    刷新玩家手牌   *******************************************************/
majiang_panel_suiZhouKaiWuXing.prototype.updatePlayerCards = function (node) {
    if(!node) {
        return;
    }
...
/****************************************     3D相关   *******************************************************/
majiang_panel_suiZhouKaiWuXing.prototype.getCardSortArray3D = function (node, newCardTag) {
    var tData = MjClient.data.sData.tData;
...
majiang_panel_suiZhouKaiWuXing.prototype.updateDownEatAndHandCards3D = function (cardArray) {
    var tData = MjClient.data.sData.tData;
...
majiang_panel_suiZhouKaiWuXing.prototype.updateRightEatAndHandCards3D = function (cardArray) {
    var playerNode = cardArray[0].getParent();
    var templetEatCard = playerNode.getChildByName(this.CsdDefaultCardType.EatCardFront);
    var templetHandCard = playerNode.getChildByName(this.CsdDefaultCardType.HandCard);
    var player = this.getPlayerInfoByName(playerNode.getName());
...
majiang_panel_suiZhouKaiWuXing.prototype.updateTopEatAndHandCards3D = function (cardArray) {
    var playerNode = cardArray[0].getParent();
    var templetEatCard = playerNode.getChildByName(this.CsdDefaultCardType.EatCardFront);
    var player = this.getPlayerInfoByName(playerNode.getName());
...
majiang_panel_suiZhouKaiWuXing.prototype.updateLeftEatAndHandCards3D = function (cardArray) {
    var playerNode = cardArray[0].getParent();
    var templetEatCard = playerNode.getChildByName(this.CsdDefaultCardType.EatCardFront);
    var templetHandCard = playerNode.getChildByName(this.CsdDefaultCardType.HandCard);
    var player = this.getPlayerInfoByName(playerNode.getName());
...
/****************************************     2D相关   *******************************************************/
majiang_panel_suiZhouKaiWuXing.prototype.getCardSortArray2D = function(node, newCardTag){
    var tData = MjClient.data.sData.tData;
...
majiang_panel_suiZhouKaiWuXing.prototype.updateCardPosition2D = function(node, sortArr) {
...
majiang_panel_suiZhouKaiWuXing.prototype.switchUpdate2D = function(node, sortArr, pos, index, chiFirstIndex){
...
majiang_panel_suiZhouKaiWuXing.prototype.setHandPosition2D = function(node, cardArr, pos, index) {
...
majiang_panel_suiZhouKaiWuXing.prototype.setPuPosition2D = function(node, cardArr, pos, index, chiFirstIndex){
    var cardNode = cardArr[index];
    cardNode.setPosition(pos);
};
 ...
 *  处理麻将明杠
 **/
majiang_panel_suiZhouKaiWuXing.prototype.dealMingGang = function(playerNode, msg) {
 ...
 *  处理麻将暗杠
 **/
majiang_panel_suiZhouKaiWuXing.prototype.dealAnGang = function(playerNode, msg) {
    var gangCard = msg.card;
    var sData = MjClient.data.sData;
    var player = sData.players[msg.uid];
    if (MjClient.rePlayVideo != -1 || playerNode.getName() == "node_down") {
...
majiang_panel_suiZhouKaiWuXing.prototype.showMjhandBeforeEndOne3D = function(nodeName){
    var player = this.getPlayerInfoByName(nodeName);
...
majiang_panel_suiZhouKaiWuXing.prototype.showMjhandBeforeEndOne2D = function(playerNodeName) {
...
majiang_panel_suiZhouKaiWuXing.prototype.removeCutCards = function(node) {
    var children = node.children;
...
majiang_panel_suiZhouKaiWuXing.prototype.dealTing = function(playerNode, msg) {
...
majiang_panel_suiZhouKaiWuXing.prototype.getIsZhongBird = function(cd){
    var tData = MjClient.data.sData.tData;
    if (tData.areaSelectMode.maiMaType == 2 &&(cd < 30 && cd % 10 == 1 || cd % 10 == 4 || cd % 10 == 7)) 
    {
       return true;
    }
    return false;
