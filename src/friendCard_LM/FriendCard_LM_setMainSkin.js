/** 
 * @Description: 联盟 - 亲友圈设置皮肤界面
 */

var Friendcard_LM_setMainSkin = cc.Layer.extend({
	...
	onClickBgBtn:function(ruleIndex,index)
	{
		...
		// if(ruleIndex == "MJ")
		// {
		// 	for (var i = 0; i < this.MJBgList.length; i++) {
		// 		 this.MJBgList[i].setSelected(false)
		// 	}
		// 	this.MJBgList[index].setSelected(true);
		// 	this.MJBgList._index = index;
		// }
