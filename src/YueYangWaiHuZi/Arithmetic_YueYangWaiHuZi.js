...
(function() {
    ...
    var MaJiangYueYangWaiHuZi = function() {
        this.KING = 91;
        this.handCount = 13;
        this.sortType = 1;
    };

    MaJiangYueYangWaiHuZi.prototype.getCardShowType = function(uid, card) {
    ...
    MaJiangYueYangWaiHuZi.prototype.getAllCardsTotal = function(tb) {
        var tData = MjClient.data.sData.tData;
        return 80 - (tData.maxPlayer == 2 ? tData.areaSelectMode.maiPaiNum : 0);
    };

    MaJiangYueYangWaiHuZi.prototype.setJiaZhuNum = function (node, pl)
    {
        if(!pl) return;
    ...
    MaJiangYueYangWaiHuZi.prototype.isEqualHunCard = function(card) {
        return card == KING;
    };

    // 理牌
    MaJiangYueYangWaiHuZi.prototype.sortCardTemp = function(hand, sortType) {
        hand = hand.slice();
    ...
    MaJiangYueYangWaiHuZi.prototype.sortByUser = function (arr) {
    ...
    MaJiangYueYangWaiHuZi.prototype.sortCard3 = function (hand, sortType) {
        return this.sortCard(hand, sortType);
    }

    MaJiangYueYangWaiHuZi.prototype.sortCard = function (hand, sortType) {
    ...
    MaJiangYueYangWaiHuZi.prototype.sortCard2 = function (handArr) {
    ...
    MaJiangYueYangWaiHuZi.prototype.cardHandCount = function (cardArr,card){
        var cardCount = 0;
    ...
    // 吃牌组合列表
    MaJiangYueYangWaiHuZi.prototype.getChiList = function(pl, card) {
    ...
    // 获取能打牌的数量
    MaJiangYueYangWaiHuZi.prototype.getCanPutCardNum = function(pl) {
        var num = 0;
        var hand = pl.mjhand;
    ...
    MaJiangYueYangWaiHuZi.prototype.isRed = function(card) {
        return [2, 7, 10, 22, 27, 30].indexOf(card) >= 0;
    };

    MaJiangYueYangWaiHuZi.prototype.isQiDui = function(pl, card) {
        var hand = pl.mjhand.slice();
        hand.push(card);
    ...
    // 红字 大字 王数量统计
    MaJiangYueYangWaiHuZi.prototype.stats = function(pl, card) {
        var hand = pl.mjhand.slice();
        hand.push(card);
    ...
    MaJiangYueYangWaiHuZi.prototype.canHuBanBan = function(tb, pl) {
        var tData = tb.tData;
    ...
    MaJiangYueYangWaiHuZi.prototype.getAchv = function(tb, pl, matrix, be, stats) {
        var tData = tb.tData;
    ...
    // 8、碰（三张）：1息；
    // 9、二七十（贰柒拾）：1息；
    MaJiangYueYangWaiHuZi.prototype.getPutCardHuxi = function(pl){
        var score = {xiaoHu:0, daHu:0};;
        score.xiaoHu += pl.mjgang0.length * 5;
        score.xiaoHu += pl.mjgang1.length * 5;
        score.xiaoHu += pl.mjwei.length * 4;

        score.daHu = score.xiaoHu;
    ...
    //支持二维数组
    MaJiangYueYangWaiHuZi.prototype.getCardCount = function(cards, card) {
        var count = 0;
        for (var i = 0; i < cards.length; i++) {
            if (cards[i].length){
    ...
    MaJiangYueYangWaiHuZi.prototype.jiangType = function(c1, c2){
        if (c1 == c2){
            return 1;
    ...
    MaJiangYueYangWaiHuZi.prototype.canHu = function(tb, pl, card, cardType) {
        var needHuxi = tb.tData.minHuxi - 1;
    ...
    MaJiangYueYangWaiHuZi.prototype.getHuInfo = function(tb, pl, card) {
    ...
    // 获取听牌
    MaJiangYueYangWaiHuZi.prototype.getTingCards = function(tb, pl, putCard) {
    ...
    // 获取听牌统计
    MaJiangYueYangWaiHuZi.prototype.getTingStats = function(tb, pl, putCard) {
    ...
    MaJiangYueYangWaiHuZi.prototype.canTing = function(tb, pl, putCard) {
        var copy = pl.mjhand.slice();
        var tingCards = [];
        if (putCard != undefined) {
            var idx = pl.mjhand.indexOf(putCard);
    ...
    // 提示打后可听的牌
    MaJiangYueYangWaiHuZi.prototype.hintPutCardsToTing = function() {
    ...
    // 打的牌 -->  听牌统计
    MaJiangYueYangWaiHuZi.prototype.put2TingStats = function(tb, pl) {
    ...
    if (typeof(MjClient) != "undefined") {
        MjClient.majiang_YueYangWaiHuZi = new MaJiangYueYangWaiHuZi();
    }   

    function test() {
        var a = new MaJiangYueYangWaiHuZi();
