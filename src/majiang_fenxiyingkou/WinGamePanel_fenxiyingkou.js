function SetEndOneUserUI_fenxiyingkou(node,off)
{
...
var EndOneView_fenxiyingkou = cc.Layer.extend({
	jsBind:{
		block: {
		...
		btnShowHeap:{
                ...
                _click:function()
                {
                	if(MjClient.endoneui){
                        var fenxiyingkouCardsHeap = new PopupShowCardsHeap();
                        fenxiyingkouCardsHeap.setName("fenxiyingkouCardsHeap");
                        MjClient.endoneui.addChild(fenxiyingkouCardsHeap);
                    }
                },
            },
		dir: {
		...
		head0:{
		   ...
		   _run:function(){ SetEndOneUserUI_fenxiyingkou(this,0); },
		...
		head1:{
		  ...
		  _run:function(){ SetEndOneUserUI_fenxiyingkou(this,1); }
		},
		head2:{
		   head:{
			   zhuang:{_visible:false}
		   ...
		   _run:function(){ SetEndOneUserUI_fenxiyingkou(this,2); }
		},
		head3:{
			 head:
			 {
			...
			_run:function(){ SetEndOneUserUI_fenxiyingkou(this,3); }
			},
		count_down:{
                _visible :function()
                {
    ...
    ctor:function () {
        this._super();
        var endoneui = ccs.load("endOne_fenxiyingkou.json");
