var FriendCard_tongji = cc.Layer.extend({
    ...
    initGroupYBTJ: function () {
        ...
        this.addItems_YBTJ = function (data) {
            ...
            for (var i in data) {
                ...
                var text_yeji = _item.getChildByName("text_yeji");
                text_yeji.setString(itemDta.honorVal ? itemDta.honorVal + "" : "0")
    ...
    fresh_table: function () {
        if (this._isManager || this.isAssistants) {
            ...
            var text_honor = Panle_top.getChildByName("text_honor");
            var text_honorcount = Panle_top.getChildByName("text_honorcount");
            if (this._record_data && ("groupTotalHonor" in this._record_data)) {
                text_honor.visible = true;
                text_honorcount.setString("" + this._record_data.groupTotalHonor);
            }
            else {
                text_honor.visible = false;
                text_honorcount.setString("");
            }
    ...
    createItem: function (oneData) {
        ...
        var text_yeji = copyNode.getChildByName("text_yeji");
        text_yeji.ignoreContentAdaptWithSize(true);
        text_yeji.setString(oneData.honorVal != undefined ? oneData.honorVal : "0");
