...
var PlayLayer_doudizhuHuaiAn = cc.Layer.extend({
    ctor: function () {
        this._super();
         var playui = ccs.load("Play_doudizhuHuaiAn.json");
...
//出牌提示
PlayLayer_doudizhuHuaiAn.prototype.showTipCards = function () {
...
// 处理斗地主智能提牌
PlayLayer_doudizhuHuaiAn.prototype.handleDoudizhuCardsAutoUp = function (bTouchMove) {
    if (!this.isSDataValid()) {
        return ;
    }
    var tData = MjClient.data.sData.tData;
...
PlayLayer_doudizhuHuaiAn.prototype.handleCardsTouchListener = function () {
    return {
...
// 处理点击
PlayLayer_doudizhuHuaiAn.prototype.handleTouchCards = function (touch, event, isBegan) {
...
// 处理玩家提起提起得牌，保留正确的牌
PlayLayer_doudizhuHuaiAn.prototype.handleUpRightCards = function (isFirst, off) {
    if (isFirst) {
        return;
    }
...
// =========================[[ 流程 ]] =========================
// 断线重连/初始化
PlayLayer_doudizhuHuaiAn.prototype.dealInitSceneData = function () {
    if (!this.isSDataValid()) {
        return ;
    }
    var tData = MjClient.data.sData.tData;
...
PlayLayer_doudizhuHuaiAn.prototype.dealChangePKImg = function () {
...
// 结算
PlayLayer_doudizhuHuaiAn.prototype.dealRoundEnd = function (eD) {
    if (!this.isSDataValid()) {
        return ;
    }
    ...
    function delayExe() {
        ...
        cc.log("dealroundend--------");
        self.addChild(new EndOneView_doudizhuHuaiAn(zhuang), 500);
    }
...
// 过、准备
PlayLayer_doudizhuHuaiAn.prototype.dealPKPass = function (eD) {
    MjClient.playui.killTimeClock();
...
// 出牌
PlayLayer_doudizhuHuaiAn.prototype.dealPKPut = function (msg) {
    var tData = MjClient.data.sData.tData;
    tData.rate = msg.rate;
...
// 等待出牌
PlayLayer_doudizhuHuaiAn.prototype.dealWaitPut = function (eD, isSceneData) {
    var tData = MjClient.data.sData.tData;
...
// 等待叫地主
PlayLayer_doudizhuHuaiAn.prototype.dealWaitJiaodizhu = function (msg) {
    var sData = MjClient.data.sData;
    var tData = sData.tData;
...
// 抢地主
PlayLayer_doudizhuHuaiAn.prototype.dealQiangDizhu = function (msg) {
    var tData = MjClient.data.sData.tData;
...
// 等待准备
PlayLayer_doudizhuHuaiAn.prototype.dealAllReady = function (bAllReady) {
    for (var i = 0; i < this.headOffLen; i++) {
        var off = this.headOffArr[i];
...
// 加倍
PlayLayer_doudizhuHuaiAn.prototype.dealMJJiazhu = function (isSceneData, off, jiazhuNum, curPlayer) {
    var tData = MjClient.data.sData.tData;
...
// 等待加倍
PlayLayer_doudizhuHuaiAn.prototype.dealWaitJiazhu = function (eD, bSceneData) {
    var tData = MjClient.data.sData.tData;
...
// 处理手牌
PlayLayer_doudizhuHuaiAn.prototype.handleMjHand = function () {
...
// 处理底牌
PlayLayer_doudizhuHuaiAn.prototype.dealDiCards = function (zhuang, diCards, handCounts, isAddCards, isIconMove) {
    var tData = MjClient.data.sData.tData;
    tData.zhuang = zhuang;
...
PlayLayer_doudizhuHuaiAn.prototype.updateUserHeadPosition = function (off, bRoundEnd) {
...
PlayLayer_doudizhuHuaiAn.prototype.updateTimes = function () {
...
//设置地区信息
PlayLayer_doudizhuHuaiAn.prototype.showGameName = function () {
...
//添加还背景的功能
PlayLayer_doudizhuHuaiAn.prototype.addChangeBg = function () {
...
PlayLayer_doudizhuHuaiAn.prototype.showVoice = function () {
...
PlayLayer_doudizhuHuaiAn.prototype.addWaitNode = function () {
...
PlayLayer_doudizhuHuaiAn.prototype.setWaitNodeVisible = function (bVisible) {
    if (!MjClient.playui.waitNode) {
        return;
    }
    MjClient.playui.waitNode.setVisible(bVisible);
}
PlayLayer_doudizhuHuaiAn.prototype.addAniLayer = function () {
...
PlayLayer_doudizhuHuaiAn.prototype.showTableID = function (bShow) {
...
PlayLayer_doudizhuHuaiAn.prototype.setHLJiabeiVisible = function (bVisible) {
...
// 出牌按钮
PlayLayer_doudizhuHuaiAn.prototype.handlePutCardBtn = function (isVisible, isFirst) {
...
PlayLayer_doudizhuHuaiAn.prototype.enablePutCardBtn = function (bAble) {
    var btnPutCard = this.node.getChildByName("BtnPutCard");
...
//操作按钮(提示和不出)
PlayLayer_doudizhuHuaiAn.prototype.handleHimtAndNoPutBtn = function (isVisible, isAble) {
...
//经典斗地主叫分按钮
PlayLayer_doudizhuHuaiAn.prototype.setJingDianBtnVisible = function (bVisible, buJiaoAble, score, bmustjiao) {
...
//欢乐斗地主叫分按钮
PlayLayer_doudizhuHuaiAn.prototype.setHuanLeBtnVisible = function (bVisible, bMustJiao) {
...
// 牌局信息
PlayLayer_doudizhuHuaiAn.prototype.showRoundInfo = function () {
    if (!this.isSDataValid()) {
        return ;
    }
...
// 局数
PlayLayer_doudizhuHuaiAn.prototype.updateGameRound = function () {
...
// 加倍
PlayLayer_doudizhuHuaiAn.prototype.setTextMult = function (bShow) {
...
//踢
PlayLayer_doudizhuHuaiAn.prototype.handleTiTag = function (off, type) {
    var node = getNode_cards(off);
...
PlayLayer_doudizhuHuaiAn.prototype.setBtnTiVisible = function (bVisible, bFanTi) {
    ...
    setWgtLayout(BtnTi, [0.14, 0.14], [0.4, 0.42 + d], [0, 0]);
    setWgtLayout(BtnBuTi, [0.14, 0.14], [0.6, 0.42 + d], [0, 0]);
    if (!bVisible) {
        return;
    }
    if (bFanTi) {
...
PlayLayer_doudizhuHuaiAn.prototype.sendTiToServer = function (TiNum) {
...
// 底分
PlayLayer_doudizhuHuaiAn.prototype.handleDifen = function () {
...
PlayLayer_doudizhuHuaiAn.prototype.hideAllUI = function () {
...
// 不抢/抢地主
PlayLayer_doudizhuHuaiAn.prototype.dealQiangDizhuText = function (off, visible, msg) {
    var node = getNode_cards(off);
    var diZhuTag = node.getChildByName("jiaodizhuTag");
...
// 要不起
PlayLayer_doudizhuHuaiAn.prototype.handleNoPutTag = function (off, visible) {
    var node = getNode_cards(off);
...
// 没有大过上家
PlayLayer_doudizhuHuaiAn.prototype.handleNoPutTips = function (isVisible) {
    var noPutTips = this.node.getChildByName("noPutTips");
...
// 没有大过上家
PlayLayer_doudizhuHuaiAn.prototype.handlePassBtn = function (isVisible) {
    var BtnPass = this.node.getChildByName("BtnPass");
...
// =========================[[ 系统 ]] ==========================
PlayLayer_doudizhuHuaiAn.prototype.dealSendVoice = function (fullFilePath) {
    if (!fullFilePath) {
...
PlayLayer_doudizhuHuaiAn.prototype.dealDownAndPlayVoice = function (msg) {
...
PlayLayer_doudizhuHuaiAn.prototype.dealUploadRecord = function (filePath) {
    if (filePath) {
...
// 绘制手牌
PlayLayer_doudizhuHuaiAn.prototype.initUserHandUiDoudizhu = function (off) {
    var pl = getUIPlayer(off);
    if (pl == null) {
        return;
    }
...
//处理出牌,打牌动作
PlayLayer_doudizhuHuaiAn.prototype.dealPKPutcard = function (off, msg) {
    var sData = MjClient.data.sData;
    var tData = sData.tData;
...
PlayLayer_doudizhuHuaiAn.prototype.playAnimation = function (cards, off) {
    var pl = getUIPlayer(off);
    if (!pl) { return ; }
...
// 增加底牌
PlayLayer_doudizhuHuaiAn.prototype.addDiCardsToZhuang = function (zhuangOff) {
    var tData = MjClient.data.sData.tData;
...
// 处理准备字准备相关
PlayLayer_doudizhuHuaiAn.prototype.handleAboutReady = function (off, bAllReady) {
...
PlayLayer_doudizhuHuaiAn.prototype.startTimeClock = function (func) {
...
PlayLayer_doudizhuHuaiAn.prototype.killTimeClock = function () {
    MjClient.clockNode.getChildByName("number").stopAllActions();
    stopEffect(playTimeUpEff);
    playTimeUpEff = null;
};

PlayLayer_doudizhuHuaiAn.prototype.clockNumberUpdate = function (node, endFunc) {
    return arrowbkNumberUpdate(node, endFunc);
}

PlayLayer_doudizhuHuaiAn.prototype.checkRoomUiDelete = function () {
...
PlayLayer_doudizhuHuaiAn.prototype.showGps = function () {
...
// 地主的三张牌
PlayLayer_doudizhuHuaiAn.prototype.handleDoudizhuDiCards = function () {
...
PlayLayer_doudizhuHuaiAn.prototype.dealMJTick = function (eD) {
    for (var i = 0; i < this.headOffLen; i++) {
        var off = this.headOffArr[i];
        var pl = getUIPlayer(off);
        if (!pl) { continue ; }
...
PlayLayer_doudizhuHuaiAn.prototype.dealLogout = function () {
    if (MjClient.playui) {
...
PlayLayer_doudizhuHuaiAn.prototype.dealEndRoom = function (msg) {
...
PlayLayer_doudizhuHuaiAn.prototype.dealLeaveGame = function () {
    MjClient.playui.killTimeClock();
    MjClient.addHomeView();
    MjClient.playui.removeFromParent(true);
    delete MjClient.playui;
...
PlayLayer_doudizhuHuaiAn.prototype.dealLoadWxHead = function (eD) {
    for (var i = 0; i < this.headOffLen; i++) {
        var off = this.headOffArr[i];
...
PlayLayer_doudizhuHuaiAn.prototype.dealPlayVoice = function (msg) {
    for (var i = 0; i < this.headOffLen; i++) {
        var off = this.headOffArr[i];
...
PlayLayer_doudizhuHuaiAn.prototype.dealChangeGameBgEvent = function () {
...
PlayLayer_doudizhuHuaiAn.prototype.handlePlayerChange = function (action, uid) {
    if (!this.isSDataValid()) {
        return ;
    }
    var targetOff = -1;
...
PlayLayer_doudizhuHuaiAn.prototype.dealMoveHead = function () {
    var that = this;
    var fun1 = function () {
...
// =========================[[ 消息 ]] ===========================
// 加倍
PlayLayer_doudizhuHuaiAn.prototype.sendJiaBeiToServer = function (beishu) {
...
// 叫地主、不叫、叫分
PlayLayer_doudizhuHuaiAn.prototype.sendQiangdizhuToServer = function (bQiang) {
     MjClient.playui.setJingDianBtnVisible(false);
    //MjClient.playui.setHuanLeBtnVisible(false);
    MjClient.gamenet.request("pkroom.handler.tableMsg", {
        cmd: "Qiangdizhu",
...
// 出牌
PlayLayer_doudizhuHuaiAn.prototype.sendPutCardsToServer = function () {
    if (this.isCardsSend) {
        return;
    }
    ;
...
// 准备-1， 提示过牌0， 不出 1
PlayLayer_doudizhuHuaiAn.prototype.sendPassToServer = function (isActivePass) {
    this.handCardsWgetArr[0].clearCardsUpStatus();
...
// =========================[[ 初始化 ]] ==========================
PlayLayer_doudizhuHuaiAn.prototype.initTagList = function () {
    this.btnTagList = {
        BtnPutCard: 1,
        BtnHimt: 2,
        BtnNoPut: 3,
...
PlayLayer_doudizhuHuaiAn.prototype.initData = function (isRoundEnd) {
    this.cardTipsArr = [];
    this.tipsIdx = 0;
...
PlayLayer_doudizhuHuaiAn.prototype.initOnce = function () {
...
PlayLayer_doudizhuHuaiAn.prototype.initUI = function () {
...
// 初始化节点
PlayLayer_doudizhuHuaiAn.prototype.initHeadWget = function () {
    this.headOffArr = [];
    this.headNode = {};
    this.AniMotion = [];
    ...
    for (var off = 0; off < 4; off++) {
        ...
        this.handCardsWgetArr[off] = new PokerCardNode_DoudizhuSpecial(off,cardScale);
        nodeStand.addChild(this.handCardsWgetArr[off].node);
        this.deskCardsWgetArr[off] = new PokerCardNode_DoudizhuSpecial(off,cardScale);
...
//初始化玩家信息
PlayLayer_doudizhuHuaiAn.prototype.initMsgEvent = function () {
    // ================ 重连 =========================
...
PlayLayer_doudizhuHuaiAn.prototype.initClickEvent = function () {
...
PlayLayer_doudizhuHuaiAn.prototype.btnBindCallBack = function (parent, str, tag, callback) {
...
PlayLayer_doudizhuHuaiAn.prototype.btnEventListener = function (sender, type) {
...
// 初始化时钟节点
PlayLayer_doudizhuHuaiAn.prototype.initClockWget = function () {
    for (var off = 0; off < 4; off++) {
        var _node = getNode(off);
...
PlayLayer_doudizhuHuaiAn.prototype.isSDataValid = function() {
    var sData = MjClient.data.sData;
    var strSData = JSON.stringify(sData);
    cc.log("lijm-------------",strSData);
