...
var HomeView_txlinfenmj = cc.Layer.extend({
    ...
    ctor: function () {
        ...
        setWgtLayout(_tilebg, [1, 1], [0.51, 1], [0, 0]);
        ...
        setWgtLayout(_bottom_bg, [0.9, 0.9], [0.5, 0], [0, 0], false,true);
        ...
        _tagIcon1.opacity = 255;
        var _act1 = cc.sequence(cc.delayTime(3),cc.fadeIn(1),cc.delayTime(5),cc.fadeOut(1),cc.delayTime(7));
        _tagIcon1.runAction(_act1.repeatForever());
        ...
        //添加动画
        this._girlNode = _back.getChildByName("meinv");
        var girlAni = createSpine("spine/renwu/NewProject.json", "spine/renwu/NewProject.atlas");
        girlAni.setAnimation(0, 'newAnimation', true);
        girlAni.setPosition(0,150);
        //girlAni.setScale(0.5);
        this._girlNode.addChild(girlAni,100);

        //云雾
        this._yun0 = _back.getChildByName("yun_0");
        this._yun1 = _back.getChildByName("yun_1");
        this._yun2 = _back.getChildByName("yun_2");

        this.runCloudAnimation(0,0);

        //樱花
        this._flowers = _back.getChildByName("flowers");
        var starParticle1 =  new cc.ParticleSystem("Particle/flowers.plist");
        starParticle1.setPosition(this._flowers.getContentSize().width/2, this._flowers.getContentSize().height/2);
        this._flowers.addChild(starParticle1);
        ...
        setWgtLayout(this._youjian, [0.145, 0.145], [0.74 + 0.07, 0.85], [0,0]);
        setWgtLayout(_BtnHTP,        [0.145, 0.145], [0.74 + 0.07*2, 0.85], [0,0]);
        setWgtLayout(_setting,       [0.145, 0.145], [0.745 + 0.07*3, 0.85], [0,0]);
        //setWgtLayout(this._girlNode, [0.145, 0.145], [0.2, 0], [0,0]);
        ...
        setWgtLayout(_gonggao, [0.258, 0.542], [0.18, 0.42], [0.0, 0.0]);
        ...
        //setWgtLayout(_headbg, [0.078, 0.14], [0.05, 0.99], [0, -0.025]);
    ...
    setGamePanel: function (gamePanelNode) {
        ...
        //添加动画 TODO
        var joinAni = createSpine("spine/joinroom/NewProject.json", "spine/joinroom/NewProject.atlas");
        joinAni.setAnimation(0, 'newAnimation', true);
        joinAni.setPosition(110,300);
        //joinAni.setScale(1.13);
        ...
        // this._createRoom.addChild(starParticle1);z
        //添加动画 TODO
        var createAni = createSpine("spine/createroom/NewProject.json", "spine/createroom/NewProject.atlas");
        createAni.setAnimation(0, 'newAnimation', true);
        createAni.setPosition(130,305);
        createAni.setName("createAni");
        //createAni.setScale(1.13);
        this._createRoom.addChild(createAni,100);

        this._createRoom.addTouchEventListener(function (sender, Type) {
            switch (Type) {
                case ccui.Widget.TOUCH_BEGAN:
                    //sender.getChildByName("createAni").setScale(1.13);
                    break;
                case ccui.Widget.TOUCH_ENDED:
                    ...
                    // }
                    //sender.getChildByName("createAni").setScale(1);
                    if (!MjClient.data.sData)
                    {
        ...
        //添加动画 TODO
        var clubAni = createSpine("spine/club/NewProject.json", "spine/club/NewProject.atlas");
        clubAni.setAnimation(0, 'newAnimation', true);
        clubAni.setPosition(110,300);
        //clubAni.setScale(1.13);
    ...
    runCloudAnimation: function(speed0, speed1){

        var startPos1 = this._yun0.getPosition();
        var startPos2 = this._yun1.getPosition();
        var self = this;
        var callback1 = function ()
        {
            self._yun0.setPosition(cc.p(startPos1.x, startPos1.y));
        }
        var callback2 = function ()
        {
            self._yun1.setPosition(cc.p(startPos2.x, startPos2.y));
        }

        this._yun0.runAction(cc.repeatForever(cc.sequence(cc.moveBy(cc.winSize.width/2 / 10,cc.p(cc.winSize.width * 2,0)), cc.callFunc(callback1))));
        this._yun1.runAction(cc.repeatForever(cc.sequence(cc.moveBy(cc.winSize.width/2 / 3,cc.p(cc.winSize.width * 2,0)), cc.callFunc(callback2))));
    },
