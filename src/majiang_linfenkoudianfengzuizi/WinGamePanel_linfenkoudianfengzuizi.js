...
function SetEndOneUserUI_linfenkoudianfengzuizi(node,off)
{
...
var EndOneView_linfenkoudianfengzuizi = cc.Layer.extend({
	jsBind:{
		block: {
		...
		head0:{
		   ...
		   _run:function(){ SetEndOneUserUI_linfenkoudianfengzuizi(this,0); },
		...
		,head1:{ 
		  ...
		  _run:function(){ SetEndOneUserUI_linfenkoudianfengzuizi(this,1); }
		}
		...
		,head2:{ 
		   ...
		   _run:function(){ SetEndOneUserUI_linfenkoudianfengzuizi(this,2); }
		}
		,head3:{
			 head:
			 {
			...
			_run:function(){ SetEndOneUserUI_linfenkoudianfengzuizi(this,3); }
			},
            count_down:{
                _visible :function()
                {
    ...
    ctor:function () {
        this._super();
        var endoneui = ccs.load("endOne_linfenkoudianfengzuizi.json");
