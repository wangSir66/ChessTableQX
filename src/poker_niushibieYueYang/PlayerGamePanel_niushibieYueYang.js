...
//初始化玩家金币和名字
function InitUserCoinAndName_niushibie(node, off)
{
...
function SetUserVisible_NiuShiBieYueYang(node, off)
{
    var pl = getUIPlayer(off);
    ...
    if(pl)
    {
        ...
        InitUserHandUI_NiuShiBieYueYang(node, off);
    }
    else
    {
        name.visible = false;
...
function InitUserHandUI_NiuShiBieYueYang(node, off)
{
...
function cardsSort_NiuShiBieYueYang(cards)
{
    var pointCounts = {};
...
var PlayLayer_NiuShiBieYueYang = cc.Layer.extend({
    _btnPutCard:null,
    jsBind: {
        _event: {
            mjhand: function() {
            ...
            endRoom: function(msg) {
                ...
                if (msg.showEnd) this.addChild(new GameOverLayer_niushibie(),500);
                else
                        ...
                        if (sData.tData.roundNum <= 0) {
                            if(!tData.matchId) {
                                ...
                                self.runAction(cc.sequence(cc.delayTime(3),cc.callFunc(function(){
                                    self.addChild(new GameOverLayer_niushibie(),500);
                                })))
                            }
                        }
                    }
            ...
            initSceneData: function() {
                ...
                MjClient.playui.UpdataNiuShiBieTips();
        ...
        down: {
            ...
            _event: {
                ...
                initSceneData: function(eD) {
                    SetUserVisible_NiuShiBieYueYang(this, 0);
                ...
                mjhand: function(eD) {
                    InitUserHandUI_NiuShiBieYueYang(this, 0);
        ...
        right: {
            ...
            _event: {
                ...
                initSceneData: function(eD) {
                    SetUserVisible_NiuShiBieYueYang(this, 1);
                ...
                mjhand: function(eD) {
                    InitUserHandUI_NiuShiBieYueYang(this, 1);
                },
                roundEnd: function() {
        ...
        top: {
            ...
            _event: {
                ...
                initSceneData: function(eD) {
                    SetUserVisible_NiuShiBieYueYang(this, 2);
                ...
                mjhand: function(eD) {
                    InitUserHandUI_NiuShiBieYueYang(this, 2);
                },
                roundEnd: function() {
        ...
        left: {
            ...
            _event: {
                ...
                initSceneData: function(eD) {
                    SetUserVisible_NiuShiBieYueYang(this, 3);
                ...
                mjhand: function(eD) {
                    InitUserHandUI_NiuShiBieYueYang(this, 3);
                },
                roundEnd: function() {
        ...
        Button_kuaijie: {
            _run: function() {
                setWgtLayout(this, [this.width/1280, this.height/720], [0.94, 0], [0, 0]);
            },
            _click: function(btn) {
                var pos = btn.getPosition();
                MjClient.Scene.addChild(new NiuShiBieQuickChatLayer(pos));
            }
        },
        Button_mingpai: {
            _run: function() {
                setWgtLayout(this, [this.width/1280, this.height/720], [0.83, 0], [0, 0]);
            },
            _click: function() {
                ...
                if(pl.isMingCard) 
                {
                    MjClient.showMsg("每队只能有一个玩家“明牌”");
                    return;
                }

                if(pl.handCount <= 0) 
                {
                    MjClient.showMsg("您的队友已出完牌，不能“明牌”");
                    return;
                }
                
                if (mySelf.handCount <= 0 || mySelf.mjhand.length <= 0)
                {
                    MjClient.showMsg("您已出完牌，不能“明牌”");
                    return;
                }
        ...
        Button_sort: {
            _run: function() {
                setWgtLayout(this, [this.width/1280, this.height/720], [0.72, 0], [0, 0]);
            },
            _click: function(btn) {
                if (MjClient.playui.isFaPai) return;
        ...
        Button_recover: {
            _run: function() {
                setWgtLayout(this, [this.width/1280, this.height/720], [0.61, 0], [0, 0]);
            },
            _click: function(btn) {
                if (MjClient.playui.isFaPai) return;
                MjClient.playui.onClickLiPai(true);
            }
        },
        Button_tonghuashun: {
            _run: function() {
                setWgtLayout(this, [this.width/1280, this.height/720], [0.50, 0], [0, 0]);
            },
            _click: function() {
                if (MjClient.playui.isFaPai) return;
                MjClient.playui.putNiuShiBieTips(MjClient.majiang.CARDTPYE.tonghuashun);
            }
        },
        Button_510K: {
            _run: function() {
                setWgtLayout(this, [this.width/1280, this.height/720], [0.39, 0], [0, 0]);
            },
            _click: function() {
                if (MjClient.playui.isFaPai) return;
                MjClient.playui.putNiuShiBieTips(MjClient.majiang.CARDTPYE.f_510k);
            }
        },
        Button_score: {
            _run: function() {
                setWgtLayout(this, [this.width/1280, this.height/720], [0.28, 0], [0, 0]);
            },
            _click: function() {
...
//牛十别专有排序
 ...
 //
    ctor: function() {
        ...
        var playui = ccs.load(res.Play_NiuShiBieYueYang_json);
        ...
        this._btn510K = playui.node.getChildByName("Button_510K");
        this._btnTongHuaShun = playui.node.getChildByName("Button_tonghuashun");
        this._btnKuaiJie = playui.node.getChildByName("Button_kuaijie");
        this._btnLiPai = playui.node.getChildByName("Button_sort");
        this._btnRecover = playui.node.getChildByName("Button_recover");
...
PlayLayer_NiuShiBieYueYang.prototype.InitC_Data = function() {
...
PlayLayer_NiuShiBieYueYang.prototype.cannotOutCardGrey = function()
{
...
PlayLayer_NiuShiBieYueYang.prototype.recoverCannotOutCard = function()
{
    var children = this._downNode.children;
    for (var i = 0; i < children.length; i++)
    {
...
PlayLayer_NiuShiBieYueYang.prototype.clockNumberUpdate = function(node, endFunc)
{
    return arrowbkNumberUpdate(node, endFunc, 20);
}

PlayLayer_NiuShiBieYueYang.prototype.updateClockPosition = function(arrowNode)
{
    var tData = MjClient.data.sData.tData;
    var uids = tData.uids;
 ...
 * @return {String}
 */
PlayLayer_NiuShiBieYueYang.prototype.getGameInfoString = function(param)
{
    var tData = MjClient.data.sData.tData;
    var str = "";

    str += tData.areaSelectMode.teammode == 1 ? "摸队," : "铁队,";
    str += tData.areaSelectMode.zhuaweifen ? "抓尾分," : "";
    str += tData.areaSelectMode.sandaidui ? "三带对," : "";
    str += tData.areaSelectMode.feijidailiandui ? "飞机带连对" : "";
    str += "底分X" + (tData.areaSelectMode.niushibie_difen==30? "30/50":tData.areaSelectMode.niushibie_difen);
...
PlayLayer_NiuShiBieYueYang.prototype.showFlyCardAnim = function(flyNode,cardValue,UIoff)
{
...
PlayLayer_NiuShiBieYueYang.prototype.showHandCardBeiMian = function()
{
...
PlayLayer_NiuShiBieYueYang.prototype.hideHandCardBeiMian = function()
{
...
PlayLayer_NiuShiBieYueYang.prototype.CardLayoutRestore = function(node, off)
{
    cc.log("PlayLayer_NiuShiBieYueYang11==============");
    
    // 如果正在发牌 不排序
    if (MjClient.playui.isFaPai) return;
    
    cc.log("PlayLayer_NiuShiBieYueYang22==============");
...
PlayLayer_NiuShiBieYueYang.prototype.CardLayoutDesk = function(node,cards,off)
{
    //if(off != 0) return;
    ...
    if (cardType == CARDTPYE.shunzi || cardType == CARDTPYE.liandui || cardType == CARDTPYE.zhadan || cardType == CARDTPYE.tonghuashun) {
        var lastOutCard = uiOut[uiOut.length - 1];
        var cardTypeTietu = new ccui.ImageView("playing/niushibie/card_type_tietu.png");
        cardTypeTietu.setScale(Math.min(MjClient.size.width/1280,MjClient.size.height/720));
        cardTypeTietu.setAnchorPoint(cc.p(1,0));
        cardTypeTietu.setPosition(cc.p(lastOutCard.x + outSize.width * outScale / 2, lastOutCard.y - outSize.height * outScale / 2));
        node.addChild(cardTypeTietu,100,"cardTypeTietu");

        var typeLabel = new ccui.Text();
        if(MjClient.getAppType() == MjClient.APP_TYPE.QXYYQP || MjClient.getAppType() == MjClient.APP_TYPE.YLHUNANMJ) {//岳阳同一使用方正兰亭
            typeLabel.setFontName("fonts/lanting.TTF");
        }
        typeLabel.setFontSize(22);
        typeLabel.setColor(cc.color(0xfe,0xef,0x96));
        typeLabel.setAnchorPoint(cc.p(0.5,0.5));
        typeLabel.setTextHorizontalAlignment(cc.TEXT_ALIGNMENT_CENTER);
        typeLabel.setPosition(cc.p(cardTypeTietu.getContentSize().width/2,cardTypeTietu.getContentSize().height/2))
        cardTypeTietu.addChild(typeLabel)

        switch (cardType)
        {
            case CARDTPYE.shunzi:
                typeLabel.setString(uiOut.length + "张顺子");
                break;
            case CARDTPYE.liandui:
                typeLabel.setString(uiOut.length/2 + "连对");
                break;
            case CARDTPYE.zhadan:
                typeLabel.setString(uiOut.length + "炸");
                break;
            case CARDTPYE.tonghuashun:
                typeLabel.setString(uiOut.length + "张同花顺");
                break;
        }
    }
};
...
//横向摆放《正常》
PlayLayer_NiuShiBieYueYang.prototype.horSort = function(node, off)
{
    var pl; //player 信息
    ...
    for(var i = 0; i < children.length; i++) //children 为 "down" 节点下的字节点
    {
        ...
        if(ci.name == "mjhand")
        {
            ...
            uistand.push(ci);
            var masklayer = ci.getChildByName("masklayer");
...
///////////////////////////////////////////////////////////////////////////////////////
    ...
    {//只有自己处理理牌逻辑
        ...
        for(var i = 0; i < this._LiPaiCards.length; i++)
        {
            ...
            {
                if( mjhandCopy[j] == Math.abs(this._LiPaiCards[i])){
        ...
        for(var i = 0; i < this._LiPaiCards.length; i++)
        {
            for(var j = 0; j < uistand.length; j++)
            {
                if( uistand[j].tag == Math.abs(this._LiPaiCards[i]) ){
                    var masklayer = uistand[j].getChildByName("masklayer");
                    if (!masklayer)
                    {
                        masklayer = new ccui.ImageView();
                        masklayer.name = "masklayer";
                        masklayer.setAnchorPoint(0,0)
                        uistand[j].addChild(masklayer);
                    }
                    masklayer.visible = true;
                    var textureSrc = this._LiPaiCards[i] > 0 ?
                        "playing/niushibie/maskgreen.png":"playing/niushibie/maskred.png";
                    masklayer.loadTexture(textureSrc)
...
//纵向摆放
PlayLayer_NiuShiBieYueYang.prototype.verSort = function(node, off)
{
    if(off != 0)
    {
        return;
...
PlayLayer_NiuShiBieYueYang.prototype.changePosition = function(msg,flyNode,oldUids)
{
    if (!msg)return;
...
//处理明牌
PlayLayer_NiuShiBieYueYang.prototype.dealMingPai = function(node, msgary, UIOff, needSound)
{   
    // 回放情形下，不需展示明牌
    if (MjClient.rePlayVideo != -1)
        return;
...
//展示队友手牌
PlayLayer_NiuShiBieYueYang.prototype.showPartnerHandCards = function(node,cards)
{   
    // 回放情形下，不需展示
    if (MjClient.rePlayVideo != -1)
        return;
...
PlayLayer_NiuShiBieYueYang.prototype.dealPartnerPutCards = function(node, putCards)
{   
...
PlayLayer_NiuShiBieYueYang.prototype.dealPKPutCards = function(node, msg, UIOff)
{
    // 回放情形下，不需处理
    if (MjClient.rePlayVideo != -1)
        return;
...
PlayLayer_NiuShiBieYueYang.prototype.CardLayoutPartnerCards = function(node)
{
    if(MjClient.rePlayVideo != -1)// 表示回放
    {
        MjClient.sortClassType = 0;
...
PlayLayer_NiuShiBieYueYang.prototype.clearPartnerUI = function(node)
{
    // 回放情形下，不需处理
    if (MjClient.rePlayVideo != -1)
        return;
...
PlayLayer_NiuShiBieYueYang.prototype.setPlayerZhuaFen = function(node,off_1,off_2)
{
...
PlayLayer_NiuShiBieYueYang.prototype.UpdataNiuShiBieTips = function(){
    var sData = MjClient.data.sData;
    var tData = sData.tData;
    ...
    function __findCardByType(tmpHand, type, areaSelectMode)
    {
        ...
        while(1)
        {
            ...
            for(var i = 0; i < curAry.length; i++)
            {
                ...
                //ret.push(curAry[i])//不全部放在一起了，注释掉
            }
            ret.push(findcardAry[findcardAry.length-1]);
        }       
        return ret;     
    }
    ...
    var tmp_510kTipsAry = []
    var _510kTipsAry_f = __findCardByType(tmpHand, MjClient.majiang.CARDTPYE.f_510k, tData.areaSelectMode);
    var _510kTipsAry_z = __findCardByType(tmpHand, MjClient.majiang.CARDTPYE.z_510k, tData.areaSelectMode); 
    for(var i = 0 ; i < _510kTipsAry_z.length; i++)
    {
        _510kTipsAry_f.push(_510kTipsAry_z[i]);
    }
    for(var i = 0 ; i < _510kTipsAry_f.length; i++)
    {
        tmp_510kTipsAry.push(_510kTipsAry_f[i]);
    }
    if (tmp_510kTipsAry.length > 0)
        MjClient.playui._510kTipsAry.push(tmp_510kTipsAry[0]);//只要最大一个
     
    tmpHand = pSelf.mjhand.slice();
    MjClient.playui._TongHuaShunTipsAry = [];

    var _tonghuashun = __findCardByType(tmpHand, MjClient.majiang.CARDTPYE.tonghuashun, tData.areaSelectMode);

    if (_tonghuashun.length > 0)
        MjClient.playui._TongHuaShunTipsAry.push(_tonghuashun[0]);//只要最大一个

    MjClient.playui._510kTipsIndex = 0;
    MjClient.playui._TongHuaShunTipsIndex = 0;
}

PlayLayer_NiuShiBieYueYang.prototype.clearDeskCard = function(node)
{
    var children = node.children;
    for (var i = 0; i < children.length; i++)
    {
...
PlayLayer_NiuShiBieYueYang.prototype.putNiuShiBieTips = function(cardType){
...
PlayLayer_NiuShiBieYueYang.prototype.onClickLiPai = function(bRecover)
{
    MjClient.playui._sortType += 1;
    if (MjClient.playui._sortType>3)MjClient.playui._sortType = 0;
...
PlayLayer_NiuShiBieYueYang.prototype._sortCardByType = function(){
    ...
    {//先看有没有提起的牌
        ...
        ////////////////////////////
        var colorIdx = 
                    (MjClient.playui._LiPaiCards.length == 0 || 
                    MjClient.playui._LiPaiCards[0] < 0)? 1:-1;//用作区分颜色，使用理牌牌值时注意取绝对值
        /////////////////////////////
        ...
        fCard = fCard.concat(MjClient.playui._LiPaiCards);
    }
    else{
        fCard = MjClient.playui._LiPaiCards;
        MjClient.showToast("请选中至少一张牌来整理");
    }
    /*else if (this._sortType == 1)
    {
        var fCard_tonghuashun = __findCardByType(tmpHand,MjClient.majiang.CARDTPYE.tonghuashun, tData.areaSelectMode);
        if (!fCard_tonghuashun || fCard_tonghuashun.length <=0)return [];
        var fCard_f510k = __findCardByType(tmpHand,MjClient.majiang.CARDTPYE.f_510k);
        var fCard_z510k =  __findCardByType(tmpHand,MjClient.majiang.CARDTPYE.z_510k, tData.areaSelectMode);
        if ((!fCard_z510k || fCard_z510k.length <=0) && (!fCard_f510k || fCard_f510k.length <=0) )return [];
        fCard = fCard.concat(fCard_tonghuashun);
        fCard = fCard.concat(fCard_f510k);
        fCard = fCard.concat(fCard_z510k);
    }
    else if (this._sortType == 2)
    {//同花顺排前面
        fCard = __findCardByType(tmpHand,MjClient.majiang.CARDTPYE.tonghuashun, tData.areaSelectMode);
    }
    else if (this._sortType == 3)
    {//510k排前面
        fCard = __findCardByType(tmpHand,MjClient.majiang.CARDTPYE.f_510k);
        var zh_510k =  __findCardByType(tmpHand,MjClient.majiang.CARDTPYE.z_510k, tData.areaSelectMode);
        fCard = fCard.concat(zh_510k);
    }*/
...
PlayLayer_NiuShiBieYueYang.prototype.resetRoundData = function()
{
    //客户端数据
    MjClient.playui._510kTipsAry=[];
    MjClient.playui._TongHuaShunTipsAry=[];
...
PlayLayer_NiuShiBieYueYang.prototype.ClearLiPai = function(uid, putcards)
{
    ...
    var sData = MjClient.data.sData;
    var pl = sData.players[uid];
    var mjhandCopy = pl.mjhand.slice();
    for(var i = 0; i < this._LiPaiCards.length; i++)
    {
        for(var j = 0; j < mjhandCopy.length; j++)
        {
    ...
    for(var i=0; i < putcards.length; i++){
        ...
        //先删除非理牌数组
        for (var j = 0; j < mjhandCopy.length; j++) {
            if( mjhandCopy[j] == putcards[i] ){
                mjhandCopy.splice(j, 1);
                bDelLiPai = true;
                break;
            }
        }
        if (bDelLiPai) continue;
        //非理牌数组没有，才删除理牌数组
        for (var j = 0; j < MjClient.playui._LiPaiCards.length; j++) {
            if( Math.abs(MjClient.playui._LiPaiCards[j]) == putcards[i] ){
...
PlayLayer_NiuShiBieYueYang.prototype.setDownMenusEnabled = function()
{
    var tData = MjClient.data.sData.tData;
    var enabled = !(tData.tState == TableState.waitJoin || tData.tState == TableState.roundFinish || tData.tState == TableState.waitReady || MjClient.playui.isFaPai);
    var downMenus = [
        MjClient.playui._btnScanScore,
        MjClient.playui._btnMingPai,
        MjClient.playui._btn510K,
        MjClient.playui._btnTongHuaShun,
        MjClient.playui._btnKuaiJie,
        MjClient.playui._btnLiPai,
        MjClient.playui._btnRecover,
    ];
...
PlayLayer_NiuShiBieYueYang.prototype.reLoadOptBtnRes = function() {
    //出牌按钮
