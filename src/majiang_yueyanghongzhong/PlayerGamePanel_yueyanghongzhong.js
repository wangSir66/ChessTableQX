...
var _isShowShaiziAni_yueyanghongzhong = false; //为了控制mjhand之后播骰子动画时newCard的状态显示
//向服务器发送 过消息
MjClient.MJPass2NetForyueyanghongzhong = function()
{
   // console.log(">>>>>>>>>普通  过 <<<<<<<<");
    cc.log("====================send======pass=====");
...
var showShaiziAni_yueyanghongzhong = false
function showShaiziAni_yueyanghongzhong_old(poff)
{
    if(poff == 0) {
        ...
        if(MjClient.rePlayVideo != -1)//回放
        {
            for (var off = 0; off < 4; off++) {
                ...
                InitUserHandUI_yueyanghongzhong(_node, off);
            }
            playEffect("shuffle");
        ...
        _isShowShaiziAni_yueyanghongzhong = true;
        ...
        firstFrame.runAction(cc.sequence(playSoundFunc, animate,showPonitFunc,cc.delayTime(0.5),cc.callFunc(function(){
            //发牌
            _isShowShaiziAni_yueyanghongzhong = false;
...
function updateHeadUI_yueyanghongzhong(node, off)
{      
    cc.log('updateHeadUI_yueyanghongzhong', off)
    var pl = getUIPlayer(off);
    if(!pl) return;
    showHandCard_yueyanghongzhong(node, off);
    MjClient.playui.CardLayoutRestore(node, off);
    cc.log('updateHeadUI_yueyanghongzhong update success', off)
...
function SetUserVisible_yueyanghongzhong(node, off)
{
    if (_isShowShaiziAni_yueyanghongzhong)  // 解决摇骰子时断线重连调用本函数，会手牌重复的bug by cyc
        return;
...
function showHandCard_yueyanghongzhong(node, off)
{
    var sData = MjClient.data.sData;
    var tData = sData.tData;
    var pl = getUIPlayer(off);
...
function InitUserHandUI_yueyanghongzhong(node, off)
{
    var sData = MjClient.data.sData;
    var tData = sData.tData;
    var pl = getUIPlayer(off);
...
function initFlower_yueyanghongzhong() {
    initFlower(false, false);
}


var PlayLayer_yueyanghongzhong = cc.Layer.extend({
    jsBind: {
        _event: {
            mjhand: function() {
            ...
            roundEnd: function() {
                ...
                function showEndCards()
                {
                    ...
                    if (getUIPlayer(0).mjState == TableState.roundFinish) {
                        self.addChild(new EndOneView_yueyanghongzhong(),500);
                    }
                }
                ...
                function delayExe()
                {
                    if(MjClient.rePlayVideo == -1)//正常游戏才显示摊牌 ,//非3D模式
                    {
                        //弹小结算之前显示其他人牌
...
/*                MjClient.Scene.addChild(new HAHZ_showCardLayer(showCards,function(){
      ...
      //               mjhand:function()
      //               {
						// if (!showShaiziAni_yueyanghongzhong)
      //                   	this.visible = true;
      //               },
      //               initSceneData:function()
      //               {
      ...
      //           }
        ...
        wait: {
            ...
            _event: {
                ...
                initSceneData: function(eD) {
                    ...
                    this.getChildByName('wxinvite').visible = IsInviteVisible();
                ...
                removePlayer: function(eD) {
                    ...
                    this.getChildByName('wxinvite').visible = true;
                    this.getChildByName('delroom').visible = IsInviteVisible() || isWaitReady;
                    this.getChildByName('backHomebtn').visible = IsInviteVisible() || isWaitReady;
                }
            }
        ...
        BtnPutCard:{ //add by  sking for put card button
            ...
            _event:{
                ...
                waitPut: function() {
                    if (_isShowShaiziAni_yueyanghongzhong) return;
        ...
        down: {
            ...
            _event: {
                ...
                initSceneData: function(eD) {
                    SetUserVisible_yueyanghongzhong(this, 0);
                ...
                mjhand: function(eD) {
					if (showShaiziAni_yueyanghongzhong){
                    	showShaiziAni_yueyanghongzhong(0);
						...
						InitUserHandUI_yueyanghongzhong(this, 0); 
                        if (MjClient.data.sData.tData.areaSelectMode.isOpenTingTip) {
                            var pl = getUIPlayer(0);
                            if (pl && getOffByIndex(MjClient.data.sData.tData.curPlayer) != 0) {
                                var tingSet = calTingSet(pl.mjhand, MjClient.data.sData.tData.hunCard);
                ...
                MJPeng: function(eD) {
                    ...
                    updateHeadUI_yueyanghongzhong(this, 0);
        ...
        right: {
            ...
            _event: {
                ...
                initSceneData: function(eD) {
                    SetUserVisible_yueyanghongzhong(this, 1);
                },
                addPlayer: function(eD) {
                    SetUserVisible_yueyanghongzhong(this, 1);
                },
                ...
                mjhand: function(eD) {
                    if (!showShaiziAni_yueyanghongzhong)
						InitUserHandUI_yueyanghongzhong(this, 1);
                },
                roundEnd: function() {
                ...
                MJPeng: function(eD) {
                    if (MjClient.rePlayVideo != -1)
                        ...
                        updateHeadUI_yueyanghongzhong(this, 1);
                    setUserOffline(this, 1);
                },
                MJHu: function(eD) {
        ...
        top: {
            ...
            _event: {
                ...
                initSceneData: function(eD) {
                    SetUserVisible_yueyanghongzhong(this, 2);
                },
                addPlayer: function(eD) {
                    SetUserVisible_yueyanghongzhong(this, 2);
                },
                ...
                mjhand: function(eD) {
                    if (!showShaiziAni_yueyanghongzhong)
						InitUserHandUI_yueyanghongzhong(this, 2);
                },
                roundEnd: function() {
                ...
                MJPeng: function(eD) {
                    if (MjClient.rePlayVideo != -1)
                        ...
                        updateHeadUI_yueyanghongzhong(this, 2);
                    setUserOffline(this, 2);
                },
                MJHu: function(eD) {
        ...
        left: {
            ...
            _event: {
                ...
                initSceneData: function(eD) {
                    SetUserVisible_yueyanghongzhong(this, 3);
                },
                addPlayer: function(eD) {
                    SetUserVisible_yueyanghongzhong(this, 3);
                },
                ...
                mjhand: function(eD) {
                    if (!showShaiziAni_yueyanghongzhong)
						InitUserHandUI_yueyanghongzhong(this, 3);
                },
                roundEnd: function() {
                ...
                MJPeng: function(eD) {
                    if (MjClient.rePlayVideo != -1)
                        ...
                        updateHeadUI_yueyanghongzhong(this, 3);
                    setUserOffline(this, 3);
                },
                MJHu: function(eD) {
        ...
        eat: {
            ...
            guo: {
                ...
                _touch: function(btn, eT) {
                    if (eT == 2)
                    {
                        MjClient.MJPass2NetForyueyanghongzhong();
                    }
                },
                bgimg: {
                    _run: function() {
            ...
            changeui: {
                ...
                changeuibg: {
                    ...
                    guobg: {
                        guo: {
                            _touch: function(btn, eT) {
                                if (eT == 2) MjClient.MJPass2NetForyueyanghongzhong();
                            }
                        },
                        fanhui: {
                            _touch: function(btn, et) {
    ...
    ctor: function() {
        this._super();
        var playui = ccs.load(res.Play_YYHZ_json);
...
PlayLayer_yueyanghongzhong.prototype.CardLayoutRestore = function(node, off, isNewCard)
{
...
// 判断吃碰杠胡的状态
PlayLayer_yueyanghongzhong.prototype.EatVisibleCheck = function()
{
    var eat = MjClient.playui.jsBind.eat;
    ...
    if(tData.tState == TableState.waitPut && pl.mjState == TableState.waitPut)
    {
        if(IsTurnToMe())
        {
            ...
            if(vnode.length > 0)
            {
                if(!must_hu) vnode.push(eat.guo._node);
                eat.ting._node.visible = false;
...
function addTingCardsSignYYHZ(children, tingCard) {
    for (var i = 0; i < children.length; i++) {
        if (children[i].name == "mjhand")
        {
...
function removeTingCardsSignYYHZ(children) {
    cc.log("get in ---------");
    for (var i = 0; i < children.length; i++) {
        if (children[i].name == "mjhand") {
...
function getTingCardsYYHZ(children, card) {
    var canTingCards = {};
