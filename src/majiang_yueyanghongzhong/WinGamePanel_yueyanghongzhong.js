...
function SetEndOneUserUI_yueyanghongzhong(node,off)
{
...
var EndOneView_yueyanghongzhong = cc.Layer.extend({
	jsBind:{
		block: {
		...
		head0:{
		   ...
		   _run:function(){ SetEndOneUserUI_yueyanghongzhong(this,0); },
		...
		,head1:{ 
		  ...
		  _run:function(){ SetEndOneUserUI_yueyanghongzhong(this,1); }
		}
		...
		,head2:{ 
		   ...
		   _run:function(){ SetEndOneUserUI_yueyanghongzhong(this,2); }
		}
		,head3:{
			 head:
			 {
			...
			_run:function(){ SetEndOneUserUI_yueyanghongzhong(this,3); }
			},
            count_down:{
                _visible :function()
                {
    ...
    ctor:function () {
        this._super();
        var endoneui = ccs.load(res.EndOne_YYHZ_json);
