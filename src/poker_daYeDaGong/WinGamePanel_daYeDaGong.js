function SetEndOneUserUI_daYeDaGong(node, off) {
    ...
    node.getChildByName("text_shuyingfen").setString("输赢倍")
    ...
    _huapai0.setVisible(false);
    _huapai1.setVisible(false);
...
var EndOneView_daYeDaGong = cc.Layer.extend({
    jsBind: {
        block: {
            _layout: [
                [1, 1],
        ...
        back: {
                ...
                _click: function (btn, eT) {
                    ...
                    if(!tData.fieldId){
                        if (sData.tData.roundNum <= 0)
                            MjClient.endoneui.getParent().addChild(new GameOverLayer_DaYeDaGong(),500);
                    }
                    if(!tData.fieldId){
            ...
            image_player_myself: {
                _run: function() {
                    SetEndOneUserUI_daYeDaGong(this, MjClient.endoneui.offs[0]);
                }
            },
            image_player_1: {
                _run: function() {
                    SetEndOneUserUI_daYeDaGong(this, MjClient.endoneui.offs[1]);
                },
            },
            image_player_2: {
                _run: function() {
                    SetEndOneUserUI_daYeDaGong(this, MjClient.endoneui.offs[2]);
                }
            },
            image_player_3: {
                _run: function() {
                    SetEndOneUserUI_daYeDaGong(this, MjClient.endoneui.offs[3]);
                }
            },
        }
    },
    ctor: function() {
        ...
        var endoneui = ccs.load("endOne_DaYeDaGong.json");
