...
function SetUserVisible_sanDaHaYueyang(node, off) {
    ...
    if (pl) {
        ...
        InitUserHandUI_sanDaHaYueyang(node, off);
    } else {
        name.visible = false;
        coin.visible = false;
...
function InitUserHandUI_sanDaHaYueyang(node, off) {
...
function cardsSort_sanDaHaYueyang(cards) {
    var pointCounts = {};
...
var PlayLayer_sanDaHaYueyang = cc.Layer.extend({
    _btnPutCard: null,
    jsBind: {
        _event: {
            mjhand: function() {
            ...
            roundEnd: function() {
                ...
                function delayExe() {
                    ...
                    self.addChild(new EndOneView_sanDaHaYueyang(), 500);
                }
        ...
        BtnPutCard: {
            ...
            _click: function(btn) {
                ...
                cardsSort_sanDaHaYueyang(MjClient.selectCards_card);
        ...
        down: {
            ...
            _event: {
                ...
                initSceneData: function(eD) {
                    SetUserVisible_sanDaHaYueyang(this, 0);
                ...
                mjhand: function(eD) {
                    InitUserHandUI_sanDaHaYueyang(this, 0);
                },
                roundEnd: function() {
        ...
        right: {
            ...
            _event: {
                ...
                initSceneData: function(eD) {
                    SetUserVisible_sanDaHaYueyang(this, 1);
                },
                addPlayer: function(eD) {
                    SetUserVisible_sanDaHaYueyang(this, 1);
                },
                ...
                mjhand: function(eD) {
                    InitUserHandUI_sanDaHaYueyang(this, 1);
                },
                roundEnd: function() {
        ...
        top: {
            ...
            ready: {
                _run: function() {
                    setWgtLayout(this, [0.084, 0.094], [0.5, 0.5], [-2, 0]);
            ...
            stand: {
                _run: function() {
                    setWgtLayout(this, [0, 0.13],  [0, 1], [2, -0.5]);
                    this.setVisible(false);
                }
            },
            ...
            _event: {
                ...
                initSceneData: function(eD) {
                    SetUserVisible_sanDaHaYueyang(this, 2);
                },
                addPlayer: function(eD) {
                    SetUserVisible_sanDaHaYueyang(this, 2);
                },
                ...
                mjhand: function(eD) {
                    InitUserHandUI_sanDaHaYueyang(this, 2);
                },
                roundEnd: function() {
        ...
        left: {
            ...
            //     },
            //     initSceneData: function(eD) {
            //         SetUserVisible_sanDaHaYueyang(this, 3);
            //     },
            //     addPlayer: function(eD) {
            //         SetUserVisible_sanDaHaYueyang(this, 3);
            //     },
            ...
            //     },
            //     mjhand: function(eD) {
            //         InitUserHandUI_sanDaHaYueyang(this, 3);
            //     },
            //     roundEnd: function() {
    ...
    ctor: function() {
        this._super();
        var playui = ccs.load("Play_sanDaHaYueyang.json");
...
PlayLayer_sanDaHaYueyang.prototype.getTouchListener_card=function()
{
    return{
        ...
        onTouchBegan: function (touch, event) {
            ...
            bTouchMove = false;
            if(MjClient.gameType == MjClient.GAME_TYPE.YUE_YANG_SAN_DA_HA)
            {
...
PlayLayer_sanDaHaYueyang.prototype.reConnectShowDeskCard = function() {
    var tData = MjClient.data.sData.tData;
...
PlayLayer_sanDaHaYueyang.prototype.cannotOutCardGrey = function() {
...
PlayLayer_sanDaHaYueyang.prototype.recoverCannotOutCard = function() {
    var children = this._downNode.children;
    for (var i = 0; i < children.length; i++) {
        if (children[i].name != "mjhand")
            continue;
...
PlayLayer_sanDaHaYueyang.prototype.clockNumberUpdate = function(node, endFunc) {
    return arrowbkNumberUpdate(node, endFunc);
}

PlayLayer_sanDaHaYueyang.prototype.updateClockPosition = function(arrowNode) {
    var tData = MjClient.data.sData.tData;
    var uids = tData.uids;
 ...
 * @return {String}
 */
PlayLayer_sanDaHaYueyang.prototype.getGameInfoString = function(param) {
    var tData = MjClient.data.sData.tData;
    var str = "";

    str += tData.areaSelectMode.SAN_DA_HA_shuaiPaiLimitTwoCard ? "庄家甩牌最多两张," : "";
    str += tData.areaSelectMode.SAN_DA_HA_allowTuoLaJiXiaoDui ? "允许拖拉机消对," : "";
...
PlayLayer_sanDaHaYueyang.prototype.updateOperateBtnPosition = function() {
...
// 拖拉机动画
PlayLayer_sanDaHaYueyang.prototype.playCardAni_liandui = function() {
...
// 闲家得分达到条件时动画、投降
PlayLayer_sanDaHaYueyang.prototype.playWinAni = function(winType) {
...
// 刷新得分栏
PlayLayer_sanDaHaYueyang.prototype.refreshScoreBanner = function() {
    var tData = MjClient.data.sData.tData;
...
// 判断是否有不同意投降的玩家
PlayLayer_sanDaHaYueyang.prototype.haveNotAgreeTouXiang = function()
{
    var sData = MjClient.data.sData;
    var tData = MjClient.data.sData.tData;
...
// 重置玩家同意投降状态
PlayLayer_sanDaHaYueyang.prototype.initAgreeTouXiangStatus = function()
{
    var sData = MjClient.data.sData;
    var tData = MjClient.data.sData.tData;
    for (var i = 0; i < tData.uids.length; i++)
...
PlayLayer_sanDaHaYueyang.prototype.showWaitTip = function(bMaiPai) {
    var sData = MjClient.data.sData;
    var tData = sData.tData;
...
// 显示各玩家叫分
PlayLayer_sanDaHaYueyang.prototype.showJiaoFenTag = function(off) {
    var tData = MjClient.data.sData.tData;
...
// 隐藏各玩家叫分
PlayLayer_sanDaHaYueyang.prototype.hideJiaoFenTag = function() {
...
// 显示叫分面板
PlayLayer_sanDaHaYueyang.prototype.showJiaoFenPanel = function() {
    if (MjClient.rePlayVideo != -1)
    {
        MjClient.playui.jsBind.panel.jiaoFenPanel._node.setVisible(false);
        return;
...
// 把底牌添加到手牌中
PlayLayer_sanDaHaYueyang.prototype.addDiPaiToHand = function() {
    var tData = MjClient.data.sData.tData;
...
// 从手牌中移除埋的牌
PlayLayer_sanDaHaYueyang.prototype.removeMaiPaiFromHand = function() {
    var tData = MjClient.data.sData.tData;
    var off = getOffByIndex(tData.curPlayer);
...
// 显示投降同意选择框
PlayLayer_sanDaHaYueyang.prototype.showTouXuangDialog = function() {
     if (MjClient.rePlayVideo != -1)
        return;
...
// 显示叫主面板
PlayLayer_sanDaHaYueyang.prototype.showJiaoZhuPanel = function() {
    var tData = MjClient.data.sData.tData;
...
// 显示埋牌、投降按扭
PlayLayer_sanDaHaYueyang.prototype.showMaiPaiBtn = function() {
    var tData = MjClient.data.sData.tData;
...
// 显示上一轮面板
PlayLayer_sanDaHaYueyang.prototype.showShangYiLunPanel = function(shangYiLunPanel) {
    var tData = MjClient.data.sData.tData;
...
// 显示查看底牌面板
PlayLayer_sanDaHaYueyang.prototype.showDiPaiPanel = function(diPaiPanel) {
    var tData = MjClient.data.sData.tData;
...
// 显示查牌面板
PlayLayer_sanDaHaYueyang.prototype.showChaPaiPanel = function(chaPaiPanel) {
    var tData = MjClient.data.sData.tData;
    var records = tData.putCardsRecord;
    ...
    var posIndexs = [2,1,0];
    var posResources = ["pos_shangjia.png","pos_xiajia.png","pos_benjia.png"];
...
// 显示得分栏上的具体分牌
PlayLayer_sanDaHaYueyang.prototype.showScoreCards = function(panel, cards) {
...
// 给手牌中的主牌设置角标
PlayLayer_sanDaHaYueyang.prototype.setCardSprite_ZhuTag = function(node) {
    var tData = MjClient.data.sData.tData;
...
// 计算各牌色数量
PlayLayer_sanDaHaYueyang.prototype.getCardNumByColor = function(cards, colorIndex) {
    var num = 0;
    var types = [1, 2, 3, 0, 4]
    for (var i = 0; i < cards.length; i++) {
...
// 清空桌面
PlayLayer_sanDaHaYueyang.prototype.clearDesk = function() {
    cc.log("clearDesk")
...
PlayLayer_sanDaHaYueyang.prototype.CardLayoutRestore = function(node, off) {
    cc.log("横向排序 off=" + off);
...
PlayLayer_sanDaHaYueyang.prototype.CardLayoutDesk = function(node, cards, off) {
    //if(off != 0) return;
    var children = node.children;
...
//横向摆放《正常》
PlayLayer_sanDaHaYueyang.prototype.horSort = function(node, off) {
    var pl; //player 信息
    ...
    if (off == 0) //自己或者对家
    {
        ...
        if(orders.length>22)
        {
            var num = orders.length - 22;//超出第一层手牌的数量
            for(var i = num; i < orders.length; i++)//第一层手牌排序
            {
                var ci = orders[i];
                ci.x = startX;
                ci.y = standUI.y;
            ...
            for(var i = 0; i < num; i++)//第二层手牌排序
            {
                var ci = orders[i];
                ci.x= startX-width*num;
                startX += width;
                ci.y = standUI.y*2;
                ci.zIndex = 100+i+num;
                ci.showWidth = width;
...
PlayLayer_sanDaHaYueyang.prototype.DealCardEffect = function(uid, off)
{
    var tData = MjClient.data.sData.tData;
