...
function SetEndOneUserUI_wutaikoudian(node,off)
{
...
var EndOneView_wutaikoudian = cc.Layer.extend({
	jsBind:{
		block: {
		...
		head0:{
		   ...
		   _run:function(){ SetEndOneUserUI_wutaikoudian(this,0); },
		...
		,head1:{ 
		  ...
		  _run:function(){ SetEndOneUserUI_wutaikoudian(this,1); }
		}
		...
		,head2:{ 
		   ...
		   _run:function(){ SetEndOneUserUI_wutaikoudian(this,2); }
		}
		,head3:{
			 head:
			 {
			...
			_run:function(){ SetEndOneUserUI_wutaikoudian(this,3); }
			},
            count_down:{
                _visible :function()
                {
    ...
    ctor:function () {
        this._super();
        var endoneui = ccs.load("endOne_wutaikoudian.json");
