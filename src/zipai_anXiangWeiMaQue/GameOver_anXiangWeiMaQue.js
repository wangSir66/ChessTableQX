function addWxHeadToEndUI_anXiangWeiMaQue(node, off) {
...
function SetGameOverLayer_anXiangWeiMaQue(node,off,isNewUi){
    ...
    setDismissTypeImg(pl,node,0.5,0.12,"chang");
    var uidSelf = SelfUid();
    var MaxWinAll=0;
    var MaxDianPao=0;
    ...
    addWxHeadToEndUI_anXiangWeiMaQue(wxNode,off);
    ...
    var textFileName = scoreContnet >= 0 ? "gameOver/pjjs_24.png" : "gameOver/pjjs_29.png";
    ...
    var showRoomStatistics = function(node,showList,data){
        // roomStatistics [] // 胡牌 自摸 次数统计
        var showStatistics = {"huCount":0,"zmCount":1};
    ...
    //
    showRoomStatistics(textNode,["huCount","zmCount"],pl.roomStatistics);
}

var GameOverLayer_anXiangWeiMaQue = cc.Layer.extend({
    sprite:null,
    jsBind:{
        back:{
            close :{
    ...
    ctor:function () {
        this._super();
        var endallui = ccs.load("endAll_anXiangWeiMaQue.json");
        ...
        for(var i = 0 ; i < playerCount ; i++){
            ...
            SetGameOverLayer_anXiangWeiMaQue(clone,i, false);
