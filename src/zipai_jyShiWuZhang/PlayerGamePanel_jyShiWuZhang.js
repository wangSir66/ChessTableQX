...
function SetUserVisible_jyShiWuZhang(node, off){
    ...
    if(pl){
        ...
        //InitUserHandUI_jyShiWuZhang(node, off);
...
function InitUserHandUI_jyShiWuZhang(node, off){
...
function getOffIndex_jyShiWuZhang(){
...
var PlayLayer_jyShiWuZhang = cc.Layer.extend({
    jsBind: {
        _event: {
        ...
        down: {
            ...
            eatNode: {
                ...
                _event:{
                    EZP_layout:function(){
                        var layoutType = util.localStorageEncrypt.getNumberItem(MjClient.KEY_QXYZ_LAYOUT_SELECT,0);
                        if(layoutType == 0)
                        {
                            btnOff_x = 3;
                        }else{
                        ...
                        // if(MjClient.getAppType() == MjClient.APP_TYPE.YLHUNANMJ || MjClient.getAppType() == MjClient.APP_TYPE.QXSYDTZ){
            ...
            _event: {
                ...
                initSceneData: function(eD) {
                    ...
                    SetUserVisible_jyShiWuZhang(this, 0);
                    InitUserHandUI_jyShiWuZhang(this, 0);
        ...
        xing: {
            ...
            _event: {
                ...
                initSceneData: function(eD) {
                    if(MjClient.MaxPlayerNum_paohuzi == 4) {
                        SetUserVisible_jyShiWuZhang(this, 1);
                        InitUserHandUI_jyShiWuZhang(this, 1);
        ...
        right: {
                ...
                zhuang: {
                    ...
                    _event: {
                        waitPut: function() {
                            if(MjClient.playui.isChangeUIWith2Player())
                                return;
                            showUserZhuangLogo_paohuzi(this, getOffIndex_jyShiWuZhang());
                        },
                        initSceneData: function() {
                            if(MjClient.playui.isChangeUIWith2Player())
                                return;
                            if (IsArrowVisible_paohuzi()) showUserZhuangLogo_paohuzi(this,getOffIndex_jyShiWuZhang());
                        },
                        mjhand: function(){
                            if(MjClient.playui.isChangeUIWith2Player())
                                return;
                    ...
                    chattext: {
                        _event: {
                            MJChat: function(msg) {
                                if(MjClient.playui.isChangeUIWith2Player())
                                    return;
                                showUserChat_paohuzi(this,getOffIndex_jyShiWuZhang(), msg);
                            },
                            playVoice: function(voicePath) {
                                if(MjClient.playui.isChangeUIWith2Player())
                                    return;
                                MjClient.data._tempMessage.msg = voicePath;
                                showUserChat_paohuzi(this, getOffIndex_jyShiWuZhang(), MjClient.data._tempMessage);
                            }
                        }
                    }
                },
                _click: function(btn) {
                    showPlayerInfo_paohuzi(getOffIndex_jyShiWuZhang(), btn);
                },
                _event: {
                    loadWxHead: function(d) {
                        if(MjClient.playui.isChangeUIWith2Player())
                            return;
                        setWxHead_paohuzi(this, d, getOffIndex_jyShiWuZhang());
                    },
                    addPlayer: function(eD) {
                        if(MjClient.playui.isChangeUIWith2Player())
                            return;
                        showFangzhuTagIcon_paohuzi(this,getOffIndex_jyShiWuZhang());
                    },
                    removePlayer: function(eD) {
                        if(MjClient.playui.isChangeUIWith2Player())
                            return;
                    ...
                    _event:{
                        ...
                        initSceneData:function(){
                            if(MjClient.playui.isChangeUIWith2Player())
                                return;
                            this.visible = true;
                            var huXi = UpdateHuXi_paohuzi(getOffIndex_jyShiWuZhang());
                            if(!IsArrowVisible_paohuzi()){
                                huXi = 0;
                            }
                            return this.setString(huXi + "胡息");
                ...
                timeImg:{
                    ...
                    _event:{
                        initSceneData: function(eD) {
                            if(MjClient.playui.isChangeUIWith2Player())
                                return;
                            this.visible = curPlayerIsMe_paohuzi(getOffIndex_jyShiWuZhang());
                        },
                        mjhand: function(eD) {
                            if(MjClient.playui.isChangeUIWith2Player())
                                return;
                        ...
                        // onlinePlayer: function(eD) {
                        //     this.visible = curPlayerIsMe_paohuzi(getOffIndex_jyShiWuZhang()) && IsArrowVisible_paohuzi();
                        // },
                        waitPut: function(eD) {
                            if(MjClient.playui.isChangeUIWith2Player())
                                return;
                    ...
                    time:{
                        ...
                        _event: {
                            initSceneData: function(eD) {
                                ...
                                stopEffect(playTimeUpEff);
                                playTimeUpEff = null;
                                if(curPlayerIsMe_paohuzi(getOffIndex_jyShiWuZhang())){
                                    arrowbkNumberUpdate(this);
                                    this.setString("00");
                                }
                            },
                            ...
                            //     stopEffect(playTimeUpEff);
                            //     playTimeUpEff = null;
                            //     var pl = getUIPlayer_paohuzi(getOffIndex_jyShiWuZhang());
                            //     if(pl.onLine && curPlayerIsMe_paohuzi(getOffIndex_jyShiWuZhang())){
                            //         arrowbkNumberUpdate(this);
                            //     }
                            // },
                            roundEnd: function() {
            ...
            ready: {
                ...
                _run: function() {
                    if(MjClient.playui.isChangeUIWith2Player())
                        return;
                    GetReadyVisible_paohuzi(this, getOffIndex_jyShiWuZhang());
                },
                _event: {
                    startShuffleCards:function (d) {
                        if(MjClient.playui.isChangeUIWith2Player())
            ...
            _event: {
                clearCardUI: function() {
                    clearCardUI_paohuzi(this, getOffIndex_jyShiWuZhang());
                },
                clearCardArr: function(){
                    var eatNode = this.getChildByName("eatNode");
                    eatNode.removeAllChildren();
                ...
                initSceneData: function(eD) {
                    if(MjClient.playui.isChangeUIWith2Player())
                        return;
                    SetUserVisible_jyShiWuZhang(this, getOffIndex_jyShiWuZhang());
                    InitUserHandUI_jyShiWuZhang(this, getOffIndex_jyShiWuZhang());
                    DealOffLineCard_paohuzi(this,getOffIndex_jyShiWuZhang());
                },
                addPlayer: function(eD) {
                    if(MjClient.playui.isChangeUIWith2Player())
                        return;
                    SetUserVisible_jyShiWuZhang(this, getOffIndex_jyShiWuZhang());
                    InitUserCoinAndName_paohuzi(this, getOffIndex_jyShiWuZhang());
                },
                removePlayer: function(eD) {
                    if(MjClient.playui.isChangeUIWith2Player())
                        return;
                ...
                HZNewCard: function(eD) {
                    ...
                    DealNewCard_paohuzi(this,eD,getOffIndex_jyShiWuZhang());
                },
                roundEnd: function() {
                    if(MjClient.playui.isChangeUIWith2Player())
                        return;
                    InitUserCoinAndName_paohuzi(this, getOffIndex_jyShiWuZhang());
                    // MjClient.playui.ResetOtherCard(this, getOffIndex_jyShiWuZhang());
                    MjClient.playui.ResetEatCardsEnd(this, getOffIndex_jyShiWuZhang());
                },
                waitPut: function(eD) {
                    if(MjClient.playui.isChangeUIWith2Player())
                        return;
                    DealWaitPut(this, eD, getOffIndex_jyShiWuZhang());
                },
                MJPut: function(eD) {
                    if(MjClient.playui.isChangeUIWith2Player())
                        return;
                    DealPutCard_paohuzi(this, eD, getOffIndex_jyShiWuZhang());
                },
                HZChiCard: function(eD) {
                    if(MjClient.playui.isChangeUIWith2Player())
                        return;
                    DealChiCard_paohuzi(this, eD, getOffIndex_jyShiWuZhang());
                },
                HZGangCard: function(eD) {
                    if(MjClient.playui.isChangeUIWith2Player())
                        return;
                    DealGangCard_paohuzi(this, eD, getOffIndex_jyShiWuZhang());
                },
                MJPeng: function(eD) {
                    if(MjClient.playui.isChangeUIWith2Player())
                        return;
                    DealPengCard_paohuzi(this, eD, getOffIndex_jyShiWuZhang());
                },
                HZWeiCard: function(eD){
                    if(MjClient.playui.isChangeUIWith2Player())
                        return;
                    DealWeiCard_paohuzi(this, eD, getOffIndex_jyShiWuZhang());
                },
                MJHu: function(eD) {
                    if(MjClient.playui.isChangeUIWith2Player())
                        return;
                    DealHu_paohuzi(this, eD, getOffIndex_jyShiWuZhang());
                },
                HZWangChuang: function(eD){
                    if(MjClient.playui.isChangeUIWith2Player())
                        return;
                    DealWangChuang_paohuzi(this, eD, getOffIndex_jyShiWuZhang());
                },
                HZWangChuangShow:function(eD){
                    if(MjClient.playui.isChangeUIWith2Player())
                        return;
                ...
                onlinePlayer: function(eD) {
                    if(MjClient.playui.isChangeUIWith2Player())
                        return;
                    setUserOffline_paohuzi(this, getOffIndex_jyShiWuZhang());
                },
                playerStatusChange: function(eD) {
                    if(MjClient.playui.isChangeUIWith2Player())
                        return;
                ...
                MJFlower: function(eD) {
                    if(MjClient.playui.isChangeUIWith2Player())
                        return;
                    HandleMJFlower(this, eD, getOffIndex_jyShiWuZhang());
                },
                MJTing: function (eD) {
                    if(MjClient.playui.isChangeUIWith2Player())
                        return;
                    HandleMJTing(this, eD, getOffIndex_jyShiWuZhang());
                },
                waitJiazhu:function (msg) {
                    if(MjClient.playui.isChangeUIWith2Player())
                        return;
        ...
        left: {
            ...
            _event: {
                ...
                initSceneData: function(eD) {
                    ...
                    SetUserVisible_jyShiWuZhang(this, MjClient.MaxPlayerNum_paohuzi - 1);
                    InitUserHandUI_jyShiWuZhang(this, MjClient.MaxPlayerNum_paohuzi - 1);
...
//重置手牌的顺序
PlayLayer_jyShiWuZhang.prototype.ResetHandCard = function(posNode,off, needAction, isDelay){
...
PlayLayer_jyShiWuZhang.prototype._doMovetoAction = function(node,endP){
    node.stopAllActions();
    var ac = cc.moveTo(0.3,endP);
    node.runAction(ac);
};

PlayLayer_jyShiWuZhang.prototype.ResetEatCardsEnd = function(posNode,off){
    var pl = getUIPlayer_paohuzi(off);
    if (!pl) return;
    //提、偎牌的特殊处理
...
PlayLayer_jyShiWuZhang.prototype.ResetOtherCard = function(posNode,off){
    //添加吃、碰、跑、偎、提
    var sData = MjClient.data.sData;
    var tData = null;
    if(sData){
    ...
    if(mjSortArr){
        ...
        var callback = function(childList){
            for(var i = 0;i < childList.length;i++){
                ...
                //     child.loadTexture("playing/paohuzi/huxiBG.png");
                // }
                var shade = new cc.Sprite("playing/paohuzi/huxiBG.png");
                if(pl.info.uid == SelfUid() || (off == 1 && MjClient.MaxPlayerNum_paohuzi == 4)) //自己和右下的位置
                {
...
PlayLayer_jyShiWuZhang.prototype.ResetPutCard = function(posNode,off){
    //添加打出的牌
    var pl = getUIPlayer_paohuzi(off);
    if (!pl) return;
    var outNode = posNode.getChildByName("outNode");
    ...
    for(var i = 0; i < pl.mjput.length; i++){
        ...
        if(off == 0){
            ...
            outCard.anchorY = 0;
            outCard.x = outNode.width - childCount * outCard.width;
            if(MjClient.APP_TYPE.QXSYDTZ == MjClient.getAppType() && MjClient.MaxPlayerNum_paohuzi == 2
                && MjClient.playui.isChangeUIWith2Player()){
                outCard.x = childCount * outCard.width;
            }
            outCard.y = 0;
            if(MjClient.MaxPlayerNum_paohuzi == 3){
...
//重置牌的顺序
PlayLayer_jyShiWuZhang.prototype.CardLayoutRestore = function(posNode,off){
    if(MjClient.rePlayVideo == -1){
...
// 判断吃、碰、跑、偎、提、胡的状态
PlayLayer_jyShiWuZhang.prototype.EatVisibleCheck = function(off){
    var eat = MjClient.playui.jsBind.eat;
...
PlayLayer_jyShiWuZhang.prototype.isFangWei = function(card) {
    var sData = MjClient.data.sData;
    for(var uid in sData.players){
...
//二人对家左右切换
PlayLayer_jyShiWuZhang.prototype.isChangeUIWith2Player = function(){
    return false;
    return MjClient.MaxPlayerNum_paohuzi == 2 && MjClient.APP_TYPE.QXSYDTZ == MjClient.getAppType();
};

//出牌摸牌布局
PlayLayer_jyShiWuZhang.prototype.changePutCardLayout = function(node) {
    if(!cc.sys.isObjectValid(node) || !this.isPutCardLayout()) {
        return;
    }
    var type = util.localStorageEncrypt.getNumberItem(MjClient.KEY_QXYZ_LAYOUT_SELECT,0);
    switch (type) {
        case 0:
...
//出牌摸牌的位置是否适配偏右、传统布局
PlayLayer_jyShiWuZhang.prototype.isPutCardLayout = function() {
    return (MjClient.APP_TYPE.QXSYDTZ == MjClient.getAppType());
};