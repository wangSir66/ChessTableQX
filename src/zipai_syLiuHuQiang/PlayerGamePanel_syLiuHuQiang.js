...
function SetUserVisible_syLiuHuQiang(node, off){
    ...
    if(pl){
        ...
        // InitUserHandUI_syLiuHuQiang(node, off);
...
function InitUserHandUI_syLiuHuQiang(node, off){
...
var PlayLayer_syLiuHuQiang = cc.Layer.extend({
    jsBind: {
        _event: {
            ...
            roundEnd: function() {
                ...
                function delayExe(){
                    ...
                    if(!MjClient.endoneui){
                        self.addChild(new EndOneView_syZiPai(),500);//EndOneView_syZiPai
                    }
        ...
        cardNumImg: {
                ...
                _event:{
                    initSceneData:function(){
                        ...
                        if(next <= 0){
                           ...
                           next -= tData.areaSelectMode.maiPaiNum;
                           cc.log(maiPaiNum, next, "还有多少张");
                    ...
                    HZNewCard:function(){
                        ...
                        if(next <= 0){
                           ...
                           //      this.addChild(child);
                           // }
                            var maipai = tData.areaSelectMode.maiPaiNum;
                            next -= maipai;
            ...
            cardnumAtlas: {
                _run: function() {
                    ...
                    this.maiPaiNum = tData.areaSelectMode.maiPaiNum
                },
                _text: function() {
                    var sData = MjClient.data.sData;
                    var tData = sData.tData;
                ...
                _event: {
                    mjhand: function() {
                        ...
                        var tData = sData.tData;
                        var maipai = tData.areaSelectMode.maiPaiNum;
                        var next = (MjClient.majiang.getAllCardsTotal() - tData.cardNext) - maipai;
                        this.y = 40 + next * 0.8
                    ...
                    initSceneData : function() {
                        ...
                        var sData = MjClient.data.sData;
                        var tData = sData.tData;
                        var next = (MjClient.majiang.getAllCardsTotal() - tData.cardNext) - tData.areaSelectMode.maiPaiNum;
                        this.y = 40 + next * 0.8
                        if (tData) this.setString(MjClient.majiang.getAllCardsTotal() - tData.cardNext - this.maiPaiNum);
                    },
                    HZNewCard: function() {
        ...
        roundInfo:{
            ...
            _run:function(){
                var tData = MjClient.data.sData.tData;
                var str = "";
                str += (tData.areaSelectMode.xiNum == 6) ? "6息," : (tData.areaSelectMode.xiNum == 9) ? "9息," : "15息," ;
                str += (tData.areaSelectMode.suanfenType == 0) ? "" : (tData.areaSelectMode.suanfenType == 1) ? "底分2分," : "1息1囤,";                  str += (tData.areaSelectMode.isMingwei) ? "明偎," : "" ;
        ...
        banner: {
            ...
            getRoomNum: {
                ...
                _click: function() {
                    ...
                    str += (tData.areaSelectMode.xiNum == 6) ? "6息," : (tData.areaSelectMode.xiNum == 9) ? "9息," : "15息," ;
                    str += (tData.areaSelectMode.xingType == 0) ? "不带醒," : (tData.areaSelectMode.xingType == 2) ? "翻醒," : "随醒," ;
                    str += (tData.areaSelectMode.suanfenType == 0) ? "" : (tData.areaSelectMode.suanfenType == 1) ? "底分2分," : "1息1囤,";
        ...
        wait: {
            ...
            wxinvite: {
                ...
                _click: function() {
                    ...
                    // if(MjClient.getAppType() == MjClient.APP_TYPE.QXYZQP || MjClient.getAppType() == MjClient.APP_TYPE.BDYZPHZ || MjClient.getAppType() == MjClient.APP_TYPE.BDHYZP){
                    //     gameName = "六胡抢";
                    // }
                    // GLog( gameName + "  房间号:" + tData.tableid + str7+txt_club, str);
        ...
        down: {
            ...
            _event: {
                ...
                initSceneData: function(eD) {
                    SetUserVisible_syLiuHuQiang(this, 0);
                    InitUserHandUI_syLiuHuQiang(this, 0);
        ...
        xing: {
            ...
            _event: {
                ...
                initSceneData: function(eD) {
                    if(MjClient.MaxPlayerNum_leiyang == 4) {
                        SetUserVisible_syLiuHuQiang(this, 1);
                        InitUserHandUI_syLiuHuQiang(this, 1);
        ...
        right: {
            ...
            head: {
                zhuang: {
                    ...
                    _event: {
                        waitPut: function() {
                            showUserZhuangLogo_hengYang(this, getRightNodeOff_ER());
                        },
                        initSceneData: function() {
                            if (IsArrowVisible_hengYang()) showUserZhuangLogo_hengYang(this, getRightNodeOff_ER());
                        },
                        mjhand: function(){
                            if (IsArrowVisible_hengYang()) showUserZhuangLogo_hengYang(this, getRightNodeOff_ER());
                        }
                ...
                chatbg: {
                    ...
                    chattext: {
                        _event: {
                            MJChat: function(msg) {
                                showUserChat_hengYang(this, getRightNodeOff_ER(), msg);
                            },
                            playVoice: function(voicePath) {
                                MjClient.data._tempMessage.msg = voicePath;
                                showUserChat_hengYang(this, getRightNodeOff_ER(), MjClient.data._tempMessage);
                            }
                        }
                    }
                },
                _click: function(btn) {
                    showPlayerInfo_hengYang(getRightNodeOff_ER(), btn);
                },
                _event: {
                    loadWxHead: function(d) {
                        setWxHead_hengYang(this, d, getRightNodeOff_ER());
                    },
                    addPlayer: function(eD) {
                        showFangzhuTagIcon_shaoyangZP(this,getRightNodeOff_ER());
                    },
                    removePlayer: function(eD) {
                        showFangzhuTagIcon_shaoyangZP(this,getRightNodeOff_ER());
                    }
                ...
                huxi:{
                    ...
                    _event:{
                        ...
                        initSceneData:function(){
                            this.visible = true;
                            var huXi = UpdateHuXi_hengYang(getRightNodeOff_ER());
                            if(!IsArrowVisible_hengYang()){
                                huXi = 0;
                                this.visible = false;
                            }
                ...
                timeImg:{
                    ...
                    // _event:{
                    //     initSceneData: function(eD) {
                    //         this.visible = curPlayerIsMe_hengYang(getRightNodeOff_ER());
                    //     },
                    //     mjhand: function(eD) {
                    //         this.visible = curPlayerIsMe_hengYang(getRightNodeOff_ER());
                    //     },
                    //     onlinePlayer: function(eD) {
                    //         this.visible = curPlayerIsMe_hengYang(getRightNodeOff_ER()) && IsArrowVisible_hengYang();
                    //     },
                    //     waitPut: function(eD) {
                    //         this.visible = curPlayerIsMe_hengYang(getRightNodeOff_ER());
                    //     },
                    ...
                    //             stopEffect(playTimeUpEff);
                    //             playTimeUpEff = null;
                    //             if(curPlayerIsMe_hengYang(getRightNodeOff_ER())){
                    //                 arrowbkNumberUpdate(this);
                    //                 this.setString("00");
                    //             }
                    //         },
                    ...
                    //             stopEffect(playTimeUpEff);
                    //             playTimeUpEff = null;
                    //             var pl = getUIPlayer_hengYang(getRightNodeOff_ER());
                    //             if(pl && pl.onLine && curPlayerIsMe_hengYang(getRightNodeOff_ER())){
                    //                 arrowbkNumberUpdate(this);
                    //             }
                    //         },
                    //         roundEnd: function() {
            ...
            ready: {
                _layout: [[0.07, 0.07],[0.5, 0.5],[2.5, 2.5]],
                _run: function() {
                    GetReadyVisible_hengYang(this, getRightNodeOff_ER());
                },
                _event: {
                    startShuffleCards:function (d) {
                        GetReadyVisible_hengYang(this, -1);
            ...
            _event: {
                clearCardUI: function() {
                    clearCardUI_hengYang(this, getRightNodeOff_ER());
                },
                clearCardArr: function(){
                    var eatNode = this.getChildByName("eatNode");
                    eatNode.removeAllChildren();
                ...
                initSceneData: function(eD) {
                    SetUserVisible_syLiuHuQiang(this, getRightNodeOff_ER());
                    InitUserHandUI_syLiuHuQiang(this, getRightNodeOff_ER());
                    InitUserCoinAndName_hengYang(this, getRightNodeOff_ER());
                    DealOffLineCard_hengYang(this,getRightNodeOff_ER());
                },
                addPlayer: function(eD) {
                    SetUserVisible_syLiuHuQiang(this, getRightNodeOff_ER());
                    InitUserCoinAndName_hengYang(this, getRightNodeOff_ER());
                ...
                HZNewCard: function(eD) {
                    ...
                    DealNewCard_hengYang(this,eD,getRightNodeOff_ER());
                },
                roundEnd: function() {
                    InitUserCoinAndName_hengYang(this, getRightNodeOff_ER());
                ...
                MJPut: function(eD) {
                    DealPutCard_hengYang(this, eD, getRightNodeOff_ER());
                },
                HZChiCard: function(eD) {
                    DealChiCard_hengYang(this, eD, getRightNodeOff_ER());
                },
                HZGangCard: function(eD) {
                    DealGangCard_hengYang(this, eD, getRightNodeOff_ER());
                },
                MJPeng: function(eD) {
                    DealPengCard_hengYang(this, eD, getRightNodeOff_ER());
                },
                HZWeiCard: function(eD){
                    DealWeiCard_hengYang(this, eD, getRightNodeOff_ER());
                },
                MJHu: function(eD) {
                    DealHu_hengYang(this, eD, getRightNodeOff_ER());
                },
                onlinePlayer: function(eD) {
                    setUserOffline_hengYang(this, getRightNodeOff_ER());
                },
                playerStatusChange: function(eD) {
                    setUserOffline_hengYang(this, getRightNodeOff_ER());
                },
                ...
                HZAddCards:function (eD) {
                    ...
                    DealAddCard_hengYang(this,eD, getRightNodeOff_ER());
                },
                HZCheckRaise:function (msg) {
                    ShowPutCardIcon();
                    //MjClient.playui.EatVisibleCheck();
        ...
        left: {
            head: {
                zhuang: {
                    ...
                    _event: {
                        waitPut: function() {
                            showUserZhuangLogo_hengYang(this, MjClient.MaxPlayerNum_leiyang - 1);
                        },
                        initSceneData: function() {
                            if (IsArrowVisible_hengYang()) showUserZhuangLogo_hengYang(this, MjClient.MaxPlayerNum_leiyang - 1);
                        },
                        mjhand: function(){
                            if (IsArrowVisible_hengYang()) showUserZhuangLogo_hengYang(this, MjClient.MaxPlayerNum_leiyang - 1);
                        }
                ...
                chatbg: {
                    ...
                    chattext: {
                        _event: {
                            MJChat: function(msg) {
                                showUserChat_hengYang(this, MjClient.MaxPlayerNum_leiyang - 1, msg);
                            },
                            playVoice: function(voicePath) {
                                MjClient.data._tempMessage.msg = voicePath;
                                showUserChat_hengYang(this, MjClient.MaxPlayerNum_leiyang - 1, MjClient.data._tempMessage);
                            }
                        }
                    }
                },
                _click: function(btn) {
                    showPlayerInfo_hengYang(MjClient.MaxPlayerNum_leiyang - 1, btn);
                },
                _event: {
                    loadWxHead: function(d) {
                        setWxHead_hengYang(this, d, MjClient.MaxPlayerNum_leiyang - 1);
                    },
                    addPlayer: function(eD) {
                        showFangzhuTagIcon_shaoyangZP(this,MjClient.MaxPlayerNum_leiyang - 1);
                    },
                    removePlayer: function(eD) {
                        showFangzhuTagIcon_shaoyangZP(this,MjClient.MaxPlayerNum_leiyang - 1);
                    }
                ...
                timeImg:{
                    ...
                    // _event:{
                    //     initSceneData: function(eD) {
                    //         this.visible = curPlayerIsMe_hengYang(MjClient.MaxPlayerNum_leiyang - 1);
                    //     },
                    //     mjhand: function(eD) {
                    //         this.visible = curPlayerIsMe_hengYang(MjClient.MaxPlayerNum_leiyang - 1);
                    //     },
                    //     onlinePlayer: function(eD) {
                    //         this.visible = curPlayerIsMe_hengYang(MjClient.MaxPlayerNum_leiyang - 1) && IsArrowVisible_hengYang();
                    //     },
                    //     waitPut: function(eD) {
                    //         this.visible = curPlayerIsMe_hengYang(MjClient.MaxPlayerNum_leiyang - 1);
                    //     },
                    ...
                    //             stopEffect(playTimeUpEff);
                    //             playTimeUpEff = null;
                    //             if(curPlayerIsMe_hengYang(MjClient.MaxPlayerNum_leiyang - 1)){
                    //                 arrowbkNumberUpdate(this);
                    //                 this.setString("00");
                    //             }
                    //         },
                    ...
                    //             stopEffect(playTimeUpEff);
                    //             playTimeUpEff = null;
                    //             var pl = getUIPlayer_hengYang(MjClient.MaxPlayerNum_leiyang - 1);
                    //             if(pl && pl.onLine && curPlayerIsMe_hengYang(MjClient.MaxPlayerNum_leiyang - 1)){
                    //                 arrowbkNumberUpdate(this);
                    //             }
                    //         },
                    //         roundEnd: function() {
            ...
            ready: {
                _layout: [[0.07, 0.07],[0.5, 0.5],[-2.5, 2.5]],
                _run: function() {
                    GetReadyVisible_hengYang(this, MjClient.MaxPlayerNum_leiyang - 1);
                },
                _event: {
                    startShuffleCards:function (d) {
                        GetReadyVisible_hengYang(this, -1);
            ...
            _event: {
                clearCardUI: function() {
                    clearCardUI_hengYang(this, MjClient.MaxPlayerNum_leiyang - 1);
                },
                clearCardArr: function(){
                    var eatNode = this.getChildByName("eatNode");
                    eatNode.removeAllChildren();
                ...
                initSceneData: function(eD) {
                    SetUserVisible_syLiuHuQiang(this, MjClient.MaxPlayerNum_leiyang - 1);
                    InitUserHandUI_syLiuHuQiang(this, MjClient.MaxPlayerNum_leiyang - 1);
                    InitUserCoinAndName_hengYang(this, MjClient.MaxPlayerNum_leiyang - 1);
                    DealOffLineCard_hengYang(this,MjClient.MaxPlayerNum_leiyang - 1);
                },
                addPlayer: function(eD) {
                    SetUserVisible_syLiuHuQiang(this, MjClient.MaxPlayerNum_leiyang - 1);
                    InitUserCoinAndName_hengYang(this, MjClient.MaxPlayerNum_leiyang - 1);
                ...
                HZNewCard: function(eD) {
                    ...
                    DealNewCard_hengYang(this,eD,MjClient.MaxPlayerNum_leiyang - 1);
                },
                roundEnd: function() {
                    InitUserCoinAndName_hengYang(this, MjClient.MaxPlayerNum_leiyang - 1);
                ...
                MJPut: function(eD) {
                    DealPutCard_hengYang(this, eD, MjClient.MaxPlayerNum_leiyang - 1);
                },
                HZChiCard: function(eD) {
                    DealChiCard_hengYang(this, eD, MjClient.MaxPlayerNum_leiyang - 1);
                },
                HZPaoCard: function(eD) {
                    DealPaoCard_hengYang(this, eD, MjClient.MaxPlayerNum_leiyang - 1);
                },
                HZGangCard: function(eD) {
                    DealGangCard_hengYang(this, eD, MjClient.MaxPlayerNum_leiyang - 1);
                },
                MJPeng: function(eD) {
                    DealPengCard_hengYang(this, eD, MjClient.MaxPlayerNum_leiyang - 1);
                },
                HZWeiCard: function(eD){
                    DealWeiCard_hengYang(this, eD, MjClient.MaxPlayerNum_leiyang - 1);
                },
                MJHu: function(eD) {
                    DealHu_hengYang(this, eD, MjClient.MaxPlayerNum_leiyang - 1);
                },
                onlinePlayer: function(eD) {
                ...
                HZAddCards:function (eD) {
                    DealAddCard_hengYang(this,eD, MjClient.MaxPlayerNum_leiyang - 1);
                },
                HZCheckRaise:function (msg) {
                    ShowPutCardIcon();
                    //MjClient.playui.EatVisibleCheck();
        ...
        chat_btn: {
            _layout: [[55/1280, 0],[0.97, 0.5],[0, -0.2]],
            _click: function() {
    ...
    ctor: function() {
        cc.log("六胡抢啊...");
        this._super();
        var playui = ccs.load("Play_syLiuHuQiang.json");
        playMusic("bgFight");
        var tData = MjClient.data.sData.tData;
...
PlayLayer_syLiuHuQiang.prototype.ResetHandCard = function(posNode,off, needAction, isDelay){
...
PlayLayer_syLiuHuQiang.prototype.ResetHandCard = function(posNode,off, needAction, isDelay){
    ...
    if(MjClient.rePlayVideo == -1){
        if(off == 0) {
            ...
            //if(MjClient.movingCard_hengYang && MjClient.movingCard_hengYang.getParent()){
            //    MjClient.movingCard_hengYang.removeFromParent(true);
...
*/
PlayLayer_syLiuHuQiang.prototype._doMovetoAction = function(node,endP){
    node.stopAllActions();
    var ac = cc.moveTo(0.3,endP);
    node.runAction(ac);
};

PlayLayer_syLiuHuQiang.prototype.ResetOtherCard = function(posNode,off){
    //添加吃、碰、跑、偎、提
    var sData = MjClient.data.sData;
    var tData = null;
    if(sData){
...
PlayLayer_syLiuHuQiang.prototype.ResetPutCard = function(posNode,off){
    //添加打出的牌
    var pl = getUIPlayer_hengYang(off);
...
//重置牌的顺序
PlayLayer_syLiuHuQiang.prototype.CardLayoutRestore = function(posNode,off){
    if(MjClient.rePlayVideo == -1){
...
// 判断吃、碰、跑、偎、提、胡的状态
PlayLayer_syLiuHuQiang.prototype.EatVisibleCheck = function(off){
    var eat = MjClient.playui.jsBind.eat;
...
PlayLayer_syLiuHuQiang.prototype.showAndHideHeadEffect = function(){
