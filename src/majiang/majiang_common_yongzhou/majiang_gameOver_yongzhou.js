/***
 * 永州App，通用大结算文件   对应 endAll_maJiang.json
 * @type {void | Class | *}
 */
var majiang_gameOver_yongzhou = majiang_gameOver.extend({
    ...
    setGameOverLayer:function(node, off){
        ...
        var uibind={
            img_bg: {
                _run: function () {
                    if(pl.winall === 0 || pl.winall < maxWinScore){
                        this.loadTexture("gameOver/majiang_loserbg.png");
                    }else{
                        this.loadTexture("gameOver/majiang_winbg.png");
                    }
                }
            },
            text_name:{
            ...
            text_score: {
                _run:function(){ 
                    this.ignoreContentAdaptWithSize(true);
                    var textFileName = pl.winall >= 0 ? "gameOver/over_add_text.png" : "gameOver/over_sub_text.png";
