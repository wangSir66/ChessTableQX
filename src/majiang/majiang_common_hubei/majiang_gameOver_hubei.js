 ...
 * @type {void | Class | *}
 */
var majiang_gameOver_hubei = majiang_gameOver.extend({
        ...
        var uibind={
            ...
            text_name:{
                _run:function(){
                    ...
                    this.setTextColor(pl.winall < 0 ? cc.color("#5C8075") : cc.color("A4844D"));
                },
                _text:function(){
            ...
            text_score: {
                _run:function(){
                    this.ignoreContentAdaptWithSize(true);
                    var score = pl.winall > 0 ? ("+" + pl.winall) : pl.winall;
                    var textFileName = pl.winall > 0 ? "common/zi_ying.png" : "common/zi_shu.png";
                    this.setProperty(score + "", textFileName, 32, 43, "+");
                }
            },
            // 大赢家
            img_bigWinner: {
    ...
    setRoomStatistics: function (layout_typeText, pl) {
        ...
        for (var i = 0; i < infoType.length; i++) {
            ...
            cloneName.setTextColor(pl.winall <= 0 ? cc.color("#5C8075") : cc.color("#A4844D"));
            cloneScore.setTextColor(pl.winall <= 0 ? cc.color("#D0E1D5") : cc.color("#F0EFB2"));
