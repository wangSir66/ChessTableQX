...
function addWxHeadToEndUI_newLiuHuQiang(node, off) {
    var pl = MjClient.getPlayerByIndex(off);
    var img = "png/default_headpic.png";
    if (pl && pl.wxHeadImg) {
        img = pl.wxHeadImg;
...
function SetGameOverLayer_liuHuQiang(node,off,isNewUi){
    ...
    setDismissTypeImg(pl,node,0.5,0.32,"chang");
    ...
    addWxHeadToEndUI_newLiuHuQiang(wxNode,off);   
...
var GameOverLayer_liuHuQiang = cc.Layer.extend({
    sprite:null,
    jsBind:{
        back:{
            close :{ 
    ...
    ctor:function () {
        ...
        var endallui = ccs.load("endAll_liuHuQiang.json");
        ...
        for(var i = 0 ; i < playerCount ; i++){
            ...
            SetGameOverLayer_liuHuQiang(clone,i, false); 
