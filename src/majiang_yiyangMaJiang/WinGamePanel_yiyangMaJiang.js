...
function SetEndOneUserUI_yiYang(node,off)
{
...
var EndOneView_yiYang = cc.Layer.extend({
	jsBind:{
		block: {
		...
		head0:{
		   ...
		   _run:function(){ SetEndOneUserUI_yiYang(this,0); },
		...
		,head1:{ 
		  ...
		  _run:function(){ SetEndOneUserUI_yiYang(this,1); }
		}
		...
		,head2:{ 
		   ...
		   _run:function(){ SetEndOneUserUI_yiYang(this,2); }
		}
		,head3:{
			 head:
			 {
			...
			_run:function(){ SetEndOneUserUI_yiYang(this,3); }
			},
            count_down:{
                _visible :function()
                {
    ...
    ctor:function () {
        this._super();
        var endoneui = ccs.load("endOne_yiYang.json");
        ...
        for(var i = 0;i < cards.length;i++)
        {
            ...
            if(tData.areaSelectMode.zhongNiaoType == 2 && cards[i] % 2 == 1){
            	zhongCount++;
            }
            else if (cards[i] == 31 || cards[i] == 71 || 
            	(tData.areaSelectMode.zhongNiaoType == 1 &&
				cards[i] <= 29 && cards[i] % 10 == 1 || cards[i] % 10 == 5 || cards[i] % 10 == 9))
            {
                zhongCount++;
            }
            else if(tData.areaSelectMode.zhongNiaoType == 3){
                zhongCount++;
			}
			else{
