...
function addWxHeadToEndUI_rugao(node,off)
{
...
function SetEndOneUserUI_rugao(node,off)
{
		...
		head: {
			...
			up: {
				...
				, _run: function () {
                    ...
                    CardLayoutRestore_changpai_RuGao(node, pl);
    ...
    addWxHeadToEndUI_rugao(uibind.head._node,off);
	//uibind.winNum._node.y=uibind.head._node.y;
}

CardLayoutRestore_changpai_RuGao = function(node, pl)
{
    if(!pl) return;
...
var EndOneView_rugao = cc.Layer.extend({
	jsBind:{
        block: {
		...
		head0:{
		   ...
		   _run:function(){ SetEndOneUserUI_rugao(this,0); },
		...
		,head1:{
		  ...
		  _run:function(){ SetEndOneUserUI_rugao(this,1); }
		}
		,head2:{
		   head:{
			   zhuang:{_visible:false}
		   ...
		   _run:function(){ SetEndOneUserUI_rugao(this,2); }
		}
		}
	},
    ctor:function () {
        this._super();
        var endoneui = ccs.load(res.EndOne_rugao_json);
