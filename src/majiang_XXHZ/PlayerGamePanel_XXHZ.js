...
//向服务器发送 过消息
MjClient.MJPass2NetForXXHZ = function () {
    cc.log("====================send======pass=====");
...
function SetUserVisible_XXHZ(node, off) {
    cc.log("====================off======================" + off);
...
function InitUserHandUI_XXHZ(node, off) {
    var sData = MjClient.data.sData;
    var tData = sData.tData;
    var pl = getUIPlayer(off);
    if (!pl) {
...
function initFlower_XXHZ() {
    initFlower(false, false);
}

var PlayLayer_XXHZ = cc.Layer.extend({
    jsBind: {
        _event: {
            mjhand: function () {
            ...
            roundEnd: function () {
                ...
                function delayExe() {
                    ...
                    self.addChild(new EndOneView_XXHZ(), 500);
                }
        ...
        wait: {
            ...
            delroom: {
                _run:function(){
                    if (isIPhoneX())
                        setWgtLayout(this, [0.11, 0.11], [0.09, 0.5], [0, 0]);
                    else
                        setWgtLayout(this, [0.11, 0.11], [0.04, 0.5], [0, 0]);

                    //湘乡告胡子APP添加ipad适配
                    if(MjClient.getAppType() === MjClient.APP_TYPE.QXXXGHZ && isIpadSize() && MjClient.MaxPlayerNum != 2){
            ...
            backHomebtn: {
                _run:function(){
                    if (isIPhoneX())
                        setWgtLayout(this, [0.11, 0.11],[0.09, 0.65],[0, 0]);
                    else
                        setWgtLayout(this, [0.11, 0.11],[0.04, 0.65],[0, 0]);
                ...
                tingIcon: {
                    ...
                    _run: function () {
                        ...
                        this.runAction(cc.sequence(
                            cc.spawn(
                                cc.tintTo(0.6, 255, 0, 0),
                                cc.scaleTo(0.6, this.getScale() + 0.3)),
                            cc.spawn(
                                cc.tintTo(0.6, 255, 255, 255),
                                cc.scaleTo(0.6, this.getScale()))
                        ).repeatForever());
                    },
        ...
        left: {
            ...
            out1: {
                _run: function () {
                    if (MjClient.size.width / MjClient.size.height >= 1.5) {
                        setWgtLayout(this, [0, 0.0545], [0, 0.5], [5.5, 4.8]);
                    }
                    else {
                        setWgtLayout(this, [0, 0.05], [0, 0.5], [5.5, 4.8]);
                    }
            ...
            chi0: {
                ...
                bg_img: {
                    _run: function () {
                        ...
                        this.runAction(cc.sequence(
                            cc.spawn(a, aa),
                            cc.spawn(a1, a2).easing(cc.easeCubicActionOut()),
                            a3,
                            cc.delayTime(0.2)
                        ).repeatForever());
                    }
            ...
            changeui: {
                ...
                changeuibg: {
                    ...
                    guobg: {
                        guo: {
                            _touch: function (btn, eT) {
                                if (eT == 2) MjClient.MJPass2NetForXXHZ();
                            }
                        },
    ...
    ctor: function () {
        ...
        var playui = ccs.load("Play_XXHZ.json");
        playMusic("bgFight");
...
PlayLayer_XXHZ.prototype.CardLayoutRestore = function (node, off) {
...
// 判断吃碰杠胡的状态
PlayLayer_XXHZ.prototype.EatVisibleCheck = function () {
    var eat = MjClient.playui.jsBind.eat;
...
PlayLayer_XXHZ.prototype.ShowAllTingTips = function ()
{
