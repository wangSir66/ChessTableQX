...
var CreateRoomNode_BDHYShiHuKa = CreateRoomNode.extend({
    initAll:function()
    {
        ...
        if (!this._isFriendCard){
            ...
            this.localStorageKey.KEY_BDHYShiHuKa_zhuangJia= "_BDHYShiHuKa_zhuangJia";   //庄家
        }
    ...
    setPlayNodeCurrentSelect:function(atClub)
    {
        ...
        if (atClub){
            ...
            zhuangJia = util.localStorageEncrypt.getNumberItem(this.localStorageKey.KEY_BDHYShiHuKa_zhuangJia, 0);
        }
    ...
    getSelectedPara:function()
    {
        ...
        if (!this._isFriendCard){
            ...
            util.localStorageEncrypt.setNumberItem(this.localStorageKey.KEY_BDHYShiHuKa_zhuangJia, para.zhuangJia);
        }
