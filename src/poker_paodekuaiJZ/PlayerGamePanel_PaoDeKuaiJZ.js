...
function SetUserVisible_PaoDeKuaiJZ(node, off)
{
    ...
    if(pl)
    {
        ...
        InitUserHandUI_PaoDeKuaiJZ(node, off);
    }
    else
    {
        name.visible = false;
...
function InitUserHandUI_PaoDeKuaiJZ(node, off, needSort)
{
...
function cardsSort_PaoDeKuaiJZ(cards)
{
    var pointCounts = {};
...
var PlayLayer_PaoDeKuaiJZ = cc.Layer.extend({
    _btnPutCard:null,
    jsBind: {
        _run: function() {
        ...
        //             // var str3 = MjClient.MaxPlayerNum == 2 ? tData.roundNum + "局,缺一," : tData.roundNum + "局,二缺一,";
        ...
        //             // var str3 = tData.roundNum + "局," + "速度加入【"+AppCnName[MjClient.getAppType()]+"】";
        //             //
        //             // var str4 = MjClient.MaxPlayerNum == 2 ? "  缺一" : "  二缺一";
        //             // var txt_club = tData.clubId ? "亲友圈(" + tData.clubId + ")" : "";
        //             // GLog(str1 + str2 + str3 + str4 + "  点击加入>>>" + txt_club);
        //             // MjClient.native.wxShareUrl(MjClient.remoteCfg.entreRoomUrl+"?vipTable="+tData.tableid, GameCnName[MjClient.gameType] + "  " + tData.tableid + str4 + "  点击加入>>>" + txt_club,
        //             //     str1+str2+str3);
        ...
        BtnPutCard:{
            ...
            _click: function(btn) {
                //cc.log("BtnPutCard");
				cardsSort_PaoDeKuaiJZ(MjClient.selectCards_card);
        ...
        down: {
            ...
            _event: {
                ...
                initSceneData: function(eD) {
                    SetUserVisible_PaoDeKuaiJZ(this, 0);
                ...
                mjhand: function(eD) {
                    InitUserHandUI_PaoDeKuaiJZ(this, 0);
                ...
                roundEnd: function() {
                    InitUserCoinAndName_jinzhong(this, 0, false);
                    //setTaiInfo("");
                },
                newCard: function(eD) {
                    // cdsNums++;
        ...
        right: {
            ...
            _event: {
                ...
                initSceneData: function(eD) {
                    SetUserVisible_PaoDeKuaiJZ(this, 1);
                },
                addPlayer: function(eD) {
                    SetUserVisible_PaoDeKuaiJZ(this, 1);
                },
                ...
                mjhand: function(eD) {
                    InitUserHandUI_PaoDeKuaiJZ(this, 1);
                },
                roundEnd: function() {
                    InitUserCoinAndName_jinzhong(this, 1);
                },
                waitPut: function(eD) {
        ...
        top: {
            ...
            _event: {
                ...
                initSceneData: function(eD) {
                    SetUserVisible_PaoDeKuaiJZ(this, 2);
                },
                addPlayer: function(eD) {
                    SetUserVisible_PaoDeKuaiJZ(this, 2);
                },
                ...
                mjhand: function(eD) {
                    InitUserHandUI_PaoDeKuaiJZ(this, 2);
                },
                roundEnd: function() {
                    InitUserCoinAndName_jinzhong(this, 2);
                },
                waitPut: function(eD) {
    ...
    ctor: function() {
        this._super();
        cc.log("JSON:" + res.Play_PaoDeKuaiJZ_json);
        cc.log("JSON:" + res.Play_PaoDeKuaiJZ_json);
        cc.log("JSON:" + res.Play_PaoDeKuaiJZ_json);
        cc.log("JSON:" + res.Play_PaoDeKuaiJZ_json);
        cc.log("JSON:" + res.Play_PaoDeKuaiJZ_json);
        ...
        var playui = ccs.load(res.Play_PaoDeKuaiJZ_json);
...
PlayLayer_PaoDeKuaiJZ.prototype.InitC_Data = function() {
...
PlayLayer_PaoDeKuaiJZ.prototype.cannotOutCardGrey = function()
{
...
PlayLayer_PaoDeKuaiJZ.prototype.recoverCannotOutCard = function()
{
    var children = this._downNode.children;
    for (var i = 0; i < children.length; i++)
    {
...
PlayLayer_PaoDeKuaiJZ.prototype.clockNumberUpdate = function(node, endFunc)
{
    return arrowbkNumberUpdate(node, endFunc);
}

PlayLayer_PaoDeKuaiJZ.prototype.updateClockPosition = function(arrowNode)
{
    var tData = MjClient.data.sData.tData;
    var uids = tData.uids;
...
PlayLayer_PaoDeKuaiJZ.prototype.shwoFlyCardAnim = function(flyNode)
{
    var tData = MjClient.data.sData.tData;
...
PlayLayer_PaoDeKuaiJZ.prototype.showHandCardBeiMian = function()
{
...
PlayLayer_PaoDeKuaiJZ.prototype.hideHandCardBeiMian = function()
{
...
PlayLayer_PaoDeKuaiJZ.prototype.CardLayoutRestore = function(node, off, needSort)
{
    // 如果正在发牌 不排序
...
PlayLayer_PaoDeKuaiJZ.prototype.CardLayoutDesk = function(node,cards,off)
{
    //if(off != 0) return;
...
//横向摆放《正常》
PlayLayer_PaoDeKuaiJZ.prototype.horSort = function(node, off, needSort)
{
    var pl; //player 信息
...
//纵向摆放
PlayLayer_PaoDeKuaiJZ.prototype.verSort = function(node, off, needSort)
{
    if(off != 0)
    {
        return;
