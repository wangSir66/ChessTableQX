...
function SetEndOneUserUI_PaoDeKuaiJZ(node, off) {
...
function CardLayoutRestoreForEndOne_PaoDeKuaiJZ(node, plNode) {
...
var EndOneView_PaoDeKuaiJZ = cc.Layer.extend({
    jsBind: {
        block: {
        ...
        back: {
            _run: function () {
                if (isIPhoneX()) {
                    // 超框处理
                    setWgtLayout(this, [0.9, 0.9], [0.5, 0.5], [0, 0]);
                } else {
            ...
            head0: {
                ...
                _run: function () { SetEndOneUserUI_PaoDeKuaiJZ(this, 0); },
    		...
    		, head1: {
    		    ...
    		    _run: function () { SetEndOneUserUI_PaoDeKuaiJZ(this, 1); }
    		}
    		...
    		, head2: {
    		    ...
    		    _run: function () { SetEndOneUserUI_PaoDeKuaiJZ(this, 2); }
    		}
        }
    },
    ctor: function () {
        ...
        var endoneui = ccs.load(res.EndOne_PaoDeKuaiJZ_json);
