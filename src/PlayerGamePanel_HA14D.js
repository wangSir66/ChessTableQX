...
//向服务器发送 过消息
MjClient.MJPass2NetForHA14D = function()
{
   // console.log(">>>>>>>>>普通  过 <<<<<<<<");
    cc.log("====================send======pass=====");
...
function SetUserVisible_HA14D(node, off)
{
    //var sData = MjClient.data.sData;
    //return;
    cc.log("====================off======================" + off);
...
function InitUserHandUI_HA14D(node, off)
{
    var sData = MjClient.data.sData;
    var tData = sData.tData;
    var pl = getUIPlayer(off);
...
function initFlower_HA14D() {
    initFlower(false, false);
}


var PlayLayer_HA14D = cc.Layer.extend({
    jsBind: {
        _event: {
            mjhand: function() {
            ...
            roundEnd: function() {
                ...
                function delayExe()
                {
                    ...
                    self.addChild(new EndOneView_HA14D(),500);
                }
        ...
        roundInfo:{
            ...
            _run:function()
            {
                ...
                var str = "";
                var str1 = (tData.areaSelectMode.zhongfabai)? "中发白全带,":"";
                var str2 = (tData.areaSelectMode.duoHu)? "一炮多响(点炮一家付),":"截胡(点炮三家付),";
                this.ignoreContentAdaptWithSize(true);
                var strPayWay = "";
                ...
                // }
                var str3 = strPayWay;
                this.setString(str + str1 + str2 + str3);

                //比赛场
                var BSStr = "";
                if(tData.matchId){
                    BSStr = ",10秒出牌";
                    this.setString(GameCnName[MjClient.gameType]+","+str + str1 + str2 + str3 + BSStr);
                }
        ...
        banner: {
            ...
            Button_1: {
                _visible : true,
                _click: function() {
                    MjClient.openWeb({url:MjClient.GAME_TYPE.HA_14DUN,help:true});
                }
            },
            hunPai:{
                baidaBg:{
        ...
        wait: {
            getRoomNum: {
                ...
                _click: function() {
                    ...
                    var str1 = "淮安14墩麻将,"
                    var str2 = "";
                    var str3 = (tData.areaSelectMode.zhongfabai)? "中发白全带,":"";
                    var str4 = (tData.areaSelectMode.duoHu)? "一炮多响(点炮一家付),":"截胡(点炮三家付),";
                    var strPayWay = "";
                    switch (tData.areaSelectMode.payWay)
                    {
                        case 0:
            ...
            wxinvite: {
                ...
                _click: function() {
                    ...
                    MjClient.getInviteUrl(function (url) {
                        MjClient.native.wxShareUrl(url, GameCnName[MjClient.gameType] + "  " + tData.tableid + "  三缺一  点击加入>>>",
                            str1+str2+str3+str4+str5+str6);
                    });
                },
                _visible:function()
            ...
            changeui: {
                ...
                changeuibg: {
                    ...
                    guobg: {
                        guo: {
                            _touch: function(btn, eT) {
                                if (eT == 2) MjClient.MJPass2NetForHA14D();
                            }
                        },
                        fanhui: {
                            _touch: function(btn, et) {
    ...
    ctor: function() {
        this._super();
        var playui = ccs.load(res.Play_HA14D_json);
        playMusic("bgFight");
...
PlayLayer_HA14D.prototype.CardLayoutRestore = function(node, off)
{
...
// 判断吃碰杠胡的状态
PlayLayer_HA14D.prototype.EatVisibleCheck = function()
{
    var eat = MjClient.playui.jsBind.eat;
