...
var _isShowShaiziAni_yiJiaoLaiYou = false; //为了控制mjhand之后播骰子动画时newCard的状态显示
//向服务器发送 过消息
MjClient.MJPass2NetForyiJiaoLaiYou = function()
{
   // console.log(">>>>>>>>>普通  过 <<<<<<<<");
    cc.log("====================send======pass=====");
...
function updateHeadUI_yiJiaoLaiYou(node, off)
{
    cc.log('updateHeadUI_yiJiaoLaiYou', off)
    var pl = getUIPlayer(off);
    if(!pl) return;
    showHandCard_yiJiaoLaiYou(node, off);
    MjClient.playui.CardLayoutRestore(node, off);
    cc.log('updateHeadUI_yiJiaoLaiYou update success', off)
...
function SetUserVisible_yiJiaoLaiYou(node, off)
{
    if (_isShowShaiziAni_yiJiaoLaiYou)  // 解决摇骰子时断线重连调用本函数，会手牌重复的bug by cyc
        return;
...
function showHandCard_yiJiaoLaiYou(node, off)
{
    var sData = MjClient.data.sData;
    var tData = sData.tData;
    var pl = getUIPlayer(off);
...
function InitUserHandUI_yiJiaoLaiYou(node, off)
{
    var sData = MjClient.data.sData;
    var tData = sData.tData;
    var pl = getUIPlayer(off);
...
function initFlower_yiJiaoLaiYou() {
    initFlower(false, false);
}


var PlayLayer_yiJiaoLaiYou = cc.Layer.extend({
    jsBind: {
        _event: {
            mjhand: function() {
            ...
            roundEnd: function() {
                ...
                function showEndCards()
                {
                    ...
                    self.addChild(new EndOneView_YiJiaoLaiYou(),500);
                }
                function delayExe()
                {
        ...
        BtnPutCard:{ //add by  sking for put card button
            ...
            _event:{
                ...
                waitPut: function() {
                    if (_isShowShaiziAni_yiJiaoLaiYou) return;
        ...
        down: {
            ...
            _event: {
                ...
                initSceneData: function(eD) {
                    SetUserVisible_yiJiaoLaiYou(this, 0);
                ...
                mjhand: function(eD) {
                    InitUserHandUI_yiJiaoLaiYou(this, 0);
                ...
                MJPeng: function(eD) {
                    ...
                    updateHeadUI_yiJiaoLaiYou(this, 0);
        ...
        right: {
            ...
            _event: {
                ...
                initSceneData: function(eD) {
                    SetUserVisible_yiJiaoLaiYou(this, 1);
                },
                addPlayer: function(eD) {
                    SetUserVisible_yiJiaoLaiYou(this, 1);
                },
                ...
                mjhand: function(eD) {
                    if (!showShaiziAni_yiJiaoLaiYou)
						InitUserHandUI_yiJiaoLaiYou(this, 1);
                },
                roundEnd: function() {
                ...
                MJPeng: function(eD) {
                    if (MjClient.rePlayVideo != -1)
                        ...
                        updateHeadUI_yiJiaoLaiYou(this, 1);
                    setUserOffline(this, 1);
                },
                MJHu: function(eD) {
        ...
        top: {
            ...
            _event: {
                ...
                initSceneData: function(eD) {
                    SetUserVisible_yiJiaoLaiYou(this, 2);
                },
                addPlayer: function(eD) {
                    SetUserVisible_yiJiaoLaiYou(this, 2);
                },
                ...
                mjhand: function(eD) {
                    if (!showShaiziAni_yiJiaoLaiYou)
						InitUserHandUI_yiJiaoLaiYou(this, 2);
                },
                roundEnd: function() {
                ...
                MJPeng: function(eD) {
                    if (MjClient.rePlayVideo != -1)
                        ...
                        updateHeadUI_yiJiaoLaiYou(this, 2);
                    setUserOffline(this, 2);
                },
                MJHu: function(eD) {
        ...
        left: {
            ...
            _event: {
                ...
                initSceneData: function(eD) {
                    SetUserVisible_yiJiaoLaiYou(this, 3);
                },
                addPlayer: function(eD) {
                    SetUserVisible_yiJiaoLaiYou(this, 3);
                },
                ...
                mjhand: function(eD) {
                    if (!showShaiziAni_yiJiaoLaiYou)
						InitUserHandUI_yiJiaoLaiYou(this, 3);
                },
                roundEnd: function() {
                ...
                MJPeng: function(eD) {
                    if (MjClient.rePlayVideo != -1)
                        ...
                        updateHeadUI_yiJiaoLaiYou(this, 3);
                    setUserOffline(this, 3);
                },
                MJHu: function(eD) {
            ...
            changeui: {
                ...
                changeuibg: {
                    ...
                    guobg: {
                        guo: {
                            _touch: function(btn, eT) {
                                if (eT == 2) MjClient.MJPass2NetForyiJiaoLaiYou();
                            }
                        },
                        fanhui: {
                            _touch: function(btn, et) {
...
PlayLayer_yiJiaoLaiYou.prototype.CardLayoutRestore = function(node, off, isNewCard)
{
    ...
    var uiOrder = [uichaotian, uigang1, uigang0, uipeng, uichi, uistand];
...
// 判断吃碰杠胡的状态
PlayLayer_yiJiaoLaiYou.prototype.EatVisibleCheck = function()
{
    var eat = MjClient.playui.jsBind.eat;
...
PlayLayer_yiJiaoLaiYou.prototype.jiaozhuToPiaoniao = function(jiazhuLayer, msg) {
    var tData = MjClient.data.sData.tData;
...
//及时刷新杠分
PlayLayer_yiJiaoLaiYou.prototype.updateGangScore = function(node, data, off){
    node.visible = true;
...
PlayLayer_yiJiaoLaiYou.prototype.DealMJGang = function(node, msg, off)
{
...
PlayLayer_yiJiaoLaiYou.prototype.HandleMJHu = function (node, msg, off)
{
    var sData = MjClient.data.sData;
    var tData = sData.tData;
    var selfIndex = getPlayerIndex(off);
...
PlayLayer_yiJiaoLaiYou.prototype.showEndInfo = function (msg , off) {
...
PlayLayer_yiJiaoLaiYou.prototype.set3DCardSprite = function(off,noSortHand)
{
    // node 是克隆新建的一个麻将节点 by sking
    ...
    var uiOrder = [uichaotian,uigang1, uigang0, uipeng, uichi, uistand,uiwang];
    if(off == 1 || off == 2)
    {
        uiOrder.reverse();//颠倒顺序
    }
...
PlayLayer_yiJiaoLaiYou.prototype.HandleMJFlower = function(node,msg,off)
{
    var sData=MjClient.data.sData;
    var tData=sData.tData;
    var selfIndex=getPlayerIndex(off);
...
PlayLayer_yiJiaoLaiYou.prototype.dealSiLaiYouXi = function()
{
...
PlayLayer_yiJiaoLaiYou.prototype.newUpdateGangScore = function(node, data, off){
    var sData = MjClient.data.sData;
    if(!sData){
        return;
    }
