...
var CreateRoomNode_yiJiaoLaiYou = CreateRoomNode.extend({
    setKey: function() {
        this.localStorageKey.KEY_YIJIAOLAIYOU_laitype                  = "_YIJIAOLAIYOU_LAI_WAY";       		//赖的方式
        this.localStorageKey.KEY_YIJIAOLAIYOU_diaoyu                = "_YIJIAOLAIYOU_DIAO_YU";       	//钓鱼
        this.localStorageKey.KEY_YIJIAOLAIYOU_liangundaipa               = "_YIJIAOLAIYOU_LIAN_GUN_DAI_PA";       	//连滚带爬
        this.localStorageKey.KEY_YIJIAOLAIYOU_silaixifen          = "_YIJIAOLAIYOU_SI_LAI_XI_FEN";  //4赖喜分
        this.localStorageKey.KEY_YIJIAOLAIYOU_qiangganghu              = "_YIJIAOLAIYOU_QIANG_GANG_HU";       	//抢杠胡
        this.localStorageKey.KEY_YIJIAOLAIYOU_qianggangquanbao                    = "_YIJIAOLAIYOU_QIANG_GANG_QUAN_BAO";       		//抢杠全包
        this.localStorageKey.KEY_YIJIAOLAIYOU_youlaizikeqianggang      = "_YIJIAOLAIYOU_YOU_LAI_ZI_KE_QIANG_GANG";//有赖子可抢杠
        this.localStorageKey.KEY_YIJIAOLAIYOU_piaofen 		 = "_YIJIAOLAIYOU_PIAO_FEN";//飘分
        this.localStorageKey.KEY_YIJIAOLAIYOU_count      = "_YIJIAOLAIYOU_COUNT";//有赖子可抢杠
        this.localStorageKey.KEY_YIJIAOLAIYOU_difen 		 = "_YIJIAOLAIYOU_DI_FEN";//底分
        this.localStorageKey.KEY_YIJIAOLAIYOU_fangGang       = "_YIJIAOLAIYOU_FANG_GANG";//放杠
        this.localStorageKey.KEY_YIJIAOLAIYOU_queyimen 		 = "_YIJIAOLAIYOU_QUE_YI_MEN";//缺一门
        this.localStorageKey.KEY_YIJIAOLAIYOU_tuoguan                  = "_YIJIAOLAIYOU_tuoguan";               //托管
        this.localStorageKey.KEY_YIJIAOLAIYOU_isOpenTingTip             = "_YIJIAOLAIYOU_isOpenTingTip";    //是否开启听牌提示
    },
    ...
    getSelectedPara: function() {
        var para = {};
        para.gameType = MjClient.GAME_TYPE.YUE_YANG_YI_JIAO_LAI_YOU;
        para.maxPlayer = 4;
        ...
        para.diaoYu = this._playNode_diaoyu.isSelected(); //钓鱼
