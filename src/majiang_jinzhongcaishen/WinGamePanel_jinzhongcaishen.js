...
function CardLayoutRestoreForEndOne_jinzhong(node, endonepl)
{
...
function SetEndOneUserUI_jinzhongcaishen(node,off)
{
	var sData=MjClient.data.sData;
	var tData=sData.tData;
...
var EndOneView_jinzhongcaishen = cc.Layer.extend({
	jsBind:{
		block: {
		...
		btnShowHeap:{
                ...
                _click:function()
                {
                	if(MjClient.endoneui){
                        var jinzhongcaishenCardsHeap = new PopupShowCardsHeap();
                        jinzhongcaishenCardsHeap.setName("jinzhongCardsHeap");
                        MjClient.endoneui.addChild(jinzhongcaishenCardsHeap);
                    }
                },
            },
        dir: {
		...
		head0:{
		   ...
		   _run:function(){ SetEndOneUserUI_jinzhongcaishen(this,0); },
		...
		head1:{
		  ...
		  _run:function(){ SetEndOneUserUI_jinzhongcaishen(this,1); }
		},
		head2:{
		   head:{
			   zhuang:{_visible:false}
		   ...
		   _run:function(){ SetEndOneUserUI_jinzhongcaishen(this,2); }
		},
		head3:{
			 head:
			 {
			...
			_run:function(){ SetEndOneUserUI_jinzhongcaishen(this,3); }
			},
		count_down:{
                _visible :function()
                {
    ...
    ctor:function () {
        this._super();
        var endoneui = ccs.load(res.EndOne_jinzhong_json);
