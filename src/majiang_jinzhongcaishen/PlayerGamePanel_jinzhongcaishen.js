...
//向服务器发送 过消息
MjClient.MJPass2NetForjinzhongcaishen = function()
{
   // console.log(">>>>>>>>>普通  过 <<<<<<<<");
    cc.log("====================MJPass2NetForjinzhongcaishen======pass=====");
...
function SetUserVisible_jinzhongcaishen(node, off)
{
    //var sData = MjClient.data.sData;
    //return;
...
//处理出牌,放一张牌，打牌动作
function DealMJPut_jinzhongcaishen(node, msg, off, outNum)
{
...
function InitUserHandUI_jinzhongcaishen(node, off)
{
    var sData = MjClient.data.sData;
    var tData = sData.tData;
    var pl = getUIPlayer(off);
    ...
    for(var i = 0; i < pl.mjput.length; i++)
    {
        ...
        DealMJPut_jinzhongcaishen(node, msg, off, i);
    }
...
function initFlower_jinzhongcaishen() {
    initFlower(false, false);
}


var PlayLayer_jinzhongcaishen = cc.Layer.extend({
    jsBind: {
        _event: {
            mjhand: function() {
            ...
            roundEnd: function() {
                ...
                function delayExe()
                {
                    ...
                    self.addChild(new EndOneView_jinzhongcaishen(),500);
                }
        ...
        eat: {
            ...
            guo: {
                ...
                _touch: function(btn, eT) {
                    if (eT == 2)
                    {
                        MjClient.MJPass2NetForjinzhongcaishen();
                    }
                },
                bgimg: {
                    _run: function() {
            ...
            changeui: {
                ...
                changeuibg: {
                    ...
                    guobg: {
                        guo: {
                            _touch: function(btn, eT) {
                                if (eT == 2) MjClient.MJPass2NetForjinzhongcaishen();
                            }
                        },
                        fanhui: {
                            _touch: function(btn, et) {
...
PlayLayer_jinzhongcaishen.prototype.CardLayoutRestore = function(node, off)
{
    ...
    if(newC)
    {
        ...
        cc.log("================044444444444444444=========isEqualHunCard======================newVal = " + newC.tag);
...
// 判断吃碰杠胡的状态
PlayLayer_jinzhongcaishen.prototype.EatVisibleCheck = function()
{
    var eat = MjClient.playui.jsBind.eat;
...
PlayLayer_jinzhongcaishen.prototype.sendMessage_MJHu = function()
{
...
/*
    玩家ui，信息
 */
PlayLayer_jinzhongcaishen.prototype.Node_player = function(off)
{
    ...
    UIEventBind(null, _node, "initSceneData", function (eD) {
        SetUserVisible_jinzhongcaishen(_node, off);
    ...
    UIEventBind(null, _node, "mjhand", function (eD) {
        InitUserHandUI_jinzhongcaishen(_node, off);
    });
    ...
    UIEventBind(null, _node, "MJPut", function (eD) {
        ...
        // }
        DealMJPut_jinzhongcaishen(_node,eD,off);
        hideTingBtn();
        if(_tingCardNumNode) _tingCardNumNode.visible = false;
    ...
    switch (off)
    {
        ...
        case 2:
            ...
            setWgtLayout(_ready,[0.07, 0.07], [0.5, 0.5], [0, 1.5]);
            setWgtLayout(_stand,[0, 0.07],[0.5 -0.05, 1], [-6, -1.0]);
