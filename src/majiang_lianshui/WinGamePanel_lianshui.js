...
function SetEndOneUserUI_lianshui(node,off)
{
...
var EndOneView_lianshui = cc.Layer.extend({
	jsBind:{
		block: {
		...
		dir:
		{
			...
			_text: function () {
                ...
                if (tData.areaSelectMode.difen) {
                    text += "积分底分" + Number(tData.areaSelectMode.difen) + ",";
                }
		...
		head0:{
		   ...
		   _run:function(){ SetEndOneUserUI_lianshui(this,0); },
		...
		,head1:{ 
		  ...
		  _run:function(){ SetEndOneUserUI_lianshui(this,1); }
		}
		...
		,head2:{ 
		   ...
		   _run:function(){ SetEndOneUserUI_lianshui(this,2); }
		}
		,head3:{
			 head:
			 {
			...
			_run:function(){ SetEndOneUserUI_lianshui(this,3); }
			},
            count_down:{
                _visible :function()
                {
    ...
    ctor:function () {
        this._super();
        var endoneui = ccs.load(res.EndOne_lianshui_json);
