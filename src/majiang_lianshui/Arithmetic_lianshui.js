...
(function() {
    var majiang = {};
    var flowerArray = [111, 121, 131, 141, 151, 161, 171, 181,71];//花的列表，根据不同来设置
    ...
    majiang.canTing = function (cds) {
        ...
        for(var tingCard in tingSet) {
            ...
            if(this.isCardFlower(cd))
            {
                tingSet.splice(tingSet.indexOf(cd),1)
            }
        }
    ...
    majiang.getAllCardsTotal = function ()
    {
        ...
        // if (tData.areaSelectMode.flowerType == WithFlowerType.commonFlower)
        // {
        //     return 144;
        // }
        return 120;
    ...
    {
        MjClient.majiang_lianshui = majiang;
    }
    else
    {
