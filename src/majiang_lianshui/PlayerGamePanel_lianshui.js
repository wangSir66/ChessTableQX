...
//向服务器发送 过消息
MjClient.MJPass2NetForLianshui = function()
{
   // console.log(">>>>>>>>>普通  过 <<<<<<<<");
    cc.log("====================send======pass=====");
    ...
    if(IsTurnToMe() && tData.tState == TableState.waitPut)
    {
        ...
        if (tData)
        {
            ...
            if(_num <= 7)
            {
                return MjClient.showToast("最后一张牌不能过");
            }
        }
...
function SetUserVisible_Lianshui(node, off)
{
    //var sData = MjClient.data.sData;
    //return;
    cc.log("====================off======================" + off);
...
function InitUserHandUI_Lianshui(node, off)
{
    var sData = MjClient.data.sData;
    var tData = sData.tData;
    var pl = getUIPlayer(off);
...
function initFlower_Lianshui() {
    initFlower(false, false);
}


var PlayLayer_Lianshui = cc.Layer.extend({
    jsBind: {
        _event: {
            mjhand: function() {
            ...
            roundEnd: function() {
                ...
                function delayExe()
                {
                    ...
                    self.addChild(new EndOneView_lianshui(),500);
                }
        ...
        roundInfo:{
            ...
            _run:function()
            {
                ...
                var str2 = (tData.areaSelectMode.baoZhuangType == 0)? "小包庄,":"大包庄,";
                if(tData.areaSelectMode.baoZhuangType == 1)
                {
                    if(tData.areaSelectMode.zhuangTing)
                    {
                        str2 += "必须听牌,"
                    }
                }
                ...
                if (tData.areaSelectMode.difen) {
                    str2 += "积分底分" + Number(tData.areaSelectMode.difen) + ",";
                }

                str = str2 + strPayWay;
                this.ignoreContentAdaptWithSize(true);
                this.setString(str);
                showPlayUI_roundInfo(str, tData.tableid);
        ...
        wait: {
            getRoomNum: {
                ...
                _click: function() {
                    ...
                    var str5 = strPayWay;
                    var str6 = tData.roundNum + "局,三缺一,速度加入【"+AppCnName[MjClient.getAppType()]+"】\n" + "(复制此消息打开游戏可直接进入该房间)";
                    GLog(str1+ str5+str6);
            ...
            wxinvite: {
                ...
                _click: function() {
                    ...
                    GLog(str1+str2+strPayWay+str6 + txt_club);
                    MjClient.native.wxShareUrl(MjClient.remoteCfg.entreRoomUrl+"?vipTable="+tData.tableid,
                        (tData.ruleName ? unescape(tData.ruleName) : GameCnName[MjClient.gameType]) + "  " + tData.tableid + "  三缺一  点击加入>>>" + txt_club,
                        (tData.ruleName ? GameCnName[MjClient.gameType] + "," : "") + str1+str2+ strPayWay +str6);
                    */
                },
                _visible:function()
                {
        ...
        down: {
            ...
            _event: {
                ...
                initSceneData: function(eD) {
                    SetUserVisible_Lianshui(this, 0);
                },
                addPlayer: function(eD) {
                    SetUserVisible_Lianshui(this, 0);
                },
                ...
                mjhand: function(eD) {
                    InitUserHandUI_Lianshui(this, 0);
                },
                roundEnd: function() {
                ...
                MJPut: function(eD) {
                    ...
                    if (eD.uid == SelfUid() ) //&& pl.isTing
                    {
                        ...
                        cc.log(">>>>>>>>>>>>>>>>>>>>>>>tingCardsNode>>>>>>>>MJPut---------------= " + JSON.stringify(tingSet));
        ...
        right: {
            ...
            _event: {
                ...
                initSceneData: function(eD) {
                    SetUserVisible_Lianshui(this, 1);
                },
                addPlayer: function(eD) {
                    SetUserVisible_Lianshui(this, 1);
                },
                ...
                mjhand: function(eD) {
                    InitUserHandUI_Lianshui(this, 1);
                },
                roundEnd: function() {
        ...
        top: {
            ...
            _event: {
                ...
                initSceneData: function(eD) {
                    SetUserVisible_Lianshui(this, 2);
                },
                addPlayer: function(eD) {
                    SetUserVisible_Lianshui(this, 2);
                },
                ...
                mjhand: function(eD) {
                    InitUserHandUI_Lianshui(this, 2);
                },
                roundEnd: function() {
        ...
        left: {
            ...
            _event: {
                ...
                initSceneData: function(eD) {
                    SetUserVisible_Lianshui(this, 3);
                },
                addPlayer: function(eD) {
                    SetUserVisible_Lianshui(this, 3);
                },
                ...
                mjhand: function(eD) {
                    InitUserHandUI_Lianshui(this, 3);
                },
                roundEnd: function() {
        ...
        eat: {
            ...
            ting: {
                ...
                _touch: function(btn, eT) {
                    if (eT == 2)
                    {
                         ...
                         */
                        var pl = getUIPlayer(0);
                        if(!pl.isTing && pl.putCount <= 0 && tData.uids[tData.zhuang] != SelfUid() && MjClient.fistTing) //闲家起手听牌算闷子
                        {
                            cc.log("=========================闷子---起手，听牌");
                            MJTingToServer();
                        }
                        ...
                        cc.log("================currentCard = " + currentCard);
            ...
            guo: {
                ...
                _touch: function(btn, eT) {
                    if (eT == 2)
                    {
                        MjClient.MJPass2NetForLianshui();
                    }
                },
                bgimg: {
                    _run: function() {
            ...
            changeui: {
                ...
                changeuibg: {
                    ...
                    guobg: {
                        guo: {
                            _touch: function(btn, eT) {
                                if (eT == 2) MjClient.MJPass2NetForLianshui();
                            }
                        },
                        fanhui: {
                            _touch: function(btn, et) {
    ...
    ctor: function() {
        this._super();
        var playui = ccs.load(res.Play_lianshui_json);
     ...
     tingIconVisible:function(node,off)
    {
        ...
        if(pl && (pl.mjState == TableState.isReady || pl.mjState == TableState.roundFinish))
        {
            ...
            if(pl != null)
            {
                if (pl.isTianting) {
                    cc.log("天听。。。。。");
                    var tingNode = getNode(off).getChildByName("head").getChildByName("tingIcon");
                    tingNode.loadTexture("playing/gameTable/tianting.png");
                    tingNode.ignoreContentAdaptWithSize(true);
                    node.visible = true;
                    this._tingCardsNode.visible = false;
                    ...
                    var tingNode = getNode(off).getChildByName("head").getChildByName("tingIcon");
                    tingNode.loadTexture("playing/gameTable/icon_ting.png");
                    tingNode.ignoreContentAdaptWithSize(true);
                    if(pl.isTing)
                    {
                        node.visible = true;
    ...
    */
    setTingCardInfo:function(node,eD,off)
    {
        ...
        if(pl.isTing)
        {
            if(pl.putCardAfterTing && pl.putCardAfterTing > 0)
            {
...
PlayLayer_Lianshui.prototype.CardLayoutRestore = function(node, off)
{
...
// 判断吃碰杠胡的状态
PlayLayer_Lianshui.prototype.EatVisibleCheck = function()
{
    var eat = MjClient.playui.jsBind.eat;
    ...
    {
        cc.log("44444444444444444444444起手听牌算闷子4444444 " );
    }
    else
    {
        cc.log("MjClient.起手听牌算闷子 pl.isTing =---------------------- " + pl.isTing);
        cc.log("MjClient.起手听牌算闷子pl.putCount =---------------------- " + pl.putCount);
        if(!pl.isTing &&  pl.putCount <= 0 && tData.tState == TableState.waitPut) //起手听牌算闷子
        {
            _isQiShow = true;
        }
        else
        ...
        cc.log("MjClient.起手听牌算闷子 =---------------------- " );
    }


    cc.log("2222222222222222222222222222222222222222222222220000" );
    //自摸
    if((tData.tState == TableState.waitPut && pl.mjState == TableState.waitPut)|| _isQiShow)
    {
        //if(IsTurnToMe())
        {
            ...
            if (!pl.isTing) {
                cc.log("￥￥￥￥听牌监测");
                cc.log("￥￥￥￥听牌监测 pl.mjhand  = " + pl.mjhand);
                MjClient.canTingCards = {};
                for (var i = 0; i < pl.mjhand.length; i++) {
                    var cardsAfterPut = pl.mjhand.slice();
                    if(_isQiShow && tData.uids[tData.zhuang] != SelfUid())
                    {
                        //起手不是庄家
                        cc.log("起手不是庄家---");
                    }
                ...
                cc.log("￥￥￥￥听牌监测 canTingCards  = " + JSON.stringify(MjClient.canTingCards));
                cc.log("￥￥￥￥听牌监测 Object.keys(MjClient.canTingCards).length = " + Object.keys(MjClient.canTingCards).length);

                MjClient.fistTing = false;
                if(pl.putCount <= 0  && pl.mjhand.length == _cardCount)//起手听牌不受张数限制
                {

                    if (Object.keys(MjClient.canTingCards).length >= 1) { //只要有听得牌就可以了
                        if (vnode.indexOf(eat.ting._node) < 0) {

                            cc.log("===闲家起手听牌----- :  ");
                            MjClient.fistTing = true;
                ...
                {
                    //小包庄，胡多张时不能听,只能听一张
                    if(tData.areaSelectMode.baoZhuangType == 0)
                    {
                        var newTingCards = {};
                        var bshowTing = false;
                        cc.log("------------- MjClient.canTingCards = " + JSON.stringify(MjClient.canTingCards));
                        for(var card in MjClient.canTingCards)
                        {
                            var tingCards = getCheckTingHuCards(parseInt(card),pl.mjhand);
                            if(Object.keys(tingCards).length == 1)
                            {
                                //有听单张了，需要提示
                                newTingCards[card] = 1; //排除能听2张的情况
                                bshowTing = true;
                            }
                        }

                        cc.log("------------- tingCards = " + JSON.stringify(newTingCards));
                        if(bshowTing)
                        {
                            MjClient.canTingCards = newTingCards;
                            if (vnode.indexOf(eat.ting._node) < 0) {
                                vnode.push(eat.ting._node);
                            }
                        }
                        ...
                        cc.log("===MjClient.canTingCards ===  " + JSON.stringify(MjClient.canTingCards));
                        if(Object.keys(MjClient.canTingCards).length > 0)
                        {
                            if (vnode.indexOf(eat.ting._node) < 0) {
                                vnode.push(eat.ting._node);
                            }
            ...
            if(pl.putCount <= 0  && pl.mjhand.length == _cardCount && tData.uids[tData.zhuang] != SelfUid())//起手听牌不受张数限制
            {
                 //起手不提示杠按钮,do nothing
            }
            else {
    ...
    {
        cc.log("别人点================================================pl.eatFlag = " + pl.eatFlag );
        if(!IsTurnToMe())
        {
            if (pl.eatFlag & 8) {
                vnode.push(eat.hu._node);
