...
function SetUserVisible_baoPaiYZ(node, off) {
    ...
    if (pl) {
        ...
        InitUserHandUI_baoPaiYZ(node, off);
    } else {
        name.visible = false;
        coin.visible = false;
...
function InitUserHandUI_baoPaiYZ(node, off) {
...
function cardsSort_baoPaiYZ(cards) {
    var pointCounts = {};
...
var PlayLayer_baoPaiYZ = cc.Layer.extend({
    _btnPutCard: null,
    jsBind: {
        _event: {
            mjhand: function() {
            ...
            roundEnd: function() {
                ...
                function delayExe() {
                    ...
                    self.addChild(new EndOneView_baoPaiYZ(), 500);
                }
            ...
            moveHead: function() {
                if (MjClient.playui.headMoved)
                    return;

                MjClient.playui.headMoved = true;
        ...
        scoreBanner: {
            ...
            _event: {
                ...
                waitPut: function(d) {
                    ...
                    var tData = MjClient.data.sData.tData;
                    var winType = MjClient.majiang.countWinType(tData.jiaoFen, tData.fenPaiArr, false, 0, tData.areaSelectMode["daDaoBuFengDing"]);
                ...
                initSceneData: function() {
                    var tData = MjClient.data.sData.tData;
                    if (tData.tState == TableState.waitPut)
                        MjClient.playui.winType = MjClient.majiang.countWinType(tData.jiaoFen, tData.fenPaiArr, false, tData.areaSelectMode["daDaoBuFengDing"]);
                    else
        ...
        BtnPutCard: {
            ...
            _click: function(btn) {
                ...
                cardsSort_baoPaiYZ(MjClient.selectCards_card);
            ...
            _event: {
                ...
                PKPut: function(eD) {
                    ...
                    var tData = MjClient.data.sData.tData;
                    var cardType = MjClient.majiang.cardsType(eD.card, tData.zhuPaiType);
                ...
                waitPut: function() {
                    ...
                    var waitPutFunc = function()
                    {
                        ...
                        if (tData.areaSelectMode.allowHanLai) {
                            MjClient.playui.jsBind.BtnHanLai._node.visible = (tData.uids[tData.zhuang] != SelfUid() && keysLen == 1 && tData.firstPutCardUid == tData.uids[tData.zhuang] && !getUIPlayer(0).hanlai);
                        }
                ...
                initSceneData: function() {
                    ...
                    if (tData.areaSelectMode.allowHanLai) {
                        if (tData.tState != TableState.waitPut)
                            MjClient.playui.jsBind.BtnHanLai._node.visible = false;
                        else {
                            var records = tData.putCardsRecord;
                            var keysLen = records.length > 0 ? Object.keys(records[records.length - 1]).length : 0;
        ...
        BtnShuaiPai: {
            _run: function() {
                ...
                if(isIPhoneX())
                {
                    setWgtLayout(this, [0.135, 0.128], [0.5, 0.44], [-0.8, 0.5]);
                }
                else {
        ...
        BtnHanLai: {
            ...
            _click: function(btn) {
                ...
                MjClient.gamenet.request("pkroom.handler.tableMsg", {cmd: "c2s_sdhHanLai"});
            }
        },
        BtnReady: {
            _visible: false,
        ...
        down: {
            head: {
                ...
                jiaChuiTag: {
                    _visible: false,
                    _event: {
                        s2c_jiaChui: function(eD) {
                            var mySelf = getUIPlayer(0);

                            if (mySelf.info.uid != eD.uid)
                                return;

                            this.visible = mySelf.jiaChui;
                        },
                        initSceneData: function(eD) {
                            MjClient.playui.setJiaChuiTagVisible(this,0);
                        },
            ...
            laiFenTag: {
                _run: function() {
                    ...
                    this.setScale(screenScale);

                    var deskCardPos = MjClient.clockNode.srcPosition;
                    this.setPosition(cc.p(deskCardPos.x - (MjClient.clockNode.width * MjClient.clockNode.scale / 2 + (this.width / 2 + 10) * screenScale),deskCardPos.y));
                },
                _visible: false,
                _event: {
                    s2c_sdhHanLai: function(d) {
                        MjClient.playui.setLaiFenTagVisible(this,0);
                    },
                    PKPut: function(d) {
                        MjClient.playui.setLaiFenTagVisible(this,0);
                    },
            ...
            _event: {
                ...
                initSceneData: function(eD) {
                    ...
                    SetUserVisible_baoPaiYZ(this, 0);
                ...
                mjhand: function(eD) {
                    ...
                    InitUserHandUI_baoPaiYZ(this, 0);
                    MjClient.playui.defen = 0;
        ...
        right: {
            head: {
                ...
                laiFenTag: {
                    ...
                    _event: {
                        s2c_sdhHanLai: function(d) {
                            MjClient.playui.setLaiFenTagVisible(this,1);
                        },
                        PKPut: function(d) {
                            MjClient.playui.setLaiFenTagVisible(this,1);
                        },
                ...
                jiaChuiTag: {
                    ...
                    _event: {
                        mjhand: function(eD) {
                            MjClient.playui.setJiaChuiTagVisible(this,1);
                        },
                        initSceneData: function(eD) {
                            MjClient.playui.setJiaChuiTagVisible(this,1,true);
                        },
                        roundEnd: function(eD) {
                            this.visible = false;
                        }
            ...
            _event: {
                ...
                initSceneData: function(eD) {
                    SetUserVisible_baoPaiYZ(this, 1);
                },
                addPlayer: function(eD) {
                    SetUserVisible_baoPaiYZ(this, 1);
                },
                ...
                mjhand: function(eD) {
                    InitUserHandUI_baoPaiYZ(this, 1);
                },
                roundEnd: function() {
        ...
        top: {
            ...
            head: {
                ...
                laiFenTag: {
                    ...
                    _event: {
                        s2c_sdhHanLai: function(d) {
                            MjClient.playui.setLaiFenTagVisible(this,2);
                        },
                        PKPut: function(d) {
                            MjClient.playui.setLaiFenTagVisible(this,2);
                        },
                ...
                jiaChuiTag: {
                    ...
                    _event: {
                        mjhand: function(eD) {
                            MjClient.playui.setJiaChuiTagVisible(this,2);
                        },
                        initSceneData: function(eD) {
                            MjClient.playui.setJiaChuiTagVisible(this,2,true);
                        },
                        roundEnd: function(eD) {
                            this.visible = false;
                        }
            ...
            _event: {
                ...
                initSceneData: function(eD) {
                    SetUserVisible_baoPaiYZ(this, 2);
                },
                addPlayer: function(eD) {
                    SetUserVisible_baoPaiYZ(this, 2);
                },
                ...
                mjhand: function(eD) {
                    InitUserHandUI_baoPaiYZ(this, 2);
                },
                roundEnd: function() {
        ...
        left: {
            head: {
                ...
                laiFenTag: {
                    ...
                    _event: {
                        s2c_sdhHanLai: function(d) {
                            MjClient.playui.setLaiFenTagVisible(this,3);
                        },
                        PKPut: function(d) {
                            MjClient.playui.setLaiFenTagVisible(this,3);
                        },
                ...
                jiaChuiTag: {
                    ...
                    _event: {
                        mjhand: function(eD) {
                            MjClient.playui.setJiaChuiTagVisible(this,3);
                        },
                        initSceneData: function(eD) {
                            MjClient.playui.setJiaChuiTagVisible(this,3,true);
                        },
                        roundEnd: function(eD) {
                            this.visible = false;
                        }
            ...
            _event: {
                ...
                initSceneData: function(eD) {
                    SetUserVisible_baoPaiYZ(this, 3);
                },
                addPlayer: function(eD) {
                    SetUserVisible_baoPaiYZ(this, 3);
                },
                ...
                mjhand: function(eD) {
                    InitUserHandUI_baoPaiYZ(this, 3);
                },
                roundEnd: function() {
            ...
            chaPaiPanel: {
                ...
                _run: function() {
                    ...
                    if (MjClient.rePlayVideo != -1)
                    {
                        ...
                        MjClient.playui.jsBind.BtnHanLai._node.y -= 50;

                        MjClient.playui.jsBind.panel.jiaChuiWaitTip._node.y -= 100;
                        MjClient.playui.jsBind.panel.BtnJiaChui._node.y -= 100;
                        MjClient.playui.jsBind.panel.BtnBuJiaChui._node.y -= 100;
                    }
                }
            },
            _event: {
                ...
                s2c_jiaChui: function(msg) {
                    var mySelf = getUIPlayer(0);

                    if (mySelf.info.uid != msg.uid)
                        return;

                    this.getChildByName("jiaChuiWaitTip").visible = true;
                    this.getChildByName("BtnJiaChui").visible = false;
                    this.getChildByName("BtnBuJiaChui").visible = false;
                },
                initSceneData: function(msg) {
                    ...
                    if (!mySelf) {
                        this.getChildByName("jiaChuiWaitTip").visible = false;
                        this.getChildByName("BtnJiaChui").visible = false;
                        this.getChildByName("BtnBuJiaChui").visible = false;
                        return;
                    }

                    this.getChildByName("jiaChuiWaitTip").visible = tData.areaSelectMode.jiaChui && tData.tState == TableState.waitJiazhu && mySelf.mjState == TableState.isReady;
                    this.getChildByName("BtnJiaChui").visible = tData.areaSelectMode.jiaChui && tData.tState == TableState.waitJiazhu && mySelf.mjState == TableState.waitJiazhu;
                    this.getChildByName("BtnBuJiaChui").visible = tData.areaSelectMode.jiaChui && tData.tState == TableState.waitJiazhu && mySelf.mjState == TableState.waitJiazhu;

                    MjClient.playui.headMoved = !(tData.tState == TableState.waitJoin || tData.tState == TableState.roundFinish || tData.tState == TableState.waitReady);
                },

                waitJiaChui: function(msg) {
                    var tData = MjClient.data.sData.tData;

                    this.getChildByName("BtnJiaChui").visible = true;
                    this.getChildByName("BtnBuJiaChui").visible = true;
                ...
                roundEnd: function() {
                    MjClient.playui.headMoved = false;
                }
            }
        },
        gps_btn: {
    ...
    ctor: function() {
        this._super();
        var playui = ccs.load(res.Play_baoPaiYZ_json);
...
PlayLayer_baoPaiYZ.prototype.reConnectShowDeskCard = function() {
    var tData = MjClient.data.sData.tData;
...
PlayLayer_baoPaiYZ.prototype.cannotOutCardGrey = function() {
...
PlayLayer_baoPaiYZ.prototype.recoverCannotOutCard = function() {
    var children = this._downNode.children;
    for (var i = 0; i < children.length; i++) {
        if (children[i].name != "mjhand")
            continue;
...
PlayLayer_baoPaiYZ.prototype.clockNumberUpdate = function(node, endFunc) {
    return arrowbkNumberUpdate(node, endFunc);
}

PlayLayer_baoPaiYZ.prototype.updateClockPosition = function(arrowNode) {
    var tData = MjClient.data.sData.tData;
    var uids = tData.uids;
 ...
 * @return {String}
 */
PlayLayer_baoPaiYZ.prototype.getGameInfoString = function(param) {
    var tData = MjClient.data.sData.tData;
...
PlayLayer_baoPaiYZ.prototype.updateOperateBtnPosition = function() {
    ...
    var hanLaiBtn = this.jsBind.BtnHanLai._node;

    if (!putCardBtn.isVisible() && !hanLaiBtn.isVisible())
        return;

    var width = 0;
    var btns = [shuaiPaiBtn, himtBtn, hanLaiBtn, putCardBtn];
...
// 拖拉机动画
PlayLayer_baoPaiYZ.prototype.playCardAni_liandui = function() {
...
// 闲家得分达到条件时动画、投降
PlayLayer_baoPaiYZ.prototype.playWinAni = function(winType) {
    ...
    if (winType >= 3) {
        // 大倒
        file = "gameOver_baoPaiYZ/dadao.png";
    } else if (winType == 2) {
        // 小倒
        file = "gameOver_baoPaiYZ/xiaodao.png";
    } else if (winType == 1) {
        // 跨庄
        file = "gameOver_baoPaiYZ/kuazhuang.png";
    } else if (winType == -4) {
        // 投降
        file = "gameOver_baoPaiYZ/touxiang.png";
    }
...
// 刷新得分栏
PlayLayer_baoPaiYZ.prototype.refreshScoreBanner = function(shouldPlayAnim) {
    var tData = MjClient.data.sData.tData;
    ...
    if (tData.jiaoFen > 0 && tData.tState != TableState.waitJiaoFen) {
        jiaofenNum.setString((205 - tData.jiaoFen) + "");
    } else {
...
// 判断是否有不同意投降的玩家
PlayLayer_baoPaiYZ.prototype.haveNotAgreeTouXiang = function()
{
    var sData = MjClient.data.sData;
    var tData = MjClient.data.sData.tData;
...
// 重置玩家同意投降状态
PlayLayer_baoPaiYZ.prototype.initAgreeTouXiangStatus = function()
{
    var sData = MjClient.data.sData;
    var tData = MjClient.data.sData.tData;
    for (var i = 0; i < tData.uids.length; i++)
...
PlayLayer_baoPaiYZ.prototype.showWaitTip = function(bMaiPai) {
    var sData = MjClient.data.sData;
    var tData = sData.tData;
...
// 显示各玩家叫分
PlayLayer_baoPaiYZ.prototype.showJiaoFenTag = function(off) {
...
// 隐藏各玩家叫分
PlayLayer_baoPaiYZ.prototype.hideJiaoFenTag = function() {
...
// 显示叫分面板
PlayLayer_baoPaiYZ.prototype.showJiaoFenPanel = function() {
    if (MjClient.rePlayVideo != -1)
    {
        MjClient.playui.jsBind.panel.jiaoFenPanel._node.setVisible(false);
        return;
    ...
    var restBtnPos =  function(){
        var nIndex = 0;

        for (var i = 200; i >= 80; i -= 5) {
            var btn = jiaoFenPanel.getChildByName("Btn_" + i);

            var x = MjClient.playui.arrPosX[nIndex];
            var y = MjClient.playui.arrPosY[nIndex];
    ...
    var func = function() {
        var min = tData.jiaoFen > 0 ? tData.jiaoFen + 5 : 80 ;
        for (var i = 80; i <= 200; i += 5) {
            var btn = jiaoFenPanel.getChildByName("Btn_" + i);

            if(MjClient.playui.arrPosX.length <= 25){
                MjClient.playui.arrPosX.push(btn.getPositionX());
            }

            if(MjClient.playui.arrPosY.length <= 25 ){
              MjClient.playui.arrPosY.push(btn.getPositionY());  
            }
            ...
            btn.setEnabled(i >= min ? true : false);
        }
    }
...
// 把底牌添加到手牌中
PlayLayer_baoPaiYZ.prototype.addDiPaiToHand = function() {
    var tData = MjClient.data.sData.tData;
    ...
    if(pl.mjhand.length == (MjClient.MaxPlayerNum == 4 ? 27 : 34))
        return;
...
// 从手牌中移除埋的牌
PlayLayer_baoPaiYZ.prototype.removeMaiPaiFromHand = function() {
    var tData = MjClient.data.sData.tData;
    var off = getOffByIndex(tData.curPlayer);
...
// 显示投降同意选择框
PlayLayer_baoPaiYZ.prototype.showTouXuangDialog = function() {
     if (MjClient.rePlayVideo != -1)
        return;
...
// 显示叫主面板
PlayLayer_baoPaiYZ.prototype.showJiaoZhuPanel = function() {
    var tData = MjClient.data.sData.tData;
...
// 显示埋牌、投降按扭
PlayLayer_baoPaiYZ.prototype.showMaiPaiBtn = function() {
    var tData = MjClient.data.sData.tData;
    ...
    var NeedNine = (MjClient.MaxPlayerNum == 3);
...
// 显示上一轮面板
PlayLayer_baoPaiYZ.prototype.showShangYiLunPanel = function(shangYiLunPanel) {
    var tData = MjClient.data.sData.tData;
...
// 显示查看底牌面板
PlayLayer_baoPaiYZ.prototype.showDiPaiPanel = function(diPaiPanel) {
    // if (true) {
    //     showbaoPaiYZPostCardAnimation();
    //     return;
    // }
    ...
    card8.visible = (MjClient.MaxPlayerNum == 3);
    for (var i = 0; i < cards.length; i++) {
...
// 显示查牌面板
PlayLayer_baoPaiYZ.prototype.showChaPaiPanel = function(chaPaiPanel) {
    var tData = MjClient.data.sData.tData;
    var records = tData.putCardsRecord;
...
// 显示得分栏上的具体分牌
PlayLayer_baoPaiYZ.prototype.showScoreCards = function(panel, cards) {
...
// 给手牌中的主牌设置角标
PlayLayer_baoPaiYZ.prototype.setCardSprite_ZhuTag = function(node) {
    var tData = MjClient.data.sData.tData;
    ...
    sprite.setName("baoPaiYZ_zhuTag");
...
// 计算各牌色数量
PlayLayer_baoPaiYZ.prototype.getCardNumByColor = function(cards, colorIndex) {
    var num = 0;
    var types = [1, 2, 3, 0, 4]
    for (var i = 0; i < cards.length; i++) {
...
// 清空桌面
PlayLayer_baoPaiYZ.prototype.clearDesk = function() {
    cc.log("clearDesk")
...
PlayLayer_baoPaiYZ.prototype.CardLayoutRestore = function(node, off) {
    cc.log("横向排序 off=" + off);
    MjClient.playui.horSort(node, off);
};

PlayLayer_baoPaiYZ.prototype.CardLayoutDesk = function(node, cards, off) {
    //if(off != 0) return;
    var children = node.children;
    ...
    var tData = MjClient.data.sData.tData;
    var cardType = MjClient.majiang.cardsType(cards, tData.zhuPaiType);
...
//横向摆放《正常》
PlayLayer_baoPaiYZ.prototype.horSort = function(node, off) {
    var pl; //player 信息
...
PlayLayer_baoPaiYZ.prototype.DealCardEffect = function(uid, off)
{
    var tData = MjClient.data.sData.tData;
    ...
    var maxCardUid = MjClient.majiang.getMaxCardPlayerUid(roundPutCards, tData.firstPutCardUid, tData.uids, tData.zhuPaiType);
...
// 显示来分标记
PlayLayer_baoPaiYZ.prototype.setLaiFenTagVisible = function(node,off) {
    node.visible = false;
    ...
    node.visible = pl.hanlai;
}

// 显示加锤标记
PlayLayer_baoPaiYZ.prototype.setJiaChuiTagVisible = function(node,off,bReconnect) {
    node.visible = false;
    ...
    var tData = MjClient.data.sData.tData;
    var bVisible = tData.areaSelectMode.jiaChui && pl.jiaChui;

    if (bReconnect)
        bVisible = bVisible && tData.tState != TableState.waitJiazhu;

    node.visible = bVisible;
}

PlayLayer_baoPaiYZ.prototype.GetReadyVisible = function(node, off) {
    if (off < 0) {
        node.visible = false;
        return false;
    }
