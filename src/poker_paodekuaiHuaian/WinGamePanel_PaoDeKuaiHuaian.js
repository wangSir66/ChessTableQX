...
function SetEndOneUserUI_PaodekuaiHuaian(node, off) {
...
function CardLayoutRestoreForEndOne_PaodekuaiHuaian(node, plNode) {
...
var EndOneView_PaodekuaiHuaian = cc.Layer.extend({
    jsBind: {
        block: {
        ...
        back: {
            ...
            head0: {
                ...
                _run: function () { SetEndOneUserUI_PaodekuaiHuaian(this, 0); },
    		...
    		, head1: {
    		    ...
    		    _run: function () { SetEndOneUserUI_PaodekuaiHuaian(this, 1); }
    		}
    		...
    		, head2: {
    		    ...
    		    _run: function () { SetEndOneUserUI_PaodekuaiHuaian(this, 2); }
    		}
        }
    },
    ctor: function () {
        ...
        var endoneui = ccs.load(res.EndOne_PaoDeKuaiHuaian_json);
