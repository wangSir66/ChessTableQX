...
PaodekuaiHuaian.prototype.CARDTPYE = PDK_CARDTPYE;
var PDK_CARDCOUNT = {};
...
PDK_CARDCOUNT[PDK_CARDTPYE.sangeA] = 4; // 3个A带一个牌作炸弹
PDK_CARDCOUNT[PDK_CARDTPYE.sange3] = 4;
...
PaodekuaiHuaian.prototype.allTipsNoOrder = [
    [PDK_CARDTPYE.danpai, []],
    [PDK_CARDTPYE.duizi, []],
 ...
 * @return {number}
 */
PaodekuaiHuaian.prototype.calPoint = function(num, justValue) {
    if (!num)
        return -1;
 ...
 * @return {boll} 
 */
PaodekuaiHuaian.prototype.isSanShun = function(oCards){
...
// console.log( PaodekuaiHuaian.prototype.isSanShun([3,3,3]) );
 ...
 */
PaodekuaiHuaian.prototype.getSanShunAndSanPai = function(oCards){
    var countSanSame = 0;
    // 记录所有3张的数值
    var sanSameList = [];
    // 记录散牌
...
PaodekuaiHuaian.prototype.countDuiNum = function(oCards){
    var num = 0;
    var cardNumByValue = {};
    for(var i in oCards){
 ...
 */
PaodekuaiHuaian.prototype.isFeiJi = function(oCards){
 ...
 * @return {bool}
 */
PaodekuaiHuaian.prototype.isShun = function(oCards) {
...
// 是否拆散了炸弹牌型
PaodekuaiHuaian.prototype.isChaiZhaDan = function(handCards, putCards, areaSelectMode){
 ...
 * @return {bool}
 */
PaodekuaiHuaian.prototype.isLiandui = function(oCards) { //oCards有序
...
PaodekuaiHuaian.prototype.calType = function(pCards, areaSelectMode) {
    ...
    if ( PDK_CARDTPYE.sangeA > 0 && cardCount == PDK_CARDCOUNT[PDK_CARDTPYE.sangeA] && pointCounts[PDK_APOINT] == 3 && areaSelectMode.can3aZhaDan)
    ...
    // 飞机
    if( PDK_CARDTPYE.feiji > 0 && cardCount >= 6 && maxCount >= 3 && this.isFeiJi(cards)!=0 ){
    ...
    // 同花顺
    if ( PDK_CARDTPYE.sztonghua > 0 && areaSelectMode.tongHuaShun && cardCount >= 5 && maxCount == 1 && this.findShunZi(cards, cardCount, true))
    ...
    // 连对，2对起
    if ( PDK_CARDTPYE.liandui > 0 && cardCount >= PDK_CARDCOUNT[PDK_CARDTPYE.liandui] && maxCount == 2 && this.isLiandui(cards))
    ...
    //三带一
    if (PDK_CARDTPYE.sandaiyi > 0 && cardCount == 4 && maxCount == 3 )
...
// 牌点比较函数
PaodekuaiHuaian.prototype.cardValueCmp = function(a, b) {
...
// 排掉从大到小排序
PaodekuaiHuaian.prototype.cardSortBigToSmall = function(a, b) {
    var pa = this.calPoint(a);
    var pb = this.calPoint(b);
    if (pa == pb)
        return b - a;
 ...
 * @return {number} 返回癞子数
 */
PaodekuaiHuaian.prototype.transformAndGetLaizi = function(oCards, cards) {
    var laizi = 0;
    for (var i = 0; i < oCards.length; i++) {
...
PaodekuaiHuaian.prototype.getMaxDanPai = function(oCards) {
 ...
 */
PaodekuaiHuaian.prototype.sortHandCards = function(oCards, sortType) {
    var cards = oCards.slice();
 ...
 * @return {array}
 */
PaodekuaiHuaian.prototype.findNSameCard = function(hands, point, n) {
 ...
 */
PaodekuaiHuaian.prototype.delPoint = function(hands, points, values){
    var arr = hands.slice();
 ...
 */
PaodekuaiHuaian.prototype.lieju = function(parr, num){
    var tmps = [];
...
PaodekuaiHuaian.prototype.formatCards = function(oCards) {
    var info = {};
...
PaodekuaiHuaian.prototype.indexOfCards = function(cardList, cards) {
...
PaodekuaiHuaian.prototype.isSameCards = function(cards1, cards2) {
 ...
 */
PaodekuaiHuaian.prototype.findCardByRole = function(oCards, findNum, ignoreCardValued) {
...
// var fc = PaodekuaiHuaian.prototype.findCardByType([19,19,19,15,15], 0, PDK_CARDTPYE.sandaier, [9,9,9,15,15])
// console.log( fc )

PaodekuaiHuaian.prototype.getAllMaxCard = function(oCards){
...
PaodekuaiHuaian.prototype.sortByCardType = function(cardsList, areaSelectMode) {
...
PaodekuaiHuaian.prototype.findDaiPai = function(oCards, type, findNum, same, buChaiTypes) {
    var ret = [];
...
// 此函数只供提示出牌调用
PaodekuaiHuaian.prototype.findCardByType_fast = function(hands, laizi, type, lastCards, buChaiTypes) {
...
PaodekuaiHuaian.prototype.initCanPutTypes = function(hands, includeCard, areaSelectMode) {
 ...
 * @return {array} 提示的牌
 */
PaodekuaiHuaian.prototype.findPutTipCards = function(hands, lastCards, areaSelectMode, isNextPlayerOneCard, isFirstRound, putOrder, allBuChaiTypes) {
 ...
 */
PaodekuaiHuaian.prototype.IsSametipCards = function(tipscardsArray, areaSelectMode)
{
...
// console.log('PaodekuaiHuaian.prototype.checkPut', pdk.checkPut(handCards, putCards, lastCards) );
