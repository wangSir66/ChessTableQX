...
function SetUserVisible_PaodekuaiHuaian(node, off)
{
    ...
    if(pl)
    {
        ...
        InitUserHandUI_PaodekuaiHuaian(node, off);
    }
    else
    {
        name.visible = false;
...
function InitUserHandUI_PaodekuaiHuaian(node, off, needSort)
{
...
function cardsSort_PaodekuaiHuaian(cards)
{
    var pointCounts = {};
...
var PlayLayer_PaoDeKuaiHuaian = cc.Layer.extend({
    _btnPutCard:null,
    jsBind: {
        _run: function() {
        ...
        down: {
            ...
            _event: {
                ...
                initSceneData: function(eD) {
                    SetUserVisible_PaodekuaiHuaian(this, 0);
                ...
                mjhand: function(eD) {
                    InitUserHandUI_PaodekuaiHuaian(this, 0);
        ...
        right: {
            ...
            _event: {
                ...
                initSceneData: function(eD) {
                    SetUserVisible_PaodekuaiHuaian(this, 1);
                },
                addPlayer: function(eD) {
                    SetUserVisible_PaodekuaiHuaian(this, 1);
                },
                ...
                mjhand: function(eD) {
                    InitUserHandUI_PaodekuaiHuaian(this, 1);
                },
                roundEnd: function() {
        ...
        top: {
            ...
            _event: {
                ...
                initSceneData: function(eD) {
                    SetUserVisible_PaodekuaiHuaian(this, 2);
                },
                addPlayer: function(eD) {
                    SetUserVisible_PaodekuaiHuaian(this, 2);
                },
                ...
                mjhand: function(eD) {
                    InitUserHandUI_PaodekuaiHuaian(this, 2);
                },
                roundEnd: function() {
    ...
    ctor: function() {
        this._super();
        var playui = ccs.load(res.Play_PaoDeKuaiHuaian_json);
...
PlayLayer_PaoDeKuaiHuaian.prototype.cannotOutCardGrey = function()
{
...
PlayLayer_PaoDeKuaiHuaian.prototype.recoverCannotOutCard = function()
{
    var children = this._downNode.children;
    for (var i = 0; i < children.length; i++)
    {
...
PlayLayer_PaoDeKuaiHuaian.prototype.clockNumberUpdate = function(node, endFunc)
{
...
PlayLayer_PaoDeKuaiHuaian.prototype.shwoFlyCardAnim = function(flyNode)
{
    var tData = MjClient.data.sData.tData;
...
PlayLayer_PaoDeKuaiHuaian.prototype.showHandCardBeiMian = function()
{
...
PlayLayer_PaoDeKuaiHuaian.prototype.hideHandCardBeiMian = function()
{
...
PlayLayer_PaoDeKuaiHuaian.prototype.CardLayoutRestore = function(node, off, needSort)
{
    // 如果正在发牌 不排序
...
PlayLayer_PaoDeKuaiHuaian.prototype.CardLayoutDesk = function(node,cards,off)
{
    //if(off != 0) return;
...
//横向摆放《正常》
PlayLayer_PaoDeKuaiHuaian.prototype.horSort = function(node, off, needSort)
{
    var pl; //player 信息
...
//纵向摆放
PlayLayer_PaoDeKuaiHuaian.prototype.verSort = function(node, off, needSort)
{
    if(off != 0)
    {
        return;
