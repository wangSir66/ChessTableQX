var paodekuaiHuaianNew_actionZindex = 1000;

// off 是四个位置，根据off 显示四个位置的信息 by sking
function SetUserVisible_PaodekuaiHuaianNew(node, off)
{
    ...
    if(pl)
    {
        ...
        InitUserHandUI_PaodekuaiHuaianNew(node, off);
    }
    else
    {
        name.visible = false;
...
function InitUserHandUI_PaodekuaiHuaianNew(node, off, needSort)
{
...
function cardsSort_PaodekuaiHuaianNew(cards)
{
    var pointCounts = {};
...
var PlayLayer_PaoDeKuaiHuaianNew = cc.Layer.extend({
    _btnPutCard:null,
    jsBind: {
        _run: function() {
        ...
        _event: {
            ...
            roundEnd: function() {
                ...
                function delayExe()
                {
                    ...
                    self.addChild(new EndOneView_PaodekuaiHuaianNew(),500);
                }
        ...
        gameName:{
            _run:function()
            {
                setWgtLayout(this,[0.15, 0.1],[0.5, 0.6],[0, 0]);
            }
        },
        roundInfo:{
            _run:function()
        ...
        BtnPutCard:{
            ...
            _click: function(btn) {
                //cc.log("BtnPutCard");
				cardsSort_PaodekuaiHuaian(MjClient.selectCards_card);
        ...
        down: {
            ...
            play_tips: {
                ...
                _run: function () {
                    this.zIndex = paodekuaiHuaianNew_actionZindex;
                },
                _visible:false,
            },
            ready: {
            ...
            _event: {
                ...
                initSceneData: function(eD) {
                    SetUserVisible_PaodekuaiHuaianNew(this, 0);
                ...
                mjhand: function(eD) {
                    InitUserHandUI_PaodekuaiHuaianNew(this, 0);
        ...
        right: {
            ...
            _event: {
                ...
                initSceneData: function(eD) {
                    SetUserVisible_PaodekuaiHuaianNew(this, 1);
                },
                addPlayer: function(eD) {
                    SetUserVisible_PaodekuaiHuaianNew(this, 1);
                },
                ...
                mjhand: function(eD) {
                    InitUserHandUI_PaodekuaiHuaianNew(this, 1);
                },
                roundEnd: function() {
        ...
        top: {
            ...
            _event: {
                ...
                initSceneData: function(eD) {
                    SetUserVisible_PaodekuaiHuaianNew(this, 2);
                },
                addPlayer: function(eD) {
                    SetUserVisible_PaodekuaiHuaianNew(this, 2);
                },
                ...
                mjhand: function(eD) {
                    InitUserHandUI_PaodekuaiHuaianNew(this, 2);
                },
                roundEnd: function() {
    ...
    ctor: function() {
        this._super();
        var playui = ccs.load(res.Play_PaoDeKuaiHuaianNew_json);
...
PlayLayer_PaoDeKuaiHuaianNew.prototype.InitC_Data = function() {
...
PlayLayer_PaoDeKuaiHuaianNew.prototype.cannotOutCardGrey = function()
{
...
PlayLayer_PaoDeKuaiHuaianNew.prototype.recoverCannotOutCard = function()
{
    var children = this._downNode.children;
    for (var i = 0; i < children.length; i++)
    {
...
PlayLayer_PaoDeKuaiHuaianNew.prototype.clockNumberUpdate = function(node, endFunc)
{
    return arrowbkNumberUpdate(node, endFunc);
}

PlayLayer_PaoDeKuaiHuaianNew.prototype.updateClockPosition = function(arrowNode)
{
    var tData = MjClient.data.sData.tData;
    var uids = tData.uids;
...
PlayLayer_PaoDeKuaiHuaianNew.prototype.shwoFlyCardAnim = function(flyNode)
{
    var tData = MjClient.data.sData.tData;
...
PlayLayer_PaoDeKuaiHuaianNew.prototype.showHandCardBeiMian = function()
{
...
PlayLayer_PaoDeKuaiHuaianNew.prototype.hideHandCardBeiMian = function()
{
...
PlayLayer_PaoDeKuaiHuaianNew.prototype.CardLayoutRestore = function(node, off, needSort)
{
    // 如果正在发牌 不排序
...
PlayLayer_PaoDeKuaiHuaianNew.prototype.CardLayoutDesk = function(node,cards,off)
{
    //if(off != 0) return;
...
//横向摆放《正常》
PlayLayer_PaoDeKuaiHuaianNew.prototype.horSort = function(node, off, needSort)
{
    var pl; //player 信息
...
//纵向摆放
PlayLayer_PaoDeKuaiHuaianNew.prototype.verSort = function(node, off, needSort)
{
    if(off != 0)
    {
        return;
