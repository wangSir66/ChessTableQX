...
var PlayLayer_PaoDeKuaiHuaianNew = PlayLayer_PDK.extend({
    getJsBind: function() {
        return {
            _event: {
                mjhand: function() {
    ...
    ctor: function() {
        var playui = this._super(res.Play_PaoDeKuaiHuaianNew_json);
...
PlayLayer_PaoDeKuaiHuaianNew.prototype.setUserVisiblePaoDeKuai = function (node, off)
{
...
PlayLayer_PaoDeKuaiHuaianNew.prototype.initUserHandUIPaoDeKuai = function (node, off, needSort)
{
