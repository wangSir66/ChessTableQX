...
function SetEndOneUserUI_PaodekuaiHuaianNew(node, off) {
...
function CardLayoutRestoreForEndOne_PaodekuaiHuaianNew(node, plNode) {
...
var EndOneView_PaodekuaiHuaianNew = cc.Layer.extend({
    jsBind: {
        block: {
        ...
        back: {
            ...
            head0: {
                ...
                _run: function () { SetEndOneUserUI_PaodekuaiHuaianNew(this, 0); },
            }
            , head1: {
                head: {
                    //:{_visible:false}
                ...
                _run: function () { SetEndOneUserUI_PaodekuaiHuaianNew(this, 1); }
            }
            ...
            , head2: {
                ...
                _run: function () { SetEndOneUserUI_PaodekuaiHuaianNew(this, 2); }
            },
    ...
    ctor: function () {
        ...
        var endoneui = ccs.load(res.EndOne_PaoDeKuaiHuaianNew_json);
