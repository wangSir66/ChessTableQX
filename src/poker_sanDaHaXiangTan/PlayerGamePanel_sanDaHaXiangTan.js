...
var PlayLayer_sanDaHaXiangTan = cc.Layer.extend({
    _btnPutCard: null,
    jsBind: {
        _event: {
            mjhand: function() {
            ...
            roundEnd: function() {
                ...
                function delayExe() {
                    ...
                    self.addChild(new EndOneView_sanDaHaXiangTan(), 500);
                }
        ...
        scoreBanner: {
            ...
            _event: {
                ...
                waitPut: function(d) {
                    ...
                    var tData = MjClient.data.sData.tData;
                    var winType = MjClient.majiang.countWinType(tData.jiaoFen, tData.fenPaiArr, false, 0, tData.areaSelectMode["xiaoGuangFen"]);
                ...
                initSceneData: function() {
                    var tData = MjClient.data.sData.tData;
                    if (tData.tState == TableState.waitPut)
                        MjClient.playui.winType = MjClient.majiang.countWinType(tData.jiaoFen, tData.fenPaiArr, false, 0, tData.areaSelectMode["xiaoGuangFen"]);
                    else
        ...
        BtnPutCard: {
            ...
            _click: function(btn) {
                ...
                MjClient.playui.cardsSort_sanDaHaXiangTan(MjClient.selectCards_card);
                PutOutCard_card(); //可以出牌
                // MjClient.playui.recoverCannotOutCard();
                btn.visible = false;

                MjClient.playui.jsBind.panel.BtnTouXiang._node.visible = false;
            },
            _event: {
                ...
                PKPut: function(eD) {
                    ...
                    var cardType = MjClient.majiang.cardsType(eD.card, MjClient.data.sData.tData.zhuPaiType, MjClient.data.sData.tData.areaSelectMode.chou6);
        ...
        BtnRenShu:{
                ...
                MjClient.showMsg("你确定要认输吗？", function() {
                    {
                        ...
                        MjClient.playui.jsBind.BtnPutCard._node.setVisible(false);
            ...
            _event:{
                ...
                {
                    var tData = MjClient.data.sData.tData;
                    var winType = MjClient.majiang.countWinType(tData.jiaoFen, tData.fenPaiArr, false, 0, MjClient.data.sData.tData.areaSelectMode["xiaoGuangFen"]);
                    var pl = getUIPlayer(0);
                    if(winType >= 3 && IsTurnToMe() && tData.uids[tData.zhuang] == pl.info.uid)
                    {
                        this.visible = true;
                    }
                    else {
        ...
        down: {
            ...
            _event: {
                ...
                initSceneData: function(eD) {
                    MjClient.playui.SetUserVisible_sanDaHaXiangTan(this, 0);
                    MjClient.playui.reConnectShowDeskCard();

                    if (MjClient.data.sData.tData.tState == TableState.waitPut)
                        MjClient.playui.allowTouXiang();
                },
                addPlayer: function(eD) {
                    MjClient.playui.SetUserVisible_sanDaHaXiangTan(this, 0);
                },
                ...
                mjhand: function(eD) {
                    ...
                    MjClient.playui.InitUserHandUI_sanDaHaXiangTan(this, 0);
        ...
        right: {
            ...
            _event: {
                ...
                initSceneData: function(eD) {
                    MjClient.playui.SetUserVisible_sanDaHaXiangTan(this, 1);
                },
                addPlayer: function(eD) {
                    MjClient.playui.SetUserVisible_sanDaHaXiangTan(this, 1);
                },
                ...
                mjhand: function(eD) {
                    MjClient.playui.InitUserHandUI_sanDaHaXiangTan(this, 1);
                },
                roundEnd: function() {
        ...
        top: {
            ...
            _event: {
                ...
                initSceneData: function(eD) {
                    MjClient.playui.SetUserVisible_sanDaHaXiangTan(this, 2);
                },
                addPlayer: function(eD) {
                    MjClient.playui.SetUserVisible_sanDaHaXiangTan(this, 2);
                },
                ...
                mjhand: function(eD) {
                    MjClient.playui.InitUserHandUI_sanDaHaXiangTan(this, 2);
                },
                roundEnd: function() {
        ...
        left: {
            ...
            _event: {
                ...
                initSceneData: function(eD) {
                    MjClient.playui.SetUserVisible_sanDaHaXiangTan(this, 3);
                },
                addPlayer: function(eD) {
                    MjClient.playui.SetUserVisible_sanDaHaXiangTan(this, 3);
                },
                ...
                mjhand: function(eD) {
                    MjClient.playui.InitUserHandUI_sanDaHaXiangTan(this, 3);
                },
                roundEnd: function() {
    ...
    ctor: function() {
        this._super();
        var playui = ccs.load(res.Play_sanDaHaXiangTan_json);
        ...
        //触摸事件监听注册
        cc.eventManager.addListener(cc.EventListener.create(MjClient.playui.getTouchListener_card()), this._rightNode);
...
PlayLayer_sanDaHaXiangTan.prototype.SetUserVisible_sanDaHaXiangTan = function(node, off) {
    ...
    if (pl) {
        ...
        MjClient.playui.InitUserHandUI_sanDaHaXiangTan(node, off);
    } else {
        name.visible = false;
        coin.visible = false;
...
PlayLayer_sanDaHaXiangTan.prototype.InitUserHandUI_sanDaHaXiangTan = function(node, off) {
    var sData = MjClient.data.sData;
    var tData = sData.tData;
    var pl = getUIPlayer(off);
...
PlayLayer_sanDaHaXiangTan.prototype.cardsSort_sanDaHaXiangTan = function(cards) {
    var pointCounts = {};
...
PlayLayer_sanDaHaXiangTan.prototype.getTouchListener_card = function() {
    return{
                ...
                if(_childrens[i].name == "mjhand")
                {
                    ...
                    if (cc.rectContainsPoint(_boundingBox, locationInNode))
                    {
                        ...
                        if(!checkIsHave(_childrens[i]))
                        {
                            cc.log("选中了");
                            bTouchMove = true;
                            if((MjClient.gameType == MjClient.GAME_TYPE.LV_LIANG_DA_QI || MjClient.gameType == MjClient.GAME_TYPE.XIN_ZHOU_SAN_DA_ER || MjClient.gameType == MjClient.GAME_TYPE.DA_TONG_ZHA_GU_ZI)  && _childrens[i].cannotOut && _childrens[i].cannotOut == true) {
                                //打七中置灰的牌不可提起
                            } else {
                                _childrens[i].setColor(MjClient.grayColor);
                                MjClient.touchMoveSelcetCardArray.push(_childrens[i]);
...
PlayLayer_sanDaHaXiangTan.prototype.reConnectShowDeskCard = function() {
    var tData = MjClient.data.sData.tData;
...
PlayLayer_sanDaHaXiangTan.prototype.cannotOutCardGrey = function() {
...
PlayLayer_sanDaHaXiangTan.prototype.recoverCannotOutCard = function() {
    var children = this._downNode.children;
    for (var i = 0; i < children.length; i++) {
        if (children[i].name != "mjhand")
            continue;
...
PlayLayer_sanDaHaXiangTan.prototype.clockNumberUpdate = function(node, endFunc) {
    return arrowbkNumberUpdate(node, endFunc);
}

PlayLayer_sanDaHaXiangTan.prototype.updateClockPosition = function(arrowNode) {
    var tData = MjClient.data.sData.tData;
    var uids = tData.uids;
 ...
 * @return {String}
 */
PlayLayer_sanDaHaXiangTan.prototype.getGameInfoString = function(param) {
    var tData = MjClient.data.sData.tData;
...
PlayLayer_sanDaHaXiangTan.prototype.updateOperateBtnPosition = function() {
...
// 拖拉机动画
PlayLayer_sanDaHaXiangTan.prototype.playCardAni_liandui = function() {
...
// 闲家得分达到条件时动画、投降
PlayLayer_sanDaHaXiangTan.prototype.playWinAni = function(winType) {
    ...
    switch (winType) {
        ...
        case 6: // 大倒
            ...
            break;
        case -2:// 大光
            file = "gameOver_sanDaHa/xiaoguang.png";
            break;
        case -3:// 小光
            file = "gameOver_sanDaHa/daguang.png";
            break;
        case -4:// 投降
            file = "gameOver_sanDaHa/touxiang.png";
            break;
        case -5:// 比常主
            file = "gameOver_sanDaHa/changzhu.png";
            break;
        default:
            return;
    }
...
// 刷新得分栏
PlayLayer_sanDaHaXiangTan.prototype.refreshScoreBanner = function(shouldPlayAnim) {
    var tData = MjClient.data.sData.tData;
...
// 判断是否有不同意投降的玩家
PlayLayer_sanDaHaXiangTan.prototype.haveNotAgreeTouXiang = function()
{
    var sData = MjClient.data.sData;
    var tData = MjClient.data.sData.tData;
...
// 重置玩家同意投降状态
PlayLayer_sanDaHaXiangTan.prototype.initAgreeTouXiangStatus = function()
{
    var sData = MjClient.data.sData;
    var tData = MjClient.data.sData.tData;
    for (var i = 0; i < tData.uids.length; i++)
...
PlayLayer_sanDaHaXiangTan.prototype.showWaitTip = function(bMaiPai) {
    var sData = MjClient.data.sData;
    var tData = sData.tData;
    ...
    MjClient.playui.panel.getChildByName("touXiangContinueTip").setVisible(zhuangPl && zhuangPl.isAgreeTouXiang == 1 && notAgreeTouXiang && !bMaiPai);


    var isSelfWaitPut = (tData.tState == TableState.waitPut && 0 == curOff)
    var winType = MjClient.majiang.countWinType(tData.jiaoFen, tData.fenPaiArr, false, 0, MjClient.data.sData.tData.areaSelectMode["xiaoGuangFen"]);
    var isHasFirstCard = MjClient.majiang.getRoundFirstCards(tData.putCardsRecord, tData.firstPutCardUid, tData.maxPlayer);
    ...
    if (touXiangContinueTip.isVisible())
    {
        touXiangContinueTip.runAction(cc.sequence(cc.delayTime(2), cc.callFunc(function() {
            ...
            MjClient.playui.BtnRenShu.setVisible(winType >= 3 && isSelfWaitPut);
            MjClient.playui.jsBind.BtnPutCard._node.setVisible(isSelfWaitPut);
            MjClient.playui.jsBind.BtnHimt._node.setVisible(isHasFirstCard && isSelfWaitPut);
...
// 显示各玩家叫分
PlayLayer_sanDaHaXiangTan.prototype.showJiaoFenTag = function(off) {
    var tData = MjClient.data.sData.tData;
...
// 隐藏各玩家叫分
PlayLayer_sanDaHaXiangTan.prototype.hideJiaoFenTag = function() {
...
// 显示叫分面板
PlayLayer_sanDaHaXiangTan.prototype.showJiaoFenPanel = function() {
    if (MjClient.rePlayVideo != -1)
    {
        MjClient.playui.jsBind.panel.jiaoFenPanel._node.setVisible(false);
        return;
    ...
    cc.log("sssssssssssssssss:"+tData.mustJiao)
    btnBuJiao.setBright(!tData.mustJiao);
    btnBuJiao.setTouchEnabled(!tData.mustJiao);
    ...
    if(isIPad())
    {
        ...
        jiaoFenPanel.scale = 0.85;
        jiaoFenPanel.setPositionY(0.6 * jiaoFenPanel.getParent().getContentSize().height);
    }

    var func = function() {
        var max = tData.jiaoFen > 0 ? tData.jiaoFen : 100 + 1;
        var path = "playing/sanDaHa/jiaoFen_xiangTan/";
        for (var i = 5; i <= 80; i += 5) {
            ...
            {
                if(i >= 55 && i<= 80){
                    if(i > 60 && tData.areaSelectMode.qiJiao60) {
                        btn.setEnabled(false)
                    }
                    else {
                        btn.loadTextures(path + "red_" + i + ".png","",path + "gray_" + i + ".png")
                    }
                }
                else if(i >= 35 && i<= 50){
                    btn.loadTextures(path + "yellow_" +i + ".png","",path + "gray_" + i + ".png")
                }
                else if(i >= 5 && i<= 30) {
                    btn.loadTextures(path + "blue_" + i + ".png","",path + "gray_" + i + ".png")
                }
            }
...
// 把底牌添加到手牌中
PlayLayer_sanDaHaXiangTan.prototype.addDiPaiToHand = function() {
    var tData = MjClient.data.sData.tData;
...
// 从手牌中移除埋的牌
PlayLayer_sanDaHaXiangTan.prototype.removeMaiPaiFromHand = function() {
    var tData = MjClient.data.sData.tData;
    var off = getOffByIndex(tData.curPlayer);
...
// 显示投降同意选择框
PlayLayer_sanDaHaXiangTan.prototype.showTouXuangDialog = function() {
     if (MjClient.rePlayVideo != -1)
        return;
...
// 显示叫主面板
PlayLayer_sanDaHaXiangTan.prototype.showJiaoZhuPanel = function() {
    var tData = MjClient.data.sData.tData;
...
// 显示埋牌、投降按扭
PlayLayer_sanDaHaXiangTan.prototype.showMaiPaiBtn = function() {
    var tData = MjClient.data.sData.tData;
    ...
    touXiangBtn.setPositionY(maiPaiBtn.getPositionY());
...
// 显示上一轮面板
PlayLayer_sanDaHaXiangTan.prototype.showShangYiLunPanel = function(shangYiLunPanel) {
    var tData = MjClient.data.sData.tData;
...
// 显示查看底牌面板
PlayLayer_sanDaHaXiangTan.prototype.showDiPaiPanel = function(diPaiPanel) {
    var tData = MjClient.data.sData.tData;
...
// 显示查牌面板
PlayLayer_sanDaHaXiangTan.prototype.showChaPaiPanel = function(chaPaiPanel) {
    var tData = MjClient.data.sData.tData;
    var records = tData.putCardsRecord;
...
// 显示得分栏上的具体分牌
PlayLayer_sanDaHaXiangTan.prototype.showScoreCards = function(panel, cards) {
    ...
    for (var i = 0; i < cards.length; i++) {
        var cardNode = tempCard.clone();
        setPKMiniImg(cardNode, cards[i], 0);
        cardNode.x = x;
        x += w;
...
// 给手牌中的主牌设置角标
PlayLayer_sanDaHaXiangTan.prototype.setCardSprite_ZhuTag = function(node) {
    var tData = MjClient.data.sData.tData;
...
// 计算各牌色数量
PlayLayer_sanDaHaXiangTan.prototype.getCardNumByColor = function(cards, colorIndex) {
    var num = 0;
    var types = [1, 2, 3, 0, 4]
    for (var i = 0; i < cards.length; i++) {
...
// 清空桌面
PlayLayer_sanDaHaXiangTan.prototype.clearDesk = function() {
    cc.log("clearDesk")
...
PlayLayer_sanDaHaXiangTan.prototype.CardLayoutRestore = function(node, off) {
    cc.log("横向排序 off=" + off);
    MjClient.playui.horSort(node, off);
};

PlayLayer_sanDaHaXiangTan.prototype.CardLayoutDesk = function(node, cards, off) {
    //if(off != 0) return;
    var children = node.children;
    ...
    var maxUid = MjClient.majiang.getMaxCardPlayerUid(roundCards, tData.firstPutCardUid, tData.uids, tData.zhuPaiType, bChou6);
...
//横向摆放《正常》
PlayLayer_sanDaHaXiangTan.prototype.horSort = function(node, off) {
    var pl; //player 信息
...
PlayLayer_sanDaHaXiangTan.prototype.DealCardEffect = function(uid, off)
{
    var tData = MjClient.data.sData.tData;
    ...
    //接牌
    var bChou6 = tData.areaSelectMode.chou6;
    var maxCardUid = MjClient.majiang.getMaxCardPlayerUid(roundPutCards, tData.firstPutCardUid, tData.uids, tData.zhuPaiType, uid, bChou6);
...
PlayLayer_sanDaHaXiangTan.prototype.getHandCount = function() {
    var tData = MjClient.data.sData.tData;
    var isFour = MjClient.MaxPlayerNum == 4;
...
// 埋完牌展示投降按钮
PlayLayer_sanDaHaXiangTan.prototype.allowTouXiang = function() {
    if (MjClient.rePlayVideo != -1)
        return;
    ...
    if(mySelf.mjhand.length != this.getHandCount()) {
        return;
    }

    var touXiangBtn = MjClient.playui.jsBind.panel.BtnTouXiang._node;
    var putCardBtn = MjClient.playui.jsBind.BtnPutCard._node;
    touXiangBtn.setVisible(true);

    var referPoint = putCardBtn.convertToWorldSpace(cc.p(0,putCardBtn.getContentSize().height/2));
    referPoint = MjClient.playui.jsBind.panel._node.convertToNodeSpace(referPoint);
    touXiangBtn.setPositionY(referPoint.y);
