...
function CardLayoutRestoreForEndOne_daningshuaijin(node, endonepl)
{
...
function SetEndOneUserUI_daningshuaijin(node,off)
{
	var sData=MjClient.data.sData;
	var tData=sData.tData;
...
var EndOneView_daningshuaijin = cc.Layer.extend({
	jsBind:{
		block: {
		...
		head0:{
		   ...
		   _run:function(){ SetEndOneUserUI_daningshuaijin(this,0); },
		...
		head1:{
		  ...
		  _run:function(){ SetEndOneUserUI_daningshuaijin(this,1); }
		},
		head2:{
		   head:{
			   zhuang:{_visible:false}
		   ...
		   _run:function(){ SetEndOneUserUI_daningshuaijin(this,2); }
		},
		head3:{
			 head:
			 {
			...
			_run:function(){ SetEndOneUserUI_daningshuaijin(this,3); }
			},
		count_down:{
                _visible :function()
                {
    ...
    ctor:function () {
        this._super();
        var endoneui = ccs.load("endOne_daningshuaijin.json");
