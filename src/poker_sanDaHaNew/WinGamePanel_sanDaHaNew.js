function SetEndOneUserUI_sanDaHaNew(node, off) {
    ...
    if (isZhuan||((tData.winType==0 || tData.winType == -5 || tData.winType == -6) && off == 0 && image_state)) {
        switch (tData.winType) {
            ...
            case -5:// 比常主流局
                ...
                break;
            case -6:// 流局
                image_state.loadTexture("gameOver_sanDaHa/liuju.png");
                break;
            case 5: // 庄家认输
...
var EndOneView_sanDaHaNew = cc.Layer.extend({
    jsBind: {
        block: {
            _layout: [
                [1, 1],
        ...
        back: {
            ...
            text_rule: {
                _run: function() {
                    ...
                    rule += tData.areaSelectMode.yiDangRenShu6 ? "一档认输6分," : "";
                    rule += tData.areaSelectMode.daWuZhu ? "打无主," : "";
                    rule += tData.areaSelectMode.jiaoFenJiaPai ? "叫分加拍," : "";
            ...
            image_player_zhuang: {
                _run: function() {
                    SetEndOneUserUI_sanDaHaNew(this, MjClient.endoneui.offs[0]);
                }
            },
            image_player_0: {
                _run: function() {
                    SetEndOneUserUI_sanDaHaNew(this, MjClient.endoneui.offs[1]);
                },
            },
            image_player_1: {
                _run: function() {
                    SetEndOneUserUI_sanDaHaNew(this, MjClient.endoneui.offs[2]);
                }
            },
            image_player_2: {
                _run: function() {
                    SetEndOneUserUI_sanDaHaNew(this, MjClient.endoneui.offs[3]);
                }
            },
        }
    },
    ctor: function() {
        ...
        var endoneui = ccs.load("endOne_sanDaHaNew.json");
