...
function SetUserVisible_HYShiWuHu(node, off){
    ...
    if(pl){
        ...
        // InitUserHandUI_HYShiWuHu(node, off);
...
function InitUserHandUI_HYShiWuHu(node, off){
...
var PlayLayer_HYShiWuHu = cc.Layer.extend({
    jsBind: {
        _event: {
        ...
        roundInfo:{
            ...
            _run:function(){
                ...
                // str += (tData.areaSelectMode.bihuType == 0) ? "有胡必胡," : (tData.areaSelectMode.bihuType == 1) ? "点炮必胡," : "无点炮胡," ;
                // str += (tData.areaSelectMode.xingType == 0) ? "不带醒" : (tData.areaSelectMode.xingType == 2) ? "翻醒" : "随醒" ;
                // str += (tData.areaSelectMode.isErfen) ? ",底分2分" : "" ;
                // str += (tData.areaSelectMode.isZiMoRate) ? ",自摸翻倍" : "" ;
                // str += (tData.areaSelectMode.isHongheidian) ? ",红黑胡" : "" ;
                // str += (tData.areaSelectMode.isAlldemit) ? ",解散须全部人同意" : "" ;
                this.ignoreContentAdaptWithSize(true);
                var strPayWay = "";
                var str5 = strPayWay;
        ...
        down: {
            ...
            _event: {
                ...
                initSceneData: function(eD) {
                    SetUserVisible_HYShiWuHu(this, 0);
                    InitUserHandUI_HYShiWuHu(this, 0);
        ...
        right: {
            ...
            _event: {
                ...
                initSceneData: function(eD) {
                    SetUserVisible_HYShiWuHu(this, 1);
                    InitUserHandUI_HYShiWuHu(this, 1);
        ...
        left: {
            ...
            _event: {
                ...
                initSceneData: function(eD) {
                    SetUserVisible_HYShiWuHu(this, 2);
                    InitUserHandUI_HYShiWuHu(this, 2);
    ...
    ctor: function() {
        ...
        switch(MjClient.getAppType()){
            case (MjClient.getAppType() == MjClient.APP_TYPE.HUNANWANGWANG || MjClient.getAppType() == MjClient.APP_TYPE.QXSYDTZ):
                var playui = ccs.load("Play_shiWuHu.json");
                break;
            default:
...
//重置手牌的顺序
PlayLayer_HYShiWuHu.prototype.ResetHandCard = function(posNode,off, needAction, isDelay){
...
PlayLayer_HYShiWuHu.prototype._doMovetoAction = function(node,endP){
    node.stopAllActions();
    var ac = cc.moveTo(0.3,endP);
    node.runAction(ac);
};

PlayLayer_HYShiWuHu.prototype.ResetOtherCard = function(posNode, off) {
    //添加吃、碰、跑、偎、提
    var sData = MjClient.data.sData;
    var tData = null;
    if (sData) {
...
PlayLayer_HYShiWuHu.prototype.ResetPutCard = function(posNode, off) {
    //添加打出的牌
    var pl = getUIPlayer_hengYang(off);
...
//重置牌的顺序
PlayLayer_HYShiWuHu.prototype.CardLayoutRestore = function(posNode,off){
    if(MjClient.rePlayVideo == -1){
...
// 判断吃、碰、跑、偎、提、胡的状态
PlayLayer_HYShiWuHu.prototype.EatVisibleCheck = function(off){
    var eat = MjClient.playui.jsBind.eat;
...
PlayLayer_HYShiWuHu.prototype.showAndHideHeadEffect = function(){
