 ...
 * @type {void | Class | *}
 */
var EndOneView_guizhouGuiYangZhuoJi = cc.Layer.extend({
    ...
    jsonFile: "endOne_guizhouGuiYangZhuoJi.json",
    ...
    getEndOneInfoImageURL: function(type){
        ...
        IMAGE_URL[SCORE_TYPE.guMai]       = originUrl + "gumai.png";
        ...
        var uibind = {
            ...
            img_que: {
                _run:function(){
                    ...
                    if (!(typeof(player.que) == "undefined" || player.que === -1)) {
                        var filePath = "playing/queUI/sign" + player.que[0] + ".png";
            ...
            img_gumai: {
                _run:function(){
                    this.setVisible(false);
                    if (player.gumaiValue && player.gumaiValue > 0) {
                        var filePath = "res/playing/gameTable/gumai/mai" + player.gumaiValue + "_1.png";
                        if (!jsb.fileUtils.isFileExist(filePath)) return;
                        this.setVisible(true);
                        this.loadTexture(filePath);
                    }
    ...
    setEveryOneCardInfo: function(node, off){
        ...
        var uibind = {
            ...
            img_gumai: {
                _run:function(){
                    this.setVisible(false);
                    if (tData.areaSelectMode.gumai && player.gumaiValue && player.gumaiValue > 0) {
                        var filePath = "res/playing/gameTable/gumai/mai" + player.gumaiValue + "_1.png";
                        if (!jsb.fileUtils.isFileExist(filePath)) return;
                        this.setVisible(true);
                        this.loadTexture(filePath);
