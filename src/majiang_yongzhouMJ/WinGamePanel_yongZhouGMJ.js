...
function SetEndOneUserUI_yongZhouGMJ(node,off)
{
...
var EndOneView_yongZhouGMJ = cc.Layer.extend({
	jsBind:{
		block: {
		...
		head0:{
		   ...
		   _run:function(){ SetEndOneUserUI_yongZhouGMJ(this,0); },
		...
		,head1:{ 
		  ...
		  _run:function(){ SetEndOneUserUI_yongZhouGMJ(this,1); }
		}
		...
		,head2:{ 
		   ...
		   _run:function(){ SetEndOneUserUI_yongZhouGMJ(this,2); }
		}
		,head3:{
			 head:
			 {
			...
			_run:function(){ SetEndOneUserUI_yongZhouGMJ(this,3); }
			},
            count_down:{
                _visible :function()
                {
