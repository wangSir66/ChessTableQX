...
//向服务器发送 过消息
MjClient.MJPass2NetForYongZhouGMJ = function()
{
   // console.log(">>>>>>>>>普通  过 <<<<<<<<");
    cc.log("====================send======pass=====");
...
function SetUserVisible_YongZhouGMJ(node, off)
{
    //var sData = MjClient.data.sData;
    //return;
    cc.log("====================off======================" + off);
...
function InitUserHandUI_YongZhouGMJ(node, off)
{
    var sData = MjClient.data.sData;
    var tData = sData.tData;
    var pl = getUIPlayer(off);
...
var PlayLayer_yongZhouGMJ = cc.Layer.extend({
    jsBind: {
        _event: {
            mjhand: function() {
            ...
            roundEnd: function() {
                ...
                function delayExe()
                {
                    ...
                    self.addChild(new EndOneView_yongZhouGMJ(),500);
                }
                ...
                baidaImg: {
                    ...
                    _event: {
                        mjhand:function()
                        {
                            ...
                            setCardSprite(this, MjClient.data.sData.tData.hunCard, 4);
        ...
        down: {
            ...
            _event: {
                ...
                initSceneData: function(eD) {
                    SetUserVisible_YongZhouGMJ(this, 0);
                },
                addPlayer: function(eD) {
                    SetUserVisible_YongZhouGMJ(this, 0);
                },
                ...
                mjhand: function(eD) {
                    InitUserHandUI_YongZhouGMJ(this, 0);
                },
                roundEnd: function() {
        ...
        right: {
            ...
            _event: {
                ...
                initSceneData: function(eD) {
                    SetUserVisible_YongZhouGMJ(this, 1);
                },
                addPlayer: function(eD) {
                    SetUserVisible_YongZhouGMJ(this, 1);
                },
        ...
        top: {
            ...
            _event: {
                ...
                initSceneData: function(eD) {
                    SetUserVisible_YongZhouGMJ(this, 2);
                },
                addPlayer: function(eD) {
                    SetUserVisible_YongZhouGMJ(this, 2);
                },
        ...
        left: {
            ...
            _event: {
                ...
                initSceneData: function(eD) {
                    SetUserVisible_YongZhouGMJ(this, 3);
                },
                addPlayer: function(eD) {
                    SetUserVisible_YongZhouGMJ(this, 3);
                },
            ...
            changeui: {
                ...
                changeuibg: {
                    ...
                    guobg: {
                        guo: {
                            _touch: function(btn, eT) {
                                if (eT == 2) MjClient.MJPass2NetForYongZhouGMJ();
                            }
                        },
                        fanhui: {
                            _touch: function(btn, et) {
    ...
    ctor: function() {
        ...
        var playui = ccs.load("Play_yongZhouGMJ.json");
        playMusic("bgFight");
    ...
    getGameInfoString: function(param) {
        ...
        var str = "";
        str += tData.areaSelectMode.huType == 0? "自摸胡," : "点炮胡," ;
        str += tData.areaSelectMode.openType == 1? "全开放," : tData.areaSelectMode.openType == 2?"半开放," :"不开放,";
...
PlayLayer_yongZhouGMJ.prototype.CardLayoutRestore = function(node, off)
{
...
// 判断吃碰杠胡的状态
PlayLayer_yongZhouGMJ.prototype.EatVisibleCheck = function()
{
    var eat = MjClient.playui.jsBind.eat;
