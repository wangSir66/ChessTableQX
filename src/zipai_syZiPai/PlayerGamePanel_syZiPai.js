...
function SetUserVisible_syZiPai(node, off){
...
function InitUserHandUI_syZiPai(node, off){
...
var PlayLayer_syZiPai = cc.Layer.extend({
    jsBind: {
        _event: {
        ...
        roundInfo:{
            ...
            _run:function(){
                var tData = MjClient.data.sData.tData;
                var str = "";
                str += tData.maxPlayer == 2 ? "2人玩" : "3人玩";
                str += tData.areaSelectMode.huXiType == 3 ? ",3息一囤" : ",5息一囤";
                str += tData.areaSelectMode.isJiaChui ? ",加锤" : "";
                str += tData.areaSelectMode.hongHeiType == 0 ? ",红黑胡翻倍" : ",红黑胡10囤";
                str += tData.areaSelectMode.isZiMo ? ",自摸+1囤" : "";
        ...
        down: {
            ...
            _event: {
                ...
                initSceneData: function(eD) {
                    SetUserVisible_syZiPai(this, 0);
                    InitUserHandUI_syZiPai(this, 0);
                ...
                MJJiazhu: function(msg) {
                    ...
                    if (MjClient.MaxPlayerNum_leiyang == 2) {
                        ...
                        MjClient.majiang.setJiaZhuNum(MjClient.playui._topNode, getUIPlayer_hengYang(1));
                    } else {
                        MjClient.majiang.setJiaZhuNum(MjClient.playui._downNode, getUIPlayer_hengYang(0));
        ...
        right: {
            ...
            _event: {
                ...
                initSceneData: function(eD) {
                    SetUserVisible_syZiPai(this, 1);
                    InitUserHandUI_syZiPai(this, 1);
        ...
        left: {
            ...
            _event: {
                ...
                initSceneData: function(eD) {
                    SetUserVisible_syZiPai(this, MjClient.MaxPlayerNum_leiyang - 1);
                    InitUserHandUI_syZiPai(this, MjClient.MaxPlayerNum_leiyang - 1);
    ...
    ctor: function() {
        ...
        //自由人数
        if (tData.areaSelectMode["convertible"] && MjClient.rePlayVideo == -1)
...
//重置手牌的顺序
PlayLayer_syZiPai.prototype.ResetHandCard = function(posNode,off, needAction, isDelay){
...
PlayLayer_syZiPai.prototype._doMovetoAction = function(node,endP){
    node.stopAllActions();
    var ac = cc.moveTo(0.3,endP);
    node.runAction(ac);
};

PlayLayer_syZiPai.prototype.ResetOtherCard = function(posNode, off) {
    //添加吃、碰、跑、偎、提
    var sData = MjClient.data.sData;
    var tData = null;
    if (sData) {
...
PlayLayer_syZiPai.prototype.ResetPutCard = function(posNode,off){
    //添加打出的牌
    var pl = getUIPlayer_hengYang(off);
...
//重置牌的顺序
PlayLayer_syZiPai.prototype.CardLayoutRestore = function(posNode,off){
    if(MjClient.rePlayVideo == -1){
...
// 判断吃、碰、跑、偎、提、胡的状态
PlayLayer_syZiPai.prototype.EatVisibleCheck = function(off){
    var eat = MjClient.playui.jsBind.eat;
...
PlayLayer_syZiPai.prototype.showAndHideHeadEffect = function(){
