...
function SetUserVisible_syBoPi(node, off){
...
function InitUserHandUI_syBoPi(node, off){
    ...
    //添加手牌
    if(MjClient.rePlayVideo == -1){
        cc.log("_________________mjhand_common______________"+JSON.stringify(pl.mjhand));
        cc.log("off:" + off + "-----node name:" + node.getName());
        //表示正常游戏
        if(pl.mjhand && off == 0){
...
var PlayLayer_syBoPi = cc.Layer.extend({
    jsBind: {
        _event: {
                ...
                function delayExe(){
                    ...
                    if(!MjClient.endoneui){
                        if(!sData.tData.fieldId){
                            self.addChild(new EndOneView_syZiPai(),500); //EndOneView_shaoYang   
                        }else{
                            //金币场
        ...
        roundInfo:{
            ...
            _run:function(){
                ...
                this.showInfo = function(){
                    var getHongHeiType = function(v, areaSelectMode){
                        if(v == 0){
                            //兼容之前的版本
                    ...
                    str += getHongHeiType(tData.areaSelectMode.hongHeiType, tData.areaSelectMode);
                    str += tData.areaSelectMode.isJiaChui ? " 加锤" : "";
                    str += tData.areaSelectMode.isSpringDouble ? " 春天翻倍" : "";
                    str += tData.areaSelectMode.isRandomZhuang ? " 随机坐庄" : "";
                    if(tData.maxPlayer == 2){
                        str += tData.areaSelectMode.isMaiPai ? " 埋牌20张" : "";
                    }
                    str += [" 天地胡加十胡"," 天地胡翻倍"," 无天地胡"][tData.areaSelectMode.tianDiHuType] ;
                    str += tData.areaSelectMode.diFen > 0 ? "低于" + tData.areaSelectMode.diFen + "分翻倍" : "";
                    if(tData.areaSelectMode.isLianZhuang){
                        str += " 可连庄";
                        if(tData.areaSelectMode.fengDing == -1){
                            str += " 不封顶";
                        }else{
                            str += " " + tData.areaSelectMode.fengDing + "胡封顶";
                        }
                    }
                    var strPayWay = "";
                    var str5 = strPayWay;
        ...
        banner: {
                ...
                if(MjClient.data.sData.tData.fieldId){
                    for(var i = 0; i < this.children.length; i++){
                        ...
                        if(node.getName() != "setting" && 
                            node.getName() != "get_gold_btn" && 
                            node.getName() != "trust_btn" && 
                            node.getName() != "gameName"){
                            node.visible = false;
                        }
                    }
                }
            ...
            getRoomNum: {
                _click: function() {
                    cc.log("111111111111111111111111111111111111111111");
                    /*
                     复制房间号-----------------------
                     */
                    var tData = MjClient.data.sData.tData;
                    ...
                    // str += tData.areaSelectMode.isHongheidian ? ",红黑点" : "";
                    ...
                    if(MjClient.MaxPlayerNum_leiyang == 3){
                        ...
                        if((MjClient.MaxPlayerNum_leiyang - Object.keys(sData.players).length) == 3){
                            str7 = "  一缺三";
                        }else if((MjClient.MaxPlayerNum_leiyang - Object.keys(sData.players).length) == 2){
                            str7 = "二缺二";
                        }else  if((MjClient.MaxPlayerNum_leiyang - Object.keys(sData.players).length) == 1){
                            str7 = "三缺一";
                        }
                    }
            ...
            setting: {
                ...
                _click: function() {
                    ...
                    MjClient.playui.addChild(settringLayer, 6000);
            ...
            roundnumImg: {
                ...
                roundnumAtlas: {
                    ...
                    _text: function() {
                        ...
                        var tData = sData.tData;
                        if (tData) {
                            var str = "第 " + (tData.roundAll - (tData.roundNum - 1)) + " 局";
                            return str;
                        }
                    },
                    _event: {
        ...
        down: {
            head: {
                ...
                chuizi_tips : {
                    _run: function(){
                        ...
                        // var tData = MjClient.data.sData.tData;
                        // this.setVisible(tData.areaSelectMode.isJiaChui); 

                        setJiachuiImgTips_hengYang(this, changeUIOff_shaoyang(0)); 
                    },
                    _event: {
                        initSceneData: function() {
                            setJiachuiImgTips_hengYang(this, changeUIOff_shaoyang(0));
                ...
                jiachuiText_tips : {
                    _run: function() {
                        setJiachuiTextTips_hengYang(this, changeUIOff_shaoyang(0));
                    },
                    _event:{
                        initSceneData: function() {
                            setJiachuiTextTips_hengYang(this, changeUIOff_shaoyang(0));
                ...
                zhuang: {
                    ...
                    _event: {
                        waitPut: function(){
                            showUserZhuangLogo_hengYang(this, changeUIOff_shaoyang(0));
                        },
                        initSceneData: function(){
                            if (IsArrowVisible_hengYang()) showUserZhuangLogo_hengYang(this, changeUIOff_shaoyang(0));
                        },
                        mjhand: function(){
                            if (IsArrowVisible_hengYang()) showUserZhuangLogo_hengYang(this, changeUIOff_shaoyang(0));
                        }
                ...
                chatbg: {
                    ...
                    chattext: {
                        _event: {
                            MJChat: function(msg) {
                                showUserChat_hengYang(this, changeUIOff_shaoyang(0), msg);
                            },
                            playVoice: function(voicePath) {
                                MjClient.data._tempMessage.msg = voicePath;
                                showUserChat_hengYang(this, changeUIOff_shaoyang(0), MjClient.data._tempMessage);
                            }
                        }
                    }
                },
                _click: function(btn) {
                    showPlayerInfo_hengYang(changeUIOff_shaoyang(0), btn);
                },
                _event: {
                    loadWxHead: function(d) {
                        setWxHead_hengYang(this, d, changeUIOff_shaoyang(0));
                    },
                    addPlayer: function() {
                ...
                huxi:{
                    ...
                    _event:{
                        ...
                        initSceneData:function(){
                            this.visible = true;
                            var huXi = UpdateHuXi_hengYang(changeUIOff_shaoyang(0));
                            if(!IsArrowVisible_hengYang()){
                                huXi = 0;
                                this.visible = false;
                            }
                ...
                skipHuIconTag: {
                    ...
                    _event: {
                        ...
                        initSceneData:function(eD)
                        {
                            var pl = getUIPlayer_hengYang(changeUIOff_shaoyang(0));
                            if (pl && pl.isQiHu) {
                                this.visible = true;
                            }
                        }
            ...
            ready: {
                ...
                _run: function() {
                    GetReadyVisible_hengYang(this, changeUIOff_shaoyang(0));
                },
                _event: {
                    startShuffleCards:function (d) {
                    ...
                    addPlayer: function() {changeUIOff_shaoyang(0)
                        GetReadyVisible_hengYang(this, changeUIOff_shaoyang(0));//根据状态设置ready 是否可见 add by sking
                    },
                    removePlayer: function() {
                        GetReadyVisible_hengYang(this, changeUIOff_shaoyang(0));
                    },
            ...
            handCard: {
                ...
                _event:{
                    changeMJBgEvent: function() {
                        ...
                        MjClient.playui.ResetHandCard(MjClient.playui._downNode,changeUIOff_shaoyang(0));
                        // setWgtLayout(this, [0.185, 0.17],[0.27,0.75],[0,0]);
            ...
            _event: {
                clearCardUI: function() {
                    clearCardUI_hengYang(this, changeUIOff_shaoyang(0));
                },
                ...
                initSceneData: function(eD) {
                    SetUserVisible_syBoPi(this, changeUIOff_shaoyang(0));
                    InitUserHandUI_syBoPi(this, changeUIOff_shaoyang(0));
                    InitUserCoinAndName_hengYang(this, changeUIOff_shaoyang(0));
                    MjClient.hasPut = false; // 重连回来重置打掉牌标志（打牌时候断线)
                    ShowPutCardIcon();
                    DealOffLineCard_hengYang(this,changeUIOff_shaoyang(0));
                ...
                mjhand: function(eD) {
                    ...
                    var uid = getUIPlayer_hengYang(changeUIOff_shaoyang(0)).info.uid;
                    if (eD.jiazhuNums)
                    {
                ...
                HZNewCard: function(eD) {
                    ...
                    DealNewCard_hengYang(this,eD,changeUIOff_shaoyang(0));
                },
                MJPut: function(eD) {
                    DealPutCard_hengYang(this,eD,changeUIOff_shaoyang(0));
                },
                HZChiCard: function(eD) {
                    DealChiCard_hengYang(this, eD, changeUIOff_shaoyang(0));
                },
                HZWeiCard: function(eD){
                    DealWeiCard_hengYang(this,eD,changeUIOff_shaoyang(0));
                },
                HZGangCard: function(eD) {
                    DealGangCard_hengYang(this, eD, changeUIOff_shaoyang(0));
                },
                MJPeng: function(eD) {
                    DealPengCard_hengYang(this, eD, changeUIOff_shaoyang(0));
                },
                MJHu: function(eD) {
                    DealHu_hengYang(this, eD, changeUIOff_shaoyang(0));
                },
                onlinePlayer: function(eD) {
                    resetHandAfterBegin_hengYang();
                    setUserOffline_hengYang(this, changeUIOff_shaoyang(0));
                },
                playerStatusChange: function(eD) {
                    setUserOffline_hengYang(this, changeUIOff_shaoyang(0));
                },
                MJFlower: function(eD) {
                    HandleMJFlower(this, eD, changeUIOff_shaoyang(0));
                },
                MJTing: function (eD) {
                    HandleMJTing(this, eD, changeUIOff_shaoyang(0));
                },
                ...
                HZPickCard:function (eD) {
                    DealShowLastCard_hengYang(this, eD, changeUIOff_shaoyang(0));
                },
                HZAddCards:function (eD) {
                    DealAddCard_hengYang(this,eD, changeUIOff_shaoyang(0));
                },
        ...
        xing: {
            ...
            head: {
                ...
                chuizi_tips : {
                    _run: function(){
                        setJiachuiImgTips_hengYang(this, changeUIOff_shaoyang(MjClient.playui.getUIOff("xing")));
                    },
                    _event: {
                        initSceneData: function() {
                            setJiachuiImgTips_hengYang(this, changeUIOff_shaoyang(MjClient.playui.getUIOff("xing")));
                ...
                jiachuiText_tips : {
                    _run:function() {
                        setJiachuiTextTips_hengYang(this, changeUIOff_shaoyang(MjClient.playui.getUIOff("xing")));
                    },
                    _event:{
                        initSceneData: function() {
                            setJiachuiTextTips_hengYang(this, changeUIOff_shaoyang(MjClient.playui.getUIOff("xing")));
                ...
                zhuang: {
                    ...
                    _event: {
                        waitPut: function() {
                            if(MjClient.MaxPlayerNum_leiyang == 4 && !MjClient.data.sData.tData.areaSelectMode.zuoXing) {
                                showUserZhuangLogo_hengYang(this, changeUIOff_shaoyang(MjClient.playui.getUIOff("xing")));
                            }
                        },
                        initSceneData: function() {
                            if(MjClient.MaxPlayerNum_leiyang == 4 && !MjClient.data.sData.tData.areaSelectMode.zuoXing) {
                                if (IsArrowVisible_hengYang()) showUserZhuangLogo_hengYang(this, changeUIOff_shaoyang(MjClient.playui.getUIOff("xing")));
                            }else if(MjClient.data.sData.tData.areaSelectMode.zuoXing && IsArrowVisible_hengYang()){
                                this.visible = true;
                            }
                        },
                        mjhand: function(){
                        ...
                        _event: {
                            MJChat: function(msg) {
                                if(MjClient.MaxPlayerNum_leiyang == 4) {
                                    showUserChat_hengYang(this, changeUIOff_shaoyang(MjClient.playui.getUIOff("xing")), msg);
                                }
                            },
                            playVoice: function(voicePath) {
                                if(MjClient.MaxPlayerNum_leiyang == 4) {
                                    MjClient.data._tempMessage.msg = voicePath;
                                    showUserChat_hengYang(this, changeUIOff_shaoyang(MjClient.playui.getUIOff("xing")), MjClient.data._tempMessage);
                                }
                            }
                        }
                    }
                ...
                _click: function(btn) {
                    if(MjClient.MaxPlayerNum_leiyang == 4) {
                        showPlayerInfo_hengYang(changeUIOff_shaoyang(MjClient.playui.getUIOff("xing")), btn);
                    }
                },
                _event: {
                    loadWxHead: function(d) {
                        if(MjClient.MaxPlayerNum_leiyang == 4) {
                            setWxHead_hengYang(this, d, changeUIOff_shaoyang(MjClient.playui.getUIOff("xing")));
                        }
                    },
                    addPlayer: function() {
                        showFangzhuTagIcon_shaoyangZP(this, changeUIOff_shaoyang(MjClient.playui.getUIOff("xing")));
                    },
                    removePlayer: function() {
                        showFangzhuTagIcon_shaoyangZP(this, changeUIOff_shaoyang(MjClient.playui.getUIOff("xing")));
                    },
                ...
                huxi:{
                    ...
                    _event:{
                        ...
                        initSceneData:function(){
                            if(MjClient.MaxPlayerNum_leiyang == 4) {
                                this.visible = true;
                                var huXi = UpdateHuXi_hengYang(changeUIOff_shaoyang(MjClient.playui.getUIOff("xing")));
                                if (!IsArrowVisible_hengYang()) {
                                    huXi = 0;
                                    this.visible = false;
                                }
            ...
            ready: {
                ...
                _run: function() {
                    if(MjClient.MaxPlayerNum_leiyang == 4) {
                        GetReadyVisible_hengYang(this, changeUIOff_shaoyang(MjClient.playui.getUIOff("xing")));
                    }
                },
                _event: {
                    startShuffleCards:function (d) {
            ...
            _event: {
                clearCardUI: function() {
                    if(MjClient.MaxPlayerNum_leiyang == 4) {
                        clearCardUI_hengYang(this, changeUIOff_shaoyang(MjClient.playui.getUIOff("xing")));
                    }
                },
                clearCardArr: function(){
                    if(MjClient.MaxPlayerNum_leiyang == 4) {
                ...
                initSceneData: function(eD) {
                    if(MjClient.MaxPlayerNum_leiyang == 4) {
                        SetUserVisible_syBoPi(this, changeUIOff_shaoyang(MjClient.playui.getUIOff("xing")));
                        InitUserHandUI_syBoPi(this, changeUIOff_shaoyang(MjClient.playui.getUIOff("xing")));
                        InitUserCoinAndName_hengYang(this, changeUIOff_shaoyang(MjClient.playui.getUIOff("xing")));
                        DealOffLineCard_hengYang(this, changeUIOff_shaoyang(MjClient.playui.getUIOff("xing")));
                    }
                },
                addPlayer: function(eD) {
                    if(MjClient.MaxPlayerNum_leiyang == 4) {
                ...
                HZNewCard: function(eD) {
                    if(MjClient.MaxPlayerNum_leiyang == 4) {
                        ...
                        if(MjClient.data.sData.tData.areaSelectMode.zuoXing){
                            //DealNewCard_shaoyang(MjClient.playui._downNode, eD, changeUIOff_shaoyang(MjClient.playui.getUIOff("xing")));
                        }else{
                            DealNewCard_hengYang(this, eD, changeUIOff_shaoyang(MjClient.playui.getUIOff("xing")));
                        }   
                    }
                },
                roundEnd: function() {
                    if(MjClient.MaxPlayerNum_leiyang == 4) {
                        InitUserCoinAndName_hengYang(this, changeUIOff_shaoyang(MjClient.playui.getUIOff("xing")));
                        MjClient.playui.ResetOtherCard(this, changeUIOff_shaoyang(MjClient.playui.getUIOff("xing")));
                    }
                },
                waitPut: function(eD) {
                    if(MjClient.MaxPlayerNum_leiyang == 4) {
                        DealWaitPut(this, eD, changeUIOff_shaoyang(MjClient.playui.getUIOff("xing")));
                    }
                },
                MJPut: function(eD) {
                    if(MjClient.MaxPlayerNum_leiyang == 4) {
                        if(MjClient.data.sData.tData.areaSelectMode.zuoXing){
                            DealXingPlayerPutCard_shaoyang(MjClient.playui._downNode, eD, changeUIOff_shaoyang(MjClient.playui.getUIOff("xing")));
                        }else{
                            DealPutCard_hengYang(this, eD, changeUIOff_shaoyang(MjClient.playui.getUIOff("xing")));
                        }
                    }
                },
                HZChiCard: function(eD) {
                    if(MjClient.MaxPlayerNum_leiyang == 4) {
                        if(MjClient.data.sData.tData.areaSelectMode.zuoXing){
                            DealXingPlayerChiCard_shaoyang(MjClient.playui._downNode, eD, changeUIOff_shaoyang(MjClient.playui.getUIOff("xing")));
                        }else{
                            DealChiCard_hengYang(this, eD, changeUIOff_shaoyang(MjClient.playui.getUIOff("xing")));
                        }
                    }
                },
                HZGangCard: function(eD) {
                    if(MjClient.MaxPlayerNum_leiyang == 4) {
                        if(MjClient.data.sData.tData.areaSelectMode.zuoXing){
                            DealXingPlayerGangCard_shaoyang(MjClient.playui._downNode, eD, changeUIOff_shaoyang(MjClient.playui.getUIOff("xing")));
                        }else{
                            DealGangCard_hengYang(this, eD, changeUIOff_shaoyang(MjClient.playui.getUIOff("xing")));
                        }
                    }
                },
                MJPeng: function(eD) {
                    if(MjClient.MaxPlayerNum_leiyang == 4) {
                        if(MjClient.data.sData.tData.areaSelectMode.zuoXing){
                            DealXingPlayerPengCard_shaoyang(MjClient.playui._downNode, eD, changeUIOff_shaoyang(MjClient.playui.getUIOff("xing")));
                        }else{
                            DealPengCard_hengYang(this, eD, changeUIOff_shaoyang(MjClient.playui.getUIOff("xing")));
                        }
                    }
                },
                HZWeiCard: function(eD){
                    if(MjClient.MaxPlayerNum_leiyang == 4) {
                        if(MjClient.data.sData.tData.areaSelectMode.zuoXing){
                            DealXingPlayerWeiCard_shaoyang(MjClient.playui._downNode, eD, changeUIOff_shaoyang(MjClient.playui.getUIOff("xing")));
                        }else{
                            DealWeiCard_hengYang(this, eD, changeUIOff_shaoyang(MjClient.playui.getUIOff("xing")));
                        }
                    }
                },
                MJHu: function(eD) {
                    if(MjClient.MaxPlayerNum_leiyang == 4) {
                        DealHu_hengYang(this, eD, changeUIOff_shaoyang(MjClient.playui.getUIOff("xing")));
                    }
                },
                onlinePlayer: function(eD) {
                    if(MjClient.MaxPlayerNum_leiyang == 4) {
                        setUserOffline_hengYang(this, changeUIOff_shaoyang(MjClient.playui.getUIOff("xing")));
                    }
                },
                playerStatusChange: function(eD) {
                    if(MjClient.MaxPlayerNum_leiyang == 4) {
                ...
                MJFlower: function(eD) {
                    if(MjClient.MaxPlayerNum_leiyang == 4) {
                        HandleMJFlower(this, eD, changeUIOff_shaoyang(MjClient.playui.getUIOff("xing")));
                    }
                },
                MJTing: function (eD) {
                    if(MjClient.MaxPlayerNum_leiyang == 4) {
                        HandleMJTing(this, eD, changeUIOff_shaoyang(MjClient.playui.getUIOff("xing")));
                    }
                },
                HZPickCard:function (eD) {
                    if(MjClient.MaxPlayerNum_leiyang == 4) {
                        if (MjClient.rePlayVideo != -1 && !MjClient.data.sData.tData.areaSelectMode.zuoXing) {
                            var pl = getUIPlayer_hengYang(changeUIOff_shaoyang(MjClient.playui.getUIOff("xing")));
                            if (eD.uid == pl.info.uid) {
                                MjClient.OtherHandArr[changeUIOff_shaoyang(MjClient.playui.getUIOff("xing"))] = MjClient.majiang.sortHandCardSpecial(pl.mjhand)
                            }
                        }
                        if(MjClient.data.sData.tData.areaSelectMode.zuoXing){
                            DealXingPlayerPickCard_shaoyang(MjClient.playui._downNode, eD, changeUIOff_shaoyang(MjClient.playui.getUIOff("xing")));
                        }else{
                            DealShowLastCard_hengYang(this, eD, changeUIOff_shaoyang(MjClient.playui.getUIOff("xing")));
                        }   
                    }
                },
                HZAddCards:function (eD) {
                    if(MjClient.MaxPlayerNum_leiyang == 4) {
                        if(MjClient.data.sData.tData.areaSelectMode.zuoXing){
                            DealXingPlayerAddCard_shaoyang(MjClient.playui._downNode, eD, changeUIOff_shaoyang(MjClient.playui.getUIOff("xing")));
                        }else{
                            DealAddCard_hengYang(this, eD, changeUIOff_shaoyang(MjClient.playui.getUIOff("xing")));
                        }
                    }
                },
                HZCheckRaise:function (msg) {
        ...
        right: {
            head: {
                ...
                chuizi_tips : {
                    _run: function(){
                        setJiachuiImgTips_hengYang(this, changeUIOff_shaoyang(MjClient.playui.getUIOff("right")));
                    },
                    _event: {
                        initSceneData: function(){
                            setJiachuiImgTips_hengYang(this, changeUIOff_shaoyang(MjClient.playui.getUIOff("right")));
                ...
                jiachuiText_tips : {
                    _run: function() {
                        setJiachuiTextTips_hengYang(this, changeUIOff_shaoyang(MjClient.playui.getUIOff("right")));
                    },
                    _event:{
                        initSceneData: function() {
                            setJiachuiTextTips_hengYang(this, changeUIOff_shaoyang(MjClient.playui.getUIOff("right")));
                ...
                zhuang: {
                    ...
                    _event: {
                        waitPut: function() {
                            showUserZhuangLogo_hengYang(this, changeUIOff_shaoyang(MjClient.playui.getUIOff("right")));
                        },
                        initSceneData: function() {
                            if (IsArrowVisible_hengYang()) showUserZhuangLogo_hengYang(this, changeUIOff_shaoyang(MjClient.playui.getUIOff("right")));
                        },
                        mjhand: function(){
                            if (IsArrowVisible_hengYang()) showUserZhuangLogo_hengYang(this, changeUIOff_shaoyang(MjClient.playui.getUIOff("right")));
                        }
                ...
                chatbg: {
                    ...
                    chattext: {
                        _event: {
                            MJChat: function(msg) {
                                showUserChat_hengYang(this, changeUIOff_shaoyang(MjClient.playui.getUIOff("right")), msg);
                            },
                            playVoice: function(voicePath) {
                                MjClient.data._tempMessage.msg = voicePath;
                                showUserChat_hengYang(this, changeUIOff_shaoyang(MjClient.playui.getUIOff("right")), MjClient.data._tempMessage);
                            }
                        }
                    }
                },
                _click: function(btn) {
                    showPlayerInfo_hengYang(changeUIOff_shaoyang(MjClient.playui.getUIOff("right")), btn);
                },
                _event: {
                    loadWxHead: function(d) {
                        setWxHead_hengYang(this, d, changeUIOff_shaoyang(MjClient.playui.getUIOff("right")));
                    },
                    addPlayer: function() {
                        showFangzhuTagIcon_shaoyangZP(this, changeUIOff_shaoyang(MjClient.playui.getUIOff("right")));
                    },
                    removePlayer: function() {
                        showFangzhuTagIcon_shaoyangZP(this, changeUIOff_shaoyang(MjClient.playui.getUIOff("right")));
                    },
                ...
                huxi:{
                    ...
                    _event:{
                        ...
                        initSceneData:function(){
                            this.visible = true;
                            var huXi = UpdateHuXi_hengYang(changeUIOff_shaoyang(MjClient.playui.getUIOff("right")));
                            if(!IsArrowVisible_hengYang()){
                                huXi = 0;
                                this.visible = false;
                            }
            ...
            ready: {
                _layout: [[0.07, 0.07],[0.5, 0.5],[2.5, 2.5]],
                _run: function() {
                    GetReadyVisible_hengYang(this, changeUIOff_shaoyang(MjClient.playui.getUIOff("right")));
                },
                _event: {
                    startShuffleCards:function (d) {
                        GetReadyVisible_hengYang(this, -1);
            ...
            _event: {
                clearCardUI: function() {
                    clearCardUI_hengYang(this, changeUIOff_shaoyang(MjClient.playui.getUIOff("right")));
                },
                clearCardArr: function(){
                    var eatNode = this.getChildByName("eatNode");
                    eatNode.removeAllChildren();
                ...
                initSceneData: function(eD) {
                    SetUserVisible_syBoPi(this, changeUIOff_shaoyang(MjClient.playui.getUIOff("right")));
                    InitUserHandUI_syBoPi(this, changeUIOff_shaoyang(MjClient.playui.getUIOff("right")));
                    InitUserCoinAndName_hengYang(this, changeUIOff_shaoyang(MjClient.playui.getUIOff("right")));
                    DealOffLineCard_hengYang(this,changeUIOff_shaoyang(MjClient.playui.getUIOff("right")));

                    MjClient.playui.showAndHideTrust(this, changeUIOff_shaoyang(MjClient.playui.getUIOff("right")));
                },
                addPlayer: function(eD) {
                    SetUserVisible_syBoPi(this, changeUIOff_shaoyang(MjClient.playui.getUIOff("right")));
                    InitUserCoinAndName_hengYang(this, changeUIOff_shaoyang(MjClient.playui.getUIOff("right")));
                ...
                HZNewCard: function(eD) {
                    ...
                    DealNewCard_hengYang(this,eD,changeUIOff_shaoyang(MjClient.playui.getUIOff("right")));
                },
                roundEnd: function() {
                    InitUserCoinAndName_hengYang(this, changeUIOff_shaoyang(MjClient.playui.getUIOff("right")));
                    MjClient.playui.ResetOtherCard(this, changeUIOff_shaoyang(MjClient.playui.getUIOff("right")));
                },
                waitPut: function(eD) {
                    DealWaitPut(this, eD, changeUIOff_shaoyang(MjClient.playui.getUIOff("right")));
                },
                MJPut: function(eD) {
                    DealPutCard_hengYang(this, eD, changeUIOff_shaoyang(MjClient.playui.getUIOff("right")));
                },
                HZChiCard: function(eD) {
                    DealChiCard_hengYang(this, eD, changeUIOff_shaoyang(MjClient.playui.getUIOff("right")));
                },
                HZGangCard: function(eD) {
                    DealGangCard_hengYang(this, eD, changeUIOff_shaoyang(MjClient.playui.getUIOff("right")));
                },
                MJPeng: function(eD) {
                    DealPengCard_hengYang(this, eD, changeUIOff_shaoyang(MjClient.playui.getUIOff("right")));
                },
                HZWeiCard: function(eD){
                    DealWeiCard_hengYang(this, eD, changeUIOff_shaoyang(MjClient.playui.getUIOff("right")));
                },
                MJHu: function(eD) {
                    DealHu_hengYang(this, eD, changeUIOff_shaoyang(MjClient.playui.getUIOff("right")));
                },
                onlinePlayer: function(eD) {
                    setUserOffline_hengYang(this, changeUIOff_shaoyang(MjClient.playui.getUIOff("right")));
                },
                playerStatusChange: function(eD) {
                    setUserOffline_hengYang(this, changeUIOff_shaoyang(MjClient.playui.getUIOff("right")));
                },
                MJFlower: function(eD) {
                    HandleMJFlower(this, eD, changeUIOff_shaoyang(MjClient.playui.getUIOff("right")));
                },
                MJTing: function (eD) {
                    HandleMJTing(this, eD, changeUIOff_shaoyang(MjClient.playui.getUIOff("right")));
                },
                HZPickCard:function (eD) {
                    if(MjClient.rePlayVideo != -1){
                        var pl = getUIPlayer_hengYang(changeUIOff_shaoyang(MjClient.playui.getUIOff("right")));
                        if(eD.uid == pl.info.uid) {
                            MjClient.OtherHandArr[changeUIOff_shaoyang(MjClient.playui.getUIOff("right"))] = MjClient.majiang.sortHandCardSpecial(pl.mjhand)
                        }
                    }

                    DealShowLastCard_hengYang(this, eD, changeUIOff_shaoyang(MjClient.playui.getUIOff("right")));
                },
                HZAddCards:function (eD) {
                    DealAddCard_hengYang(this,eD, changeUIOff_shaoyang(MjClient.playui.getUIOff("right")));
                },
                HZCheckRaise:function (msg) {
                    ShowPutCardIcon();
        ...
        left: {
            head: {
                ...
                chuizi_tips : {
                    _run: function(){
                        setJiachuiImgTips_hengYang(this, changeUIOff_shaoyang(MjClient.MaxPlayerNum_leiyang - 1));
                    },
                    _event: {
                        initSceneData: function() {
                            setJiachuiImgTips_hengYang(this, changeUIOff_shaoyang(MjClient.MaxPlayerNum_leiyang - 1));
                ...
                jiachuiText_tips : {
                    _run: function() {
                        setJiachuiTextTips_hengYang(this, changeUIOff_shaoyang(MjClient.MaxPlayerNum_leiyang - 1));
                    },
                    _event:{
                        initSceneData: function() {
                            setJiachuiTextTips_hengYang(this, changeUIOff_shaoyang(MjClient.MaxPlayerNum_leiyang - 1));
                ...
                zhuang: {
                    ...
                    _event: {
                        waitPut: function() {
                            showUserZhuangLogo_hengYang(this, changeUIOff_shaoyang(MjClient.MaxPlayerNum_leiyang - 1));
                        },
                        initSceneData: function() {
                            if (IsArrowVisible_hengYang()) showUserZhuangLogo_hengYang(this,changeUIOff_shaoyang(MjClient.MaxPlayerNum_leiyang - 1));
                        },
                        mjhand: function(){
                            if (IsArrowVisible_hengYang()) showUserZhuangLogo_hengYang(this,changeUIOff_shaoyang(MjClient.MaxPlayerNum_leiyang - 1));
                        }
                ...
                chatbg: {
                    ...
                    chattext: {
                        _event: {
                            MJChat: function(msg) {
                                showUserChat_hengYang(this,changeUIOff_shaoyang(MjClient.MaxPlayerNum_leiyang - 1), msg);
                            },
                            playVoice: function(voicePath) {
                                MjClient.data._tempMessage.msg = voicePath;
                                showUserChat_hengYang(this,changeUIOff_shaoyang(MjClient.MaxPlayerNum_leiyang - 1), MjClient.data._tempMessage);
                            }
                        }
                    }
                },
                _click: function(btn) {
                    showPlayerInfo_hengYang(changeUIOff_shaoyang(MjClient.MaxPlayerNum_leiyang - 1), btn);
                },
                _event: {
                    loadWxHead: function(d) {
                        setWxHead_hengYang(this, d,changeUIOff_shaoyang(MjClient.MaxPlayerNum_leiyang - 1));
                    },
                    addPlayer: function() {
                        showFangzhuTagIcon_shaoyangZP(this, changeUIOff_shaoyang(MjClient.MaxPlayerNum_leiyang - 1));
                    },
                    removePlayer: function() {
                        showFangzhuTagIcon_shaoyangZP(this, changeUIOff_shaoyang(MjClient.MaxPlayerNum_leiyang - 1));
                    },
                ...
                huxi:{
                    _event:{
                        ...
                        initSceneData:function(){
                            this.visible = true;
                            var huXi = UpdateHuXi_hengYang(changeUIOff_shaoyang(MjClient.MaxPlayerNum_leiyang - 1));
                            if(!IsArrowVisible_hengYang()){
                                huXi = 0;
                                this.visible = false;
                            }
            ...
            ready: {
                _layout: [[0.07, 0.07],[0.5, 0.5],[-2.5, 2.5]],
                _run: function() {
                    GetReadyVisible_hengYang(this, changeUIOff_shaoyang(MjClient.MaxPlayerNum_leiyang - 1));
                },
                _event: {
                    startShuffleCards:function (d) {
                        GetReadyVisible_hengYang(this, -1);
            ...
            _event: {
                clearCardUI: function() {
                    clearCardUI_hengYang(this, changeUIOff_shaoyang(MjClient.MaxPlayerNum_leiyang - 1));
                },
                clearCardArr: function(){
                    var eatNode = this.getChildByName("eatNode");
                    eatNode.removeAllChildren();
                ...
                initSceneData: function(eD) {
                    SetUserVisible_syBoPi(this, changeUIOff_shaoyang(MjClient.MaxPlayerNum_leiyang - 1));
                    InitUserHandUI_syBoPi(this, changeUIOff_shaoyang(MjClient.MaxPlayerNum_leiyang - 1));
                    InitUserCoinAndName_hengYang(this, changeUIOff_shaoyang(MjClient.MaxPlayerNum_leiyang - 1));
                    DealOffLineCard_hengYang(this,changeUIOff_shaoyang(MjClient.MaxPlayerNum_leiyang - 1));
                    MjClient.playui.showAndHideTrust(this, changeUIOff_shaoyang(MjClient.MaxPlayerNum_leiyang - 1));
                },
                addPlayer: function(eD) {
                    SetUserVisible_syBoPi(this, changeUIOff_shaoyang(MjClient.MaxPlayerNum_leiyang - 1));
                    InitUserCoinAndName_hengYang(this, changeUIOff_shaoyang(MjClient.MaxPlayerNum_leiyang - 1));
                ...
                HZNewCard: function(eD) {
                    ...
                    DealNewCard_hengYang(this,eD,changeUIOff_shaoyang(MjClient.MaxPlayerNum_leiyang - 1));
                },
                roundEnd: function() {
                    InitUserCoinAndName_hengYang(this, changeUIOff_shaoyang(MjClient.MaxPlayerNum_leiyang - 1));
                    MjClient.playui.ResetOtherCard(this, changeUIOff_shaoyang(MjClient.MaxPlayerNum_leiyang - 1));
                },
                waitPut: function(eD) {
                    DealWaitPut(this, eD, changeUIOff_shaoyang(MjClient.MaxPlayerNum_leiyang - 1));
                },
                MJPut: function(eD) {
                    DealPutCard_hengYang(this, eD, changeUIOff_shaoyang(MjClient.MaxPlayerNum_leiyang - 1));
                },
                HZChiCard: function(eD) {
                    DealChiCard_hengYang(this, eD, changeUIOff_shaoyang(MjClient.MaxPlayerNum_leiyang - 1));
                },
                HZPaoCard: function(eD) {
                    DealPaoCard_hengYang(this, eD, changeUIOff_shaoyang(MjClient.MaxPlayerNum_leiyang - 1));
                },
                HZGangCard: function(eD) {
                    DealGangCard_hengYang(this, eD, changeUIOff_shaoyang(MjClient.MaxPlayerNum_leiyang - 1));
                },
                MJPeng: function(eD) {
                    DealPengCard_hengYang(this, eD, changeUIOff_shaoyang(MjClient.MaxPlayerNum_leiyang - 1));
                },
                HZWeiCard: function(eD){
                    DealWeiCard_hengYang(this, eD, changeUIOff_shaoyang(MjClient.MaxPlayerNum_leiyang - 1));
                },
                MJHu: function(eD) {
                    DealHu_hengYang(this, eD, changeUIOff_shaoyang(MjClient.MaxPlayerNum_leiyang - 1));
                },
                onlinePlayer: function(eD) {
                    setUserOffline_hengYang(this, changeUIOff_shaoyang(MjClient.MaxPlayerNum_leiyang - 1));
                },
                playerStatusChange: function(eD) {
                    setUserOffline_hengYang(this, changeUIOff_shaoyang(MjClient.MaxPlayerNum_leiyang - 1));
                },
                MJFlower: function(eD) {
                    HandleMJFlower(this, eD, changeUIOff_shaoyang(MjClient.MaxPlayerNum_leiyang - 1));
                },
                MJTing: function (eD) {
                    HandleMJTing(this, eD, changeUIOff_shaoyang(MjClient.MaxPlayerNum_leiyang - 1));
                },
                HZPickCard:function (eD) {
                    if(MjClient.rePlayVideo != -1) {
                        var pl = getUIPlayer_hengYang(changeUIOff_shaoyang(MjClient.MaxPlayerNum_leiyang - 1));
                        if(eD.uid == pl.info.uid){
                            MjClient.OtherHandArr[MjClient.MaxPlayerNum_leiyang - 1] = MjClient.majiang.sortHandCardSpecial(pl.mjhand)
                        }
                    }
                    DealShowLastCard_hengYang(this, eD, changeUIOff_shaoyang(MjClient.MaxPlayerNum_leiyang - 1));
                },
                HZAddCards:function (eD) {
                    DealAddCard_hengYang(this,eD, changeUIOff_shaoyang(MjClient.MaxPlayerNum_leiyang - 1));
                },
                HZCheckRaise:function (msg) {
                    ShowPutCardIcon();
                    var tData = MjClient.data.sData.tData;
                    ...
                    this.adaptChiLayout = function() {
                        ...
                        if (cards_option.length == 0) { // 吃牌选好了
                            if ((MjClient.data.sData.players[SelfUid()].eatFlag & 32) > 0) {
                                MjClient.showMsg("选择吃后视为过胡，确定吃吗？", function() {
                                    ...
                                    HZChiToServer_hengYang(cards_select[0], biCards);
                                    this.visible = false;
                                }.bind(this), function() {
                                    cards_select.pop();
                                    this.adaptChiLayout();
                        ...
                        for (var i = 0; i < cards_select.length; i++) {
                            ...
                            for (var j = 0; j < row.length; j++) {
                                ...
                                chiCardImg.loadTexture(MjClient.cardPath_hengYang + "out" + row[j] + ".png");
        ...
        chat_btn: {
            ...
            _click: function() {
                ...
                // MjClient.Scene.addChild(new GameOverLayer_syZiPai(),500);
            }
        },
        voice_btn: {
    ...
    ctor: function() {
        this._super();
        var playui = ccs.load("Play_syBoPi.json");
        playMusic("bgFight");
        var tData = MjClient.data.sData.tData;
        ...
        // test 
        // this.addChild(new EndOneView_syZiPai(),500); 
        return true;
    },
...
//切换xing、right节点的偏移
PlayLayer_syBoPi.prototype.getUIOff = function(name){
    var tData = MjClient.data.sData.tData;
    if(tData.areaSelectMode.zuoXing){
        ...
        if(name == "xing"){
            ...
            return MjClient.MaxPlayerNum_leiyang - 2;
        }
    }
};
PlayLayer_syBoPi.prototype.ResetHandCard = function(posNode,off, needAction, isDelay){
    resetHandCard_hengYang(posNode,off, needAction, isDelay);
}
/*
//重置手牌的顺序
PlayLayer_syBoPi.prototype.ResetHandCard = function(posNode,off, needAction, isDelay){
    ...
    if(MjClient.rePlayVideo == -1){
        ...
        if(off == 0){
            ...
            }else if(MjClient.MaxPlayerNum_leiyang == 4 && !tData.areaSelectMode.zuoXing){
        ...
        if(off != 0 && tData.areaSelectMode.zuoXing){
        ...
        for(var k = 0;k < cardArr.length;k++){
            ...
            for(var j = 0;j < groupList.length;j++){
                if(off == 0){
                    if(MjClient.MaxPlayerNum_leiyang == 3 || MjClient.MaxPlayerNum_leiyang == 2 
                        || (MjClient.MaxPlayerNum_leiyang == 4 && tData.areaSelectMode.zuoXing))
                    {
                        addHandCard_hengYang(k,j,groupList[j],off);
                    }else if(MjClient.MaxPlayerNum_leiyang == 4){
        ...
        if(off == 0 && (MjClient.MaxPlayerNum_leiyang == 3 || MjClient.MaxPlayerNum_leiyang == 2|| (MjClient.MaxPlayerNum_leiyang == 4 && tData.areaSelectMode.zuoXing))) {
            var scale_x = handCard.scaleX;
            var winSize = MjClient.size;
...
*/
PlayLayer_syBoPi.prototype._doMovetoAction = function(node,endP){
    node.stopAllActions();
    var ac = cc.moveTo(0.3,endP);
    node.runAction(ac);
};

PlayLayer_syBoPi.prototype.ResetOtherCard = function(posNode, off) {
    // 添加吃、碰、跑、偎、提
    var sData = MjClient.data.sData;
    var tData = null;
    if (sData) {
    ...
    if (mjSortArr) {
        ...
        var callback = function(childList) {
            ...
            for (var i = 0; i < childList.length; i++) {
                ...
                if (i != getShowCardIdx_hengYang(posNode, chiTip)) {
...
PlayLayer_syBoPi.prototype.ResetPutCard = function(posNode, off) {
    //添加打出的牌
    var pl = getUIPlayer_hengYang(off);
    ...
    for (var i = 0; i < pl.mjput.length; i++) {
        ...
        //                 outCard.y = outNode.height + outCard.height;
        //             }
        //         }
        //     } else if (off == 2) {
        //         outCard.anchorX = 1;
        ...
        //             outCard.y = outNode.height;
        //             if (childCount >= 8) {
        //                 outCard.x = childCount * outCard.width - 8 * outCard.width;
        //                 outCard.y = outNode.height + outCard.height;
        //             }
        //         }
        //     } else if (off == 3) {
...
//重置牌的顺序
PlayLayer_syBoPi.prototype.CardLayoutRestore = function(posNode,off){
    if (MjClient.rePlayVideo == -1) {
...
// 判断吃、碰、跑、偎、提、胡的状态
PlayLayer_syBoPi.prototype.EatVisibleCheck = function(off){
    var eat = MjClient.playui.jsBind.eat;
...
PlayLayer_syBoPi.prototype.showAndHideHeadEffect = function(){
    var tData = MjClient.data.sData.tData;
    var arr = [this._downNode, this._xingNode, this._rightNode, this._topNode];
    if(MjClient.MaxPlayerNum_leiyang == 3){
        arr = [this._downNode, this._rightNode, this._topNode];
    }else if(MjClient.MaxPlayerNum_leiyang == 4 && tData.xingPlayer != -1){
        arr = [this._downNode, this._rightNode, this._downNode, this._topNode];
    }
    ...
    }else if(curPlayerIsMe_hengYang(3)){
    ...
    {   
        ...
        _armature = this._xingNode.getChildByName("head").getChildByTag(tag);
        if(_armature && cc.sys.isObjectValid(_armature)){
            _armature.visible = false;
        }
...
PlayLayer_syBoPi.prototype.addHeadEffect = function(head){
    var tag = 2018322;
...
PlayLayer_syBoPi.prototype.showAndHideTrust = function(node, uiOff){
    var tData = MjClient.data.sData.tData;
...
PlayLayer_syBoPi.prototype.showCountdown = function(node){
