...
function SetUserVisible_syBoPiTwoPlayer(node, off){
...
function InitUserHandUI_syBoPiTwoPlayer(node, off){
...
var PlayLayer_syBoPiTwoPlayer = cc.Layer.extend({
    jsBind: {
        _event: {
            ...
            roundEnd: function() {
                ...
                function delayExe(){
                    ...
                    if(!MjClient.endoneui){
                        self.addChild(new EndOneView_syZiPai(),500)
                    }
            ...
            EZP_layout : function(){
                if(MjClient.data.sData.tData.maxPlayer < 4){
                    ...
                    MjClient.playui.ResetPutCard(MjClient.playui._topNode, MjClient.MaxPlayerNum_leiyang-1);
                }
            },
        ...
        roundInfo:{
            ...
            _run:function(){
                ...
                //     personInfo = "四人坐醒"; 
                // }else{
                //     personInfo = tData.areaSelectMode.maxPlayer + "人";
                // }
                // str += personInfo;
        ...
        down: {
            ...
            _event: {
                ...
                initSceneData: function(eD) {
                    SetUserVisible_syBoPiTwoPlayer(this, changeUIOff_shaoyang(0));
                    InitUserHandUI_syBoPiTwoPlayer(this, changeUIOff_shaoyang(0));
...
//切换xing、right节点的偏移
PlayLayer_syBoPiTwoPlayer.prototype.getUIOff = function(name){
    if(name == "right"){
        return 1;
    }
    return 0;
};
PlayLayer_syBoPiTwoPlayer.prototype.ResetHandCard = function(posNode,off, needAction, isDelay){
...
*/
PlayLayer_syBoPiTwoPlayer.prototype._doMovetoAction = function(node,endP){
    node.stopAllActions();
    var ac = cc.moveTo(0.3,endP);
    node.runAction(ac);
};

PlayLayer_syBoPiTwoPlayer.prototype.ResetOtherCard = function(posNode, off) {
    // 添加吃、碰、跑、偎、提
    var sData = MjClient.data.sData;
    var tData = null;
    if (sData) {
...
PlayLayer_syBoPiTwoPlayer.prototype.ResetPutCard = function(posNode, off) {
    //添加打出的牌
    var pl = getUIPlayer_hengYang(off);
...
//重置牌的顺序
PlayLayer_syBoPiTwoPlayer.prototype.CardLayoutRestore = function(posNode,off){
    if (MjClient.rePlayVideo == -1) {
...
// 判断吃、碰、跑、偎、提、胡的状态
PlayLayer_syBoPiTwoPlayer.prototype.EatVisibleCheck = function(off){
    var eat = MjClient.playui.jsBind.eat;
