var ShuffleEffectLayer = cc.Layer.extend({
    jsBind: {
        _event: {
            mjhand: function(eD) {
	...
	ctor : function(){
        ...
        var node = ccs.load("shuffleEffect_ziPai.json").node;
        this.addChild(node);
    ...
    playEffect : function(uid) {
        ...
        if(pl) {
            ...
            var spineNode = createSpine("spine/ziPaiShuffle/zipai.json", "spine/ziPaiShuffle/zipai.atlas");
