...
function SetUserVisible_syBoPiZuoXing(node, off){
...
function InitUserHandUI_syBoPiZuoXing(node, off){
...
var PlayLayer_syBoPiZuoXing = cc.Layer.extend({
    jsBind: {
        _event: {
        ...
        down: {
            ...
            _event: {
                ...
                initSceneData: function(eD) {
                    SetUserVisible_syBoPiZuoXing(this, 0);
                    InitUserHandUI_syBoPiZuoXing(this, 0);
                ...
                HZPickCard:function (eD) {
                    ...
                    if(MjClient.rePlayVideo != -1){
                        if(eD.uid == pl.info.uid) {
                            ...
                            MjClient.playui.ResetHandCard(MjClient.playui._rightNode,2);
                        }
                ...
                HZAddCards:function (eD) {
                    if(isXingPlayer_shaoyang(0)){
                        DealXingPlayerAddCard_shaoyang(this,eD, 0);
                    }else{
        ...
        xing: {
            ...
            _event: {
                ...
                initSceneData: function(eD) {
                    SetUserVisible_syBoPiZuoXing(this, 1);
                    InitUserHandUI_syBoPiZuoXing(this, 1);
                ...
                HZPickCard:function (eD) {
                    if(MjClient.rePlayVideo != -1){
                        ...
                        if(eD.uid == pl.info.uid) {
                            ...
                            MjClient.playui.ResetHandCard(MjClient.playui._topNode,3);
                        }
                    }
                    if(isXingPlayer_shaoyang(1) && MjClient.rePlayVideo != -1){
                ...
                HZAddCards:function (eD) {
                    if(isXingPlayer_shaoyang(1) && MjClient.rePlayVideo != -1){
                        DealXingPlayerAddCard_shaoyang(this,eD, 1);
                    }else{
        ...
        right: {
            head: {
                chuizi_tips : {
                    _run: function(){
                        setJiachuiImgTips_hengYang(this, 2);
                    },
                    _event: {
                        initSceneData: function(){
                            setJiachuiImgTips_hengYang(this, 2);
                ...
                jiachuiText_tips : {
                    _run: function() {
                        setJiachuiTextTips_hengYang(this, 2);
                    },
                    _event:{
                        initSceneData: function() {
                            setJiachuiTextTips_hengYang(this, 2);
                ...
                zhuang: {
                    ...
                    _event: {
                        ...
                        initSceneData: function() {
                            if (IsArrowVisible_hengYang()) showUserZhuangLogoZuoXing_hengYang(this, 2);
                        },
                        mjhand: function(){
                            if (IsArrowVisible_hengYang()) showUserZhuangLogoZuoXing_hengYang(this, 2);
                        }
            ...
            _event: {
                ...
                initSceneData: function(eD) {
                    SetUserVisible_syBoPiZuoXing(this, 2);
                    InitUserHandUI_syBoPiZuoXing(this, 2);
                ...
                HZAddCards:function (eD) {
                    if(isXingPlayer_shaoyang(2) && MjClient.rePlayVideo != -1){
                        DealXingPlayerAddCard_shaoyang(this,eD, 2);
                    }else{
        ...
        left: {
            head: {
                chuizi_tips : {
                    _run: function(){
                        setJiachuiImgTips_hengYang(this, 3);
                    },
                    _event: {
                        initSceneData: function() {
                            setJiachuiImgTips_hengYang(this, 3);
                ...
                jiachuiText_tips : {
                    _run: function() {
                        setJiachuiTextTips_hengYang(this, 3);
                    },
                    _event:{
                        initSceneData: function() {
                            setJiachuiTextTips_hengYang(this, 3);
                ...
                chatbg: {
                    ...
                    chattext: {
                        _event: {
                            MJChat: function(msg) {
                                showUserChat_hengYang(this,3, msg);
                            },
                            playVoice: function(voicePath) {
                                MjClient.data._tempMessage.msg = voicePath;
                                showUserChat_hengYang(this,3, MjClient.data._tempMessage);
                            }
                        }
                    }
                },
                _click: function(btn) {
                    showPlayerInfo_hengYang(3, btn);
                },
                _event: {
                    loadWxHead: function(d) {
                        setWxHead_hengYang(this, d,3);
                    },
                    addPlayer: function() {
                ...
                huxi:{
                    ...
                    _event:{
                        ...
                        initSceneData:function(){
                            this.visible = true;
                            var huXi = UpdateHuXi_hengYang(3);
                            if(!IsArrowVisible_hengYang()){
                                huXi = 0;
                            }
                            return this.setString("胡息:" + huXi);
            ...
            ready: {
                _layout: [[0.07, 0.07],[0.5, 0.5],[-2.5, 2.5]],
                _run: function() {
                    GetReadyVisible_hengYang(this, 3);
                },
                _event: {
                    startShuffleCards:function (d) {
                        GetReadyVisible_hengYang(this, -1);
            ...
            _event: {
                ...
                initSceneData: function(eD) {
                    SetUserVisible_syBoPiZuoXing(this, 3);
                    InitUserHandUI_syBoPiZuoXing(this, 3);
                    InitUserCoinAndName_hengYang(this, 3);
                    DealOffLineCard_hengYang(this,3);
                },
                addPlayer: function(eD) {
                    SetUserVisible_syBoPiZuoXing(this, 3);
                    InitUserCoinAndName_hengYang(this, 3);
                ...
                HZNewCard: function(eD) {
                    ...
                    DealNewCard_hengYang(this,eD,3);
                },
                roundEnd: function() {
                    InitUserCoinAndName_hengYang(this, 3);
                ...
                MJPut: function(eD) {
                    if(isXingPlayer_shaoyang(3) && MjClient.rePlayVideo != -1){
                        ...
                        DealPutCard_hengYang(this,eD,3);
                    }
                },
                HZChiCard: function(eD) {
                    if(isXingPlayer_shaoyang(3) && MjClient.rePlayVideo != -1){
                        ...
                        DealChiCard_hengYang(this, eD, 3);
                    }
                },
                ...
                HZGangCard: function(eD) {
                    if(isXingPlayer_shaoyang(3) && MjClient.rePlayVideo != -1){
                        ...
                        DealGangCard_hengYang(this, eD, 3);
                    }
                },
                MJPeng: function(eD) {
                    if(isXingPlayer_shaoyang(3) && MjClient.rePlayVideo != -1){
                        ...
                        DealPengCard_hengYang(this, eD, 3);
                    }
                },
                HZWeiCard: function(eD){
                    if(isXingPlayer_shaoyang(3) && MjClient.rePlayVideo != -1){
                        ...
                        DealWeiCard_hengYang(this,eD,3);
                    } 
                },
                MJHu: function(eD) {
                    DealHu_hengYang(this, eD, 3);
                },
                onlinePlayer: function(eD) {
                ...
                HZPickCard:function (eD) {
                    if(MjClient.rePlayVideo != -1){
                        ...
                        if(eD.uid == pl.info.uid) {
                            MjClient.OtherHandArr[3] = MjClient.majiang.sortHandCardSpecial(pl.mjhand);
                            MjClient.OtherHandArr[1] = MjClient.majiang.sortHandCardSpecial(pl.mjhand);
                            MjClient.playui.ResetHandCard(MjClient.playui._xingNode,1);
                        }
                    }
                    if(isXingPlayer_shaoyang(3) && MjClient.rePlayVideo != -1){
                ...
                HZAddCards:function (eD) {
                    if(isXingPlayer_shaoyang(3) && MjClient.rePlayVideo != -1){
                        DealXingPlayerAddCard_shaoyang(this,eD, 3);
                    }else{
...
//重置手牌的顺序
PlayLayer_syBoPiZuoXing.prototype.ResetHandCard = function(posNode,off, needAction, isDelay){
    needAction = false;
    ...
    if(MjClient.rePlayVideo == -1){
        ...
        var handCard = posNode.getChildByName("out0");
        var cardArr = null;
...
PlayLayer_syBoPiZuoXing.prototype._doMovetoAction = function(node,endP){
    node.stopAllActions();
    var ac = cc.moveTo(0.3,endP);
    node.runAction(ac);
};

PlayLayer_syBoPiZuoXing.prototype.ResetOtherCard = function(posNode, off) {
    // 添加吃、碰、跑、偎、提
    var sData = MjClient.data.sData;
    var tData = null;
    if (sData) {
...
PlayLayer_syBoPiZuoXing.prototype.ResetPutCard = function(posNode, off) {
    //添加打出的牌
    var pl = getUIPlayer_hengYang(off);
...
//重置牌的顺序
PlayLayer_syBoPiZuoXing.prototype.CardLayoutRestore = function(posNode,off){
    if (MjClient.rePlayVideo == -1) {
...
// 判断吃、碰、跑、偎、提、胡的状态
PlayLayer_syBoPiZuoXing.prototype.EatVisibleCheck = function(off){
...
PlayLayer_syBoPiZuoXing.prototype.showAndHideHeadEffect = function(){
    var tData = MjClient.data.sData.tData;
...
//手牌张数 
PlayLayer_syBoPiZuoXing.prototype.getHandCount = function() {
    return 20;
}
PlayLayer_syBoPiZuoXing.prototype.loadCardTexture = function (node, num) {
    node.loadTexture(MjClient.cardPath_hengYang+"out" + num + ".png"); 
};