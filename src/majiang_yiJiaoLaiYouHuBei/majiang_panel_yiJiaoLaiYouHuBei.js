...
var majiang_panel_yiJiaoLaiYouHuBei;
(function () {

    majiang_panel_yiJiaoLaiYouHuBei = majiang_panel_hubei.extend({
        jsonFile: "Play_majiang_yiJiaoLaiYou.json",
        ...
        ctor: function () {
            this._super(majiang_panel_yiJiaoLaiYouHuBei, this.jsonFile);
            return true;
        },
        ...
        createEndOnePanel: function(){
            return new majiang_winGamePanel_yiJiaoLaiYouHuBei();
        },
     ...
     *  是否显示癞子牌
     **/
    majiang_panel_yiJiaoLaiYouHuBei.prototype.isHunCardShow = function () {
        return true;
    };
     ...
     *  获取朝牌
     **/
    majiang_panel_yiJiaoLaiYouHuBei.prototype.getChaoCard = function () {
     ...
     *  是否能添加癞子标识
     **/
    majiang_panel_yiJiaoLaiYouHuBei.prototype.isCanAddLaiZiIcon = function (cardTag) {
        var tData = MjClient.data.sData.tData;
     ...
     *  获得癞子标识
     **/
    majiang_panel_yiJiaoLaiYouHuBei.prototype.getLaiZiIcon2D = function (cardTag) {
     ...
     *  撑癞子动画
     **/
    majiang_panel_yiJiaoLaiYouHuBei.prototype.addChengLaiZiAni = function (playerNode, msg) {
