...
function addWxHeadToEndUI_rudong(node,off)
{
...
function SetEndOneUserUI_rudong(node,off)
{
    ...
    addWxHeadToEndUI_rudong(uibind.head._node,off);
...
var EndOneView_rudong = cc.Layer.extend({
	jsBind:{
        block: {
		...
		head0:{
		   ...
		   _run:function(){ SetEndOneUserUI_rudong(this,0); },
		...
		,head1:{
		  ...
		  _run:function(){ SetEndOneUserUI_rudong(this,1); }
		}
		,head2:{
		   head:{
			   zhuang:{_visible:false}
		   ...
		   _run:function(){ SetEndOneUserUI_rudong(this,2); }
		}
		}
	},
    ctor:function () {
        this._super();
        var endoneui = ccs.load(res.EndOne_rudong_json);
