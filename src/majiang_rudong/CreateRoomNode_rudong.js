...
var CreateRoomNode_rudong = CreateRoomNode.extend({
    setKeyByCardFriend:function(){
        // this.localStorageKey.KEY_rudong_147_xiJiang    = "_RU_DONG_147_XI_JIANG";  //是否147喜将
        this.localStorageKey.KEY_rudong_mengzigun      = "CF_RU_DONG_MEN_ZI_GUN";     //闷子棍
        this.localStorageKey.KEY_rudong_shuanglonghui  = "CF_RU_DONG_SHUANG_LONG_HUI";       //双龙汇
        this.localStorageKey.KEY_rudong_huimianchuhan  = "CF_RU_DONG_HUI_MIAN_CHU_HAN";   //会面出汗
        this.localStorageKey.KEY_rudong_haidilaoyue    = "CF_RU_DONG_HAI_DI_LAO_YUE";       //海底捞月
        this.localStorageKey.KEY_rudong_fengdingNum    = "CF_RU_DONG_FENG_DING_NUM";       //封顶数
        this.localStorageKey.KEY_rudong_daixi          = "CF_RU_DONG_DAI_XI";       //带喜
        this.localStorageKey.KEY_rudong_shengyihu      = "CF_RU_DONG_SHENG_YI_HU";       //剩一胡
        this.localStorageKey.KEY_rudong_sanlaohuimian  = "CF_RU_DONG_SAN_LAO_HUI_MIAN";       //三老会面
        this.localStorageKey.KEY_rudong_maizhuang      = "CF_RU_DONG_MAI_ZHUANG";       //买装
        this.localStorageKey.KEY_rudong_jizi           = "CF_RU_DONG_JI_ZI";       //机子
        this.localStorageKey.KEY_rudong_daixi1         = "CF_RU_DONG_XI1";       //喜1
        this.localStorageKey.KEY_rudong_daixi2         = "CF_RU_DONG_XI2";       //喜2
        this.localStorageKey.KEY_rudong_tiehu          = "CF_RU_DONG_TIE_HU"; //贴胡
        this.localStorageKey.KEY_rudong_qitie          = "CF_RU_DONG_QI_TIE"; //起贴
        this.localStorageKey.KEY_rudong_tiehuCount     = "CF_RU_DONG_TIE_HU_COUNT"; //贴胡数
    },
    setKey:function(){
        // this.localStorageKey.KEY_rudong_147_xiJiang    = "_RU_DONG_147_XI_JIANG";  //是否147喜将
        this.localStorageKey.KEY_rudong_mengzigun      = "_RU_DONG_MEN_ZI_GUN";     //闷子棍
        this.localStorageKey.KEY_rudong_shuanglonghui  = "_RU_DONG_SHUANG_LONG_HUI";       //双龙汇
        this.localStorageKey.KEY_rudong_huimianchuhan  = "_RU_DONG_HUI_MIAN_CHU_HAN";   //会面出汗
        this.localStorageKey.KEY_rudong_haidilaoyue    = "_RU_DONG_HAI_DI_LAO_YUE";       //海底捞月
        this.localStorageKey.KEY_rudong_fengdingNum    = "_RU_DONG_FENG_DING_NUM";       //封顶数
        this.localStorageKey.KEY_rudong_daixi          = "_RU_DONG_DAI_XI";       //带喜
        this.localStorageKey.KEY_rudong_shengyihu      = "_RU_DONG_SHENG_YI_HU";       //剩一胡
        this.localStorageKey.KEY_rudong_sanlaohuimian  = "_RU_DONG_SAN_LAO_HUI_MIAN";       //三老会面
        this.localStorageKey.KEY_rudong_maizhuang      = "_RU_DONG_MAI_ZHUANG";       //买装
        this.localStorageKey.KEY_rudong_jizi           = "_RU_DONG_JI_ZI";       //机子
        this.localStorageKey.KEY_rudong_daixi1         = "_RU_DONG_XI1";       //喜1
        this.localStorageKey.KEY_rudong_daixi2         = "_RU_DONG_XI2";       //喜2
        this.localStorageKey.KEY_rudong_tiehu          = "_RU_DONG_TIE_HU"; //贴胡
        this.localStorageKey.KEY_rudong_qitie          = "_RU_DONG_QI_TIE"; //起贴
        this.localStorageKey.KEY_rudong_tiehuCount     = "_RU_DONG_TIE_HU_COUNT"; //贴胡数
    },
    ...
    initAll:function(IsFriendCard)
    {
        ...
        this.bg_node = ccs.load("bg_rudong.json").node;

        this.addChild(this.bg_node);
        this.bg_node = this.bg_node.getChildByName("bg_rudong");
    ...
    initPlayNode:function()
    {
        ...
        //带喜1
        this._playNode_daixi1 = _play.getChildByName("daixi1");
        this.addListenerText(this._playNode_daixi1);
        this._playNode_daixi1.addEventListener(this.clickCB, this._playNode_daixi1);

        //带喜2
        this._playNode_daixi2 = _play.getChildByName("daixi2");
        this.addListenerText(this._playNode_daixi2);
        this._playNode_daixi2.addEventListener(this.clickCB, this._playNode_daixi2);

        var that = this;
        this._playNode_daixi.schedule(function() {
            that._playNode_daixi1.visible = that._playNode_daixi.isSelected();
            that._playNode_daixi2.visible = that._playNode_daixi.isSelected();
        });
    ...
    {
        this._super();
        var _fengxiangNum = util.localStorageEncrypt.getNumberItem(this.localStorageKey.KEY_rudong_fengdingNum,0);
        ...
        // var _mengziguan = util.localStorageEncrypt.getBoolItem(this.localStorageKey.KEY_rudong_mengzigun, false);
        ...
        var _huanglonghui = util.localStorageEncrypt.getBoolItem(this.localStorageKey.KEY_rudong_shuanglonghui,true);
        ...
        var _sanlaohuimian = util.localStorageEncrypt.getBoolItem(this.localStorageKey.KEY_rudong_sanlaohuimian, true);
        ...
        var _daixi= util.localStorageEncrypt.getBoolItem(this.localStorageKey.KEY_rudong_daixi, true);
        this._playNode_daixi.setSelected(_daixi);
        var text = this._playNode_daixi.getChildByName("text");
        this.selectedCB(text,_daixi)

        var _daixi1= util.localStorageEncrypt.getBoolItem(this.localStorageKey.KEY_rudong_daixi1,false);
        this._playNode_daixi1.setSelected(_daixi1);
        var text = this._playNode_daixi1.getChildByName("text");
        this.selectedCB(text,_daixi1)

        var _daixi2= util.localStorageEncrypt.getBoolItem(this.localStorageKey.KEY_rudong_daixi2, false);
        this._playNode_daixi2.setSelected(_daixi2);
        var text = this._playNode_daixi2.getChildByName("text");
        this.selectedCB(text,_daixi2)



        var _haidilaoyue = util.localStorageEncrypt.getBoolItem(this.localStorageKey.KEY_rudong_haidilaoyue, false);
        ...
        var _maiNum = util.localStorageEncrypt.getNumberItem(this.localStorageKey.KEY_rudong_maizhuang,0);
        ...
        var _jizi = util.localStorageEncrypt.getBoolItem(this.localStorageKey.KEY_rudong_jizi, true);
        this._playNode_jizi.setSelected(_jizi);
        var text = this._playNode_jizi.getChildByName("text");
        this.selectedCB(text,_jizi);

        var _tiehu = util.localStorageEncrypt.getBoolItem(this.localStorageKey.KEY_rudong_tiehu, false);
        this._playNode_tiehu.setSelected(_tiehu);
        var text = this._playNode_tiehu.getChildByName("text");
        this.selectedCB(text, _tiehu);
        this.is_Tiehu();

        var _qitie = util.localStorageEncrypt.getNumberItem(this.localStorageKey.KEY_rudong_qitie, 100);
        var list = [];
        ...
        var _tiehuCount = util.localStorageEncrypt.getNumberItem(this.localStorageKey.KEY_rudong_tiehuCount, 20);
        var list = [];
    ...
    getSelectedPara:function()
    {
        ...
        para.gameType = MjClient.GAME_TYPE.RU_DONG_SHUANG_JIANG;
        para.maxPlayer = 3;
        // para.menzigun = false;
        ...
        para.qinghudaixifan = false;
        para.piaohudaixibufan = false;
        //封顶
        para.fengding = this._playNode_fengding_0.isSelected()==true?0:(this._playNode_fengding_1.isSelected()==true?600:800);
        util.localStorageEncrypt.setNumberItem(this.localStorageKey.KEY_rudong_fengdingNum,para.fengding);
        // //闷子棍
        // para.menzigun = this._playNode_mengzigun.isSelected() == true ? true:false;
        // util.localStorageEncrypt.setBoolItem(this.localStorageKey.KEY_rudong_mengzigun,para.menzigun);
        //双龙会
        para.shuanglonghui = this._playNode_huanglonghui.isSelected() == true?true:false;
        util.localStorageEncrypt.setBoolItem(this.localStorageKey.KEY_rudong_shuanglonghui,para.shuanglonghui);
        //会面出汗
        para.sanlaohuimian = this._playNode_sanlaohuimian.isSelected();
        util.localStorageEncrypt.setBoolItem(this.localStorageKey.KEY_rudong_sanlaohuimian,para.sanlaohuimian);


        para.daixi = this._playNode_daixi.isSelected();
        util.localStorageEncrypt.setBoolItem(this.localStorageKey.KEY_rudong_daixi,para.daixi);

        para.qinghudaixifan = this._playNode_daixi1.isSelected();
        util.localStorageEncrypt.setBoolItem(this.localStorageKey.KEY_rudong_daixi1,para.qinghudaixifan);

        para.piaohudaixibufan = this._playNode_daixi2.isSelected();
        util.localStorageEncrypt.setBoolItem(this.localStorageKey.KEY_rudong_daixi2,para.piaohudaixibufan);
        // para.shengyihu = this._playNode_shengyihu.isSelected();
        // util.localStorageEncrypt.setBoolItem(this.localStorageKey.KEY_rudong_shengyihu,para.shengyihu);

        //海底捞月
        para.haidilaoyue = this._playNode_laodilaoyue.isSelected() == true?true:false;
        util.localStorageEncrypt.setBoolItem(this.localStorageKey.KEY_rudong_haidilaoyue,para.haidilaoyue);
        ...
        util.localStorageEncrypt.setNumberItem(this.localStorageKey.KEY_rudong_maizhuang,para.maizhuang);

        para.jizi = this._playNode_jizi.isSelected();
        util.localStorageEncrypt.setBoolItem(this.localStorageKey.KEY_rudong_jizi,para.jizi);

        para.tiehu = this._playNode_tiehu.isSelected();
        util.localStorageEncrypt.setBoolItem(this.localStorageKey.KEY_rudong_tiehu, para.tiehu);

        if(para.tiehu)
        {
            para.qitie = this._playNode_buxianzhi.isSelected() == true ? 0 : 100;
            util.localStorageEncrypt.setNumberItem(this.localStorageKey.KEY_rudong_qitie, para.qitie);

            para.tiehuCount = this._playNode_tie20hu.isSelected() == true ? 20 : 50;
            util.localStorageEncrypt.setNumberItem(this.localStorageKey.KEY_rudong_tiehuCount, para.tiehuCount);
        }
