...
//向服务器发送 过消息
MjClient.MJPass2NetForrudong = function()
{
   // console.log(">>>>>>>>>普通  过 <<<<<<<<");
    cc.log("====================send======pass=====");
...
function SetUserVisible_rudong(node, off)
{
    //var sData = MjClient.data.sData;
    //return;
    ...
    if(pl)
    {
        ...
        InitUserHandUI_rudong(node, off);
...
function InitUserHandUI_rudong(node, off)
{
    var sData = MjClient.data.sData;
    var tData = sData.tData;
    var pl = getUIPlayer_changpai(off);
...
var PlayLayer_rudong = cc.Layer.extend({
    jsBind: {
        _event: {
            mjhand: function() {
            ...
            roundEnd: function() {
                ...
                function delayExe()
                {
                    ...
                    self.addChild(new EndOneView_rudong(),500);
                }
        ...
        down: {
            ...
            _event: {
                ...
                RGLong: function (eD) { //不罗龙
                    ...
                    PlayLayer_rudong.prototype.CardLayoutRestore(_downNode,0);
                },
            ...
            changeui: {
                ...
                changeuibg: {
                    ...
                    guobg: {
                        guo: {
                            _touch: function(btn, eT) {
                                if (eT == 2) MjClient.MJPass2NetForrudong();
                            }
                        },
                        fanhui: {
                            _touch: function(btn, et) {
    ...
    ctor: function() {
        this._super();
        var playui = ccs.load(res.Play_rudong_json);
        playMusic("bgFight");
...
PlayLayer_rudong.prototype.CardLayoutRestore = function(node, off)
{
...
// 判断吃碰杠胡的状态
PlayLayer_rudong.prototype.EatVisibleCheck = function()
{
    var eat = MjClient.playui.jsBind.eat;
...
/*
    显示洛龙，不洛龙的按钮
 */
PlayLayer_rudong.prototype.longTouch = function(cd)
{
    var eat = MjClient.playui.jsBind.eat;
    //sk 为啥要隐藏掉？   //因为一开始是不可见的，隐藏根节点 by sking
    MjClient.playui.jsBind.eat.changeui.changeuibg._node.visible = false;
...
/*
    获取当前牌张数
 */
PlayLayer_rudong.prototype.setLeftCardCount = function(off)
{
    var pl = getUIPlayer_changpai(off);
    var sData = MjClient.data.sData;
    var tData = sData.tData;
