function addWxHeadToEndUI_yueYangPengHu_GO(node, off) {
...
function SetGameOverLayer_yueYangPengHu(node,off,isNewUi){
    ...
    addWxHeadToEndUI_yueYangPengHu_GO(wxNode,off);
    ...
    if(MjClient.getAppType() == MjClient.APP_TYPE.QXSYDTZ){
        textFileName = scoreContnet >= 0 ? "gameOver/pjjs_24_new.png" : "gameOver/pjjs_29_new.png";
...
var GameOverLayer_yueYangPengHu = cc.Layer.extend({
    sprite:null,
    jsBind:{
        back:{
            close :{
    ...
    ctor:function () {
        this._super();
        var endallui = ccs.load("endAll_yueYangPengHu.json");
        ...
        for(var i = 0 ; i < playerCount ; i++){
            ...
            SetGameOverLayer_yueYangPengHu(clone,i, false);
