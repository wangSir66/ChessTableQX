var yueYangPengHu = yueYangPengHu || {};

yueYangPengHu.Gold = cc.Node.extend({
    ...
    _initUi : function(){
        var icon = new cc.Sprite("penghu/jinBi.png");
        this.icon = icon;
        this.addChild(icon);
    ...
    doMoveAction : function(targetPos){
        var ac = cc.moveTo(0.5,targetPos);
