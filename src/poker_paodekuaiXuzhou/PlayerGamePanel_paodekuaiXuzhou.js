...
function SetUserVisible_paodekuaiXuzhou(node, off)
{
    ...
    if(pl)
    {
        ...
        InitUserHandUI_paodekuaiXuzhou(node, off);
    }
    else
    {
        name.visible = false;
...
function InitUserHandUI_paodekuaiXuzhou(node, off, needSort)
{
...
function cardsSort_paodekuaiXuzhou(cards)
{
    var pointCounts = {};
...
var PlayLayer_paodekuaiXuzhou = cc.Layer.extend({
    _btnPutCard:null,
    jsBind: {
        _run: function() {
        ...
        banner: {
            ...
            setting: {
                ...
                _run:function() {
                    //setWgtLayout(this,[0.12, 0.12],[0.93,0.05],[0,0]);
                }
            },
            gps_btn: {
                _run: function() {
            ...
            changeBg: {
                ...
                _run:function() {
                    //setWgtLayout(this,[0.12, 0.12],[0.84,0.05],[0,0]);
                }
            },
            Button_1: {
                _visible : true,
        ...
        //     wxinvite: {
        //         _run:function() {
        //             setWgtLayout(this, [0.18, 0.18], [0.3, 0.5], [0.6, -0.35]);
        //         },
        //         _click: function() {
        ...
        //                 this.getChildByName('backHomebtn').visible = IsInviteVisible();
        //             }
        //         },
        ...
        BtnPutCard:{
            ...
            _click: function(btn) {
                //cc.log("BtnPutCard");
				cardsSort_paodekuaiXuzhou(MjClient.selectCards_card);
        ...
        down: {
            ...
            _event: {
                ...
                initSceneData: function(eD) {
                    SetUserVisible_paodekuaiXuzhou(this, 0);
                ...
                mjhand: function(eD) {
                    ...
                    InitUserHandUI_paodekuaiXuzhou(this, 0);
        ...
        right: {
            ...
            _event: {
                ...
                initSceneData: function(eD) {
                    SetUserVisible_paodekuaiXuzhou(this, 1);
                },
                addPlayer: function(eD) {
                    SetUserVisible_paodekuaiXuzhou(this, 1);
                },
                ...
                mjhand: function(eD) {
                    InitUserHandUI_paodekuaiXuzhou(this, 1);
                },
                roundEnd: function() {
        ...
        top: {
            ...
            _event: {
                ...
                initSceneData: function(eD) {
                    SetUserVisible_paodekuaiXuzhou(this, 2);
                },
                addPlayer: function(eD) {
                    SetUserVisible_paodekuaiXuzhou(this, 2);
                },
                ...
                mjhand: function(eD) {
                    InitUserHandUI_paodekuaiXuzhou(this, 2);
                },
                roundEnd: function() {
    ...
    ctor: function() {
        this._super();
        var playui = ccs.load(res.Play_PaoDeKuaiXuzhou_json);
...
PlayLayer_paodekuaiXuzhou.prototype.InitC_Data = function() {
...
PlayLayer_paodekuaiXuzhou.prototype.cannotOutCardGrey = function()
{
...
PlayLayer_paodekuaiXuzhou.prototype.recoverCannotOutCard = function()
{
    var children = this._downNode.children;
    for (var i = 0; i < children.length; i++)
    {
...
PlayLayer_paodekuaiXuzhou.prototype.clockNumberUpdate = function(node, endFunc)
{
    return arrowbkNumberUpdate(node, endFunc);
}

PlayLayer_paodekuaiXuzhou.prototype.updateClockPosition = function(arrowNode)
{
    var tData = MjClient.data.sData.tData;
    var uids = tData.uids;
...
PlayLayer_paodekuaiXuzhou.prototype.shwoFlyCardAnim = function(flyNode)
{
    var tData = MjClient.data.sData.tData;
    ...
    flyNode.runAction(cc.sequence(cc.delayTime(0.5), cc.spawn(cc.moveTo(1.0, point), cc.scaleTo(1.0, flyNode.getScale()/1.5)), cc.callFunc(function() {
...
PlayLayer_paodekuaiXuzhou.prototype.showHandCardBeiMian = function()
{
...
PlayLayer_paodekuaiXuzhou.prototype.hideHandCardBeiMian = function()
{
...
PlayLayer_paodekuaiXuzhou.prototype.CardLayoutRestore = function(node, off, needSort)
{
    // 如果正在发牌 不排序
...
PlayLayer_paodekuaiXuzhou.prototype.CardLayoutDesk = function(node,cards,off)
{
    //if(off != 0) return;
...
//横向摆放《正常》
PlayLayer_paodekuaiXuzhou.prototype.horSort = function(node, off,needSort)
{
    var pl; //player 信息
...
//纵向摆放
PlayLayer_paodekuaiXuzhou.prototype.verSort = function(node, off, needSort)
{
    if(off != 0)
    {
        return;
