...
//向服务器发送 过消息
MjClient.MJPass2NetForxiangtanPHZ = function(){
    cc.log("====================send======pass=====");
...
function SetUserVisible_xiangtanPHZ(node, off){
    ...
    var score = head.getChildByName("score");
    if(pl){
        name.visible = true;
        coin.visible = true;
        ...
        setUserOffline_xiangxiang(node, off);
        // InitUserHandUI_xiangtanPHZ(node, off);
...
function InitUserHandUI_xiangtanPHZ(node, off){
...
var PlayLayer_xiangtanPHZ = cc.Layer.extend({
    jsBind: {
        _event: {
            mjhand: function() {
            ...
            endRoom: function(msg) {
                ...
                if (msg.showEnd){
                    if(MjClient.getAppType() == MjClient.APP_TYPE.HUNANWANGWANG || MjClient.getAppType() == MjClient.APP_TYPE.QXSYDTZ){
                        ...
                        this.addChild(new GameOverLayer_xiangtanPHZ(),500);
                    }
                }else{
            ...
            roundEnd: function() {
                ...
                function delayExe(){
                    ...
                    if (sData.tData.roundNum <= 0){
                        var layer = null;
                        if(MjClient.getAppType() == MjClient.APP_TYPE.HUNANWANGWANG || MjClient.getAppType() == MjClient.APP_TYPE.QXSYDTZ){
                            layer = new GameOverLayer_syLoudi();
                        }else{
                            layer = new GameOverLayer_xiangtanPHZ();
                        }
                    ...
                    if(!MjClient.endoneui){
                        self.addChild(new EndOneView_xiangtanPHZ(),500);
                    }
                }
            ...
            EZP_layout : function(){
                ...
                MjClient.playui.ResetPutCard(MjClient.playui._topNode, MjClient.MaxPlayerNum_xiangxiang - 1);
                    ...
                    HZNewCard:function(){
                        ...
                        if(next <= 0){
                           ...
                           // }
                            ...
                            if(childNum > 0 && childNum +1 > next && next < 20){ //少于20张时开始减厚度
        ...
        roundInfo:{
            _layout: [[0.11, 0.11],[0.5, 0.62],[0, -3.4]],
            _run:function(){
                var tData = MjClient.data.sData.tData;
                var str = "";
                str += (tData.areaSelectMode.minHuType == 0) ? "15胡起胡" : "10胡起胡" ;
                str += (tData.areaSelectMode.countTunWay == 2) ? "/三息一囤" : "/一息一囤";
                if (MjClient.getAppType() == MjClient.APP_TYPE.HUNANWANGWANG || MjClient.getAppType() == MjClient.APP_TYPE.QXSYDTZ) {
                    str += (tData.areaSelectMode.countTunWay == 2 && tData.areaSelectMode.diFen) ? "/底分" +  tData.areaSelectMode.diFen + "分" : "";
                }
                str += (tData.areaSelectMode.mingwei == true) ? "/明偎" : "/暗偎" ;
                str += (tData.areaSelectMode["isShowChouWei"] == true) ? "/臭偎明示" : "" ;
                str += (tData.areaSelectMode["zimoaddhuxi"] == true) ? "/自摸加3胡": "" ;
                str += (tData.areaSelectMode["isYiwushi"]   == true) ? "/一五十"   : "" ;
                str += (tData.areaSelectMode["sanshirate"]  == true) ? "/30胡翻倍" : "" ;
                str += (tData.areaSelectMode["nohuaddhuxi"] == true) ? "/荒庄5胡息": "" ;
                str += (tData.areaSelectMode["yidianhong"]  == true) ? "/一点红" : "" ;
                str += (tData.areaSelectMode["tiandihu"]    == true) ? "/天地胡" : "" ;
                str += (tData.areaSelectMode["daxiaozi"]    == true) ? "/大小字" : "" ;
                str += (tData.areaSelectMode["pengpenghu"]  == true) ? "/碰碰胡" : "" ;
                str += (tData.areaSelectMode["hongheihu"]   == true) ? (tData.areaSelectMode["honghutype"] == true) ? "/红黑胡10红" : "/红黑胡13红" : "" ;
                str +=  tData.areaSelectMode.isShowMTDieJia ? "/名堂叠加" : "";
                str +=  tData.areaSelectMode.isPutLimit ? "/吃边打边" : "";
        ...
        operateWait:{
            _visible:false,
            _layout: [[0.37, 0.09],[0.5, 0.5],[0, 2.6]],
        ...
        banner: {
            ...
            getRoomNum: {
                ...
                //     str += (tData.areaSelectMode["limitWinHuxi"] == 1) ? "10胡起胡," : "15胡起胡," ;
                //     str += (tData.areaSelectMode["jifenType"] == 1) ? "囤数计分" : "胡息计分" ;
                //     str += (tData.areaSelectMode["littleRed"] == true) ? ",一点红" : "" ;
                //     str += (tData.areaSelectMode["tianDiHu"] == true) ? ",天地胡" : "" ;
                //     str += (tData.areaSelectMode["RedBlackHu"] == true) ? ",红黑胡" : "" ;
                //     var sData = MjClient.data.sData;
                //     var str7 = "  二缺一";
            ...
            gps_btn: {
                ...
                _run: function(){
                    var tData = MjClient.data.sData.tData;
                    this.visible = tData.maxPlayer != 2;
                },
                _click: function() {
        ...
        wait: {
            ...
            //         var sData = MjClient.data.sData;
            //         var str7 = "  二缺一";
            //         if((MjClient.MaxPlayerNum_xiangxianggao - Object.keys(sData.players).length) == 2){
            //             str7 = "  一缺二";
            //         }
            //         // var _nameStr = unescape(pl.info.nickname );
            //         str7 += "(";
            ...
            backHomebtn: {
                ...
                _event: {
                    ...
                    addPlayer: function(eD) {
                        this.visible = IsInviteVisible() || !MjClient.data.sData.tData.areaSelectMode.fullperson;
                    },
                    mjhand: function(){
                        this.visible = false;
                    },
        ...
        down: {
            head: {
                zhuang: {
                    ...
                    _event: {
                        waitPut: function(){
                            showUserZhuangLogo_xiangxiang(this, 0);
                        },
                        initSceneData: function(){
                            if (IsArrowVisible_xiangxiang()) showUserZhuangLogo_xiangxiang(this, 0);
                        },
                        mjhand: function(){
                            if (IsArrowVisible_xiangxiang()) showUserZhuangLogo_xiangxiang(this, 0);
                        }
                ...
                _event: {
                    ...
                    addPlayer: function(eD) {
                        showFangzhuTagIcon_xiangxiang(this,0);
                    },
                    removePlayer: function(eD) {
                        showFangzhuTagIcon_xiangxiang(this,0);
                    }
            ...
            ready: {
                _layout: [[0.07, 0.07],[0.1, 0.17],[0, 0]],
                _run: function() {
                    //ipad适配
                    if(isIpadSize()){
                        setWgtLayout(this, [0.07, 0.07],[0.13, 0.17],[0, 0]);
                    }
                ...
                _event: {
                    ...
                    onlinePlayer: function() {
                        var tData = MjClient.data.sData.tData;
                        var pl = getUIPlayer_xiangxiang(0);
                        if(tData.areaSelectMode.tuototuo > 0 && pl && pl.jiazhuNum >= 0){
                            GetReadyVisible_xiangxiang(this, -1);
                        }else{
                            GetReadyVisible_xiangxiang(this, 0);
                        }
            ...
            outNode: {
                _visible: true,
                _layout : [[0.14, 0.14], [0.95, 0.35], [0, 0]]
            },
            handCard: {
                _run:function () {
                    this.ignoreContentAdaptWithSize(true);
                ...
                _event:{
                    ...
                    EZP_huXi: function(type){
                        ...
                        if(MjClient.getAppType() === MjClient.APP_TYPE.QXXXGHZ){
                            showStatus = showStatus == 0 ?  true : false;
                        }else{
            ...
            put: {
                ...
                _run:function()
                {
                    var layoutType = 0;//util.localStorageEncrypt.getNumberItem(MjClient.KEY_ZI_PAI_PLAY_UI_LAYOUT,0);
                    if(layoutType == 0){
            ...
            _event: {
                ...
                initSceneData: function(eD) {
                    SetUserVisible_xiangtanPHZ(this, 0);
                    InitUserHandUI_xiangtanPHZ(this, 0);
                ...
                MJPut: function(eD) {
                    ...
                    MjClient.playui.UpdateEatCardsAfterFirst(this, 0);
                },
                HZChiCard: function(eD) {
                    DealChiCard_xiangxiang(this, eD, 0);
                },
                HZWeiCard: function(eD){
                    DealWeiCard_xiangxiang(this,eD,0);
                },
                HZGangCard: function(eD) {
                    DealGangCard_xiangxiang(this, eD, 0);
                },
                MJPeng: function(eD) {
                    DealPengCard_xiangxiang(this, eD, 0);
                },
                MJHu: function(eD) {
                ...
                onlinePlayer: function(eD) {
                    ...
                    setUserOffline_xiangxiang(this, 0);
                },
                ...
                HZPickCard:function (eD) {
                    ...
                    if(eD.uid == pl.info.uid) {
                        if(MjClient.rePlayVideo != -1){
                            var changeArr = [];
                            var originArr = MjClient.HandCardArr;
                            for(var i = 0; i < originArr.length; i++){
                                for(var j = 0; j < originArr[i].length; j++){
                                    changeArr.push(originArr[i][j]);
                                }
                            }
                            changeArr.push(eD.card);
                            MjClient.HandCardArr = changeArr;
                            MjClient.HandCardArr = MjClient.majiang.sortHandCardSpecial(MjClient.HandCardArr);
                        }else{
                            MjClient.HandCardArr = MjClient.majiang.sortHandCardSpecial(pl.mjhand);
                        }
                ...
                HZAddCards:function (eD) {
                    DealAddCard_xiangxiang(this,eD, 0);
                },
        ...
        right: {
            _visible:function(){
                return MjClient.MaxPlayerNum_xiangxiang != 2;
            },
            head: {
                zhuang: {
                    _run: function() {
                    ...
                    _event: {
                        waitPut: function() {
                            if(MjClient.MaxPlayerNum_xiangxiang != 2){
                                showUserZhuangLogo_xiangxiang(this, 1);
                            }
                        },
                        initSceneData: function() {
                            if (IsArrowVisible_xiangxiang() && MjClient.MaxPlayerNum_xiangxiang != 2) showUserZhuangLogo_xiangxiang(this, 1);
                        },
                        mjhand: function(){
                            if (IsArrowVisible_xiangxiang() && MjClient.MaxPlayerNum_xiangxiang != 2) showUserZhuangLogo_xiangxiang(this, 1);
                        }
                ...
                chatbg: {
                    ...
                    chattext: {
                        _event: {
                            MJChat: function(msg) {
                                if(MjClient.MaxPlayerNum_xiangxiang != 2){
                                    showUserChat_xiangxiang(this, 1, msg);
                                }
                            },
                            playVoice: function(voicePath) {
                                if(MjClient.MaxPlayerNum_xiangxiang != 2){
                                    MjClient.data._tempMessage.msg = voicePath;
                                    showUserChat_xiangxiang(this, 1, MjClient.data._tempMessage);
                                }
                            }
                        }
                    }
                ...
                _click: function(btn) {
                    if(MjClient.MaxPlayerNum_xiangxiang != 2){
                        showPlayerInfo_xiangxiang(1, btn);
                    }
                },
                _event: {
                    loadWxHead: function(d) {
                        if(MjClient.MaxPlayerNum_xiangxiang != 2){
                            setWxHead_xiangxiang(this, d, 1);
                        }
                    },
                    addPlayer: function(eD) {
                        if(MjClient.MaxPlayerNum_xiangxiang != 2){
                            showFangzhuTagIcon_xiangxiang(this,1);
                        }
                    },
                    removePlayer: function(eD) {
                        if(MjClient.MaxPlayerNum_xiangxiang != 2){
            ...
            ready: {
                _layout: [[0.07, 0.07],[0.9, 0.85],[0, 0]],
                _run: function() {
                    if(MjClient.MaxPlayerNum_xiangxiang == 2){
                        return;
                    }
                    //ipad适配
                    if(isIpadSize()){
                        setWgtLayout(this, [0.07, 0.07],[0.87, 0.85],[0, 0]);
                    }
                    GetReadyVisible_xiangxiang(this, 1);
                },
                _event: {
            ...
            outNode: {
                _visible: true,
                _layout : [[0.14, 0.14], [0.95, 0.82], [0, 0]]
            },
            put: {
                _visible: false,
            ...
            _event: {
                ...
                initSceneData: function(eD) {
                    ...
                    SetUserVisible_xiangtanPHZ(this, 1);
                    InitUserHandUI_xiangtanPHZ(this, 1);
                ...
                MJPut: function(eD) {
                    ...
                    MjClient.playui.UpdateEatCardsAfterFirst(this, 1);
                },
                HZChiCard: function(eD) {
                    if(MjClient.MaxPlayerNum_xiangxiang == 2){
                        return;
                    }
                    DealChiCard_xiangxiang(this, eD, 1);
                },
                HZGangCard: function(eD) {
                    if(MjClient.MaxPlayerNum_xiangxiang == 2){
                        return;
                    }
                    DealGangCard_xiangxiang(this, eD, 1);
                },
                MJPeng: function(eD) {
                    if(MjClient.MaxPlayerNum_xiangxiang == 2){
                        return;
                    }
                    DealPengCard_xiangxiang(this, eD, 1);
                },
                HZWeiCard: function(eD){
                    DealWeiCard_xiangxiang(this, eD, 1);
                },
                MJHu: function(eD) {
                    if(MjClient.MaxPlayerNum_xiangxiang == 2){
                        return;
                ...
                HZPickCard:function (eD) {
                    ...
                    if(MjClient.rePlayVideo != -1){
                        ...
                        if(eD.uid == pl.info.uid) {
                            var changeArr = [];
                            var originArr = MjClient.OtherHandArr[1];
                            for(var i = 0; i <originArr.length; i++){
                                for(var j = 0; j < originArr[i].length; j++){
                                    changeArr.push(originArr[i][j]);
                                }
                            ...
                            changeArr.push(eD.card);
                            MjClient.OtherHandArr[1] = changeArr;
                            MjClient.OtherHandArr[1] = MjClient.majiang.sortHandCardSpecial(MjClient.OtherHandArr[1]);
                        }
                    }
                    RemovePutCardOut_xiangxiang(true);
                    var putNode = this.getChildByName("put");
                ...
                HZAddCards:function (eD) {
                    ...
                    DealAddCard_xiangxiang(this,eD, 1);
                },
                HZCheckRaise:function (msg) {
                    if(MjClient.MaxPlayerNum_xiangxiang == 2){
                        return;
        ...
        left: {
            head: {
                zhuang: {
                    ...
                    _event: {
                        waitPut: function() {
                            showUserZhuangLogo_xiangxiang(this, MjClient.MaxPlayerNum_xiangxiang - 1);
                        },
                        initSceneData: function() {
                            if (IsArrowVisible_xiangxiang()) showUserZhuangLogo_xiangxiang(this, MjClient.MaxPlayerNum_xiangxiang - 1);
                        },
                        mjhand: function(){
                            if (IsArrowVisible_xiangxiang()) showUserZhuangLogo_xiangxiang(this, MjClient.MaxPlayerNum_xiangxiang - 1);
                        }
                ...
                chatbg: {
                    ...
                    chattext: {
                        _event: {
                            MJChat: function(msg) {
                                showUserChat_xiangxiang(this, MjClient.MaxPlayerNum_xiangxiang - 1, msg);
                            },
                            playVoice: function(voicePath) {
                                MjClient.data._tempMessage.msg = voicePath;
                                showUserChat_xiangxiang(this, MjClient.MaxPlayerNum_xiangxiang - 1, MjClient.data._tempMessage);
                            }
                        }
                    }
                },
                _click: function(btn) {
                    showPlayerInfo_xiangxiang(MjClient.MaxPlayerNum_xiangxiang - 1, btn);
                },
                _event: {
                    loadWxHead: function(d) {
                            setWxHead_xiangxiang(this, d, MjClient.MaxPlayerNum_xiangxiang - 1);
                    },
                    addPlayer: function(eD) {
                            showFangzhuTagIcon_xiangxiang(this,MjClient.MaxPlayerNum_xiangxiang - 1);
                    },
                    removePlayer: function(eD) {
                            showFangzhuTagIcon_xiangxiang(this,MjClient.MaxPlayerNum_xiangxiang - 1);
                    }
                ...
                huxi:{
                    ...
                    _event:{
                        ...
                        initSceneData:function(){
                            ...
                            var huXi = 0;
                            if(IsArrowVisible_xiangxiang()){
                                huXi = UpdateHuXi_xiangxiang(MjClient.MaxPlayerNum_xiangxiang - 1);
                            }
                            return this.setString(huXi + "胡息");
                        },
                        mjhand:function(){
                            this.visible = true;
                            var huXi = UpdateHuXi_xiangxiang(MjClient.MaxPlayerNum_xiangxiang - 1);
                            if(!IsArrowVisible_xiangxiang()){
                                huXi = 0;
                            }
                            return this.setString(huXi + "胡息");
                ...
                score:{
                    ...
                    _event:{
                        ...
                        initSceneData:function(){
                            this.visible = IsArrowVisible_xiangxiang();
                            var huXi = GetPlayerAllHuXi_xiangxiang(MjClient.MaxPlayerNum_xiangxiang - 1);
                            if(!IsArrowVisible_xiangxiang()){
                                huXi = 0;
                            }
                            return this.setString(huXi);
                ...
                timeImg:{
                    ...
                    _event:{
                        // initSceneData: function(eD) {
                        //     this.visible = curPlayerIsMe_xiangxiang(MjClient.MaxPlayerNum_xiangxiang - 1);
                        // },
                        // mjhand: function(eD) {
                        //     this.visible = curPlayerIsMe_xiangxiang(MjClient.MaxPlayerNum_xiangxiang - 1);
                        // },
                        // onlinePlayer: function(eD) {
                        //     this.visible = curPlayerIsMe_xiangxiang(MjClient.MaxPlayerNum_xiangxiang - 1) && IsArrowVisible_xiangxiang();
                        //     if(MjClient.endoneui)
                        //         this.visible = false;
                        // },
                        // waitPut: function(eD) {
                    ...
                    time:{
                        ...
                        _event: {
                            initSceneData: function(eD) {
                                ...
                                stopEffect(playTimeUpEff);
                                playTimeUpEff = null;
                                if(curPlayerIsMe_xiangxiang(MjClient.MaxPlayerNum_xiangxiang - 1)){
                                    arrowbkNumberUpdate_xxghz(this);
                                    this.setString("0");
                                }
                            },
                            ...
                            onlinePlayer: function(){
                                ...
                                stopEffect(playTimeUpEff);
                                playTimeUpEff = null;
                                var pl = getUIPlayer_xiangxiang(MjClient.MaxPlayerNum_xiangxiang - 1);
                                if(pl && pl.onLine && curPlayerIsMe_xiangxiang(MjClient.MaxPlayerNum_xiangxiang - 1)){
                                    arrowbkNumberUpdate_xxghz(this);
                                }
                            },
                            roundEnd: function() {
            ...
            ready: {
                _layout: [[0.07, 0.07],[0.1, 0.85],[0, 0]],
                _run: function() {
                    //ipad适配
                    if(isIpadSize()){
                        setWgtLayout(this, [0.07, 0.07],[0.13, 0.85],[0, 0]);
                    }
                    GetReadyVisible_xiangxiang(this, MjClient.MaxPlayerNum_xiangxiang - 1);
                },
                _event: {
                    moveHead: function() {
                        GetReadyVisible_xiangxiang(this, -1);
            ...
            outNode: {
                _visible: false,
                _layout : [[0.14, 0.14], [0.02, 0.82], [0, 0]]
            },
            put: {
                _visible: false,
            ...
            _event: {
                clearCardUI: function() {
                    clearCardUI_xiangxiang(this, MjClient.MaxPlayerNum_xiangxiang - 1);
                },
                clearCardArr: function(){
                    var eatNode = this.getChildByName("eatNode");
                    eatNode.removeAllChildren();
                ...
                initSceneData: function(eD) {
                    SetUserVisible_xiangtanPHZ(this, MjClient.MaxPlayerNum_xiangxiang - 1);
                    InitUserHandUI_xiangtanPHZ(this, MjClient.MaxPlayerNum_xiangxiang - 1);
                    InitUserCoinAndName_xiangxiang(this, MjClient.MaxPlayerNum_xiangxiang - 1);
                    DealOffLineCard_xiangxiang(this,MjClient.MaxPlayerNum_xiangxiang - 1);
                },
                addPlayer: function(eD) {
                    SetUserVisible_xiangtanPHZ(this, MjClient.MaxPlayerNum_xiangxiang - 1);
                    InitUserCoinAndName_xiangxiang(this, MjClient.MaxPlayerNum_xiangxiang - 1);
                ...
                HZNewCard: function(eD) {
                    ...
                    DealNewCard_xiangxiang(this,eD,MjClient.MaxPlayerNum_xiangxiang - 1);
                },
                roundEnd: function() {
                    InitUserCoinAndName_xiangxiang(this, MjClient.MaxPlayerNum_xiangxiang - 1);
                    MjClient.playui.ResetOtherCard(this, MjClient.MaxPlayerNum_xiangxiang - 1);
                },
                waitPut: function(eD) {
                    DealWaitPut(this, eD, MjClient.MaxPlayerNum_xiangxiang - 1);
                },
                MJPut: function(eD) {
                    DealPutCard_xiangxiang(this, eD, MjClient.MaxPlayerNum_xiangxiang - 1);
                    MjClient.playui.UpdateEatCardsAfterFirst(this, MjClient.MaxPlayerNum_xiangxiang - 1);
                },
                HZChiCard: function(eD) {
                    DealChiCard_xiangxiang(this, eD, MjClient.MaxPlayerNum_xiangxiang - 1);
                },
                HZPaoCard: function(eD) {
                    DealPaoCard_leiyang(this, eD, MjClient.MaxPlayerNum_xiangxiang - 1);
                },
                HZGangCard: function(eD) {
                    DealGangCard_xiangxiang(this, eD, MjClient.MaxPlayerNum_xiangxiang - 1);
                },
                MJPeng: function(eD) {
                    DealPengCard_xiangxiang(this, eD, MjClient.MaxPlayerNum_xiangxiang - 1);
                },
                HZWeiCard: function(eD){
                    DealWeiCard_xiangxiang(this, eD, MjClient.MaxPlayerNum_xiangxiang - 1);
                },
                MJHu: function(eD) {
                    DealHu_xiangxiang(this, eD, MjClient.MaxPlayerNum_xiangxiang - 1);
                },
                onlinePlayer: function(eD) {
                    setUserOffline_xiangxiang(this, MjClient.MaxPlayerNum_xiangxiang - 1);
                },
                playerStatusChange: function(eD) {
                    setUserOffline_xiangxiang(this, MjClient.MaxPlayerNum_xiangxiang - 1);
                },
                MJFlower: function(eD) {
                    HandleMJFlower(this, eD, MjClient.MaxPlayerNum_xiangxiang - 1);
                },
                MJTing: function (eD) {
                    HandleMJTing(this, eD, MjClient.MaxPlayerNum_xiangxiang - 1);
                },
                HZPickCard:function (eD) {
                    if(MjClient.rePlayVideo != -1) {
                        var pl = getUIPlayer_xiangxiang(MjClient.MaxPlayerNum_xiangxiang - 1);
                        if(eD.uid == pl.info.uid){
                            var changeArr = [];
                            var originArr = MjClient.OtherHandArr[MjClient.MaxPlayerNum_xiangxiang - 1];
                            for(var i = 0; i <originArr.length; i++){
                                for(var j = 0; j < originArr[i].length; j++){
                                    changeArr.push(originArr[i][j]);
                                }
                            ...
                            changeArr.push(eD.card);
                            MjClient.OtherHandArr[MjClient.MaxPlayerNum_xiangxiang - 1] = changeArr;
                            MjClient.OtherHandArr[MjClient.MaxPlayerNum_xiangxiang - 1] = MjClient.majiang.sortHandCardSpecial(MjClient.OtherHandArr[MjClient.MaxPlayerNum_xiangxiang - 1]);
                        }
                    }
                    RemovePutCardOut_xiangxiang(true);
                    var putNode = this.getChildByName("put");
                    putNode.setPosition(putNode.getUserData().pos);
                    putNode.opacity = 255;
                    MjClient.playui.ResetHandCard(this,MjClient.MaxPlayerNum_xiangxiang - 1);
                },
                HZAddCards:function (eD) {
                    DealAddCard_xiangxiang(this,eD, MjClient.MaxPlayerNum_xiangxiang - 1);
                },
                HZCheckRaise:function (msg) {
                    ShowPutCardIcon_xiangxiang();
                    MjClient.playui.EatVisibleCheck();
                    ...
                    //     return;
                    // }
                    // if (pl.jiazhuNum == MjClient.MaxPlayerNum_xiangxiang - 1 && MjClient.rePlayVideo == -1)
                    // {
                    //     if (SelfUid() == pl.info.uid) {
                    //         var layer = new laZhangLayer();
                    //         MjClient.playui.addChild(layer, 99);
            ...
            chi: {
                ...
                _touch: function(btn, eT) {
                    if (eT == 2){
                        ...
                        showSelectEatCards_xiangxiang(this,btn.tag);

                        // showSelectEatCards_loudifpf(this,btn.tag);
                    ...
                    this.adaptChiLayout = function() {
                        ...
                        for (var i = 0; i < cards_select.length; i++) {
                            ...
                            for (var j = 0; j < row.length; j++) {
                                ...
                                chiCardImg.loadTexture(MjClient.cardPath_xiangxiang + "out" + row[j] + ".png");
        ...
        cutLine:{
            ...
            _run: function () {
                ...
                if(MjClient.getAppType() == MjClient.APP_TYPE.HUNANWANGWANG || MjClient.getAppType() == MjClient.APP_TYPE.QXSYDTZ){
                    ...
                    if(type == 0){
                        setWgtLayout(this,[1, 0.3], [0.5, 0.53], [0, 0]);
                    }else{
                        setWgtLayout(this,[1, 0.3], [0.5, 0.44], [0, 0]);
                    }
                }
            },
            _event: {
    ...
    ctor: function() {
        this._super();
        var playui = ccs.load("Play_xiangxiangPHZ.json");
        playMusic("bgFight");
        var tData = MjClient.data.sData.tData;
    ...
    resetJiaZhuTip: function()
    {
        ...
        // for (var i = 0; i < MjClient.MaxPlayerNum_xiangxianggao; i ++)
        // {
...
//重置手牌的顺序
PlayLayer_xiangtanPHZ.prototype.ResetHandCard = function(posNode,off, needAction,  isDelay){
    ...
    if(off == 0){
        ...
        //if(MjClient.movingCard_xiangxianggao && MjClient.movingCard_xiangxianggao.getParent()){
        //    MjClient.movingCard_xiangxianggao.removeFromParent(true);
        //    MjClient.movingCard_xiangxianggao = null;
        //}
...
PlayLayer_xiangtanPHZ.prototype._doMovetoAction = function(node,endP){
    node.stopAllActions();
...
//庄家打出第一张牌之后，刷新提垅的牌
PlayLayer_xiangtanPHZ.prototype.UpdateEatCardsAfterFirst = function(posNode,off){
    var sData = MjClient.data.sData;
    var tData = MjClient.data.sData.tData;
...
PlayLayer_xiangtanPHZ.prototype.ResetOtherCard = function(posNode,off){
    //添加吃、碰、跑、偎、提
    var sData = MjClient.data.sData;
    var tData = null;
    if(sData){
    ...
    if(mjSortArr){
        ...
        var callback = function(childList, isCardReverse){
            var cardNum = pl.mjwei[pos];
            var length = childList.length;
            for(var i = 0;i < childList.length;i++){
                var child = childList[i];
                if(off != 0 && i == 0){
                    if(length == 4 && !tData.areaSelectMode.mingwei){
                        child.loadTexture(MjClient.cardPath_xiangxiang+"huxiBG.png");
                    }
                    if(length == 3 && isCardReverse){
                        child.loadTexture(MjClient.cardPath_xiangxiang+"huxiBG.png");
                    }
                }else if(off == 0 && length == 4 && i == 3){

                }else if(off == 0 && length == 3 && i == 2){
        ...
        for(var k = 0;k < mjSortArr.length;k++){
            ...
            if(name == "mjwei"){
                ...
                if(!tData.areaSelectMode.mingwei && ((off != 0 && !skipPeng_xiangxiang) || !tData.areaSelectMode.isShowChouWei)){
                    callback(childArr, true);
                }else{
                    callback(childArr);
                }
            }
...
PlayLayer_xiangtanPHZ.prototype.ResetPutCard = function(posNode,off){
    //添加打出的牌
    var pl = getUIPlayer_xiangxiang(off);
    if (!pl) return;
    ...
    for(var i = 0; i < pl.mjput.length; i++){
        ...
        // cc.log("off======" + off + "===outCard scale x:" + outCard.scaleX + "===outCard scale y:" + outCard.scaleY);
        // if(off == 0){
        //     outCard.anchorX = 1;
        //     outCard.anchorY = 0;
...
//重置牌的顺序
PlayLayer_xiangtanPHZ.prototype.CardLayoutRestore = function(posNode,off){
    if(MjClient.rePlayVideo == -1){
...
// 判断吃、碰、跑、偎、提、胡的状态
PlayLayer_xiangtanPHZ.prototype.EatVisibleCheck = function(off){
    var eat = MjClient.playui.jsBind.eat;
    ...
    if(tData.tState != TableState.roundFinish && pl.mjState != TableState.roundFinish){
        if(IsTurnToMe()){
            ...
            if(pl.eatFlag & 4){
                ...
                if(!canHu){
                    // HZGangToServer_xiangxianggao(2);
                    return;
                }
            } 
...
PlayLayer_xiangtanPHZ.prototype.showAndHideHeadEffect = function(){
