...
//向服务器发送 过消息
MjClient.MJPass2NetForxiangxianggao = function(){
    cc.log("====================send======pass=====");
...
function SetUserVisible_xiangxianggao(node, off){
    ...
    if(pl){
        ...
        // InitUserHandUI_xiangxianggao(node, off);
...
function InitUserHandUI_xiangxianggao(node, off){
...
var PlayLayer_xxGaoHuZi = cc.Layer.extend({
    jsBind: {
        _event: {
            mjhand: function() {
            ...
            endRoom: function(msg) {
                ...
                if (msg.showEnd){
                    if(MjClient.getAppType() == MjClient.APP_TYPE.HUNANWANGWANG || MjClient.getAppType() == MjClient.APP_TYPE.QXSYDTZ){
                        ...
                        this.addChild(new endAll_xxghz(),500);
                    }
                }else{
            ...
            roundEnd: function() {
                ...
                function delayExe(){
                    ...
                    if(!MjClient.endoneui){
                        self.addChild(new EndOneView_xxghz(),500);//EndOneView_xxghz()
                    }
                }
        ...
        cardNumImg: {
            ...
            _event: {
                initSceneData: function(eD) {
                    this.visible = IsArrowVisible_xiangxiang() && TableState.waitJiazhu != getUIPlayer_xiangxiang(0).mjState;
                },
                mjhand: function(eD) {
        ...
        roundInfo:{
            ...
            _run:function(){
                ...
                switch(tData.areaSelectMode.tuototuo){
                    case 0:
                        str += "不打坨";
                        break ;
                    case 1:
        ...
        down: {
                ...
                datuoflag:{
                    ...
                    _event:{
                        MJJiazhu:function(msg){
                            ...
                            MjClient.playui.setDaTuoImg(jiazhu, this);
                        },
                        initSceneData:function(){
                            var pl = getUIPlayer_xiangxiang(0);
                            ...
                            MjClient.playui.setDaTuoImg(pl.jiazhuNum, this);
                        },
                        removePlayer:function(){
                            this.visible = false;
                        }
            ...
            ready: {
                _layout: [[0.07, 0.07],[0.15, 0.17],[0, 0]],
                _run: function() {
            ...
            _event: {
                ...
                initSceneData: function(eD) {
                    SetUserVisible_xiangxianggao(this, 0);
                    InitUserHandUI_xiangxianggao(this, 0);
        ...
        right: {
            ...
            _event: {
                ...
                initSceneData: function(eD) {
                    ...
                    SetUserVisible_xiangxianggao(this, 1);
                    InitUserHandUI_xiangxianggao(this, 1);
        ...
        left: {
            head: {
                ...
                datuoflag:{
                    ...
                    _event:{
                        ...
                        initSceneData:function(){
                            if(getUIPlayer_xiangxiang(MjClient.MaxPlayerNum_xiangxiang - 1))
                                var pl = getUIPlayer_xiangxiang(MjClient.MaxPlayerNum_xiangxiang - 1);
                            else return ;
                            this.visible = pl.jiazhuNum >= 0;
                            if(MjClient.data.sData.tData.areaSelectMode.tuototuo == 0){
            ...
            ready: {
                _layout: [[0.07, 0.07],[0.15, 0.85],[0, 0]],
                _run: function() {
            ...
            _event: {
                ...
                initSceneData: function(eD) {
                    SetUserVisible_xiangxianggao(this, MjClient.MaxPlayerNum_xiangxiang - 1);
                    InitUserHandUI_xiangxianggao(this, MjClient.MaxPlayerNum_xiangxiang - 1);
                    ...
                    MjClient.playui.showAndHideTrust(this, MjClient.MaxPlayerNum_xiangxiang - 1);
                },
                addPlayer: function(eD) {
                    SetUserVisible_xiangxianggao(this, MjClient.MaxPlayerNum_xiangxiang - 1);
                    InitUserCoinAndName_xiangxiang(this, MjClient.MaxPlayerNum_xiangxiang - 1);
                ...
                HZPickCard:function (eD) {
                    if(MjClient.rePlayVideo != -1) {
                        var pl = getUIPlayer_xiangxiang(MjClient.MaxPlayerNum_xiangxiang - 1);
                        if(eD.uid == pl.info.uid){
                            MjClient.OtherHandArr[MjClient.MaxPlayerNum_xiangxiang - 1] = MjClient.majiang.sortHandCardSpecial(pl.mjhand)
                        }
                    }
                    RemovePutCardOut_xiangxiang(true);
                    var putNode = this.getChildByName("put");
...
PlayLayer_xxGaoHuZi.prototype.showAndHideTrust = function(node, uiOff){
    var tData = MjClient.data.sData.tData;
...
//重置手牌的顺序
PlayLayer_xxGaoHuZi.prototype.ResetHandCard = function(posNode,off, needAction,  isDelay){
...
PlayLayer_xxGaoHuZi.prototype._doMovetoAction = function(node,endP){
    node.stopAllActions();
...
//庄家打出第一张牌之后，刷新提垅的牌
PlayLayer_xxGaoHuZi.prototype.UpdateEatCardsAfterFirst = function(posNode,off){
    var sData = MjClient.data.sData;
    var tData = MjClient.data.sData.tData;
...
PlayLayer_xxGaoHuZi.prototype.ResetOtherCard = function(posNode,off){
    //添加吃、碰、跑、偎、提
    var sData = MjClient.data.sData;
    var tData = null;
    if(sData){
    ...
    if(mjSortArr){
        ...
        var callback = function(childList){
            ...
            for(var i = 0;i < childList.length;i++){
                ...
                if(off != 0 && i == 0){
                    if(length == 4 && off != 0 && tData.isLastDraw){
...
PlayLayer_xxGaoHuZi.prototype.ResetPutCard = function(posNode,off){
    //添加打出的牌
    var pl = getUIPlayer_xiangxiang(off);
    if (!pl) return;
...
//打坨标识
PlayLayer_xxGaoHuZi.prototype.setDaTuoImg = function(jiazhu, node){
    var daTuoImg = "game_picture/datuotip.png"
    var buDaTuoImg = "game_picture/datuotip_no.png"
    if(MjClient.getAppType() == MjClient.APP_TYPE.HUNANWANGWANG || MjClient.getAppType() == MjClient.APP_TYPE.QXSYDTZ){
        daTuoImg = "game_picture/datuotip_XX.png";
        buDaTuoImg = "game_picture/datuotip_no_XX.png";
    }

    if(jiazhu <= 0){
        node.loadTexture(buDaTuoImg);
    }else{
        node.loadTexture(daTuoImg);
    } 
}

//重置牌的顺序
PlayLayer_xxGaoHuZi.prototype.CardLayoutRestore = function(posNode,off){
    if(MjClient.rePlayVideo == -1){
...
// 判断吃、碰、跑、偎、提、胡的状态
PlayLayer_xxGaoHuZi.prototype.EatVisibleCheck = function(off){
    var eat = MjClient.playui.jsBind.eat;
...
PlayLayer_xxGaoHuZi.prototype.showAndHideHeadEffect = function(){
...
PlayLayer_xxGaoHuZi.prototype.showCountdown = function(node){
