// 邵阳湘乡告胡子字牌
var playPanel_xxGaoHuZi = playLayer_ziPai.extend({
    ctor: function() {
    ...
    getJsBind: function() {
        var jsBind = {
            ...
            img_banner: {
                ...
                btn_setting: {
                    _click: function() {
                        MjClient.Scene.addChild(new settingPanel_xxGaoHuZi(), 6000);
                    ...
                    img_daTuoFlag: {
                        ...
                        _event:{
                            MJJiazhu:function(msg){
                                ...
                                if(jiazhu <= 0){
                                    this.loadTexture("game_picture/datuotip_no_XX.png");
                                }else{
                                    this.loadTexture("game_picture/datuotip_XX.png");
                                }
                            },
                            initSceneData:function(){
...
//倒计时
playPanel_xxGaoHuZi.prototype.excCountDown = function(node) {
...
playPanel_xxGaoHuZi.prototype.showAndHideTrust = function(node){
    var off = this.getUIOffByNode(node);
...
// 打坨UI
playPanel_xxGaoHuZi.prototype.showDaTuoNode = function(node) {
    var off = this.getUIOffByNode(node);
...
// 设置玩家分数
playPanel_xxGaoHuZi.prototype.setPlayerScore = function(node) {
...
// 胡息
playPanel_xxGaoHuZi.prototype.updateHuXi = function(node) {
    node.setString("");
    if (!this.isInPlay()) {
        return;
    }
...
// 获取累计总胡息
playPanel_xxGaoHuZi.prototype.getTotalHuXi = function(node) {
    var off = this.getUIOffByNode(node);
    var pl = this.getUIPlayer(off);
    if(!pl || !pl.winall){
        return 0;
...
//检测距离信息
playPanel_xxGaoHuZi.prototype.checkCanShowDistance = function(layoutData) {
...
playPanel_xxGaoHuZi.prototype.calculateHintPutList = function() {
    MjClient.hintPutList_ziPai = MjClient.huzi.hintPutCardsToTing();
};

//Override
playPanel_xxGaoHuZi.prototype.isNeedShuffle = function() {
    return false;
};

//规则说明
playPanel_xxGaoHuZi.prototype.getRuleInfo = function() {
    var tData = MjClient.data.sData.tData;
    var str = "";
...
//Override
playPanel_xxGaoHuZi.prototype.createEndOneLayer = function(type) {
    return MjClient.playui.isCoinField() ? (new EndOneView_ziPaiGold()) : (new EndOneView_xxghz());
};

playPanel_xxGaoHuZi.prototype.getTingCards = function(sData, pl, putCard) {
    return MjClient.huzi.getTingCards(sData, pl, putCard);
};

//总结算面板
playPanel_xxGaoHuZi.prototype.createGameOverLayer = function(type) {
    return new GameOverLayer_syLoudi();
};

//字牌字体列表
playPanel_xxGaoHuZi.prototype.getCardFontList = function() {
    return ["type1", "type4", "type3"];
};

//Override 
playPanel_xxGaoHuZi.prototype.initSettingData = function() {
...
//双击出牌tempData
playPanel_xxGaoHuZi.prototype.initDoubleTempData = function() {
...
//Override
playPanel_xxGaoHuZi.prototype.setCardTouchHandler = function(card, off) {
    var self = this;
    var pl = this.getUIPlayer(off);
    var dict = {};
...
//Override 收入亮张动画
playPanel_xxGaoHuZi.prototype.showPickCardAnimation = function(node) {
    var self = this;
    var off = this.getUIOffByNode(node);
    var tData = MjClient.data.sData.tData;
...
//Override
playPanel_xxGaoHuZi.prototype.updateHandCardByHZPickCard = function(node) {
    var off = this.getUIOffByNode(node);
    if (!this.isCurPlayer(off)) {
        if (off == 0) {
...
//Override
playPanel_xxGaoHuZi.prototype.updateHandCardByPick = function(node) {
    return;
};

//Override
playPanel_xxGaoHuZi.prototype.showPutCardAnimation = function(node) {
    var off = this.getUIOffByNode(node);
...
// 出牌线&出牌手指动画
// playPanel_xxGaoHuZi.prototype.checkCutLineVisible = function(node) {
...
playPanel_xxGaoHuZi.prototype.showDefeatTip = function (uid) {
...
playPanel_xxGaoHuZi.prototype.removeDefeatTip = function () {
    var sData = MjClient.data.sData;
    for (var uid in sData.players) {
        var playerNode = this.getUINodeByUid(Number(uid));
        var playerHead = playerNode.getChildByName("layout_head");
...
// 更新展示牌(背光跟牌)
playPanel_xxGaoHuZi.prototype.updatePutCard = function(node, msg, isReconnect) {
    var tData = MjClient.data.sData.tData;
...
playPanel_xxGaoHuZi.prototype.isAniParallel = function() {
    return false;
};

// 发牌间隔
playPanel_xxGaoHuZi.prototype.getSendCardInterval = function() {
...
playPanel_xxGaoHuZi.prototype.changeEatBtnLayout = function(btnNode, len, idx) {
    var scale = 0.20;
    if(MjClient.getAppType() == MjClient.APP_TYPE.HUNANWANGWANG || MjClient.getAppType() == MjClient.APP_TYPE.QXSYDTZ){
