...
var topOff = 2;
//向服务器发送 过消息
MjClient.MJPass2NetForhuaianCC = function() {
    // console.log(">>>>>>>>>普通  过 <<<<<<<<");
    cc.log("====================send======pass=====");
...
function SetUserVisible_huaianCC(node, off) {
    //var sData = MjClient.data.sData;
    //return;
    cc.log("====================off======================" + off);
...
function InitUserHandUI_huaianCC(node, off) {
    var sData = MjClient.data.sData;
    var tData = sData.tData;
    var pl = getUIPlayer(off);
    if (!pl) {
    ...
    cc.log("_________________InitUserHandUI_huaianCC_______________" + JSON.stringify(pl));
...
function initFlower_huaianCC() {
    initFlower(false, false);
}


var PlayLayer_huaianCC = cc.Layer.extend({
    jsBind: {
        _event: {
            mjhand: function() {
            ...
            roundEnd: function() {
                ...
                function delayExe() {
                    ...
                    self.addChild(new EndOneView_huaianCC(), 500);
                }
        ...
        roundInfo: {
            _run: function() {
                ...
                showPlayUI_roundInfo(getPlayingRoomInfo(0), tData.tableid);
        ...
        banner: {
            ...
            Button_1: {
                _visible: true,
                _click: function() {
                    MjClient.openWeb({ url: MjClient.GAME_TYPE.HUAI_AN_CC, help: true });
                }
            },
            hunPai: {
                baidaBg: {
        ...
        down: {
            ...
            _event: {
                ...
                initSceneData: function(eD) {
                    SetUserVisible_huaianCC(this, 0);
                },
                addPlayer: function(eD) {
                    SetUserVisible_huaianCC(this, 0);
                },
                ...
                mjhand: function(eD) {
                    InitUserHandUI_huaianCC(this, 0);
                },
                roundEnd: function() {
        ...
        right: {
            ...
            _event: {
                ...
                initSceneData: function(eD) {
                    SetUserVisible_huaianCC(this, 1);
                },
                addPlayer: function(eD) {
                    SetUserVisible_huaianCC(this, 1);
                },
                ...
                mjhand: function(eD) {
                    InitUserHandUI_huaianCC(this, 1);
                },
                roundEnd: function() {
        ...
        top: {
            ...
            _event: {
                ...
                initSceneData: function(eD) {
                    SetUserVisible_huaianCC(this, topOff);
                },
                addPlayer: function(eD) {
                    SetUserVisible_huaianCC(this, topOff);
                },
                ...
                mjhand: function(eD) {
                    InitUserHandUI_huaianCC(this, topOff);
                },
                roundEnd: function() {
        ...
        left: {
            ...
            _event: {
                ...
                initSceneData: function(eD) {
                    SetUserVisible_huaianCC(this, 3);
                },
                addPlayer: function(eD) {
                    SetUserVisible_huaianCC(this, 3);
                },
                ...
                mjhand: function(eD) {
                    InitUserHandUI_huaianCC(this, 3);
                },
                roundEnd: function() {
        ...
        eat: {
            ...
            guo: {
                ...
                _touch: function(btn, eT) {
                    if (eT == 2) {
                        MjClient.MJPass2NetForhuaianCC();
                    }
                },
                bgimg: {
                    _run: function() {
            ...
            changeui: {
                ...
                changeuibg: {
                    ...
                    guobg: {
                        guo: {
                            _touch: function(btn, eT) {
                                if (eT == 2) MjClient.MJPass2NetForhuaianCC();
                            }
                        },
                        fanhui: {
                            _touch: function(btn, et) {
    ...
    ctor: function() {
        ...
        var playui = ccs.load(res.Play_huaianCC_json);
        playMusic("bgFight");
...
PlayLayer_huaianCC.prototype.CardLayoutRestore = function(node, off) {
...
// 判断吃碰杠胡的状态
PlayLayer_huaianCC.prototype.EatVisibleCheck = function() {
    var eat = MjClient.playui.jsBind.eat;
