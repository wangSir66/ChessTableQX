...
function SetEndOneUserUI_lingshibianlong(node,off)
{
...
var EndOneView_lingshibianlong = cc.Layer.extend({
	jsBind:{
		block: {
		...
		head0:{
		   ...
		   _run:function(){ SetEndOneUserUI_lingshibianlong(this,0); },
		...
		,head1:{ 
		  ...
		  _run:function(){ SetEndOneUserUI_lingshibianlong(this,1); }
		}
		...
		,head2:{ 
		   ...
		   _run:function(){ SetEndOneUserUI_lingshibianlong(this,2); }
		}
		,head3:{
			 head:
			 {
			...
			_run:function(){ SetEndOneUserUI_lingshibianlong(this,3); }
			},
            count_down:{
                _visible :function()
                {
    ...
    ctor:function () {
        this._super();
        var endoneui = ccs.load(res.EndOne_lingshibianlong_json);
