...
var _isShowShaiziAni_chenzhou = false; //为了控制mjhand之后播骰子动画时newCard的状态显示
//向服务器发送 过消息
MjClient.MJPass2NetForchenzhou = function()
{
   // console.log(">>>>>>>>>普通  过 <<<<<<<<");
    cc.log("====================send======pass=====");
...
var showShaiziAni_chenzhou = false;
function showShaiziAni_chenzhou_old(poff)
{
    if(poff == 0) {
        ...
        if(MjClient.rePlayVideo != -1)//回放
        {
            for (var off = 0; off < 4; off++) {
                ...
                InitUserHandUI_chenzhou(_node, off);
            }
            playEffect("shuffle");
        ...
        _isShowShaiziAni_chenzhou = true;
        ...
        firstFrame.runAction(cc.sequence(playSoundFunc, animate,showPonitFunc,cc.delayTime(0.5),cc.callFunc(function(){
            //发牌
            _isShowShaiziAni_chenzhou = false;
...
function updateHeadUI_chenzhou(node, off)
{      
    cc.log('updateHeadUI_chenzhou', off)
    var pl = getUIPlayer(off);
    if(!pl) return;
    showHandCard_chenzhou(node, off);
    MjClient.playui.CardLayoutRestore(node, off);
    cc.log('updateHeadUI_chenzhou update success', off)
...
function SetUserVisible_chenzhou(node, off)
{
    if (_isShowShaiziAni_chenzhou)  // 解决摇骰子时断线重连调用本函数，会手牌重复的bug by cyc
        return;
...
function showHandCard_chenzhou(node, off)
{
    var sData = MjClient.data.sData;
    var tData = sData.tData;
    var pl = getUIPlayer(off);
...
function InitUserHandUI_chenzhou(node, off)
{
    var sData = MjClient.data.sData;
    var tData = sData.tData;
    var pl = getUIPlayer(off);
...
function initFlower_chenzhou() {
    initFlower(false, false);
}


var PlayLayer_chenzhou = cc.Layer.extend({
    jsBind: {
        _event: {
            mjhand: function() {
            ...
            roundEnd: function() {
                ...
                function showEndCards()
                {
                    ...
                    self.addChild(new EndOneView_chenzhou(),500);
                }
                function delayExe()
                {
      ...
      //           }
        ...
        BtnPutCard:{ //add by  sking for put card button
            ...
            _event:{
                ...
                waitPut: function() {
                    if (_isShowShaiziAni_chenzhou) return;
        ...
        down: {
            ...
            _event: {
                ...
                initSceneData: function(eD) {
                    SetUserVisible_chenzhou(this, 0);
                },
                addPlayer: function(eD) {
                    SetUserVisible_chenzhou(this, 0);
                },
                ...
                mjhand: function(eD) {
					if (showShaiziAni_chenzhou){
						...
						InitUserHandUI_chenzhou(this, 0);
                        if (MjClient.data.sData.tData.areaSelectMode.isOpenTingTip) {
                            var pl = getUIPlayer(0);
                            if (pl && getOffByIndex(MjClient.data.sData.tData.curPlayer) != 0) {
                                var tingSet = {};
                ...
                newCard: function(eD) {
                    ...
                    cc.log("pl.tingLists    ---------- ",MjClient.canTingCards);
        ...
        right: {
            ...
            _event: {
                ...
                initSceneData: function(eD) {
                    SetUserVisible_chenzhou(this, 1);
                },
                addPlayer: function(eD) {
                    SetUserVisible_chenzhou(this, 1);
                },
                ...
                mjhand: function(eD) {
                    if (!showShaiziAni_chenzhou)
						InitUserHandUI_chenzhou(this, 1);
                },
                roundEnd: function() {
        ...
        top: {
            ...
            _event: {
                ...
                initSceneData: function(eD) {
                    SetUserVisible_chenzhou(this, 2);
                },
                addPlayer: function(eD) {
                    SetUserVisible_chenzhou(this, 2);
                },
                ...
                mjhand: function(eD) {
                    if (!showShaiziAni_chenzhou)
						InitUserHandUI_chenzhou(this, 2);
                },
                roundEnd: function() {
        ...
        left: {
            ...
            _event: {
                ...
                initSceneData: function(eD) {
                    SetUserVisible_chenzhou(this, 3);
                },
                addPlayer: function(eD) {
                    SetUserVisible_chenzhou(this, 3);
                },
                ...
                mjhand: function(eD) {
                    if (!showShaiziAni_chenzhou)
						InitUserHandUI_chenzhou(this, 3);
                },
                roundEnd: function() {
        ...
        eat: {
            ...
            guo: {
                ...
                _touch: function(btn, eT) {
                    if (eT == 2)
                    {
                        MjClient.MJPass2NetForchenzhou();
                    }
                },
                bgimg: {
                    _run: function() {
            ...
            changeui: {
                ...
                changeuibg: {
                    ...
                    guobg: {
                        guo: {
                            _touch: function(btn, eT) {
                                if (eT == 2) MjClient.MJPass2NetForchenzhou();
                            }
                        },
                        fanhui: {
                            _touch: function(btn, et) {
    ...
    ctor: function() {
        this._super();
        var playui = ccs.load("Play_chenzhou.json");
...
PlayLayer_chenzhou.prototype.willHuShowArrow = function()
{
    var tData = MjClient.data.sData.tData;
...
PlayLayer_chenzhou.prototype.CardLayoutRestore = function(node, off, isNewCard)
{
...
// 判断吃碰杠胡的状态
PlayLayer_chenzhou.prototype.EatVisibleCheck = function()
{
    var eat = MjClient.playui.jsBind.eat;
...
PlayLayer_chenzhou.prototype.jiaozhuToPiaoniao = function(jiazhuLayer, msg) {
    var tData = MjClient.data.sData.tData;
