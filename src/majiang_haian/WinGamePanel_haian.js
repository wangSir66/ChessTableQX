...
function SetEndOneUserUI_haian(node,off)
{
...
var EndOneView_haian = cc.Layer.extend({
	jsBind:{
		block: {
		...
		head0:{
		   ...
		   _run:function(){ SetEndOneUserUI_haian(this,0); },
		...
		,head1:{ 
		  ...
		  _run:function(){ SetEndOneUserUI_haian(this,1); }
		}
		...
		,head2:{ 
		   ...
		   _run:function(){ SetEndOneUserUI_haian(this,2); }
		}
		,head3:{
			 head:
			 {
			...
			_run:function(){ SetEndOneUserUI_haian(this,3); }
			},
            count_down:{
                _visible :function()
                {
    ...
    ctor:function () {
        this._super();
        var endoneui = ccs.load(res.EndOne_haian_json);
		...
		var _shaizi =  _back.getChildByName("Panel_shaizi");
		showShaiZiUI_haian(_shaizi);
