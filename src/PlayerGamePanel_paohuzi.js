...
function SetUserVisible_paohuzi(node, off){
    ...
    if(pl){
        ...
        // InitUserHandUI_paohuzi(node, off);
...
function InitUserHandUI_paohuzi(node, off){
...
var PlayLayer_paohuzi = cc.Layer.extend({
    jsBind: {
        _event: {
        ...
        roundInfo:{
            ...
            _run:function(){
                ...
                str += (tData.areaSelectMode.baodi == -1) ? "" : "保底" + tData.areaSelectMode.baodi + "分,"; 
        ...
        wait: {
            ...
            wxinvite: {
                ...
                _click: function() {
                    ...
                    //     str1+str2+str3+str5+str6);
                    // GLog(GameCnName[MjClient.gameType] + "  房间号:" + tData.tableid + str7+str1+str2+str3+str5+str6 );
        ...
        down: {
                    ...
                    time:{
                        ...
                        _event: {
                            ...
                            onlinePlayer: function(){
                                ...
                                if(pl && pl.onLine && curPlayerIsMe_paohuzi(0)){
                                    arrowbkNumberUpdate(this);
                                }
                            },
                            roundEnd: function() {
            ...
            _event: {
                ...
                initSceneData: function(eD) {
                    ...
                    SetUserVisible_paohuzi(this, 0);
                    InitUserHandUI_paohuzi(this, 0);
        ...
        right: {
                    ...
                    time:{
                        ...
                        _event: {
                            ...
                            onlinePlayer: function(){
                                ...
                                if(pl && pl.onLine && curPlayerIsMe_paohuzi(1)){
                                    arrowbkNumberUpdate(this);
                                }
                            },
                            roundEnd: function() {
            ...
            _event: {
                ...
                initSceneData: function(eD) {
                    SetUserVisible_paohuzi(this, 1);
                    InitUserHandUI_paohuzi(this, 1);
        ...
        left: {
            head: {
                zhuang: {
                    ...
                    _event: {
                        waitPut: function() {
                            showUserZhuangLogo_paohuzi(this, 2);
                        },
                        initSceneData: function() {
                            if (IsArrowVisible_paohuzi()) showUserZhuangLogo_paohuzi(this, 2);
                        },
                        mjhand: function(){
                            if (IsArrowVisible_paohuzi()) showUserZhuangLogo_paohuzi(this, 2);
                        }
                ...
                chatbg: {
                    ...
                    chattext: {
                        _event: {
                            MJChat: function(msg) {
                                showUserChat_paohuzi(this, 2, msg);
                            },
                            playVoice: function(voicePath) {
                                MjClient.data._tempMessage.msg = voicePath;
                                showUserChat_paohuzi(this, 2, MjClient.data._tempMessage);
                            }
                        }
                    }
                },
                _click: function(btn) {
                    showPlayerInfo_paohuzi(2, btn);
                },
                _event: {
                    loadWxHead: function(d) {
                        setWxHead_paohuzi(this, d, 2);
                    },
                    addPlayer: function(eD) {
                        showFangzhuTagIcon_paohuzi(this,2);
                    },
                    removePlayer: function(eD) {
                        showFangzhuTagIcon_paohuzi(this,2);
                    }
                ...
                timeImg:{
                    ...
                    _event:{
                        initSceneData: function(eD) {
                            this.visible = curPlayerIsMe_paohuzi(2);
                        },
                        mjhand: function(eD) {
                            this.visible = curPlayerIsMe_paohuzi(2);
                        },
                        onlinePlayer: function(eD) {
                            this.visible = curPlayerIsMe_paohuzi(2) && IsArrowVisible_paohuzi();
                        },
                        waitPut: function(eD) {
                            this.visible = curPlayerIsMe_paohuzi(2);
                        },
                    ...
                    time:{
                        ...
                        _event: {
                            ...
                            onlinePlayer: function(){
                                ...
                                stopEffect(playTimeUpEff);
                                playTimeUpEff = null;
                                var pl = getUIPlayer_paohuzi(2);
                                if(pl && pl.onLine && curPlayerIsMe_paohuzi(2)){
                                    arrowbkNumberUpdate(this);
                                }
                            },
                            roundEnd: function() {
            ...
            ready: {
                _layout: [[0.07, 0.07],[0.5, 0.5],[-2.5, 2.5]],
                _run: function() {
                    GetReadyVisible_paohuzi(this, 2);
                },
                _event: {
                    startShuffleCards:function (d) {
                        GetReadyVisible_paohuzi(this, -1);
            ...
            _event: {
                ...
                initSceneData: function(eD) {
                    SetUserVisible_paohuzi(this, 2);
                    InitUserHandUI_paohuzi(this, 2);
                    InitUserCoinAndName_paohuzi(this, 2);
                    DealOffLineCard_paohuzi(this,2);
                },
                addPlayer: function(eD) {
                    SetUserVisible_paohuzi(this, 2);
                    InitUserCoinAndName_paohuzi(this, 2);
                ...
                HZNewCard: function(eD) {
                    ...
                    DealNewCard_paohuzi(this,eD,2);
                },
                roundEnd: function() {
                    InitUserCoinAndName_paohuzi(this, 2);
                    // MjClient.playui.ResetOtherCard(this, 2);
                    MjClient.playui.ResetEatCardsEnd(this, 2);
                },
                waitPut: function(eD) {
                    DealWaitPut(this, eD, 2);
                },
                MJPut: function(eD) {
                    DealPutCard_paohuzi(this, eD, 2);
                },
                HZChiCard: function(eD) {
                    DealChiCard_paohuzi(this, eD, 2);
                },
                HZPaoCard: function(eD) {
                    DealPaoCard_paohuzi(this, eD, 2);
                },
                HZGangCard: function(eD) {
                    DealGangCard_paohuzi(this, eD, 2);
                },
                MJPeng: function(eD) {
                    DealPengCard_paohuzi(this, eD, 2);
                },
                HZWeiCard: function(eD){
                    DealWeiCard_paohuzi(this, eD, 2);
                },
                MJHu: function(eD) {
                    DealHu_paohuzi(this, eD, 2);
                },
                onlinePlayer: function(eD) {
                    setUserOffline_paohuzi(this, 2);
                },
                playerStatusChange: function(eD) {
                    setUserOffline_paohuzi(this, 2);
                },
                ...
                HZWangChuang: function(eD){
                    DealWangChuang_paohuzi(this, eD, 2);
                },
                HZWangChuangShow:function(eD){
                    DealWangChuang_paohuzi(this, eD, 2);
                },
...
//重置手牌的顺序
PlayLayer_paohuzi.prototype.ResetHandCard = function(posNode,off,needAction,isDelay){
    needAction = needAction === undefined ? false : needAction;

    if(off == 0){

        // cc.log("=======================ResetHandCard player.mjhand========================");
        // cc.log("执行动画前手牌 MjClient.HandCardArr=====:" , MjClient.HandCardArr);
        // var uid = MjClient.data.pinfo.uid;
        // var player = MjClient.data.sData.players[uid];
        // if(player){
        //     cc.log(player.mjhand);
        // }

        // var result = checkMjhand_HandCards(MjClient.HandCardArr);
        // if(!result.isSame)
        // {
        //     cc.log(result.reList);
        // }
...
// PlayLayer_paohuzi.prototype.refreshNode_paohuzi = function(posNode,off,needAction){
//     needAction = needAction === undefined ? false : needAction;
...
//     this._checkIsAddGroup_paohuzi();

//     var index = 0;
//     for(var k = 0;k < oldLen;k++){
//         var groupList = cardArr[index];

//         if(this._hasValueInArr_paohuzi(deleIndexArr, k)){
//             continue;
//         }

//         this._checkGroupList_paohuzi(groupList,k);
//         for(var j = 0;j < groupList.length;j++){
...
//         var addNode = handNode.getChildByTag(i);
//         if(addNode && this._hasValueInArr_paohuzi(deleIndexArr, addNode.tag)){
...
//             }
//             this._doMovetoAction(addNode, cc.p((winSize.width - totalWidth)/2 + index * handCard.width * scale_x,0));
//             index += 1;
//         }
//     }
...
// PlayLayer_paohuzi.prototype._checkIsAddGroup_paohuzi = function(){
//     var cardArr = MjClient.HandCardArr;
...
// //检测并删除一列里多余的牌
// PlayLayer_paohuzi.prototype._checkGroupList_paohuzi = function(groupList,tagName){
//     var _node = getNode_paohuzi(0);
//     //根据牌的类型获得需要添加的节点
//     var addNode = _node.getChildByName("handNode");
//     if(!addNode){
...
//             if(card && 
//                 (!this._hasValueInArr_paohuzi(groupList,card.tag) || 
...
// PlayLayer_paohuzi.prototype._hasValueInArr_paohuzi = function(arr,value){
//     var len = arr.length;
//     for(var i = 0; i < len; i++){
//         var temp = arr[i];
//         if(temp == value){
...
PlayLayer_paohuzi.prototype._doMovetoAction = function(node,endP){
    node.stopAllActions();
    var ac = cc.moveTo(0.3,endP);
    node.runAction(ac);
};

PlayLayer_paohuzi.prototype.ResetEatCardsEnd = function(posNode,off){
    var pl = getUIPlayer_paohuzi(off);
    if (!pl) return;
    //提、偎牌的特殊处理
...
PlayLayer_paohuzi.prototype.ResetOtherCard = function(posNode,off){
    //添加吃、碰、跑、偎、提
    var sData = MjClient.data.sData;
    var tData = null;
    if(sData){
...
PlayLayer_paohuzi.prototype.ResetPutCard = function(posNode,off){
    //添加打出的牌
    var pl = getUIPlayer_paohuzi(off);
    if (!pl) return;
    var outNode = posNode.getChildByName("outNode");
...
//重置牌的顺序
PlayLayer_paohuzi.prototype.CardLayoutRestore = function(posNode,off){
    if(MjClient.rePlayVideo == -1){
...
// 判断吃、碰、跑、偎、提、胡的状态
PlayLayer_paohuzi.prototype.EatVisibleCheck = function(off){
    var eat = MjClient.playui.jsBind.eat;
    var sData = MjClient.data.sData;
    var tData = sData.tData;
