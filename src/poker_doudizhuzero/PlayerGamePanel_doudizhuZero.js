...
var PlayLayer_doudizhuZERO = cc.Layer.extend({
    ctor: function () {
        this._super();
        var playui = ccs.load(res.Play_doudizhuJZ_json);
...
//出牌提示
PlayLayer_doudizhuZERO.prototype.showTipCards = function () {
...
// 处理斗地主智能提牌
PlayLayer_doudizhuZERO.prototype.handleDoudizhuCardsAutoUp = function (bTouchMove) {
    if (!this.isSDataValid()) {
        return ;
    }
    var tData = MjClient.data.sData.tData;
...
PlayLayer_doudizhuZERO.prototype.handleCardsTouchListener = function () {
    return {
...
// 处理点击
PlayLayer_doudizhuZERO.prototype.handleTouchCards = function (touch, event, isBegan) {
...
// 处理玩家提起提起得牌，保留正确的牌
PlayLayer_doudizhuZERO.prototype.handleUpRightCards = function (isFirst, off) {
    if (isFirst) {
        return;
    }
...
// =========================[[ 流程 ]] =========================
// 断线重连/初始化
PlayLayer_doudizhuZERO.prototype.dealInitSceneData = function () {
    if (!this.isSDataValid()) {
        return ;
    }
    var tData = MjClient.data.sData.tData;
...
PlayLayer_doudizhuZERO.prototype.dealChangePKImg = function () {
...
// 结算
PlayLayer_doudizhuZERO.prototype.dealRoundEnd = function (eD) {
    if (!this.isSDataValid()) {
        return ;
    }
    ...
    function delayExe() {
        ...
        if (MjClient.playui.isJinBiChang()) {
            ...
            self.addChild(new EndOneView_doudizhuZERO(zhuang), 500);
        }
    }
...
// 过、准备
PlayLayer_doudizhuZERO.prototype.dealPKPass = function (eD) {
    MjClient.playui.killTimeClock();
    MjClient.clockNode.visible = false;
...
// 出牌
PlayLayer_doudizhuZERO.prototype.dealPKPut = function (msg) {
    var tData = MjClient.data.sData.tData;
    tData.rate = msg.rate;
...
// 等待出牌
PlayLayer_doudizhuZERO.prototype.dealWaitPut = function (eD, isSceneData) {
    var tData = MjClient.data.sData.tData;
...
// 等待叫地主
PlayLayer_doudizhuZERO.prototype.dealWaitJiaodizhu = function (msg, isSceneData) {
    var sData = MjClient.data.sData;
    var tData = sData.tData;
...
// 抢地主
PlayLayer_doudizhuZERO.prototype.dealQiangDizhu = function (msg) {
    var tData = MjClient.data.sData.tData;
...
// 等待准备
PlayLayer_doudizhuZERO.prototype.dealAllReady = function (bAllReady) {
    for (var i = 0; i < this.headOffLen; i++) {
        var off = this.headOffArr[i];
...
// 加倍
PlayLayer_doudizhuZERO.prototype.dealMJJiazhu = function (isSceneData, off, jiazhuNum, curPlayer) {
    var tData = MjClient.data.sData.tData;
...
// 等待加倍
PlayLayer_doudizhuZERO.prototype.dealWaitJiazhu = function (eD, isSceneData, isIconMove) {
    var tData = MjClient.data.sData.tData;
...
// 处理手牌
PlayLayer_doudizhuZERO.prototype.handleMjHand = function (isSendCard) {
...
PlayLayer_doudizhuZERO.prototype.showPostCardAnimation = function () {
...
// 处理底牌
PlayLayer_doudizhuZERO.prototype.dealDiCards = function (zhuang, diCards, handCounts, isAddCards, isIconMove) {
    var tData = MjClient.data.sData.tData;
    tData.zhuang = zhuang;
...
//处理托管 1：托管，2：非托管
PlayLayer_doudizhuZERO.prototype.dealTrust = function (msg, cbTrust) {
    if (msg != undefined) {
        var tData = MjClient.data.sData.tData;
        if (!MjClient.playui.isJinBiChang()) {
            return;
...
// =========================[[ 小控件 ]] ========================
PlayLayer_doudizhuZERO.prototype.updateUserHeadPosition = function (off, bRoundEnd) {
...
PlayLayer_doudizhuZERO.prototype.updateTimes = function () {
...
//设置地区信息
PlayLayer_doudizhuZERO.prototype.showGameName = function () {
    ...
    if (MjClient.playui.isJinBiChang()) {
        text = "playing/gameTable/game_doudizhuZERO_jb.png";
    }
    gameName.loadTexture(text);
};

//添加还背景的功能
PlayLayer_doudizhuZERO.prototype.addChangeBg = function () {
...
PlayLayer_doudizhuZERO.prototype.showVoice = function () {
...
PlayLayer_doudizhuZERO.prototype.addWaitNode = function () {
    if (!MjClient.playui.isJinBiChang()) {
...
PlayLayer_doudizhuZERO.prototype.setWaitNodeVisible = function (bVisible) {
...
PlayLayer_doudizhuZERO.prototype.addAniLayer = function () {
...
PlayLayer_doudizhuZERO.prototype.showTableID = function (bShow) {
...
PlayLayer_doudizhuZERO.prototype.setHLJiabeiVisible = function (bVisible) {
...
// 出牌按钮
PlayLayer_doudizhuZERO.prototype.handlePutCardBtn = function (isVisible, isFirst) {
...
PlayLayer_doudizhuZERO.prototype.enablePutCardBtn = function (bAble) {
    var btnPutCard = this.node.getChildByName("BtnPutCard");
...
//操作按钮(提示和不出)
PlayLayer_doudizhuZERO.prototype.handleHimtAndNoPutBtn = function (isVisible, isAble) {
...
//经典斗地主叫分按钮
PlayLayer_doudizhuZERO.prototype.setJingDianBtnVisible = function (bVisible, buJiaoAble, score, bmustjiao) {
...
//欢乐斗地主叫分按钮
PlayLayer_doudizhuZERO.prototype.setHuanLeBtnVisible = function (bVisible) {
...
// 牌局信息
PlayLayer_doudizhuZERO.prototype.showRoundInfo = function () {
    if (!this.isSDataValid()) {
        return ;
    }
...
// 局数
PlayLayer_doudizhuZERO.prototype.updateGameRound = function () {
...
// 加倍
PlayLayer_doudizhuZERO.prototype.setTextMult = function (bShow) {
...
// 底分
PlayLayer_doudizhuZERO.prototype.handleDifen = function () {
...
// 不抢/抢地主
PlayLayer_doudizhuZERO.prototype.dealQiangDizhuText = function (off, isPlayEffect) { // , visible, msg
    if (!this.isSDataValid()) {
        return ;
    }
    var tData = MjClient.data.sData.tData;
...
// 要不起
PlayLayer_doudizhuZERO.prototype.handleNoPutTag = function (off, visible) {
    var node = getNode_cards(off);
...
// 没有大过上家
PlayLayer_doudizhuZERO.prototype.handleNoPutTips = function (isVisible) {
...
// 没有大过上家
PlayLayer_doudizhuZERO.prototype.handlePassBtn = function (isVisible) {
...
//加倍
PlayLayer_doudizhuZERO.prototype.handleJiabeiTag = function (off, type) {
    var node = getNode_cards(off);
...
PlayLayer_doudizhuZERO.prototype.ShowWaittingJiabei = function () {
...
// =========================[[ 系统 ]] ==========================
PlayLayer_doudizhuZERO.prototype.dealSendVoice = function (fullFilePath) {
    if (!fullFilePath) {
...
PlayLayer_doudizhuZERO.prototype.dealDownAndPlayVoice = function (msg) {
...
PlayLayer_doudizhuZERO.prototype.dealUploadRecord = function (filePath) {
    if (filePath) {
...
// 绘制手牌
PlayLayer_doudizhuZERO.prototype.initUserHandUiDoudizhu = function (off) {
    var pl = getUIPlayer(off);
    if (pl == null) {
        return;
    }
...
//处理出牌,打牌动作
PlayLayer_doudizhuZERO.prototype.dealPKPutcard = function (off, msg) {
...
PlayLayer_doudizhuZERO.prototype.playAnimation = function (cards, off) {
    var pl = getUIPlayer(off);
    if (!pl) { return ; }
...
// 增加底牌
PlayLayer_doudizhuZERO.prototype.addDiCardsToZhuang = function (zhuangOff) {
    var tData = MjClient.data.sData.tData;
...
PlayLayer_doudizhuZERO.prototype.hideAllUI = function () {
...
// 处理准备字准备相关
PlayLayer_doudizhuZERO.prototype.handleAboutReady = function (off, bAllReady) {
...
PlayLayer_doudizhuZERO.prototype.startTimeClock = function (func, isSceneData, curOff) {
...
PlayLayer_doudizhuZERO.prototype.killTimeClock = function () {
    MjClient.clockNode.getChildByName("number").stopAllActions();
    stopEffect(playTimeUpEff);
    playTimeUpEff = null;
};

PlayLayer_doudizhuZERO.prototype.clockNumberUpdate = function (node, endFunc) {
    return arrowbkNumberUpdate(node, endFunc);
}

PlayLayer_doudizhuZERO.prototype.checkRoomUiDelete = function () {
...
PlayLayer_doudizhuZERO.prototype.showGps = function () {
...
// 地主的三张牌
PlayLayer_doudizhuZERO.prototype.handleDoudizhuDiCards = function () {
    var isShow = false;
    var cards;
    if (this.isSDataValid()) {
        var tData = MjClient.data.sData.tData
...
PlayLayer_doudizhuZERO.prototype.dealMJTick = function (eD) {
    for (var i = 0; i < this.headOffLen; i++) {
        var off = this.headOffArr[i];
        var pl = getUIPlayer(off);
        if (!pl) { continue ; }
...
PlayLayer_doudizhuZERO.prototype.dealLogout = function () {
    if (MjClient.playui) {
...
PlayLayer_doudizhuZERO.prototype.dealEndRoom = function (msg) {
...
PlayLayer_doudizhuZERO.prototype.dealLeaveGame = function () {
    MjClient.playui.killTimeClock();
    MjClient.addHomeView();
    MjClient.playui.removeFromParent(true);
    delete MjClient.playui;
...
PlayLayer_doudizhuZERO.prototype.dealLoadWxHead = function (eD) {
    for (var i = 0; i < this.headOffLen; i++) {
        var off = this.headOffArr[i];
...
PlayLayer_doudizhuZERO.prototype.dealPlayVoice = function (msg) {
    for (var i = 0; i < this.headOffLen; i++) {
        var off = this.headOffArr[i];
...
PlayLayer_doudizhuZERO.prototype.dealChangeGameBgEvent = function () {
...
PlayLayer_doudizhuZERO.prototype.handlePlayerChange = function (action, uid) {
    if (!this.isSDataValid()) {
        return ;
    }
    var targetOff = -1;
...
PlayLayer_doudizhuZERO.prototype.hideAllPlayerReadyState = function () {
    var isFull = !IsInviteVisible();
    var count = 0;
...
PlayLayer_doudizhuZERO.prototype.dealMoveHead = function () {
    var that = this;
    var fun1 = function () {
...
// =========================[[ 消息 ]] ===========================
// 加倍
PlayLayer_doudizhuZERO.prototype.sendJiaBeiToServer = function (beishu) {
    MjClient.gamenet.request("pkroom.handler.tableMsg", {
        cmd: "MJJiazhu",
        jiazhuNum: beishu,
    });
...
// 叫地主、不叫、叫分
PlayLayer_doudizhuZERO.prototype.sendQiangdizhuToServer = function (bQiang) {
    MjClient.gamenet.request("pkroom.handler.tableMsg", {
        cmd: "Qiangdizhu",
        qiang: bQiang
    });
...
// 出牌
PlayLayer_doudizhuZERO.prototype.sendPutCardsToServer = function () {
...
// 准备-1， 提示过牌0， 不出 1
PlayLayer_doudizhuZERO.prototype.sendPassToServer = function (isActivePass) {
    this.handCardsWgetArr[0].clearCardsUpStatus();
...
PlayLayer_doudizhuZERO.prototype.sendCancelTuoGuanToServer = function () {
    MjClient.gamenet.request("pkroom.handler.tableMsg", {cmd: "cancelTrust"});
};

PlayLayer_doudizhuZERO.prototype.sendTuoGuanToServer = function () {
    MjClient.gamenet.request("pkroom.handler.tableMsg", {cmd: "beTrust"});
};

// =========================[[ 初始化 ]] ==========================
PlayLayer_doudizhuZERO.prototype.initData = function (isRoundEnd) {
    this.cardTipsArr = [];
    this.tipsIdx = 0;
...
PlayLayer_doudizhuZERO.prototype.initTagList = function () {
    this.btnTagList = {
        BtnPutCard: 1,
        BtnHimt: 2,
        BtnNoPut: 3,
...
PlayLayer_doudizhuZERO.prototype.initOnce = function () {
...
PlayLayer_doudizhuZERO.prototype.initUI = function () {
...
//设置金币场节点
PlayLayer_doudizhuZERO.prototype.displayJinBiChangNode = function () {
...
// 初始化节点
PlayLayer_doudizhuZERO.prototype.initHeadWget = function () {
    this.headOffArr = [];
    this.headNode = {};
    this.AniMotion = [];
...
//初始化玩家信息
PlayLayer_doudizhuZERO.prototype.initMsgEvent = function () {
    // ================ 重连 =========================
...
PlayLayer_doudizhuZERO.prototype.initClickEvent = function () {
    ...
    var btnList1 = ["BtnPutCard", "BtnHimt", "BtnNoPut", "BtnJiaodizhu", "Btnbujiao",
        "BtnReady", "BtnJiabei", "Btnbujiabei", "Btnbujiao_JD", "Btnfen1", "Btnfen2", "Btnfen3", "gps_btn", "chat_btn", "tuoguan_btn", "duty_btn", "BtnPass"];
...
PlayLayer_doudizhuZERO.prototype.btnBindCallBack = function (parent, str, tag, callback) {
    var tmpNode = parent.getChildByName(str);
    tmpNode.tag = tag;
    tmpNode.addTouchEventListener(callback);
};

PlayLayer_doudizhuZERO.prototype.btnEventListener = function (sender, type) {
...
// 初始化时钟节点
PlayLayer_doudizhuZERO.prototype.initClockWget = function () {
    for (var off = 0; off < 4; off++) {
        var _node = getNode(off);
...
//判断自己是不是托管状态
PlayLayer_doudizhuZERO.prototype.isTrusted = function () {
    if (!MjClient.playui.isJinBiChang()) {
        return false;
    }
    var pl = getUIPlayer(0);
...
PlayLayer_doudizhuZERO.prototype.handleMutiple = function (isSceneData) {
    var tData = MjClient.data.sData.tData;
    var imgMutiple = this._banner.getChildByName("imgMutiple");
    imgMutiple.visible = false;
...
PlayLayer_doudizhuZERO.prototype.showJiabeiTagMove = function (off, jizhuNum) {
    var node = getNode_cards(off);
    var jiabeiTag = node.getChildByName("jiabeiTag");
        ...
        jiabeiTag.runAction(
            cc.sequence(
                ...
                cc.callFunc(function () {
                    MjClient.playui.headNode[off].setJiaBeiIcon(jizhuNum == 2);
                })
            )
        );
    }
}
PlayLayer_doudizhuZERO.prototype.isSDataValid = function() {
    var sData = MjClient.data.sData;
