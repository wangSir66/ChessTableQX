...
function SetEndOneUserUI_guanyun(node,off)
{
...
var EndOneView_guanyun = cc.Layer.extend({
	jsBind:{
		block: {
		...
		head0:{
		   ...
		   _run:function(){ SetEndOneUserUI_shuyang(this,0); },
		...
		,head1:{ 
		  ...
		  _run:function(){ SetEndOneUserUI_shuyang(this,1); }
		}
		...
		,head2:{ 
		   ...
		   _run:function(){ SetEndOneUserUI_shuyang(this,2); }
		}
		,head3:{
			 head:
			 {
			...
			_run:function(){ SetEndOneUserUI_shuyang(this,3); }
			},
            count_down:{
                _visible :function()
                {
    ...
    ctor:function () {
        this._super();
        var endoneui = ccs.load(res.EndOne_guanyun_json);
