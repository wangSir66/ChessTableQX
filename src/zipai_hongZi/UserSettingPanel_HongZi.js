...
//选项选中时的颜色处理  统一处理
var HZ_SETTNG_COLOR_1 = cc.color(255,119,28);
var HZ_SETTNG_COLOR_2 = cc.color(118,99,42);
...
var SettingView_HongZi = cc.Layer.extend({
    ...
    ctor:function () {
        ...
        if(MjClient.getAppType() == MjClient.APP_TYPE.TXLINFENMJ){
            HZ_SETTNG_COLOR_1 = cc.color(94,119,199);
            HZ_SETTNG_COLOR_2 = cc.color(91,95,128);
        }
        ...
        puTongHua_txt.setTextColor(HZ_SETTNG_COLOR_1);
        benDiHua_txt.setTextColor(HZ_SETTNG_COLOR_2);
        ...
        if(voiceType  == 0)
        {
            ...
            benDiHua_txt.setTextColor(HZ_SETTNG_COLOR_1);
            puTongHua_txt.setTextColor(HZ_SETTNG_COLOR_2);
        }
            ...
            onTouchEnded: function (touch, event) { 
                ...
                if (listnode) {
                    ...
                    if (radio == that._playNode_Hua_radio) {
                        ...
                        if (number == 0) {
                            that.puTongHua_txt.setTextColor(HZ_SETTNG_COLOR_1);
                            that.benDiHua_txt.setTextColor(HZ_SETTNG_COLOR_2);
                            util.localStorageEncrypt.setNumberItem(MjClient.KEY_voiceType_HongZi, 0);
                        }
                        if (number == 1) {
                            that.benDiHua_txt.setTextColor(HZ_SETTNG_COLOR_1);
                            that.puTongHua_txt.setTextColor(HZ_SETTNG_COLOR_2);
                            util.localStorageEncrypt.setNumberItem(MjClient.KEY_voiceType_HongZi, 1);
                        }
                    }
                    ...
                    that.bgMusic1_txt.setTextColor(bgMusicType  == 0 ? HZ_SETTNG_COLOR_1 : HZ_SETTNG_COLOR_2);
                    that.bgMusic2_txt.setTextColor(bgMusicType  == 1 ? HZ_SETTNG_COLOR_1 : HZ_SETTNG_COLOR_2);
                    that.bgMusic3_txt.setTextColor(bgMusicType  == 2 ? HZ_SETTNG_COLOR_1 : HZ_SETTNG_COLOR_2);
