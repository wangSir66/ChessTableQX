...
(function() {
    ...
    MaJiangMLHZ.prototype.getAllCardsTotal = function() {
    ...
    MaJiangMLHZ.prototype.isEqualHunCard = function(card) {
        return card == KING;
    };

    MaJiangMLHZ.prototype.sortByUser = function(arr) {
    ...
    // 理牌
    MaJiangMLHZ.prototype.sortCard = function(hand, sortType) {
        hand = hand.slice();
    ...
    MaJiangMLHZ.prototype.cardHandCount = function (cardArr,card){
        var cardCount = 0;
    ...
    // 获取能打牌的数量
    MaJiangMLHZ.prototype.getCanPutCardNum = function(pl) {
        var num = 0;
        var hand = pl.mjhand;
    ...
    // 获取听牌
    MaJiangMLHZ.prototype.getTingCards = function(tb, pl, putCard) {
    ...
    // 获取听牌统计
    MaJiangMLHZ.prototype.getTingStats = function(tb, pl, putCard) {
    ...
    MaJiangMLHZ.prototype.canTing = function(tb, pl, putCard) {
        var copy = pl.mjhand.slice();
        var tingCards = [];
        if (putCard != undefined) {
            var idx = pl.mjhand.indexOf(putCard);
    ...
    // 提示打后可听的牌
    MaJiangMLHZ.prototype.hintPutCardsToTing = function() {
    ...
    // 打的牌 -->  听牌统计
    MaJiangMLHZ.prototype.put2TingStats = function(tb, pl) {
    ...
    if (typeof(MjClient) != "undefined") {
        MjClient.majiang_hongZi = new MaJiangMLHZ();
    }   
