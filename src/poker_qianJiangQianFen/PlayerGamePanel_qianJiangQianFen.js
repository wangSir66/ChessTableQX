...
var GameOverLayer_QianJiangQianFen =  GameOverLayer_Poker.extend({
    ctor: function() {
        this._super();
    },
...
//初始化玩家金币和名字
function InitUserCoinAndName_QianJiangQianFen(node, off)
{
...
function SetUserVisible_QianJiangQianFen(node, off)
{
    var pl = getUIPlayer(off);
    ...
    if(pl)
    {
        ...
        InitUserHandUI_QianJiangQianFen(node, off);
    }
    else
    {
        name.visible = false;
...
function InitUserHandUI_QianJiangQianFen(node, off)
{
    ...
    //初始化玩家金币和名称
    InitUserCoinAndName_QianJiangQianFen(node, off);
    ...
    if(MjClient.rePlayVideo == -1)// 表示正常游戏
    {
        if (pl.mjhand && off == 0) {//只初始化自己的手牌
            ...
            for (var i = 0; i < pl.mjhand.length; i++) {
                ...
                MjClient.playui.addFenTag(card);
            }
...
var PlayLayer_QianJiangQianFen = cc.Layer.extend({
    _btnPutCard:null,
    jsBind: {
        _event: {
            mjhand: function() {
            ...
            endRoom: function(msg) {
                ...
                if (msg.showEnd) this.addChild(new GameOverLayer_QianJiangQianFen(),500);
                else
            ...
            roundEnd: function() {
                ...
                function delayExe()
                {
                        ...
                        if (sData.tData.roundNum <= 0) {
                            if(!tData.matchId) {
                                ...
                                self.runAction(cc.sequence(cc.delayTime(3),cc.callFunc(function(){
                                    self.addChild(new GameOverLayer_QianJiangQianFen(),500);
                                })))
                            }
                        }
                    }
                    ...
                    self.addChild(new EndOneView_qianJiangQianFen(),500,650);
                    MjClient.playui.resetRoundData();
                }
                // delayExe();
                var jinGongAni = function () {
                    var msg = {isRoundEnd : true};
                    MjClient.playui.showXiAndZhaAnim(msg);
                }
                this.runAction(cc.sequence(cc.callFunc(jinGongAni),cc.delayTime(2.0),cc.callFunc(delayExe)));
            ...
            initSceneData: function() {
                ...
                //     MjClient.playui.showXiFenAnim(_msg);
                // }, 2);
                ...
                // tData.chickenCard = 37 ;
                // tData.zhuangPartner = 1;
                // tData.zhuang = 0;
                ...
                //     pi.winOrLose  = -3007;
                // }
                // MjClient.playui.addChild(new EndOneView_QianJiangQianFen(),500,650);
            },
            ...
            updatePlayerXiFen: function(msg){
                MjClient.playui.showXiAndZhaAnim(msg);
            },
        ...
        BtnNoPut:{
            _run: function () {
                this.visible = false;
                if(isIPhoneX())
                    setWgtLayout(this,[0.15, 0.14], [0.5, 0.46], [0, 0.26]);
                else
                    setWgtLayout(this,[0.15, 0.14], [0.5, 0.39], [0, 0.26]);
        ...
        baoJingMaxTip: {
            _run: function() {
                ...
                this.checkVisible = function() {
                    ...
                    // 下家报单或报双,单牌双牌请出最大牌
                    if (IsTurnToMe() && tData.tState == TableState.waitPut && plNext) {
                        if(plNext.handCount == 1){
                            this.loadTexture("playing/QianJiangQianFen/wenzi2.png");
                            this.visible = tData.lastPutPlayer == tData.curPlayer || tData.lastPutCard.length == 1;
                        }
                        if(plNext.handCount == 2){
                            this.loadTexture("playing/QianJiangQianFen/wenzi1.png");
                            this.visible = tData.lastPutPlayer == tData.curPlayer || tData.lastPutCard.length == 2;
                        }
        ...
        down: {
            head: {
                ...
                zhua:{
                    ...
                    _event: {
                        ...
                        initSceneData: function() {
                            MjClient.playui.setPlayerZhuaFen(this,0,true);
                        },
                        mjhand: function() {
                            MjClient.playui.setPlayerZhuaFen(this);
                        }
                    }
                },
                icon_you:
                ...
                imgFirstPut:{
                    ...
                    _event: {
                        waitPut: function(eD) {
                            MjClient.playui.playFirstPutAni(this,0);
                        },
                    }
                },
            },
            ...
            _event: {
                ...
                initSceneData: function(eD) {
                    ...
                    SetUserVisible_QianJiangQianFen(this, 0);
                ...
                mjhand: function(eD) {
                    InitUserHandUI_QianJiangQianFen(this, 0);
                ...
                roundEnd: function() {
                    InitUserCoinAndName_QianJiangQianFen(this, 0);
                    //setTaiInfo("");
                },
        ...
        right: {
            head: {
                ...
                zhua:{
                    ...
                    _event: {
                        ...
                        initSceneData: function() {
                            MjClient.playui.setPlayerZhuaFen(this,1,true);
                        },
                        mjhand: function() {
                            MjClient.playui.setPlayerZhuaFen(this);
                        }
                ...
                imgFirstPut:{
                    ...
                    _event: {
                        waitPut: function(eD) {
                            MjClient.playui.playFirstPutAni(this,1);
                        },
                    }
                },
            },
            ...
            _event: {
                ...
                initSceneData: function(eD) {
                    SetUserVisible_QianJiangQianFen(this, 1);
                ...
                mjhand: function(eD) {
                    InitUserHandUI_QianJiangQianFen(this, 1);
                },
                roundEnd: function() {
                    InitUserCoinAndName_QianJiangQianFen(this, 1);
                },
                waitPut: function(eD) {
        ...
        top: {
            ...
            head: {
                ...
                zhua:{
                    ...
                    _event: {
                        ...
                        initSceneData: function() {
                            MjClient.playui.setPlayerZhuaFen(this,2,true);
                        },
                        mjhand: function() {
                            MjClient.playui.setPlayerZhuaFen(this);
                        }
                ...
                imgFirstPut:{
                    ...
                    _event: {
                        waitPut: function(eD) {
                            MjClient.playui.playFirstPutAni(this,2);
                        },
                    }
                },
            },
            ...
            _event: {
                ...
                initSceneData: function(eD) {
                    SetUserVisible_QianJiangQianFen(this, 2);
                ...
                mjhand: function(eD) {
                    InitUserHandUI_QianJiangQianFen(this, 2);
                },
                roundEnd: function() {
                    InitUserCoinAndName_QianJiangQianFen(this, 2);
                },
                waitPut: function(eD) {
        ...
        left: {
            head: {
                ...
                zhua:{
                    ...
                    _event: {
                        ...
                        initSceneData: function() {
                            MjClient.playui.setPlayerZhuaFen(this,3,true);
                        },
                        mjhand: function() {
                            MjClient.playui.setPlayerZhuaFen(this);
                        }
                ...
                imgFirstPut:{
                    ...
                    _event: {
                        waitPut: function(eD) {
                            MjClient.playui.playFirstPutAni(this,3);
                        },
                    }
                },
            ...
            _event: {
                ...
                initSceneData: function(eD) {
                    SetUserVisible_QianJiangQianFen(this, 3);
                ...
                mjhand: function(eD) {
                    InitUserHandUI_QianJiangQianFen(this, 3);
                },
                roundEnd: function() {
                    InitUserCoinAndName_QianJiangQianFen(this, 3);
                },
                waitPut: function(eD) {
...
//牛十别专有排序
 ...
 //
    ctor: function() {
        ...
        var playui = ccs.load(res.Play_qianJiangQianFen_json);
...
PlayLayer_QianJiangQianFen.prototype.InitC_Data = function() {
...
PlayLayer_QianJiangQianFen.prototype.clockNumberUpdate = function(node, endFunc)
{
...
PlayLayer_QianJiangQianFen.prototype.updateClockPosition = function(arrowNode)
{
    var tData = MjClient.data.sData.tData;
    var uids = tData.uids;
 ...
 * @return {String}
 */
PlayLayer_QianJiangQianFen.prototype.getGameInfoString = function(param)
{
    var tData = MjClient.data.sData.tData;
    var str = "";
...
PlayLayer_QianJiangQianFen.prototype.isChickenPlayer = function(){

};

PlayLayer_QianJiangQianFen.prototype.showQiangZhuangTag = function(off, eD){
    var tData = MjClient.data.sData.tData;
...
PlayLayer_QianJiangQianFen.prototype.checkPartnerIsConfirm = function(){
    var tData = MjClient.data.sData.tData;
    var ret = true;
...
PlayLayer_QianJiangQianFen.prototype.addFenTag = function(node){
    var tData = MjClient.data.sData.tData;
    ...
    //     return
    // }
    if(!node.getChildByName("jipaiTag") && (Math.ceil(node.tag / 4) == 5 || Math.ceil(node.tag / 4) == 10 || Math.ceil(node.tag / 4) == 13))
    {
        var _cardTag = new ccui.ImageView("playing/qianJiangQianFen/icon-fen.png");
        _cardTag.setAnchorPoint(0, 0.5)
        _cardTag.setPosition(12, node.height/3);
...
PlayLayer_QianJiangQianFen.prototype.addChickenCardIcon = function(off){
    var pl = getUIPlayer(off);
...
PlayLayer_QianJiangQianFen.prototype.setChickenCardIcon = function(eD)
{
    if(true){
...
PlayLayer_QianJiangQianFen.prototype.showJieFengAnim = function(msg)
{
...
//身份识别后播鸡的动画
PlayLayer_QianJiangQianFen.prototype.showChickenAnim = function(index){
    var tData = MjClient.data.sData.tData;
...
//亮身份
PlayLayer_QianJiangQianFen.prototype.showIdentityIcon = function(eD){
    var tData = MjClient.data.sData.tData;
...
PlayLayer_QianJiangQianFen.prototype.showPartnerTips = function(){
    var tData = MjClient.data.sData.tData;
    var pl = getUIPlayer(0);
...
//重连
PlayLayer_QianJiangQianFen.prototype.dealZhuangMing = function(){
    var tData = MjClient.data.sData.tData;
...
//明抢了
PlayLayer_QianJiangQianFen.prototype.showMingAnim = function(msg){
...
PlayLayer_QianJiangQianFen.prototype.showZhuangIcon = function (UIoff, isMing) {
    var tData = MjClient.data.sData.tData;
...
PlayLayer_QianJiangQianFen.prototype.showFlyCardAnim = function(flyNode,cardValue,UIoff)
{
    var playerNode = getNode_cards(UIoff);
    if (!playerNode)
        return;
...
PlayLayer_QianJiangQianFen.prototype.showHandCardBeiMian = function()
{
...
PlayLayer_QianJiangQianFen.prototype.hideHandCardBeiMian = function()
{
...
PlayLayer_QianJiangQianFen.prototype.CardLayoutRestore = function(node, off)
{
    cc.log("PlayLayer_QianJiangQianFen11==============");
    
    // 如果正在发牌 不排序
    if (MjClient.playui.isFaPai) return;
    
    cc.log("PlayLayer_QianJiangQianFen22==============");
...
PlayLayer_QianJiangQianFen.prototype.CardLayoutDesk = function(node,cards,off)
{
    var tData = MjClient.data.sData.tData;
...
PlayLayer_QianJiangQianFen.prototype.getJokerCardsFromRet = function(ret) {
        if (!ret || ret.length <= 0)
            return [];
...
//横向摆放《正常》
PlayLayer_QianJiangQianFen.prototype.horSort = function(node, off)
{
    var pl; //player 信息
...
//纵向摆放
PlayLayer_QianJiangQianFen.prototype.verSort = function(node, off)
{
    if(off != 0)
    {
        return;
...
PlayLayer_QianJiangQianFen.prototype.changePosition = function(msg,flyNode,oldUids)
{
    if (!msg)return;
...
PlayLayer_QianJiangQianFen.prototype.showXiAndZhaAnim = function(msg){
    if(msg == null){
        return;
    }
    var sData = MjClient.data.sData;
    ...
    (function(msg){
        for(var i = 0; i < MjClient.MaxPlayerNum; i++ ){
            ...
            var winScoreUid = msg.uid;

            var off = getUiOffByUid(uid);
            var type = 0;//1:7喜   2:8喜    3:天王   4:8喜(7+1)   5:总炸  6:进贡分
            var score = 0;
            if(msg.isRoundEnd){
                type = 6;
                var player = getUIPlayerByUID(uid);
            ...
            var nodeLose = getNode_cards(off).getChildByName("head").getChildByName("flyScore_0");
            var nodeWin = getNode_cards(off).getChildByName("head").getChildByName("flyScore_1");
            var headNodeZhua = getNode_cards(off).getChildByName("head").getChildByName("zhua");
            ...
            var child_name = ("icon_").concat(type);
            var showNode = MjClient.playui.Node_Anim.getChildByName(child_name);

            if(type >= 1 && type <= 6 && showNode && i == 0){
                showNode.zIndex = 9999;
                showNode.setVisible(true);

                showNode.runAction(cc.sequence( cc.fadeIn(0.1), cc.fadeOut(1.4), cc.callFunc(function(){
                    
                })  ));
            }

            (function(nodeWin, nodeLose, pos,headNodeZhua,score){
                if(score == 0){
                    return;
                }
                nodeLose.setScale(1.8);
                nodeWin.setScale(1.8);
                nodeLose.zIndex = 999;
                nodeWin.zIndex = 999;
                if(uid == winScoreUid){
                    nodeWin.setString("/" + score);
                    nodeWin.setVisible(true);
                    //cc.fadeOut(1.5),  cc.moveBy(0.8, cc.p(0,-20))
                    nodeWin.runAction(cc.sequence( cc.moveBy(0.2, cc.p(0,20)), cc.delayTime(1.3), cc.callFunc(function(){
                        MjClient.playui.setPlayerZhuaFen(headNodeZhua, off,null,score);
                        nodeWin.setPosition(pos.win);
                        nodeWin.setVisible(false);
                    })  ));
                }else{
                    nodeLose.setVisible(true);
                    nodeLose.setString("/" + score);
                    nodeLose.runAction(cc.sequence( cc.moveBy(0.2, cc.p(0,20)), cc.delayTime(1.3),  cc.callFunc(function(){
                        MjClient.playui.setPlayerZhuaFen(headNodeZhua, off,null,-score);
                        nodeLose.setPosition(pos.lose);
                        nodeLose.setVisible(false);
                    })  ));
                }
            }.bind(this))(nodeWin, nodeLose,pos,headNodeZhua,score);
        }
    }.bind(this))(msg); 
...
//处理明牌
PlayLayer_QianJiangQianFen.prototype.dealMingPai = function(node, msgary, UIOff, needSound)
{   
    // 回放情形下，不需展示明牌
    if (MjClient.rePlayVideo != -1)
        return;
...
PlayLayer_QianJiangQianFen.prototype.showWatchPanel = function(node, cards){
...
PlayLayer_QianJiangQianFen.prototype.dealSwitchWatch = function(watch, cards){
    if(!watch){
...
//展示队友手牌
PlayLayer_QianJiangQianFen.prototype.showPartnerHandCards = function(node, cards)
{   
    // 回放情形下，不需展示
    if (MjClient.rePlayVideo != -1 || !MjClient.playui.checkPartnerIsConfirm() || cards == null){
        node.setVisible(false);
...
PlayLayer_QianJiangQianFen.prototype.dealPartnerPutCards = function(node, putCards)
{   
...
PlayLayer_QianJiangQianFen.prototype.dealPKPutCards = function(node, msg)
{
...
PlayLayer_QianJiangQianFen.prototype.CardLayoutPartnerCards = function(node)
{
    if(MjClient.rePlayVideo != -1)// 表示回放
    {
        MjClient.sortClassType = 0;
...
PlayLayer_QianJiangQianFen.prototype.clearPartnerUI = function(node)
{
    // 回放情形下，不需处理
    if (MjClient.rePlayVideo != -1)
        return;
...
PlayLayer_QianJiangQianFen.prototype.showFlyZhuaFenAnim = function(msg){
    var UIoff =  getUiOffByUid(msg.uid);
    var score= msg.zhuaFen;

    var playerNode = getNode_cards(UIoff);
    if (!playerNode || score == null )
        return;

    MjClient.playui.flyZhuaFen.setPosition(MjClient.playui.srcPos.flyZhuaFen);

    var flyNode = MjClient.playui.flyZhuaFen;
    flyNode.setString(score);
    var headNode = playerNode.getChildByName("head").getChildByName("zhua");
    var point = headNode.convertToWorldSpace(cc.p(headNode.width/2, headNode.height/2));
    point = flyNode.getParent().convertToNodeSpace(point);

    flyNode.setString(score - parseInt(headNode.getString()));
    ...
    flyNode.runAction(cc.sequence(cc.delayTime(0),cc.spawn(cc.moveTo(0.6, point), cc.scaleTo(0.6, flyNode.getScale()/1.5)), cc.callFunc(function() {
        MjClient.playui.setPlayerZhuaFen(headNode, UIoff, null, score);
        flyNode.setVisible(false);
    })));
...
PlayLayer_QianJiangQianFen.prototype.setPlayerZhuaFen = function(node,off,isInitSceneData,score)
{
    if (arguments.length < 2) {
        node.setString("0");
        return;
    }
    var totalScore = isInitSceneData ? 0 : parseInt(node.getString());
    if(isInitSceneData){
        ...
        if (player) {
            ...
            if(player.zhaFen){
                totalScore += player.zhaFen;
            }
            if(player.xiFen){
                totalScore += player.xiFen;
            }
        }
    }else {
        totalScore += score;
...
PlayLayer_QianJiangQianFen.prototype.UpdataDaMaZiTips = function(){
    var sData = MjClient.data.sData;
    var tData = sData.tData;
...
PlayLayer_QianJiangQianFen.prototype.clearDeskCard = function(node)
{
    var children = node.children;
    for (var i = 0; i < children.length; i++)
    {
...
PlayLayer_QianJiangQianFen.prototype.putDaMaZiTips = function(cardType){
...
PlayLayer_QianJiangQianFen.prototype.onClickLiPai = function()
{
...
PlayLayer_QianJiangQianFen.prototype._sortS2B = function(oCards){
...
PlayLayer_QianJiangQianFen.prototype._sortCardByType = function(){
...
PlayLayer_QianJiangQianFen.prototype.resetRoundData = function()
{
    var sData = MjClient.data.sData;
    var tData = sData.tData;
...
PlayLayer_QianJiangQianFen.prototype.ClearLiPai = function(uid, putcards)
{
...
PlayLayer_QianJiangQianFen.prototype.setDownMenusEnabled = function()
{
    var tData = MjClient.data.sData.tData;
...
// 展示报喜动画
PlayLayer_QianJiangQianFen.prototype.showBaoxiAnimation = function(msg)
{   
    ...
    MjClient.playui.addChild(new PiaoFenView_QianJiangQianFen(msg.score,uiOff),500);
}

// 设置己方喜牌数据
PlayLayer_QianJiangQianFen.prototype.setMajiangXiCard = function()
{   
...
// 创建投降UI
PlayLayer_QianJiangQianFen.prototype.createTouXiangView = function(touXiangData)
{   
    //回放的时候，不弹投降窗口
    // if(MjClient.rePlayVideo != -1) 
    //     return;
...
PlayLayer_QianJiangQianFen.prototype.reLoadOptBtnRes = function() {
    //出牌按钮
...
//弹出选择的牌
PlayLayer_QianJiangQianFen.prototype.selectUICards = function(_tipsCardArray)
{
...
PlayLayer_QianJiangQianFen.prototype.checkPut = function (oHands, oCards, lastPutCard, areaSelectMode) {
    var tData = MjClient.data.sData.tData;
    ...
    if ((tData.lastPutPlayer == tData.curPlayer || tData.lastPutPlayer == -1)) {
        ...
        this._btnHimt.visible = false;
        this._btnPutCard.x = this._btnPutCard.srcX - 290 * screenScale;
    } else {
        this._btnNoPut.visible = (!MjClient.playui.isFaPai &&
            tData.lastPutPlayer != tData.curPlayer && tData.lastPutPlayer != -1 && MjClient.tipCardsArray.length <= 0);

        if (this._btnHimt.isVisible()) {
            // this._btnNoPut.x = this._btnNoPut.srcX;
            this._btnPutCard.x = this._btnPutCard.srcX - 150 * screenScale;
            this._btnHimt.x = this._btnHimt.srcX - 150 * screenScale;
        } else {
            this._btnNoPut.x = this._btnPutCard.srcX - 290 * screenScale;
    ...
    var nextPlayer = this.getNextOffPlayer(tData.curPlayer,1);
    var nextPlayerCardNum = nextPlayer.handCount;
    cc.log("nextPlayernextPlayer,",nextPlayer)
    cc.log("nextPlayerCardNum,",nextPlayerCardNum)
    return MjClient.majiang.checkPut(oHands, oCards, lastPutCard, areaSelectMode,nextPlayerCardNum);
};
PlayLayer_QianJiangQianFen.prototype.getNextOffPlayer = function(plIndex, off) {
    var tData = MjClient.data.sData.tData;
    off = off || 1;
    return getUIPlayerByUID(tData.uids[ (tData.maxPlayer + plIndex + off) % tData.maxPlayer ]);
}

PlayLayer_QianJiangQianFen.prototype.RemoveNodeBack = function(node, name, num, tag) {
...
PlayLayer_QianJiangQianFen.prototype.findNodesBack = function(node, name, tags) {
    tags = tags.slice();
...
PlayLayer_QianJiangQianFen.prototype.cardsSort = function(cards)
{
    var pointCounts = {};
    for (var i = 0; i < cards.length; i++) {
...
PlayLayer_QianJiangQianFen.prototype.isUsingJiPaiQi = function()
{
    var jipaiqi = MjClient.data.sData.tData.jipaiqi;
    return jipaiqi && jipaiqi.indexOf(SelfUid()) >= 0;
}

PlayLayer_QianJiangQianFen.prototype.createJiPaiQiPanel = function()
{
...
// 记牌器购买面板
PlayLayer_QianJiangQianFen.prototype.showJiPaiQiBuyingPanel = function(commoditys,purchaseCallback) {
...
PlayLayer_QianJiangQianFen.prototype.setJiPaiQiEnabled = function(node) {
    var tData = MjClient.data.sData.tData;
    var enabled = tData.tState != TableState.waitJoin && 
        tData.tState != TableState.roundFinish && 
        tData.tState != TableState.waitReady && 
...
PlayLayer_QianJiangQianFen.prototype.setJiPaiQiNum = function(node) {
...
PlayLayer_QianJiangQianFen.prototype.checkJiPaiQiListValid = function(commoditys) {
...
PlayLayer_QianJiangQianFen.prototype.checkJiPaiQiButtonVisible = function(node) {
...
PlayLayer_QianJiangQianFen.prototype.playFirstPutAni = function(node,off){
    var tData = MjClient.data.sData.tData;
    var curPlayerIndex = (tData.curPlayer + MjClient.MaxPlayerNum - tData.uids.indexOf(SelfUid())) % MjClient.MaxPlayerNum;
    if(off == curPlayerIndex && tData.roundAll == tData.roundNum && tData.lastPutPlayer == -1){
        node.runAction(cc.sequence(cc.delayTime(3), cc.callFunc(function(){
            node.setVisible(true);
        }), cc.moveBy(0.2, cc.p(0,20)), cc.fadeOut(2.3), cc.callFunc(function(){
            node.setVisible(false);
        })));
    }
}