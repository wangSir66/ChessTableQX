...
//向服务器发送 过消息
MjClient.MJPass2NetForYanChengHH = function()
{
   // console.log(">>>>>>>>>普通  过 <<<<<<<<");
    cc.log("====================send======pass=====");
...
function SetUserVisible_yanchenghh(node, off)
{
    //var sData = MjClient.data.sData;
    //return;
    cc.log("====================off======================" + off);
    ...
    if(pl)
    {
        ...
        InitUserHandUI_yanchenghh(node, off);
...
function InitUserHandUI_yanchenghh(node, off)
{
    var sData = MjClient.data.sData;
    var tData = sData.tData;
    var pl = getUIPlayer(off);
...
function initFlower_yanchenghh() {
    initFlower(false, false);
}


var PlayLayer_yanchenghh = cc.Layer.extend({
    jsBind: {
        _event: {
            mjhand: function() {
            ...
            roundEnd: function() {
                ...
                function delayExe()
                {
                    ...
                    self.addChild(new EndOneView_yanchenghh(),500);
                }
        ...
        roundInfo:{
            ...
            _run:function()
            {
                ...
                var strZaiMo = tData.areaSelectMode.gangBao?"杠爆":"不杠爆";
                str += strZaiMo;
                this.ignoreContentAdaptWithSize(true);
                var strPayWay = "";
        ...
        banner: {
            ...
            Button_1: {
                _visible : true,
                _click: function() {
                    MjClient.openWeb({url:MjClient.GAME_TYPE.YAN_CHENG_HH,help:true});
                }
            },
            hunPai:{
                baidaBg:{
        ...
        wait: {
            getRoomNum: {
                ...
                _click: function() {
                    ...
                    var tData = MjClient.data.sData.tData;
                    var str1 = "盐城晃晃,";
                    var str2 = tData.areaSelectMode.gangBao?"杠爆,":"不杠爆,";
                    var strPayWay = "";
                    switch (tData.areaSelectMode.payWay)
                    {
                        case 0:
            ...
            _click: function(btn) {
                ...
                for(var i = 0; i < children.length; i++)
                {
                    if(children[i].name == "mjhand")
                    {
                        ...
                        {
                            if(children[i].tag != tData.hunCard){
        ...
        down: {
            ...
            _event: {
                ...
                initSceneData: function(eD) {
                    SetUserVisible_yanchenghh(this, 0);
                },
                addPlayer: function(eD) {
                    SetUserVisible_yanchenghh(this, 0);
                },
                ...
                mjhand: function(eD) {
                    InitUserHandUI_yanchenghh(this, 0);
                },
                roundEnd: function() {
        ...
        right: {
            ...
            _event: {
                ...
                initSceneData: function(eD) {
                    SetUserVisible_yanchenghh(this, 1);
                },
                addPlayer: function(eD) {
                    SetUserVisible_yanchenghh(this, 1);
                },
                ...
                mjhand: function(eD) {
                    InitUserHandUI_yanchenghh(this, 1);
                },
                roundEnd: function() {
        ...
        top: {
            ...
            _event: {
                ...
                initSceneData: function(eD) {
                    SetUserVisible_yanchenghh(this, 2);
                },
                addPlayer: function(eD) {
                    SetUserVisible_yanchenghh(this, 2);
                },
                ...
                mjhand: function(eD) {
                    InitUserHandUI_yanchenghh(this, 2);
                },
                roundEnd: function() {
        ...
        left: {
            ...
            _event: {
                ...
                initSceneData: function(eD) {
                    SetUserVisible_yanchenghh(this, 3);
                },
                addPlayer: function(eD) {
                    SetUserVisible_yanchenghh(this, 3);
                },
                ...
                mjhand: function(eD) {
                    InitUserHandUI_yanchenghh(this, 3);
                },
                roundEnd: function() {
        ...
        eat: {
            ...
            guo: {
                ...
                _touch: function(btn, eT) {
                    if (eT == 2)
                    {
                        MjClient.MJPass2NetForYanChengHH();
                    }
                },
                bgimg: {
                    _run: function() {
            ...
            changeui: {
                ...
                changeuibg: {
                    ...
                    guobg: {
                        guo: {
                            _touch: function(btn, eT) {
                                if (eT == 2) MjClient.MJPass2NetForYanChengHH();
                            }
                        },
                        fanhui: {
                            _touch: function(btn, et) {
    ...
    ctor: function() {
        this._super();
        var playui = ccs.load(res.Play_yanchenghh_json);
        playMusic("bgFight");
...
PlayLayer_yanchenghh.prototype.CardLayoutRestore = function(node, off)
{
...
// 判断吃碰杠胡的状态
PlayLayer_yanchenghh.prototype.EatVisibleCheck = function()
{
    var eat = MjClient.playui.jsBind.eat;
