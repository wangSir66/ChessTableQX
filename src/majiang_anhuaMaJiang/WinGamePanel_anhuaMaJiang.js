...
function SetEndOneUserUI_anhuaMaJiang(node,off)
{
...
var EndOneView_anhuaMaJiang = cc.Layer.extend({
	jsBind:{
		block: {
		...
		head0:{
		   ...
		   _run:function(){ SetEndOneUserUI_anhuaMaJiang(this,0); },
		...
		,head1:{ 
		  ...
		  _run:function(){ SetEndOneUserUI_anhuaMaJiang(this,1); }
		}
		...
		,head2:{ 
		   ...
		   _run:function(){ SetEndOneUserUI_anhuaMaJiang(this,2); }
		}
		,head3:{
			 head:
			 {
			...
			_run:function(){ SetEndOneUserUI_anhuaMaJiang(this,3); }
			},
            count_down:{
                _visible :function()
                {
    ...
    ctor:function () {
        this._super();
        var endoneui = ccs.load("endOne_anhuaMaJiang.json");
        ...
        for(var i = 0;i < cards.length;i++)
        {
            ...
            if(tData.areaSelectMode.zhongNiaoType == 1 && (cards[i] <= 29 && cards[i] % 10 == 1 || cards[i] % 10 == 5 || cards[i] % 10 == 9))
            {
            	zhongCount++;
            }
            else if (tData.areaSelectMode.zhongNiaoType == 0 && (cards[i] % 10 % tData.maxPlayer == 1))
            {
                zhongCount++;
            }
            else
