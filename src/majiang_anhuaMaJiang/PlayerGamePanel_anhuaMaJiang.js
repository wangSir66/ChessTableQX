...
//向服务器发送 过消息
MjClient.MJPass2NetForanhuaMaJiang = function()
{
   // console.log(">>>>>>>>>普通  过 <<<<<<<<");
    cc.log("====================send======pass=====");
...
function SetUserVisible_anhuaMaJiang(node, off)
{
    //var sData = MjClient.data.sData;
    //return;
    cc.log("====================off======================" + off);
...
function InitUserHandUI_anhuaMaJiang(node, off)
{
    var sData = MjClient.data.sData;
    var tData = sData.tData;
    var pl = getUIPlayer(off);
...
function initFlower_anhuaMaJiang() {
    initFlower(false, false);
}


var PlayLayer_anhuaMaJiang = cc.Layer.extend({
    jsBind: {
        _event: {
            mjhand: function() {
            ...
            roundEnd: function() {
                ...
                function showEndCards()
                {
                    ...
                    if (getUIPlayer(0).mjState == TableState.roundFinish) {
                        self.addChild(new EndOneView_anhuaMaJiang(),500);
                    } 
                }
...
/*                MjClient.Scene.addChild(new HAHZ_showCardLayer(showCards,function(){
        ...
        roundInfo:{
            ...
            _run:function()
            {
                ...
                str += tData.areaSelectMode.beiShu + "倍底分,"; 
                str += tData.areaSelectMode.kingNum == 7 ? "七王" : "四王"; 
                ...
                str += tData.areaSelectMode.zhongNiaoType == 1 ? ",159中鸟" : "";  //159中鸟 选择为true否则为false
                str += tData.areaSelectMode.wangdaiying   ? ",王代硬"   : "";  //王代硬   选择为true否则为false
                str += tData.areaSelectMode.isDuoHu       ? ",一炮多响" : "";  //一炮多响 选中为true否则为false
                str += tData.areaSelectMode.zhuangxianfen ? ",庄闲分"   : "";  //庄闲分   选择为true否则为false
        ...
        down: {
            ...
            _event: {
                ...
                initSceneData: function(eD) {
                    SetUserVisible_anhuaMaJiang(this, 0);
                ...
                mjhand: function(eD) {
                    ...
                    //{
                        InitUserHandUI_anhuaMaJiang(this, 0);
                    //}
                    //else
                    //{
        ...
        right: {
           ...
           out0: {
            ...
            _event: {
                ...
                initSceneData: function(eD) {
                    SetUserVisible_anhuaMaJiang(this, 1);
                },
                addPlayer: function(eD) {
                    SetUserVisible_anhuaMaJiang(this, 1);
                },
                ...
                showTableEvent: function(isShow){ 
                    InitUserHandUI_anhuaMaJiang(this, 1);
                },
                mjhand: function(eD) {
                    InitUserHandUI_anhuaMaJiang(this, 1);
                },
        ...
        top: {
           ...
           out0: {
            ...
            _event: {
                ...
                initSceneData: function(eD) {
                    SetUserVisible_anhuaMaJiang(this, 2);
                },
                addPlayer: function(eD) {
                    SetUserVisible_anhuaMaJiang(this, 2);
                },
                ...
                mjhand: function(eD) {
                    InitUserHandUI_anhuaMaJiang(this, 2);
                },
                showTableEvent: function(isShow){ 
                    InitUserHandUI_anhuaMaJiang(this, 2);
                },
        ...
        left: {
            ...
            _event: {
                ...
                initSceneData: function(eD) {
                    SetUserVisible_anhuaMaJiang(this, 3);
                },
                addPlayer: function(eD) {
                    SetUserVisible_anhuaMaJiang(this, 3);
                },
                ...
                mjhand: function(eD) {
                    InitUserHandUI_anhuaMaJiang(this, 3);
                },
                showTableEvent: function(isShow){ 
                    InitUserHandUI_anhuaMaJiang(this, 3);
                },
        ...
        eat: {
            ...
            guo: {
                ...
                _touch: function(btn, eT) {
                    if (eT == 2)
                    {
                        MjClient.MJPass2NetForanhuaMaJiang();
                    }
                },
                bgimg: {
                    _run: function() {
            ...
            changeui: {
                ...
                changeuibg: {
                    ...
                    guobg: {
                        guo: {
                            _touch: function(btn, eT) {
                                if (eT == 2) MjClient.MJPass2NetForanhuaMaJiang();
                            }
                        },
                        fanhui: {
                            _touch: function(btn, et) {
    ...
    ctor: function() {
        ...
        var playui = ccs.load("Play_anhuaMaJiang.json");
        playMusic("bgFight");
...
PlayLayer_anhuaMaJiang.prototype.showKaiGangBigCards = function(kaiGangKuang, addnewcard) {
    var tData = MjClient.data.sData.tData;
...
// 显示当前局数增加的分数
PlayLayer_anhuaMaJiang.prototype.NowRoundScore = function(node,off,isShow) { 
    var pl = getUIPlayer(off);
    if(!pl)return; 
...
PlayLayer_anhuaMaJiang.prototype.CardLayoutRestore = function(node, off, isNewCard)
{
...
// 判断吃碰杠胡的状态
PlayLayer_anhuaMaJiang.prototype.EatVisibleCheck = function()
{
    isTouZi_huaihuaMJ = false;
    var eat = MjClient.playui.jsBind.eat;
    ...
    if(tData.tState == TableState.waitPut && pl.mjState == TableState.waitPut)
    {
        if(IsTurnToMe())
        {
            ...
            if(MjClient.majiang.isHunCard(pl.newCd, tData.hunCard) && pl.isTing){
                isSiShou = true;
            }
            // //骰
...
PlayLayer_anhuaMaJiang.prototype.ShowAllTingTips = function ()
{
    if (!MjClient.data.sData.tData.areaSelectMode.isOpenTingTip)
        return;
