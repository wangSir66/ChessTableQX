...
//向服务器发送 过消息
MjClient.MJPass2NetForxiangxiangPHZ = function(){
    cc.log("====================send======pass=====");
...
function SetUserVisible_xiangxiangPHZ(node, off){
    ...
    if(pl){
        ...
        // InitUserHandUI_xiangxiangPHZ(node, off);
...
function InitUserHandUI_xiangxiangPHZ(node, off){
...
var PlayLayer_xiangxiangPHZ = cc.Layer.extend({
    jsBind: {
        _event: {
            mjhand: function() {
            ...
            endRoom: function(msg) {
                ...
                if (msg.showEnd){
                    if(MjClient.getAppType() == MjClient.APP_TYPE.HUNANWANGWANG || MjClient.getAppType() == MjClient.APP_TYPE.QXSYDTZ){
                        ...
                        this.addChild(new GameOverLayer_xiangxiangPHZ(),500);
                    }
                }else{
                ...
                function delayExe(){
                    ...
                    if (sData.tData.roundNum <= 0){
                        ...
                        if(MjClient.getAppType() == MjClient.APP_TYPE.HUNANWANGWANG || MjClient.getAppType() == MjClient.APP_TYPE.QXSYDTZ){
                            ...
                            layer = new GameOverLayer_xiangxiangPHZ();
                        }
                    ...
                    if(!MjClient.endoneui){
                        self.addChild(new EndOneView_xiangxiangPHZ(),500);
                    }
                }
            ...
            _run:function(){
                ...
                if(MjClient.APP_TYPE.QXXXGHZ == MjClient.getAppType()){
                    if(tData.areaSelectMode.hasOwnProperty("zuoZhuang")){
                        str += tData.areaSelectMode.zuoZhuang == 1 ? "/房主庄" : "/随机庄";
                    }
                }
        ...
        down: {
            ...
            _event: {
                ...
                initSceneData: function(eD) {
                    SetUserVisible_xiangxiangPHZ(this, 0);
                    InitUserHandUI_xiangxiangPHZ(this, 0);
        ...
        right: {
            ...
            _event: {
                ...
                initSceneData: function(eD) {
                    ...
                    SetUserVisible_xiangxiangPHZ(this, 1);
                    InitUserHandUI_xiangxiangPHZ(this, 1);
        ...
        left: {
            ...
            _event: {
                ...
                initSceneData: function(eD) {
                    SetUserVisible_xiangxiangPHZ(this, MjClient.MaxPlayerNum_xiangxiang - 1);
                    InitUserHandUI_xiangxiangPHZ(this, MjClient.MaxPlayerNum_xiangxiang - 1);
...
//重置手牌的顺序
PlayLayer_xiangxiangPHZ.prototype.ResetHandCard = function(posNode,off, needAction,  isDelay){
...
PlayLayer_xiangxiangPHZ.prototype._doMovetoAction = function(node,endP){
    node.stopAllActions();
...
//庄家打出第一张牌之后，刷新提垅的牌
PlayLayer_xiangxiangPHZ.prototype.UpdateEatCardsAfterFirst = function(posNode,off){
    var sData = MjClient.data.sData;
    var tData = MjClient.data.sData.tData;
...
PlayLayer_xiangxiangPHZ.prototype.ResetOtherCard = function(posNode,off){
    //添加吃、碰、跑、偎、提
    var sData = MjClient.data.sData;
    var tData = null;
    if(sData){
...
PlayLayer_xiangxiangPHZ.prototype.ResetPutCard = function(posNode,off){
    //添加打出的牌
    var pl = getUIPlayer_xiangxiang(off);
    if (!pl) return;
...
//重置牌的顺序
PlayLayer_xiangxiangPHZ.prototype.CardLayoutRestore = function(posNode,off){
    if(MjClient.rePlayVideo == -1){
...
// 判断吃、碰、跑、偎、提、胡的状态
PlayLayer_xiangxiangPHZ.prototype.EatVisibleCheck = function(off){
    var eat = MjClient.playui.jsBind.eat;
...
PlayLayer_xiangxiangPHZ.prototype.showAndHideHeadEffect = function(){
