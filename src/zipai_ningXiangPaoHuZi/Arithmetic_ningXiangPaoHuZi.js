var majiang_ningXiangPaoHuZiLink = function(majiang) {
...
(function() {
    ...
    huzi.prototype.getTingCards = function(tb, pl, putCard) {
        ...
        for (var uid in tb.players) {
            ...
            for (var i = 0; i < p.mjwei.length; i++) {
                //安化跑胡子只有自己偎的或者别人明偎可见的才加到统计牌里面 （怀化红拐弯和湘潭跑胡子也一样） 还有臭偎
    ...
    if (typeof(MjClient) != "undefined") {
        MjClient.majiang_ningxiangpaohuzi = new huzi();
        majiang_ningXiangPaoHuZiLink(MjClient.majiang_ningxiangpaohuzi);
    }
}());
