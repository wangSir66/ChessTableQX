...
var HomeView_hbqp = cc.Layer.extend({
    ...
    ctor: function () {
        ...
        */
        ...
        for (var i = 0; i < topBtns.length; i ++) {
            setWgtLayout(topBtns[i], [0.06, 0.13], [1, 1.03], [-0.9 - 1.2*i , -0.9]);
        }

        setWgtLayout(this._tileIcon, [0.4, 0.4], [0.36, 0.94], [0, 0]);
    ...
    setGamePanel: function (gamePanelNode) {
        ...
        /*加入房间特效*/
        // var left0 = this._joinRoom.getChildByName("Image_flowerleft0");
        ...
        /* 创建房间特效*/
        // var _creatName = this._createRoom.getChildByName("Image_22");
        ...
        // var _matchNameIcon = goldBtn.getChildByName("Image_23");
        // _matchNameIcon.setLocalZOrder(10);
        // var _light = goldBtn.getChildByName("light");
        // _light.runAction(cc.rotateBy(10,360).repeatForever());

        //
        // //四个角的元宝
        // var gold0 = goldBtn.getChildByName("gold_0");
        // var gold1 = goldBtn.getChildByName("gold_1");
        // var gold2 = goldBtn.getChildByName("gold_2");
        // var gold3 = goldBtn.getChildByName("gold_3");
        //
        ...
        // }
        //
        // gold0.runAction(getMoveAction1(cc.p(10,-10),cc.p(-10,10)));
        // gold1.runAction(getMoveAction1(cc.p(-10,-10),cc.p(10,10)));
        // gold2.runAction(getMoveAction1(cc.p(-8,8),cc.p(8,-8)));
        // gold3.runAction(getMoveAction1(cc.p(6,6),cc.p(-6,-6)));
        // var sprite1 = new cc.Sprite("game_picture/match/liuguang_01.png");
        // sprite1.setBlendFunc(cc.ONE,cc.ONE);
        // sprite1.setOpacity(255*0.9);
        // clipper.addChild(sprite1, 1);
        ...
        //     cc.delayTime(2)
        // ).repeatForever());
        // clipper.addChild(sprite_star2, 5);
        //
        // //樱花
        // var _bisaNode = goldBtn.getChildByName("Panel_star");
        // var _starMatch =  new cc.ParticleSystem("Particle/starMatch.plist");
        // _starMatch.setPosition(goldBtn.getContentSize().width/2, goldBtn.getContentSize().height/2);
        // _starMatch.setScale(1);
        // _starMatch.setTotalParticles(5);
        // _bisaNode.addChild(_starMatch,0);
        /* end of 金币场的特效*/
        // var Image_qianghongbao_gold = goldBtn.getChildByName("Image_qianghongbao_gold");
