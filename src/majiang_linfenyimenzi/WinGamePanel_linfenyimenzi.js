...
function SetEndOneUserUI_linfenyimenzi(node,off)
{
...
var EndOneView_linfenyimenzi = cc.Layer.extend({
	jsBind:{
		block: {
		...
		btnShowHeap:{
                ...
                _click:function()
                {
                	if(MjClient.endoneui){
                       // var linfenyimenziCardsHeap = new PopupShowCardsHeap();
                       // linfenyimenziCardsHeap.setName("linfenyimenziCardsHeap");
                       // MjClient.endoneui.addChild(linfenyimenziCardsHeap);
                    }
                },
            },
		dir: {
		...
		head0:{
		   ...
		   _run:function(){ SetEndOneUserUI_linfenyimenzi(this,0); },
		...
		head1:{
		  ...
		  _run:function(){ SetEndOneUserUI_linfenyimenzi(this,1); }
		},
		head2:{
		   head:{
			   zhuang:{_visible:false}
		   ...
		   _run:function(){ SetEndOneUserUI_linfenyimenzi(this,2); }
		},
		head3:{
			 head:
			 {
			...
			_run:function(){ SetEndOneUserUI_linfenyimenzi(this,3); }
			},
		count_down:{
                _visible :function()
                {
    ...
    ctor:function () {
        this._super();
        var endoneui = ccs.load("endOne_linfenyimenzi.json");
