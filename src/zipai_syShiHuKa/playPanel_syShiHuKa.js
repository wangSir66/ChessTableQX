//新版邵阳十胡卡
var playPanel_syShiHuKa = playLayer_ziPai.extend({
    ctor: function() {
        this._super("Play_shaoYangShiHuKa.json");
    ...
    getJsBind: function() {
        var jsBind = {
            ...
            img_banner: {
                btn_setting: {
                    _click: function() {
                        MjClient.Scene.addChild(new settingPanel_syShiHuKa(), 6000);
...
playPanel_syShiHuKa.prototype.showOrHideJiachuiText = function(node, off) {
    node.visible = false;
    var tData = MjClient.data.sData.tData;
...
//检测距离信息
playPanel_syShiHuKa.prototype.checkCanShowDistance = function(layoutData) {
...
//字牌字体列表
playPanel_syShiHuKa.prototype.getCardFontList = function() {
    return ["type1", "type2", "type3"];
};

//Override
playPanel_syShiHuKa.prototype.getInitDiPaiCount = function() {
    var tData = MjClient.data.sData.tData;
    var diPaiCount = MjClient.majiang.getAllCardsTotal();
    diPaiCount -= tData.areaSelectMode.maiPaiNum;
    diPaiCount = diPaiCount - tData.maxPlayer * 20;
    return diPaiCount;
};

//Override
playPanel_syShiHuKa.prototype.checkChuiFlagVisible = function(node) {
...
//Override 
playPanel_syShiHuKa.prototype.initSettingData = function() {
...
//Override
playPanel_syShiHuKa.prototype.isShowLongCard = function() {
    return true;
};

playPanel_syShiHuKa.prototype.isCheckTingStats = function() {
    return true;
}

//获取听的牌
playPanel_syShiHuKa.prototype.getTingCards = function(sData, pl, putCard) {
...
playPanel_syShiHuKa.prototype.changeEatBtnLayout = function(btnNode, len, idx) {
    var scale = 0.20;
    if(MjClient.getAppType() == MjClient.APP_TYPE.HUNANWANGWANG || MjClient.getAppType() == MjClient.APP_TYPE.QXSYDTZ){
