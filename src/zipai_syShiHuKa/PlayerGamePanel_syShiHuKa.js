...
function SetUserVisible_syShiHuKa(node, off){
...
function InitUserHandUI_syShiHuKa(node, off){
...
var PlayLayer_syShiHuKa = cc.Layer.extend({
    jsBind: {
        _event: {
                ...
                _event:{
                    initSceneData:function(){
                        ...
                        if(next <= 0){
                           ...
                           var maipai = tData.areaSelectMode.isMaiPai ? 20 : 0;
                           next -= maipai;
        ...
        down: {
            ...
            _event: {
                ...
                initSceneData: function(eD) {
                    SetUserVisible_syShiHuKa(this, 0);
                    InitUserHandUI_syShiHuKa(this, 0);
        ...
        right: {
            ...
            _event: {
                ...
                initSceneData: function(eD) {
                    SetUserVisible_syShiHuKa(this, 1);
                    InitUserHandUI_syShiHuKa(this, 1);
        ...
        left: {
            ...
            _event: {
                ...
                initSceneData: function(eD) {
                    SetUserVisible_syShiHuKa(this, MjClient.MaxPlayerNum_leiyang - 1);
                    InitUserHandUI_syShiHuKa(this, MjClient.MaxPlayerNum_leiyang - 1);
...
//重置手牌的顺序
PlayLayer_syShiHuKa.prototype.ResetHandCard = function(posNode,off, needAction, isDelay){
...
PlayLayer_syShiHuKa.prototype._doMovetoAction = function(node,endP){
    node.stopAllActions();
    var ac = cc.moveTo(0.3,endP);
    node.runAction(ac);
};

PlayLayer_syShiHuKa.prototype.ResetOtherCard = function(posNode, off) {
    //添加吃、碰、跑、偎、提
    var sData = MjClient.data.sData;
    var tData = null;
    if (sData) {
...
PlayLayer_syShiHuKa.prototype.ResetPutCard = function(posNode,off){
    //添加打出的牌
    var pl = getUIPlayer_hengYang(off);
...
//重置牌的顺序
PlayLayer_syShiHuKa.prototype.CardLayoutRestore = function(posNode,off){
    if(MjClient.rePlayVideo == -1){
...
// 判断吃、碰、跑、偎、提、胡的状态
PlayLayer_syShiHuKa.prototype.EatVisibleCheck = function(off){
    var eat = MjClient.playui.jsBind.eat;
...
PlayLayer_syShiHuKa.prototype.showAndHideHeadEffect = function(){
