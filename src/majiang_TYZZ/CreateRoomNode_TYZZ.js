...
var CreateRoomNode_TYZZ = CreateRoomNode.extend({
    ...
    initPlayNode: function() {
        ...
        var playerNumCallBack = function(index, sender, list){
            ...
            if(_play.getChildByName("play_queYiMen")){
                this._playNode_queyimen.visible = (index == 2 || index == 3);
            }
        }.bind(this);
        ...
        this.schedule(function() {
            ...
            {
                this.nodeListFanBei[i].y = -815 + offset;
            }
            this.text_fanbei.y = -676 + offset;

            for(var i = 0;i < this.tingTipList.length;i++)
            {
                this.tingTipList[i].y = -875 + offset;
            }
            this.text_tishi.y = -736 + offset;
        }.bind(this));
    },
    ...
    getSelectedPara: function() {
        ...
        if (!this._isFriendCard) {
            ...
            util.localStorageEncrypt.setNumberItem(this.localStorageKey.KEY_TYZZ_maxPlayer, para.convertible ? 0 : para.maxPlayer);
