...
var HomeView_txlvliangmj = cc.Layer.extend({
    ...
    ctor: function () {
        ...
        //右上角的帮助按钮,
        var _BtnHTP = _bottom_bg.getChildByName("BtnHTP");
        ...
        //邮件
        this._youjian = _bottom_bg.getChildByName("youjian");
        ...
        setWgtLayout(_btnmoreGame, [0.145, 0.145], [0.58 + 0.093, 0.90], [0,0]);
        setWgtLayout(_btntuijian,  [0.145, 0.145], [0.58 + 0.093*2, 0.90], [0,0]);
        setWgtLayout(_btnShareGet, [0.145, 0.145], [0.58 + 0.093*3, 0.90], [0,0]);
        setWgtLayout(_setting,     [0.145, 0.145], [0.58 + 0.093*4, 0.90], [0,0]);
