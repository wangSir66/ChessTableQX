...
var PlayLayer_doudizhuDaTong = cc.Layer.extend({
    ctor: function () {
        this._super();
        var playui = ccs.load(res.Play_doudizhuDaTong_json);
...
//出牌提示
PlayLayer_doudizhuDaTong.prototype.showTipCards = function () {
...
// 处理斗地主智能提牌
PlayLayer_doudizhuDaTong.prototype.handleDoudizhuCardsAutoUp = function (bTouchMove) {
    if (!this.isSDataValid()) {
        return ;
    }
    var tData = MjClient.data.sData.tData;
...
PlayLayer_doudizhuDaTong.prototype.handleCardsTouchListener = function () {
    return {
...
// 处理点击
PlayLayer_doudizhuDaTong.prototype.handleTouchCards = function (touch, event, isBegan) {
...
// 处理玩家提起提起得牌，保留正确的牌
PlayLayer_doudizhuDaTong.prototype.handleUpRightCards = function (isFirst, off) {
    if (isFirst) {
        return;
    }
...
// =========================[[ 流程 ]] =========================
// 断线重连/初始化
PlayLayer_doudizhuDaTong.prototype.dealInitSceneData = function () {
    if (!this.isSDataValid()) {
        return ;
    }
    var tData = MjClient.data.sData.tData;
    var tState = tData.tState;
    cc.log("dealinitscenedata++++++++" + tState);
    MjClient.playui.initData(tState == TableState.roundFinish ? true : false);
...
PlayLayer_doudizhuDaTong.prototype.dealChangePKImg = function () {
...
// 结算
PlayLayer_doudizhuDaTong.prototype.dealRoundEnd = function (eD) {
    if (!this.isSDataValid()) {
        return ;
    }
    ...
    function delayExe() {
        ...
        self.addChild(new EndOneView_doudizhuDaTong(zhuang), 500);
    }
...
// 过、准备
PlayLayer_doudizhuDaTong.prototype.dealPKPass = function (eD) {
    MjClient.playui.killTimeClock();
    MjClient.clockNode.visible = false;
...
// 出牌
PlayLayer_doudizhuDaTong.prototype.dealPKPut = function (msg) {
    cc.log("----------dealpkput");
    var tData = MjClient.data.sData.tData;
    tData.rate = msg.rate;
...
// 等待出牌
PlayLayer_doudizhuDaTong.prototype.dealWaitPut = function (eD) {
    var tData = MjClient.data.sData.tData;
...
// 等待叫地主
PlayLayer_doudizhuDaTong.prototype.dealWaitJiaodizhu = function (msg) {
    var sData = MjClient.data.sData;
    var tData = sData.tData;
...
// 抢地主
PlayLayer_doudizhuDaTong.prototype.dealQiangDizhu = function (msg) {
    var tData = MjClient.data.sData.tData;
...
// 等待准备
PlayLayer_doudizhuDaTong.prototype.dealAllReady = function (bAllReady) {
    for (var i = 0; i < this.headOffLen; i++) {
        var off = this.headOffArr[i];
...
// 加倍
PlayLayer_doudizhuDaTong.prototype.dealMJJiazhu = function (isSceneData, off, jiazhuNum, curPlayer) {
    var tData = MjClient.data.sData.tData;
...
// 等待加倍
PlayLayer_doudizhuDaTong.prototype.dealWaitJiazhu = function (eD) {
    var tData = MjClient.data.sData.tData;
...
// 处理手牌
PlayLayer_doudizhuDaTong.prototype.handleMjHand = function () {
...
// 处理底牌
PlayLayer_doudizhuDaTong.prototype.dealDiCards = function (zhuang, diCards, handCounts, isAddCards, isIconMove) {
    var tData = MjClient.data.sData.tData;
    tData.zhuang = zhuang;
...
PlayLayer_doudizhuDaTong.prototype.updateUserHeadPosition = function (off, bRoundEnd) {
...
PlayLayer_doudizhuDaTong.prototype.updateTimes = function () {
...
//设置地区信息
PlayLayer_doudizhuDaTong.prototype.showGameName = function () {
...
//添加还背景的功能
PlayLayer_doudizhuDaTong.prototype.addChangeBg = function () {
...
PlayLayer_doudizhuDaTong.prototype.showVoice = function () {
...
PlayLayer_doudizhuDaTong.prototype.addWaitNode = function () {
...
PlayLayer_doudizhuDaTong.prototype.setWaitNodeVisible = function (bVisible) {
...
PlayLayer_doudizhuDaTong.prototype.addAniLayer = function () {
...
PlayLayer_doudizhuDaTong.prototype.showTableID = function (bShow) {
...
PlayLayer_doudizhuDaTong.prototype.setHLJiabeiVisible = function (bVisible) {
...
// 出牌按钮
PlayLayer_doudizhuDaTong.prototype.handlePutCardBtn = function (isVisible, isFirst) {
...
PlayLayer_doudizhuDaTong.prototype.enablePutCardBtn = function (bAble) {
    var btnPutCard = this.node.getChildByName("BtnPutCard");
...
//操作按钮(提示和不出) 
PlayLayer_doudizhuDaTong.prototype.handleHimtAndNoPutBtn = function (isVisible, isAble) {
...
//经典斗地主叫分按钮
PlayLayer_doudizhuDaTong.prototype.setJingDianBtnVisible = function (bVisible, buJiaoAble, score, bmustjiao) {
...
//欢乐斗地主叫分按钮
PlayLayer_doudizhuDaTong.prototype.setHuanLeBtnVisible = function (bVisible) {
...
// 牌局信息
PlayLayer_doudizhuDaTong.prototype.showRoundInfo = function () {
    if (!this.isSDataValid()) {
        return ;
    }
...
// 局数
PlayLayer_doudizhuDaTong.prototype.updateGameRound = function () {
...
// 加倍
PlayLayer_doudizhuDaTong.prototype.setTextMult = function (bShow) {
...
//加倍
PlayLayer_doudizhuDaTong.prototype.handleJiabeiTag = function (off, type) {
    var node = getNode_cards(off);
...
// 底分
PlayLayer_doudizhuDaTong.prototype.handleDifen = function () {
...
// 不抢/抢地主
PlayLayer_doudizhuDaTong.prototype.dealQiangDizhuText = function (off, visible, msg) {
    var node = getNode_cards(off);
    var diZhuTag = node.getChildByName("jiaodizhuTag");
...
// 要不起
PlayLayer_doudizhuDaTong.prototype.handleNoPutTag = function (off, visible) {
    var node = getNode_cards(off);
...
// 没有大过上家
PlayLayer_doudizhuDaTong.prototype.handleNoPutTips = function (isVisible) {
...
// 没有大过上家
PlayLayer_doudizhuDaTong.prototype.handlePassBtn = function (isVisible) {
...
// =========================[[ 系统 ]] ==========================
PlayLayer_doudizhuDaTong.prototype.dealSendVoice = function (fullFilePath) {
    if (!fullFilePath) {
...
PlayLayer_doudizhuDaTong.prototype.dealDownAndPlayVoice = function (msg) {
...
PlayLayer_doudizhuDaTong.prototype.dealUploadRecord = function (filePath) {
    if (filePath) {
...
// 绘制手牌
PlayLayer_doudizhuDaTong.prototype.initUserHandUiDoudizhu = function (off) {
    var pl = getUIPlayer(off);
    if (pl == null) {
        return;
    }
...
//处理出牌,打牌动作
PlayLayer_doudizhuDaTong.prototype.dealPKPutcard = function (off, msg) {
    var sData = MjClient.data.sData;
    var tData = sData.tData;
...
PlayLayer_doudizhuDaTong.prototype.playAnimation = function (cards, off) {
    var pl = getUIPlayer(off);
    if (!pl) { return ; }
...
// 增加底牌
PlayLayer_doudizhuDaTong.prototype.addDiCardsToZhuang = function (zhuangOff) {
    var tData = MjClient.data.sData.tData;
...
// 处理准备字准备相关
PlayLayer_doudizhuDaTong.prototype.handleAboutReady = function (off,bAllReady) {
...
PlayLayer_doudizhuDaTong.prototype.startTimeClock = function (func) {
...
PlayLayer_doudizhuDaTong.prototype.killTimeClock = function () {
    MjClient.clockNode.getChildByName("number").stopAllActions();
    stopEffect(playTimeUpEff);
    playTimeUpEff = null;
};

PlayLayer_doudizhuDaTong.prototype.clockNumberUpdate = function (node, endFunc) {
    return arrowbkNumberUpdate(node, endFunc);
}

PlayLayer_doudizhuDaTong.prototype.checkRoomUiDelete = function () {
...
PlayLayer_doudizhuDaTong.prototype.showGps = function () {
...
// 地主的三张牌
PlayLayer_doudizhuDaTong.prototype.handleDoudizhuDiCards = function () {
...
PlayLayer_doudizhuDaTong.prototype.dealMJTick = function (eD) {
    for (var i = 0; i < this.headOffLen; i++) {
        var off = this.headOffArr[i];
        var pl = getUIPlayer(off);
        if (!pl) { continue; }
...
PlayLayer_doudizhuDaTong.prototype.dealLogout = function () {
    if (MjClient.playui) {
...
PlayLayer_doudizhuDaTong.prototype.dealEndRoom = function (msg) {
...
PlayLayer_doudizhuDaTong.prototype.dealLeaveGame = function () {
    MjClient.playui.killTimeClock();
    MjClient.addHomeView();
    MjClient.playui.removeFromParent(true);
    delete MjClient.playui;
...
PlayLayer_doudizhuDaTong.prototype.dealLoadWxHead = function (eD) {
    for (var i = 0; i < this.headOffLen; i++) {
        var off = this.headOffArr[i];
...
PlayLayer_doudizhuDaTong.prototype.dealPlayVoice = function (msg) {
    for (var i = 0; i < this.headOffLen; i++) {
        var off = this.headOffArr[i];
...
PlayLayer_doudizhuDaTong.prototype.dealChangeGameBgEvent = function () {
...
PlayLayer_doudizhuDaTong.prototype.handlePlayerChange = function (action, uid) {
    if (!this.isSDataValid()) {
        return ;
    }
    var targetOff = -1;
...
PlayLayer_doudizhuDaTong.prototype.dealMoveHead = function () {
    var that =this;
    var fun1 = function (){
...
// =========================[[ 消息 ]] ===========================
// 加倍
PlayLayer_doudizhuDaTong.prototype.sendJiaBeiToServer = function (beishu) {
    MjClient.playui.setHLJiabeiVisible(false);
    MjClient.gamenet.request("pkroom.handler.tableMsg", {
        cmd: "MJJiazhu",
        jiazhuNum: beishu,
...
// 叫地主、不叫、叫分
PlayLayer_doudizhuDaTong.prototype.sendQiangdizhuToServer = function (bQiang) {
    MjClient.playui.setJingDianBtnVisible(false);
    MjClient.playui.setHuanLeBtnVisible(false);
    MjClient.gamenet.request("pkroom.handler.tableMsg", {
        cmd: "Qiangdizhu",
...
// 出牌
PlayLayer_doudizhuDaTong.prototype.sendPutCardsToServer = function () {
    if (this.isCardsSend) {
        return;
    }
    ;
...
// 准备-1， 提示过牌0， 不出 1
PlayLayer_doudizhuDaTong.prototype.sendPassToServer = function (isActivePass) {
    this.handCardsWgetArr[0].clearCardsUpStatus();
...
// =========================[[ 初始化 ]] ==========================
PlayLayer_doudizhuDaTong.prototype.initTagList = function () {
    this.btnTagList = {
        BtnPutCard: 1,
        BtnHimt: 2,
        BtnNoPut: 3,
...
PlayLayer_doudizhuDaTong.prototype.initData = function (isRoundEnd) {
    this.cardTipsArr = [];
    this.tipsIdx = 0;
...
PlayLayer_doudizhuDaTong.prototype.initOnce = function () {
...
PlayLayer_doudizhuDaTong.prototype.hideAllUI = function () {
...
PlayLayer_doudizhuDaTong.prototype.initUI = function () {
...
// 初始化节点
PlayLayer_doudizhuDaTong.prototype.initHeadWget = function () {
    this.headOffArr = [];
    this.headNode = {};
    this.AniMotion = [];
...
//初始化玩家信息
PlayLayer_doudizhuDaTong.prototype.initMsgEvent = function () {
    // ================ 重连 =========================
...
PlayLayer_doudizhuDaTong.prototype.initClickEvent = function () {
...
PlayLayer_doudizhuDaTong.prototype.btnBindCallBack = function (parent, str, tag, callback) {
    var tmpNode = parent.getChildByName(str);
    tmpNode.tag = tag;
    tmpNode.addTouchEventListener(callback);
};

PlayLayer_doudizhuDaTong.prototype.btnEventListener = function (sender, type) {
...
// 初始化时钟节点
PlayLayer_doudizhuDaTong.prototype.initClockWget = function () {
    for (var off = 0; off < 4; off++) {
        var _node = getNode(off);
...
PlayLayer_doudizhuDaTong.prototype.isSDataValid = function() {
    var sData = MjClient.data.sData;
