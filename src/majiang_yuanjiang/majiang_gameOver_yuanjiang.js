var GameOverLayer_maJiang_pingjiangzhaniao = majiang_gameOver.extend({
    _jsBind:{
        bgBox:{
...
GameOverLayer_maJiang_pingjiangzhaniao.prototype.getEndallStatisticsName = function(pl) {  
    return pl.roomStatistics || [];
};

GameOverLayer_maJiang_pingjiangzhaniao.prototype.getEndallStatisticsKey = function(pl) {  
    return pl.roomStatisticsDesc || ["自摸次数","点炮次数","暗杠次数","明杠次数","大胡次数","小胡次数"];
};
// 设置房间统计内容
GameOverLayer_maJiang_pingjiangzhaniao.prototype.setRoomStatistics = function(layout_typeText,pl) { 
