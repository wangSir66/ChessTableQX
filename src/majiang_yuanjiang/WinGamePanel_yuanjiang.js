...
function SetEndOneUserUI_yuanjiang(node,off)
{
	...
	var uibind= {
        ...
        tip:{
        	_run:function()
        	{
        		 if(pl.isXiInfo)
        		{
        			this.loadTexture("gameOver/youxi.png");
        			this.visible = true;
        		}
        		else
        		{
...
var EndOneView_yuanjiang = cc.Layer.extend({
	jsBind:{
		block: {
		...
		head0:{
		   ...
		   _run:function(){ SetEndOneUserUI_yuanjiang(this,0); },
		...
		,head1:{ 
		  ...
		  _run:function(){ SetEndOneUserUI_yuanjiang(this,1); }
		}
		...
		,head2:{ 
		   ...
		   _run:function(){ SetEndOneUserUI_yuanjiang(this,2); }
		}
		,head3:{
			 head:
			 {
			...
			_run:function(){ SetEndOneUserUI_yuanjiang(this,3); }
			},
            count_down:{
                _visible :function()
                {
    ...
    ctor:function () {
		...
		var endoneui = ccs.load("endOne_yuanjiang.json");
...
//是否可以码牌
EndOneView_yuanjiang.prototype.isCanShuffleCards = function(){
	return true;
};

// 准备按钮点击事件
EndOneView_yuanjiang.prototype.btnReadyEvent = function(){ 
	var sData=MjClient.data.sData;
	var tData=sData.tData;
...
// 分享按钮点击事件
EndOneView_yuanjiang.prototype.btnShareEevent = function(btn){
    var tData = MjClient.data.sData.tData;
