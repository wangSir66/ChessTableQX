...
//向服务器发送 过消息
MjClient.MJPass2NetForHuaianERZ = function()
{
   // console.log(">>>>>>>>>普通  过 <<<<<<<<");
    cc.log("====================send======pass=====");
...
function SetUserVisible_huaianERZ(node, off)
{
    //var sData = MjClient.data.sData;
    //return;
    cc.log("====================off======================" + off);
...
function InitUserHandUI_huaianERZ(node, off)
{
    var sData = MjClient.data.sData;
    var tData = sData.tData;
    var pl = getUIPlayer(off);
...
function initFlower_huaianERZ() {
    initFlower(false, false);
}


var PlayLayer_huaianERZ = cc.Layer.extend({
    jsBind: {
        _event: {
            mjhand: function() {
            ...
            roundEnd: function() {
                ...
                function delayExe()
                {
                    ...
                    self.addChild(new EndOneView_huaianERZ(),500);
                }
        ...
        down: {
            ...
            _event: {
                ...
                initSceneData: function(eD) {
                    SetUserVisible_huaianERZ(this, 0);
                },
                addPlayer: function(eD) {
                    SetUserVisible_huaianERZ(this, 0);
                },
                ...
                mjhand: function(eD) {
                    InitUserHandUI_huaianERZ(this, 0);
                },
                roundEnd: function() {
        ...
        right: {
            ...
            _event: {
                ...
                initSceneData: function(eD) {
                    SetUserVisible_huaianERZ(this, 1);
                },
                addPlayer: function(eD) {
                    SetUserVisible_huaianERZ(this, 1);
                },
                ...
                mjhand: function(eD) {
                    InitUserHandUI_huaianERZ(this, 1);
                },
                roundEnd: function() {
        ...
        top: {
            ...
            _event: {
                ...
                initSceneData: function(eD) {
                    SetUserVisible_huaianERZ(this, 2);
                },
                addPlayer: function(eD) {
                    SetUserVisible_huaianERZ(this, 2);
                },
                ...
                mjhand: function(eD) {
                    InitUserHandUI_huaianERZ(this, 2);
                },
                roundEnd: function() {
        ...
        left: {
            ...
            _event: {
                ...
                initSceneData: function(eD) {
                    SetUserVisible_huaianERZ(this, 3);
                },
                addPlayer: function(eD) {
                    SetUserVisible_huaianERZ(this, 3);
                },
                ...
                mjhand: function(eD) {
                    InitUserHandUI_huaianERZ(this, 3);
                },
                roundEnd: function() {
        ...
        eat: {
            ...
            guo: {
                ...
                _touch: function(btn, eT) {
                    if (eT == 2)
                    {
                        MjClient.MJPass2NetForHuaianERZ();
                    }
                },
                bgimg: {
                    _run: function() {
            ...
            changeui: {
                ...
                changeuibg: {
                    ...
                    guobg: {
                        guo: {
                            _touch: function(btn, eT) {
                                if (eT == 2) MjClient.MJPass2NetForHuaianERZ();
                            }
                        },
                        fanhui: {
                            _touch: function(btn, et) {
    ...
    ctor: function() {
        ...
        var playui = ccs.load(res.Play_huaianERZ_json);
        playMusic("bgFight");
    ...
    */
    ...
    {
        var idx = MjClient.data.sData.tData.uids.indexOf(eD.uid);
        if (getOffByIndex(idx) == off) {
            return true;
        } else {
            return false;
        }
...
PlayLayer_huaianERZ.prototype.CardLayoutRestore = function(node, off)
{
...
// 判断吃碰杠胡的状态
PlayLayer_huaianERZ.prototype.EatVisibleCheck = function()
{
    var eat = MjClient.playui.jsBind.eat;
