...
//向服务器发送 过消息
MjClient.MJPass2NetForhaianbaida = function()
{
   // console.log(">>>>>>>>>普通  过 <<<<<<<<");
    cc.log("====================send======pass=====");
...
function showShaiziAni_haianbaida(poff)
{
    if(poff == 0) {
        ...
        function showHunAni()
        {
            ...
            MjClient.playui._hunCardImg.visible = true;
            MjClient.playui._hunCardImg.setScale(1);
            MjClient.playui._hunCardImg.setPosition(-296,-280);
            var HuncardMsg = MjClient.data.sData.tData.fanCard;

            var func = cc.callFunc(function(){
                playEffect("hunCardFly");
            });

            setCardSprite(MjClient.playui._hunCardImg, parseInt(HuncardMsg), 4);
            var imgMing = new ccui.ImageView();
            imgMing.loadTexture("playing/MJ/ming.png");
            imgMing.setPosition(MjClient.playui._hunCardImg.getContentSize().width/2,MjClient.playui._hunCardImg.getContentSize().height/2);
            MjClient.playui._hunCardImg.addChild(imgMing,1000);
            MjClient.playui._hunCardImg.runAction(cc.sequence(cc.delayTime(1),
        ...
        if(MjClient.rePlayVideo != -1 )//回放
        {
            for (var off = 0; off < 4; off++) {
                ...
                InitUserHandUI_haianbaida(_node, off);
            }
            playEffect("shuffle");
        ...
        firstFrame.runAction(cc.sequence(playSoundFunc, animate,showPonitFunc,cc.delayTime(0.8),cc.callFunc(function(){
            ...
            if(COMMON_UI3D.is3DUI()) {
                ...
                var baidaImg = MjClient.playui._hunCardImg;
                var HuncardMsg = MjClient.data.sData.tData.fanCard;
                if(HuncardMsg && baidaImg) {
                    setCardSprite(baidaImg, parseInt(HuncardMsg), 4);
                    var imgMing = new ccui.ImageView();
                    imgMing.loadTexture("playing/MJ/ming.png");
                    imgMing.setPosition(baidaImg.getContentSize().width/2,baidaImg.getContentSize().height/2);
                    baidaImg.addChild(imgMing, 100);
                }
            } else {
                setHunNodeVisible(true);
                showHunAni();
...
function SetUserVisible_haianbaida(node, off)
{
    /*摇色子，断网重连手牌异常bug*/
    var _AniNode = MjClient.playui._AniNode;
    ...
    if(pl)
    {
        cc.log("====================SetUserVisible_haianbaida======================" + off);
        head.visible = true;
        name.visible = true;
        coin.visible = true;
...
function InitUserHandUI_haianbaida(node, off)
{
    var sData = MjClient.data.sData;
    var tData = sData.tData;
    var pl = getUIPlayer(off);
    cc.log("--------InitUserHandUI_haianbaida  off = " + off);
    cc.log("--------InitUserHandUI_haianbaida  pl = " + JSON.stringify(pl));
    if(!pl)
    {
        return;
    }
    ...
    setHunNodeVisible(false);
    var HunCardMsg = tData.fanCard;
    if(HunCardMsg) setHunNodeVisible(true);
...
function initFlower_haianbaida() {
    initFlower(false, false);
}


var PlayLayer_haianbaida = cc.Layer.extend({
    jsBind: {
        _event: {
            mjhand: function() {
                ...
                function delayExe()
                {
                    ...
                    if (sData.tData.roundNum <= 0)
                    {
                        if(!tData.matchId){
                            ...
                            self.runAction(cc.sequence(cc.delayTime(1.5),cc.callFunc(function(){
                                self.addChild(new GameOverLayer(),500);
                            })))
                        }
                    }
                    self.addChild(new EndOneView_haianbaida(),500);
                }
        ...
        down: {
            ...
            tingCardNumNode: {
                ...
                _event: {
                    clearCardUI: function(eD) {
                        ...
                        {
                            MjClient.playui._AniNode.removeChildByName("quanTingPaiIcon");
                        }
                    },
                    MJHu: function(eD) {
                        this.visible = false;
                    ...
                    initSceneData: function(eD) {
                        var pl = getUIPlayer(0);
                        if(MjClient.data.sData.tData.hunCard && pl.mjhand && MjClient.majiang.quantingpai(pl.mjhand,MjClient.data.sData.tData))
                        {
            ...
            _event: {
                ...
                initSceneData: function(eD) {
                    SetUserVisible_haianbaida(this, 0);
                },
                addPlayer: function(eD) {
                    SetUserVisible_haianbaida(this, 0);
                },
                ...
                mjhand: function(eD) {
                    cc.log("---showShaiziAni_haianbaida-------....mjhand");
                    showShaiziAni_haianbaida(0);
                },
                roundEnd: function() {
                ...
                MJPut: function(eD) {
                    ...
                    if (eD.uid == SelfUid())
                    {
                        ...
                        var tingSet = calTingSet(pl.mjhand, MjClient.data.sData.tData);
        ...
        right: {
            ...
            _event: {
                ...
                initSceneData: function(eD) {
                    SetUserVisible_haianbaida(this, 1);
                },
                addPlayer: function(eD) {
                    SetUserVisible_haianbaida(this, 1);
                },
        ...
        top: {
            ...
            _event: {
                ...
                initSceneData: function(eD) {
                    SetUserVisible_haianbaida(this, 2);
                },
                addPlayer: function(eD) {
                    SetUserVisible_haianbaida(this, 2);
                },
        ...
        left: {
            ...
            _event: {
                ...
                initSceneData: function(eD) {
                    SetUserVisible_haianbaida(this, 3);
                },
                addPlayer: function(eD) {
                    SetUserVisible_haianbaida(this, 3);
                },
        ...
        eat: {
            ...
            guo: {
                ...
                _touch: function(btn, eT) {
                    if (eT == 2)
                    {
                        MjClient.MJPass2NetForhaianbaida();
                    }
                },
                bgimg: {
                    _run: function() {
            ...
            changeui: {
                ...
                changeuibg: {
                    ...
                    guobg: {
                        guo: {
                            _touch: function(btn, eT) {
                                if (eT == 2) MjClient.MJPass2NetForhaianbaida();
                            }
                        },
                        fanhui: {
                            _touch: function(btn, et) {
    ...
    ctor: function() {
        ...
        this._hunCardImg = playui.node.getChildByName("banner").getChildByName("hunPai").getChildByName("baidaImg");
...
PlayLayer_haianbaida.prototype.CardLayoutRestore = function(node, off)
{
    ...
    if (pl.mjhand && pl.mjhand.length > 0)
    {
        ...
        if(count == 14 && mjhandNum == pl.mjhand.length)
        {
            ...
            else
            {
                ...
                {
                    if(MjClient.data.sData.tData.hunCard.indexOf(a) >= 0)
                    {
                        return -1;
                    }
                    else if (MjClient.data.sData.tData.hunCard.indexOf(b) >= 0)
                    {
                        return 1;
                    }
                    else
    ...
    for(var i = 0; i < children.length; i++) //children 为 "down" 节点下的字节点
    {
        ...
        if(ci.name == "mjhand")
        {
            ...
            {
                if(MjClient.data.sData.tData.hunCard.indexOf(ci.tag) >= 0)
                {
                    uihun.push(ci);
                }
                else
...
// 判断吃碰杠胡的状态
PlayLayer_haianbaida.prototype.EatVisibleCheck = function()
{
    if(_isAniShow_Haian) return;
    var eat = MjClient.playui.jsBind.eat;
    ...
    if(tData.tState == TableState.waitPut && pl.mjState == TableState.waitPut)
    {
        if(IsTurnToMe())
        {
            ...
            {
                if(cduis[i].name == "mjhand" && MjClient.majiang.isCardFlower(cduis[i].tag, tData) && pl.isNew)
                {
                    // var callback = function () {
...
PlayLayer_haianbaida.prototype.showQuanTingPai = function()
{
    if(!MjClient.playui._AniNode.getChildByName("quanTingPaiIcon"))
    {
