...
function SetEndOneUserUI_haianbaida(node,off)
{
    ...
    var maizhuangIcon = node.getChildByName("maizhuangicon");
	...
	var uibind= {
        ...
        */
        ...
        for(var i = 0;i < cards.length;i++)
        {
            ...
            _node.setPosition(cc.p(_flowerUp.x + slotwith*i,_flowerUp.y*1.3));
...
var EndOneView_haianbaida = cc.Layer.extend({
	jsBind:{
		block: {
		...
		head0:{
		   ...
		   _run:function(){ SetEndOneUserUI_haianbaida(this,0); },
		...
		,head1:{ 
		  ...
		  _run:function(){ SetEndOneUserUI_haianbaida(this,1); }
		}
		...
		,head2:{ 
		   ...
		   _run:function(){ SetEndOneUserUI_haianbaida(this,2); }
		}
		,head3:{
			 head:
			 {
			...
			_run:function(){ SetEndOneUserUI_haianbaida(this,3); }
			},
            count_down:{
                _visible :function()
                {
    ...
    ctor:function () {
        this._super();
        var endoneui = ccs.load(res.EndOne_haianbaida_json);
