function SetGameOverLayer_NanXianGuiHuZi(node,off,isNewUi){
    ...
    setOfflineShow_NanXianGuiHuZi(head, pl);
...
var GameOverLayer_NanXianGuiHuZi = cc.Layer.extend({
    sprite:null,
    jsBind:{
        back:{
            share:{
    ...
    ctor:function () {
        ...
        var endallui = ccs.load("endAll_nanXianGuiHuZi.json");
        ...
        function _infoText(){
            ...
            text += "房间号:" + roomID + "," + getRoundInfo_NanXianGuiHuZi();
        ...
        for(var i = 0 ; i < playerCount ; i++){
            ...
            SetGameOverLayer_NanXianGuiHuZi(clone,i, isNewUi);
