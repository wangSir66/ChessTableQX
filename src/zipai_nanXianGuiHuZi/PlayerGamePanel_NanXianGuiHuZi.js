...
//     }else{
//         HZPassConfirmToServer_NanXianGuiHuZi();
//     }
// };

// 这个没看懂干嘛的
// off 是四个位置，根据off 显示四个位置的信息 by sking
function SetUserVisible_NanXianGuiHuZi(node, off){
    ...
    if(pl){
        ...
        setUserOffline_NanXianGuiHuZi(node, off);
        // InitUserHandUI_NanXianGuiHuZi(node, off);
...
function InitUserHandUI_NanXianGuiHuZi(node, off){
    ...
    if (pl.jiazhuNum == 2 && MjClient.rePlayVideo == -1)
    {
        ...
        MjClient.majiang.setJiaZhuNum(node, getUIPlayer_NanXianGuiHuZi(off));
    }
...
var PlayLayer_NanXianGuiHuZi = cc.Layer.extend({
    jsBind: {
        _event: {
            mjhand: function() {
            ...
            endRoom: function(msg) {
                ...
                if (msg.showEnd){
                    this.addChild(new GameOverLayer_NanXianGuiHuZi(),500);
                }else{
            ...
            roundEnd: function() {
                ...
                if(!MjClient.isDismiss && tData.hunCard && tData.hunCard != -1 && tData.areaSelectMode.xingType==2){
                    ...
                    ShowEatActionAnim_NanXianGuiHuZi(MjClient.playui._downNode, ActionType_paohuzi.FANXING, 0);
                    DealFanXingNewCard_NanXianGuiHuZi(hunCard);
                }
                ...
                function delayExe(){
                    ...
                    if (sData.tData.roundNum <= 0){
                        var layer = new GameOverLayer_NanXianGuiHuZi();
                        layer.setVisible(false);
                        self.addChild(layer,500);
                    }
                    if(!MjClient.endoneui){
                        self.addChild(new EndOneView_NanXianGuiHuZi(),500);
                    }
            ...
            moveHead: function() {
                ...
                //tableStartHeadMoveAction_NanXianGuiHuZi(this);   //不涉及到头像移动动作
            },
            initSceneData: function() {
                ...
                reConectHeadLayout_NanXianGuiHuZi(this);        //不涉及到头像移动动作
                CheckRoomUiDelete();
                tableStartHeadMoveAction_NanXianGuiHuZi(this);   //不涉及到头像移动动作
            ...
            changeMJBgEvent: function() {
                changeMJBg_NanXianGuiHuZi(this, ziPai.getZiPaiType());
            },
            MJPeng: function() {
                MjClient.playui.showAndHideHeadEffect();
            },
            ...
            EZP_layout : function(){
                if(MjClient.data.sData.tData.maxPlayer < 4){
                    ...
                    if(IsArrowVisible_NanXianGuiHuZi()){
                        ...
                        MjClient.playui.ResetPutCard(MjClient.playui._rightNode, MjClient.MaxPlayerNum_NanXianGuiHuZi - 2);
                        MjClient.playui.ResetPutCard(MjClient.playui._topNode, MjClient.MaxPlayerNum_NanXianGuiHuZi - 1);
                    }
                }
        ...
        cardNumImg: {
            ...
            _event: {
                initSceneData: function(eD) {
                    this.visible = IsArrowVisible_NanXianGuiHuZi();
                },
                mjhand: function(eD) {
                    this.visible = IsArrowVisible_NanXianGuiHuZi();
                },
            ...
            cardNumImg:{
                _event:{
                    initSceneData:function(){
                        setCardNumImage_NanXianGuiHuZi(this);
                    },
                    mjhand:function(){
                        setCardNumImage_NanXianGuiHuZi(this);
                    },
        ...
        operateWait: {
            ...
            _event: {
                initSceneData: function (eD) {
                    if (MjClient.playui.jsBind.left.head.timeImg.time._node.getString() == "0" && curPlayerIsMe_NanXianGuiHuZi(MjClient.MaxPlayerNum_NanXianGuiHuZi - 1) ||
                        MjClient.playui.jsBind.right.head.timeImg.time._node.getString() == "0" && curPlayerIsMe_NanXianGuiHuZi(MjClient.MaxPlayerNum_NanXianGuiHuZi - 2) && MjClient.MaxPlayerNum_NanXianGuiHuZi != 2) {
                        //this.visible = true;
                    }
                },
                mjhand: function (eD) {
        ...
        banner: {
            ...
            getRoomNum: {
                ...
                _click: function() {
                    ...
                    str += tData.areaSelectMode.maiPai20 + "埋牌20张,";
                    str += tData.areaSelectMode.shouQianShou ? ",手牵手" : "";


                    str += tData.areaSelectMode.beiKaoBei ? ",背靠背" : "";
                    str += tData.areaSelectMode.chiBuChao2 ? ",吃不能超过2次" : "";
                    str += tData.areaSelectMode.mingTang ? ",小卓版" : "大卓版";
                    ...
                    if(MjClient.MaxPlayerNum_NanXianGuiHuZi == 3){
                        if((MjClient.MaxPlayerNum_NanXianGuiHuZi - Object.keys(sData.players).length) == 2){
                            str7 = "  一缺二";
                        }
                    }else if(MjClient.MaxPlayerNum_NanXianGuiHuZi == 4){
                        if((MjClient.MaxPlayerNum_NanXianGuiHuZi - Object.keys(sData.players).length) == 3){
                            str7 = "  一缺三";
                        }else if((MjClient.MaxPlayerNum_NanXianGuiHuZi - Object.keys(sData.players).length) == 2){
                            str7 = "二缺二";
                        }else  if((MjClient.MaxPlayerNum_NanXianGuiHuZi - Object.keys(sData.players).length) == 1){
                            str7 = "三缺一";
                        }
                    }
            ...
            gps_btn: {
                ...
                _run:function () {
                    //this.visible = MjClient.MaxPlayerNum_NanXianGuiHuZi >= 3 ? true : false;
                    this.setVisible(MjClient.MaxPlayerNum_NanXianGuiHuZi >= 3);
                },
                _click: function() {
                    if(MjClient.MaxPlayerNum_NanXianGuiHuZi == 3){
        ...
        wait: {
            ...
            delroom: {
                ...
                _event: {
                    initSceneData: function(eD) {
                        //this.visible = isShowBackBtn_NanXianGuiHuZi();
                    },
                    removePlayer: function(eD) {
                        //this.visible = isShowBackBtn_NanXianGuiHuZi();
                    },
        ...
        down: {
            head: {
                siShou:{
                    ...
                    _event:{
                        initSceneData:function () {
                            setSiShou_NanXianGuiHuZi(this, 0);
                        },
                        MJPeng: function(eD) {
                            setSiShou_NanXianGuiHuZi(this, 0);
                        },
                ...
                zhuang: {
                    ...
                    _event: {
                        waitPut: function(){
                            showUserZhuangLogo_NanXianGuiHuZi(this, 0);
                        },
                        initSceneData: function(){
                            if (IsArrowVisible_NanXianGuiHuZi()) showUserZhuangLogo_NanXianGuiHuZi(this, 0);
                        },
                        mjhand: function(){
                            if (IsArrowVisible_NanXianGuiHuZi()) showUserZhuangLogo_NanXianGuiHuZi(this, 0);
                        }
                    ...
                    chattext: {
                        _event: {
                            ...
                            MJChat: function(msg) {
                                ...
                                showUserChat_NanXianGuiHuZi(this, 0, msg);
                            },
                            playVoice: function(voicePath) {
                                MjClient.data._tempMessage.msg = voicePath;
                                showUserChat_NanXianGuiHuZi(this, 0, MjClient.data._tempMessage);
                            }
                        }
                    }
                },
                _click: function(btn) {
                    showPlayerInfo_NanXianGuiHuZi(0, btn);
                },
                _event: {
                    loadWxHead: function(d) {
                        setWxHead_NanXianGuiHuZi(this, d, 0);
                    },
                    addPlayer: function(eD) {
                        showFangzhuTagIcon_NanXianGuiHuZi(this,0);
                    },
                    removePlayer: function(eD) {
                        showFangzhuTagIcon_NanXianGuiHuZi(this,0);
                    }
                ...
                huxi:{
                    ...
                    _event:{
                        ...
                        initSceneData:function(){
                            this.visible = true;
                            var huXi = UpdateHuXi_NanXianGuiHuZi(0);
                            if(!IsArrowVisible_NanXianGuiHuZi()){
                                huXi = 0;
                                this.visible = false;
                            }
                ...
                timeImg:{
                    ...
                    _event:{
                        initSceneData: function(eD) {
                            //this.visible = curPlayerIsMe_NanXianGuiHuZi(0);
                        },
                        onlinePlayer: function(eD) {
                            //this.visible = curPlayerIsMe_NanXianGuiHuZi(0) && IsArrowVisible_NanXianGuiHuZi();
                        },
                        waitPut: function(eD) {
                            //this.visible = curPlayerIsMe_NanXianGuiHuZi(0);
                        },
                    ...
                    time:{
                        ...
                        _event: {
                            ...
                            onlinePlayer: function(){
                                ...
                                if(pl && pl.onLine && curPlayerIsMe_NanXianGuiHuZi(0)){
                                    arrowbkNumberUpdate(this);
                                }
                            },
                            roundEnd: function() {
            ...
            ready: {
                ...
                _run: function() {
                    GetReadyVisible_NanXianGuiHuZi(this, 0);
                },
                _event: {
                    startShuffleCards:function () {
                        GetReadyVisible_NanXianGuiHuZi(this, 0);
                    ...
                    moveHead: function() {
                        GetReadyVisible_NanXianGuiHuZi(this, -1);
                    },
                    addPlayer: function() {
                        GetReadyVisible_NanXianGuiHuZi(this, 0);//根据状态设置ready 是否可见 add by sking
                    },
                    removePlayer: function() {
                        GetReadyVisible_NanXianGuiHuZi(this, 0);
                    },
            ...
            handNode: {
                ...
                _event:  {
                    initSceneData: function() {
                        calculateHintPutList_NanXianGuiHuZi();
                    },
                    mjhand:function () {
                        calculateHintPutList_NanXianGuiHuZi();
                    },
                    ...
                    MJPass: function() { // 天胡 提 偎 跑后过胡
                        calculateHintPutList_NanXianGuiHuZi();
                        addTingSign_NanXianGuiHuZi(MjClient.playui._downNode);
                    },
            ...
            _event: {
                clearCardUI: function() {
                    clearCardUI_NanXianGuiHuZi(this, 0);
                },
                ...
                initSceneData: function(eD) {
                    SetUserVisible_NanXianGuiHuZi(this, 0);
                    InitUserHandUI_NanXianGuiHuZi(this, 0);
                    InitUserCoinAndName_NanXianGuiHuZi(this, 0);
                    MjClient.hasPut = false; // 重连回来重置打掉牌标志（打牌时候断线)
                    ShowPutCardIcon_NanXianGuiHuZi();
                    DealOffLineCard_NanXianGuiHuZi(this,0);
                    resetHandAfterBegin_NanXianGuiHuZi();
                },
                addPlayer: function(eD) {
                    SetUserVisible_NanXianGuiHuZi(this, 0);
                    InitUserCoinAndName_NanXianGuiHuZi(this, 0);
                ...
                mjhand: function(eD) {
                    ...
                    var uid = getUIPlayer_NanXianGuiHuZi(0).info.uid;
                    if (eD.jiazhuNums)
                    {
                ...
                HZNewCard: function(eD) {
                    ...
                    DealNewCard_NanXianGuiHuZi(this,eD,0);
                },
                MJPassWei:function(eD){
                    DealPassWeiCard(this,eD,0);
                },
                MJPut: function(eD) {
                    DealPutCard_NanXianGuiHuZi(this,eD,0);
                },
                HZChiCard: function(eD) {
                    DealChiCard_NanXianGuiHuZi(this, eD, 0);
                    ShowPutCardIcon_NanXianGuiHuZi();
                },
                HZWeiCard: function(eD){
                    DealWeiCard_NanXianGuiHuZi(this,eD,0);
                },
                HZLiuCard: function(eD) {
                    DealGangCard_NanXianGuiHuZi(this, eD, 0);
                },
                MJPeng: function(eD) {
                    DealPengCard_NanXianGuiHuZi(this, eD, 0);
                    ShowPutCardIcon_NanXianGuiHuZi();
                },
                MJHu: function(eD) {
                    DealHu_NanXianGuiHuZi(this, eD, 0);
                },
                onlinePlayer: function(eD) {
                    resetHandAfterBegin_NanXianGuiHuZi();
                    setUserOffline_NanXianGuiHuZi(this, 0);
                },
                ...
                MJJiazhu: function(msg) {
                    ...
                    MjClient.majiang.setJiaZhuNum(MjClient.playui._downNode, getUIPlayer_NanXianGuiHuZi(0));
                    MjClient.majiang.setJiaZhuNum(MjClient.playui._rightNode, getUIPlayer_NanXianGuiHuZi(1));
                    MjClient.majiang.setJiaZhuNum(MjClient.playui._topNode, getUIPlayer_NanXianGuiHuZi(2));
                },
                ...
                HZAddCards:function (eD) {
                    DealAddCard_NanXianGuiHuZi(this,eD, 0);
                },
        ...
        xing: {
            _run:function () {
                if(MjClient.MaxPlayerNum_NanXianGuiHuZi == 3 || MjClient.MaxPlayerNum_NanXianGuiHuZi == 2){
                    this.setVisible(false);
                }
            },
            head: {
                    ...
                    _event:{
                        initSceneData:function () {
                            if(MjClient.MaxPlayerNum_NanXianGuiHuZi == 4) {
                                setSiShou_NanXianGuiHuZi(this, 1);
                            }
                        },
                        MJPeng: function(eD) {
                            if(MjClient.MaxPlayerNum_NanXianGuiHuZi == 4) {
                ...
                zhuang: {
                    ...
                    _event: {
                        waitPut: function() {
                            if(MjClient.MaxPlayerNum_NanXianGuiHuZi == 4) {
                                showUserZhuangLogo_NanXianGuiHuZi(this, 1);
                            }
                        },
                        initSceneData: function() {
                            if(MjClient.MaxPlayerNum_NanXianGuiHuZi == 4) {
                                if (IsArrowVisible_NanXianGuiHuZi()) showUserZhuangLogo_NanXianGuiHuZi(this, 1);
                            }
                        },
                        mjhand: function(){
                            if(MjClient.MaxPlayerNum_NanXianGuiHuZi == 4) {
                ...
                chatbg: {
                    ...
                    chattext: {
                        _event: {
                            MJChat: function(msg) {
                                if(MjClient.MaxPlayerNum_NanXianGuiHuZi == 4) {
                                    showUserChat_NanXianGuiHuZi(this, 1, msg);
                                }
                            },
                            playVoice: function(voicePath) {
                                if(MjClient.MaxPlayerNum_NanXianGuiHuZi == 4) {
                                    MjClient.data._tempMessage.msg = voicePath;
                                    showUserChat_NanXianGuiHuZi(this, 1, MjClient.data._tempMessage);
                                }
                            }
                        }
                    }
                ...
                _click: function(btn) {
                    if(MjClient.MaxPlayerNum_NanXianGuiHuZi == 4) {
                        showPlayerInfo_NanXianGuiHuZi(1, btn);
                    }
                },
                _event: {
                    loadWxHead: function(d) {
                        if(MjClient.MaxPlayerNum_NanXianGuiHuZi == 4) {
                            setWxHead_NanXianGuiHuZi(this, d, 1);
                        }
                    },
                    addPlayer: function(eD) {
                        if(MjClient.MaxPlayerNum_NanXianGuiHuZi == 4) {
                            showFangzhuTagIcon_NanXianGuiHuZi(this, 1);
                        }
                    },
                    removePlayer: function(eD) {
                        if(MjClient.MaxPlayerNum_NanXianGuiHuZi == 4) {
                ...
                huxi:{
                    ...
                    _event:{
                        ...
                        initSceneData:function(){
                            if(MjClient.MaxPlayerNum_NanXianGuiHuZi == 4) {
                                // this.visible = true;
                                var huXi = UpdateHuXi_NanXianGuiHuZi(1);
                                if (!IsArrowVisible_NanXianGuiHuZi()) {
                                    huXi = 0;
                                }
                ...
                timeImg:{
                    ...
                    _event:{
                        initSceneData: function(eD) {
                            if(MjClient.MaxPlayerNum_NanXianGuiHuZi == 4) {
                                //this.visible = curPlayerIsMe_NanXianGuiHuZi(1);
                            }
                            // MjClient.playui.refreshHeadLight(true);
                        },
                        onlinePlayer: function(eD) {
                            if(MjClient.MaxPlayerNum_NanXianGuiHuZi == 4) {
                                //this.visible = curPlayerIsMe_NanXianGuiHuZi(1) && IsArrowVisible_NanXianGuiHuZi();
                            }
                        },
                        waitPut: function(eD) {
                            if(MjClient.MaxPlayerNum_NanXianGuiHuZi == 4) {
                        ...
                        _event: {
                            initSceneData: function(eD) {
                                if(MjClient.MaxPlayerNum_NanXianGuiHuZi == 4) {
                                    ...
                                    stopEffect(playTimeUpEff);
                                    playTimeUpEff = null;
                                    if (curPlayerIsMe_NanXianGuiHuZi(1)) {
                                        arrowbkNumberUpdate(this);
                                        this.setString("0");
                                    }
                                }
                            ...
                            onlinePlayer: function(){
                                if(MjClient.MaxPlayerNum_NanXianGuiHuZi == 4) {
                                    ...
                                    stopEffect(playTimeUpEff);
                                    playTimeUpEff = null;
                                    var pl = getUIPlayer_NanXianGuiHuZi(1);
                                    if (pl && pl.onLine && curPlayerIsMe_NanXianGuiHuZi(1)) {
                                        arrowbkNumberUpdate(this);
                                    }
                                }
                            },
            ...
            _event: {
                clearCardUI: function() {
                    if(MjClient.MaxPlayerNum_NanXianGuiHuZi == 4) {
                        clearCardUI_NanXianGuiHuZi(this, 1);
                    }
                },
                clearCardArr: function(){
                    if(MjClient.MaxPlayerNum_NanXianGuiHuZi == 4) {
                ...
                initSceneData: function(eD) {
                    if(MjClient.MaxPlayerNum_NanXianGuiHuZi == 4) {
                        SetUserVisible_NanXianGuiHuZi(this, 1);
                        InitUserHandUI_NanXianGuiHuZi(this, 1);
                        InitUserCoinAndName_NanXianGuiHuZi(this, 1);
                        DealOffLineCard_NanXianGuiHuZi(this, 1);
                    }
                },
                addPlayer: function(eD) {
                    if(MjClient.MaxPlayerNum_NanXianGuiHuZi == 4) {
                ...
                HZNewCard: function(eD) {
                    if(MjClient.MaxPlayerNum_NanXianGuiHuZi == 4) {
                        ...
                        DealNewCard_NanXianGuiHuZi(this, eD, 1);
                    }
                },
                roundEnd: function() {
                    if(MjClient.MaxPlayerNum_NanXianGuiHuZi == 4) {
                ...
                MJPut: function(eD) {
                    if(MjClient.MaxPlayerNum_NanXianGuiHuZi == 4) {
                        DealPutCard_NanXianGuiHuZi(this, eD, 1);
                    }
                },
                HZChiCard: function(eD) {
                    if(MjClient.MaxPlayerNum_NanXianGuiHuZi == 4) {
                        DealChiCard_NanXianGuiHuZi(this, eD, 1);
                    }
                },
                HZLiuCard: function(eD) {
                    if(MjClient.MaxPlayerNum_NanXianGuiHuZi == 4) {
                        DealGangCard_NanXianGuiHuZi(this, eD, 1);
                    }
                },
                MJPeng: function(eD) {
                    if(MjClient.MaxPlayerNum_NanXianGuiHuZi == 4) {
                        DealPengCard_NanXianGuiHuZi(this, eD, 1);
                    }
                },
                MJPassWei:function(eD){
                ...
                HZWeiCard: function(eD){
                    if(MjClient.MaxPlayerNum_NanXianGuiHuZi == 4) {
                        DealWeiCard_NanXianGuiHuZi(this, eD, 1);
                    }
                },
                MJHu: function(eD) {
                    if(MjClient.MaxPlayerNum_NanXianGuiHuZi == 4) {
                        DealHu_NanXianGuiHuZi(this, eD, 1);
                    }
                },
                onlinePlayer: function(eD) {
                    if(MjClient.MaxPlayerNum_NanXianGuiHuZi == 4) {
                        setUserOffline_NanXianGuiHuZi(this, 1);
                    }
                },
                playerStatusChange: function(eD) {
                    if(MjClient.MaxPlayerNum_NanXianGuiHuZi == 4) {
                ...
                HZAddCards:function (eD) {
                    if(MjClient.MaxPlayerNum_NanXianGuiHuZi == 4) {
                        DealAddCard_NanXianGuiHuZi(this, eD, 1);
                    }
                },
                HZCheckRaise:function (msg) {
                    if(MjClient.MaxPlayerNum_NanXianGuiHuZi == 4) {
        ...
        right: {
            ...
            head: {
                siShou:{
                    ...
                    _event:{
                        initSceneData:function () {
                            setSiShou_NanXianGuiHuZi(this, MjClient.MaxPlayerNum_NanXianGuiHuZi - 2);
                        },
                        MJPeng: function(eD) {
                            setSiShou_NanXianGuiHuZi(this, MjClient.MaxPlayerNum_NanXianGuiHuZi - 2);
                        },
                ...
                zhuang: {
                    ...
                    _event: {
                        waitPut: function() {
                            showUserZhuangLogo_NanXianGuiHuZi(this, MjClient.MaxPlayerNum_NanXianGuiHuZi - 2);
                        },
                        initSceneData: function() {
                            if (IsArrowVisible_NanXianGuiHuZi()) showUserZhuangLogo_NanXianGuiHuZi(this, MjClient.MaxPlayerNum_NanXianGuiHuZi - 2);
                        },
                        mjhand: function(){
                            if (IsArrowVisible_NanXianGuiHuZi()) showUserZhuangLogo_NanXianGuiHuZi(this, MjClient.MaxPlayerNum_NanXianGuiHuZi - 2);
                        }
                ...
                chatbg: {
                    ...
                    chattext: {
                        _event: {
                            MJChat: function(msg) {
                                showUserChat_NanXianGuiHuZi(this, MjClient.MaxPlayerNum_NanXianGuiHuZi - 2, msg);
                            },
                            playVoice: function(voicePath) {
                                MjClient.data._tempMessage.msg = voicePath;
                                showUserChat_NanXianGuiHuZi(this, MjClient.MaxPlayerNum_NanXianGuiHuZi - 2, MjClient.data._tempMessage);
                            }
                        }
                    }
                },
                _click: function(btn) {
                    showPlayerInfo_NanXianGuiHuZi(MjClient.MaxPlayerNum_NanXianGuiHuZi - 2, btn);
                },
                _event: {
                    loadWxHead: function(d) {
                        setWxHead_NanXianGuiHuZi(this, d, MjClient.MaxPlayerNum_NanXianGuiHuZi - 2);
                    },
                    addPlayer: function(eD) {
                        showFangzhuTagIcon_NanXianGuiHuZi(this,MjClient.MaxPlayerNum_NanXianGuiHuZi - 2);
                    },
                    removePlayer: function(eD) {
                        showFangzhuTagIcon_NanXianGuiHuZi(this,MjClient.MaxPlayerNum_NanXianGuiHuZi - 2);
                    }
                ...
                huxi:{
                    ...
                    _event:{
                        ...
                        initSceneData:function(){
                            this.visible = true;
                            var huXi = UpdateHuXi_NanXianGuiHuZi(MjClient.MaxPlayerNum_NanXianGuiHuZi - 2);
                            if(!IsArrowVisible_NanXianGuiHuZi()){
                                huXi = 0;
                                this.visible = false;
                            }
                ...
                timeImg:{
                    ...
                    _event:{
                        initSceneData: function(eD) {
                            //this.visible = curPlayerIsMe_NanXianGuiHuZi(MjClient.MaxPlayerNum_NanXianGuiHuZi - 2);
                        },
                        onlinePlayer: function(eD) {
                            //this.visible = curPlayerIsMe_NanXianGuiHuZi(MjClient.MaxPlayerNum_NanXianGuiHuZi - 2) && IsArrowVisible_NanXianGuiHuZi();
                        },
                        waitPut: function(eD) {
                            //this.visible = curPlayerIsMe_NanXianGuiHuZi(MjClient.MaxPlayerNum_NanXianGuiHuZi - 2);
                        },
                    ...
                    time:{
                        ...
                        _event: {
                            initSceneData: function(eD) {
                                ...
                                stopEffect(playTimeUpEff);
                                playTimeUpEff = null;
                                if(curPlayerIsMe_NanXianGuiHuZi(MjClient.MaxPlayerNum_NanXianGuiHuZi - 2)){
                                    arrowbkNumberUpdate(this);
                                    this.setString("0");
                                }
                            },
                            ...
                            onlinePlayer: function(){
                                ...
                                stopEffect(playTimeUpEff);
                                playTimeUpEff = null;
                                var pl = getUIPlayer_NanXianGuiHuZi(MjClient.MaxPlayerNum_NanXianGuiHuZi - 2);
                                if(pl && pl.onLine && curPlayerIsMe_NanXianGuiHuZi(MjClient.MaxPlayerNum_NanXianGuiHuZi - 2)){
                                    arrowbkNumberUpdate(this);
                                }
                            },
                            roundEnd: function() {
            ...
            ready: {
                _layout: [[0.07, 0.07],[0.5, 0.5],[2.5, 2.5]],
                _run: function() {
                    GetReadyVisible_NanXianGuiHuZi(this, MjClient.MaxPlayerNum_NanXianGuiHuZi - 2);
                },
                _event: {
                    startShuffleCards:function () {
                        GetReadyVisible_NanXianGuiHuZi(this, MjClient.MaxPlayerNum_NanXianGuiHuZi - 2);
            ...
            _event: {
                clearCardUI: function() {
                    clearCardUI_NanXianGuiHuZi(this, MjClient.MaxPlayerNum_NanXianGuiHuZi - 2);
                },
                clearCardArr: function(){
                    var eatNode = this.getChildByName("eatNode");
                    eatNode.removeAllChildren();
                ...
                initSceneData: function(eD) {
                    SetUserVisible_NanXianGuiHuZi(this, MjClient.MaxPlayerNum_NanXianGuiHuZi - 2);
                    InitUserHandUI_NanXianGuiHuZi(this, MjClient.MaxPlayerNum_NanXianGuiHuZi - 2);
                    InitUserCoinAndName_NanXianGuiHuZi(this, MjClient.MaxPlayerNum_NanXianGuiHuZi - 2);
                    DealOffLineCard_NanXianGuiHuZi(this,MjClient.MaxPlayerNum_NanXianGuiHuZi - 2);
                },
                addPlayer: function(eD) {
                    SetUserVisible_NanXianGuiHuZi(this, MjClient.MaxPlayerNum_NanXianGuiHuZi - 2);
                    InitUserCoinAndName_NanXianGuiHuZi(this, MjClient.MaxPlayerNum_NanXianGuiHuZi - 2);
                ...
                HZNewCard: function(eD) {
                    ...
                    DealNewCard_NanXianGuiHuZi(this,eD,MjClient.MaxPlayerNum_NanXianGuiHuZi - 2);
                },
                roundEnd: function() {
                    InitUserCoinAndName_NanXianGuiHuZi(this, MjClient.MaxPlayerNum_NanXianGuiHuZi - 2);
                    MjClient.playui.ResetOtherCard(this, MjClient.MaxPlayerNum_NanXianGuiHuZi - 2);
                },
                waitPut: function(eD) {
                    //DealWaitPut(this, eD, MjClient.MaxPlayerNum_NanXianGuiHuZi - 2);
                },
                MJPut: function(eD) {
                    DealPutCard_NanXianGuiHuZi(this, eD, MjClient.MaxPlayerNum_NanXianGuiHuZi - 2);
                },
                HZChiCard: function(eD) {
                    DealChiCard_NanXianGuiHuZi(this, eD, MjClient.MaxPlayerNum_NanXianGuiHuZi - 2);
                },
                MJPassWei:function(eD){
                    DealPassWeiCard(this,eD,MjClient.MaxPlayerNum_NanXianGuiHuZi - 2);
                },
                HZLiuCard: function(eD) {
                    DealGangCard_NanXianGuiHuZi(this, eD, MjClient.MaxPlayerNum_NanXianGuiHuZi - 2);
                },
                MJPeng: function(eD) {
                    DealPengCard_NanXianGuiHuZi(this, eD, MjClient.MaxPlayerNum_NanXianGuiHuZi - 2);
                },
                HZWeiCard: function(eD){
                    DealWeiCard_NanXianGuiHuZi(this, eD, MjClient.MaxPlayerNum_NanXianGuiHuZi - 2);
                },
                MJHu: function(eD) {
                    DealHu_NanXianGuiHuZi(this, eD, MjClient.MaxPlayerNum_NanXianGuiHuZi - 2);
                },
                onlinePlayer: function(eD) {
                    setUserOffline_NanXianGuiHuZi(this, MjClient.MaxPlayerNum_NanXianGuiHuZi - 2);
                },
                playerStatusChange: function(eD) {
                    setUserOffline_NanXianGuiHuZi(this, MjClient.MaxPlayerNum_NanXianGuiHuZi - 2);
                },
                MJFlower: function(eD) {
                    HandleMJFlower(this, eD, MjClient.MaxPlayerNum_NanXianGuiHuZi - 2);
                },
                MJTing: function (eD) {
                    HandleMJTing(this, eD, MjClient.MaxPlayerNum_NanXianGuiHuZi - 2);
                },
                waitJiazhu:function (msg) {
                    postEvent("returnPlayerLayer");
                    /*
                ...
                HZPickCard:function (eD) {
                    if(MjClient.rePlayVideo != -1){
                        var pl = getUIPlayer_NanXianGuiHuZi(MjClient.MaxPlayerNum_NanXianGuiHuZi - 2);
                        if(eD.uid == pl.info.uid) {
                            MjClient.OtherHandArr[MjClient.MaxPlayerNum_NanXianGuiHuZi - 2] = MjClient.majiang.sortCard3(pl.mjhand, 2)
                        }
                    }

                    RemovePutCardOut_NanXianGuiHuZi(true);
                    MjClient.playui.ResetHandCard(this,MjClient.MaxPlayerNum_NanXianGuiHuZi - 2);
                },
                HZAddCards:function (eD) {
                    DealAddCard_NanXianGuiHuZi(this,eD, MjClient.MaxPlayerNum_NanXianGuiHuZi - 2);
                },
                HZCheckRaise:function (msg) {
                    ShowPutCardIcon_NanXianGuiHuZi();
                    //MjClient.playui.EatVisibleCheck();
        ...
        left: {
            head: {
                siShou:{
                    ...
                    _event:{
                        initSceneData:function () {
                            setSiShou_NanXianGuiHuZi(this, MjClient.MaxPlayerNum_NanXianGuiHuZi - 1);
                        },
                        MJPeng: function(eD) {
                            setSiShou_NanXianGuiHuZi(this, MjClient.MaxPlayerNum_NanXianGuiHuZi - 1);
                        },
                ...
                zhuang: {
                    ...
                    _event: {
                        waitPut: function() {
                            showUserZhuangLogo_NanXianGuiHuZi(this, MjClient.MaxPlayerNum_NanXianGuiHuZi - 1);
                        },
                        initSceneData: function() {
                            if (IsArrowVisible_NanXianGuiHuZi()) showUserZhuangLogo_NanXianGuiHuZi(this, MjClient.MaxPlayerNum_NanXianGuiHuZi - 1);
                        },
                        mjhand: function(){
                            if (IsArrowVisible_NanXianGuiHuZi()) showUserZhuangLogo_NanXianGuiHuZi(this, MjClient.MaxPlayerNum_NanXianGuiHuZi - 1);
                        }
                ...
                chatbg: {
                    ...
                    chattext: {
                        _event: {
                            MJChat: function(msg) {
                                showUserChat_NanXianGuiHuZi(this, MjClient.MaxPlayerNum_NanXianGuiHuZi - 1, msg);
                            },
                            playVoice: function(voicePath) {
                                MjClient.data._tempMessage.msg = voicePath;
                                showUserChat_NanXianGuiHuZi(this, MjClient.MaxPlayerNum_NanXianGuiHuZi - 1, MjClient.data._tempMessage);
                            }
                        }
                    }
                },
                _click: function(btn) {
                    showPlayerInfo_NanXianGuiHuZi(MjClient.MaxPlayerNum_NanXianGuiHuZi - 1, btn);
                },
                _event: {
                    loadWxHead: function(d) {
                        setWxHead_NanXianGuiHuZi(this, d, MjClient.MaxPlayerNum_NanXianGuiHuZi - 1);
                    },
                    addPlayer: function(eD) {
                        showFangzhuTagIcon_NanXianGuiHuZi(this,MjClient.MaxPlayerNum_NanXianGuiHuZi - 1);
                    },
                    removePlayer: function(eD) {
                        showFangzhuTagIcon_NanXianGuiHuZi(this,MjClient.MaxPlayerNum_NanXianGuiHuZi - 1);
                    }
                ...
                huxi:{
                    ...
                    _event:{
                        ...
                        initSceneData:function(){
                            this.visible = true;
                            var huXi = UpdateHuXi_NanXianGuiHuZi(MjClient.MaxPlayerNum_NanXianGuiHuZi - 1);
                            if(!IsArrowVisible_NanXianGuiHuZi()){
                                huXi = 0;
                                this.visible = false;
                            }
                ...
                timeImg:{
                    ...
                    _event:{
                        initSceneData: function(eD) {
                            //this.visible = curPlayerIsMe_NanXianGuiHuZi(MjClient.MaxPlayerNum_NanXianGuiHuZi - 1);
                        },
                        onlinePlayer: function(eD) {
                            //this.visible = curPlayerIsMe_NanXianGuiHuZi(MjClient.MaxPlayerNum_NanXianGuiHuZi - 1) && IsArrowVisible_NanXianGuiHuZi();
                        },
                        waitPut: function(eD) {
                            //this.visible = curPlayerIsMe_NanXianGuiHuZi(MjClient.MaxPlayerNum_NanXianGuiHuZi - 1);
                        },
                    ...
                    time:{
                        ...
                        _event: {
                            initSceneData: function(eD) {
                                ...
                                stopEffect(playTimeUpEff);
                                playTimeUpEff = null;
                                if(curPlayerIsMe_NanXianGuiHuZi(MjClient.MaxPlayerNum_NanXianGuiHuZi - 1)){
                                    arrowbkNumberUpdate(this);
                                    this.setString("0");
                                }
                            },
                            ...
                            onlinePlayer: function(){
                                ...
                                stopEffect(playTimeUpEff);
                                playTimeUpEff = null;
                                var pl = getUIPlayer_NanXianGuiHuZi(MjClient.MaxPlayerNum_NanXianGuiHuZi - 1);
                                if(pl && pl.onLine && curPlayerIsMe_NanXianGuiHuZi(MjClient.MaxPlayerNum_NanXianGuiHuZi - 1)){
                                    arrowbkNumberUpdate(this);
                                }
                            },
                            roundEnd: function() {
            ...
            ready: {
                _layout: [[0.07, 0.07],[0.5, 0.5],[-2.5, 2.5]],
                _run: function() {
                    GetReadyVisible_NanXianGuiHuZi(this, MjClient.MaxPlayerNum_NanXianGuiHuZi - 1);
                },
                _event: {
                    startShuffleCards:function () {
                        GetReadyVisible_NanXianGuiHuZi(this, MjClient.MaxPlayerNum_NanXianGuiHuZi - 1);
            ...
            _event: {
                clearCardUI: function() {
                    clearCardUI_NanXianGuiHuZi(this, MjClient.MaxPlayerNum_NanXianGuiHuZi - 1);
                },
                clearCardArr: function(){
                    var eatNode = this.getChildByName("eatNode");
                    eatNode.removeAllChildren();
                ...
                initSceneData: function(eD) {
                    SetUserVisible_NanXianGuiHuZi(this, MjClient.MaxPlayerNum_NanXianGuiHuZi - 1);
                    InitUserHandUI_NanXianGuiHuZi(this, MjClient.MaxPlayerNum_NanXianGuiHuZi - 1);
                    InitUserCoinAndName_NanXianGuiHuZi(this, MjClient.MaxPlayerNum_NanXianGuiHuZi - 1);
                    DealOffLineCard_NanXianGuiHuZi(this,MjClient.MaxPlayerNum_NanXianGuiHuZi - 1);
                },
                addPlayer: function(eD) {
                    SetUserVisible_NanXianGuiHuZi(this, MjClient.MaxPlayerNum_NanXianGuiHuZi - 1);
                    InitUserCoinAndName_NanXianGuiHuZi(this, MjClient.MaxPlayerNum_NanXianGuiHuZi - 1);
                ...
                HZNewCard: function(eD) {
                    ...
                    DealNewCard_NanXianGuiHuZi(this,eD,MjClient.MaxPlayerNum_NanXianGuiHuZi - 1);
                },
                MJPassWei:function(eD){
                    DealPassWeiCard(this,eD,MjClient.MaxPlayerNum_NanXianGuiHuZi - 1);
                },
                roundEnd: function() {
                    InitUserCoinAndName_NanXianGuiHuZi(this, MjClient.MaxPlayerNum_NanXianGuiHuZi - 1);
                    MjClient.playui.ResetOtherCard(this, MjClient.MaxPlayerNum_NanXianGuiHuZi - 1);
                },
                waitPut: function(eD) {
                    //DealWaitPut(this, eD, MjClient.MaxPlayerNum_NanXianGuiHuZi - 1);
                },
                MJPut: function(eD) {
                    DealPutCard_NanXianGuiHuZi(this, eD, MjClient.MaxPlayerNum_NanXianGuiHuZi - 1);
                },
                HZChiCard: function(eD) {
                    DealChiCard_NanXianGuiHuZi(this, eD, MjClient.MaxPlayerNum_NanXianGuiHuZi - 1);
                },
                HZPaoCard: function(eD) {
                    DealPaoCard_NanXianGuiHuZi(this, eD, MjClient.MaxPlayerNum_NanXianGuiHuZi - 1);
                },
                HZLiuCard: function(eD) {
                    DealGangCard_NanXianGuiHuZi(this, eD, MjClient.MaxPlayerNum_NanXianGuiHuZi - 1);
                },
                MJPeng: function(eD) {
                    DealPengCard_NanXianGuiHuZi(this, eD, MjClient.MaxPlayerNum_NanXianGuiHuZi - 1);
                },
                HZWeiCard: function(eD){
                    DealWeiCard_NanXianGuiHuZi(this, eD, MjClient.MaxPlayerNum_NanXianGuiHuZi - 1);
                },
                MJHu: function(eD) {
                    DealHu_NanXianGuiHuZi(this, eD, MjClient.MaxPlayerNum_NanXianGuiHuZi - 1);
                },
                onlinePlayer: function(eD) {
                    setUserOffline_NanXianGuiHuZi(this, MjClient.MaxPlayerNum_NanXianGuiHuZi - 1);
                },
                playerStatusChange: function(eD) {
                    setUserOffline_NanXianGuiHuZi(this, MjClient.MaxPlayerNum_NanXianGuiHuZi - 1);
                },
                MJFlower: function(eD) {
                    HandleMJFlower(this, eD, MjClient.MaxPlayerNum_NanXianGuiHuZi - 1);
                },
                MJTing: function (eD) {
                    HandleMJTing(this, eD, MjClient.MaxPlayerNum_NanXianGuiHuZi - 1);
                },
                HZPickCard:function (eD) {
                    if(MjClient.rePlayVideo != -1) {
                        var pl = getUIPlayer_NanXianGuiHuZi(MjClient.MaxPlayerNum_NanXianGuiHuZi - 1);
                        if(eD.uid == pl.info.uid){
                            MjClient.OtherHandArr[MjClient.MaxPlayerNum_NanXianGuiHuZi - 1] = MjClient.majiang.sortCard3(pl.mjhand, 2)
                        }
                    }
                    RemovePutCardOut_NanXianGuiHuZi(true);
                    MjClient.playui.ResetHandCard(this,MjClient.MaxPlayerNum_NanXianGuiHuZi - 1);
                },
                HZAddCards:function (eD) {
                    DealAddCard_NanXianGuiHuZi(this,eD, MjClient.MaxPlayerNum_NanXianGuiHuZi - 1);
                },
                HZCheckRaise:function (msg) {
                    ShowPutCardIcon_NanXianGuiHuZi();
                    //MjClient.playui.EatVisibleCheck();
        ...
        eat: {
                ...
                _touch: function(btn, eT) {
                    if (eT == 2){
                        ...
                        if(ziPai.getHasFastEat()){
                            ...
                            if (chiList.length == 1) {
                                commitEatCards_NanXianGuiHuZi(chiList[0], null);
                                return;
                            }
                        }
                        
                        showSelectEatCards_NanXianGuiHuZi(this,btn.tag);
                        ...
                        // MJChiCardchange_NanXianGuiHuZi();
                    }
                }
            },
            noTing : {
            ...
            liu:{
                ...
                _touch: function(btn, eT) {
                    ...
                    if (eT == 2){
                        showSelectLiuCards_NanXianGuiHuZi(this, 0);
                    }
                }
            },
            piao:{
                ...
                _touch: function(btn, eT) {
                    ...
                    if (eT == 2){
                        showSelectLiuCards_NanXianGuiHuZi(this,1);
                    }
                }
            },
            guo: {
                    ...
                    if (eT == 2){
                        if ((MjClient.data.sData.players[SelfUid()].eatFlag & 32) > 0) {
                            MjClient.showMsg("确定过胡吗？", function() {
                                HZPassConfirmToServer_NanXianGuiHuZi(); // todo 
                                setChiVisible_NanXianGuiHuZi();//add by maoyu
                            }, function() {}, "1");
                        } else {
                            HZPassConfirmToServer_NanXianGuiHuZi(); // todo 
                            setChiVisible_NanXianGuiHuZi();//add by maoyu
            ...
            wangDiao:{
                ...
                _touch: function(btn, eT) {
                    console.log(">>>> lf，点击碰按钮");
                    if (eT == 2) {
                        HZWangChuangToServer_NanXianGuiHuZi(1);
                        setChiVisible_NanXianGuiHuZi();//add by maoyu
                    }
                }
            },
            wangChuang:{
                ...
                _touch: function(btn, eT) {
                    console.log(">>>> lf，点击碰按钮");
                    if (eT == 2) {
                        HZWangChuangToServer_NanXianGuiHuZi(2);
                        setChiVisible_NanXianGuiHuZi();//add by maoyu
                    }
                }
            },
            wangZha:{
                ...
                _touch: function(btn, eT) {
                    console.log(">>>> lf，点击碰按钮");
                    if (eT == 2) {
                        HZWangChuangToServer_NanXianGuiHuZi(4);
                        setChiVisible_NanXianGuiHuZi();//add by maoyu
                    }
                }
            },
                    ...
                    this.adaptChiLayout = function() {
                        ...
                        if (cards_option.length == 0) { // 吃牌选好了
                            if ((MjClient.data.sData.players[SelfUid()].eatFlag & 32) > 0) {
                                MjClient.showMsg("选择吃后视为过胡，确定吃吗？", function() {
                                    ...
                                    HZChiToServer_NanXianGuiHuZi(cards_select[0], biCards);
                                    this.visible = false;
                                }.bind(this), function() {
                                    cards_select.pop();
                                    this.adaptChiLayout();
                        ...
                        for (var i = 0; i < cards_select.length; i++) {
                            ...
                            for (var j = 0; j < row.length; j++) {
                                ...
                                chiCardImg.loadTexture(MjClient.cardPath_NanXianGuiHuZi + "out" + row[j] + ".png");
        ...
        chat_btn: {
            ...
            _click: function() {
                ...
                // MjClient.Scene.addChild(new EndOneView_NanXianGuiHuZi(),500);
                // MjClient.Scene.addChild(new GameOverLayer_NanXianGuiHuZi(),500);
            }
        },
        voice_btn: {
            ...
            _event: {
                ...
                downAndPlayVoice: function(msg) {
                    ...
                    // downAndPlayVoice_NanXianGuiHuZi(msg.uid, msg.msg);
    ...
    ctor: function() {
        this._super();
        ziPai.initZiPaiData();
        var playui = ccs.load("Play_nanXianGuiHuZi.json");
        playMusic("bgHongZi");
        var tData = MjClient.data.sData.tData;
        MjClient.MaxPlayerNum_NanXianGuiHuZi = tData.maxPlayer;
        cc.log(MjClient.MaxPlayerNum_NanXianGuiHuZi);
        ...
        this.newTingLayer = new NanXianGuiHuZiNewTingLayer();
        playui.node.addChild(this.newTingLayer);

        this.tingLayer = new NanXianGuiHuZiPhzTingLayer();
    ...
    resetJiaZhuTip: function()
    {
        ...
        for (var i = 0; i < MjClient.MaxPlayerNum_NanXianGuiHuZi; i ++)
        {
...
//重置手牌的顺序
PlayLayer_NanXianGuiHuZi.prototype.ResetHandCard = function(posNode,off, needAction, isDelay){
    ...
    if(MjClient.rePlayVideo == -1){
        if(off == 0) {
            ...
            checkCard_NanXianGuiHuZi(posNode, off);
            // if(!needAction && !isDelay && MjClient.addGroupIndex != 0){
            //     refreshNode_NanXianGuiHuZi(posNode,off,needAction);
            //
            ...
            cleanCardNode_NanXianGuiHuZi(off);
            handNode.removeAllChildren();
            ...
            for (var k = 0; k < cardArr.length; k++) {
                ...
                for (var j = 0; j < groupList.length; j++) {
                    addOrAdjustHandCard_NanXianGuiHuZi(k, j, groupList[j], off);
                }
            }
            resetCardNode_NanXianGuiHuZi(off)
            addTingSign_NanXianGuiHuZi(posNode); // 添加听牌角标
        ...
        //if(MjClient.movingCard_NanXianGuiHuZi && MjClient.movingCard_NanXianGuiHuZi.getParent()){
        //    MjClient.movingCard_NanXianGuiHuZi.removeFromParent(true);
        ...
        for(var k = 0;k < cardArr.length;k++){
            ...
            for(var j = 0;j < groupList.length;j++){
                if(off == 0){
                    if(MjClient.MaxPlayerNum_NanXianGuiHuZi == 3 || MjClient.MaxPlayerNum_NanXianGuiHuZi == 2){
                        addHandCard_NanXianGuiHuZi(k,j,groupList[j],off);
                    }else if(MjClient.MaxPlayerNum_NanXianGuiHuZi == 4){
                        addHandCardReplay_NanXianGuiHuZi(k,j,groupList[j],off);
                    }
                }else {
                    addHandCardReplay_NanXianGuiHuZi(k,j,groupList[j],off);
                }
        ...
        if(off == 0 && (MjClient.MaxPlayerNum_NanXianGuiHuZi == 3 || MjClient.MaxPlayerNum_NanXianGuiHuZi == 2)) {
            var type = ziPai.getZiPaiType();
            var sizeArr = [98,84,100,103];
            var width =sizeArr[type] * changeCardSize; // handCard.getVirtualRendererSize().width;
...
PlayLayer_NanXianGuiHuZi.prototype._doMovetoAction = function(node,endP){
    node.stopAllActions();
    var ac = cc.moveTo(0.3,endP);
    node.runAction(ac);
};

PlayLayer_NanXianGuiHuZi.prototype.ResetOtherCard = function(posNode, off) {
    // 添加吃、碰、跑、偎、提
    var sData = MjClient.data.sData;
    var tData = null;
    if (sData) {
        ...
        // 提/偎牌的特殊处理
         var callback = function(childList) {
             ...
             for (var i = 0; i < childList.length; i++) {
                 ...
                 // } else {
                 //     child.loadTexture(MjClient.cardPath_NanXianGuiHuZi + "huxiBG.png");
                 // }
                 if (off == 0) {
                     ...
                     if (i != getShowCardIdx_NanXianGuiHuZi(posNode, chiTip)) {
                         child.loadTexture(MjClient.cardPath_NanXianGuiHuZi + "huxiBG.png");
                     }
                 } else {
                     child.loadTexture(MjClient.cardPath_NanXianGuiHuZi + "huxiBG.png");
        ...
        for (var k = 0; k < mjSortArr.length; k++) {
            ...
            //提
             if (name == "mjgang1") {
                 ...
                 for (var i = 0; i < 4; i++) {
                     addEatCard_NanXianGuiHuZi(posNode, "mjgang1" + k, cardNum, off);
                 }
            ...
            if (name == "mjgang2") {
                ...
                for (var i = 0; i < 4; i++) {
                    addEatCard_NanXianGuiHuZi(posNode, "mjgang2" + k, cardNum, off);
                }
            ...
            //偎
             if (name == "mjwei") {
                 var cardNum = pl.mjwei[pos];
                 for (var i = 0; i < 3; i++) {
                     addEatCard_NanXianGuiHuZi(posNode, "mjwei" + k, cardNum, off);
                 }
            ...
            if (name == "mjgang0") {
                ...
                for (var i = 0; i < 4; i++) {
                    addEatCard_NanXianGuiHuZi(posNode, "mjgang0" + k, cardNum, off);
                }
            ...
            if (name == "mjpeng") {
                ...
                for (var i = 0; i < 3; i++) {
                    addEatCard_NanXianGuiHuZi(posNode, "mjpeng" + k, cardNum, off);
                }
            }
            //吃
            if (name == "mjchi") {
                ...
                for (var i = 0; i < eatCards.length; i++) {
                    addEatCard_NanXianGuiHuZi(posNode, "mjchi" + k, eatCards[i], off);
                }
                ...
                if (biCards && biCards.length > 0) {
                    for (var i = 0; i < biCards.length; i++) {
                        ...
                        for (var m = 0; m < biArr.length; m++) {
                            addEatCard_NanXianGuiHuZi(posNode, "mjbi" + k + i, biArr[m], off);
                        }
                    }
                }
    ...
    //    var outCard = getNewCard_NanXianGuiHuZi(pl.mjput[i], 2, off);
    //    if(off == 0){
    //        outCard.anchorX = 1;
    //        outCard.anchorY = 0;
...
PlayLayer_NanXianGuiHuZi.prototype.ResetPutCard = function(posNode,off){
    ...
    if(type == 0 && MjClient.data.sData.tData.maxPlayer < 4){
        ...
        for(var i = 0; i < pl.mjput.length; i++){
            ...
            outNode.addChild(outCard);
            addPutFrame_NanXianGuiHuZi(outCard, pl.mjputType[i]);
        }
    }else{
        for(var i = 0; i < pl.mjput.length; i++){
            if(curUId == pl.info.uid && i == pl.mjput.length - 1 && tData.currCard == pl.mjput[i]){
...
//重置牌的顺序
PlayLayer_NanXianGuiHuZi.prototype.CardLayoutRestore = function(posNode,off){
    if(MjClient.rePlayVideo == -1){
...
PlayLayer_NanXianGuiHuZi.prototype.ShowHuTypeText = function(){
    var pl = getUIPlayer_NanXianGuiHuZi(0);
    cc.log("test . log ----------------------");   
...
// 判断吃、碰、跑、偎、提、胡的状态
PlayLayer_NanXianGuiHuZi.prototype.EatVisibleCheck = function(msg){
    var eat = MjClient.playui.jsBind.eat;
...
PlayLayer_NanXianGuiHuZi.prototype.showAndHideHeadEffect = function(){
    ...
    else if (curPlayerIsMe_NanXianGuiHuZi(1)){
        curPlayerNode = arr[1].getChildByName("head");
    }else if (curPlayerIsMe_NanXianGuiHuZi(2)){
        curPlayerNode = arr[2].getChildByName("head");
    }else if (curPlayerIsMe_NanXianGuiHuZi(3)){
