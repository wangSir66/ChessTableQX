...
var CreateRoomNode_doudizhuGZ = CreateRoomNode.extend({
    setKey:function()
    {
        this.localStorageKey.KEY_DDZGZ_playerNumber       = "_DOU_DI_ZHU_GZ_PLAYER_NUMBER";     //玩家数量
        this.localStorageKey.KEY_DDZGZ_fengding           = "_DOU_DI_ZHU_GZ_FENG_DING";           //封顶 封顶
        this.localStorageKey.KEY_DDZGZ_dizhu               = "_DI_ZHU_GZ_FENG_DING";           //底分
        this.localStorageKey.KEY_DDZGZ_type            = "_DOU_DI_ZHU_GZ_TYPE";           //类型
        //this.localStorageKey.KEY_DDZGZ_yingjiachu           = "_DOU_DI_ZHU_yingjiachu";         //赢家出
        this.localStorageKey.KEY_DDZGZ_gps      = "_DOU_DI_ZHU_GZ_GPS"; //防作弊
        this.localStorageKey.KEY_DDZGZ_shuangwangbijiao                = "_DOU_DI_ZHU_GZ_SHUANG_WANG_BIJIAO";                //双王必叫
        this.localStorageKey.KEY_DDZGZ_sigeerbijiao                = "_DOU_DI_ZHU_GZ_SI_GE_ER_BIJIAO";                //四个二必叫
    },
    initAll:function(IsFriendCard)
    {
        ...
        this.bg_node = ccs.load("bg_doudizhuGZ.json").node;
    ...
    setPlayNodeCurrentSelect:function(isClub) {
        ...
        if (isClub)
            ...
            _fengDing = util.localStorageEncrypt.getNumberItem(this.localStorageKey.KEY_DDZGZ_fengding, 3);
        ...
        if (isClub) {
            ...
            _type = util.localStorageEncrypt.getNumberItem(this.localStorageKey.KEY_DDZGZ_type, 1);
        ...
        if (isClub) {
            ...
            _difen = util.localStorageEncrypt.getNumberItem(this.localStorageKey.KEY_DDZGZ_dizhu, 0);
        ...
        if (isClub)
            ...
            _gps = util.localStorageEncrypt.getBoolItem(this.localStorageKey.KEY_DDZGZ_gps, false);
        ...
        if(isClub)
            ...
            _shuangwangbijiao = util.localStorageEncrypt.getBoolItem(this.localStorageKey.KEY_DDZGZ_shuangwangbijiao, true);
        ...
        if(isClub)
            ...
            _sigeerbijiao = util.localStorageEncrypt.getBoolItem(this.localStorageKey.KEY_DDZGZ_sigeerbijiao, true);
    ...
    {
        var para = {};
        para.gameType = MjClient.GAME_TYPE.DOU_DI_ZHU_GZ;
        para.maxPlayer = 3;
        para.zhafengding  = 3;
        para.difen = 1;
        para.type = "jingdian";
        ...
        if (!this._isFriendCard) {
            util.localStorageEncrypt.setNumberItem(this.localStorageKey.KEY_DDZGZ_fengding,para.zhafengding);
            util.localStorageEncrypt.setNumberItem(this.localStorageKey.KEY_DDZGZ_type, _type);
            util.localStorageEncrypt.setBoolItem(this.localStorageKey.KEY_DDZGZ_shuangwangbijiao, para.bijiaoShuangwang);
            util.localStorageEncrypt.setBoolItem(this.localStorageKey.KEY_DDZGZ_sigeerbijiao, para.bijiaoSigeer);
            ...
            util.localStorageEncrypt.setNumberItem(this.localStorageKey.KEY_DDZGZ_dizhu, this._zhuIdx);
            util.localStorageEncrypt.setBoolItem(this.localStorageKey.KEY_DDZGZ_gps,  para.gps);
        }
