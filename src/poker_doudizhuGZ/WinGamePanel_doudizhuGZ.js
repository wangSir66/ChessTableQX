...
function SetEndOneUserUI_doudizhuJZ(node, off) {
        ...
        head: {
            ...
            stand: {
                ...
                _run: function () {
                    ...
                    CardLayoutRestoreForEndOne_doudizhuJZ(node, pl);
                }
            },
            cardType: {
                _run:function()
            ...
            jiaBeiFlag: {
                ...
                _run:function()
                {
                    this.visible = (MjClient.playui.endInfo.jiaZhuNums[pl.info.uid +""] == 2);
                }
            },
        }
		, winNum: {
...
function CardLayoutRestoreForEndOne_doudizhuJZ(node, plNode) {
...
var EndOneView_doudizhuGZ = cc.Layer.extend({
    jsBind: {
        block: {
        ...
        back: {
            ...
            head0: {
                ...
                _run: function () { SetEndOneUserUI_doudizhuJZ(this, 0); },
    		...
    		, head1: {
    		    ...
    		    _run: function () { SetEndOneUserUI_doudizhuJZ(this, 1); }
    		}
    		...
    		, head2: {
    		    ...
    		    _run: function () { SetEndOneUserUI_doudizhuJZ(this, 2); }
    		},
            publicMutiple: {
                _run:function()
                {
                ...
                _text: function () {
                    ...
                    if (index == -1) { // 没有解散
                        text += "底分X" + (tData.fieldBase ? tData.fieldBase : tData.areaSelectMode.difen);
                        text += "，叫分X" + endInfo.diFen;
                        text += tData.totalZhaDan > 0 ? "，炸弹X" + Math.pow(2, tData.totalZhaDan) : "";
                        text += tData.chuntianRate > 1 ? "，春天X" + tData.chuntianRate : "";
                        text += "=公共倍数" + ((tData.fieldBase ? tData.fieldBase : tData.areaSelectMode.difen) * endInfo.diFen * Math.pow(2, tData.totalZhaDan) * tData.chuntianRate);
                    } else {
    ...
    ctor: function (zhuang) {
        ...
        var endoneui = ccs.load("endOne_doudizhuGZ.json");
