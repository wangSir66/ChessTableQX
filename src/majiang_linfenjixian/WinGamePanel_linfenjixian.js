...
function SetEndOneUserUI_linfenjixian(node,off)
{
...
var EndOneView_linfenjixian = cc.Layer.extend({
	jsBind:{
		block: {
		...
		btnShowHeap:{
                ...
                _click:function()
                {
                	if(MjClient.endoneui){
                       // var linfenjixianCardsHeap = new PopupShowCardsHeap();
                       // linfenjixianCardsHeap.setName("linfenjixianCardsHeap");
                       // MjClient.endoneui.addChild(linfenjixianCardsHeap);
                    }
                },
            },
		dir: {
		...
		head0:{
		   ...
		   _run:function(){ SetEndOneUserUI_linfenjixian(this,0); },
		...
		head1:{
		  ...
		  _run:function(){ SetEndOneUserUI_linfenjixian(this,1); }
		},
		head2:{
		   head:{
			   zhuang:{_visible:false}
		   ...
		   _run:function(){ SetEndOneUserUI_linfenjixian(this,2); }
		},
		head3:{
			 head:
			 {
			...
			_run:function(){ SetEndOneUserUI_linfenjixian(this,3); }
			},
		count_down:{
                _visible :function()
                {
    ...
    ctor:function () {
        this._super();
        var endoneui = ccs.load("endOne_linfenjixian.json");
