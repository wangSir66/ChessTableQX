...
function SetEndOneUserUI_siyang_New(node,off)
{
...
var EndOneView_siyang_New = cc.Layer.extend({
	jsBind:{
		block: {
		...
		head0:{
		   ...
		   _run:function(){ SetEndOneUserUI_siyang_New(this,0); },
		...
		,head1:{ 
		  ...
		  _run:function(){ SetEndOneUserUI_siyang_New(this,1); }
		}
		...
		,head2:{ 
		   ...
		   _run:function(){ SetEndOneUserUI_siyang_New(this,2); }
		}
		,head3:{
			 head:
			 {
			...
			_run:function(){ SetEndOneUserUI_siyang_New(this,3); }
			},
            count_down:{
                _visible :function()
                {
    ...
    ctor:function () {
        this._super();
        var endoneui = ccs.load("endOne_siyang_new.json");
