...
//向服务器发送 过消息
MjClient.MJPass2NetForSiyang_New = function()
{
   // console.log(">>>>>>>>>普通  过 <<<<<<<<");
    cc.log("====================send======pass=====");
...
function SetUserVisible_siyang_New(node, off)
{
    //var sData = MjClient.data.sData;
    //return;
    cc.log("====================off======================" + off);
...
function InitUserHandUI_siyang_New(node, off)
{
    var sData = MjClient.data.sData;
    var tData = sData.tData;
    var pl = getUIPlayer(off);
...
function initFlower_siyang_new() {
    initFlower(false, false);
}


var PlayLayer_siyang_New = cc.Layer.extend({
    jsBind: {
        _event: {
            mjhand: function() {
        ...
        down: {
            ...
            _event: {
                ...
                initSceneData: function(eD) {
                    SetUserVisible_siyang_New(this, 0);
                },
                addPlayer: function(eD) {
                    SetUserVisible_siyang_New(this, 0);
                },
                ...
                mjhand: function(eD) {
                    InitUserHandUI_siyang_New(this, 0);
                },
                roundEnd: function() {
        ...
        right: {
            ...
            _event: {
                ...
                initSceneData: function(eD) {
                    SetUserVisible_siyang_New(this, 1);
                },
                addPlayer: function(eD) {
                    SetUserVisible_siyang_New(this, 1);
                },
                ...
                mjhand: function(eD) {
                    InitUserHandUI_siyang_New(this, 1);
                },
                roundEnd: function() {
        ...
        top: {
            ...
            _event: {
                ...
                initSceneData: function(eD) {
                    SetUserVisible_siyang_New(this, 2);
                },
                addPlayer: function(eD) {
                    SetUserVisible_siyang_New(this, 2);
                },
                ...
                mjhand: function(eD) {
                    InitUserHandUI_siyang_New(this, 2);
                },
                roundEnd: function() {
        ...
        left: {
            ...
            _event: {
                ...
                initSceneData: function(eD) {
                    SetUserVisible_siyang_New(this, 3);
                },
                addPlayer: function(eD) {
                    SetUserVisible_siyang_New(this, 3);
                },
                ...
                mjhand: function(eD) {
                    InitUserHandUI_siyang_New(this, 3);
                },
                roundEnd: function() {
        ...
        eat: {
            ...
            guo: {
                ...
                _touch: function(btn, eT) {
                    if (eT == 2)
                    {
                        MjClient.MJPass2NetForSiyang_New();
                    }
                },
                bgimg: {
                    _run: function() {
            ...
            changeui: {
                ...
                changeuibg: {
                    ...
                    guobg: {
                        guo: {
                            _touch: function(btn, eT) {
                                if (eT == 2) MjClient.MJPass2NetForSiyang_New();
                            }
                        },
                        fanhui: {
                            _touch: function(btn, et) {
    ...
    ctor: function() {
        ...
        var playui = ccs.load("Play_siyang_new.json");
...
PlayLayer_siyang_New.prototype.CardLayoutRestore = function(node, off)
{
...
// 判断吃碰杠胡的状态
PlayLayer_siyang_New.prototype.EatVisibleCheck = function()
{
    var eat = MjClient.playui.jsBind.eat;
    ...
    if(vnode.length > 0)
    {
        ...
        for(var i = vnode.length - 1; i > -1; i--)
        {
            ...
            setWgtLayout(vnode[i], [0, 0.2], [0.8, 0], [(i - vnode.length + 1) *1.2, 1.5], false, false);
            /*吃碰杠按钮，适配iOS*/
            if(isIPad() || isIPhoneX()){
                setWgtLayout(vnode[i], [0, 0.2], [0.75, 0], [(i - vnode.length + 1) *1.2, 1.5], false, false);
            }
        }
    }
