...
function SetEndOneUserUI_doudizhuHBTY(node, off) {
        ...
        head: {
            ...
            stand: {
                ...
                _run: function () {
                    ...
                    CardLayoutRestoreForEndOne_doudizhuHBTY(node, pl);
                }
            },
            cardType: {
                _run:function()
        ...
        ,head_bg:{
            bg:{
                _run:function () {
                    if(pl && pl.winone > 0)
                    {
                        this.loadTexture("gameOver/dizhu_red.png");
                    }
                }
            },
            Image_dizhu: {
...
function CardLayoutRestoreForEndOne_doudizhuHBTY(node, plNode) {
...
var EndOneView_doudizhuHBTY = cc.Layer.extend({
    jsBind: {
        block: {
        ...
        back: {
            ...
            ready: {
                ...
                _click: function (btn, eT) {
                    ...
                    if (sData.tData.roundNum <= 0) 
                        MjClient.endoneui.getParent().addChild(new GameOverLayer_DoudizhuHBTY(),500);
            ...
            head0: {
                ...
                _run: function () { SetEndOneUserUI_doudizhuHBTY(this, 0); },
    		...
    		, head1: {
    		    ...
    		    _run: function () { SetEndOneUserUI_doudizhuHBTY(this, 1); }
    		}
    		...
    		, head2: {
    		    ...
    		    _run: function () { SetEndOneUserUI_doudizhuHBTY(this, 2); }
            }
            , publicMutiple: {
                _run:function()
                {
    ...
    ctor: function (zhuang, rate) {
        ...
        var endoneui = ccs.load("endOne_doudizhuHBTY.json");
