...
var CreateRoomNode_doudizhuHBTY = CreateRoomNode.extend({
    setKey:function()
    {
        this.localStorageKey.KEY_DDZTY_playerNumber       = "_DOU_DI_ZHU_HBTY_PLAYER_NUMBER";     //玩家数量
        this.localStorageKey.KEY_DDZTY_fengding           = "_DOU_DI_ZHU_HBTY_FENG_DING";           //封顶 封顶
        this.localStorageKey.KEY_DDZTY_dizhu           = "_DI_ZHU_HBTY_FENG_DING";           //封顶 封顶
        this.localStorageKey.KEY_DDZTY_showCount            = "_DOU_DI_ZHU_HBTY_SHOW_COUNT";           //显示手牌张数
        this.localStorageKey.KEY_DDZTY_yingjiachu         = "_DOU_DI_ZHU_HBTY_yingjiachu";         //赢家出
        this.localStorageKey.KEY_DDZTY_type             = "_DI_ZHU_HBTY_TYPE"; 
        this.localStorageKey.KEY_DDZTY_difen            = "_DI_ZHU_HBTY_DIFEN";        

        this.setExtraKey({
            jieSuanDiFen: "_DOU_DI_ZHU_HBTY_jiesuandifen"
        });
    ...
    initAll:function(IsFriendCard)
    {
        if (!IsFriendCard)
            this.setKey();
        this.bgNode = ccs.load("bg_doudizhuHBTY.json").node;
    ...
    {
        var para = {};
        para.gameType = MjClient.GAME_TYPE.DOU_DI_ZHU_HBTY;
        para.maxPlayer = 3;
