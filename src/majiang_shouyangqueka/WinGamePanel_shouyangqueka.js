...
function SetEndOneUserUI_shouyangqueka(node,off)
{
...
var EndOneView_shouyangqueka = cc.Layer.extend({
	jsBind:{
		block: {
		...
		btnShowHeap:{
                ...
                _click:function()
                {
                    var shouyangquekaCardsHeap = new PopupShowCardsHeap();
                    shouyangquekaCardsHeap.setName("shouyangquekaCardsHeap");
                    MjClient.Scene.addChild(shouyangquekaCardsHeap);
                },
            },
		dir: {
			_visible:true,
		...
		head0:{
		   ...
		   _run:function(){ SetEndOneUserUI_shouyangqueka(this,0); },
		...
		head1:{
		  ...
		  _run:function(){ SetEndOneUserUI_shouyangqueka(this,1); }
		},
		head2:{
		   head:{
			   zhuang:{_visible:false}
		   ...
		   _run:function(){ SetEndOneUserUI_shouyangqueka(this,2); }
		},
		head3:{
			 head:
			 {
			...
			_run:function(){ SetEndOneUserUI_shouyangqueka(this,3); }
			},
		count_down:{
                _visible :function()
                {
    ...
    ctor:function () {
        this._super();
        var endoneui = ccs.load("endOne_shouyangqueka.json");
