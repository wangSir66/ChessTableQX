...
COMMON_UI.showCurrentEatCards = function (vnode) {
    ...
    for (var i = vnode.length - 1; i >= 0; i--) {
        ...
        setWgtLayout(vnode[i], [0, 0.14], [0.96, 0], [-dx * 1.55, 2.2], false, false);
    }
    ...
    var _copyNode = MjClient.playui._AniNode.getChildByName("gang0").getChildByName("card");
    if (!_copyNode) return;
...
/*加载本地头像
*/
COMMON_UI.refreshLocalHead = function (url, head) {
    if (!head) return;
    var clippingNode = head.getChildByName("LocalHeadClippingNode"),
        texture = cc.spriteFrameCache.getSpriteFrame(url || DefaultHeadUrl);
    if (!clippingNode) {
        clippingNode = new cc.ClippingNode();
        var sp = new cc.Sprite(texture);
        var headMask = "A_Common/default_headpic.png";
        ...
        clippingNode.setName("LocalHeadClippingNode");
...
COMMON_UI.addHomeAdvMode = function (advNode, _Y_Pos) {
    ...
    var allAdvImages = {
        "personalStore": {
            icon: "personalStoreicon", bigImage: "personalStoreicon", callback: function (sender, type) {
        ...
        "baojinbuyu": {
            icon: "baojinbuyuicon", bigImage: "baiwanbuyu", callback: function (sender, type) {
                if (type === ccui.Widget.TOUCH_ENDED) {
                    // if(sender.getScale() == 1 && sender.getName() != "page") {
                    //     toPage(3);
                    //     return;
        ...
        "chuanqi": {
            icon: "chuanqilaile-icon-fs8", bigImage: "chuanqilaile-Banner-fs8", callback: function (sender, type) {
                if (type === ccui.Widget.TOUCH_ENDED) {
                    // if(sender.getScale() == 1 && sender.getName() != "page") {
                    //     toPage(0);
                    //     return;
        ...
        "rexue": {
            icon: "rexueheji_icon", bigImage: "rexueheji_banner", callback: function (sender, type) {
                if (type === ccui.Widget.TOUCH_ENDED) {
                    // if(sender.getScale() == 1 && sender.getName() != "page") {
                    //     toPage(1);
                    //     return;
        ...
        "moyu": {
            icon: "moyu_icon", bigImage: "moyulaile", callback: function (sender, type) {
                if (type === ccui.Widget.TOUCH_ENDED) {
                    // if(sender.getScale() == 1 && sender.getName() != "page") {
                    //     toPage(2);
                    //     return;
        ...
        "caiyun": {
            icon: "icon_yinyuancaiyun", bigImage: "banner_yinyuancaiyun", callback: function (sender, type) {
                if (type === ccui.Widget.TOUCH_ENDED) {
                    // if(sender.getScale() == 1 && sender.getName() != "page") {
                    //     toPage(4);
                    //     return;
        ...
        "jiandangjianghu": {
            icon: "jiandangjianghuicon", bigImage: "baiwanbuyu", callback: function (sender, type) {
                if (type === ccui.Widget.TOUCH_ENDED) {
                    // if(sender.getScale() == 1 && sender.getName() != "page") {
                    //     toPage(3);
                    //     return;
        ...
        "buyu": {
            icon: "buyuicon", bigImage: "baiwanbuyu", callback: function (sender, type) {
                if (type === ccui.Widget.TOUCH_ENDED) {
