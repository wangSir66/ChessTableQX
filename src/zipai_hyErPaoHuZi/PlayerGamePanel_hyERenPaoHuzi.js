...
function SetUserVisible_hyERenPaoHuZi(node, off){
    ...
    if(pl){
        ...
        // InitUserHandUI_hyERenPaoHuZi(node, off);
...
function InitUserHandUI_hyERenPaoHuZi(node, off){
...
var PlayLayer_hyERenPaoHuZi = cc.Layer.extend({
    jsBind: {
        _event: {
                ...
                _event:{
                    initSceneData:function(){
                        ...
                        if(next <= 0){
                           ...
                           var maipai = tData.areaSelectMode.huxiType == 0 ? 0 : 20;
                           next -= maipai;
            ...
            cardnumAtlas: {
                ...
                _event: {
                    mjhand: function() {
                        ...
                        var next = MjClient.majiang.getAllCardsTotal() - tData.cardNext;
                        this.y = 40 + next * 0.8
                        if (tData) this.setString(MjClient.majiang.getAllCardsTotal() - tData.cardNext - (MjClient.data.sData.tData.areaSelectMode.huxiType == 0 ? 0 : 20));
                    },
                    initSceneData : function() {
                        this.visible = true;
                        var sData = MjClient.data.sData;
        ...
        roundInfo:{
            ...
            _run:function(){
                ...
                // str += (tData.areaSelectMode.huxiType == 0) ? "21胡息" : "卡20张" ;
                this.ignoreContentAdaptWithSize(true);
                var strPayWay = "";
                var str5 = strPayWay;
        ...
        down: {
            ...
            _event: {
                ...
                initSceneData: function(eD) {
                    SetUserVisible_hyERenPaoHuZi(this, 0);
                    InitUserHandUI_hyERenPaoHuZi(this, 0);
        ...
        right: {
            ...
            _event: {
                ...
                initSceneData: function(eD) {
                    SetUserVisible_hyERenPaoHuZi(this, 1);
                    InitUserHandUI_hyERenPaoHuZi(this, 1);
        ...
        left: {
            ...
            _event: {
                ...
                initSceneData: function(eD) {
                    SetUserVisible_hyERenPaoHuZi(this, 2);
                    InitUserHandUI_hyERenPaoHuZi(this, 2);
    ...
    ctor: function() {
        this._super();
         switch(MjClient.getAppType()){
            case (MjClient.getAppType() == MjClient.APP_TYPE.HUNANWANGWANG || MjClient.getAppType() == MjClient.APP_TYPE.QXSYDTZ):
                var playui = ccs.load("Play_erRenPaoHuZi.json");
                break;
            default:
        ...
        addClub_BackHallBtn(true, [[0.036, 0], [0.83, 0.95], [0, 0]], [[0.036, 0], [0.83, 0.95], [0, 0]]); // 亲友圈返回大厅 
...
//重置手牌的顺序
PlayLayer_hyERenPaoHuZi.prototype.ResetHandCard = function(posNode,off, needAction, isDelay){
...
PlayLayer_hyERenPaoHuZi.prototype._doMovetoAction = function(node,endP){
    node.stopAllActions();
    var ac = cc.moveTo(0.3,endP);
    node.runAction(ac);
};

PlayLayer_hyERenPaoHuZi.prototype.ResetOtherCard = function(posNode, off) {
    //添加吃、碰、跑、偎、提
    var sData = MjClient.data.sData;
    var tData = null;
    if (sData) {
...
PlayLayer_hyERenPaoHuZi.prototype.ResetPutCard = function(posNode, off) {
    //添加打出的牌
    var pl = getUIPlayer_hengYang(off);
...
//重置牌的顺序
PlayLayer_hyERenPaoHuZi.prototype.CardLayoutRestore = function(posNode,off){
    if(MjClient.rePlayVideo == -1){
...
// 判断吃、碰、跑、偎、提、胡的状态
PlayLayer_hyERenPaoHuZi.prototype.EatVisibleCheck = function(off){
    var eat = MjClient.playui.jsBind.eat;
...
PlayLayer_hyERenPaoHuZi.prototype.showAndHideHeadEffect = function(){
