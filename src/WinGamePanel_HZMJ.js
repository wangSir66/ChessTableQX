...
function SetEndOneUserUI_HZMJ(node,off)
{
...
var EndOneView_HZMJ = cc.Layer.extend({
	jsBind:{
		block: {
		...
		head0:{
		   ...
		   _run:function(){ SetEndOneUserUI_HZMJ(this,0); },
		...
		,head1:{ 
		  ...
		  _run:function(){ SetEndOneUserUI_HZMJ(this,1); }
		}
		...
		,head2:{ 
		   ...
		   _run:function(){ SetEndOneUserUI_HZMJ(this,2); }
		}
		,head3:{
			 head:
			 {
			...
			_run:function(){ SetEndOneUserUI_HZMJ(this,3); }
			},
            count_down:{
                _visible :function()
                {
    ...
    ctor:function () {
        this._super();
        var endoneui = ccs.load(res.EndOne_HZMJ_json);
