//跑得快算法类
(function () {
    function GameLogic_NewRunFaster() {
        this.handCount = 10;
        this.laiziCard = -1;
    ...
    GameLogic_NewRunFaster.prototype.initAreaSelectMode = function (areaSelectMode) {
    ...
    GameLogic_NewRunFaster.prototype.CARDTPYE = PDK_CARDTPYE;
    var PDK_CARDCOUNT = {};
    ...
    GameLogic_NewRunFaster.prototype.allTipsNoOrder = [
        [PDK_CARDTPYE.danpai, []],
        [PDK_CARDTPYE.duizi, []],
        [PDK_CARDTPYE.sanzhang, []],
        [PDK_CARDTPYE.sizhang, []],
    ...
    */
     ...
     * @return {number}
     */
    GameLogic_NewRunFaster.prototype.calPoint = function (num, justValue) {
        if (!num)
            return -1;
    ...
    GameLogic_NewRunFaster.prototype.calFlower = function (num) {
        return (num + 3) % 4;
    }
     ...
     * @return {boll} 
     */
    GameLogic_NewRunFaster.prototype.isSanShun = function (oCards) {
    ...
    // cc.log( GameLogic_NewRunFaster.prototype.isSanShun([3,3,3]) );
     ...
     */
    GameLogic_NewRunFaster.prototype.getSanShunAndSanPai = function (oCards) {
        var countSanSame = 0;
        // 记录所有3张的数值
        var sanSameList = [];
        // 记录散牌
    ...
    GameLogic_NewRunFaster.prototype.countDuiNum = function (oCards) {
        var num = 0;
        var cardNumByValue = {};
        for (var i in oCards) {
    ...
    GameLogic_NewRunFaster.prototype.formatFeiJiType = function (oCards) {
        // 记录所有3张的数值
        var sanSameList = [];
        // 记录散牌
        var sanPaiList = [];
     ...
     */
    GameLogic_NewRunFaster.prototype.isFeiJi = function (oCards) {
     ...
     * @return {bool}
     */
    GameLogic_NewRunFaster.prototype.isShun = function (oCards) {
    ...
    GameLogic_NewRunFaster.prototype.isZhaDan = function (oCards, areaSelectMode) {
    ...
    GameLogic_NewRunFaster.prototype.isHadZhaDan = function (cards, areaSelectMode) {
    ...
    // 是否拆散了炸弹牌型
    GameLogic_NewRunFaster.prototype.isChaiZhaDan = function (handCards, putCards, areaSelectMode) {
     ...
     * @return {bool}
     */
    GameLogic_NewRunFaster.prototype.isLiandui = function (oCards) { //oCards有序
     ...
     */
    GameLogic_NewRunFaster.prototype.findShunZi = function (oCards, cardNum, isNeedSameFlower) {
     ...
     */
    GameLogic_NewRunFaster.prototype.calType = function (pCards, areaSelectMode, skipSzdaipai) {
    ...
    GameLogic_NewRunFaster.prototype.cardsType = function (cards, areaSelectMode) {
     ...
     * @return {number}
     */
    GameLogic_NewRunFaster.prototype.calCardsValue = function (cards, type, areaSelectMode) {
    ...
    // 牌点比较函数
    GameLogic_NewRunFaster.prototype.cardValueCmp = function (a, b) {
    ...
    // 排掉从大到小排序
    GameLogic_NewRunFaster.prototype.cardSortBigToSmall = function (a, b) {
        var pa = this.calPoint(a);
        var pb = this.calPoint(b);
        if (pa == pb)
            return b - a;
    ...
    GameLogic_NewRunFaster.prototype.sortBigCardValue = function (a, b) {
     ...
     * @return {number} 返回癞子数
     */
    GameLogic_NewRunFaster.prototype.transformAndGetLaizi = function (oCards, cards) {
        var laizi = 0;
        for (var i = 0; i < oCards.length; i++) {
     ...
     */
    GameLogic_NewRunFaster.prototype.canPut = function (oCards, oLastCards, handsNum, areaSelectMode) {

        var cardsType = this.calType(oCards, areaSelectMode);

        // cc.log("GameLogic_NewRunFaster.prototype.canPut oCards:", oCards );
     ...
     */
    GameLogic_NewRunFaster.prototype.checkPut = function (oHands, cards, lastCards, areaSelectMode, isNextPlayerOneCard, isFirstRound) {
    ...
    GameLogic_NewRunFaster.prototype.getMaxDanPai = function (oCards) {
     ...
     */
    GameLogic_NewRunFaster.prototype.sortHandCards = function (oCards, sortType) {
        var cards = oCards.slice();
     ...
     * @return {array}
     */
    GameLogic_NewRunFaster.prototype.findNSameCard = function (hands, point, n) {
    ...
    // 删除相应牌值
    GameLogic_NewRunFaster.prototype.delPoint = function (hands, points, values) {
        var arr = hands.slice();
     ...
     */
    GameLogic_NewRunFaster.prototype.lieju = function (parr, num) {
        var tmps = [];
    ...
    GameLogic_NewRunFaster.prototype.formatCards = function (oCards) {
        var info = {};
    ...
    GameLogic_NewRunFaster.prototype.indexOfCards = function (cardList, cards) {
    ...
    GameLogic_NewRunFaster.prototype.isSameCards = function (cards1, cards2) {
     ...
     */
    GameLogic_NewRunFaster.prototype.findCardByRole = function (oCards, findNum, ignoreCardValued) {
     ...
     * @param {array} 拼好的 
     */
    GameLogic_NewRunFaster.prototype.findCardByType = function (hands, laizi, type, lastCards, buChaiTypes) {
        var rets = [];
        var laizis = [];
    ...
    // var fc = GameLogic_NewRunFaster.prototype.findCardByType([19,19,19,15,15], 0, PDK_CARDTPYE.sandaier, [9,9,9,15,15])
    // cc.log( fc )

    GameLogic_NewRunFaster.prototype.getAllMaxCard = function (oCards) {
    ...
    GameLogic_NewRunFaster.prototype.sortByCardType = function (cardsList, areaSelectMode) {
    ...
    GameLogic_NewRunFaster.prototype.findDaiPai = function (oCards, type, findNum, same, buChaiTypes) {
        var ret = [];
    ...
    // 此函数只供提示出牌调用
    GameLogic_NewRunFaster.prototype.findCardByType_fast = function (hands, laizi, type, lastCards, buChaiTypes) {
    ...
    GameLogic_NewRunFaster.prototype.initCanPutTypes = function (hands, includeCard, areaSelectMode) {
     ...
     * @return {array} 提示的牌
     */
    GameLogic_NewRunFaster.prototype.findPutTipCards = function (hands, lastCards, areaSelectMode, isNextPlayerOneCard, isFirstRound, putOrder, allBuChaiTypes) {
     ...
     * @return {Boolean} 
     */
    GameLogic_NewRunFaster.prototype.isMustPutCard3 = function (oHands, areaSelectMode, isFirstRound) {
        let bankerRule = areaSelectMode && areaSelectMode.mustPutHongTaoSan;
        needFindSpade3 = false;
        if (bankerRule === this.GameBankerRule.EveryRoundPlaySpade3) {
            needFindSpade3 = true;
     ...
     * @return {array} 提示的牌
     */
    GameLogic_NewRunFaster.prototype.tipCards = function (oHands, oLastCards, areaSelectMode, isNextPlayerOneCard, isFirstRound, isSmartTip) {
        var rets = [],
     ...
     */
    GameLogic_NewRunFaster.prototype.IsSametipCards = function (tipscardsArray, areaSelectMode) {
     ...
     * @param  {Boolean} areaSelectMode 创建房间的选项
     */
    GameLogic_NewRunFaster.prototype.delDaipai = function (Cards, areaSelectMode) {
        var cardtype = this.calType(Cards, areaSelectMode);
    ...
    if (typeof (module) != "undefined" && module.exports)
        module.exports = GameLogic_NewRunFaster;

    if (typeof (MjClient) != "undefined")
        MjClient.majiang_runfasterya = new GameLogic_NewRunFaster();
