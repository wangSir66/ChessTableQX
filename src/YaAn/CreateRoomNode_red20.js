...
var CreateRoomNode_red20 = cc.Node.extend({
    _view: null,
    bg_node: null,
    _data: null,
    ctor: function (layer, data) {
        ...
        this._selectColor = CREATEROOM_COLOR_1;
        this._unSelectColor = CREATEROOM_COLOR_3;
    ...
    initAll: function (IsFriendCard) {
        ...
        cc.log('this.bg_nodethis.bg_node', this._view)
    },
    //事件监听
    initLister: function () {
    ...
    initRoundNode: function () {
        //打几局  ，选择局数
        var _round = this._view.getChildByName("jushu");
        this.roundNodeArray = [];
        var roundNode = _round.getChildByName("btnRadio" + this.roundNodeArray.length);
        while (roundNode && roundNode.isVisible()) {
            cc.log("============btnRadio=============btnRadio ");
            this.roundNodeArray.push(roundNode);
            roundNode = _round.getChildByName("btnRadio" + this.roundNodeArray.length);
        }
        _round = this._view.getChildByName("zhifufangshi");
        this.payWayNodeArray = [];
        let num = 29
        while (_round.getChildByName("btnRadio" + num)) {
            this.payWayNodeArray.push(_round.getChildByName("btnRadio" + num));
            num++
        }
