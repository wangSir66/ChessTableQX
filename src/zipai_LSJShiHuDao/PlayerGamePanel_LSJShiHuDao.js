...
function SetUserVisible_LSJShiHuDao(node, off){
    ...
    if(pl){
        ...
        // InitUserHandUI_syShiHuKa(node, off);
...
function InitUserHandUI_LSJShiHuDao(node, off){
...
var PlayLayer_LSJShiHuDao = cc.Layer.extend({
    jsBind: {
        _event: {
            ...
            roundEnd: function() {
                ...
                function delayExe(){
                    ...
                    if(!MjClient.endoneui){
                        self.addChild(new EndOneView_lsjShiHuDao(), 500);  
                    }
        ...
        roundInfo:{
            ...
            _run:function(){
                var tData = MjClient.data.sData.tData;
                var str = "";
                str += tData.areaSelectMode.maxPlayer + "人玩,";
                str += (tData.areaSelectMode.isJiaChui) ? "加锤," : "不锤," ;
                str += (tData.areaSelectMode.isMingWei) ? "明偎," : "暗偎," ;
                str += (tData.areaSelectMode.isManualCutCard) ? "手动切牌" : "系统切牌" ;
                str += tData.areaSelectMode.fanBei == 1 ? ",小于" + tData.areaSelectMode.fanBeiScore + "分翻倍" : "";
        ...
        down: {
            head: {
                chuizi_tips : {
                    _run: function(){
                        setJiachuiImgTips_hengYang(this, 0);
                    },
                    _event: {
                        initSceneData: function() {
                            setJiachuiImgTips_hengYang(this, 0);
                ...
                jiachuiText_tips : {
                    _run: function() {
                        setJiachuiTextTips_hengYang(this, 0);
                    },
                    _event:{
                        initSceneData: function() {
                            setJiachuiTextTips_hengYang(this, 0);
            ...
            _event: {
                ...
                initSceneData: function(eD) {
                    SetUserVisible_LSJShiHuDao(this, 0);
                    InitUserHandUI_LSJShiHuDao(this, 0);
        ...
        right: {
            ...
            head: {
                chuizi_tips : {
                    _run: function(){
                        setJiachuiImgTips_hengYang(this, 1);
                    },
                    _event: {
                        initSceneData: function() {
                            setJiachuiImgTips_hengYang(this, 1);
                ...
                jiachuiText_tips : {
                    _run:function() {
                        setJiachuiTextTips_hengYang(this, 1);
                    },
                    _event:{
                        initSceneData: function() {
                            setJiachuiTextTips_hengYang(this, 1);
            ...
            _event: {
                ...
                initSceneData: function(eD) {
                    SetUserVisible_LSJShiHuDao(this, 1);
                    InitUserHandUI_LSJShiHuDao(this, 1);
        ...
        left: {
            ...
            head: {
                chuizi_tips : {
                    _run: function(){
                        setJiachuiImgTips_hengYang(this, MjClient.MaxPlayerNum_leiyang-1);
                    },
                    _event: {
                        initSceneData: function() {
                            setJiachuiImgTips_hengYang(this, MjClient.MaxPlayerNum_leiyang-1);
                ...
                jiachuiText_tips : {
                    _run:function() {
                        setJiachuiTextTips_hengYang(this, MjClient.MaxPlayerNum_leiyang-1);
                    },
                    _event:{
                        initSceneData: function() {
                            setJiachuiTextTips_hengYang(this, MjClient.MaxPlayerNum_leiyang-1);
            ...
            _event: {
                ...
                initSceneData: function(eD) {
                    SetUserVisible_LSJShiHuDao(this, MjClient.MaxPlayerNum_leiyang-1);
                    InitUserHandUI_LSJShiHuDao(this, MjClient.MaxPlayerNum_leiyang-1);
    ...
    ctor: function() {
        this._super();
        var playui = ccs.load("Play_LSJShiHuDao.json");
        playMusic("bgFight");
        var tData = MjClient.data.sData.tData;
...
//重置手牌的顺序
PlayLayer_LSJShiHuDao.prototype.ResetHandCard = function(posNode,off, needAction, isDelay){

    // needAction = needAction === undefined ? false : needAction;
    // needAction = false;

    if(off == 0){
        resetHandCard_hengYangEx(posNode,off, needAction, isDelay);
...
PlayLayer_LSJShiHuDao.prototype._doMovetoAction = function(node,endP){
    node.stopAllActions();
    var ac = cc.moveTo(0.3,endP);
    node.runAction(ac);
};

PlayLayer_LSJShiHuDao.prototype.ResetOtherCard = function(posNode, off) {
    //添加吃、碰、跑、偎、提
    var sData = MjClient.data.sData;
    var tData = null;
    if (sData) {
...
PlayLayer_LSJShiHuDao.prototype.ResetPutCard = function(posNode,off){
    //添加打出的牌
    var pl = getUIPlayer_hengYang(off);
...
//重置牌的顺序
PlayLayer_LSJShiHuDao.prototype.CardLayoutRestore = function(posNode,off){
    if(MjClient.rePlayVideo == -1){
...
// 判断吃、碰、跑、偎、提、胡的状态
PlayLayer_LSJShiHuDao.prototype.EatVisibleCheck = function(off){
    var eat = MjClient.playui.jsBind.eat;
...
PlayLayer_LSJShiHuDao.prototype.showAndHideHeadEffect = function(){
