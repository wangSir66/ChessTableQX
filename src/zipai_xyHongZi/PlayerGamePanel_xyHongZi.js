...
//     }else{
//         HZPassConfirmToServer_xyHongZi();
//     }
// };

// 这个没看懂干嘛的
// off 是四个位置，根据off 显示四个位置的信息 by sking
function SetUserVisible_xyHongZi(node, off){
    ...
    if(pl){
        ...
        setUserOffline_xyHongZi(node, off);
        // InitUserHandUI_xyHongZi(node, off);
...
function InitUserHandUI_xyHongZi(node, off){
    ...
    if (pl.jiazhuNum == 2 && MjClient.rePlayVideo == -1)
    {
        ...
        MjClient.majiang.setJiaZhuNum(node, getUIPlayer_xyHongZi(off));
    }
...
var PlayLayer_xyHongZi = cc.Layer.extend({
    jsBind: {
        _event: {
            mjhand: function() {
            ...
            endRoom: function(msg) {
                ...
                if (msg.showEnd){
                    this.addChild(new GameOverLayer_xyHongZi(),500);
                }else{
            ...
            roundEnd: function() {
                ...
                if(!MjClient.isDismiss && tData.hunCard && tData.hunCard != -1 && tData.areaSelectMode.xingType==2){
                    ...
                    ShowEatActionAnim_xyHongZi(MjClient.playui._downNode, ActionType_paohuzi.FANXING, 0);
                    DealFanXingNewCard_xyHongZi(hunCard);
                }
                ...
                function delayExe(){
                    ...
                    if (sData.tData.roundNum <= 0){
                        var layer = new GameOverLayer_xyHongZi();
                        // layer.setVisible(false);
                        self.addChild(layer,500);
                    }
                    if(!MjClient.endoneui){
                        self.addChild(new EndOneView_xyHongZi(),500);
                    }
            ...
            moveHead: function() {
                ...
                //tableStartHeadMoveAction_xyHongZi(this);   //不涉及到头像移动动作
            },
            initSceneData: function() {
                ...
                reConectHeadLayout_xyHongZi(this);        //不涉及到头像移动动作
                CheckRoomUiDelete();
                tableStartHeadMoveAction_xyHongZi(this);   //不涉及到头像移动动作
            ...
            changeMJBgEvent: function() {
                changeMJBg_xyHongZi(this, ziPai.getZiPaiType());
            },
            MJPeng: function() {
                MjClient.playui.showAndHideHeadEffect();
            },
        ...
        cardNumImg: {
            ...
            _event: {
                initSceneData: function(eD) {
                    this.visible = IsArrowVisible_xyHongZi();
                },
                mjhand: function(eD) {
                    this.visible = IsArrowVisible_xyHongZi();
                },
        ...
        banner: {
            ...
            getRoomNum: {
                ...
                _click: function() {
                    ...
                    str += tData.areaSelectMode.isJuJuHong ? ",花胡" : ""; 
                    str += tData.areaSelectMode.isQiDui ? ",七对" : "";
                    str += tData.areaSelectMode.isShangShou ? ",蝴蝶可上手" : "";
                    ...
                    if(MjClient.MaxPlayerNum_xyHongZi == 3){
                        if((MjClient.MaxPlayerNum_xyHongZi - Object.keys(sData.players).length) == 2){
                            str7 = "  一缺二";
                        }
                    }else if(MjClient.MaxPlayerNum_xyHongZi == 4){
                        if((MjClient.MaxPlayerNum_xyHongZi - Object.keys(sData.players).length) == 3){
                            str7 = "  一缺三";
                        }else if((MjClient.MaxPlayerNum_xyHongZi - Object.keys(sData.players).length) == 2){
                            str7 = "二缺二";
                        }else  if((MjClient.MaxPlayerNum_xyHongZi - Object.keys(sData.players).length) == 1){
                            str7 = "三缺一";
                        }
                    }
            ...
            gps_btn: {
                ...
                _run:function(){
                    this.setEnabled(MjClient.MaxPlayerNum_xyHongZi >= 3);
                },
                _click: function() {
                    if(MjClient.MaxPlayerNum_xyHongZi == 3){
        ...
        wait: {
            ...
            delroom: {
                ...
                _event: {
                    initSceneData: function(eD) {
                        //this.visible = isShowBackBtn_xyHongZi();
                    },
                    removePlayer: function(eD) {
                        //this.visible = isShowBackBtn_xyHongZi();
                    },
        ...
        down: {
            head: {
                zhuang: {
                    ...
                    _event: {
                        waitPut: function(){
                            showUserZhuangLogo_xyHongZi(this, 0);
                        },
                        initSceneData: function(){
                            if (IsArrowVisible_xyHongZi()) showUserZhuangLogo_xyHongZi(this, 0);
                        },
                        mjhand: function(){
                            if (IsArrowVisible_xyHongZi()) showUserZhuangLogo_xyHongZi(this, 0);
                        }
                    ...
                    chattext: {
                        _event: {
                            ...
                            MJChat: function(msg) {
                                ...
                                showUserChat_xyHongZi(this, 0, msg);
                            },
                            playVoice: function(voicePath) {
                                MjClient.data._tempMessage.msg = voicePath;
                                showUserChat_xyHongZi(this, 0, MjClient.data._tempMessage);
                            }
                        }
                    }
                },
                _click: function(btn) {
                    showPlayerInfo_xyHongZi(0, btn);
                },
                _event: {
                    loadWxHead: function(d) {
                        setWxHead_xyHongZi(this, d, 0);
                    },
                    addPlayer: function(eD) {
                        showFangzhuTagIcon_xyHongZi(this,0);
                    },
                    removePlayer: function(eD) {
                        showFangzhuTagIcon_xyHongZi(this,0);
                    }
                ...
                huxi:{
                    ...
                    _event:{
                        ...
                        initSceneData:function(){
                            // this.visible = true;
                            var huXi = UpdateHuXi_xyHongZi(0);
                            if(!IsArrowVisible_xyHongZi()){
                                huXi = 0;
                            }
                ...
                timeImg:{
                    ...
                    _event:{
                        initSceneData: function(eD) {
                            //this.visible = curPlayerIsMe_xyHongZi(0);
                        },
                        onlinePlayer: function(eD) {
                            //this.visible = curPlayerIsMe_xyHongZi(0) && IsArrowVisible_xyHongZi();
                        },
                        waitPut: function(eD) {
                            //this.visible = curPlayerIsMe_xyHongZi(0);
                        },
                    ...
                    time:{
                        ...
                        _event: {
                            ...
                            onlinePlayer: function(){
                                ...
                                if(pl && pl.onLine && curPlayerIsMe_xyHongZi(0)){
                                    arrowbkNumberUpdate(this);
                                }
                            },
                            roundEnd: function() {
            ...
            ready: {
                ...
                _run: function() {
                    GetReadyVisible_xyHongZi(this, 0);
                },
                _event: {
                    startShuffleCards:function () {
                        GetReadyVisible_xyHongZi(this, -1);
                    },
                    moveHead: function() {
                        GetReadyVisible_xyHongZi(this, -1);
                    },
                    addPlayer: function() {
                        GetReadyVisible_xyHongZi(this, 0);//根据状态设置ready 是否可见 add by sking
                    },
                    removePlayer: function() {
                        GetReadyVisible_xyHongZi(this, 0);
                    },
            ...
            handNode: {
                ...
                _event:  {
                    ...
                    MJPass: function() { // 天胡 提 偎 跑后过胡
                        calculateHintPutList_xyHongZi();
                        addTingSign_xyHongZi(MjClient.playui._downNode);
                    },
            ...
            _event: {
                ...
                initSceneData: function(eD) {
                    SetUserVisible_xyHongZi(this, 0);
                    InitUserHandUI_xyHongZi(this, 0);
                    InitUserCoinAndName_xyHongZi(this, 0);
                    MjClient.hasPut = false; // 重连回来重置打掉牌标志（打牌时候断线)
                    ShowPutCardIcon_xyHongZi();
                    DealOffLineCard_xyHongZi(this,0);
                },
                addPlayer: function(eD) {
                    SetUserVisible_xyHongZi(this, 0);
                    InitUserCoinAndName_xyHongZi(this, 0);
                ...
                mjhand: function(eD) {
                    ...
                    var uid = getUIPlayer_xyHongZi(0).info.uid;
                    if (eD.jiazhuNums)
                    {
                ...
                HZNewCard: function(eD) {
                    ...
                    DealNewCard_xyHongZi(this,eD,0);
                },
                MJPut: function(eD) {
                    DealPutCard_xyHongZi(this,eD,0);
                },
                HZChiCard: function(eD) {
                    DealChiCard_xyHongZi(this, eD, 0);
                    ShowPutCardIcon_xyHongZi();
                },
                HZWeiCard: function(eD){
                    DealWeiCard_xyHongZi(this,eD,0);
                },
                HZGangCard: function(eD) {
                    DealGangCard_xyHongZi(this, eD, 0);
                },
                MJPeng: function(eD) {
                    DealPengCard_xyHongZi(this, eD, 0);
                    ShowPutCardIcon_xyHongZi();
                },
                MJHu: function(eD) {
                    DealHu_xyHongZi(this, eD, 0);
                },
                onlinePlayer: function(eD) {
                    resetHandAfterBegin_xyHongZi();
                    setUserOffline_xyHongZi(this, 0);
                },
                ...
                MJJiazhu: function(msg) {
                    ...
                    MjClient.majiang.setJiaZhuNum(MjClient.playui._downNode, getUIPlayer_xyHongZi(0));
                    MjClient.majiang.setJiaZhuNum(MjClient.playui._rightNode, getUIPlayer_xyHongZi(1));
                    MjClient.majiang.setJiaZhuNum(MjClient.playui._topNode, getUIPlayer_xyHongZi(2));
                },
                ...
                HZAddCards:function (eD) {
                    DealAddCard_xyHongZi(this,eD, 0);
                },
        ...
        xing: {
            _run:function () {
                if(MjClient.MaxPlayerNum_xyHongZi == 3 || MjClient.MaxPlayerNum_xyHongZi == 2){
                    this.setVisible(false);
                }
            },
            head: {
                    ...
                    _event: {
                        waitPut: function() {
                            if(MjClient.MaxPlayerNum_xyHongZi == 4) {
                                showUserZhuangLogo_xyHongZi(this, 1);
                            }
                        },
                        initSceneData: function() {
                            if(MjClient.MaxPlayerNum_xyHongZi == 4) {
                                if (IsArrowVisible_xyHongZi()) showUserZhuangLogo_xyHongZi(this, 1);
                            }
                        },
                        mjhand: function(){
                            if(MjClient.MaxPlayerNum_xyHongZi == 4) {
                ...
                chatbg: {
                    ...
                    chattext: {
                        _event: {
                            MJChat: function(msg) {
                                if(MjClient.MaxPlayerNum_xyHongZi == 4) {
                                    showUserChat_xyHongZi(this, 1, msg);
                                }
                            },
                            playVoice: function(voicePath) {
                                if(MjClient.MaxPlayerNum_xyHongZi == 4) {
                                    MjClient.data._tempMessage.msg = voicePath;
                                    showUserChat_xyHongZi(this, 1, MjClient.data._tempMessage);
                                }
                            }
                        }
                    }
                ...
                _click: function(btn) {
                    if(MjClient.MaxPlayerNum_xyHongZi == 4) {
                        showPlayerInfo_xyHongZi(1, btn);
                    }
                },
                _event: {
                    loadWxHead: function(d) {
                        if(MjClient.MaxPlayerNum_xyHongZi == 4) {
                            setWxHead_xyHongZi(this, d, 1);
                        }
                    },
                    addPlayer: function(eD) {
                        if(MjClient.MaxPlayerNum_xyHongZi == 4) {
                            showFangzhuTagIcon_xyHongZi(this, 1);
                        }
                    },
                    removePlayer: function(eD) {
                        if(MjClient.MaxPlayerNum_xyHongZi == 4) {
                ...
                huxi:{
                    ...
                    _event:{
                        ...
                        initSceneData:function(){
                            if(MjClient.MaxPlayerNum_xyHongZi == 4) {
                                // this.visible = true;
                                var huXi = UpdateHuXi_xyHongZi(1);
                                if (!IsArrowVisible_xyHongZi()) {
                                    huXi = 0;
                                }
                                return this.setString("胡息:" + huXi);
                ...
                timeImg:{
                    ...
                    _event:{
                        initSceneData: function(eD) {
                            if(MjClient.MaxPlayerNum_xyHongZi == 4) {
                                //this.visible = curPlayerIsMe_xyHongZi(1);
                            }
                            // MjClient.playui.refreshHeadLight(true);
                        },
                        onlinePlayer: function(eD) {
                            if(MjClient.MaxPlayerNum_xyHongZi == 4) {
                                //this.visible = curPlayerIsMe_xyHongZi(1) && IsArrowVisible_xyHongZi();
                            }
                        },
                        waitPut: function(eD) {
                            if(MjClient.MaxPlayerNum_xyHongZi == 4) {
                        ...
                        _event: {
                            ...
                            onlinePlayer: function(){
                                if(MjClient.MaxPlayerNum_xyHongZi == 4) {
                                    ...
                                    stopEffect(playTimeUpEff);
                                    playTimeUpEff = null;
                                    var pl = getUIPlayer_xyHongZi(1);
                                    if (pl && pl.onLine && curPlayerIsMe_xyHongZi(1)) {
                                        arrowbkNumberUpdate(this);
                                    }
                                }
                            },
            ...
            _event: {
                ...
                initSceneData: function(eD) {
                    if(MjClient.MaxPlayerNum_xyHongZi == 4) {
                        SetUserVisible_xyHongZi(this, 1);
                        InitUserHandUI_xyHongZi(this, 1);
                        InitUserCoinAndName_xyHongZi(this, 1);
                        DealOffLineCard_xyHongZi(this, 1);
                    }
                },
                addPlayer: function(eD) {
                    if(MjClient.MaxPlayerNum_xyHongZi == 4) {
                ...
                HZNewCard: function(eD) {
                    if(MjClient.MaxPlayerNum_xyHongZi == 4) {
                        ...
                        DealNewCard_xyHongZi(this, eD, 1);
                    }
                },
                roundEnd: function() {
                    if(MjClient.MaxPlayerNum_xyHongZi == 4) {
                ...
                MJPut: function(eD) {
                    if(MjClient.MaxPlayerNum_xyHongZi == 4) {
                        DealPutCard_xyHongZi(this, eD, 1);
                    }
                },
                HZChiCard: function(eD) {
                    if(MjClient.MaxPlayerNum_xyHongZi == 4) {
                        DealChiCard_xyHongZi(this, eD, 1);
                    }
                },
                HZGangCard: function(eD) {
                    if(MjClient.MaxPlayerNum_xyHongZi == 4) {
                        DealGangCard_xyHongZi(this, eD, 1);
                    }
                },
                MJPeng: function(eD) {
                    if(MjClient.MaxPlayerNum_xyHongZi == 4) {
                        DealPengCard_xyHongZi(this, eD, 1);
                    }
                },
                HZWeiCard: function(eD){
                    if(MjClient.MaxPlayerNum_xyHongZi == 4) {
                        DealWeiCard_xyHongZi(this, eD, 1);
                    }
                },
                MJHu: function(eD) {
                    if(MjClient.MaxPlayerNum_xyHongZi == 4) {
                        DealHu_xyHongZi(this, eD, 1);
                    }
                },
                onlinePlayer: function(eD) {
                    if(MjClient.MaxPlayerNum_xyHongZi == 4) {
                        setUserOffline_xyHongZi(this, 1);
                    }
                },
                playerStatusChange: function(eD) {
                    if(MjClient.MaxPlayerNum_xyHongZi == 4) {
                ...
                HZAddCards:function (eD) {
                    if(MjClient.MaxPlayerNum_xyHongZi == 4) {
                        DealAddCard_xyHongZi(this, eD, 1);
                    }
                },
                HZCheckRaise:function (msg) {
                    if(MjClient.MaxPlayerNum_xyHongZi == 4) {
        ...
        right: {
            _run:function(){
                if(MjClient.MaxPlayerNum_xyHongZi == 2)
                    this.setVisible(false);
            },
            head: {
                zhuang: {
                    ...
                    _event: {
                        waitPut: function() {
                            // var maxNum = MjClient.MaxPlayerNum_xyHongZi == 2 ?

                            showUserZhuangLogo_xyHongZi(this, MjClient.playui.rightMaxPlayerNum());
                        },
                        initSceneData: function() {
                            if (IsArrowVisible_xyHongZi()) showUserZhuangLogo_xyHongZi(this, MjClient.playui.rightMaxPlayerNum());
                        },
                        mjhand: function(){
                            if (IsArrowVisible_xyHongZi()) showUserZhuangLogo_xyHongZi(this, MjClient.playui.rightMaxPlayerNum());
                        }
                ...
                chatbg: {
                    ...
                    chattext: {
                        _event: {
                            MJChat: function(msg) {
                                showUserChat_xyHongZi(this, MjClient.playui.rightMaxPlayerNum(), msg);
                            },
                            playVoice: function(voicePath) {
                                MjClient.data._tempMessage.msg = voicePath;
                                showUserChat_xyHongZi(this, MjClient.playui.rightMaxPlayerNum(), MjClient.data._tempMessage);
                            }
                        }
                    }
                },
                _click: function(btn) {
                    showPlayerInfo_xyHongZi(MjClient.playui.rightMaxPlayerNum(), btn);
                },
                _event: {
                    loadWxHead: function(d) {
                        setWxHead_xyHongZi(this, d, MjClient.playui.rightMaxPlayerNum());
                    },
                    addPlayer: function(eD) {
                        showFangzhuTagIcon_xyHongZi(this,MjClient.playui.rightMaxPlayerNum());
                    },
                    removePlayer: function(eD) {
                        showFangzhuTagIcon_xyHongZi(this,MjClient.playui.rightMaxPlayerNum());
                    }
                ...
                huxi:{
                    ...
                    _event:{
                        ...
                        initSceneData:function(){
                            // this.visible = true;
                            var huXi = UpdateHuXi_xyHongZi(MjClient.playui.rightMaxPlayerNum());
                            if(!IsArrowVisible_xyHongZi()){
                                huXi = 0;
                            }
                            return this.setString("胡息:" + huXi);
                ...
                timeImg:{
                    ...
                    _event:{
                        initSceneData: function(eD) {
                            //this.visible = curPlayerIsMe_xyHongZi(MjClient.playui.rightMaxPlayerNum());
                        },
                        onlinePlayer: function(eD) {
                            //this.visible = curPlayerIsMe_xyHongZi(MjClient.playui.rightMaxPlayerNum()) && IsArrowVisible_xyHongZi();
                        },
                        waitPut: function(eD) {
                            //this.visible = curPlayerIsMe_xyHongZi(MjClient.playui.rightMaxPlayerNum());
                        },
                    ...
                    time:{
                        ...
                        _event: {
                            initSceneData: function(eD) {
                                ...
                                stopEffect(playTimeUpEff);
                                playTimeUpEff = null;
                                if(curPlayerIsMe_xyHongZi(MjClient.playui.rightMaxPlayerNum())){
                                    arrowbkNumberUpdate(this);
                                    this.setString("00");
                                }
                            },
                            ...
                            onlinePlayer: function(){
                                ...
                                stopEffect(playTimeUpEff);
                                playTimeUpEff = null;
                                var pl = getUIPlayer_xyHongZi(MjClient.playui.rightMaxPlayerNum());
                                if(pl && pl.onLine && curPlayerIsMe_xyHongZi(MjClient.playui.rightMaxPlayerNum())){
                                    arrowbkNumberUpdate(this);
                                }
                            },
                            roundEnd: function() {
            ...
            ready: {
                _layout: [[0.07, 0.07],[0.5, 0.5],[2.5, 2.5]],
                _run: function() {
                    GetReadyVisible_xyHongZi(this, MjClient.playui.rightMaxPlayerNum());
                },
                _event: {
                    startShuffleCards:function () {
                        GetReadyVisible_xyHongZi(this, -1);
            ...
            _event: {
                clearCardUI: function() {
                    clearCardUI_xyHongZi(this, MjClient.playui.rightMaxPlayerNum());
                },
                clearCardArr: function(){
                    var eatNode = this.getChildByName("eatNode");
                    eatNode.removeAllChildren();
                ...
                initSceneData: function(eD) {
                    SetUserVisible_xyHongZi(this, MjClient.playui.rightMaxPlayerNum());
                    InitUserHandUI_xyHongZi(this, MjClient.playui.rightMaxPlayerNum());
                    InitUserCoinAndName_xyHongZi(this, MjClient.playui.rightMaxPlayerNum());
                    DealOffLineCard_xyHongZi(this,MjClient.playui.rightMaxPlayerNum());
                },
                addPlayer: function(eD) {
                    SetUserVisible_xyHongZi(this, MjClient.playui.rightMaxPlayerNum());
                    InitUserCoinAndName_xyHongZi(this, MjClient.playui.rightMaxPlayerNum());
                ...
                HZNewCard: function(eD) {
                    ...
                    DealNewCard_xyHongZi(this,eD,MjClient.playui.rightMaxPlayerNum());
                },
                roundEnd: function() {
                    InitUserCoinAndName_xyHongZi(this, MjClient.playui.rightMaxPlayerNum());
                ...
                MJPut: function(eD) {
                    DealPutCard_xyHongZi(this, eD, MjClient.playui.rightMaxPlayerNum());
                },
                HZChiCard: function(eD) {
                    DealChiCard_xyHongZi(this, eD, MjClient.playui.rightMaxPlayerNum());
                },
                HZGangCard: function(eD) {
                    DealGangCard_xyHongZi(this, eD, MjClient.playui.rightMaxPlayerNum());
                },
                MJPeng: function(eD) {
                    DealPengCard_xyHongZi(this, eD, MjClient.playui.rightMaxPlayerNum());
                },
                HZWeiCard: function(eD){
                    DealWeiCard_xyHongZi(this, eD, MjClient.playui.rightMaxPlayerNum());
                },
                MJHu: function(eD) {
                    DealHu_xyHongZi(this, eD, MjClient.playui.rightMaxPlayerNum());
                },
                onlinePlayer: function(eD) {
                    setUserOffline_xyHongZi(this, MjClient.playui.rightMaxPlayerNum());
                },
                playerStatusChange: function(eD) {
                    setUserOffline_xyHongZi(this, MjClient.playui.rightMaxPlayerNum());
                },
                ...
                HZAddCards:function (eD) {
                    DealAddCard_xyHongZi(this,eD, MjClient.playui.rightMaxPlayerNum());
                },
                HZCheckRaise:function (msg) {
                    ShowPutCardIcon_xyHongZi();
                    //MjClient.playui.EatVisibleCheck();
        ...
        left: {
            ...
            head: {
                zhuang: {
                    ...
                    _event: {
                        waitPut: function() {
                            showUserZhuangLogo_xyHongZi(this, MjClient.MaxPlayerNum_xyHongZi - 1);
                        },
                        initSceneData: function() {
                            if (IsArrowVisible_xyHongZi()) showUserZhuangLogo_xyHongZi(this, MjClient.MaxPlayerNum_xyHongZi - 1);
                        },
                        mjhand: function(){
                            if (IsArrowVisible_xyHongZi()) showUserZhuangLogo_xyHongZi(this, MjClient.MaxPlayerNum_xyHongZi - 1);
                        }
                ...
                chatbg: {
                    ...
                    chattext: {
                        _event: {
                            MJChat: function(msg) {
                                showUserChat_xyHongZi(this, MjClient.MaxPlayerNum_xyHongZi - 1, msg);
                            },
                            playVoice: function(voicePath) {
                                MjClient.data._tempMessage.msg = voicePath;
                                showUserChat_xyHongZi(this, MjClient.MaxPlayerNum_xyHongZi - 1, MjClient.data._tempMessage);
                            }
                        }
                    }
                },
                _click: function(btn) {
                    showPlayerInfo_xyHongZi(MjClient.MaxPlayerNum_xyHongZi - 1, btn);
                },
                _event: {
                    loadWxHead: function(d) {
                        setWxHead_xyHongZi(this, d, MjClient.MaxPlayerNum_xyHongZi - 1);
                    },
                    addPlayer: function(eD) {
                        showFangzhuTagIcon_xyHongZi(this,MjClient.MaxPlayerNum_xyHongZi - 1);
                    },
                    removePlayer: function(eD) {
                        showFangzhuTagIcon_xyHongZi(this,MjClient.MaxPlayerNum_xyHongZi - 1);
                    }
                ...
                huxi:{
                    ...
                    _event:{
                        ...
                        initSceneData:function(){
                            // this.visible = true;
                            var huXi = UpdateHuXi_xyHongZi(MjClient.MaxPlayerNum_xyHongZi - 1);
                            if(!IsArrowVisible_xyHongZi()){
                                huXi = 0;
                            }
                            return this.setString("胡息:" + huXi);
                ...
                timeImg:{
                    ...
                    _event:{
                        initSceneData: function(eD) {
                            //this.visible = curPlayerIsMe_xyHongZi(MjClient.MaxPlayerNum_xyHongZi - 1);
                        },
                        onlinePlayer: function(eD) {
                            //this.visible = curPlayerIsMe_xyHongZi(MjClient.MaxPlayerNum_xyHongZi - 1) && IsArrowVisible_xyHongZi();
                        },
                        waitPut: function(eD) {
                            //this.visible = curPlayerIsMe_xyHongZi(MjClient.MaxPlayerNum_xyHongZi - 1);
                        },
                    ...
                    time:{
                        ...
                        _event: {
                            initSceneData: function(eD) {
                                ...
                                stopEffect(playTimeUpEff);
                                playTimeUpEff = null;
                                if(curPlayerIsMe_xyHongZi(MjClient.MaxPlayerNum_xyHongZi - 1)){
                                    arrowbkNumberUpdate(this);
                                    this.setString("00");
                                }
                            },
                            ...
                            onlinePlayer: function(){
                                ...
                                stopEffect(playTimeUpEff);
                                playTimeUpEff = null;
                                var pl = getUIPlayer_xyHongZi(MjClient.MaxPlayerNum_xyHongZi - 1);
                                if(pl && pl.onLine && curPlayerIsMe_xyHongZi(MjClient.MaxPlayerNum_xyHongZi - 1)){
                                    arrowbkNumberUpdate(this);
                                }
                            },
                            roundEnd: function() {
            ...
            ready: {
                _layout: [[0.07, 0.07],[0.5, 0.5],[-2.5, 2.5]],
                _run: function() {
                    GetReadyVisible_xyHongZi(this, MjClient.MaxPlayerNum_xyHongZi - 1);
                },
                _event: {
                    startShuffleCards:function () {
                        GetReadyVisible_xyHongZi(this, -1);
            ...
            _event: {
                clearCardUI: function() {
                    clearCardUI_xyHongZi(this, MjClient.MaxPlayerNum_xyHongZi - 1);
                },
                clearCardArr: function(){
                    var eatNode = this.getChildByName("eatNode");
                    eatNode.removeAllChildren();
                ...
                initSceneData: function(eD) {
                    SetUserVisible_xyHongZi(this, MjClient.MaxPlayerNum_xyHongZi - 1);
                    InitUserHandUI_xyHongZi(this, MjClient.MaxPlayerNum_xyHongZi - 1);
                    InitUserCoinAndName_xyHongZi(this, MjClient.MaxPlayerNum_xyHongZi - 1);
                    DealOffLineCard_xyHongZi(this,MjClient.MaxPlayerNum_xyHongZi - 1);
                },
                addPlayer: function(eD) {
                    SetUserVisible_xyHongZi(this, MjClient.MaxPlayerNum_xyHongZi - 1);
                    InitUserCoinAndName_xyHongZi(this, MjClient.MaxPlayerNum_xyHongZi - 1);
                ...
                HZNewCard: function(eD) {
                    ...
                    DealNewCard_xyHongZi(this,eD,MjClient.MaxPlayerNum_xyHongZi - 1);
                },
                roundEnd: function() {
                    InitUserCoinAndName_xyHongZi(this, MjClient.MaxPlayerNum_xyHongZi - 1);
                    MjClient.playui.ResetOtherCard(this, MjClient.MaxPlayerNum_xyHongZi - 1);
                },
                waitPut: function(eD) {
                    DealWaitPut(this, eD, MjClient.MaxPlayerNum_xyHongZi - 1);
                },
                MJPut: function(eD) {
                    DealPutCard_xyHongZi(this, eD, MjClient.MaxPlayerNum_xyHongZi - 1);
                },
                HZChiCard: function(eD) {
                    DealChiCard_xyHongZi(this, eD, MjClient.MaxPlayerNum_xyHongZi - 1);
                },
                HZPaoCard: function(eD) {
                    DealPaoCard_xyHongZi(this, eD, MjClient.MaxPlayerNum_xyHongZi - 1);
                },
                HZGangCard: function(eD) {
                    DealGangCard_xyHongZi(this, eD, MjClient.MaxPlayerNum_xyHongZi - 1);
                },
                MJPeng: function(eD) {
                    DealPengCard_xyHongZi(this, eD, MjClient.MaxPlayerNum_xyHongZi - 1);
                },
                HZWeiCard: function(eD){
                    DealWeiCard_xyHongZi(this, eD, MjClient.MaxPlayerNum_xyHongZi - 1);
                },
                MJHu: function(eD) {
                    DealHu_xyHongZi(this, eD, MjClient.MaxPlayerNum_xyHongZi - 1);
                },
                onlinePlayer: function(eD) {
                    setUserOffline_xyHongZi(this, MjClient.MaxPlayerNum_xyHongZi - 1);
                },
                playerStatusChange: function(eD) {
                    setUserOffline_xyHongZi(this, MjClient.MaxPlayerNum_xyHongZi - 1);
                },
                MJFlower: function(eD) {
                    HandleMJFlower(this, eD, MjClient.MaxPlayerNum_xyHongZi - 1);
                },
                MJTing: function (eD) {
                    HandleMJTing(this, eD, MjClient.MaxPlayerNum_xyHongZi - 1);
                },
                HZPickCard:function (eD) {
                    if(MjClient.rePlayVideo != -1) {
                        var pl = getUIPlayer_xyHongZi(MjClient.MaxPlayerNum_xyHongZi - 1);
                        if(eD.uid == pl.info.uid){
                            MjClient.OtherHandArr[MjClient.MaxPlayerNum_xyHongZi - 1] = MjClient.majiang.sortCard(pl.mjhand)
                        }
                    }
                    RemovePutCardOut_xyHongZi(true);
                    MjClient.playui.ResetHandCard(this,MjClient.MaxPlayerNum_xyHongZi - 1);
                },
                HZAddCards:function (eD) {
                    DealAddCard_xyHongZi(this,eD, MjClient.MaxPlayerNum_xyHongZi - 1);
                },
                HZCheckRaise:function (msg) {
                    ShowPutCardIcon_xyHongZi();
                    //MjClient.playui.EatVisibleCheck();
        ...
        eat: {
                ...
                _touch: function(btn, eT) {
                    if (eT == 2){
                        ...
                        if(ziPai.getHasFastEat()){
                            ...
                            if (chiList.length == 1) {
                                commitEatCards_xyHongZi(chiList[0], null);
                                return;
                            }
                        }
                        
                        showSelectEatCards_xyHongZi(this,btn.tag);
                    ...
                    if (eT == 2){
                        if ((MjClient.data.sData.players[SelfUid()].eatFlag & 32) > 0) {
                            MjClient.showMsg("确定过胡吗？", function() {
                                HZPassConfirmToServer_xyHongZi(); // todo 
                                setChiVisible_xyHongZi();//add by maoyu
                            }, function() {}, "1");
                        } else {
                            HZPassConfirmToServer_xyHongZi(); // todo 
                            setChiVisible_xyHongZi();//add by maoyu
            ...
            wangDiao:{
                ...
                _touch: function(btn, eT) {
                    console.log(">>>> lf，点击碰按钮");
                    if (eT == 2) {
                        HZWangChuangToServer_xyHongZi(1);
                        setChiVisible_xyHongZi();//add by maoyu
                    }
                }
            },
            wangChuang:{
                ...
                _touch: function(btn, eT) {
                    console.log(">>>> lf，点击碰按钮");
                    if (eT == 2) {
                        HZWangChuangToServer_xyHongZi(2);
                        setChiVisible_xyHongZi();//add by maoyu
                    }
                }
            },
            wangZha:{
                ...
                _touch: function(btn, eT) {
                    console.log(">>>> lf，点击碰按钮");
                    if (eT == 2) {
                        HZWangChuangToServer_xyHongZi(4);
                        setChiVisible_xyHongZi();//add by maoyu
                    }
                }
            },
                    ...
                    this.adaptChiLayout = function() {
                        ...
                        if (cards_option.length == 0) { // 吃牌选好了
                            if ((MjClient.data.sData.players[SelfUid()].eatFlag & 32) > 0) {
                                MjClient.showMsg("选择吃后视为过胡，确定吃吗？", function() {
                                    ...
                                    HZChiToServer_xyHongZi(cards_select[0], biCards);
                                    this.visible = false;
                                }.bind(this), function() {
                                    cards_select.pop();
                                    this.adaptChiLayout();
                        ...
                        for (var i = 0; i < cards_select.length; i++) {
                            ...
                            for (var j = 0; j < row.length; j++) {
                                ...
                                chiCardImg.loadTexture(MjClient.cardPath_xyHongZi + "out" + row[j] + ".png");
        ...
        chat_btn: {
            ...
            _click: function() {
                ...
                // MjClient.Scene.addChild(new EndOneView_xyHongZi(),500);
                // MjClient.Scene.addChild(new GameOverLayer_xyHongZi(),500);
            }
        },
        voice_btn: {
            ...
            _event: {
                ...
                downAndPlayVoice: function(msg) {
                    ...
                    // downAndPlayVoice_xyHongZi(msg.uid, msg.msg);
    ...
    ctor: function() {
        this._super();
        ziPai.initZiPaiData();
        var playui = ccs.load("Play_xyHongZi.json");
        playMusic("bgHongZi");
        var tData = MjClient.data.sData.tData;
        MjClient.MaxPlayerNum_xyHongZi = tData.maxPlayer;
        cc.log(MjClient.MaxPlayerNum_xyHongZi);
        ...
        this.newTingLayer = new xyNewTingLayer(); 
        playui.node.addChild(this.newTingLayer);

        this.tingLayer = new xyPhzTingLayer(); 
    ...
    resetJiaZhuTip: function()
    {
        ...
        for (var i = 0; i < MjClient.MaxPlayerNum_xyHongZi; i ++)
        {
...
//重置手牌的顺序
PlayLayer_xyHongZi.prototype.ResetHandCard = function(posNode,off, needAction, isDelay){
    if(off == 1 && posNode.getName() == "right" && MjClient.MaxPlayerNum_xyHongZi == 2){
    ...
    if(MjClient.rePlayVideo == -1){
        if(off == 0) {
            checkCard_xyHongZi(posNode, off);
            if(!needAction && !isDelay && MjClient.addGroupIndex != 0){
                refreshNode_xyHongZi(posNode,off,needAction);

                this.scheduleOnce(function(){ // 为什么这里要延迟一下？
            ...
            for (var k = 0; k < cardArr.length; k++) {
                ...
                for (var j = 0; j < groupList.length; j++) {
                    addHandCard_xyHongZi(k, j, groupList[j], off);
                }
            }

            addTingSign_xyHongZi(posNode); // 添加听牌角标
        ...
        //if(MjClient.movingCard_xyHongZi && MjClient.movingCard_xyHongZi.getParent()){
        //    MjClient.movingCard_xyHongZi.removeFromParent(true);
            ...
            for(var j = 0;j < groupList.length;j++){
                if(off == 0){
                    if(MjClient.MaxPlayerNum_xyHongZi == 3 || MjClient.MaxPlayerNum_xyHongZi == 2){
                        ...
                        addHandCardReplay_xyHongZi(k,j,groupList[j],off);
                    }
                }else {
                    addHandCardReplay_xyHongZi(k,j,groupList[j],off);
                }
        ...
        if(off == 0 && (MjClient.MaxPlayerNum_xyHongZi == 3 || MjClient.MaxPlayerNum_xyHongZi == 2)) {
            var scale_x = handCard.scaleX;
            var winSize = MjClient.size;
...
PlayLayer_xyHongZi.prototype._doMovetoAction = function(node,endP){
    node.stopAllActions();
    var ac = cc.moveTo(0.3,endP);
    node.runAction(ac);
};

PlayLayer_xyHongZi.prototype.ResetOtherCard = function(posNode, off) {
    // 添加吃、碰、跑、偎、提
    var sData = MjClient.data.sData;
    var tData = null;
    if (sData) {
    ...
    if (mjSortArr) {
        ...
        //         // } else {
        //         //     child.loadTexture(MjClient.cardPath_xyHongZi + "huxiBG.png");
        //         // }
                
        //         var chiTip = childList.length == 3 ? "wei" : "ti";
        //         if (i != getShowCardIdx_xyHongZi(posNode, chiTip)) {
        //             child.loadTexture(MjClient.cardPath_xyHongZi + "huxiBG.png");
        //         }
        ...
        for (var k = 0; k < mjSortArr.length; k++) {
            ...
            //     for (var i = 0; i < 4; i++) {
            //         addEatCard_xyHongZi(posNode, "mjgang1" + k, cardNum, off);
            //     }
            ...
            //     var cardNum = pl.mjwei[pos];
            //     for (var i = 0; i < 3; i++) {
            //         addEatCard_xyHongZi(posNode, "mjwei" + k, cardNum, off);
            //     }
            ...
            if (name == "mjgang0") {
                ...
                for (var i = 0; i < 4; i++) {
                    addEatCard_xyHongZi(posNode, "mjgang0" + k, cardNum, off);
                }
            }
            //碰
            if (name == "mjpeng") {
                ...
                for (var i = 0; i < 3; i++) {
                    addEatCard_xyHongZi(posNode, "mjpeng" + k, cardNum, off);
                }
            }
            //吃
            if (name == "mjchi") {
                ...
                for (var i = 0; i < eatCards.length; i++) {
                    addEatCard_xyHongZi(posNode, "mjchi" + k, eatCards[i], off);
                }
                ...
                if (biCards && biCards.length > 0) {
                    for (var i = 0; i < biCards.length; i++) {
                        ...
                        for (var m = 0; m < biArr.length; m++) {
                            addEatCard_xyHongZi(posNode, "mjbi" + k + i, biArr[m], off);
                        }
                    }
                }
    ...
    //    var outCard = getNewCard_xyHongZi(pl.mjput[i], 2, off);
    //    if(off == 0){
    //        outCard.anchorX = 1;
    //        outCard.anchorY = 0;
...
PlayLayer_xyHongZi.prototype.ResetPutCard = function(posNode,off){
    if(off == 1 && posNode.getName() == "right" && MjClient.MaxPlayerNum_xyHongZi == 2){
        return;//2人玩法right节点同为玩家节点
    }
    //添加打出的牌
...
PlayLayer_xyHongZi.prototype.rightMaxPlayerNum = function(){
    return MjClient.MaxPlayerNum_xyHongZi == 2 ? 1 : MjClient.MaxPlayerNum_xyHongZi - 2;
};

//重置牌的顺序
PlayLayer_xyHongZi.prototype.CardLayoutRestore = function(posNode,off){
    if(MjClient.rePlayVideo == -1){
...
PlayLayer_xyHongZi.prototype.ShowHuTypeText = function(){
    var pl = getUIPlayer_xyHongZi(0);
    cc.log("test . log ----------------------");   
...
// 判断吃、碰、跑、偎、提、胡的状态
PlayLayer_xyHongZi.prototype.EatVisibleCheck = function(off){
    var eat = MjClient.playui.jsBind.eat;
...
PlayLayer_xyHongZi.prototype.showAndHideHeadEffect = function(){
    ...
    else if (curPlayerIsMe_xyHongZi(1)){
        curPlayerNode = arr[1].getChildByName("head");
    }else if (curPlayerIsMe_xyHongZi(2)){
        curPlayerNode = arr[2].getChildByName("head");
    }else if (curPlayerIsMe_xyHongZi(3)){
