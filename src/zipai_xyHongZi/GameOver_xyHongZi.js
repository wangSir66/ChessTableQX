function SetGameOverLayer_xyHongZi(node,off,isNewUi){
    ...
    // setRoundEndUserOffline_xyHongZi(wxNode,pl);
...
/*
    红字大结算
 */
var GameOverLayer_xyHongZi = cc.Layer.extend({
    sprite:null,
    jsBind:{
        back:{
            share:{
    ...
    ctor:function () {
        ...
        for(var i = 0 ; i < playerCount ; i++){
            ...
            SetGameOverLayer_xyHongZi(clone,i, isNewUi);
