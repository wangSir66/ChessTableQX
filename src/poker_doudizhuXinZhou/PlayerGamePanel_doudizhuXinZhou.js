...
var PlayLayer_doudizhuXinZhou = cc.Layer.extend({
    ctor: function () {
        this._super();
        var playui = ccs.load(res.Play_doudizhuXinZhou_json);
...
//出牌提示
PlayLayer_doudizhuXinZhou.prototype.showTipCards = function () {
...
// 处理斗地主智能提牌
PlayLayer_doudizhuXinZhou.prototype.handleDoudizhuCardsAutoUp = function (bTouchMove) {
    if (!this.isSDataValid()) {
        return ;
    }
    var tData = MjClient.data.sData.tData;
...
PlayLayer_doudizhuXinZhou.prototype.handleCardsTouchListener = function () {
    return {
...
// 处理点击
PlayLayer_doudizhuXinZhou.prototype.handleTouchCards = function (touch, event, isBegan) {
...
// 处理玩家提起提起得牌，保留正确的牌
PlayLayer_doudizhuXinZhou.prototype.handleUpRightCards = function (isFirst, off) {
    if (isFirst) {
        return;
    }
...
// =========================[[ 流程 ]] =========================
// 断线重连/初始化
PlayLayer_doudizhuXinZhou.prototype.dealInitSceneData = function () {
    if (!this.isSDataValid()) {
        return ;
    }
    var tData = MjClient.data.sData.tData;
...
PlayLayer_doudizhuXinZhou.prototype.dealChangePKImg = function () {
...
// 结算
PlayLayer_doudizhuXinZhou.prototype.dealRoundEnd = function (eD) {
    if (!this.isSDataValid()) {
        return ;
    }
    ...
    var tData = MjClient.data.sData.tData;
    MjClient.playui.endInfo.diFen = tData.areaSelectMode.type == "jingdian" ? tData.minJiaofen:tData.rate / (Math.pow(2, tData.zhadan)*tData.chuntianRate);
    ...
    function delayExe() {
        ...
        cc.log("dealroundend--------");
        self.addChild(new EndOneView_doudizhuXZ(zhuang), 500);
    }
...
// 过、准备
PlayLayer_doudizhuXinZhou.prototype.dealPKPass = function (eD) {
    MjClient.playui.killTimeClock();
    MjClient.clockNode.visible = false;
...
// 出牌
PlayLayer_doudizhuXinZhou.prototype.dealPKPut = function (msg) {
    var tData = MjClient.data.sData.tData;
    tData.rate = msg.rate;
...
// 等待出牌
PlayLayer_doudizhuXinZhou.prototype.dealWaitPut = function (eD) {
    var tData = MjClient.data.sData.tData;
    ...
    if (isFirstPut) {
        ...
        MjClient.playui.node.runAction(cc.sequence(cc.DelayTime(1.0), cc.callFunc(autofunc), cc.DelayTime(0.9), cc.callFunc(autofunc2)));
        return;
    }
...
// 等待叫地主
PlayLayer_doudizhuXinZhou.prototype.dealWaitJiaodizhu = function (msg) {
    var sData = MjClient.data.sData;
    var tData = sData.tData;
...
// 抢地主
PlayLayer_doudizhuXinZhou.prototype.dealQiangDizhu = function (msg) {
    var tData = MjClient.data.sData.tData;
...
// 等待准备
PlayLayer_doudizhuXinZhou.prototype.dealAllReady = function (bAllReady) {
    for (var i = 0; i < this.headOffLen; i++) {
        var off = this.headOffArr[i];
...
// 加倍
PlayLayer_doudizhuXinZhou.prototype.dealMJJiazhu = function (isSceneData, off, jiazhuNum, curPlayer) {
    var tData = MjClient.data.sData.tData;
    if (typeof(curPlayer) != "undefined") {
        tData.curPlayer = curPlayer;
    }

    cc.log("lijm-------------" + tData.tState);
...
// 等待加倍
PlayLayer_doudizhuXinZhou.prototype.dealWaitJiazhu = function (eD) {
    var tData = MjClient.data.sData.tData;
...
// 处理手牌
PlayLayer_doudizhuXinZhou.prototype.handleMjHand = function () {
...
// 处理底牌
PlayLayer_doudizhuXinZhou.prototype.dealDiCards = function (zhuang, diCards, handCounts, isAddCards, isIconMove) {
    var tData = MjClient.data.sData.tData;
    tData.zhuang = zhuang;
...
PlayLayer_doudizhuXinZhou.prototype.updateUserHeadPosition = function (off, bRoundEnd) {
...
PlayLayer_doudizhuXinZhou.prototype.updateTimes = function () {
...
//设置地区信息
PlayLayer_doudizhuXinZhou.prototype.showGameName = function () {
...
//添加还背景的功能
PlayLayer_doudizhuXinZhou.prototype.addChangeBg = function () {
...
PlayLayer_doudizhuXinZhou.prototype.showVoice = function () {
...
PlayLayer_doudizhuXinZhou.prototype.addWaitNode = function () {
...
PlayLayer_doudizhuXinZhou.prototype.setWaitNodeVisible = function (bVisible) {
    if (!MjClient.playui.waitNode) {
        return;
    }
    MjClient.playui.waitNode.setVisible(bVisible);
}
PlayLayer_doudizhuXinZhou.prototype.addAniLayer = function () {
...
PlayLayer_doudizhuXinZhou.prototype.showTableID = function (bShow) {
...
PlayLayer_doudizhuXinZhou.prototype.setHLJiabeiVisible = function (bVisible) {
...
// 出牌按钮
PlayLayer_doudizhuXinZhou.prototype.handlePutCardBtn = function (isVisible, isFirst) {
...
PlayLayer_doudizhuXinZhou.prototype.enablePutCardBtn = function (bAble) {
    var btnPutCard = this.node.getChildByName("BtnPutCard");
...
//操作按钮(提示和不出) 
PlayLayer_doudizhuXinZhou.prototype.handleHimtAndNoPutBtn = function (isVisible, isAble) {
...
//经典斗地主叫分按钮
PlayLayer_doudizhuXinZhou.prototype.setJingDianBtnVisible = function (bVisible, buJiaoAble, score, bmustjiao) {
...
//欢乐斗地主叫分按钮
PlayLayer_doudizhuXinZhou.prototype.setHuanLeBtnVisible = function (bVisible) {
...
// 牌局信息
PlayLayer_doudizhuXinZhou.prototype.showRoundInfo = function () {
    if (!this.isSDataValid()) {
        return ;
    }
...
// 局数
PlayLayer_doudizhuXinZhou.prototype.updateGameRound = function () {
...
// 加倍
PlayLayer_doudizhuXinZhou.prototype.setTextMult = function (bShow) {
...
//加倍
PlayLayer_doudizhuXinZhou.prototype.handleJiabeiTag = function (off, type) {
    var node = getNode_cards(off);
...
// 底分
PlayLayer_doudizhuXinZhou.prototype.handleDifen = function () {
...
PlayLayer_doudizhuXinZhou.prototype.hideAllUI = function () {
...
// 不抢/抢地主
PlayLayer_doudizhuXinZhou.prototype.dealQiangDizhuText = function (off, visible, msg) {
    var node = getNode_cards(off);
    var diZhuTag = node.getChildByName("jiaodizhuTag");
...
// 要不起
PlayLayer_doudizhuXinZhou.prototype.handleNoPutTag = function (off, visible) {
    var node = getNode_cards(off);
...
// 没有大过上家
PlayLayer_doudizhuXinZhou.prototype.handleNoPutTips = function (isVisible) {
    var noPutTips = this.node.getChildByName("noPutTips");
...
// 没有大过上家
PlayLayer_doudizhuXinZhou.prototype.handlePassBtn = function (isVisible) {
    var BtnPass = this.node.getChildByName("BtnPass");
...
// =========================[[ 系统 ]] ==========================
PlayLayer_doudizhuXinZhou.prototype.dealSendVoice = function (fullFilePath) {
    if (!fullFilePath) {
...
PlayLayer_doudizhuXinZhou.prototype.dealDownAndPlayVoice = function (msg) {
...
PlayLayer_doudizhuXinZhou.prototype.dealUploadRecord = function (filePath) {
    if (filePath) {
...
// 绘制手牌
PlayLayer_doudizhuXinZhou.prototype.initUserHandUiDoudizhu = function (off) {
    var pl = getUIPlayer(off);
    if (pl == null) {
        return;
    }
...
//处理出牌,打牌动作
PlayLayer_doudizhuXinZhou.prototype.dealPKPutcard = function (off, msg) {
    var sData = MjClient.data.sData;
    var tData = sData.tData;
...
PlayLayer_doudizhuXinZhou.prototype.playAnimation = function (cards, off) {
    var pl = getUIPlayer(off);
    if (!pl) { return ; }
...
// 增加底牌
PlayLayer_doudizhuXinZhou.prototype.addDiCardsToZhuang = function (zhuangOff) {
    var tData = MjClient.data.sData.tData;
...
// 处理准备字准备相关
PlayLayer_doudizhuXinZhou.prototype.handleAboutReady = function (off,bAllReady) {
...
PlayLayer_doudizhuXinZhou.prototype.startTimeClock = function (func) {
...
PlayLayer_doudizhuXinZhou.prototype.killTimeClock = function () {
    MjClient.clockNode.getChildByName("number").stopAllActions();
    stopEffect(playTimeUpEff);
    playTimeUpEff = null;
};

PlayLayer_doudizhuXinZhou.prototype.clockNumberUpdate = function (node, endFunc) {
    return arrowbkNumberUpdate(node, endFunc);
}

PlayLayer_doudizhuXinZhou.prototype.checkRoomUiDelete = function () {
...
PlayLayer_doudizhuXinZhou.prototype.showGps = function () {
...
// 地主的三张牌
PlayLayer_doudizhuXinZhou.prototype.handleDoudizhuDiCards = function () {
...
PlayLayer_doudizhuXinZhou.prototype.dealMJTick = function (eD) {
    for (var i = 0; i < this.headOffLen; i++) {
        var off = this.headOffArr[i];
        var pl = getUIPlayer(off);
        if (!pl) { continue ; }
...
PlayLayer_doudizhuXinZhou.prototype.dealLogout = function () {
    if (MjClient.playui) {
...
PlayLayer_doudizhuXinZhou.prototype.dealEndRoom = function (msg) {
...
PlayLayer_doudizhuXinZhou.prototype.dealLeaveGame = function () {
    MjClient.playui.killTimeClock();
    MjClient.addHomeView();
    MjClient.playui.removeFromParent(true);
    delete MjClient.playui;
...
PlayLayer_doudizhuXinZhou.prototype.dealLoadWxHead = function (eD) {
    for (var i = 0; i < this.headOffLen; i++) {
        var off = this.headOffArr[i];
...
PlayLayer_doudizhuXinZhou.prototype.dealPlayVoice = function (msg) {
    for (var i = 0; i < this.headOffLen; i++) {
        var off = this.headOffArr[i];
...
PlayLayer_doudizhuXinZhou.prototype.dealChangeGameBgEvent = function () {
...
PlayLayer_doudizhuXinZhou.prototype.handlePlayerChange = function (action, uid) {
    if (!this.isSDataValid()) {
        return ;
    }
    var targetOff = -1;
...
PlayLayer_doudizhuXinZhou.prototype.dealMoveHead = function () {
    var that =this;
    var fun1 = function (){
...
// =========================[[ 消息 ]] ===========================
// 加倍
PlayLayer_doudizhuXinZhou.prototype.sendJiaBeiToServer = function (beishu) {
    MjClient.playui.setHLJiabeiVisible(false);
    MjClient.gamenet.request("pkroom.handler.tableMsg", {
        cmd: "MJJiazhu",
        jiazhuNum: beishu,
...
// 叫地主、不叫、叫分
PlayLayer_doudizhuXinZhou.prototype.sendQiangdizhuToServer = function (bQiang) {
    MjClient.playui.setJingDianBtnVisible(false);
    MjClient.playui.setHuanLeBtnVisible(false);
    MjClient.gamenet.request("pkroom.handler.tableMsg", {
        cmd: "Qiangdizhu",
...
// 出牌
PlayLayer_doudizhuXinZhou.prototype.sendPutCardsToServer = function () {
    if (this.isCardsSend) {
        return;
    }
    ;
...
// 准备-1， 提示过牌0， 不出 1
PlayLayer_doudizhuXinZhou.prototype.sendPassToServer = function (isActivePass) {
    this.handCardsWgetArr[0].clearCardsUpStatus();
...
// =========================[[ 初始化 ]] ==========================
PlayLayer_doudizhuXinZhou.prototype.initTagList = function () {
    this.btnTagList = {
        BtnPutCard: 1,
        BtnHimt: 2,
        BtnNoPut: 3,
...
PlayLayer_doudizhuXinZhou.prototype.initData = function (isRoundEnd) {
    this.cardTipsArr = [];
    this.tipsIdx = 0;
...
PlayLayer_doudizhuXinZhou.prototype.initOnce = function () {
...
PlayLayer_doudizhuXinZhou.prototype.initUI = function () {
...
// 初始化节点
PlayLayer_doudizhuXinZhou.prototype.initHeadWget = function () {
    this.headOffArr = [];
    this.headNode = {};
    this.AniMotion = [];
...
//初始化玩家信息
PlayLayer_doudizhuXinZhou.prototype.initMsgEvent = function () {
    // ================ 重连 =========================
...
PlayLayer_doudizhuXinZhou.prototype.initClickEvent = function () {
...
PlayLayer_doudizhuXinZhou.prototype.btnBindCallBack = function (parent, str, tag, callback) {
    var tmpNode = parent.getChildByName(str);
    tmpNode.tag = tag;
    tmpNode.addTouchEventListener(callback);
};

PlayLayer_doudizhuXinZhou.prototype.btnEventListener = function (sender, type) {
...
// 初始化时钟节点
PlayLayer_doudizhuXinZhou.prototype.initClockWget = function () {
    for (var off = 0; off < 4; off++) {
        var _node = getNode(off);
...
PlayLayer_doudizhuXinZhou.prototype.isSDataValid = function() {
    var sData = MjClient.data.sData;
