...
function SetEndOneUserUI_doudizhuXZ(node, off) {
        ...
        head: {
            ...
            stand: {
                ...
                _run: function () {
                    ...
                    CardLayoutRestoreForEndOne_doudizhuXZ(node, pl);
                }
            },
            cardType: {
                _run:function()
...
function CardLayoutRestoreForEndOne_doudizhuXZ(node, plNode) {
...
var EndOneView_doudizhuXZ = cc.Layer.extend({
    jsBind: {
        block: {
        ...
        back: {
            ...
            head0: {
                ...
                _run: function () { SetEndOneUserUI_doudizhuXZ(this, 0); },
    		...
    		, head1: {
    		    ...
    		    _run: function () { SetEndOneUserUI_doudizhuXZ(this, 1); }
    		}
    		...
    		, head2: {
    		    ...
    		    _run: function () { SetEndOneUserUI_doudizhuXZ(this, 2); }
    		},
            publicMutiple: {
                _run:function()
                {
    ...
    ctor: function (zhuang) {
        ...
        var endoneui = ccs.load("endOne_doudizhuXinZhou.json");
