...
function SetEndOneUserUI_HZTDH(node,off)
{
...
var EndOneView_HZTDH = cc.Layer.extend({
	jsBind:{
		block: {
		...
		dir:
		{
			...
			_text: function () {
				...
				var str3 = tData.areaSelectMode.lazhuang ?  "拉庄,":"不拉庄,";
				...
				var str5 = tData.areaSelectMode.liu8zhang ? "留8张牌," : "";

				if (tData.areaSelectMode.difen) {
		            str5 += "积分底分" + Number(tData.areaSelectMode.difen) + ",";
		        }
				...
				var text = str1 + str6 + str2 + str3 + str4 + str5;
		...
		head0:{
		   ...
		   _run:function(){ SetEndOneUserUI_HZTDH(this,0); },
		...
		,head1:{ 
		  ...
		  _run:function(){ SetEndOneUserUI_HZTDH(this,1); }
		}
		...
		,head2:{ 
		   ...
		   _run:function(){ SetEndOneUserUI_HZTDH(this,2); }
		}
		,head3:{
			 head:
			 {
			...
			_run:function(){ SetEndOneUserUI_HZTDH(this,3); }
			},
            count_down:{
                _visible :function()
                {
    ...
    ctor:function () {
        this._super();
        var endoneui = ccs.load(res.EndOne_HZTDH_json);
