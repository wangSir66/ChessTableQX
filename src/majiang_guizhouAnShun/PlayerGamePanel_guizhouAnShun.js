//贵州，安顺麻将
var PlayLayer_guizhouAnShun;
(function() {
    PlayLayer_guizhouAnShun = PlayLayer_guizhou.extend({
        getJsBind: function() {
            var jsBind = {
                node_down: {
                    layout_head: {
        ...
        ctor: function() {
            this._super(PlayLayer_guizhouAnShun, res.Play_guizhouAnShun_json);
        ...
        getPlayerEatNode: function () {
            ...
            if(this.isTurnMe()){
                ...
                cc.log("getPlayerEatNode player.isTing ==== " + player.isTing);
                //听
