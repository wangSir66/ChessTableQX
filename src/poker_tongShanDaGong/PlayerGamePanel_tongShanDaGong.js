...
var GameOverLayer_TongShanDaGong =  GameOverLayer_Poker.extend({
    ctor: function() {
        this._super();
    },
    getPlayInfo: function(){
        ...
        str += tData.areaSelectMode.jokerNum  == 4 ? "4王," : "8王," ;
        str += tData.areaSelectMode.laiziPoint == 2 ? "癞子为2," : "癞子为3," ;
        str += "单炸封顶" + tData.areaSelectMode.danZhaFengDing + "笼," ;
        str += ["起牌拱,","发牌拱,","疯狂拱,","变态拱,"][tData.areaSelectMode.postCardsWay];
...
//初始化玩家金币和名字
function InitUserCoinAndName_TongShanDaGong(node, off)
{
...
function SetUserVisible_TongShanDaGong(node, off)
{
    var pl = getUIPlayer(off);
    ...
    if(pl)
    {
        ...
        InitUserHandUI_TongShanDaGong(node, off);
    }
    else
    {
        name.visible = false;
...
function InitUserHandUI_TongShanDaGong(node, off)
{
    ...
    //初始化玩家金币和名称
    InitUserCoinAndName_TongShanDaGong(node, off);
    ...
    if(MjClient.rePlayVideo == -1)// 表示正常游戏
    {
        if (pl.mjhand && off == 0) {//只初始化自己的手牌
            ...
            for (var i = 0; i < pl.mjhand.length; i++) {
                ...
                {
                    card.setUserData(1);
                    if(_tempData[pl.mjhand[i]]){
                        card.setUserData(_tempData[pl.mjhand[i]]);
                    }
                }
                else
                {
                ...
                if(_tempData[pl.mjhand[i]]){
                   _tempData[pl.mjhand[i]]++;
                }else{
                    _tempData[pl.mjhand[i]] = 1;
                }
...
var PlayLayer_TongShanDaGong = cc.Layer.extend({
    _btnPutCard:null,
    jsBind: {
        _event: {
            mjhand: function() {
            ...
            endRoom: function(msg) {
                ...
                if (msg.showEnd) this.addChild(new GameOverLayer_TongShanDaGong(),500);
                else
            ...
            roundEnd: function() {
                ...
                function delayExe()
                {
                        ...
                        if (sData.tData.roundNum <= 0) {
                            if(!tData.matchId) {
                                ...
                                self.runAction(cc.sequence(cc.delayTime(3),cc.callFunc(function(){
                                    self.addChild(new GameOverLayer_TongShanDaGong(),500);
                                })))
                            }
                        }
                    }
                    ...
                    self.addChild(new EndOneView_tongShanDaGong(),500,650);
        ...
        down: {
            ...
            _event: {
                ...
                initSceneData: function(eD) {
                    ...
                    SetUserVisible_TongShanDaGong(this, 0);
                ...
                mjhand: function(eD) {
                    InitUserHandUI_TongShanDaGong(this, 0);
                ...
                roundEnd: function() {
                    InitUserCoinAndName_TongShanDaGong(this, 0);
                    //setTaiInfo("");
                },
        ...
        right: {
            ...
            _event: {
                ...
                initSceneData: function(eD) {
                    SetUserVisible_TongShanDaGong(this, 1);
                ...
                mjhand: function(eD) {
                    InitUserHandUI_TongShanDaGong(this, 1);
                },
                roundEnd: function() {
                    InitUserCoinAndName_TongShanDaGong(this, 1);
                },
                waitPut: function(eD) {
        ...
        top: {
            ...
            _event: {
                ...
                initSceneData: function(eD) {
                    SetUserVisible_TongShanDaGong(this, 2);
                ...
                mjhand: function(eD) {
                    InitUserHandUI_TongShanDaGong(this, 2);
                },
                roundEnd: function() {
                    InitUserCoinAndName_TongShanDaGong(this, 2);
                },
                waitPut: function(eD) {
        ...
        left: {
            ...
            _event: {
                ...
                initSceneData: function(eD) {
                    SetUserVisible_TongShanDaGong(this, 3);
                ...
                mjhand: function(eD) {
                    InitUserHandUI_TongShanDaGong(this, 3);
                },
                roundEnd: function() {
                    InitUserCoinAndName_TongShanDaGong(this, 3);
                },
                waitPut: function(eD) {
...
//牛十别专有排序
 ...
 //
    ctor: function() {
        ...
        var playui = ccs.load(res.Play_tongShanDaGong_json);
...
PlayLayer_TongShanDaGong.prototype.InitC_Data = function() {
...
PlayLayer_TongShanDaGong.prototype.clockNumberUpdate = function(node, endFunc)
{
...
PlayLayer_TongShanDaGong.prototype.updateClockPosition = function(arrowNode)
{
    var tData = MjClient.data.sData.tData;
    var uids = tData.uids;
 ...
 * @return {String}
 */
PlayLayer_TongShanDaGong.prototype.getGameInfoString = function(param)
{
    var tData = MjClient.data.sData.tData;
    var str = "";
...
PlayLayer_TongShanDaGong.prototype.isChickenPlayer = function(){

};

PlayLayer_TongShanDaGong.prototype.showQiangZhuangTag = function(off, eD){
    var tData = MjClient.data.sData.tData;
...
PlayLayer_TongShanDaGong.prototype.checkPartnerIsConfirm = function(){
    var tData = MjClient.data.sData.tData;
    var ret = true;

    cc.log("checkPartnerIsConfirm-----", tData.chickenCard, tData.zhuangPartner,tData.zhuang, tData.tState)
...
PlayLayer_TongShanDaGong.prototype.addJiPaiTag = function(node){
    var tData = MjClient.data.sData.tData;
...
PlayLayer_TongShanDaGong.prototype.addChickenCardIcon = function(off){
    var pl = getUIPlayer(off);
...
PlayLayer_TongShanDaGong.prototype.setChickenCardIcon = function(eD)
{
    if(true){
...
PlayLayer_TongShanDaGong.prototype.showJieFengAnim = function(msg)
{
...
//身份识别后播鸡的动画
PlayLayer_TongShanDaGong.prototype.showChickenAnim = function(index){
    var tData = MjClient.data.sData.tData;
...
//亮身份
PlayLayer_TongShanDaGong.prototype.showIdentityIcon = function(eD){
    var tData = MjClient.data.sData.tData;
...
PlayLayer_TongShanDaGong.prototype.showPartnerTips = function(){
    var tData = MjClient.data.sData.tData;
    var pl = getUIPlayer(0);
...
PlayLayer_TongShanDaGong.prototype.showYouPai = function(){
    var tData = MjClient.data.sData.tData;
...
PlayLayer_TongShanDaGong.prototype.showYouPaiAnim = function(flyNode, cardValue ){
...
//重连
PlayLayer_TongShanDaGong.prototype.dealZhuangMing = function(){
    var tData = MjClient.data.sData.tData;
...
//明抢了
PlayLayer_TongShanDaGong.prototype.showMingAnim = function(msg){
...
PlayLayer_TongShanDaGong.prototype.showZhuangIcon = function (UIoff, isMing) {
    var tData = MjClient.data.sData.tData;
...
PlayLayer_TongShanDaGong.prototype.showFlyCardAnim = function(flyNode,cardValue,UIoff)
{
    var playerNode = getNode_cards(UIoff);
    if (!playerNode)
        return;
...
PlayLayer_TongShanDaGong.prototype.showHandCardBeiMian = function()
{
...
PlayLayer_TongShanDaGong.prototype.hideHandCardBeiMian = function()
{
...
PlayLayer_TongShanDaGong.prototype.CardLayoutRestore = function(node, off)
{
    cc.log("PlayLayer_TongShanDaGong11==============");
    
    // 如果正在发牌 不排序
    if (MjClient.playui.isFaPai) return;
    
    cc.log("PlayLayer_TongShanDaGong22==============");
...
PlayLayer_TongShanDaGong.prototype.CardLayoutDesk = function(node,cards,off)
{
    var tData = MjClient.data.sData.tData;
...
//横向摆放《正常》
PlayLayer_TongShanDaGong.prototype.horSort = function(node, off)
{
    var pl; //player 信息
...
//纵向摆放
PlayLayer_TongShanDaGong.prototype.verSort = function(node, off)
{
    if(off != 0)
    {
        return;
...
PlayLayer_TongShanDaGong.prototype.changePosition = function(msg,flyNode,oldUids)
{
    if (!msg)return;
...
PlayLayer_TongShanDaGong.prototype.showXiFenAnim = function(msg){
    if(msg == null){
        return;
    }
    var sData = MjClient.data.sData;
    ...
    var typeArr = ["1_animIcon.png", "2_animIcon.png","3_animIcon.png","4_animIcon.png","5_animIcon.png","6_animIcon.png",
        "7_animIcon.png","8_animIcon.png","9_animIcon.png","10_animIcon.png", "11_animIcon.png", "12_animIcon.png"];
...
//处理明牌
PlayLayer_TongShanDaGong.prototype.dealMingPai = function(node, msgary, UIOff, needSound)
{   
    // 回放情形下，不需展示明牌
    if (MjClient.rePlayVideo != -1)
        return;
...
PlayLayer_TongShanDaGong.prototype.showWatchPanel = function(node, cards){
...
PlayLayer_TongShanDaGong.prototype.dealSwitchWatch = function(watch, cards){
    if(!watch){
...
//展示队友手牌
PlayLayer_TongShanDaGong.prototype.showPartnerHandCards = function(node, cards)
{   
    // 回放情形下，不需展示
    if (MjClient.rePlayVideo != -1 || !MjClient.playui.checkPartnerIsConfirm() || cards == null){
        node.setVisible(false);
    ...
    for (var i = 0; i < cards.length; i++) {
        ...
        {
            card.setUserData(1);
            if(_tempData[cards[i]]){
                card.setUserData(_tempData[cards[i]]);
            }
        }
        else
        {
...
PlayLayer_TongShanDaGong.prototype.dealPartnerPutCards = function(node, putCards)
{   
...
PlayLayer_TongShanDaGong.prototype.dealPKPutCards = function(node, msg)
{
...
PlayLayer_TongShanDaGong.prototype.CardLayoutPartnerCards = function(node)
{
    if(MjClient.rePlayVideo != -1)// 表示回放
    {
        MjClient.sortClassType = 0;
...
PlayLayer_TongShanDaGong.prototype.clearPartnerUI = function(node)
{
    // 回放情形下，不需处理
    if (MjClient.rePlayVideo != -1)
        return;
...
PlayLayer_TongShanDaGong.prototype.showFlyZhuaFenAnim = function(msg){
    var UIoff =  getUiOffByUid(msg.uid);
...
PlayLayer_TongShanDaGong.prototype.setPlayerZhuaFen = function(node,off_1)
{
...
PlayLayer_TongShanDaGong.prototype.UpdataDaMaZiTips = function(){
    var sData = MjClient.data.sData;
    var tData = sData.tData;
...
PlayLayer_TongShanDaGong.prototype.clearDeskCard = function(node)
{
    var children = node.children;
    for (var i = 0; i < children.length; i++)
    {
...
PlayLayer_TongShanDaGong.prototype.putDaMaZiTips = function(cardType){
...
PlayLayer_TongShanDaGong.prototype.onClickLiPai = function()
{
...
PlayLayer_TongShanDaGong.prototype.getJokerCardsFromRet = function(ret) {
        if (!ret || ret.length <= 0)
            return [];
...
PlayLayer_TongShanDaGong.prototype._sortS2B = function(oCards){
...
PlayLayer_TongShanDaGong.prototype._sortCardByType = function(){
...
PlayLayer_TongShanDaGong.prototype.resetRoundData = function()
{
    var sData = MjClient.data.sData;
    var tData = sData.tData;
...
PlayLayer_TongShanDaGong.prototype.ClearLiPai = function(uid, putcards)
{
...
PlayLayer_TongShanDaGong.prototype.setDownMenusEnabled = function()
{
    var tData = MjClient.data.sData.tData;
...
// 展示报喜动画
PlayLayer_TongShanDaGong.prototype.showBaoxiAnimation = function(msg)
{   
    ...
    MjClient.playui.addChild(new PiaoFenView_TongShanDaGong(msg.score,uiOff),500);
}

// 设置己方喜牌数据
PlayLayer_TongShanDaGong.prototype.setMajiangXiCard = function()
{   
...
// 创建投降UI
PlayLayer_TongShanDaGong.prototype.createTouXiangView = function(touXiangData)
{   
    //回放的时候，不弹投降窗口
    // if(MjClient.rePlayVideo != -1) 
    //     return;
...
PlayLayer_TongShanDaGong.prototype.reLoadOptBtnRes = function() {
    //出牌按钮
...
//弹出选择的牌
PlayLayer_TongShanDaGong.prototype.selectUICards = function(_tipsCardArray)
{
...
PlayLayer_TongShanDaGong.prototype.checkPut = function (oHands, oCards, lastPutCard) {
    var tData = MjClient.data.sData.tData;
    ...
    var _haveMore8CountLaiZi = laizis.length >= 8 ? true : false;
    ...
    if (laizis.length <= 0) {
        ...
        var _haveGunlong = false;
        var _have510kGunlong = false;
        var _haveGunlongIndex = -1;
        var _have510kGunlongIndex = -1;
        var _510kSetp = 0;
        var _gunLongSetp = 0;
        ...
        if (!lastPutCard || lastPutCard == -1) {
            ...
            var findTypes = [
                CARDTPYE.wangzha,
                CARDTPYE.gunlong,
                CARDTPYE.f_510kgunlong,
                CARDTPYE.z_510kgunlong,
                CARDTPYE.zhadan,
                CARDTPYE.f_510k,
                CARDTPYE.z_510k,
                CARDTPYE.sanshun,
            ...
            for (var i = 0; i < findTypes.length; i++) {
                if(findTypes[i] == CARDTPYE.gunlong ){
                    _gunLongSetp = 0;
                    tempRets = [];
                    var lianNum = 2;
                    while (oCards.length / lianNum >= 4) {
                        if (oCards.length % lianNum != 0) {
                            lianNum++;
                            continue;
                        }
                        
                        tempRets = MjClient.majiang.findCardByType(cards, laizis, findTypes[i], oCards.length, {step: oCards.length / lianNum});

                        if (tempRets.length > 0){
                            _gunLongSetp = oCards.length / lianNum;
                            break;
                        }
                        else
                            lianNum++;
                ...
                if (tempRets.length > 0) {
                    ...
                    if(findTypes[i] == CARDTPYE.gunlong){
                        _haveGunlong = true;
                        _haveGunlongIndex = results.length;
                    }else if( (findTypes[i] == CARDTPYE.f_510kgunlong || findTypes[i] == CARDTPYE.z_510kgunlong) ){
                        _510kSetp = oCards.length/3;
                        _have510kGunlong = true;
                        _have510kGunlongIndex = results.length ;
                    }
            ...
            if(lastCardsType == CARDTPYE.wangzha ){
                return null;
            }

            if(lastCardsType == CARDTPYE.gunlong){
                findTypes.push(CARDTPYE.wangzha);

                findTypes.push(CARDTPYE.f_510kgunlong);
                findTypes.push(CARDTPYE.z_510kgunlong);

                findTypes.push(CARDTPYE.gunlong);

            }
            else if(lastCardsType == CARDTPYE.f_510kgunlong){
                findTypes.push(CARDTPYE.wangzha);
                findTypes.push(CARDTPYE.gunlong);
            }
            else if(lastCardsType == CARDTPYE.z_510kgunlong){
                findTypes.push(CARDTPYE.wangzha);
                findTypes.push(CARDTPYE.gunlong);
                findTypes.push(CARDTPYE.f_510kgunlong);
            }else if (lastCardsType == CARDTPYE.zhadan || lastCardsType == CARDTPYE.f_510k) {
                findTypes.push(CARDTPYE.wangzha);
                findTypes.push(CARDTPYE.gunlong);
                findTypes.push(CARDTPYE.f_510kgunlong);
                findTypes.push(CARDTPYE.z_510kgunlong);

                if (lastCardsType == CARDTPYE.f_510k) {
                    if (oCards.length >= 5)
                        findTypes.push(CARDTPYE.zhadan);
                    else if (oCards.length == 3)
                        findTypes.push(CARDTPYE.f_510k);
                }

                // if(lastCardsType == CARDTPYE.f_510k && oCards.length >= 5){
                //     findTypes.push(CARDTPYE.zhadan);
                // }
            ...
            else if (lastCardsType == CARDTPYE.z_510k) {
                findTypes.push(CARDTPYE.wangzha);
                findTypes.push(CARDTPYE.gunlong);
                findTypes.push(CARDTPYE.f_510kgunlong);
                findTypes.push(CARDTPYE.z_510kgunlong);
        ...
        if(_haveGunlong && _have510kGunlong && _haveMore8CountLaiZi && (_gunLongSetp == _510kSetp)
            && (_510kSetp >= 4)){
            var _temp = results[_have510kGunlongIndex];
            results[_have510kGunlongIndex] =  results[_haveGunlongIndex];
            results[_haveGunlongIndex] = _temp;
        }
...
PlayLayer_TongShanDaGong.prototype.RemoveNodeBack = function(node, name, num, tag) {
...
PlayLayer_TongShanDaGong.prototype.findNodesBack = function(node, name, tags) {
    tags = tags.slice();
...
PlayLayer_TongShanDaGong.prototype.cardsSort = function(cards)
{
    var pointCounts = {};
    for (var i = 0; i < cards.length; i++) {
