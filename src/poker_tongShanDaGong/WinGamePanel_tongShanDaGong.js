function SetEndOneUserUI_tongShanDaGong(node, off) {
    ...
    if(off != 0){
        node.getChildByName("text_shuyingfen").setTextColor(cc.color("#5C8075"));
        node.getChildByName("text_hua").setTextColor(cc.color("#5C8075"));
        node.getChildByName("text_xi").setTextColor(cc.color("#5C8075"));
    }
    ...
    _huapai0.setVisible(pl.long < 0 );
    _huapai1.setVisible(pl.long >= 0);
    _huapai0.setString(pl.long  + "");
    _huapai1.setString("," + pl.long  + "");
    ...
    if(off == 0){
        var _difen = node.getChildByName("image_difen").getChildByName("text_difen"); 
        _difen.setString(tData.areaSelectMode.diFen == null ? 0 : tData.areaSelectMode.diFen);
    }
}

var EndOneView_tongShanDaGong = cc.Layer.extend({
    jsBind: {
        block: {
            _layout: [
                [1, 1],
        ...
        back: {
                ...
                _click: function (btn, eT) {
                    ...
                    if(!tData.fieldId){
                        if (sData.tData.roundNum <= 0)
                            MjClient.endoneui.getParent().addChild(new GameOverLayer_TongShanDaGong(),500);
                    }
                    if(!tData.fieldId){
            ...
            image_player_myself: {
                _run: function() {
                    SetEndOneUserUI_tongShanDaGong(this, MjClient.endoneui.offs[0]);
                }
            },
            image_player_1: {
                _run: function() {
                    SetEndOneUserUI_tongShanDaGong(this, MjClient.endoneui.offs[1]);
                },
            },
            image_player_2: {
                _run: function() {
                    SetEndOneUserUI_tongShanDaGong(this, MjClient.endoneui.offs[2]);
                }
            },
            image_player_3: {
                _run: function() {
                    SetEndOneUserUI_tongShanDaGong(this, MjClient.endoneui.offs[3]);
                }
            },
        }
    },
    ctor: function() {
        ...
        var endoneui = ccs.load("endOne_TongShanDaGong.json");
