...
function SetUserVisible_hanShouPaoHuZi(node, off){
    ...
    if(pl){
        ...
        setUserOffline_hanShouPaoHuZi(node, off);
...
function InitUserHandUI_hanShouPaoHuZi(node, off){
    ...
    if (pl.jiazhuNum == 2 && MjClient.rePlayVideo == -1)
    {
        ...
        MjClient.majiang.setJiaZhuNum(node, getUIPlayer_hanShouPaoHuZi(off));
    }
...
var PlayLayer_hanShouPaoHuZi = cc.Layer.extend({
    jsBind: {
        _event: {
            ...
            endRoom: function(msg) {
                ...
                if (msg.showEnd){
                    this.addChild(new GameOverLayer_hanShouPaoHuZi(),500);
                }else{
            ...
            roundEnd: function() {
                ...
                if(!MjClient.isDismiss && tData.hunCard && tData.hunCard != -1 && tData.areaSelectMode.xingType==2){
                    ...
                    ShowEatActionAnim_hanShouPaoHuZi(MjClient.playui._downNode, ActionType_paohuzi.FANXING, 0);
                    DealFanXingNewCard_hanShouPaoHuZi(hunCard);
                }
                ...
                function delayExe(){
                    ...
                    if (sData.tData.roundNum <= 0){
                        var layer = new GameOverLayer_hanShouPaoHuZi();
                        layer.setVisible(false);
                        self.addChild(layer,500);
                    }
                    if(!MjClient.endoneui){
                        self.addChild(new EndOneView_hanShouPaoHuZi(),500);
                    }
            ...
            moveHead: function() {
                ...
                //tableStartHeadMoveAction_hanShouPaoHuZi(this);   //不涉及到头像移动动作
            },
            initSceneData: function() {
                ...
                reConectHeadLayout_hanShouPaoHuZi(this);        //不涉及到头像移动动作
                CheckRoomUiDelete();
                tableStartHeadMoveAction_hanShouPaoHuZi(this);   //不涉及到头像移动动作
            ...
            changeMJBgEvent: function() {
                changeMJBg_hanShouPaoHuZi(this, ziPai.getZiPaiType());
            },
            MJPeng: function() {
                MjClient.playui.showAndHideHeadEffect();
            },
            ...
            EZP_layout : function(){
                if(MjClient.data.sData.tData.maxPlayer < 4){
                    ...
                    if(IsArrowVisible_hanShouPaoHuZi()){
                        MjClient.playui.ResetPutCard(MjClient.playui._downNode, changeUIOff_hanShouPaoHuZi(0));
                        MjClient.playui.ResetPutCard(MjClient.playui._rightNode, changeUIOff_hanShouPaoHuZi(2));
                        MjClient.playui.ResetPutCard(MjClient.playui._topNode, changeUIOff_hanShouPaoHuZi(3));
                    }
                }
            }
        },
        cardNumImg: {
            ...
            _event: {
                initSceneData: function(eD) {
                    var sData = MjClient.data.sData;
                    var tData = sData.tData;
                    this.visible = IsArrowVisible_hanShouPaoHuZi() && TableState.waitJiazhu != tData.tState;
                },
                mjhand: function(eD) {
                    var sData = MjClient.data.sData;
                    var tData = sData.tData;
            ...
            cardNumImg:{
                _run: function(){
                    ...
                    if (MjClient.data.sData.tData.areaSelectMode.isShiWuZhang || tData.maxPlayer == 4){
        ...
        roundInfo:{
            ...
            _run:function(){
                ...
                if (item = ["倒一","倒二","倒三","倒五","倒八","倒十"][tData.areaSelectMode.wanFa]){
                    infos.push(item);
                }

                if (item = ["不封顶","单局20分","单局40分","单局60分","单局80分"][tData.areaSelectMode.fengDing]){
                    infos.push(item);
                }

                if (item = ["不叠加名堂","叠加名堂"][tData.areaSelectMode.sanTiWuKan]){
                    infos.push(item);
                }

                if (item = ["不翻倍","≤10分翻倍","≤15分翻倍","≤20分翻倍","≤30分翻倍"][tData.areaSelectMode.fanBei]){
                    infos.push(item);
                }
        ...
        banner: {
            ...
            _run: function() {
                ...
                if (MjClient.MaxPlayerNum_hanShouPaoHuZi == 2){
            ...
            getRoomNum: {
                ...
                _click: function() {
                    ...
                    var sData = MjClient.data.sData;
                    var str7 = " ";
                    if (Object.keys(sData.players).length > 0 && MjClient.MaxPlayerNum_hanShouPaoHuZi > Object.keys(sData.players).length){
                        str7 += ["一","二","三"][Object.keys(sData.players).length - 1] + "缺" + ["一","二","三"][MjClient.MaxPlayerNum_hanShouPaoHuZi - Object.keys(sData.players).length - 1];
                    }
            ...
            gps_btn: {
                ...
                _click: function() {
                    if(MjClient.MaxPlayerNum_hanShouPaoHuZi == 3){
                        MjClient.Scene.addChild(new showDistance3PlayerLayer());
                    }else if(MjClient.MaxPlayerNum_hanShouPaoHuZi == 4){
            ...
            roundnumImg: {
                ...
                _event: {
                    initSceneData: function(eD) {
                        this.visible = IsArrowVisible_hanShouPaoHuZi();
                    },
                    mjhand: function(eD) {
                        this.visible = IsArrowVisible_hanShouPaoHuZi();
                    },
        ...
        wait: {
            ...
            backHomebtn: {
                ...
                _event: {
                    ...
                    initSceneData: function(eD) {
                        this.visible = isShowBackBtn_hanShouPaoHuZi();
                    },
                    removePlayer: function(eD) {
                        this.visible = isShowBackBtn_hanShouPaoHuZi();
                    },
        ...
        btns_piao:{
            ...
            btn_piao0: {
                _click:function() {
                    var pl = getUIPlayer_hanShouPaoHuZi(0);
                    pl.piaoFen = -1;
                    paioFenToServer_hanShouPaoHuZi(0);
                },
            },
            btn_piao1: {
                _click:function() {
                    var pl = getUIPlayer_hanShouPaoHuZi(0);
                    pl.piaoFen = -1;
                    paioFenToServer_hanShouPaoHuZi(1);
                },
            },
            btn_piao2: {
                _click:function() {
                    var pl = getUIPlayer_hanShouPaoHuZi(0);
                    pl.piaoFen = -1;
                    paioFenToServer_hanShouPaoHuZi(2);
                },
            },
            btn_piao3: {
                _click:function() {
                    var pl = getUIPlayer_hanShouPaoHuZi(0);
                    pl.piaoFen = -1;
                    paioFenToServer_hanShouPaoHuZi(3);
                },
            },
        },
        BtnReady:{
        ...
        down: {
            head: {
                chuizi_tips : {
                    _run: function(){
                        setJiachuiImgTips_hanShouPaoHuZi(this, 0);
                    },
                    _event: {
                        initSceneData: function() {
                            setJiachuiImgTips_hanShouPaoHuZi(this, 0);
                ...
                jiachuiText_tips : {
                    _run: function() {
                        setJiachuiTextTips_hanShouPaoHuZi(this, 0);
                    },
                    _event:{
                        initSceneData: function() {
                            setJiachuiTextTips_hanShouPaoHuZi(this, 0);
                ...
                zhuang: {
                    ...
                    _event: {
                        waitPut: function(){
                            showUserZhuangLogo_hanShouPaoHuZi(this, 0);
                        },
                        initSceneData: function(){
                            if (IsArrowVisible_hanShouPaoHuZi()) showUserZhuangLogo_hanShouPaoHuZi(this, 0);
                        },
                        mjhand: function(){
                            if (IsArrowVisible_hanShouPaoHuZi()) showUserZhuangLogo_hanShouPaoHuZi(this, 0);
                        }
                    ...
                    chattext: {
                        _event: {
                            ...
                            MJChat: function(msg) {
                                ...
                                showUserChat_hanShouPaoHuZi(this, 0, msg);
                            },
                            playVoice: function(voicePath) {
                                MjClient.data._tempMessage.msg = voicePath;
                                showUserChat_hanShouPaoHuZi(this, 0, MjClient.data._tempMessage);
                            }
                        }
                    }
                },
                _click: function(btn) {
                    showPlayerInfo_hanShouPaoHuZi(0, btn);
                },
                _event: {
                    loadWxHead: function(d) {
                        setWxHead_hanShouPaoHuZi(this, d, 0);
                    },
                    addPlayer: function(eD) {
                        showFangzhuTagIcon_hanShouPaoHuZi(this,0);
                    },
                    removePlayer: function(eD) {
                        showFangzhuTagIcon_hanShouPaoHuZi(this,0);
                    }
                ...
                huxi:{
                    ...
                    _event:{
                        ...
                        initSceneData:function(){
                            this.visible = true;
                            var huXi = UpdateHuXi_hanShouPaoHuZi(0);
                            if(!IsArrowVisible_hanShouPaoHuZi()){
                                huXi = 0;
                                this.visible = false;
                            }
                ...
                timeImg:{
                    ...
                    // _event:{
                    //     initSceneData: function(eD) {
                    //         this.visible = curPlayerIsMe_hanShouPaoHuZi(0);
                    //     },
                    //     mjhand: function(eD) {
                    //         this.visible = curPlayerIsMe_hanShouPaoHuZi(0);
                    //     },
                    //     onlinePlayer: function(eD) {
                    //         this.visible = curPlayerIsMe_hanShouPaoHuZi(0) && IsArrowVisible_hanShouPaoHuZi();
                    //     },
                    //     waitPut: function(eD) {
                    //         this.visible = curPlayerIsMe_hanShouPaoHuZi(0);
                    //     },
                    ...
                    //             playTimeUpEff = null;
                    //             var pl = getUIPlayer_hanShouPaoHuZi(0);
                    //             if(pl && pl.onLine && curPlayerIsMe_hanShouPaoHuZi(0)){
                    //                 arrowbkNumberUpdate(this);
                    //             }
                    //         },
                    //         roundEnd: function() {
            ...
            put_sure_btn:{
                _visible: false,
                _layout: [[0.185, 0.143], [0.75, 0.5], [0, 0], true],
                _click: function() {
            ...
            ready: {
                ...
                _run: function() {
                    GetReadyVisible_hanShouPaoHuZi(this, 0);
                },
                _event: {
                    startShuffleCards:function (d) {
                        GetReadyVisible_hanShouPaoHuZi(this, -1);
                    },
                    moveHead: function() {
                        GetReadyVisible_hanShouPaoHuZi(this, -1);
                    },
                    ...
                    addPlayer: function() {
                        GetReadyVisible_hanShouPaoHuZi(this, 0);//根据状态设置ready 是否可见 add by sking
                    },
                    removePlayer: function() {
                        GetReadyVisible_hanShouPaoHuZi(this, 0);
                    },
            ...
            handNode: {
                ...
                _event:  {
                    initSceneData: function() {
                        calculateHintPutList_hanShouPaoHuZi();
                    },
                    HZPickCard: function() {
                        calculateHintPutList_hanShouPaoHuZi();
                    },
                    ...
                    MJPass: function() { // 天胡 提 偎 跑后过胡
                        calculateHintPutList_hanShouPaoHuZi();
                        addTingSign_hanShouPaoHuZi(MjClient.playui._downNode);
                    },
            ...
            _event: {
                clearCardUI: function() {
                    clearCardUI_hanShouPaoHuZi(this, 0);
                },
                ...
                initSceneData: function(eD) {
                    SetUserVisible_hanShouPaoHuZi(this, 0);
                    InitUserHandUI_hanShouPaoHuZi(this, 0);
                    InitUserCoinAndName_hanShouPaoHuZi(this, 0);
                    MjClient.hasPut = false; // 重连回来重置打掉牌标志（打牌时候断线)
                    ShowPutCardIcon_hanShouPaoHuZi();
                    DealOffLineCard_hanShouPaoHuZi(this,0);
                    resetHandAfterBegin_hanShouPaoHuZi();
                },
                addPlayer: function(eD) {
                    SetUserVisible_hanShouPaoHuZi(this, 0);
                    InitUserCoinAndName_hanShouPaoHuZi(this, 0);
                ...
                mjhand: function(eD) {
                    ...
                    var uid = getUIPlayer_hanShouPaoHuZi(0).info.uid;
                    // if (eD.jiazhuNums)
                    // {
                ...
                HZNewCard: function(eD) {
                    ...
                    DealNewCard_hanShouPaoHuZi(this,eD,0);
                },
                MJPut: function(eD) {
                    DealPutCard_hanShouPaoHuZi(this,eD,0);
                },
                HZChiCard: function(eD) {
                    DealChiCard_hanShouPaoHuZi(this, eD, 0);
                },
                HZWeiCard: function(eD){
                    DealWeiCard_hanShouPaoHuZi(this,eD,0);
                },
                HZGangCard: function(eD) {
                    DealGangCard_hanShouPaoHuZi(this, eD, 0);
                },
                MJPeng: function(eD) {
                    DealPengCard_hanShouPaoHuZi(this, eD, 0);
                },
                MJHu: function(eD) {
                    DealHu_hanShouPaoHuZi(this, eD, 0);
                },
                onlinePlayer: function(eD) {
                    resetHandAfterBegin_hanShouPaoHuZi();
                    setUserOffline_hanShouPaoHuZi(this, 0);
                },
                ...
                MJJiazhu: function(msg) {
                    ...
                    MjClient.majiang.setJiaZhuNum(MjClient.playui._downNode, getUIPlayer_hanShouPaoHuZi(0));
                    MjClient.majiang.setJiaZhuNum(MjClient.playui._rightNode, getUIPlayer_hanShouPaoHuZi(1));
                    MjClient.majiang.setJiaZhuNum(MjClient.playui._topNode, getUIPlayer_hanShouPaoHuZi(2));
                },
                HZPickCard:function (eD) {
                    ...
                    DealShowLastCard_hanShouPaoHuZi(this, eD, 0);
                },
                HZAddCards:function (eD) {
                    DealAddCard_hanShouPaoHuZi(this,eD, 0);
                },
        ...
        right: {
            head: {
                chuizi_tips : {
                    _run: function(){
                        setJiachuiImgTips_hanShouPaoHuZi(this, changeUIOff_hanShouPaoHuZi(2));
                    },
                    _event: {
                        initSceneData: function() {
                            setJiachuiImgTips_hanShouPaoHuZi(this, changeUIOff_hanShouPaoHuZi(2));
                ...
                jiachuiText_tips : {
                    _run:function() {
                        setJiachuiTextTips_hanShouPaoHuZi(this, changeUIOff_hanShouPaoHuZi(2));
                    },
                    _event:{
                        initSceneData: function() {
                            setJiachuiTextTips_hanShouPaoHuZi(this, changeUIOff_hanShouPaoHuZi(2));
                        ...
                        MJJiazhu: function(msg) {
                            var pl = getUIPlayer_hanShouPaoHuZi(changeUIOff_hanShouPaoHuZi(2))
                            if (msg.uid == pl.info.uid) {
                                setJiachuiTextTips_hanShouPaoHuZi(this, changeUIOff_hanShouPaoHuZi(2));
                            }
                        },
                ...
                zhuang: {
                    ...
                    _event: {
                        waitPut: function() {
                            showUserZhuangLogo_hanShouPaoHuZi(this, changeUIOff_hanShouPaoHuZi(2));
                        },
                        initSceneData: function() {
                            if (IsArrowVisible_hanShouPaoHuZi()) showUserZhuangLogo_hanShouPaoHuZi(this, changeUIOff_hanShouPaoHuZi(2));
                        },
                        mjhand: function(){
                            if (IsArrowVisible_hanShouPaoHuZi()) showUserZhuangLogo_hanShouPaoHuZi(this, changeUIOff_hanShouPaoHuZi(2));
                        }
                ...
                chatbg: {
                    ...
                    chattext: {
                        _event: {
                            MJChat: function(msg) {
                                showUserChat_hanShouPaoHuZi(this, changeUIOff_hanShouPaoHuZi(2), msg);
                            },
                            playVoice: function(voicePath) {
                                MjClient.data._tempMessage.msg = voicePath;
                                showUserChat_hanShouPaoHuZi(this, changeUIOff_hanShouPaoHuZi(2), MjClient.data._tempMessage);
                            }
                        }
                    }
                },
                _click: function(btn) {
                    showPlayerInfo_hanShouPaoHuZi(changeUIOff_hanShouPaoHuZi(2), btn);
                },
                _event: {
                    loadWxHead: function(d) {
                        setWxHead_hanShouPaoHuZi(this, d, changeUIOff_hanShouPaoHuZi(2));
                    },
                    addPlayer: function(eD) {
                        showFangzhuTagIcon_hanShouPaoHuZi(this,changeUIOff_hanShouPaoHuZi(2));
                    },
                    removePlayer: function(eD) {
                        showFangzhuTagIcon_hanShouPaoHuZi(this,changeUIOff_hanShouPaoHuZi(2));
                    }
                ...
                huxi:{
                    ...
                    _event:{
                        ...
                        initSceneData:function(){
                            this.visible = true;
                            var huXi = UpdateHuXi_hanShouPaoHuZi(changeUIOff_hanShouPaoHuZi(2));
                            if(!IsArrowVisible_hanShouPaoHuZi()){
                                huXi = 0;
                                this.visible = false;
                            }
                ...
                timeImg:{
                    ...
                    // _event:{
                    //     initSceneData: function(eD) {
                    //         this.visible = curPlayerIsMe_hanShouPaoHuZi(1);
                    //     },
                    //     mjhand: function(eD) {
                    //         this.visible = curPlayerIsMe_hanShouPaoHuZi(1);
                    //     },
                    //     onlinePlayer: function(eD) {
                    //         this.visible = curPlayerIsMe_hanShouPaoHuZi(1) && IsArrowVisible_hanShouPaoHuZi();
                    //     },
                    //     waitPut: function(eD) {
                    //         this.visible = curPlayerIsMe_hanShouPaoHuZi(1);
                    //     },
                    ...
                    //             stopEffect(playTimeUpEff);
                    //             playTimeUpEff = null;
                    //             if(curPlayerIsMe_hanShouPaoHuZi(1)){
                    //                 arrowbkNumberUpdate(this);
                    //                 this.setString("00");
                    //             }
                    //         },
                    ...
                    //             stopEffect(playTimeUpEff);
                    //             playTimeUpEff = null;
                    //             var pl = getUIPlayer_hanShouPaoHuZi(1);
                    //             if(pl && pl.onLine && curPlayerIsMe_hanShouPaoHuZi(1)){
                    //                 arrowbkNumberUpdate(this);
                    //             }
                    //         },
                    //         roundEnd: function() {
            ...
            ready: {
                _layout: [[0.07, 0.07],[0.5, 0.5],[2.5, 2.5]],
                _run: function() {
                    GetReadyVisible_hanShouPaoHuZi(this, changeUIOff_hanShouPaoHuZi(2));
                },
                _event: {
                    startShuffleCards:function (d) {
                        GetReadyVisible_hanShouPaoHuZi(this, -1);
            ...
            _event: {
                clearCardUI: function() {
                    clearCardUI_hanShouPaoHuZi(this, changeUIOff_hanShouPaoHuZi(2));
                },
                clearCardArr: function(){
                    var eatNode = this.getChildByName("eatNode");
                    eatNode.removeAllChildren();
                ...
                initSceneData: function(eD) {
                    SetUserVisible_hanShouPaoHuZi(this, changeUIOff_hanShouPaoHuZi(2));
                    InitUserHandUI_hanShouPaoHuZi(this, changeUIOff_hanShouPaoHuZi(2));
                    InitUserCoinAndName_hanShouPaoHuZi(this, changeUIOff_hanShouPaoHuZi(2));
                    DealOffLineCard_hanShouPaoHuZi(this,changeUIOff_hanShouPaoHuZi(2));
                },
                addPlayer: function(eD) {
                    SetUserVisible_hanShouPaoHuZi(this, changeUIOff_hanShouPaoHuZi(2));
                    InitUserCoinAndName_hanShouPaoHuZi(this, changeUIOff_hanShouPaoHuZi(2));
                ...
                HZNewCard: function(eD) {
                    ...
                    DealNewCard_hanShouPaoHuZi(this,eD,changeUIOff_hanShouPaoHuZi(2));
                },
                roundEnd: function() {
                    InitUserCoinAndName_hanShouPaoHuZi(this, changeUIOff_hanShouPaoHuZi(2));
                    MjClient.playui.ResetOtherCard(this, changeUIOff_hanShouPaoHuZi(2));
                },
                waitPut: function(eD) {
                    DealWaitPut(this, eD, 1);
                },
                MJPut: function(eD) {
                    DealPutCard_hanShouPaoHuZi(this, eD, changeUIOff_hanShouPaoHuZi(2));
                },
                HZChiCard: function(eD) {
                    DealChiCard_hanShouPaoHuZi(this, eD, changeUIOff_hanShouPaoHuZi(2));
                },
                HZGangCard: function(eD) {
                    DealGangCard_hanShouPaoHuZi(this, eD, changeUIOff_hanShouPaoHuZi(2));
                },
                MJPeng: function(eD) {
                    DealPengCard_hanShouPaoHuZi(this, eD, changeUIOff_hanShouPaoHuZi(2));
                },
                HZWeiCard: function(eD){
                    DealWeiCard_hanShouPaoHuZi(this, eD, changeUIOff_hanShouPaoHuZi(2));
                },
                MJHu: function(eD) {
                    DealHu_hanShouPaoHuZi(this, eD, changeUIOff_hanShouPaoHuZi(2));
                },
                onlinePlayer: function(eD) {
                    setUserOffline_hanShouPaoHuZi(this, changeUIOff_hanShouPaoHuZi(2));
                },
                playerStatusChange: function(eD) {
                    setUserOffline_hanShouPaoHuZi(this, changeUIOff_hanShouPaoHuZi(2));
                },
                MJFlower: function(eD) {
                    HandleMJFlower(this, eD, changeUIOff_hanShouPaoHuZi(2));
                },
                MJTing: function (eD) {
                    HandleMJTing(this, eD, changeUIOff_hanShouPaoHuZi(2));
                },
                HZPickCard:function (eD) {
                    if(MjClient.rePlayVideo != -1){
                        MjClient.playui._doPickResetHandCardForPlayBack(eD, changeUIOff_hanShouPaoHuZi(2));
                    }

                    // RemovePutCardOut_hanShouPaoHuZi(true);
                    // MjClient.playui.ResetHandCard(this,1);

                    DealShowLastCard_hanShouPaoHuZi(this, eD, changeUIOff_hanShouPaoHuZi(2));
                },
                HZAddCards:function (eD) {
                    DealAddCard_hanShouPaoHuZi(this,eD, changeUIOff_hanShouPaoHuZi(2));
                },
                HZCheckRaise:function (msg) {
                    ShowPutCardIcon_hanShouPaoHuZi();
                    //MjClient.playui.EatVisibleCheck();
        ...
        left: {
            head: {
                chuizi_tips : {
                    _run: function(){
                        setJiachuiImgTips_hanShouPaoHuZi(this, changeUIOff_hanShouPaoHuZi(3));
                    },
                    _event: {
                        initSceneData: function() {
                            setJiachuiImgTips_hanShouPaoHuZi(this, changeUIOff_hanShouPaoHuZi(3));
                ...
                jiachuiText_tips : {
                    _visible:false,
                    _run:function() {
                        setJiachuiTextTips_hanShouPaoHuZi(this, changeUIOff_hanShouPaoHuZi(3));
                    },
                    _event:{
                        initSceneData: function() {
                            setJiachuiTextTips_hanShouPaoHuZi(this, changeUIOff_hanShouPaoHuZi(3));
                        ...
                        MJJiazhu: function(msg) {
                            var pl = getUIPlayer_hanShouPaoHuZi(changeUIOff_hanShouPaoHuZi(3))
                            if (msg.uid == pl.info.uid) {
                                setJiachuiTextTips_hanShouPaoHuZi(this, changeUIOff_hanShouPaoHuZi(3));
                            }
                        },
                ...
                zhuang: {
                    ...
                    _event: {
                        waitPut: function() {
                            showUserZhuangLogo_hanShouPaoHuZi(this, changeUIOff_hanShouPaoHuZi(3));
                        },
                        initSceneData: function() {
                            if (IsArrowVisible_hanShouPaoHuZi()) showUserZhuangLogo_hanShouPaoHuZi(this, changeUIOff_hanShouPaoHuZi(3));
                        },
                        mjhand: function(){
                            if (IsArrowVisible_hanShouPaoHuZi()) showUserZhuangLogo_hanShouPaoHuZi(this, changeUIOff_hanShouPaoHuZi(3));
                        }
                ...
                chatbg: {
                    ...
                    chattext: {
                        _event: {
                            MJChat: function(msg) {
                                showUserChat_hanShouPaoHuZi(this, changeUIOff_hanShouPaoHuZi(3), msg);
                            },
                            playVoice: function(voicePath) {
                                MjClient.data._tempMessage.msg = voicePath;
                                showUserChat_hanShouPaoHuZi(this, changeUIOff_hanShouPaoHuZi(3), MjClient.data._tempMessage);
                            }
                        }
                    }
                },
                _click: function(btn) {
                    showPlayerInfo_hanShouPaoHuZi(changeUIOff_hanShouPaoHuZi(3), btn);
                },
                _event: {
                    loadWxHead: function(d) {
                        setWxHead_hanShouPaoHuZi(this, d, changeUIOff_hanShouPaoHuZi(3));
                    },
                    addPlayer: function(eD) {
                        showFangzhuTagIcon_hanShouPaoHuZi(this,changeUIOff_hanShouPaoHuZi(3));
                    },
                    removePlayer: function(eD) {
                        showFangzhuTagIcon_hanShouPaoHuZi(this,changeUIOff_hanShouPaoHuZi(3));
                    }
                ...
                huxi:{
                    ...
                    _event:{
                        ...
                        initSceneData:function(){
                            this.visible = true;
                            var huXi = UpdateHuXi_hanShouPaoHuZi(changeUIOff_hanShouPaoHuZi(3));
                            if(!IsArrowVisible_hanShouPaoHuZi()){
                                huXi = 0;
                                this.visible = false;
                            }
                ...
                timeImg:{
                    ...
                    // _event:{
                    //     initSceneData: function(eD) {
                    //         this.visible = curPlayerIsMe_hanShouPaoHuZi(2);
                    //     },
                    //     mjhand: function(eD) {
                    //         this.visible = curPlayerIsMe_hanShouPaoHuZi(2);
                    //     },
                    //     onlinePlayer: function(eD) {
                    //         this.visible = curPlayerIsMe_hanShouPaoHuZi(2) && IsArrowVisible_hanShouPaoHuZi();
                    //     },
                    //     waitPut: function(eD) {
                    //         this.visible = curPlayerIsMe_hanShouPaoHuZi(2);
                    //     },
                    ...
                    //             stopEffect(playTimeUpEff);
                    //             playTimeUpEff = null;
                    //             if(curPlayerIsMe_hanShouPaoHuZi(2)){
                    //                 arrowbkNumberUpdate(this);
                    //                 this.setString("00");
                    //             }
                    //         },
                    ...
                    //             stopEffect(playTimeUpEff);
                    //             playTimeUpEff = null;
                    //             var pl = getUIPlayer_hanShouPaoHuZi(2);
                    //             if(pl && pl.onLine && curPlayerIsMe_hanShouPaoHuZi(2)){
                    //                 arrowbkNumberUpdate(this);
                    //             }
                    //         },
                    //         roundEnd: function() {
            ...
            ready: {
                _layout: [[0.07, 0.07],[0.5, 0.5],[-2.5, 2.5]],
                _run: function() {
                    GetReadyVisible_hanShouPaoHuZi(this, changeUIOff_hanShouPaoHuZi(3));
                },
                _event: {
                    startShuffleCards:function (d) {
                        GetReadyVisible_hanShouPaoHuZi(this, -1);
            ...
            _event: {
                clearCardUI: function() {
                    clearCardUI_hanShouPaoHuZi(this, changeUIOff_hanShouPaoHuZi(3));
                },
                clearCardArr: function(){
                    var eatNode = this.getChildByName("eatNode");
                    eatNode.removeAllChildren();
                ...
                initSceneData: function(eD) {
                    SetUserVisible_hanShouPaoHuZi(this, changeUIOff_hanShouPaoHuZi(3));
                    InitUserHandUI_hanShouPaoHuZi(this, changeUIOff_hanShouPaoHuZi(3));
                    InitUserCoinAndName_hanShouPaoHuZi(this, changeUIOff_hanShouPaoHuZi(3));
                    DealOffLineCard_hanShouPaoHuZi(this,changeUIOff_hanShouPaoHuZi(3));
                },
                addPlayer: function(eD) {
                    SetUserVisible_hanShouPaoHuZi(this, changeUIOff_hanShouPaoHuZi(3));
                    InitUserCoinAndName_hanShouPaoHuZi(this, changeUIOff_hanShouPaoHuZi(3));
                ...
                HZNewCard: function(eD) {
                    ...
                    DealNewCard_hanShouPaoHuZi(this,eD,changeUIOff_hanShouPaoHuZi(3));
                },
                roundEnd: function() {
                    InitUserCoinAndName_hanShouPaoHuZi(this,changeUIOff_hanShouPaoHuZi(3));
                    MjClient.playui.ResetOtherCard(this, changeUIOff_hanShouPaoHuZi(3));
                },
                waitPut: function(eD) {
                    DealWaitPut(this, eD, changeUIOff_hanShouPaoHuZi(3));
                },
                MJPut: function(eD) {
                    DealPutCard_hanShouPaoHuZi(this, eD, changeUIOff_hanShouPaoHuZi(3));
                },
                HZChiCard: function(eD) {
                    DealChiCard_hanShouPaoHuZi(this, eD, changeUIOff_hanShouPaoHuZi(3));
                },
                HZGangCard: function(eD) {
                    DealGangCard_hanShouPaoHuZi(this, eD, changeUIOff_hanShouPaoHuZi(3));
                },
                MJPeng: function(eD) {
                    DealPengCard_hanShouPaoHuZi(this, eD, changeUIOff_hanShouPaoHuZi(3));
                },
                HZWeiCard: function(eD){
                    DealWeiCard_hanShouPaoHuZi(this, eD, changeUIOff_hanShouPaoHuZi(3));
                },
                MJHu: function(eD) {
                    DealHu_hanShouPaoHuZi(this, eD, changeUIOff_hanShouPaoHuZi(3));
                },
                onlinePlayer: function(eD) {
                    setUserOffline_hanShouPaoHuZi(this, changeUIOff_hanShouPaoHuZi(3));
                },
                playerStatusChange: function(eD) {
                    setUserOffline_hanShouPaoHuZi(this, changeUIOff_hanShouPaoHuZi(3));
                },
                MJFlower: function(eD) {
                    HandleMJFlower(this, eD, changeUIOff_hanShouPaoHuZi(3));
                },
                MJTing: function (eD) {
                    HandleMJTing(this, eD, changeUIOff_hanShouPaoHuZi(3));
                },
                HZPickCard:function (eD) {
                    if(MjClient.rePlayVideo != -1) {
                        MjClient.playui._doPickResetHandCardForPlayBack(eD, changeUIOff_hanShouPaoHuZi(3));
                    }
                    // RemovePutCardOut_hanShouPaoHuZi(true);
                    // MjClient.playui.ResetHandCard(this,2);

                    DealShowLastCard_hanShouPaoHuZi(this, eD, changeUIOff_hanShouPaoHuZi(3));
                },
                HZAddCards:function (eD) {
                    DealAddCard_hanShouPaoHuZi(this,eD, changeUIOff_hanShouPaoHuZi(3));
                },
                HZCheckRaise:function (msg) {
                    ShowPutCardIcon_hanShouPaoHuZi();
                    //MjClient.playui.EatVisibleCheck();
        ...
        xing: {
            _run:function () {
                if(MjClient.MaxPlayerNum_hanShouPaoHuZi != 4){
                    this.setVisible(false);
                }
            },
            head: {
                chuizi_tips : {
                    _run: function(){
                        setJiachuiImgTips_hanShouPaoHuZi(this, changeUIOff_hanShouPaoHuZi(1));
                    },
                    _event: {
                        initSceneData: function() {
                            setJiachuiImgTips_hanShouPaoHuZi(this, changeUIOff_hanShouPaoHuZi(1));
                ...
                jiachuiText_tips : {
                    _run:function() {
                        setJiachuiTextTips_hanShouPaoHuZi(this, changeUIOff_hanShouPaoHuZi(1));
                    },
                    _event:{
                        initSceneData: function() {
                            setJiachuiTextTips_hanShouPaoHuZi(this, changeUIOff_hanShouPaoHuZi(1));
                        ...
                        MJJiazhu: function(msg) {
                            var pl = getUIPlayer_hanShouPaoHuZi(changeUIOff_hanShouPaoHuZi(1))
                            if (msg.uid == pl.info.uid) {
                                setJiachuiTextTips_hanShouPaoHuZi(this, changeUIOff_hanShouPaoHuZi(1));
                            }
                        },
                ...
                zhuang: {
                    ...
                    _event: {
                        waitPut: function() {
                            if(MjClient.MaxPlayerNum_hanShouPaoHuZi == 4 ) {
                                showUserZhuangLogo_hanShouPaoHuZi(this, changeUIOff_hanShouPaoHuZi(1));
                            }
                        },
                        initSceneData: function() {
                            if(MjClient.MaxPlayerNum_hanShouPaoHuZi == 4 ) {
                                if (IsArrowVisible_hanShouPaoHuZi()) showUserZhuangLogo_hanShouPaoHuZi(this, changeUIOff_hanShouPaoHuZi(1));
                            }
                        },
                        mjhand: function(){
                            if(MjClient.MaxPlayerNum_hanShouPaoHuZi == 4 ) {
                ...
                chatbg: {
                    ...
                    chattext: {
                        _event: {
                            MJChat: function(msg) {
                                if(MjClient.MaxPlayerNum_hanShouPaoHuZi == 4) {
                                    showUserChat_hanShouPaoHuZi(this, changeUIOff_hanShouPaoHuZi(1), msg);
                                }
                            },
                            playVoice: function(voicePath) {
                                if(MjClient.MaxPlayerNum_hanShouPaoHuZi == 4) {
                                    MjClient.data._tempMessage.msg = voicePath;
                                    showUserChat_hanShouPaoHuZi(this, changeUIOff_hanShouPaoHuZi(1), MjClient.data._tempMessage);
                                }
                            }
                        }
                    }
                ...
                _click: function(btn) {
                    if(MjClient.MaxPlayerNum_hanShouPaoHuZi == 4) {
                        showPlayerInfo_hanShouPaoHuZi(changeUIOff_hanShouPaoHuZi(1), btn);
                    }
                },
                _event: {
                    loadWxHead: function(d) {
                        if(MjClient.MaxPlayerNum_hanShouPaoHuZi == 4) {
                            setWxHead_hanShouPaoHuZi(this, d, changeUIOff_hanShouPaoHuZi(1));
                        }
                    },
                    addPlayer: function(eD) {
                        showFangzhuTagIcon_hanShouPaoHuZi(this,changeUIOff_hanShouPaoHuZi(1));
                    },
                    removePlayer: function(eD) {
                        showFangzhuTagIcon_hanShouPaoHuZi(this,changeUIOff_hanShouPaoHuZi(1));
                    }
                ...
                huxi:{
                    ...
                    _event:{
                        ...
                        initSceneData:function(){
                            if(MjClient.MaxPlayerNum_hanShouPaoHuZi == 4) {
                                this.visible = true;
                                var huXi = UpdateHuXi_hanShouPaoHuZi(changeUIOff_hanShouPaoHuZi(1));
                                if (!IsArrowVisible_hanShouPaoHuZi()) {
                                    huXi = 0;
                                    this.visible = false;
                                }
            ...
            ready: {
                ...
                _run: function() {
                    if(MjClient.MaxPlayerNum_hanShouPaoHuZi == 4) {
                        GetReadyVisible_hanShouPaoHuZi(this, changeUIOff_hanShouPaoHuZi(1));
                    }
                },
                _event: {
                    startShuffleCards:function (d) {
            ...
            _event: {
                clearCardUI: function() {
                    if(MjClient.MaxPlayerNum_hanShouPaoHuZi == 4) {
                        clearCardUI_hanShouPaoHuZi(this, changeUIOff_hanShouPaoHuZi(1));
                    }
                },
                clearCardArr: function(){
                    if(MjClient.MaxPlayerNum_hanShouPaoHuZi == 4) {
                ...
                initSceneData: function(eD) {
                    if(MjClient.MaxPlayerNum_hanShouPaoHuZi == 4) {
                        SetUserVisible_hanShouPaoHuZi(this, changeUIOff_hanShouPaoHuZi(1));
                        InitUserHandUI_hanShouPaoHuZi(this, changeUIOff_hanShouPaoHuZi(1));
                        InitUserCoinAndName_hanShouPaoHuZi(this, changeUIOff_hanShouPaoHuZi(1));
                        DealOffLineCard_hanShouPaoHuZi(this, changeUIOff_hanShouPaoHuZi(1));
                    }
                },
                addPlayer: function(eD) {
                    if(MjClient.MaxPlayerNum_hanShouPaoHuZi == 4) {
                ...
                HZNewCard: function(eD) {
                    if(MjClient.MaxPlayerNum_hanShouPaoHuZi == 4) {
                        ...
                        DealNewCard_hanShouPaoHuZi(this, eD, changeUIOff_hanShouPaoHuZi(1));
                    }
                },
                roundEnd: function() {
                    if(MjClient.MaxPlayerNum_hanShouPaoHuZi == 4) {
                        InitUserCoinAndName_hanShouPaoHuZi(this, changeUIOff_hanShouPaoHuZi(1));
                        MjClient.playui.ResetOtherCard(this, changeUIOff_hanShouPaoHuZi(1));
                    }
                },
                waitPut: function(eD) {
                    if(MjClient.MaxPlayerNum_hanShouPaoHuZi == 4) {
                        DealWaitPut(this, eD, changeUIOff_hanShouPaoHuZi(1));
                    }
                },
                MJPut: function(eD) {
                    if(MjClient.MaxPlayerNum_hanShouPaoHuZi == 4) {
                        DealPutCard_hanShouPaoHuZi(this, eD, changeUIOff_hanShouPaoHuZi(1));
                    }
                },
                HZChiCard: function(eD) {
                    if(MjClient.MaxPlayerNum_hanShouPaoHuZi == 4) {
                        DealChiCard_hanShouPaoHuZi(this, eD, changeUIOff_hanShouPaoHuZi(1));
                    }
                },
                HZGangCard: function(eD) {
                    if(MjClient.MaxPlayerNum_hanShouPaoHuZi == 4) {
                        DealGangCard_hanShouPaoHuZi(this, eD, changeUIOff_hanShouPaoHuZi(1));
                    }
                },
                MJPeng: function(eD) {
                    if(MjClient.MaxPlayerNum_hanShouPaoHuZi == 4) {
                        DealPengCard_hanShouPaoHuZi(this, eD, changeUIOff_hanShouPaoHuZi(1));
                    }
                },
                HZWeiCard: function(eD){
                    if(MjClient.MaxPlayerNum_hanShouPaoHuZi == 4) {
                        DealWeiCard_hanShouPaoHuZi(this, eD, changeUIOff_hanShouPaoHuZi(1));
                    }
                },
                MJHu: function(eD) {
                    if(MjClient.MaxPlayerNum_hanShouPaoHuZi == 4) {
                        DealHu_hanShouPaoHuZi(this, eD, changeUIOff_hanShouPaoHuZi(1));
                    }
                },
                onlinePlayer: function(eD) {
                    if(MjClient.MaxPlayerNum_hanShouPaoHuZi == 4) {
                        setUserOffline_hanShouPaoHuZi(this, changeUIOff_hanShouPaoHuZi(1));
                    }
                },
                playerStatusChange: function(eD) {
                    if(MjClient.MaxPlayerNum_hanShouPaoHuZi == 4) {
                ...
                MJFlower: function(eD) {
                    if(MjClient.MaxPlayerNum_hanShouPaoHuZi == 4) {
                        HandleMJFlower(this, eD, changeUIOff_hanShouPaoHuZi(1));
                    }
                },
                MJTing: function (eD) {
                    if(MjClient.MaxPlayerNum_hanShouPaoHuZi == 4) {
                        HandleMJTing(this, eD, changeUIOff_hanShouPaoHuZi(1));
                    }
                },
                HZPickCard:function (eD) {
                    if(MjClient.MaxPlayerNum_hanShouPaoHuZi == 4) {
                        if (MjClient.rePlayVideo != -1 ) {
                            var pl = getUIPlayer_hanShouPaoHuZi(changeUIOff_hanShouPaoHuZi(1));
                            if (eD.uid == pl.info.uid) {
                                MjClient.OtherHandArr[changeUIOff_hanShouPaoHuZi(1)] = MjClient.majiang.sortHandCardSpecial(pl.mjhand)
                            }
                        }
                        DealShowLastCard_hanShouPaoHuZi(this, eD, changeUIOff_hanShouPaoHuZi(1));
                    }
                },
                HZAddCards:function (eD) {
                    if(MjClient.MaxPlayerNum_hanShouPaoHuZi == 4) {
                        DealAddCard_hanShouPaoHuZi(this, eD, changeUIOff_hanShouPaoHuZi(1));
                    }
                },
                HZCheckRaise:function (msg) {
                    if(MjClient.MaxPlayerNum_hanShouPaoHuZi == 4) {
        ...
        eat: {
            chi: {
                ...
                _touch: function(btn, eT) {
                    if (eT == 2){
                        if(ziPai.getHasFastEat()){
                            ...
                            if (chiSet.length == 1) {
                                ...
                                if (pl.mjhand.indexOf(putCard) < 0 || copy.indexOf(putCard) >= 0) {
                                    ...
                                    commitEatCards_hanShouPaoHuZi(eatCards, null);
                        ...
                        showSelectEatCards_hanShouPaoHuZi(this,btn.tag);
                        ...
                        // MJChiCardchange_hanShouPaoHuZi();
                    }
                }
            },
            noTing : {
            ...
            hu: {
                ...
                _touch: function(btn, eT) {
                    if (eT == 2) {
                        MJHuToServer_hanShouPaoHuZi();
                        setChiVisible_hanShouPaoHuZi();//add by maoyu
                    }
                }
            },
            cancel: {
            ...
            wangDiao:{
                ...
                _touch: function(btn, eT) {
                    console.log(">>>> lf，点击碰按钮");
                    if (eT == 2) {
                        HZWangChuangToServer_hanShouPaoHuZi(1);
                        setChiVisible_hanShouPaoHuZi();//add by maoyu
                    }
                }
            },
            wangChuang:{
                ...
                _touch: function(btn, eT) {
                    console.log(">>>> lf，点击碰按钮");
                    if (eT == 2) {
                        HZWangChuangToServer_hanShouPaoHuZi(2);
                        setChiVisible_hanShouPaoHuZi();//add by maoyu
                    }
                }
            },
            wangZha:{
                ...
                _touch: function(btn, eT) {
                    console.log(">>>> lf，点击碰按钮");
                    if (eT == 2) {
                        HZWangChuangToServer_hanShouPaoHuZi(4);
                        setChiVisible_hanShouPaoHuZi();//add by maoyu
                    }
                }
            },
                    ...
                    this.adaptChiLayout = function() {
                        ...
                        if (cards_option.length == 0) { // 吃牌选好了
                            if ((MjClient.data.sData.players[SelfUid()].eatFlag & 32) > 0) {
                                MjClient.showMsg("选择吃后视为过胡，确定吃吗？", function() {
                                    ...
                                    HZChiToServer_hanShouPaoHuZi(cards_select[0], biCards);
                                    this.visible = false;
                                }.bind(this), function() {
                                    cards_select.pop();
                                    this.adaptChiLayout();
                        ...
                        for (var i = 0; i < cards_select.length; i++) {
                            ...
                            for (var j = 0; j < row.length; j++) {
                                ...
                                chiCardImg.loadTexture(MjClient.cardPath_hanShouPaoHuZi + "out" + row[j] + ".png");
        ...
        voice_btn: {
            ...
            _event: {
                ...
                downAndPlayVoice: function(msg) {
                    ...
                    downAndPlayVoice_hanShouPaoHuZi(msg.uid, msg.msg);
                }
            }
        },
        cutLine:{
    ...
    ctor: function() {
        this._super();
        ziPai.initZiPaiData();
        var playui = ccs.load("Play_hanShouPaoHuZi.json");
        playMusic("bgFight");
        var tData = MjClient.data.sData.tData;
        MjClient.MaxPlayerNum_hanShouPaoHuZi = tData.maxPlayer;
        ...
        if (MjClient.MaxPlayerNum_hanShouPaoHuZi == 2){
            ...
            this.jsBind.right = PlayLayer_hanShouPaoHuZi.jsBindRightCopy;
        }
        ...
        this.tingLayer = new HanShouPaoHuZiTingLayer();
    ...
    resetJiaZhuTip: function()
    {
        ...
        for (var i = 0; i < MjClient.MaxPlayerNum_hanShouPaoHuZi; i ++)
        {
            var pl = getUIPlayer_hanShouPaoHuZi(i);
            if (!pl)
                continue;
...
PlayLayer_hanShouPaoHuZi.jsBindRightCopy = PlayLayer_hanShouPaoHuZi.prototype.jsBind.right;

//重置手牌的顺序
PlayLayer_hanShouPaoHuZi.prototype.ResetHandCard = function(posNode,off, needAction, isDelay){

    needAction = needAction === undefined ? false : needAction;
    // needAction = false;

    if(off == 0){
        resetHandCard_hanShouPaoHuZiEx(posNode,off, needAction, isDelay);
...
//回放时其他家补牌重置手牌的处理
PlayLayer_hanShouPaoHuZi.prototype._doPickResetHandCardForPlayBack = function(msg, off){
    var pl = getUIPlayer_hanShouPaoHuZi(off);
...
PlayLayer_hanShouPaoHuZi.prototype._doMovetoAction = function(node,endP){
    node.stopAllActions();
    var ac = cc.moveTo(0.3,endP);
    node.runAction(ac);
};

PlayLayer_hanShouPaoHuZi.prototype.ResetOtherCard = function(posNode, off) {
    //添加吃、碰、跑、偎、提
    var sData = MjClient.data.sData;
    var tData = null;
    if (sData) {
    ...
    if (mjSortArr) {
            ...
            for (var i = 0; i < childList.length; i++) {
                ...
                if(tData.maxPlayer == 4){
                    if((off <= 1 && i != childList.length - 1) ||
                        (off >= 2 && i != 0)){
                        child.loadTexture(MjClient.cardPath_hanShouPaoHuZi + "huxiBG.png");
                    }
                }else{
        ...
        for (var k = 0; k < mjSortArr.length; k++) {
            ...
            if (name == "mjgang1") {
                ...
                for (var i = 0; i < 4; i++) {
                    addEatCard_hanShouPaoHuZi(posNode, "mjgang1" + k, cardNum, off);
                }
            ...
            if (name == "mjwei") {
                var cardNum = pl.mjwei[pos];
                for (var i = 0; i < 3; i++) {
                    addEatCard_hanShouPaoHuZi(posNode, "mjwei" + k, cardNum, off);
                }

                var weiParentNode = eatNode.getChildByName("mjwei" + k);
                var childArr = weiParentNode.children;
                var skipPeng = pl.skipPeng;
                if(MjClient.majiang.getCardShowType(pl.info.uid, cardNum) != 2 && MjClient.majiang.getCardShowType(pl.info.uid, cardNum) != 1){
                    //callback(childArr);
            ...
            if (name == "mjgang0") {
                ...
                for (var i = 0; i < 4; i++) {
                    addEatCard_hanShouPaoHuZi(posNode, "mjgang0" + k, cardNum, off);
                }
            }
            //碰
            if (name == "mjpeng") {
                ...
                for (var i = 0; i < 3; i++) {
                    addEatCard_hanShouPaoHuZi(posNode, "mjpeng" + k, cardNum, off);
                }
            }
            //吃
            if (name == "mjchi") {
                ...
                for (var i = 0; i < eatCards.length; i++) {
                    addEatCard_hanShouPaoHuZi(posNode, "mjchi" + k, eatCards[i], off);
                }
                ...
                if (biCards && biCards.length > 0) {
                    for (var i = 0; i < biCards.length; i++) {
                        ...
                        for (var m = 0; m < biArr.length; m++) {
                            addEatCard_hanShouPaoHuZi(posNode, "mjbi" + k + i, biArr[m], off);
                        }
                    }
                }
    ...
    //    var outCard = getNewCard_hanShouPaoHuZi(pl.mjput[i], 2, off);
    //    if(off == 0){
    //        outCard.anchorX = 1;
    //        outCard.anchorY = 0;
...
PlayLayer_hanShouPaoHuZi.prototype.ResetPutCard = function(posNode,off){
    //添加打出的牌
    var pl = getUIPlayer_hanShouPaoHuZi(off);
    if (!pl) return;
    var outNode = posNode.getChildByName("outNode");
    ...
    for (var i = 0; i < pl.mjput.length; i++) {
        ...
        setPutCardPos_hanShouPaoHuZi(outNode, outCard, i, off);
...
//重置牌的顺序
PlayLayer_hanShouPaoHuZi.prototype.CardLayoutRestore = function(posNode,off){
    if(MjClient.rePlayVideo == -1){
...
// 判断吃、碰、跑、偎、提、胡的状态
PlayLayer_hanShouPaoHuZi.prototype.EatVisibleCheck = function(off){
    var eat = MjClient.playui.jsBind.eat;
    ...
    if(tData.tState != TableState.roundFinish && pl.mjState != TableState.roundFinish){
        if(IsTurnToMe()){
            ...
            if(pl.eatFlag & 4){
                ...
                if(!canHu){
                    // HZGangToServer_hanShouPaoHuZi(2);
                    return;
                }
            }
            //吃
...
PlayLayer_hanShouPaoHuZi.prototype.showAndHideHeadEffect = function(){
    ...
    else if (curPlayerIsMe_hanShouPaoHuZi(1)){
        curPlayerNode = arr[1].getChildByName("head");
    }else if (curPlayerIsMe_hanShouPaoHuZi(2)){
        curPlayerNode = arr[2].getChildByName("head");
    }else if (curPlayerIsMe_hanShouPaoHuZi(3)){
