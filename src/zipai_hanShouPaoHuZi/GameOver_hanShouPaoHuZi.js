function addWxHeadToEndUI_hanShouPaoHuZi_GO(node, off) {
...
function SetGameOverLayer_hanShouPaoHuZi(node,off,isNewUi){
    ...
    addWxHeadToEndUI_hanShouPaoHuZi_GO(wxNode,off);
    ...
    //
    showRoomStatistics(textNode,["huNum","ziNum","tiNum","paoNum"],pl.roomStatistics);
}

var GameOverLayer_hanShouPaoHuZi = cc.Layer.extend({
    sprite:null,
    jsBind:{
        back:{
            close :{
    ...
    ctor:function () {
        this._super();
        var endallui = ccs.load("endAll_HanShouPaoHuZi.json");
        ...
        for(var i = 0 ; i < playerCount ; i++){
            ...
            SetGameOverLayer_hanShouPaoHuZi(clone,i, false);
