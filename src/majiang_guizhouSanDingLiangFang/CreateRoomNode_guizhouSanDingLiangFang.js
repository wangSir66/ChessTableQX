...
var CreateRoomNode_guizhouSanDingLiangFang = CreateRoomNode.extend({
    setKey:function(){
        this.localStorageKey.KEY_guizhouSanDingLiangFang_yaobaiji     = "_guizhouSanDingLiangFang_YAO_BAI_JI";   //摇摆鸡（上下鸡）
        this.localStorageKey.KEY_guizhouSanDingLiangFang_mantangji    = "_guizhouSanDingLiangFang_MAN_TANG_JI";  //满堂鸡
        this.localStorageKey.KEY_guizhouSanDingLiangFang_wuguji       = "_guizhouSanDingLiangFang_WU_GU_JI";     //乌骨鸡
        this.localStorageKey.KEY_guizhouSanDingLiangFang_qgshaoji     = "_guizhouSanDingLiangFang_QG_SHAO_JI";   //抢杠烧鸡
        this.localStorageKey.KEY_guizhouSanDingLiangFang_qgshaodou    = "_guizhouSanDingLiangFang_QG_SHAO_DOU";  //抢杠烧豆
        this.localStorageKey.KEY_guizhouSanDingLiangFang_xingqiji     = "_guizhouSanDingLiangFang_XING_QI_JI";   //星期鸡
        this.localStorageKey.KEY_guizhouSanDingLiangFang_baoji        = "_guizhouSanDingLiangFang_BAO_JI";       //包鸡
        this.localStorageKey.KEY_guizhouSanDingLiangFang_repaopeifen  = "_guizhouSanDingLiangFang_RP_PEI_FEN";   //热炮赔分
        this.localStorageKey.KEY_guizhouSanDingLiangFang_lianzhuang   = "_guizhouSanDingLiangFang_LIAN_ZHUANG";  //连庄
        this.localStorageKey.KEY_guizhouSanDingLiangFang_difen        = "_guizhouSanDingLiangFang_DI_FEN";       //底分
        this.localStorageKey.KEY_guizhouSanDingLiangFang_zimotpye     = "_guizhouSanDingLiangFang_ZIMO_TYPE";    //自摸算分
        this.localStorageKey.KEY_guizhouSanDingLiangFang_qgtpye       = "_guizhouSanDingLiangFang_QG_TYPE";      //抢杠算分
        this.localStorageKey.KEY_guizhouSanDingLiangFang_gps          = "_guizhouSanDingLiangFang_GPS";          //防作弊
        this.localStorageKey.KEY_guizhouSanDingLiangFang_count        = "_guizhouSanDingLiangFang_COUNT";        //人数
        this.localStorageKey.KEY_guizhouSanDingLiangFang_tuoguan      = "_guizhouSanDingLiangFang_TUO_GUAN";     //托管
        this.localStorageKey.KEY_guizhouSanDingLiangFang_zhipaixing   = "_guizhouSanDingLiangFang_ZHI_PAI_XING"; //只牌型分
        this.localStorageKey.KEY_guizhouSanDingLiangFang_benji    = "_guizhouSanDingLiangFang_BEN_JI";  //本鸡

    },
    initAll:function(IsFriendCard) {

        if (!IsFriendCard) this.setKey();
        this.bg_node = ccs.load("bg_guizhouSanDingLiangFang.json").node;
    ...
    initPlayNode:function() {
        ...
        //摇摆鸡
        this._playNode_yaobaiji = _play.getChildByName("play_shangxiaji");
        ...
        //自摸算分类型
        this._play_zm_fanbei = _play.getChildByName("play_zm_fanbei");
        this._play_zm_jiayifen = _play.getChildByName("play_zm_jiayifen");
        var nodeZiMoList = [this._play_zm_fanbei, this._play_zm_jiayifen];
        ...
        this.addListenerText(nodeZiMoList, this._playNode_zimo_radio,this.changePayForPlayerNum.bind(this));
        this._zimolist = nodeZiMoList;

        //抢杠算分类型
        this._play_qg_peifen = _play.getChildByName("play_qg_peifen");
        this._play_qg_baoliangjia = _play.getChildByName("play_qg_baoliangjia");
        var nodeQiangGangList = [this._play_qg_peifen, this._play_qg_baoliangjia];
        ...
        this.addListenerText(nodeQiangGangList, this._playNode_qianggang_radio,this.changePayForPlayerNum.bind(this));
    ...
    setPlayNodeCurrentSelect: function(isClub) {
        ...
        if (isClub)
            ...
            _yaobaiji = util.localStorageEncrypt.getBoolItem(this.localStorageKey.KEY_guizhouSanDingLiangFang_yaobaiji, false);
        ...
        if (isClub)
            ...
            _mantangji = util.localStorageEncrypt.getBoolItem(this.localStorageKey.KEY_guizhouSanDingLiangFang_mantangji, false);
        ...
        if (isClub)
            ...
            _wuguji = util.localStorageEncrypt.getBoolItem(this.localStorageKey.KEY_guizhouSanDingLiangFang_wuguji, false);
        ...
        if (isClub)
            ...
            _qianggangshaoji = util.localStorageEncrypt.getBoolItem(this.localStorageKey.KEY_guizhouSanDingLiangFang_qgshaoji, true);
        ...
        if (isClub)
            ...
            _qianggangshaodou = util.localStorageEncrypt.getBoolItem(this.localStorageKey.KEY_guizhouSanDingLiangFang_qgshaodou, true);
        ...
        if (isClub)
            ...
            _lianzhuang = util.localStorageEncrypt.getBoolItem(this.localStorageKey.KEY_guizhouSanDingLiangFang_lianzhuang, false);
        ...
        if (isClub)
            ...
            _xingqiji = util.localStorageEncrypt.getBoolItem(this.localStorageKey.KEY_guizhouSanDingLiangFang_xingqiji, false);
        ...
        var _baoji;
        if (isClub)
            _baoji = this.getBoolItem("baoji", true);
        else
            _baoji = util.localStorageEncrypt.getBoolItem(this.localStorageKey.KEY_guizhouSanDingLiangFang_baoji, true);
        ...
        if (isClub)
            ...
            _repaopeifen = util.localStorageEncrypt.getBoolItem(this.localStorageKey.KEY_guizhouSanDingLiangFang_repaopeifen, false);
        ...
        if (isClub)
            ...
            _zhipaixingfenfanbei = util.localStorageEncrypt.getBoolItem(this.localStorageKey.KEY_guizhouSanDingLiangFang_zhipaixing, false);
        ...
        if (isClub) {
            ...
            _beiCount = util.localStorageEncrypt.getNumberItem(this.localStorageKey.KEY_guizhouSanDingLiangFang_difen, 1);
        ...
        var _zimoCount;
        if (isClub)
            _zimoCount = this.getNumberItem("zimosuanfen", 0);
        else
            _zimoCount = util.localStorageEncrypt.getNumberItem(this.localStorageKey.KEY_guizhouSanDingLiangFang_zimotpye, 0);
        this._playNode_zimo_radio.selectItem(_zimoCount);
        this.radioBoxSelectCB(_zimoCount, this._zimolist[_zimoCount], this._zimolist);


        //抢杠算分类型
        var _qianggangCount;
        if (isClub)
            _qianggangCount = this.getNumberItem("qianggangsuanfen", 0);
        else
            _qianggangCount = util.localStorageEncrypt.getNumberItem(this.localStorageKey.KEY_guizhouSanDingLiangFang_qgtpye, 0);
        this._playNode_qianggang_radio.selectItem(_qianggangCount);
        this.radioBoxSelectCB(_qianggangCount, this._qiangganglist[_qianggangCount], this._qiangganglist);
        ...
        if (isClub)
            ...
            _gps = util.localStorageEncrypt.getBoolItem(this.localStorageKey.KEY_guizhouSanDingLiangFang_gps, false);
        ...
        if (isClub)
            ...
            _trustTime = util.localStorageEncrypt.getNumberItem(this.localStorageKey.KEY_guizhouSanDingLiangFang_tuoguan, 0);
        ...
        if (isClub)
            ...
            _benji = util.localStorageEncrypt.getBoolItem(this.localStorageKey.KEY_guizhouSanDingLiangFang_benji, false);
    ...
    getSelectedPara:function() {
        var para = {};
        para.gameType = MjClient.GAME_TYPE.GUI_ZHOU_SAN_DING_LIANG_FANG;
        para.maxPlayer = 3;
        para.yaobaiji = true;
        para.mantangji = true;
        para.wuguji = true;
        ...
        // 自摸
        if (this._play_zm_fanbei.isSelected()) {
            para.zimosuanfen = 0;
        }
        else if (this._play_zm_jiayifen.isSelected()) {
            para.zimosuanfen = 1;
        }

        // 抢杠
        if (this._play_qg_peifen.isSelected()) {
            para.qianggangsuanfen = 0;
        }
        else if (this._play_qg_baoliangjia.isSelected()) {
            para.qianggangsuanfen = 1;
        }
        ...
        if (!this._isFriendCard) {
            util.localStorageEncrypt.setBoolItem(this.localStorageKey.KEY_guizhouSanDingLiangFang_benji,  para.benji);
            util.localStorageEncrypt.setBoolItem(this.localStorageKey.KEY_guizhouSanDingLiangFang_yaobaiji,  para.yaobaiji);
            util.localStorageEncrypt.setBoolItem(this.localStorageKey.KEY_guizhouSanDingLiangFang_mantangji,  para.mantangji);
            util.localStorageEncrypt.setBoolItem(this.localStorageKey.KEY_guizhouSanDingLiangFang_wuguji,  para.wuguji);
            util.localStorageEncrypt.setBoolItem(this.localStorageKey.KEY_guizhouSanDingLiangFang_qgshaoji,  para.qianggangshaoji);
            util.localStorageEncrypt.setBoolItem(this.localStorageKey.KEY_guizhouSanDingLiangFang_qgshaodou,  para.qianggangshaodou);
            util.localStorageEncrypt.setBoolItem(this.localStorageKey.KEY_guizhouSanDingLiangFang_baoji,  para.baoji);
            util.localStorageEncrypt.setBoolItem(this.localStorageKey.KEY_guizhouSanDingLiangFang_repaopeifen,  para.repaopeifen);
            util.localStorageEncrypt.setBoolItem(this.localStorageKey.KEY_guizhouSanDingLiangFang_lianzhuang,  para.lianzhuang);
            util.localStorageEncrypt.setBoolItem(this.localStorageKey.KEY_guizhouSanDingLiangFang_xingqiji,  para.xingqiji);
            util.localStorageEncrypt.setBoolItem(this.localStorageKey.KEY_guizhouSanDingLiangFang_zhipaixing, para.paiXinScoreOnly);
            util.localStorageEncrypt.setNumberItem(this.localStorageKey.KEY_guizhouSanDingLiangFang_tuoguan, para.trustTime);

            util.localStorageEncrypt.setNumberItem(this.localStorageKey.KEY_guizhouSanDingLiangFang_zimotpye, Number(para.zimosuanfen));
            util.localStorageEncrypt.setNumberItem(this.localStorageKey.KEY_guizhouSanDingLiangFang_qgtpye, Number(para.qianggangsuanfen));
            util.localStorageEncrypt.setNumberItem(this.localStorageKey.KEY_guizhouSanDingLiangFang_difen, para.beishu);

        }


        cc.log("createara guizhouSanDingLiangFang: " + JSON.stringify(para));
        return para;
    }
});