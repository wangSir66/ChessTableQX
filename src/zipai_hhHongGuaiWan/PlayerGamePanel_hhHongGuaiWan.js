...
//距离显示适配
var layoutData_hhhgw = [[0.25, 0.25], [0.5, 0.5], [0, 0]];
//向服务器发送 过消息
MjClient.MJPass2NetForhhHongGuaiWan = function(){
    cc.log("====================send======pass=====");
...
function SetUserVisible_hhHongGuaiWan(node, off){
    ...
    if(pl){
        ...
        // InitUserHandUI_hhHongGuaiWan(node, off);
...
function InitUserHandUI_hhHongGuaiWan(node, off){
...
var PlayLayer_hhHongGuaiWan = cc.Layer.extend({
    jsBind: {
        _event: {
            mjhand: function() {
                ...
                //距离位置显示
                checkCanShowDistance(layoutData_hhhgw);
            ...
            endRoom: function(msg) {
                ...
                if (msg.showEnd){
                    this.addChild(new GameOverLayer_hhHongGuaiWan(),500);
                }else{
            ...
            roundEnd: function() {
                ...
                function delayExe(){
                    ...
                    if (sData.tData.roundNum <= 0){
                        var layer = new GameOverLayer_hhHongGuaiWan();
                        layer.setVisible(false);
                        self.addChild(layer,500);
                    }
                    if(!MjClient.endoneui){
                        self.addChild(new EndOneView_hhHongGuaiWan(),500);//EndOneView_xxghz()
                    }
                }
        ...
        operateWait:{
            _visible:false,
            _layout: [[0.37, 0.09],[0.5, 0.71],[0, 0]],
            ...
            _event:{  
                initSceneData: function(eD) {
                    if(MjClient.MaxPlayerNum_xiangxiang == 2 && curPlayerIsMe_xiangxiang(1) && MjClient.playui._leftTime.getString() == "0"){
                        this.visible = true;
                    }
        ...
        banner: {
            ...
            getRoomNum: {
                ...
                _click: function() {
                    ...
                    var tData = MjClient.data.sData.tData;
                    var str = "";
                    str += (tData.areaSelectMode.payWay == 0) ? "房主支付," : "AA支付," ;
                    str += (tData.maxPlayer == 2) ? "两人," : "三人," ;
                    str += (tData.roundAll == 10) ? "10局," : "20局" ;
                    str += tData.areaSelectMode.shiwuzimo ? "15胡可自摸胡," : "";
                    str += (tData.areaSelectMode.iszimo == 0) ? "" : "自摸+1囤," ;
                    ...
                    str += (tData.areaSelectMode.redguaiwanOne == 1) ? "红拐弯(234)" : "红拐弯(468)" ;
            ...
            roundnumImg: {
                ...
                roundnumAtlas: {
                    ...
                    _text: function() {
                        var sData = MjClient.data.sData;
                        var tData = sData.tData;
                        if (tData) return ("第" + (tData.roundAll - tData.roundNum + 1).toString() + "/" + tData.roundAll.toString() + "局");
                    },
                    _event: {
                        mjhand: function() {
                            var sData = MjClient.data.sData;
                            var tData = sData.tData;
                            if (tData) return this.setString("第" + (tData.roundAll - tData.roundNum + 1).toString() + "/" + tData.roundAll.toString() + "局");
                        }
                    }
                }
            },
            roundnumAtlas_0: {
                _event: {
                    initSceneData: function(eD) {
                        ...
                        var sData = MjClient.data.sData;
                        var tData = sData.tData;
                        if (tData) return this.setString("第" + (tData.roundAll - tData.roundNum).toString() + "/" + tData.roundAll.toString() + "局");
                    },
                    mjhand: function(eD) {
                        this.visible = !IsArrowVisible_xiangxiang();
                        var sData = MjClient.data.sData;
        ...
        wait: {
            ...
            wxinvite: {
                ...
                //     str += (tData.maxPlayer == 2) ? "两人," : "三人," ;
                //     str += "15胡起胡,有炮必接,满百结算,";
                //     str += (tData.areaSelectMode.tuototuo == 0) ? "不打坨," : (tData.areaSelectMode.tuototuo == 1) ? "坨对坨四番," : "坨对坨三番," ;
                //     str += "点击立即加入牌局>>>";
        ...
        down: {
                ...
                score_all:{
                    ...
                    _event:{
                        clearCardUI: function(){
                            var pl=getUIPlayer_xiangxiang(0);
                            if(pl.winall){
                                return this.setString(pl.winall);
                            }
                            else{
                        ...
                        initSceneData:function(){
                            ...
                            this.visible = !(tState == TableState.waitJoin || tState == TableState.waitReady);
                            var pl=getUIPlayer_xiangxiang(0);
                            if(pl.winall){
                                return this.setString(pl.winall);
                            }
            ...
            _event: {
                ...
                initSceneData: function(eD) {
                    SetUserVisible_hhHongGuaiWan(this, 0);
                    InitUserHandUI_hhHongGuaiWan(this, 0);
                ...
                HZPickCard:function (eD) {
                    ...
                    // DealPickCard_xiangxiang(this,eD,0);
                },
        ...
        right: {
                ...
                zhuang: {
                    ...
                    _event: {
                        ...
                        initSceneData: function() {
                            ...
                            if (IsArrowVisible_xiangxiang()) showUserZhuangLogo_xiangxiang(this, 1);
                        },
                        mjhand: function(){
                            if(MjClient.MaxPlayerNum_xiangxiang == 2){
                                return;
            ...
            put: {
                ...
                _run:function()
                {
                    setWgtLayout(this, [0.35, 0.35],[0.78, 0.75],[0, 0]);
                    var userData = {scale:this.getScale(), pos:this.getPosition()};
                    this.setUserData(userData);
                },
            ...
            _event: {
                ...
                initSceneData: function(eD) {
                    ...
                    SetUserVisible_hhHongGuaiWan(this, 1);
                    InitUserHandUI_hhHongGuaiWan(this, 1);
            ...
            */
            head: {
                ...
                _event: {
                    ...
                    addPlayer: function(eD) {
                        showFangzhuTagIcon_shaoyangZP(this,MjClient.MaxPlayerNum_xiangxiang-1);
                    },
                    removePlayer: function(eD) {
                        showFangzhuTagIcon_shaoyangZP(this,MjClient.MaxPlayerNum_xiangxiang-1);
                    }
            ...
            put: {
                ...
                _run:function()
                {
                    setWgtLayout(this, [0.35, 0.35],[0.22,0.75],[0,0]);
                    var userData = {scale:this.getScale(), pos:this.getPosition()};
                    this.setUserData(userData);
                },
            ...
            _event: {
                ...
                initSceneData: function(eD) {
                    SetUserVisible_hhHongGuaiWan(this, MjClient.MaxPlayerNum_xiangxiang-1);
                    InitUserHandUI_hhHongGuaiWan(this, MjClient.MaxPlayerNum_xiangxiang-1);
                ...
                HZNewCard: function(eD) {
                    ...
                    DealNewCard_huaihua(this,eD,MjClient.MaxPlayerNum_xiangxiang-1);
                },
                roundEnd: function() {
                    InitUserCoinAndName_xiangxiang(this, MjClient.MaxPlayerNum_xiangxiang-1);
                ...
                HZPaoCard: function(eD) {
                    DealPaoCard_xiangxiang(this, eD, MjClient.MaxPlayerNum_xiangxiang-1);
                },
                HZGangCard: function(eD) {
            ...
            chi: {
                ...
                _touch: function(btn, eT) {
                    if (eT == 2){
                        ...
                        // showSelectEatCards_xiangxianggao(this,btn.tag);
    ...
    ctor: function() {
        this._super();
        var playui = ccs.load("Play_hhHongGuaiWan.json");
        playMusic("bgFight");
        var tData = MjClient.data.sData.tData;
...
//重置手牌的顺序
PlayLayer_hhHongGuaiWan.prototype.ResetHandCard = function(posNode,off, needAction,  isDelay){
...
PlayLayer_hhHongGuaiWan.prototype._doMovetoAction = function(node,endP){
    node.stopAllActions();
...
//庄家打出第一张牌之后，刷新提垅的牌
PlayLayer_hhHongGuaiWan.prototype.UpdateEatCardsAfterFirst = function(posNode,off){
    var sData = MjClient.data.sData;
    var tData = MjClient.data.sData.tData;
...
PlayLayer_hhHongGuaiWan.prototype.ResetOtherCard = function(posNode,off){
    //添加吃、碰、跑、偎、提
    var sData = MjClient.data.sData;
    var tData = null;
    if(sData){
    ...
    if(mjSortArr){
        ...
        var callback = function(childList){
            ...
            for(var i = 0;i < childList.length;i++){
                ...
                if(i == childList.length - 1 && off == 0 || i == 0 && off != 0){
                    ...
                    if(off == 0){
                        ...
                        var size = child.getCustomSize();
                        sp.setAnchorPoint(0.5,0.5);
                        sp.setPosition(cc.p(size.width/2, size.height/2));
                        sp.setScale(size.width/child.getContentSize().width);
                        child.addChild(sp);
                    }else{
                        child.loadTexture(MjClient.cardPath_xiangxiang+"huxiBG.png");
                    }
...
PlayLayer_hhHongGuaiWan.prototype.ResetPutCard = function(posNode,off){
    //添加打出的牌
    var pl = getUIPlayer_xiangxiang(off);
...
//重置牌的顺序
PlayLayer_hhHongGuaiWan.prototype.CardLayoutRestore = function(posNode,off){
    if(MjClient.rePlayVideo == -1){
...
// 判断吃、碰、跑、偎、提、胡的状态
PlayLayer_hhHongGuaiWan.prototype.EatVisibleCheck = function(off){
    var eat = MjClient.playui.jsBind.eat;
...
PlayLayer_hhHongGuaiWan.prototype.showAndHideHeadEffect = function(){
