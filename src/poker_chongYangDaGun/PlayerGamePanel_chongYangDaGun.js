...
var GameOverLayer_ChongYangDaGun =  GameOverLayer_Poker.extend({
    ctor: function() {
        this._super();
    },
    getPlayInfo: function(){
        ...
        if(tData.areaSelectMode.isTrustWhole){
            if(tData.areaSelectMode.trustWay == 0){
                str += "托管当局,";
            }else if(tData.areaSelectMode.trustWay == 1){
                str += "托管当局+下一局,";
            }else if(tData.areaSelectMode.trustWay == 2){
                str += "整场托管,"; 
            }
        }
...
//初始化玩家金币和名字
function InitUserCoinAndName_ChongYangDaGun(node, off)
{
...
function SetUserVisible_ChongYangDaGun(node, off)
{
    var pl = getUIPlayer(off);
    ...
    if(pl)
    {
        ...
        InitUserHandUI_ChongYangDaGun(node, off);
    }
    else
    {
        name.visible = false;
...
function InitUserHandUI_ChongYangDaGun(node, off)
{
    ...
    //初始化玩家金币和名称
    InitUserCoinAndName_ChongYangDaGun(node, off);
...
var PlayLayer_ChongYangDaGun = cc.Layer.extend({
    _btnPutCard:null,
    jsBind: {
        _event: {
            mjhand: function() {
            ...
            endRoom: function(msg) {
                ...
                if (msg.showEnd) this.addChild(new GameOverLayer_ChongYangDaGun(),500);
                else
            ...
            roundEnd: function() {
                ...
                function delayExe()
                {
                        ...
                        if (sData.tData.roundNum <= 0) {
                            if(!tData.matchId) {
                                ...
                                self.runAction(cc.sequence(cc.delayTime(3),cc.callFunc(function(){
                                    self.addChild(new GameOverLayer_ChongYangDaGun(),500);
                                })))
                            }
                        }
                    }
                    ...
                    self.addChild(new EndOneView_chongYangDaGun(),500,650);
        ...
        down: {
            ...
            _event: {
                ...
                initSceneData: function(eD) {
                    ...
                    SetUserVisible_ChongYangDaGun(this, 0);
                ...
                mjhand: function(eD) {
                    InitUserHandUI_ChongYangDaGun(this, 0);
                ...
                roundEnd: function() {
                    InitUserCoinAndName_ChongYangDaGun(this, 0);
                    //setTaiInfo("");
                },
        ...
        right: {
            ...
            _event: {
                ...
                initSceneData: function(eD) {
                    SetUserVisible_ChongYangDaGun(this, 1);
                ...
                mjhand: function(eD) {
                    InitUserHandUI_ChongYangDaGun(this, 1);
                },
                roundEnd: function() {
                    InitUserCoinAndName_ChongYangDaGun(this, 1);
                },
                waitPut: function(eD) {
        ...
        top: {
            ...
            _event: {
                ...
                initSceneData: function(eD) {
                    SetUserVisible_ChongYangDaGun(this, 2);
                ...
                mjhand: function(eD) {
                    InitUserHandUI_ChongYangDaGun(this, 2);
                },
                roundEnd: function() {
                    InitUserCoinAndName_ChongYangDaGun(this, 2);
                },
                waitPut: function(eD) {
        ...
        left: {
            ...
            _event: {
                ...
                initSceneData: function(eD) {
                    SetUserVisible_ChongYangDaGun(this, 3);
                ...
                mjhand: function(eD) {
                    InitUserHandUI_ChongYangDaGun(this, 3);
                },
                roundEnd: function() {
                    InitUserCoinAndName_ChongYangDaGun(this, 3);
                },
                waitPut: function(eD) {
...
//牛十别专有排序
 ...
 //
    ctor: function() {
        ...
        var playui = ccs.load(res.Play_chongYangDaGun_json);
...
PlayLayer_ChongYangDaGun.prototype.InitC_Data = function() {
...
PlayLayer_ChongYangDaGun.prototype.clockNumberUpdate = function(node, endFunc)
{
...
PlayLayer_ChongYangDaGun.prototype.updateClockPosition = function(arrowNode)
{
    var tData = MjClient.data.sData.tData;
    var uids = tData.uids;
 ...
 * @return {String}
 */
PlayLayer_ChongYangDaGun.prototype.getGameInfoString = function(param)
{
    var tData = MjClient.data.sData.tData;
    var str = "";
...
PlayLayer_ChongYangDaGun.prototype.isChickenPlayer = function(){

};

PlayLayer_ChongYangDaGun.prototype.showQiangZhuangTag = function(off, eD){
    var tData = MjClient.data.sData.tData;
...
PlayLayer_ChongYangDaGun.prototype.checkPartnerIsConfirm = function(){
    var tData = MjClient.data.sData.tData;
    var ret = true;
...
PlayLayer_ChongYangDaGun.prototype.addJiPaiTag = function(node){
    var tData = MjClient.data.sData.tData;
...
PlayLayer_ChongYangDaGun.prototype.addChickenCardIcon = function(off){
    var pl = getUIPlayer(off);
...
PlayLayer_ChongYangDaGun.prototype.setChickenCardIcon = function(eD)
{
    if(true){
...
PlayLayer_ChongYangDaGun.prototype.showJieFengAnim = function(msg)
{
...
//身份识别后播鸡的动画
PlayLayer_ChongYangDaGun.prototype.showChickenAnim = function(index){
    var tData = MjClient.data.sData.tData;
...
//亮身份
PlayLayer_ChongYangDaGun.prototype.showIdentityIcon = function(eD){
    var tData = MjClient.data.sData.tData;
...
PlayLayer_ChongYangDaGun.prototype.showPartnerTips = function(){
    var tData = MjClient.data.sData.tData;
    var pl = getUIPlayer(0);
...
PlayLayer_ChongYangDaGun.prototype.showYouPai = function(){
    var tData = MjClient.data.sData.tData;
...
PlayLayer_ChongYangDaGun.prototype.showYouPaiAnim = function(flyNode, cardValue ){
...
//重连
PlayLayer_ChongYangDaGun.prototype.dealZhuangMing = function(){
    var tData = MjClient.data.sData.tData;
...
//明抢了
PlayLayer_ChongYangDaGun.prototype.showMingAnim = function(msg){
...
PlayLayer_ChongYangDaGun.prototype.showZhuangIcon = function (UIoff, isMing) {
    var tData = MjClient.data.sData.tData;
...
PlayLayer_ChongYangDaGun.prototype.showFlyCardAnim = function(flyNode,cardValue,UIoff)
{
    var playerNode = getNode_cards(UIoff);
    if (!playerNode)
        return;
...
PlayLayer_ChongYangDaGun.prototype.showHandCardBeiMian = function()
{
...
PlayLayer_ChongYangDaGun.prototype.hideHandCardBeiMian = function()
{
...
PlayLayer_ChongYangDaGun.prototype.CardLayoutRestore = function(node, off)
{
    cc.log("PlayLayer_ChongYangDaGun11==============");
    
    // 如果正在发牌 不排序
    if (MjClient.playui.isFaPai) return;
    
    cc.log("PlayLayer_ChongYangDaGun22==============");
...
PlayLayer_ChongYangDaGun.prototype.CardLayoutDesk = function(node,cards,off)
{
    var tData = MjClient.data.sData.tData;
...
//横向摆放《正常》
PlayLayer_ChongYangDaGun.prototype.horSort = function(node, off)
{
    var pl; //player 信息
...
//纵向摆放
PlayLayer_ChongYangDaGun.prototype.verSort = function(node, off)
{
    if(off != 0)
    {
        return;
...
PlayLayer_ChongYangDaGun.prototype.changePosition = function(msg,flyNode,oldUids)
{
    if (!msg)return;
...
PlayLayer_ChongYangDaGun.prototype.showXiFenAnim = function(msg){
    if(msg == null){
        return;
    }
    var sData = MjClient.data.sData;
...
//处理明牌
PlayLayer_ChongYangDaGun.prototype.dealMingPai = function(node, msgary, UIOff, needSound)
{   
    // 回放情形下，不需展示明牌
    if (MjClient.rePlayVideo != -1)
        return;
...
PlayLayer_ChongYangDaGun.prototype.showWatchPanel = function(node, cards){
...
PlayLayer_ChongYangDaGun.prototype.dealSwitchWatch = function(watch, cards){
    if(!watch){
...
//展示队友手牌
PlayLayer_ChongYangDaGun.prototype.showPartnerHandCards = function(node, cards)
{   
    // 回放情形下，不需展示
    if (MjClient.rePlayVideo != -1 || !MjClient.playui.checkPartnerIsConfirm() || cards == null){
        node.setVisible(false);
...
PlayLayer_ChongYangDaGun.prototype.dealPartnerPutCards = function(node, putCards)
{   
...
PlayLayer_ChongYangDaGun.prototype.dealPKPutCards = function(node, msg)
{
...
PlayLayer_ChongYangDaGun.prototype.CardLayoutPartnerCards = function(node)
{
    if(MjClient.rePlayVideo != -1)// 表示回放
    {
        MjClient.sortClassType = 0;
...
PlayLayer_ChongYangDaGun.prototype.clearPartnerUI = function(node)
{
    // 回放情形下，不需处理
    if (MjClient.rePlayVideo != -1)
        return;
...
PlayLayer_ChongYangDaGun.prototype.showFlyZhuaFenAnim = function(msg){
    var UIoff =  getUiOffByUid(msg.uid);
...
PlayLayer_ChongYangDaGun.prototype.setPlayerZhuaFen = function(node,off_1)
{
...
PlayLayer_ChongYangDaGun.prototype.UpdataDaMaZiTips = function(){
    var sData = MjClient.data.sData;
    var tData = sData.tData;
...
PlayLayer_ChongYangDaGun.prototype.clearDeskCard = function(node)
{
    var children = node.children;
    for (var i = 0; i < children.length; i++)
    {
...
PlayLayer_ChongYangDaGun.prototype.putDaMaZiTips = function(cardType){
...
PlayLayer_ChongYangDaGun.prototype.onClickLiPai = function()
{
...
PlayLayer_ChongYangDaGun.prototype._sortCardByType = function(){
...
PlayLayer_ChongYangDaGun.prototype.resetRoundData = function()
{
    var sData = MjClient.data.sData;
    var tData = sData.tData;
...
PlayLayer_ChongYangDaGun.prototype.ClearLiPai = function(uid, putcards)
{
...
PlayLayer_ChongYangDaGun.prototype.setDownMenusEnabled = function()
{
    var tData = MjClient.data.sData.tData;
...
// 展示报喜动画
PlayLayer_ChongYangDaGun.prototype.showBaoxiAnimation = function(msg)
{   
    ...
    MjClient.playui.addChild(new PiaoFenView_ChongYangDaGun(msg.score,uiOff),500);
}

// 设置己方喜牌数据
PlayLayer_ChongYangDaGun.prototype.setMajiangXiCard = function()
{   
...
// 创建投降UI
PlayLayer_ChongYangDaGun.prototype.createTouXiangView = function(touXiangData)
{   
    //回放的时候，不弹投降窗口
    // if(MjClient.rePlayVideo != -1) 
    //     return;
...
PlayLayer_ChongYangDaGun.prototype.reLoadOptBtnRes = function() {
    //出牌按钮
...
//弹出选择的牌
PlayLayer_ChongYangDaGun.prototype.selectUICards = function(_tipsCardArray)
{
...
PlayLayer_ChongYangDaGun.prototype.checkPut = function (oHands, oCards, lastPutCard) {
    var tData = MjClient.data.sData.tData;
...
PlayLayer_ChongYangDaGun.prototype.RemoveNodeBack = function(node, name, num, tag) {
...
PlayLayer_ChongYangDaGun.prototype.findNodesBack = function(node, name, tags) {
    tags = tags.slice();
...
PlayLayer_ChongYangDaGun.prototype.cardsSort = function(cards)
{
    var pointCounts = {};
    for (var i = 0; i < cards.length; i++) {
