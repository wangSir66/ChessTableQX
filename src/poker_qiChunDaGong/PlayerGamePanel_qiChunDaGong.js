...
var GameOverLayer_QiChunDaGong =  GameOverLayer_Poker.extend({
    ctor: function() {
        this._super();
    },
    getPlayInfo: function(){
        ...
        str += tData.areaSelectMode.catPartnerCards == 0 ? "可看队友手牌," : "" ;
...
//初始化玩家金币和名字
function InitUserCoinAndName_QiChunDaGong(node, off)
{
...
function SetUserVisible_QiChunDaGong(node, off)
{
    var pl = getUIPlayer(off);
    ...
    if(pl)
    {
        ...
        InitUserHandUI_QiChunDaGong(node, off);
    }
    else
    {
        name.visible = false;
...
function InitUserHandUI_QiChunDaGong(node, off)
{
    ...
    //初始化玩家金币和名称
    InitUserCoinAndName_QiChunDaGong(node, off);
...
var PlayLayer_QiChunDaGong = cc.Layer.extend({
    _btnPutCard:null,
    jsBind: {
        _event: {
            mjhand: function() {
            ...
            endRoom: function(msg) {
                ...
                if (msg.showEnd) this.addChild(new GameOverLayer_QiChunDaGong(),500);
                else
            ...
            roundEnd: function() {
                ...
                function delayExe()
                {
                        ...
                        if (sData.tData.roundNum <= 0) {
                            if(!tData.matchId) {
                                ...
                                self.runAction(cc.sequence(cc.delayTime(3),cc.callFunc(function(){
                                    self.addChild(new GameOverLayer_QiChunDaGong(),500);
                                })))
                            }
                        }
                    }
                    ...
                    self.addChild(new EndOneView_QiChunDaGong(),500,650);
            ...
            initSceneData: function() {
                ...
                //     pi.winOrLose  = -3007;
                // }
                // MjClient.playui.addChild(new EndOneView_QiChunDaGong(),500,650);
            },
        ...
        down: {
            head: {
                ...
                zhua:{
                    ...
                    _event: {
                        ...
                        // },
                        waitPut: function() {
                            this.runAction(cc.sequence(cc.delayTime(1.6), cc.callFunc(() => {
                                MjClient.playui.setPlayerZhuaFen(this,0);
                            })));
                        },
                        roundEnd: function() {
            ...
            _event: {
                ...
                initSceneData: function(eD) {
                    ...
                    SetUserVisible_QiChunDaGong(this, 0);
                ...
                mjhand: function(eD) {
                    InitUserHandUI_QiChunDaGong(this, 0);
                ...
                roundEnd: function() {
                    InitUserCoinAndName_QiChunDaGong(this, 0);
                    //setTaiInfo("");
                },
        ...
        right: {
            ...
            _event: {
                ...
                initSceneData: function(eD) {
                    SetUserVisible_QiChunDaGong(this, 1);
                ...
                mjhand: function(eD) {
                    InitUserHandUI_QiChunDaGong(this, 1);
                },
                roundEnd: function() {
                    InitUserCoinAndName_QiChunDaGong(this, 1);
                },
                waitPut: function(eD) {
        ...
        top: {
            ...
            _event: {
                ...
                initSceneData: function(eD) {
                    SetUserVisible_QiChunDaGong(this, 2);
                ...
                mjhand: function(eD) {
                    InitUserHandUI_QiChunDaGong(this, 2);
                },
                roundEnd: function() {
                    InitUserCoinAndName_QiChunDaGong(this, 2);
                },
                waitPut: function(eD) {
        ...
        left: {
            ...
            _event: {
                ...
                initSceneData: function(eD) {
                    SetUserVisible_QiChunDaGong(this, 3);
                ...
                mjhand: function(eD) {
                    InitUserHandUI_QiChunDaGong(this, 3);
                },
                roundEnd: function() {
                    InitUserCoinAndName_QiChunDaGong(this, 3);
                },
                waitPut: function(eD) {
...
//牛十别专有排序
 ...
 //
    ctor: function() {
        ...
        var playui = ccs.load(res.Play_qiChunDaGong_json);
...
PlayLayer_QiChunDaGong.prototype.InitC_Data = function() {
...
PlayLayer_QiChunDaGong.prototype.clockNumberUpdate = function(node, endFunc)
{
...
PlayLayer_QiChunDaGong.prototype.updateClockPosition = function(arrowNode)
{
    var tData = MjClient.data.sData.tData;
    var uids = tData.uids;
 ...
 * @return {String}
 */
PlayLayer_QiChunDaGong.prototype.getGameInfoString = function(param)
{
    var tData = MjClient.data.sData.tData;
    var str = "";
...
PlayLayer_QiChunDaGong.prototype.isChickenPlayer = function(){

};

PlayLayer_QiChunDaGong.prototype.showQiangZhuangTag = function(off, eD){
    var tData = MjClient.data.sData.tData;
...
PlayLayer_QiChunDaGong.prototype.checkPartnerIsConfirm = function(){
    var tData = MjClient.data.sData.tData;
    var ret = true;
...
PlayLayer_QiChunDaGong.prototype.addJiPaiTag = function(node){
    var tData = MjClient.data.sData.tData;
...
PlayLayer_QiChunDaGong.prototype.addChickenCardIcon = function(off){
    var pl = getUIPlayer(off);
...
PlayLayer_QiChunDaGong.prototype.setChickenCardIcon = function(eD)
{
    if(true){
...
PlayLayer_QiChunDaGong.prototype.showJieFengAnim = function(msg)
{
...
//身份识别后播鸡的动画
PlayLayer_QiChunDaGong.prototype.showChickenAnim = function(index){
    var tData = MjClient.data.sData.tData;
...
//亮身份
PlayLayer_QiChunDaGong.prototype.showIdentityIcon = function(eD){
    var tData = MjClient.data.sData.tData;
...
PlayLayer_QiChunDaGong.prototype.showPartnerTips = function(){
    var tData = MjClient.data.sData.tData;
    var pl = getUIPlayer(0);
...
PlayLayer_QiChunDaGong.prototype.showYouPai = function(){
    var tData = MjClient.data.sData.tData;
...
PlayLayer_QiChunDaGong.prototype.showYouPaiAnim = function(flyNode, cardValue ){
...
//重连
PlayLayer_QiChunDaGong.prototype.dealZhuangMing = function(){
    var tData = MjClient.data.sData.tData;
...
//明抢了
PlayLayer_QiChunDaGong.prototype.showMingAnim = function(msg){
...
PlayLayer_QiChunDaGong.prototype.showZhuangIcon = function (UIoff, isMing) {
    var tData = MjClient.data.sData.tData;
    ...
    {   
        ...
        if(isMing){
            node.loadTexture("playing/damazi/icon-bao-small.png");
        }else{
...
PlayLayer_QiChunDaGong.prototype.showFlyCardAnim = function(flyNode,cardValue,UIoff)
{
    var playerNode = getNode_cards(UIoff);
    if (!playerNode)
        return;
...
PlayLayer_QiChunDaGong.prototype.showHandCardBeiMian = function()
{
...
PlayLayer_QiChunDaGong.prototype.hideHandCardBeiMian = function()
{
...
PlayLayer_QiChunDaGong.prototype.CardLayoutRestore = function(node, off)
{
    cc.log("PlayLayer_QiChunDaGong11==============");
    
    // 如果正在发牌 不排序
    if (MjClient.playui.isFaPai) return;
    
    cc.log("PlayLayer_QiChunDaGong22==============");
...
PlayLayer_QiChunDaGong.prototype.CardLayoutDesk = function(node,cards,off)
{
    var tData = MjClient.data.sData.tData;
...
PlayLayer_QiChunDaGong.prototype.getJokerCardsFromRet = function(ret) {
        if (!ret || ret.length <= 0)
            return [];
...
//横向摆放《正常》
PlayLayer_QiChunDaGong.prototype.horSort = function(node, off)
{
    var pl; //player 信息
...
//纵向摆放
PlayLayer_QiChunDaGong.prototype.verSort = function(node, off)
{
    if(off != 0)
    {
        return;
...
PlayLayer_QiChunDaGong.prototype.changePosition = function(msg,flyNode,oldUids)
{
    if (!msg)return;
...
PlayLayer_QiChunDaGong.prototype.showXiFenAnim = function(msg){
    if(msg == null){
        return;
    }
    var sData = MjClient.data.sData;
...
//处理明牌
PlayLayer_QiChunDaGong.prototype.dealMingPai = function(node, msgary, UIOff, needSound)
{   
    // 回放情形下，不需展示明牌
    if (MjClient.rePlayVideo != -1)
        return;
...
PlayLayer_QiChunDaGong.prototype.showWatchPanel = function(node, cards){
...
PlayLayer_QiChunDaGong.prototype.dealSwitchWatch = function(watch, cards){
    if(!watch){
...
//展示队友手牌
PlayLayer_QiChunDaGong.prototype.showPartnerHandCards = function(node, cards)
{   
    // 回放情形下，不需展示
    if (MjClient.rePlayVideo != -1 || !MjClient.playui.checkPartnerIsConfirm() || cards == null){
        node.setVisible(false);
...
PlayLayer_QiChunDaGong.prototype.dealPartnerPutCards = function(node, putCards)
{   
...
PlayLayer_QiChunDaGong.prototype.dealPKPutCards = function(node, msg)
{
...
PlayLayer_QiChunDaGong.prototype.CardLayoutPartnerCards = function(node)
{
    if(MjClient.rePlayVideo != -1)// 表示回放
    {
        MjClient.sortClassType = 0;
...
PlayLayer_QiChunDaGong.prototype.clearPartnerUI = function(node)
{
    // 回放情形下，不需处理
    if (MjClient.rePlayVideo != -1)
        return;
...
PlayLayer_QiChunDaGong.prototype.showFlyZhuaFenAnim = function(msg){
    var UIoff =  getUiOffByUid(msg.uid);
    ...
    flyNode.runAction(cc.sequence(cc.delayTime(0),cc.spawn(cc.moveTo(0.6, point), cc.scaleTo(0.6, flyNode.getScale()/1.5)), cc.callFunc(function() {
        MjClient.playui.showAddZhuaFenAnim(headNode, UIoff);
        flyNode.setVisible(false);
    })));

}

PlayLayer_QiChunDaGong.prototype.showAddZhuaFenAnim = function(node, off){
    var starParticle = new cc.ParticleSystem("Particle/diamondtail.plist");
    starParticle.setPosition(cc.p(20, 10));
    node.addChild(starParticle);
    node.runAction(cc.sequence(
        cc.scaleTo(1, 1.5).easing(cc.easeBackOut()),
        cc.callFunc(() => {
            MjClient.playui.setPlayerZhuaFen(node, off);
        }),
        cc.scaleTo(0.3, 1))
    );
}

PlayLayer_QiChunDaGong.prototype.setPlayerZhuaFen = function(node,off_1,off_2)
{
...
PlayLayer_QiChunDaGong.prototype.UpdataDaMaZiTips = function(){
    var sData = MjClient.data.sData;
    var tData = sData.tData;
...
PlayLayer_QiChunDaGong.prototype.clearDeskCard = function(node)
{
    var children = node.children;
    for (var i = 0; i < children.length; i++)
    {
...
PlayLayer_QiChunDaGong.prototype.putDaMaZiTips = function(cardType){
...
PlayLayer_QiChunDaGong.prototype.onClickLiPai = function()
{
...
PlayLayer_QiChunDaGong.prototype._sortS2B = function(oCards){
...
PlayLayer_QiChunDaGong.prototype._sortCardByType = function(){
...
PlayLayer_QiChunDaGong.prototype.resetRoundData = function()
{
    var sData = MjClient.data.sData;
    var tData = sData.tData;
...
PlayLayer_QiChunDaGong.prototype.ClearLiPai = function(uid, putcards)
{
...
PlayLayer_QiChunDaGong.prototype.setDownMenusEnabled = function()
{
    var tData = MjClient.data.sData.tData;
...
// 展示报喜动画
PlayLayer_QiChunDaGong.prototype.showBaoxiAnimation = function(msg)
{   
    ...
    MjClient.playui.addChild(new PiaoFenView_QiChunDaGong(msg.score,uiOff),500);
}

// 设置己方喜牌数据
PlayLayer_QiChunDaGong.prototype.setMajiangXiCard = function()
{   
...
// 创建投降UI
PlayLayer_QiChunDaGong.prototype.createTouXiangView = function(touXiangData)
{   
    //回放的时候，不弹投降窗口
    // if(MjClient.rePlayVideo != -1) 
    //     return;
...
PlayLayer_QiChunDaGong.prototype.reLoadOptBtnRes = function() {
    //出牌按钮
...
//弹出选择的牌
PlayLayer_QiChunDaGong.prototype.selectUICards = function(_tipsCardArray)
{
...
PlayLayer_QiChunDaGong.prototype.checkPut = function (oHands, oCards, lastPutCard, areaSelectMode) {
    var tData = MjClient.data.sData.tData;
...
PlayLayer_QiChunDaGong.prototype.RemoveNodeBack = function(node, name, num, tag) {
...
PlayLayer_QiChunDaGong.prototype.findNodesBack = function(node, name, tags) {
    tags = tags.slice();
...
PlayLayer_QiChunDaGong.prototype.cardsSort = function(cards)
{
    var pointCounts = {};
    for (var i = 0; i < cards.length; i++) {
...
PlayLayer_QiChunDaGong.prototype.isUsingJiPaiQi = function()
{
    var jipaiqi = MjClient.data.sData.tData.jipaiqi;
    return jipaiqi && jipaiqi.indexOf(SelfUid()) >= 0;
}

PlayLayer_QiChunDaGong.prototype.createJiPaiQiPanel = function()
{
...
// 记牌器购买面板
PlayLayer_QiChunDaGong.prototype.showJiPaiQiBuyingPanel = function(commoditys,purchaseCallback) {
...
PlayLayer_QiChunDaGong.prototype.setJiPaiQiEnabled = function(node) {
    var tData = MjClient.data.sData.tData;
    var enabled = tData.tState != TableState.waitJoin && 
        tData.tState != TableState.roundFinish && 
        tData.tState != TableState.waitReady && 
...
PlayLayer_QiChunDaGong.prototype.setJiPaiQiNum = function(node) {
...
PlayLayer_QiChunDaGong.prototype.checkJiPaiQiListValid = function(commoditys) {
...
PlayLayer_QiChunDaGong.prototype.checkJiPaiQiButtonVisible = function(node) {
