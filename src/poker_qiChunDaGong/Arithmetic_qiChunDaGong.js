...
(function() {
    ...
    PokerQiChunDaGong.prototype.CARDTPYE = CARDTPYE;
    ...
    //两副牌，4人，每人27张
    PokerQiChunDaGong.prototype.randomCards = function(areaSelectMode, tData) {
        var cards = [];
    ...
    PokerQiChunDaGong.prototype.isLaizi = function(card) {
     ...
     * @return {number}
     */
    PokerQiChunDaGong.prototype.calPoint = function(num) {
        if (!num) { return -1; }
     ...
     * @return {number}
     */
    PokerQiChunDaGong.prototype.calFlower = function(num) {
        num = this.removeLaiziSign(num);
        return (num + 3) % 4;
    }
     ...
     * @return {bool}
     */
    PokerQiChunDaGong.prototype.isShun = function(oCards) {
     ...
     * @return {bool}
     */
    PokerQiChunDaGong.prototype.isTongHua = function(oCards) {
     ...
     * @return {bool}
     */
    PokerQiChunDaGong.prototype.is510K = function(oCards) {
        if (!oCards || oCards.length != 3)
            return false;
     ...
     * @return {bool}
     */
    PokerQiChunDaGong.prototype.isTongHua510K = function(oCards) {
     ...
     * @return {bool}
     */
    PokerQiChunDaGong.prototype.isLiandui = function(oCards) { //oCards有序
     ...
     * @return {bool}
     */
    PokerQiChunDaGong.prototype.isAllLaizi = function(oCards) { //oCards有序
        if (!oCards || oCards.length <= 0)
            return false;
     ...
     */
    PokerQiChunDaGong.prototype.calType = function(oCards) {
        if (!oCards)
            return -1;
    ...
    PokerQiChunDaGong.prototype.cardsType = function(cards) {
        return this.calType(cards)
    }
    
    // 计算牌型点数
    PokerQiChunDaGong.prototype.calCardsValue = function (oCards) {
        if (!oCards || oCards.length == 0) {
            return -1;
        }
    ...
    // 牌点比较函数（从小到大）
    PokerQiChunDaGong.prototype.cardValueCmp = function(a, b) {
     ...
     * @return {number} 返回癞子数
     */
    PokerQiChunDaGong.prototype.transformAndGetLaizi = function(oCards, cards) {
        var laizis = [];
        for (var i = 0; i < oCards.length; i++) {
            if (this.isLaizi(oCards[i]))
     ...
     */
    PokerQiChunDaGong.prototype.canPut = function(oCards, oLastCards, areaSelectMode) {
        var cards = oCards.slice();
    ...
    // 检查是否能出牌
    PokerQiChunDaGong.prototype.checkPut = function (oHands, oCards, lastPutCard, areaSelectMode) {
     ...
     */
    PokerQiChunDaGong.prototype.sortHandCards = function(oCards, sortType) {
        var cards = oCards.slice();
    ...
    // 找N张点数一样的牌
    PokerQiChunDaGong.prototype.findNSameCard = function (hands, point, n) {
    ...
    PokerQiChunDaGong.prototype.findAllSameCard = function(hands, point) {
        var sameCards = []
    ...
    PokerQiChunDaGong.prototype.indexOfCards = function(cardList, cards) {
    ...
    PokerQiChunDaGong.prototype.isSameCards = function(cards1, cards2) {
     ...
     */
    PokerQiChunDaGong.prototype.lieju = function(parr, num){
        var tmps = [];
     ...
     */
    PokerQiChunDaGong.prototype.findCardByType = function(hands, laizis, type, cardCount, areaSelectMode, extras) {
        var rets = [];
    ...
    PokerQiChunDaGong.prototype.findFirstPutCards = function(oHands,areaSelectMode) {
    ...
    // 压牌提示
    PokerQiChunDaGong.prototype.findTipsForBackHand = function(oHands,oLastCards,areaSelectMode) {
        var hands = [];
     ...
     * @return {array} 提示的牌
     */
    PokerQiChunDaGong.prototype.tipCards = function(oHands, oLastCards, areaSelectMode) {
     ...
     */
    PokerQiChunDaGong.prototype.getLaiziCardsFromRet = function(ret) {
        if (!ret || ret.length <= 0)
            return [];
     ...
     */
    PokerQiChunDaGong.prototype.getRealLaizi = function(laiziCard) {
        if (!laiziCard)
            return -1;
     ...
     * @param {array} rets 结果
     */
     PokerQiChunDaGong.prototype.removeSameResults = function(rets) {
        var pointsCache = {};
     ...
     * @cardValue {number} 
     */
    PokerQiChunDaGong.prototype.addLaiziSign = function(cardValue,laiziValue) {
     ...
     * @cardValue {number} 
     */
    PokerQiChunDaGong.prototype.removeLaiziSign = function(cardValue) {
        return cardValue % LAI_ZI_SIGN;
    }
     ...
     * @cardValue {number} 
     */
    PokerQiChunDaGong.prototype.haveLaiziSign = function(cardValue) {
        return cardValue > LAI_ZI_SIGN;
    }
     ...
     */
    PokerQiChunDaGong.prototype.replaceLaizi = function(laiziValue,point,cards) {
    ...
    if(typeof(module)!="undefined" && module.exports)    
        module.exports = PokerQiChunDaGong;
    
    if(typeof(MjClient)!="undefined")
        MjClient.majiang_PokerQiChunDaGong = new PokerQiChunDaGong();
