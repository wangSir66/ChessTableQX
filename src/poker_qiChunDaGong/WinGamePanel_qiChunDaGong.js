function SetEndOneUserUI_qiChunDaGong(node, off) {
...
var EndOneView_QiChunDaGong = cc.Layer.extend({
    jsBind: {
        block: {
            _layout: [
                [1, 1],
        ...
        back: {
                ...
                _click: function (btn, eT) {
                    ...
                    if(!tData.fieldId){
                        if (sData.tData.roundNum <= 0)
                            MjClient.endoneui.getParent().addChild(new GameOverLayer_QiChunDaGong(),500);
                    }
                    if(!tData.fieldId){
            ...
            image_player_myself: {
                _run: function() {
                    SetEndOneUserUI_qiChunDaGong(this, MjClient.endoneui.offs[0]);
                }
            },
            image_player_1: {
                _run: function() {
                    SetEndOneUserUI_qiChunDaGong(this, MjClient.endoneui.offs[1]);
                },
            },
            image_player_2: {
                _run: function() {
                    SetEndOneUserUI_qiChunDaGong(this, MjClient.endoneui.offs[2]);
                }
            },
            image_player_3: {
                _run: function() {
                    SetEndOneUserUI_qiChunDaGong(this, MjClient.endoneui.offs[3]);
                }
            },
        }
    },
    ctor: function() {
        ...
        var endoneui = ccs.load("endOne_qiChunDaGong.json");
