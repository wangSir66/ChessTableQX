...
function SetUserVisible_SYloudifpf(node, off){
    ...
    if(pl){
        ...
        // InitUserHandUI_SYloudifpf(node, off);
...
function InitUserHandUI_SYloudifpf(node, off){
...
var PlayLayer_SYloudifpf = cc.Layer.extend({
    jsBind: {
        _event: {
            ...
            roundEnd: function() {
                ...
                function delayExe(){
                    ...
                    if(!MjClient.endoneui && !sData.tData.fieldId){
                        self.addChild(new EndOneView_SYldfpf(),500); //EndOneView_shaoYang
                    }else{
                        //金币场
            ...
            // setWgtLayout(this, [0.5, 0.5],[0.5, 1],[0, 0]);
                ...
                if(MjClient.data.sData.tData.fieldId){
                    for(var i = 0; i < this.children.length; i++){
                        ...
                        if(node.getName() != "setting" && node.getName() != "get_gold_btn" && node.getName() != "trust_btn" && node.getName() != "gameName"){
                            node.visible = false;
                        }
                    }
                }
                    ...
                    initSceneData: function(eD) {
                        ...
                        if (tData){
                            if(tData.fieldId) {//金币场显示场次名称
                                ...
                                this.visible = !IsArrowVisible_xiangxiang();
                                return this.setString("第" + (tData.roundAll - tData.roundNum).toString()+"局");
                            }
                        }
                    },
                    mjhand: function(eD) {
        ...
        down: {
            head: {
                ...
                thishuxi:{
                    _run: function(){
                        if(MjClient.data.sData.tData.fieldId){
                            this.setPosition(this.getParent().getChildByName("total_huxi").getPosition());
                        }
                    },
                    _visible: false,
                    _event:{
                ...
                huxi:{
                    _run: function(){
                        if(MjClient.data.sData.tData.fieldId){
                            this.setPosition(this.getParent().getChildByName("totalhuxi").getPosition());
                        }
                    },
                    _visible: false,
                    _event:{
            ...
            put: {
                ...
                _run:function()
                {
                    ...
                    */
                    setWgtLayout(this, [0.35, 0.35], [0.63, 0.6], [0, 0]);  //按产品要求:传统布局出牌位置调整为和偏右一致
            ...
            _event: {
                ...
                initSceneData: function(eD) {
                    SetUserVisible_SYloudifpf(this, 0);
                    InitUserHandUI_SYloudifpf(this, 0);
        ...
        right: {
            ...
            _event: {
                ...
                initSceneData: function(eD) {
                    ...
                    SetUserVisible_SYloudifpf(this, 1);
                    InitUserHandUI_SYloudifpf(this, 1);
        ...
        left: {
            head: {
                _run : function(){
                    MjClient.playui.addHeadEffect(this);
                    showFangzhuTagIcon_shaoyangZP(this,MjClient.MaxPlayerNum_xiangxiang==2 ? 1 : 2);
                },
                trust : {
                    _run : function(){
                        this.visible = false;
                ...
                zhuang: {
                    ...
                    _event: {
                        waitPut: function() {
                            showUserZhuangLogo_xiangxiang(this, MjClient.MaxPlayerNum_xiangxiang==2 ? 1 : 2);
                        },
                        initSceneData: function() {
                            if (IsArrowVisible_xiangxiang()) showUserZhuangLogo_xiangxiang(this, MjClient.MaxPlayerNum_xiangxiang==2 ? 1 : 2);
                        },
                        mjhand: function(){
                            if (IsArrowVisible_xiangxiang()) showUserZhuangLogo_xiangxiang(this, MjClient.MaxPlayerNum_xiangxiang==2 ? 1 : 2);
                        }
                ...
                chatbg: {
                    ...
                    chattext: {
                        _event: {
                            MJChat: function(msg) {
                                showUserChat_xiangxiang(this, MjClient.MaxPlayerNum_xiangxiang==2 ? 1 : 2, msg);
                            },
                            playVoice: function(voicePath) {
                                MjClient.data._tempMessage.msg = voicePath;
                                showUserChat_xiangxiang(this, MjClient.MaxPlayerNum_xiangxiang==2 ? 1 : 2, MjClient.data._tempMessage);
                            }
                        }
                    }
                },
                _click: function(btn) {
                    showPlayerInfo_xiangxiang(MjClient.MaxPlayerNum_xiangxiang==2 ? 1 : 2, btn);
                },
                _event: {
                    loadWxHead: function(d) {
                        setWxHead_xiangxiang(this, d, MjClient.MaxPlayerNum_xiangxiang==2 ? 1 : 2);
                    },
                    addPlayer: function(eD) {
                        showFangzhuTagIcon_shaoyangZP(this,MjClient.MaxPlayerNum_xiangxiang==2 ? 1 : 2);
                    },
                ...
                datuoflag:{
                    ...
                    _event:{
                        MJJiazhu:function(msg){
                            var jiaZhuArr = msg.jiazhuNums;
                            var pl = getUIPlayer_xiangxiang(MjClient.MaxPlayerNum_xiangxiang==2 ? 1 : 2);
                            var jiazhu = jiaZhuArr[pl.info.uid];
                            this.visible = jiazhu >= 0;
                            if(jiazhu <= 0){
                                this.loadTexture("game_picture/datuotip_no.png");
                        ...
                        initSceneData:function(){
                            if (getUIPlayer_xiangxiang(MjClient.MaxPlayerNum_xiangxiang==2 ? 1 : 2))
                                var pl = getUIPlayer_xiangxiang(MjClient.MaxPlayerNum_xiangxiang==2 ? 1 : 2);
                            else return;
                            this.visible = pl.jiazhuNum >= 0;
                            if(MjClient.data.sData.tData.areaSelectMode.tuototuo == 0){
                ...
                huxi:{
                    ...
                    _event:{
                        ...
                        initSceneData:function(){
                            ...
                            var huXi = 0;
                            if(IsArrowVisible_xiangxiang()){
                                huXi = UpdateHuXi_xiangxiang(MjClient.MaxPlayerNum_xiangxiang==2 ? 1 : 2);
                            }
                            return this.setString(huXi + "息");
                        },
                        mjhand:function(){
                            this.visible = true;
                            var huXi = UpdateHuXi_xiangxiang(MjClient.MaxPlayerNum_xiangxiang==2 ? 1 : 2);
                            if(!IsArrowVisible_xiangxiang()){
                                huXi = 0;
                            }
                            return this.setString(huXi + "息");
                ...
                totalhuxi:{
                    ...
                    _event:{
                        ...
                        initSceneData:function(){
                            ...
                            var huXi = GetPlayerAllHuXi_xiangxiang(MjClient.MaxPlayerNum_xiangxiang==2 ? 1 : 2);
                            if(!IsArrowVisible_xiangxiang()){
                                huXi = 0;
                            }
                            return this.setString(huXi + "息");
                    ...
                    time:{
                        ...
                        _event: {
                            initSceneData: function(eD) {
                                ...
                                stopEffect(playTimeUpEff);
                                playTimeUpEff = null;
                                if(curPlayerIsMe_xiangxiang(MjClient.MaxPlayerNum_xiangxiang==2 ? 1 : 2)){
                                    arrowbkNumberUpdate_xxghz(this);
                                    this.setString("0");
                                }
                            },
                            ...
                            onlinePlayer: function(){
                                ...
                                playTimeUpEff = null;
                                var pl = getUIPlayer_xiangxiang(MjClient.MaxPlayerNum_xiangxiang==2 ? 1 : 2);
                                if(pl && pl.onLine && curPlayerIsMe_xiangxiang(MjClient.MaxPlayerNum_xiangxiang==2 ? 1 : 2)){
                                    arrowbkNumberUpdate_xxghz(this);
                                }
                            },
                            roundEnd: function() {
            ...
            ready: {
                _layout: [[0.07, 0.07],[0.5, 0.5],[-2.5, 2.5]],
                _run: function() {
                    GetReadyVisible_xiangxiang(this, MjClient.MaxPlayerNum_xiangxiang==2 ? 1 : 2);
                },
                _event: {
                    startShuffleCards:function (d) {
                        GetReadyVisible_xiangxiang(this, -1);
            ...
            eatNode: {
                ...
                {
                    if(isIPhoneX()){
                        setWgtLayout(this, [0.14, 0.14], [0.045, 0.74], [0, 0]);
                    }else{
                        setWgtLayout(this, [0.14, 0.14], [0.02, 0.74], [0, 0]);
                    }
                },
            },
            outNode: {
            ...
            _event: {
                clearCardUI: function() {
                    clearCardUI_xiangxiang(this, MjClient.MaxPlayerNum_xiangxiang==2 ? 1 : 2);
                },
                clearCardArr: function(){
                    var eatNode = this.getChildByName("eatNode");
                    eatNode.removeAllChildren();
                ...
                initSceneData: function(eD) {
                    SetUserVisible_SYloudifpf(this, MjClient.MaxPlayerNum_xiangxiang==2 ? 1 : 2);
                    InitUserHandUI_SYloudifpf(this, MjClient.MaxPlayerNum_xiangxiang==2 ? 1 : 2);
                    InitUserCoinAndName_xiangxiang(this, MjClient.MaxPlayerNum_xiangxiang==2 ? 1 : 2);
                    DealOffLineCard_xiangxiang(this,MjClient.MaxPlayerNum_xiangxiang==2 ? 1 : 2);
                    MjClient.playui.showAndHideTrust(this, MjClient.MaxPlayerNum_xiangxiang==2 ? 1 : 2);
                },
                addPlayer: function(eD) {
                    SetUserVisible_SYloudifpf(this, MjClient.MaxPlayerNum_xiangxiang==2 ? 1 : 2);
                    InitUserCoinAndName_xiangxiang(this, MjClient.MaxPlayerNum_xiangxiang==2 ? 1 : 2);
                ...
                HZNewCard: function(eD) {
                    ...
                    DealNewCard_xiangxiang(this,eD,MjClient.MaxPlayerNum_xiangxiang==2 ? 1 : 2);
                },
                roundEnd: function() {
                    InitUserCoinAndName_xiangxiang(this, MjClient.MaxPlayerNum_xiangxiang==2 ? 1 : 2);
                    MjClient.playui.ResetOtherCard(this, MjClient.MaxPlayerNum_xiangxiang==2 ? 1 : 2);
                },
                waitPut: function(eD) {
                    DealWaitPut(this, eD, MjClient.MaxPlayerNum_xiangxiang==2 ? 1 : 2);
                },
                MJPut: function(eD) {
                    DealPutCard_xiangxiang(this, eD, MjClient.MaxPlayerNum_xiangxiang==2 ? 1 : 2);
                    MjClient.playui.UpdateEatCardsAfterFirst(this,MjClient.MaxPlayerNum_xiangxiang==2 ? 1 : 2);
                },
                HZChiCard: function(eD) {
                    DealChiCard_shaoyang(this, eD, MjClient.MaxPlayerNum_xiangxiang==2 ? 1 : 2);
                },
                HZPaoCard: function(eD) {
                    DealPaoCard_leiyang(this, eD, MjClient.MaxPlayerNum_xiangxiang==2 ? 1 : 2);
                },
                HZGangCard: function(eD) {
                    DealGangCard_shaoyang(this, eD, MjClient.MaxPlayerNum_xiangxiang==2 ? 1 : 2);
                },
                MJPeng: function(eD) {
                    DealPengCard_shaoyang(this, eD, MjClient.MaxPlayerNum_xiangxiang==2 ? 1 : 2);
                },
                HZWeiCard: function(eD){
                    DealWeiCard_shaoyang(this, eD, MjClient.MaxPlayerNum_xiangxiang==2 ? 1 : 2);
                },
                MJHu: function(eD) {
                    DealHu_xiangxiang(this, eD, MjClient.MaxPlayerNum_xiangxiang==2 ? 1 : 2);
                },
                onlinePlayer: function(eD) {
                    setUserOffline_hengYang(this, MjClient.MaxPlayerNum_xiangxiang==2 ? 1 : 2);
                },
                playerStatusChange: function(eD) {
                    setUserOffline_hengYang(this, MjClient.MaxPlayerNum_xiangxiang==2 ? 1 : 2);
                },
                MJFlower: function(eD) {
                    HandleMJFlower(this, eD, MjClient.MaxPlayerNum_xiangxiang==2 ? 1 : 2);
                },
                MJTing: function (eD) {
                    HandleMJTing(this, eD, MjClient.MaxPlayerNum_xiangxiang==2 ? 1 : 2);
                },
                HZPickCard:function (eD) {
                    if(MjClient.rePlayVideo != -1) {
                        var pl = getUIPlayer_xiangxiang(MjClient.MaxPlayerNum_xiangxiang==2 ? 1 : 2);
                        if(eD.uid == pl.info.uid){
                            MjClient.OtherHandArr[MjClient.MaxPlayerNum_xiangxiang==2 ? 1 : 2] = MjClient.majiang.sortHandCardSpecial(pl.mjhand)
                        }
                    }
                    RemovePutCardOut_xiangxiang(true);
                    var putNode = this.getChildByName("put");
                    putNode.setPosition(putNode.getUserData().pos);
                    putNode.opacity = 255;
                    MjClient.playui.ResetHandCard(this,MjClient.MaxPlayerNum_xiangxiang==2 ? 1 : 2);
                },
                HZAddCards:function (eD) {
                    DealAddCard_xiangxiang(this,eD, MjClient.MaxPlayerNum_xiangxiang==2 ? 1 : 2);
                },
                HZCheckRaise:function (msg) {
                    ShowPutCardIcon_xiangxiang();
                    MjClient.playui.EatVisibleCheck();
...
//庄家打出第一张牌之后，刷新提垅的牌
PlayLayer_SYloudifpf.prototype.UpdateEatCardsAfterFirst = function(posNode,off){
    var sData = MjClient.data.sData;
    var tData = MjClient.data.sData.tData;
...
//重置手牌的顺序
PlayLayer_SYloudifpf.prototype.ResetHandCard = function(posNode,off, needAction, isDelay){
...
PlayLayer_SYloudifpf.prototype._doMovetoAction = function(node,endP){
    node.stopAllActions();
    var ac = cc.moveTo(0.3,endP);
    node.runAction(ac);
};

PlayLayer_SYloudifpf.prototype.ResetOtherCard = function(posNode,off){
    //添加吃、碰、跑、偎、提
    var sData = MjClient.data.sData;
    var tData = null;
    if(sData){
    ...
    if(mjSortArr){
        ...
        var callback = function(childList){
            ...
            for(var i = 0; i < childList.length; i++){
                ...
                }else if(off == 0 && i == childList.length - 1){
...
PlayLayer_SYloudifpf.prototype.ResetPutCard = function(posNode,off){
    //添加打出的牌
    var pl = getUIPlayer_xiangxiang(off);
...
//重置牌的顺序
PlayLayer_SYloudifpf.prototype.CardLayoutRestore = function(posNode,off){
    if(MjClient.rePlayVideo == -1){
...
// 判断吃、碰、跑、偎、提、胡的状态
PlayLayer_SYloudifpf.prototype.EatVisibleCheck = function(off){
    var eat = MjClient.playui.jsBind.eat;
...
PlayLayer_SYloudifpf.prototype.addHeadEffect = function(head){
    var tag = 2018322;
...
PlayLayer_SYloudifpf.prototype.showAndHideHeadEffect = function(){
    var tData = MjClient.data.sData.tData;
...
PlayLayer_SYloudifpf.prototype.showAndHideTrust = function(node, uiOff){
    var tData = MjClient.data.sData.tData;
...
PlayLayer_SYloudifpf.prototype.showCountdown = function(node){
...
PlayLayer_SYloudifpf.prototype.showDefeatTip = function (uid) {
...
PlayLayer_SYloudifpf.prototype.removeDefeatTip = function () {
    var sData = MjClient.data.sData;
    for (var uid in sData.players) {
