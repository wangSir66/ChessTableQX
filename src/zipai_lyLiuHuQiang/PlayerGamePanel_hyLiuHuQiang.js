...
function SetUserVisible_hyLiuHuQiang(node, off){
    ...
    if(pl){
        ...
        // InitUserHandUI_hyLiuHuQiang(node, off);
...
function InitUserHandUI_hyLiuHuQiang(node, off){
...
var PlayLayer_hyLiuHuQiang = cc.Layer.extend({
    jsBind: {
        _event: {
        ...
        down: {
            ...
            _event: {
                ...
                initSceneData: function(eD) {
                    ...
                    SetUserVisible_hyLiuHuQiang(this, 0);
                    InitUserHandUI_hyLiuHuQiang(this, 0);
        ...
        xing: {
            ...
            _event: {
                ...
                initSceneData: function(eD) {
                    if(MjClient.MaxPlayerNum_leiyang == 4) {
                        SetUserVisible_hyLiuHuQiang(this, 1);
                        InitUserHandUI_hyLiuHuQiang(this, 1);
        ...
        right: {
            ...
            head: {
                zhuang: {
                    ...
                    _event: {
                        waitPut: function() {
                            showUserZhuangLogo_leiyang(this, MjClient.MaxPlayerNum_leiyang - 2);
                        },
                        initSceneData: function() {
                            if (IsArrowVisible_leiyang()) showUserZhuangLogo_leiyang(this, MjClient.MaxPlayerNum_leiyang - 2);
                        },
                        mjhand: function(){
                            if (IsArrowVisible_leiyang()) showUserZhuangLogo_leiyang(this, MjClient.MaxPlayerNum_leiyang - 2);
                        }
                ...
                chatbg: {
                    ...
                    chattext: {
                        _event: {
                            MJChat: function(msg) {
                                showUserChat_leiyang(this, MjClient.MaxPlayerNum_leiyang - 2, msg);
                            },
                            playVoice: function(voicePath) {
                                MjClient.data._tempMessage.msg = voicePath;
                                showUserChat_leiyang(this, MjClient.MaxPlayerNum_leiyang - 2, MjClient.data._tempMessage);
                            }
                        }
                    }
                },
                _click: function(btn) {
                    showPlayerInfo_leiyang(MjClient.MaxPlayerNum_leiyang - 2, btn);
                },
                _event: {
                    loadWxHead: function(d) {
                        setWxHead_leiyang(this, d, MjClient.MaxPlayerNum_leiyang - 2);
                    },
                    addPlayer: function(eD) {
                        showFangzhuTagIcon_leiyang(this,MjClient.MaxPlayerNum_leiyang - 2);
                    },
                    removePlayer: function(eD) {
                        showFangzhuTagIcon_leiyang(this,MjClient.MaxPlayerNum_leiyang - 2);
                    }
                ...
                huxi:{
                    ...
                    _event:{
                        ...
                        initSceneData:function(){
                            this.visible = true;
                            var huXi = UpdateHuXi_leiyang(MjClient.MaxPlayerNum_leiyang - 2);
                            if(!IsArrowVisible_leiyang()){
                                huXi = 0;
                            }
                            return this.setString(huXi + "胡息");
                ...
                timeImg:{
                    ...
                    _event:{
                        initSceneData: function(eD) {
                            this.visible = curPlayerIsMe_leiyang(MjClient.MaxPlayerNum_leiyang - 2);
                        },
                        mjhand: function(eD) {
                            this.visible = curPlayerIsMe_leiyang(MjClient.MaxPlayerNum_leiyang - 2);
                        },
                        onlinePlayer: function(eD) {
                            this.visible = curPlayerIsMe_leiyang(MjClient.MaxPlayerNum_leiyang - 2) && IsArrowVisible_leiyang();
                        },
                        waitPut: function(eD) {
                            this.visible = curPlayerIsMe_leiyang(MjClient.MaxPlayerNum_leiyang - 2);
                        },
                    ...
                    time:{
                        ...
                        _event: {
                            initSceneData: function(eD) {
                                ...
                                stopEffect(playTimeUpEff);
                                playTimeUpEff = null;
                                if(curPlayerIsMe_leiyang(MjClient.MaxPlayerNum_leiyang - 2)){
                                    arrowbkNumberUpdate(this);
                                    this.setString("00");
                                }
                            },
                            ...
                            onlinePlayer: function(){
                                ...
                                if(pl && pl.onLine && curPlayerIsMe_leiyang(MjClient.MaxPlayerNum_leiyang - 2)){
                                    arrowbkNumberUpdate(this);
                                }
                            },
                            roundEnd: function() {
            ...
            ready: {
                _layout: [[0.07, 0.07],[0.5, 0.5],[2.5, 2.5]],
                _run: function() {
                    GetReadyVisible_leiyang(this, MjClient.MaxPlayerNum_leiyang - 2);
                },
                _event: {
                    startShuffleCards:function (d) {
                        GetReadyVisible_leiyang(this, -1);
            ...
            _event: {
                ...
                initSceneData: function(eD) {
                    SetUserVisible_hyLiuHuQiang(this, MjClient.MaxPlayerNum_leiyang - 2);
                    InitUserHandUI_hyLiuHuQiang(this, MjClient.MaxPlayerNum_leiyang - 2);
        ...
        left: {
            ...
            _event: {
                ...
                initSceneData: function(eD) {
                    SetUserVisible_hyLiuHuQiang(this, MjClient.MaxPlayerNum_leiyang - 1);
                    InitUserHandUI_hyLiuHuQiang(this, MjClient.MaxPlayerNum_leiyang - 1);
    ...
    ctor: function() {
        ...
        if (MjClient.MaxPlayerNum_leiyang == 2){
            ...
            this.jsBind.right = PlayLayer_hyLiuHuQiang.jsBindLeftCopy;
        }
...
PlayLayer_hyLiuHuQiang.jsBindLeftCopy = PlayLayer_hyLiuHuQiang.prototype.jsBind.right;

//重置手牌的顺序
PlayLayer_hyLiuHuQiang.prototype.ResetHandCard = function(posNode,off, needAction, isDelay){
...
PlayLayer_hyLiuHuQiang.prototype._doMovetoAction = function(node,endP){
    node.stopAllActions();
    var ac = cc.moveTo(0.3,endP);
    node.runAction(ac);
};

PlayLayer_hyLiuHuQiang.prototype.ResetOtherCard = function(posNode, off) {
    // 添加吃、碰、跑、偎、提
    var sData = MjClient.data.sData;
    var tData = null;
    if (sData) {
    ...
    if (mjSortArr) {
        ...
        var callback = function(childList) {
            ...
            for (var i = 0; i < childList.length; i++) {
                ...
                if (i != getShowCardIdx_leiyang(posNode, chiTip)) {
                    child.loadTexture(MjClient.cardPath_leiyang + "huxiBG.png");
                }
...
PlayLayer_hyLiuHuQiang.prototype.ResetPutCard = function(posNode,off){
    //添加打出的牌
    var pl = getUIPlayer_leiyang(off);
    if (!pl) return;
    var outNode = posNode.getChildByName("outNode");
...
//重置牌的顺序
PlayLayer_hyLiuHuQiang.prototype.CardLayoutRestore = function(posNode,off){
    if(MjClient.rePlayVideo == -1){
...
// 判断吃、碰、跑、偎、提、胡的状态
PlayLayer_hyLiuHuQiang.prototype.EatVisibleCheck = function(off){
    var eat = MjClient.playui.jsBind.eat;
...
PlayLayer_hyLiuHuQiang.prototype.getReaminCardNum = function(){
    var tData = MjClient.data.sData.tData; 
    var maiPaiNum = 0;
