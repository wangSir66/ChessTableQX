//新版邵阳字牌
var playPanel_syShiWuHu = playLayer_ziPai.extend({
	ctor: function() {
		this._super("Play_shaoYangShiWuHu.json");
	...
	getJsBind: function() {
		var jsBind = {
			...
			img_banner: {
				btn_setting: {
					_click: function() {
						MjClient.Scene.addChild(new settingPanel_syShiWuHu(), 6000);
...
//检测距离信息
playPanel_syShiWuHu.prototype.checkCanShowDistance = function(layoutData) {
...
//字牌字体列表
playPanel_syShiWuHu.prototype.getCardFontList = function() {
    return ["type1", "type2", "type3"];
};

//Override 
playPanel_syShiWuHu.prototype.initSettingData = function() {
...
//Override
playPanel_syShiWuHu.prototype.isShowLongCard = function() {
	return false;
};

playPanel_syShiWuHu.prototype.isCheckTingStats = function() {
    return true;
}

//获取听的牌
playPanel_syShiWuHu.prototype.getTingCards = function(sData, pl, putCard) {
...
playPanel_syShiWuHu.prototype.changeEatBtnLayout = function(btnNode, len, idx) {
    var scale = 0.20;
    if(MjClient.getAppType() == MjClient.APP_TYPE.HUNANWANGWANG || MjClient.getAppType() == MjClient.APP_TYPE.QXSYDTZ){
