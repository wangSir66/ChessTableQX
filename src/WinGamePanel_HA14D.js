...
function SetEndOneUserUI_HA14D(node,off)
{
...
var EndOneView_HA14D = cc.Layer.extend({
	jsBind:{
		back:{
		...
		head0:{
		   ...
		   _run:function(){ SetEndOneUserUI_HA14D(this,0); },
		...
		,head1:{ 
		  ...
		  _run:function(){ SetEndOneUserUI_HA14D(this,1); }
		}
		...
		,head2:{ 
		   ...
		   _run:function(){ SetEndOneUserUI_HA14D(this,2); }
		}
		,head3:{
			 head:
			 {
			...
			_run:function(){ SetEndOneUserUI_HA14D(this,3); }
			},
            count_down:{
                _visible :function()
                {
    ...
    ctor:function () {
        this._super();
        var endoneui = ccs.load(res.EndOne_HA14D_json);
