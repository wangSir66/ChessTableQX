...
var majiang_panel_xiaoGanKaiWuXing;
(function () {
    majiang_panel_xiaoGanKaiWuXing = majiang_panel_hubei.extend({
        jsonFile: "Play_xiaoGanKaWuXing.json",
        getJsBind:function(){
            return{
                node_down:{
                    layout_head:{
        ...
        ctor: function(){
            ...
            this._super(majiang_panel_xiaoGanKaiWuXing, jsonFile);
            return true;
        },
        ...
        createEndOnePanel: function(){
            return new majiang_winGamePanel_xiaoGanKaiWuXing();
        },
        //开启自动摸打
