...
//向服务器发送 过消息
MjClient.MJPass2NetForleiyangGMJ = function()
{
   // console.log(">>>>>>>>>普通  过 <<<<<<<<");
    cc.log("====================send======pass=====");
    ...
    if(IsTurnToMe() && tData.tState == TableState.waitPut)
    {
        var isGang = false;
        var isHu = false;
        var hasGuoGang = MjClient.playui.checkGuoGang();

        var eat = MjClient.playui.jsBind.eat;
        var msg = "确认过";
        if(eat.gang0._node.visible && !hasGuoGang)
        {
            msg += " 杠 ";
            isGang = true;
        }
        ...
        if(hasGuoGang && !isHu) {
            ...
            MjClient.showMsg(msg, function()
            {
                ...
                doGuo();
                if(isGang) {
                    util.localStorageEncrypt.setStringItem("IGNORE_G_TIP", tData.tableid +":"+tData.roundNum);
                }
            }, function() {}, "1");
        }
...
function SetUserVisible_leiyangGMJ(node, off)
{
    //var sData = MjClient.data.sData;
    //return;
    cc.log("====================off======================" + off);
...
function InitUserHandUI_leiyangGMJ(node, off)
{
    var sData = MjClient.data.sData;
    var tData = sData.tData;
    var pl = getUIPlayer(off);
...
var PlayLayer_leiyangGMJ = cc.Layer.extend({
    jsBind: {
        _event: {
            mjhand: function() {
            ...
            roundEnd: function() {
                ...
                function delayExe()
                {
                    ...
                    self.addChild(new EndOneView_leiyangGMJ(),500);
                }
                ...
                var showAllCardOfTable = function() {
                    if(MjClient.rePlayVideo === -1){
                        self.runAction(cc.sequence(cc.delayTime(0.1),cc.callFunc(COMMON_UI.showMjhandBeforeEndOne),cc.delayTime(1.5),cc.callFunc(delayExe)));
                    }else{
                ...
                {
                    this.runAction(cc.sequence(cc.DelayTime(0.2),cc.callFunc(showAllCardOfTable)));
                    return;
                }
            ...
            hunPai:{
                ...
                baidaImg: {
                    ...
                    _event: {
                        mjhand:function()
                        {
                            // var isFanGui = MjClient.data.sData.tData.areaSelectMode.guipaiType != 1;
                            // if (!isFanGui)
                            //     return;
        ...
        wait: {
            ...
            wxinvite: {
                ...
                _click: function() {
                    ...
                    var titleStr = GameCnName[MjClient.gameType] + "  房间号:" + tData.tableid + str4 + txt_club;
                    var contentStr = str1 + str2 + str3;
                    MjClient.getInviteUrl(function (url) {
                        MjClient.shareUrlToMultiPlatform(url, titleStr, contentStr);
                    });
                },
                _visible:function()
                {
        ...
        down: {
            ...
            out1: {
                _run: function () {
                    ...
                    if(MjClient.data.sData.tData.maxPlayer == 2){
                        setWgtLayout(this, [0.0, 0.07], [0.33, 0], [-7, 4.7]);
                    }
            ...
            out0: {
                _run: function () {
                    ...
                    if(MjClient.data.sData.tData.maxPlayer == 2){
                        setWgtLayout(this, [0.0, 0.07], [0.33, 0], [-7, 3.7]);
                    }
            ...
            _event: {
                ...
                initSceneData: function(eD) {
                    SetUserVisible_leiyangGMJ(this, 0);
                },
                addPlayer: function(eD) {
                    SetUserVisible_leiyangGMJ(this, 0);
                },
                ...
                mjhand: function(eD) {
                    InitUserHandUI_leiyangGMJ(this, 0);
                },
                roundEnd: function() {
        ...
        right: {
            ...
            _event: {
                ...
                initSceneData: function(eD) {
                    SetUserVisible_leiyangGMJ(this, 1);
                },
                addPlayer: function(eD) {
                    SetUserVisible_leiyangGMJ(this, 1);
                },
        ...
        top: {
            ...
            out0: {
                _run: function () {
                    ...
                    if(MjClient.data.sData.tData.maxPlayer == 2){
                        setWgtLayout(this, [0, 0.07],[0.7, 0.98],[6.8, -2.5]);
                    }
            ...
            out1: {
                _run: function () {
                    ...
                    if(MjClient.data.sData.tData.maxPlayer == 2){
                        setWgtLayout(this, [0, 0.07],[0.7, 0.98],[6.8, -3.5]);
                    }
            ...
            _event: {
                ...
                initSceneData: function(eD) {
                    SetUserVisible_leiyangGMJ(this, 2);
                },
                addPlayer: function(eD) {
                    SetUserVisible_leiyangGMJ(this, 2);
                },
        ...
        left: {
            ...
            _event: {
                ...
                initSceneData: function(eD) {
                    SetUserVisible_leiyangGMJ(this, 3);
                },
                addPlayer: function(eD) {
                    SetUserVisible_leiyangGMJ(this, 3);
                },
            ...
            changeui: {
                ...
                changeuibg: {
                    ...
                    guobg: {
                        guo: {
                            _touch: function(btn, eT) {
                                if (eT == 2) MjClient.MJPass2NetForleiyangGMJ();
                            }
                        },
                        fanhui: {
                            _touch: function(btn, et) {
    ...
    ctor: function() {
        ...
        var playui = ccs.load("Play_leiyangGMJ.json");
        playMusic("bgFight");
...
PlayLayer_leiyangGMJ.prototype.CardLayoutRestore = function(node, off)
{
    ...
    if (pl.mjhand && pl.mjhand.length > 0)
    {
        ...
        if(count == 14 && mjhandNum == pl.mjhand.length)
        {
            ...
            else
            {
                ...
                {
                    if(tempMaJiang.isHunCard(a, MjClient.data.sData.tData.hunCard))
                    {
                        return -1;
                    }
                    else if (tempMaJiang.isHunCard(b,MjClient.data.sData.tData.hunCard))
                    {
                        return 1;
                    }
                    else
                ...
                if(ci.name == orders[i - 1].name)
                {
                    ...
                    else
                    {
                        ...
                        else
                        {
                            ...
                            {
                                ci.x = orders[i - 1].x + upSize.width * upS * 0.91;//对家的手牌
                            }
                        }
                    }
                }
...
PlayLayer_leiyangGMJ.prototype.showTingCardSign = function(){
    var node = getNode(0);
    var children = node.children;
    for(var i = 0; i < children.length; i++){
        if(children[i].getChildByName("ting_tips")){
            children[i].removeChildByName("ting_tips");
        }
    }
...
PlayLayer_leiyangGMJ.prototype.hideEat= function() {
    var eat = MjClient.playui.jsBind.eat;
...
// 判断吃碰杠胡的状态
PlayLayer_leiyangGMJ.prototype.EatVisibleCheck = function()
{
    var eat = MjClient.playui.jsBind.eat;
    ...
    if(tData.tState == TableState.waitPut && pl.mjState == TableState.waitPut)
    {
        if(IsTurnToMe())
        {
            ...
            //杠
            var rtn = MjClient.majiang.canGang1(pl.mjpeng, pl.mjhand, pl.isTing, pl.canGangHand);
...
PlayLayer_leiyangGMJ.prototype.checkGuoGang = function() {
    if(MjClient.getAppType() == MjClient.APP_TYPE.QXSYDTZ) {
        ...
        return roomMsgValue == saveRoomMsgValueG;
    }
    return false;
}