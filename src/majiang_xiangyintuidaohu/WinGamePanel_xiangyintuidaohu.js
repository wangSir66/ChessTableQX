function CardLayoutRestoreForEndOne_xiangyintuidaohu(node, endonepl)
{
...
function SetEndOneUserUI_xiangyintuidaohu(node,off)
{
	var sData=MjClient.data.sData;
		...
		head: {
			...
			up: {
				...
				, _run: function () {
					...
					CardLayoutRestoreForEndOne_xiangyintuidaohu(node, pl);
...
var EndOneView_xiangyintuidaohu = cc.Layer.extend({
	jsBind:{
		block: {
		...
		head0:{
		   ...
		   _run:function(){ SetEndOneUserUI_xiangyintuidaohu(this,0); },
		...
		,head1:{ 
		  ...
		  _run:function(){ SetEndOneUserUI_xiangyintuidaohu(this,1); }
		}
		...
		,head2:{ 
		   ...
		   _run:function(){ SetEndOneUserUI_xiangyintuidaohu(this,2); }
		}
		,head3:{
			 head:
			 {
			...
			_run:function(){ SetEndOneUserUI_xiangyintuidaohu(this,3); }
			},
            count_down:{
                _visible :function()
                {
    ...
    ctor:function () {
        this._super();
        var endoneui = ccs.load("endOne_xiangyintuidaohu.json");
        ...
        for(var i = 0;i < cards.length;i++)
        {
        	...
        	cc.log("mopai---",JSON.stringify(tData));
