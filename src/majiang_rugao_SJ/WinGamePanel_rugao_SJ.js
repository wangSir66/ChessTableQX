...
function addWxHeadToEndUI_rugao_SJ(node,off)
{
...
function SetEndOneUserUI_rugao_SJ(node,off)
{
		...
		head: {
			...
			up: {
				...
				, _run: function () {
                    ...
                    CardLayoutRestore_changpai_SJ(node, pl);
    ...
    addWxHeadToEndUI_rugao_SJ(uibind.head._node,off);
...
CardLayoutRestore_changpai_SJ = function(node, pl)
{
    if(!pl) return;
...
var EndOneView_rugao_SJ = cc.Layer.extend({
	jsBind:{
        block: {
		...
		head0:{
		   ...
		   _run:function(){ SetEndOneUserUI_rugao_SJ(this,0); },
		...
		,head1:{
		  ...
		  _run:function(){ SetEndOneUserUI_rugao_SJ(this,1); }
		}
		,head2:{
		   head:{
			   zhuang:{_visible:false}
		   ...
		   _run:function(){ SetEndOneUserUI_rugao_SJ(this,2); }
		}
		}
	},
    ctor:function () {
        this._super();
        var endoneui = ccs.load(res.EndOne_rugao_SJ_json);
        ...
        var _jiangpai2 = endoneui.node.getChildByName("back").getChildByName("hunCard2");
        setCardSprite_changpai(_jiangpai2, MjClient.data.sData.tData.hunCard2);
