...
//向服务器发送 过消息
MjClient.MJPass2NetForrugao_SJ = function()
{
   // console.log(">>>>>>>>>普通  过 <<<<<<<<");
    cc.log("====================send======pass=====");
...
function SetUserVisible_rugao_SJ(node, off)
{
    //var sData = MjClient.data.sData;
    //return;
    ...
    if(pl)
    {
        ...
        InitUserHandUI_rugao_SJ(node, off);
...
function InitUserHandUI_rugao_SJ(node, off)
{
    var sData = MjClient.data.sData;
    var tData = sData.tData;
    var pl = getUIPlayer_changpai(off);
    ...
    cc.log("return init handUI = " + pl.mjhand);
    ...
    for(var i = 0; i < pl.mjgang1.length; i++)
    {
        ...
        if(pl.mjgang1[i] === tData.hunCard && pl.mjgang1[i] == tData.hunCard2)
        {
            cardCount = 2;
        }
        else if((pl.mjgang1[i] === tData.hunCard && pl.mjgang1[i] != tData.hunCard2) || (pl.mjgang1[i] != tData.hunCard && pl.mjgang1[i] == tData.hunCard2))
        {
            cardCount = 3;
        }
    ...
    if(MjClient.rePlayVideo == -1)//表示正常游戏
    {
        ...
        MjClient.playui.setLeftCardCount(off)
    }
    else
    {
        /*
...
var PlayLayer_rugao_SJ = cc.Layer.extend({
    jsBind: {
        _event: {
            mjhand: function() {
            ...
            roundEnd: function() {
                ...
                function delayExe()
                {
                    ...
                    self.addChild(new EndOneView_rugao_SJ(),500);
                }
            ...
            showCard:function(msg)
            {
                ...
                cardRollAction_changpai_SJ(msg);
        ...
        down: {
            ...
            flowerCardNode: {
                ...
                _run:function(){
                    this.setRotation(90);
                    this.visible = false;
                    setWgtLayout(this,[0.16, 0.16],[0.12, 0.45],[0, 0]);
                },
                _event: {
                    clearCardUI: function(eD) {
                        this.visible = false;
            ...
            _event: {
                ...
                initSceneData: function(eD) {
                    SetUserVisible_rugao_SJ(this, 0);
                },
                addPlayer: function(eD) {
                    SetUserVisible_rugao_SJ(this, 0);
                },
                ...
                mjhand: function(eD) {
                    InitUserHandUI_rugao_SJ(this, 0);
                },
                roundEnd: function() {
                ...
                RGLong: function (eD) { //不罗龙
                    DealNoLong_changpai(this,eD);
                    var _downNode = getNode_changpai(0);
                    PlayLayer_rugao_SJ.prototype.CardLayoutRestore(_downNode,0);
                },
        ...
        right: {
            ...
            play_tips: {
                _layout: [[0.08, 0.14], [0.75, 0.6], [0, 0.5]],
                _run: function () {
                    this.zIndex = actionZindex;
                },
                _visible:false,
            ...
            flowerCardNode: {
                ...
                _run:function(){
                    this.setRotation(90);
                    setWgtLayout(this,[0.15, 0.15],[0.87, 0.86],[0, 0]);
                },
                _event: {
                    clearCardUI: function(eD) {
                        //this.visible = false;
            ...
            _event: {
                ...
                initSceneData: function(eD) {
                    SetUserVisible_rugao_SJ(this, 1);
                },
                addPlayer: function(eD) {
                    SetUserVisible_rugao_SJ(this, 1);
                },
                ...
                mjhand: function(eD) {
                    InitUserHandUI_rugao_SJ(this, 1);
                },
                roundEnd: function() {
        ...
        top: {
            ...
            play_tips: {
                _layout: [[0.08, 0.14], [0.25, 0.6], [0, 0.5]],
                _run: function () {
                    this.zIndex = actionZindex;
                },
                _visible:false,
            ...
            flowerCardNode: {
                ...
                _run:function(){
                    this.setRotation(90);
                    setWgtLayout(this,[0.15, 0.15],[0.13, 0.86],[0, 0]);
                },
                _event: {
                    clearCardUI: function(eD) {
                        //this.visible = false;
            ...
            _event: {
                ...
                initSceneData: function(eD) {
                    SetUserVisible_rugao_SJ(this, 2);
                },
                addPlayer: function(eD) {
                    SetUserVisible_rugao_SJ(this, 2);
                },
                ...
                mjhand: function(eD) {
                    InitUserHandUI_rugao_SJ(this, 2);
                },
                roundEnd: function() {
        ...
        eat: {
            ...
            guo: {
                ...
                _touch: function(btn, eT) {
                    if (eT == 2)
                    {
                        MjClient.MJPass2NetForrugao_SJ();
                    }
                },
                bgimg: {
                    _run: function() {
            ...
            changeui: {
                ...
                changeuibg: {
                    ...
                    guobg: {
                        guo: {
                            _touch: function(btn, eT) {
                                if (eT == 2) MjClient.MJPass2NetForrugao_SJ();
                            }
                        },
                        fanhui: {
                            _touch: function(btn, et) {
        ...
        long_btn: {
            ...
            _click: function(btn, eT) {
                //显示花
                btn.stopAllActions();
                btn.setScale(btn.getParent().getChildByName("voice_btn").getScale());
                btn.setColor(cc.color(255,255,255));
                var layer = new showLongLayer();
                MjClient.Scene.addChild(layer);
            },
            _event: {
                clearCardUI: function() {
                    this.stopAllActions();
                    this.setScale(this.getParent().getChildByName("voice_btn").getScale());
                ...
                initSceneData: function(eD) {
                    for(var off = 0; off <MjClient.MaxPlayerNum_changPai;off++ )
                    {
                        ...
                        {
                            this.runAction(cc.sequence(cc.spawn(cc.tintTo(0.8, 255,0,0),cc.scaleTo(0.9,this.getScale() + 0.1)),
                                cc.spawn(cc.tintTo(0.6, 255,255,255),cc.scaleTo(0.8,this.getScale()))).repeatForever());
                        }
                    }
                },
                RGLong: function (eD) { //不罗龙
        ...
        cardBg:{
            _run: function () {
                // setWgtLayout(this,[0.42, 0.42], [0.5, 1], [0, 0]);
                if(isIPhoneX())
                    setWgtLayout(this,[0.3, 0], [0.55, 0.85], [0, 0]);
                else
                    setWgtLayout(this,[0.3, 0], [0.5, 0.85], [0, 0]);
            },
            _event:{
                initSceneData: function() {
                    var sData = MjClient.data.sData;
                    ...
                    {
                        cc.log("-------------11111111111" + MjClient.data.sData.tData.hunCard);
                        cc.log("-------------22222222222" + MjClient.data.sData.tData.hunCard2);
    ...
    ctor: function() {
        this._super();
        var playui = ccs.load(res.Play_rugao_SJ_json);
        playMusic("bgFight");
        ...
        this._showJiangCardBg.getChildByName("cardIcon2").visible = false;
...
PlayLayer_rugao_SJ.prototype.CardLayoutRestore = function(node, off)
{
    ...
    */
    ...
    if(off == 0)
    {
        ...
        var _uiDy = upSize.height * upS * 0.055;
        //碰，杠，从左边作为起点
            ...
            for(var j = 0;j < _uis.length;j++)
            {
                ...
                if(i == 0 || i == 1 )//杠是四张牌
                {
                    if(_idx == 4)
                    {
                        ...
                        ((_uis[j - 1].tag == MjClient.data.sData.tData.hunCard2 && _uis[j - 1].tag != MjClient.data.sData.tData.hunCard)||
                        (_uis[j - 1].tag != MjClient.data.sData.tData.hunCard2 && _uis[j - 1].tag == MjClient.data.sData.tData.hunCard)))
                        //如皋三张牌的杠
                    {
                         cc.log("--------杠是3张牌----------");
                    ...
                    else if (_idx == 2 &&(_uis[j - 1].tag == MjClient.data.sData.tData.hunCard2 && _uis[j - 1].tag == MjClient.data.sData.tData.hunCard))//如皋三张牌的杠
                    {
                         cc.log("--------杠是2张牌----------");
                        _idx = 0;
                        leftStartX += _uiDx;
    ...
    else //两侧的
    {
        ...
        //碰，杠，从左边作为起点
        var UpStartY = MjClient.size.height - upSize.height * upS * 0.93//起始位置
        var uiArray0 = [uigang1, uigang0, uipeng, uichi];
        for(var i = 0;i < uiArray0.length;i++)
        {
            var _uis = uiArray0[i];
    ...
    if(MjClient.playui.setLeftCardCount)
    {
        MjClient.playui.setLeftCardCount(off)
    }
};
...
// 判断吃碰杠胡的状态
PlayLayer_rugao_SJ.prototype.EatVisibleCheck = function()
{
    var eat = MjClient.playui.jsBind.eat;
    ...
    if(tData.tState == TableState.waitPut && pl.mjState == TableState.waitPut || _isQiShow)
    {
        if(!_isQiShow)
        {
            ...
            //杠
            var rtn = MjClient.majiang.canGang1(pl.mjpeng, pl.mjhand, pl.isTing, pl.putCount, tData.hunCard, tData.hunCard2);
        ...
        {
            cc.log("$$$$杠牌监测777"+JSON.stringify(pl.long));

            //杠
            var rtn = MjClient.majiang.canGang1(pl.mjpeng, pl.mjhand, pl.isTing, pl.putCount, tData.hunCard, tData.hunCard2, pl.long);
...
/*
    显示洛龙，不洛龙的按钮
 */
PlayLayer_rugao_SJ.prototype.longTouch = function(cd)
{
    var eat = MjClient.playui.jsBind.eat;
    //sk 为啥要隐藏掉？   //因为一开始是不可见的，隐藏根节点 by sking
    MjClient.playui.jsBind.eat.changeui.changeuibg._node.visible = false;
...
/*
    获取当前牌张数
 */
PlayLayer_rugao_SJ.prototype.setLeftCardCount = function(off)
{
    var pl = getUIPlayer_changpai(off);
    var sData = MjClient.data.sData;
    var tData = sData.tData;
    ...
    {
        var upCardCount = CardCount - ((pl.mjpeng.length + pl.mjgang0.length + pl.mjgang1.length) * 3 + pl.mjchi.length);
        var _nodeCount = _node.getChildByName("head").getChildByName("cardCount").getChildByName("text");
        _nodeCount.ignoreContentAdaptWithSize(true);
        _node.getChildByName("head").getChildByName("cardCount").visible = true;
        _nodeCount.setString(upCardCount);
    }
    else {
        _node.getChildByName("head").getChildByName("cardCount").visible = false;
    }
