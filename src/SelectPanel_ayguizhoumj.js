...
var HomeView_ayguizhoumj = cc.Layer.extend({
    ...
    ctor: function () {
        ...
        // 咨询
        var btnZiXun = _back.getChildByName("btnZiXun");
        btnZiXun.zIndex = 9;
        btnZiXun.setAnchorPoint(0,0.5);
        setWgtLayout(btnZiXun, [129/1280, 159/720], [0.0, 0.49], [-0.5, 0], false, true);
        if(isIPhoneX())
        {
            setWgtLayout(btnZiXun, [129/1280, 159/720], [0.0, 0.49], [0, 0], false, true);
        }


        //人物
        var _roleNode = _back.getChildByName("roleNode");
        setWgtLayout(_roleNode, [0.23, 0.23], [0.4, 0.22], [0, 0], false, true);
        ...
        roleAni.setPosition(-140,-150);
        roleAni.setScale(0.58);
        if(isIPhoneX())
        {
            setWgtLayout(_roleNode, [0.2, 0.2], [0.38, 0.22], [0, 0], false, true);
        }
        _roleNode.addChild(roleAni,100);

        var jiAni = createSpine("spine/home/ji/ji.json", "spine/home/ji/ji.atlas");
        jiAni.setAnimation(0, 'tiao', true);
        jiAni.setPosition(50,-70);
        jiAni.setScale(0.3);
        _roleNode.addChild(jiAni,100);


        var _bAni = false;
        _roleNode.schedule(function(){
            if(_bAni)
            {
                jiAni.setAnimation(0, 'tiao', true);
                _bAni = false;
            ...
            {
                jiAni.setAnimation(0, 'daiji', true);
                _bAni = true;
            }
        },3.4)
        ...
        var sten = cc.Sprite.create("game_picture/activeBtn/shangcheng.png");
        ...
        setWgtLayout(this._youjian, [0.1, 0.1], [0.74 + 0.07, 0.88], [0,0]);
        setWgtLayout(_BtnHTP,        [0.1, 0.1], [0.74 + 0.07*2, 0.88], [0,0]);
        setWgtLayout(_setting,       [0.1, 0.1], [0.745 + 0.07*3, 0.88], [0,0]);
        ...
        setWgtLayout(_headbg, [0.25, 0.25], [0, 1], [0, 0]);
        ...
        */
        ...
        //游戏
        this._gamePanelNode = _back.getChildByName("Panel_game");
        this._gamePanelNode.visible = false;
        if(isIPhoneX())
        {
            this._gamePanelNode.getChildByName("Panel_left").x = 850;
        }
    ...
    doHideAction:function () {
        ...
        var rightActionList = [];
        // 右边功能按钮
        rightActionList.push(this._gamePanelNode.getChildByName("Panel_right"));
    ...
    setGamePanel: function (gamePanelNode) {
        ...
        var gamePanelRighttNode = gamePanelNode.getChildByName("Panel_right");

        setWgtLayout(gamePanelNode, [1, 1], [0.5, 0.5], [0, 0],false,true);
        if(isIPhoneX())
        {
            setWgtLayout(gamePanelNode, [1, 1], [0.5, 0.5], [0, 0],false,true);
            gamePanelLeftNode.setPositionX(gamePanelLeftNode.getPositionX() - 60);
            gamePanelRighttNode.setPositionX(gamePanelRighttNode.getPositionX() + 100);
        }
        ...
        */
        ...
        var ylcGold = btn_jinbichang.getChildByName("ylcGold");

        var hongbaoEffect = btn_jinbichang.getChildByName("Node_hongbaoEffect");
        for(var i = 0; i < 5; i++){
        ...
        if(MjClient.systemConfig.fieldRedpacketActivityOpen){
            ylcGold.setVisible(false);
            hongbaoEffect.setVisible(true);
        }else {
            ylcGold.setVisible(true);
            hongbaoEffect.setVisible(false);
        }

        goldField_updateListener(btn_jinbichang);
        btn_jinbichang.addTouchEventListener(function (sender, Type) {
            switch (Type) {
                case ccui.Widget.TOUCH_ENDED:
        ...
        */
        ...
        //
        // /* 广告 传奇 入口 */
        // var chuanqiBtn = gamePanelRighttNode.getChildByName("chuanqiBtn");
        // if (chuanqiBtn) {
        //
        //
        ...
        //
        // /* 广告 八字算命 入口 */
        // var baZisuanMianBtn = gamePanelRighttNode.getChildByName("bazisuanmianBtn");
        // if (baZisuanMianBtn) {
        //
        //
        ...
        //
        // // 热血合击
        // var rexueHejiBtn = gamePanelRighttNode.getChildByName("rexueHejiBtn");
        // if (rexueHejiBtn) {
        ...
        //
        // // 捕鱼
        // var buyuBtn = gamePanelRighttNode.getChildByName("buyuBtn");
        // if (buyuBtn) {
        //
        ...
        //
        // // 王者战神
        // var wangzheZhanshenBtn = gamePanelRighttNode.getChildByName("wangzheZhanshenBtn");
