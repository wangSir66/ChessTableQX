function addWxHeadToEndUI_shiMenPaoHuZi_GO(node, off) {
...
function SetGameOverLayer_shiMenPaoHuZi(node,off,isNewUi){
    ...
    addWxHeadToEndUI_shiMenPaoHuZi_GO(wxNode,off);
...
var GameOverLayer_shiMenPaoHuZi = cc.Layer.extend({
    sprite:null,
    jsBind:{
        back:{
            close :{
    ...
    ctor:function () {
        this._super();
        var endallui = ccs.load("endAll_shiMenPaoHuZi.json");
        ...
        for(var i = 0 ; i < playerCount ; i++){
            ...
            SetGameOverLayer_shiMenPaoHuZi(clone,i, false);
