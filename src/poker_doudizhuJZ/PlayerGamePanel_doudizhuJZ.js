...
var PlayLayer_doudizhuJZ = cc.Layer.extend({
    ctor: function () {
        this._super();
...
PlayLayer_doudizhuJZ.prototype.isCanPutCards = function (putCards) {
    ...
    var ret = MjClient.majiang.checkPut(pl.mjhand, putCards, lastPutCards, tData.areaSelectMode);
    return ret != null;
};
...
//出牌提示
PlayLayer_doudizhuJZ.prototype.showTipCards = function () {
...
// 处理斗地主智能提牌
PlayLayer_doudizhuJZ.prototype.handleDoudizhuCardsAutoUp = function (bTouchMove) {
    if (!this.isSDataValid()) {
        return ;
    }
    var tData = MjClient.data.sData.tData;
...
PlayLayer_doudizhuJZ.prototype.handleCardsTouchListener = function () {
    return {
...
// 处理点击
PlayLayer_doudizhuJZ.prototype.handleTouchCards = function (touch, event, isBegan) {
...
// 处理玩家提起提起得牌，保留正确的牌
PlayLayer_doudizhuJZ.prototype.handleUpRightCards = function (isFirst, off) {
    if (isFirst) {
        return;
    }
...
// =========================[[ 流程 ]] =========================
// 断线重连/初始化
PlayLayer_doudizhuJZ.prototype.dealInitSceneData = function () {
    if (!this.isSDataValid()) {
        return ;
    }
    var tData = MjClient.data.sData.tData;
...
PlayLayer_doudizhuJZ.prototype.dealChangePKImg = function () {
...
// 结算
PlayLayer_doudizhuJZ.prototype.dealRoundEnd = function (eD) {
    if (!this.isSDataValid()) {
        return ;
    }
    ...
    function delayExe() {
        ...
        if (MjClient.playui.isJinBiChang()) {
            ...
            self.addChild(new EndOneView_doudizhuJZ(zhuang), 500);
        }
    }
...
// 过、准备
PlayLayer_doudizhuJZ.prototype.dealPKPass = function (eD) {
    MjClient.playui.killTimeClock();
    MjClient.clockNode.visible = false;
...
// 出牌
PlayLayer_doudizhuJZ.prototype.dealPKPut = function (msg) {
    var tData = MjClient.data.sData.tData;
    tData.rate = msg.rate;
...
// 等待出牌
PlayLayer_doudizhuJZ.prototype.dealWaitPut = function (eD, isSceneData) {
    var tData = MjClient.data.sData.tData;
...
// 等待叫地主
PlayLayer_doudizhuJZ.prototype.dealWaitJiaodizhu = function (msg, isSceneData) {
    var sData = MjClient.data.sData;
    var tData = sData.tData;
...
// 抢地主
PlayLayer_doudizhuJZ.prototype.dealQiangDizhu = function (msg) {
    var tData = MjClient.data.sData.tData;
...
// 等待准备
PlayLayer_doudizhuJZ.prototype.dealAllReady = function (bAllReady) {
    for (var i = 0; i < this.headOffLen; i++) {
        var off = this.headOffArr[i];
...
// 加倍
PlayLayer_doudizhuJZ.prototype.dealMJJiazhu = function (isSceneData, off, jiazhuNum, curPlayer) {
    var tData = MjClient.data.sData.tData;
...
// 等待加倍
PlayLayer_doudizhuJZ.prototype.dealWaitJiazhu = function (eD, isSceneData, isIconMove) {
    var tData = MjClient.data.sData.tData;
...
// 处理手牌
PlayLayer_doudizhuJZ.prototype.handleMjHand = function (isSendCard) {
...
PlayLayer_doudizhuJZ.prototype.showPostCardAnimation = function () {
...
// 处理底牌
PlayLayer_doudizhuJZ.prototype.dealDiCards = function (zhuang, diCards, handCounts, isAddCards, isIconMove) {
    var tData = MjClient.data.sData.tData;
    tData.zhuang = zhuang;
...
//处理托管 1：托管，2：非托管
PlayLayer_doudizhuJZ.prototype.dealTrust = function (msg, cbTrust) {
    if (msg != undefined) {
        var tData = MjClient.data.sData.tData;
        if (!MjClient.playui.isJinBiChang()) {
            return;
...
// =========================[[ 小控件 ]] ========================
PlayLayer_doudizhuJZ.prototype.updateUserHeadPosition = function (off, bRoundEnd) {
...
PlayLayer_doudizhuJZ.prototype.updateTimes = function () {
...
//设置地区信息
PlayLayer_doudizhuJZ.prototype.showGameName = function () {
...
//添加还背景的功能
PlayLayer_doudizhuJZ.prototype.addChangeBg = function () {
...
PlayLayer_doudizhuJZ.prototype.showVoice = function () {
...
PlayLayer_doudizhuJZ.prototype.addWaitNode = function () {
    if (!MjClient.playui.isJinBiChang()) {
...
PlayLayer_doudizhuJZ.prototype.setWaitNodeVisible = function (bVisible) {
...
PlayLayer_doudizhuJZ.prototype.addAniLayer = function () {
...
PlayLayer_doudizhuJZ.prototype.showTableID = function (bShow) {
...
PlayLayer_doudizhuJZ.prototype.setHLJiabeiVisible = function (bVisible) {
...
// 出牌按钮
PlayLayer_doudizhuJZ.prototype.handlePutCardBtn = function (isVisible, isFirst) {
...
PlayLayer_doudizhuJZ.prototype.enablePutCardBtn = function (bAble) {
    var btnPutCard = this.node.getChildByName("BtnPutCard");
...
//操作按钮(提示和不出)
PlayLayer_doudizhuJZ.prototype.handleHimtAndNoPutBtn = function (isVisible, isAble) {
...
//经典斗地主叫分按钮
PlayLayer_doudizhuJZ.prototype.setJingDianBtnVisible = function (bVisible, buJiaoAble, score, bmustjiao) {
...
//欢乐斗地主叫分按钮
PlayLayer_doudizhuJZ.prototype.setHuanLeBtnVisible = function (bVisible) {
...
// 牌局信息
PlayLayer_doudizhuJZ.prototype.showRoundInfo = function () {
    if (!this.isSDataValid()) {
        return ;
    }
...
// 局数
PlayLayer_doudizhuJZ.prototype.updateGameRound = function () {
...
// 加倍
PlayLayer_doudizhuJZ.prototype.setTextMult = function (bShow) {
...
// 底分
PlayLayer_doudizhuJZ.prototype.handleDifen = function () {
...
// 不抢/抢地主
PlayLayer_doudizhuJZ.prototype.dealQiangDizhuText = function (off, isPlayEffect) { // , visible, msg
    if (!this.isSDataValid()) {
        return ;
    }
    var tData = MjClient.data.sData.tData;
...
// 要不起
PlayLayer_doudizhuJZ.prototype.handleNoPutTag = function (off, visible) {
    var node = getNode_cards(off);
...
// 没有大过上家
PlayLayer_doudizhuJZ.prototype.handleNoPutTips = function (isVisible) {
...
// 没有大过上家
PlayLayer_doudizhuJZ.prototype.handlePassBtn = function (isVisible) {
...
//加倍
PlayLayer_doudizhuJZ.prototype.handleJiabeiTag = function (off, type) {
    var node = getNode_cards(off);
...
PlayLayer_doudizhuJZ.prototype.ShowWaittingJiabei = function () {
...
// =========================[[ 系统 ]] ==========================
PlayLayer_doudizhuJZ.prototype.dealSendVoice = function (fullFilePath) {
    if (!fullFilePath) {
...
PlayLayer_doudizhuJZ.prototype.dealDownAndPlayVoice = function (msg) {
...
PlayLayer_doudizhuJZ.prototype.dealUploadRecord = function (filePath) {
    if (filePath) {
...
// 绘制手牌
PlayLayer_doudizhuJZ.prototype.initUserHandUiDoudizhu = function (off) {
    var pl = getUIPlayer(off);
    if (pl == null) {
        return;
    }
...
//处理出牌,打牌动作
PlayLayer_doudizhuJZ.prototype.dealPKPutcard = function (off, msg) {
...
PlayLayer_doudizhuJZ.prototype.playAnimation = function (cards, off) {
    var pl = getUIPlayer(off);
    if (!pl) { return ; }
...
// 增加底牌
PlayLayer_doudizhuJZ.prototype.addDiCardsToZhuang = function (zhuangOff) {
    var tData = MjClient.data.sData.tData;
...
PlayLayer_doudizhuJZ.prototype.hideAllUI = function () {
...
// 处理准备字准备相关
PlayLayer_doudizhuJZ.prototype.handleAboutReady = function (off, bAllReady) {
...
PlayLayer_doudizhuJZ.prototype.startTimeClock = function (func, isSceneData, curOff) {
...
PlayLayer_doudizhuJZ.prototype.killTimeClock = function () {
    MjClient.clockNode.getChildByName("number").stopAllActions();
    stopEffect(playTimeUpEff);
    playTimeUpEff = null;
};

PlayLayer_doudizhuJZ.prototype.clockNumberUpdate = function (node, endFunc) {
    return arrowbkNumberUpdate(node, endFunc);
}

PlayLayer_doudizhuJZ.prototype.checkRoomUiDelete = function () {
...
PlayLayer_doudizhuJZ.prototype.showGps = function () {
...
// 地主的三张牌
PlayLayer_doudizhuJZ.prototype.handleDoudizhuDiCards = function () {
    var isShow = false;
    var cards;
    if (this.isSDataValid()) {
        var tData = MjClient.data.sData.tData
...
PlayLayer_doudizhuJZ.prototype.dealMJTick = function (eD) {
    for (var i = 0; i < this.headOffLen; i++) {
        var off = this.headOffArr[i];
        var pl = getUIPlayer(off);
        if (!pl) { continue ; }
...
PlayLayer_doudizhuJZ.prototype.dealLogout = function () {
    if (MjClient.playui) {
...
PlayLayer_doudizhuJZ.prototype.dealEndRoom = function (msg) {
...
PlayLayer_doudizhuJZ.prototype.dealLeaveGame = function () {
    MjClient.playui.killTimeClock();
    MjClient.addHomeView();
    MjClient.playui.removeFromParent(true);
    delete MjClient.playui;
...
PlayLayer_doudizhuJZ.prototype.dealLoadWxHead = function (eD) {
    for (var i = 0; i < this.headOffLen; i++) {
        var off = this.headOffArr[i];
...
PlayLayer_doudizhuJZ.prototype.dealPlayVoice = function (msg) {
    for (var i = 0; i < this.headOffLen; i++) {
        var off = this.headOffArr[i];
...
PlayLayer_doudizhuJZ.prototype.dealChangeGameBgEvent = function () {
...
PlayLayer_doudizhuJZ.prototype.handlePlayerChange = function (action, uid) {
    if (!this.isSDataValid()) {
        return ;
    }
    var targetOff = -1;
...
PlayLayer_doudizhuJZ.prototype.hideAllPlayerReadyState = function () {
    var isFull = !IsInviteVisible();
    var count = 0;
...
PlayLayer_doudizhuJZ.prototype.playSuperJiaBeiAni = function () {
...
PlayLayer_doudizhuJZ.prototype.dealMoveHead = function () {
    var that = this;
    var fun1 = function () {
...
// =========================[[ 消息 ]] ===========================
// 加倍
PlayLayer_doudizhuJZ.prototype.sendJiaBeiToServer = function (beishu) {
    MjClient.gamenet.request("pkroom.handler.tableMsg", {
        cmd: "MJJiazhu",
        jiazhuNum: beishu,
    });
...
// 叫地主、不叫、叫分
PlayLayer_doudizhuJZ.prototype.sendQiangdizhuToServer = function (bQiang) {
    MjClient.gamenet.request("pkroom.handler.tableMsg", {
        cmd: "Qiangdizhu",
        qiang: bQiang
    });
...
// 出牌
PlayLayer_doudizhuJZ.prototype.sendPutCardsToServer = function () {
...
// 准备-1， 提示过牌0， 不出 1
PlayLayer_doudizhuJZ.prototype.sendPassToServer = function (isActivePass) {
    this.handCardsWgetArr[0].clearCardsUpStatus();
...
PlayLayer_doudizhuJZ.prototype.sendCancelTuoGuanToServer = function () {
    MjClient.gamenet.request("pkroom.handler.tableMsg", {cmd: "cancelTrust"});
};

PlayLayer_doudizhuJZ.prototype.sendTuoGuanToServer = function () {
    MjClient.gamenet.request("pkroom.handler.tableMsg", {cmd: "beTrust"});
};

// =========================[[ 初始化 ]] ==========================
PlayLayer_doudizhuJZ.prototype.initData = function (isRoundEnd) {
    this.cardTipsArr = [];
    this.tipsIdx = 0;
...
PlayLayer_doudizhuJZ.prototype.initTagList = function () {
    this.btnTagList = {
        BtnPutCard: 1,
        BtnHimt: 2,
        BtnNoPut: 3,
...
PlayLayer_doudizhuJZ.prototype.initOnce = function () {
...
PlayLayer_doudizhuJZ.prototype.initUI = function () {
...
//设置金币场节点
PlayLayer_doudizhuJZ.prototype.displayJinBiChangNode = function () {
...
// 初始化节点
PlayLayer_doudizhuJZ.prototype.initHeadWget = function () {
    this.headOffArr = [];
    this.headNode = {};
    this.AniMotion = [];
...
//初始化玩家信息
PlayLayer_doudizhuJZ.prototype.initMsgEvent = function () {
    // ================ 重连 =========================
...
PlayLayer_doudizhuJZ.prototype.initClickEvent = function () {
...
PlayLayer_doudizhuJZ.prototype.btnBindCallBack = function (parent, str, tag, callback) {
    var tmpNode = parent.getChildByName(str);
    tmpNode.tag = tag;
    tmpNode.addTouchEventListener(callback);
};

PlayLayer_doudizhuJZ.prototype.btnEventListener = function (sender, type) {
...
// 初始化时钟节点
PlayLayer_doudizhuJZ.prototype.initClockWget = function () {
    for (var off = 0; off < 4; off++) {
        var _node = getNode(off);
...
//判断自己是不是托管状态
PlayLayer_doudizhuJZ.prototype.isTrusted = function () {
    if (!MjClient.playui.isJinBiChang()) {
        return false;
    }
    var pl = getUIPlayer(0);
...
PlayLayer_doudizhuJZ.prototype.handleMutiple = function (isSceneData) {
    var tData = MjClient.data.sData.tData;
    var imgMutiple = this._banner.getChildByName("imgMutiple");
    imgMutiple.visible = false;
...
PlayLayer_doudizhuJZ.prototype.showJiabeiTagMove = function (off, jizhuNum) {
    var node = getNode_cards(off);
    var jiabeiTag = node.getChildByName("jiabeiTag");
...
PlayLayer_doudizhuJZ.prototype.isSDataValid = function() {
    var sData = MjClient.data.sData;
