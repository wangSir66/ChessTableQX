...
var CreateRoomNode_doudizhuJZ = CreateRoomNode.extend({
    setKey:function()
    {
        this.localStorageKey.KEY_DDZJZ_playerNumber       = "_DOU_DI_ZHU_JZ_PLAYER_NUMBER";     //玩家数量
        this.localStorageKey.KEY_DDZJZ_fengding           = "_DOU_DI_ZHU_JZ_FENG_DING";           //封顶 封顶
        this.localStorageKey.KEY_DDZJZ_dizhu               = "_DI_ZHU_JZ_FENG_DING";           //底分
        this.localStorageKey.KEY_DDZJZ_type            = "_DOU_DI_ZHU_TYPE";           //类型
        //this.localStorageKey.KEY_DDZJZ_yingjiachu           = "_DOU_DI_ZHU_yingjiachu";         //赢家出
        this.localStorageKey.KEY_DDZJZ_gps      = "_DOU_DI_ZHU_JZ_GPS"; //防作弊
        this.localStorageKey.KEY_DDZJZ_shuangwangbijiao                = "_DOU_DI_ZHU_JZ_SHUANG_WANG_BIJIAO";                //双王必叫
        this.localStorageKey.KEY_DDZJZ_sigeerbijiao                = "_DOU_DI_ZHU_JZ_SI_GE_ER_BIJIAO";                //四个二必叫
        this.localStorageKey.KEY_DDZJZ_sandai           = "_DOU_DI_ZHU_JZ_SAN_DAI";           // 
    ...
    initPlayNode:function()
    {
        ...
        //sandai 
        this._playNode_sandai_0 = _playWay.getChildByName("play_sandai_0");
        this._playNode_sandai_1 = _playWay.getChildByName("play_sandai_1");
        this._playNode_sandai_2 = _playWay.getChildByName("play_sandai_2");
        var nodeListSanDai = [];
        nodeListSanDai.push( this._playNode_sandai_0 );
        nodeListSanDai.push( this._playNode_sandai_1 );
        nodeListSanDai.push( this._playNode_sandai_2 );
        this._playNode_SanDai_radio = createRadioBoxForCheckBoxs(nodeListSanDai,this.radioBoxSelectCB);
        this.addListenerText(nodeListSanDai,this._playNode_SanDai_radio);
    ...
    setPlayNodeCurrentSelect:function(isClub) {
        ...
        if (isClub)
            ...
            _fengDing = util.localStorageEncrypt.getNumberItem(this.localStorageKey.KEY_DDZJZ_fengding, 3);
        ...
        var _sandai;
        if (isClub)
            _sandai = this.getNumberItem("sandai", 2);
        else
            _sandai = util.localStorageEncrypt.getNumberItem(this.localStorageKey.KEY_DDZJZ_sandai, 2);
        this._playNode_sandai_0.setSelected(false);
        this._playNode_sandai_1.setSelected(false);
        this._playNode_sandai_2.setSelected(false);

        var sandai_list = [];
        sandai_list.push(this._playNode_sandai_0);
        sandai_list.push(this._playNode_sandai_1);
        sandai_list.push(this._playNode_sandai_2);
        var sandai_index = 0;

        if (_sandai == 0) {
            this._playNode_sandai_0.setSelected(true);
            sandai_index = 0;
        }
        else if (_sandai == 1) {
            sandai_index = 1;
            this._playNode_sandai_1.setSelected(true);
        }
        else if (_sandai == 2) {
            sandai_index = 2;
            this._playNode_sandai_2.setSelected(true);
        }
        this.radioBoxSelectCB(sandai_index, sandai_list[sandai_index], sandai_list);
        //
        ...
        if (isClub) {
            ...
            _type = util.localStorageEncrypt.getNumberItem(this.localStorageKey.KEY_DDZJZ_type, 1);
        ...
        if (isClub) {
            ...
            _difen = util.localStorageEncrypt.getNumberItem(this.localStorageKey.KEY_DDZJZ_dizhu, 0);
        ...
        if (isClub)
            ...
            _gps = util.localStorageEncrypt.getBoolItem(this.localStorageKey.KEY_DDZJZ_gps, false);
        ...
        if(isClub)
            ...
            _shuangwangbijiao = util.localStorageEncrypt.getBoolItem(this.localStorageKey.KEY_DDZJZ_shuangwangbijiao, true);
        ...
        if(isClub)
            ...
            _sigeerbijiao = util.localStorageEncrypt.getBoolItem(this.localStorageKey.KEY_DDZJZ_sigeerbijiao, true);
        ...
        if (isClub) {
            ...
            _countIdx = util.localStorageEncrypt.getNumberItem(this.localStorageKey.KEY_DDZJZ_playerNumber, 0);
        }
    ...
    {
        var para = {};
        para.gameType = MjClient.GAME_TYPE.DOU_DI_ZHU_JZ;
        para.maxPlayer = 3;
        para.zhafengding  = 3;
        para.sandai  = 2;
        para.difen = 1;
        ...
        if(this._playNode_sandai_0.isSelected())
        {
            para.sandai = 0;
        }
        else if(this._playNode_sandai_1.isSelected())
        {
            para.sandai = 1;
        }
        else if(this._playNode_sandai_2.isSelected())
        {
            para.sandai = 2;
        }
        ...
        if (!this._isFriendCard) {
            util.localStorageEncrypt.setNumberItem(this.localStorageKey.KEY_DDZJZ_sandai,para.sandai);
            util.localStorageEncrypt.setNumberItem(this.localStorageKey.KEY_DDZJZ_fengding,para.zhafengding);
            util.localStorageEncrypt.setNumberItem(this.localStorageKey.KEY_DDZJZ_type, _type);
            util.localStorageEncrypt.setBoolItem(this.localStorageKey.KEY_DDZJZ_shuangwangbijiao, para.bijiaoShuangwang);
            util.localStorageEncrypt.setBoolItem(this.localStorageKey.KEY_DDZJZ_sigeerbijiao, para.bijiaoSigeer);
            ...
            util.localStorageEncrypt.setNumberItem(this.localStorageKey.KEY_DDZJZ_dizhu, this._zhuIdx);
            util.localStorageEncrypt.setBoolItem(this.localStorageKey.KEY_DDZJZ_gps,  para.gps);
            util.localStorageEncrypt.setNumberItem(this.localStorageKey.KEY_DDZJZ_playerNumber, _countIdx);
        }
