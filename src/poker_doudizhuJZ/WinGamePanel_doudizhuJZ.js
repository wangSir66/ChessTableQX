...
var EndOneView_doudizhuJZ = cc.Layer.extend({
    jsBind: {
        block: {
            ...
            publicMutiple: {
                ...
                _text: function () {
                    ...
                    if (index == -1) { // 没有解散
                        ...
                        text += "=公共倍数" + revise(((tData.fieldBase ? tData.fieldBase : tData.areaSelectMode.difen) * endInfo.diFen * Math.pow(2, tData.totalZhaDan) * tData.chuntianRate));
                    } else {
