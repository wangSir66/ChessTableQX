...
//向服务器发送 过消息
MjClient.MJPass2NetFortuidaohu = function()
{
   // console.log(">>>>>>>>>普通  过 <<<<<<<<");
    cc.log("====================MJPass2NetFortuidaohu======pass=====");
...
function SetUserVisible_tuidaohu(node, off)
{
    //var sData = MjClient.data.sData;
    //return;
    cc.log("====================off======================" + off);
...
function DealMJPut_tuidaohu(node, msg, off, outNum)
{
...
function InitUserHandUI_tuidaohu(node, off)
{
    var sData = MjClient.data.sData;
    var tData = sData.tData;
    var pl = getUIPlayer(off);
    ...
    for(var i = 0; i < pl.mjput.length; i++)
    {
        ...
        DealMJPut_tuidaohu(node, msg, off, i);
    }
...
function initFlower_tuidaohu() {
    initFlower(false, false);
}


var PlayLayer_tuidaohu = cc.Layer.extend({
    jsBind: {
        _event: {
            mjhand: function() {
            ...
            roundEnd: function() {
                ...
                function delayExe()
                {
                    ...
                    self.addChild(new EndOneView_tuidaohu(),500);
                }
        ...
        eat: {
            ...
            guo: {
                ...
                _touch: function(btn, eT) {
                    if (eT == 2)
                    {
                        MjClient.MJPass2NetFortuidaohu();
                    }
                },
                bgimg: {
                    _run: function() {
            ...
            changeui: {
                ...
                changeuibg: {
                    ...
                    guobg: {
                        guo: {
                            _touch: function(btn, eT) {
                                if (eT == 2) MjClient.MJPass2NetFortuidaohu();
                            }
                        },
                        fanhui: {
                            _touch: function(btn, et) {
            ...
            _event: {
                ...
                waitPut: function(eD) {
                    ...
                    MjClient.playui.EatVisibleCheck();
                    //胡牌引导，可听得牌加箭头
                    if(!MjClient.data.sData.tData.areaSelectMode.baoting)
                    {
    ...
    ctor: function() {
        this._super();
        var playui = ccs.load(res.Play_tuidaohu_json);
...
PlayLayer_tuidaohu.prototype.CardLayoutRestore = function(node, off)
{
...
// 判断吃碰杠胡的状态
PlayLayer_tuidaohu.prototype.EatVisibleCheck = function()
{
    var eat = MjClient.playui.jsBind.eat;
...
/*
    玩家ui，信息
 */
PlayLayer_tuidaohu.prototype.Node_player = function(off)
{
    ...
    UIEventBind(null, _node, "initSceneData", function (eD) {
        SetUserVisible_tuidaohu(_node, off);
    ...
    UIEventBind(null, _node, "mjhand", function (eD) {
        InitUserHandUI_tuidaohu(_node, off);
    });
