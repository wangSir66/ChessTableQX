...
function SetEndOneUserUI_tuidaohu(node,off)
{
    ...
    else if (tData.areaSelectMode.baoting)
    {
...
var EndOneView_tuidaohu = cc.Layer.extend({
	jsBind:{
		block: {
		...
		head0:{
		   ...
		   _run:function(){ SetEndOneUserUI_tuidaohu(this,0); },
		...
		,head1:{ 
		  ...
		  _run:function(){ SetEndOneUserUI_tuidaohu(this,1); }
		}
		...
		,head2:{ 
		   ...
		   _run:function(){ SetEndOneUserUI_tuidaohu(this,2); }
		}
		,head3:{
			 head:
			 {
			...
			_run:function(){ SetEndOneUserUI_tuidaohu(this,3); }
			},
            count_down:{
                _visible :function()
                {
    ...
    ctor:function () {
        this._super();
        var endoneui = ccs.load(res.EndOne_tuidaohu_json);
