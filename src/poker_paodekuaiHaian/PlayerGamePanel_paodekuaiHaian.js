...
function SetUserVisible_paodekuaiHaian(node, off)
{
    ...
    if(pl)
    {
        ...
        InitUserHandUI_paodekuaiHaian(node, off);
...
function InitUserHandUI_paodekuaiHaian(node, off, needSort)
{
...
function cardsSort_paodekuaiHaian(cards)
{
    var pointCounts = {};
    for (var i = 0; i < cards.length; i++) {
        var p = MjClient.majiang_paodekuaiHaian.calPoint(cards[i]);
        if (pointCounts[p])
            pointCounts[p] ++;
        else
            pointCounts[p] = 1;
    ...
    var commonCmp = function (a, b) {
        var c1 = pointCounts[MjClient.majiang_paodekuaiHaian.calPoint(a)];
        var c2 = pointCounts[MjClient.majiang_paodekuaiHaian.calPoint(b)];
        if (c1 == c2)
            return MjClient.majiang_paodekuaiHaian.cardValueCmp(a, b);
        else
            return c1 - c2;
    }
...
var PlayLayer_paodekuaiHaian = cc.Layer.extend({
    _btnPutCard:null,
    jsBind: {
        _run: function() {
        ...
        banner: {
            ...
            gps_btn: {
                _run: function() {
                    ...
                    cc.log("The delroom size width = " + delroom.getContentSize().width);
        ...
        BtnPutCard:{ //add by  sking for put card button
            ...
            _click: function(btn) {
                //cc.log("BtnPutCard");
				cardsSort_paodekuaiHaian(MjClient.selectCards_card);
        ...
        down: {
            ...
            _event: {
                ...
                initSceneData: function(eD) {
                    SetUserVisible_paodekuaiHaian(this, 0);
                ...
                mjhand: function(eD) {
                    InitUserHandUI_paodekuaiHaian(this, 0);
        ...
        right: {
            ...
            _event: {
                ...
                initSceneData: function(eD) {
                    SetUserVisible_paodekuaiHaian(this, 1);
                },
                addPlayer: function(eD) {
                    SetUserVisible_paodekuaiHaian(this, 1);
                },
                ...
                mjhand: function(eD) {
                    InitUserHandUI_paodekuaiHaian(this, 1);
                },
                roundEnd: function() {
        ...
        top: {
            ...
            _event: {
                ...
                initSceneData: function(eD) {
                    SetUserVisible_paodekuaiHaian(this, 2);
                },
                addPlayer: function(eD) {
                    SetUserVisible_paodekuaiHaian(this, 2);
                },
                ...
                mjhand: function(eD) {
                    InitUserHandUI_paodekuaiHaian(this, 2);
                },
                roundEnd: function() {
        ...
        left: {
            ...
            _event: {
                ...
                initSceneData: function(eD) {
                    SetUserVisible_paodekuaiHaian(this, 3);
                },
                addPlayer: function(eD) {
                    SetUserVisible_paodekuaiHaian(this, 3);
                },
                ...
                mjhand: function(eD) {
                    InitUserHandUI_paodekuaiHaian(this, 3);
                },
                roundEnd: function() {
    ...
    ctor: function() {
        this._super();
        var playui = ccs.load(res.Play_PaoDeKuaiHaian_json);
...
PlayLayer_paodekuaiHaian.prototype.cannotOutCardGrey = function()
{
...
PlayLayer_paodekuaiHaian.prototype.recoverCannotOutCard = function()
{
    var children = this._downNode.children;
    for (var i = 0; i < children.length; i++)
    {
...
PlayLayer_paodekuaiHaian.prototype.clockNumberUpdate = function(node, endFunc)
{
...
PlayLayer_paodekuaiHaian.prototype.shwoFlyCardAnim = function(flyNode)
{
    var tData = MjClient.data.sData.tData;
...
PlayLayer_paodekuaiHaian.prototype.showHandCardBeiMian = function()
{
...
PlayLayer_paodekuaiHaian.prototype.hideHandCardBeiMian = function()
{
...
PlayLayer_paodekuaiHaian.prototype.CardLayoutRestore = function(node, off, needSort)
{
    // 如果正在发牌 不排序
...
PlayLayer_paodekuaiHaian.prototype.CardLayoutDesk = function(node,cards,off)
{
    //if(off != 0) return;
    ...
    var sort = function (node)
    {
        ...
        for (var i = 0; i < node.length; i++) {
            var p = MjClient.majiang_paodekuaiHaian.calPoint(node[i].tag);
            if (pointCounts[p])
                pointCounts[p] ++;
            else
                pointCounts[p] = 1;
        ...
        var commonCmp = function (a, b) {
            var c1 = pointCounts[MjClient.majiang_paodekuaiHaian.calPoint(a.tag)];
            var c2 = pointCounts[MjClient.majiang_paodekuaiHaian.calPoint(b.tag)];
            if (c1 == c2)
                return MjClient.majiang_paodekuaiHaian.cardValueCmp(a.tag, b.tag);
            else
                return c1 - c2;
        }
...
//横向摆放《正常》
PlayLayer_paodekuaiHaian.prototype.horSort = function(node, off, needSort)
{
    var pl; //player 信息
...
//纵向摆放
PlayLayer_paodekuaiHaian.prototype.verSort = function(node, off, needSort)
{
    if(off != 0)
    {
        return;
