...
function SetEndOneUserUI_paodekuaiHaian(node, off) {
...
function CardLayoutRestoreForEndOne_paodekuaiHaian(node, plNode) {
...
var EndOneView_paodekuaiHaian = cc.Layer.extend({
    jsBind: {
        block: {
        ...
        back: {
            ...
            head0: {
                ...
                _run: function () { SetEndOneUserUI_paodekuaiHaian(this, 0); },
    		...
    		, head1: {
    		    ...
    		    _run: function () { SetEndOneUserUI_paodekuaiHaian(this, 1); }
    		}
    		...
    		, head2: {
    		    ...
    		    _run: function () { SetEndOneUserUI_paodekuaiHaian(this, 2); }
    		}
        }
    },
    ctor: function () {
        this._super();
        var endoneui = ccs.load(res.EndOne_PaoDeKuaiHaian_json);
