...
var majiang_panel_daYeKaiKouFan = majiang_panel_hubei.extend({
    jsonFile: "Play_daYeKaiKouFan.json",
    ctor: function(){
        ...
        this._super(majiang_panel_daYeKaiKouFan, this.jsonFile);
    },
...
//动画展示癞子牌
majiang_panel_daYeKaiKouFan.prototype.showPiZiAndLaiZi = function(node){
...
//Override 是否能添加癞子标识
majiang_panel_daYeKaiKouFan.prototype.isCanAddLaiZiIcon = function(cardTag){
...
//Override
majiang_panel_daYeKaiKouFan.prototype.getLaiZiIcon2D = function(cardTag){
...
//Override 是否显示飘分
majiang_panel_daYeKaiKouFan.prototype.isShowPiao = function(){
	return false;
};

majiang_panel_daYeKaiKouFan.prototype.getHunIconPosition2D = function(){
    return [[60, 107], [52, 70], [40, 104], [74, 68], [40, 78], [61, 77], [22, 30]];
};

//Override 癞子位置偏移比
majiang_panel_daYeKaiKouFan.prototype.getEatAndHandCardsLaiZiIconPosSpcae3D = function(){
    return cc.p(0.88, 1.1);
};


//Override [createEndOnePanel 创建小结算界面]
majiang_panel_daYeKaiKouFan.prototype.createEndOnePanel = function(){
    return new majiang_winGamePanel_daYeKaiKouFan();
};

//Override 所有的牌进行排序
majiang_panel_daYeKaiKouFan.prototype.getCardSortArray2D = function(node, newCardTag){
    var tData = MjClient.data.sData.tData;
...
//Override 所有的牌进行排序
majiang_panel_daYeKaiKouFan.prototype.getCardSortArray3D = function(node, newCardTag){
    var tData = MjClient.data.sData.tData;
...
//获取手牌中的痞子牌或癞子牌
majiang_panel_daYeKaiKouFan.prototype.getSpecilaCardsOfHand = function(type){
    var cardArr = [];
...
//设置其他牌大小
majiang_panel_daYeKaiKouFan.prototype.updateOtherCardSize = function(node){
    var is3D = MjClient.playui.is3DStyle();
...
//Override 计算打牌插牌位置
majiang_panel_daYeKaiKouFan.prototype.getInsertCardPosIndex = function (handcardUI, index) {
 ...
 *  Override 常量定义
 **/
majiang_panel_daYeKaiKouFan.prototype.initCardTypeName = function(){
 ...
 *  Override 刷新手牌大小
 **/
majiang_panel_daYeKaiKouFan.prototype.updateHandCardSize = function(node){
    var playNode = node.getParent();
 ...
 **/
majiang_panel_daYeKaiKouFan.prototype.getMoveDistance2D = function(node, cardArr, index, chiFirstIndex){
    if(index == 0){
        return 0;
    }
 ...
 *  Override刷新牌
 **/
majiang_panel_daYeKaiKouFan.prototype.resetCardLayout2D = function(node){
 ...
 *  Override 刷新牌,待完成
 **/
majiang_panel_daYeKaiKouFan.prototype.resetCardLayout3D = function(node){
...
//更新node_down玩家的特殊杠
majiang_panel_daYeKaiKouFan.prototype.updateDownPiZiGangCards3D = function(node, piZiGangArr){
...
//更新node_right玩家的特殊杠
majiang_panel_daYeKaiKouFan.prototype.updateRightPiZiGangCards3D = function(node, piZiGangArr){
    var templetCard = node.getChildByName(this.CsdDefaultCardType.PiZiGang);
    var scale = templetCard.getScale() * 1.3;
...
//更新node_top玩家的特殊杠
majiang_panel_daYeKaiKouFan.prototype.updateTopPiZiGangCards3D = function(node, piZiGangArr){
    var templetCard = node.getChildByName(this.CsdDefaultCardType.PiZiGang);
    var scale = templetCard.getScale() * 1.3;
...
//更新node_left玩家的特殊杠
majiang_panel_daYeKaiKouFan.prototype.updateLeftPiZiGangCards3D = function(node, piZiGangArr){
    var templetCard = node.getChildByName(this.CsdDefaultCardType.PiZiGang);
    var scale = templetCard.getScale() * 1.3;
...
//Override 更新玩家的牌
majiang_panel_daYeKaiKouFan.prototype.updatePlayerCards = function (node){
    var player = this.getPlayerInfoByName(node.getName());
    if(!player){
        return;
    }
 ...
 *  添加癞子标识
 **/
majiang_panel_daYeKaiKouFan.prototype.addLaiZiIcon2D = function(cardNode){
...
//获取癞子杠的图标偏移量
majiang_panel_daYeKaiKouFan.prototype.getPiZiGangIconPositionOffset2D = function(cardNode){
    var playerNodeName = cardNode.getParent().getName();
 ...
 *  Override 添加癞子标识
 **/
majiang_panel_daYeKaiKouFan.prototype.addLaiZiIcon3D = function(cardNode){
    if(!this.isCanAddLaiZiIcon(cardNode.tag)){
        return;
    }
 ...
 **/
majiang_panel_daYeKaiKouFan.prototype.getHandCardFacePosition3D = function(mjBgType){
 ...
 *  return {Array}
 **/
majiang_panel_daYeKaiKouFan.prototype.getCardFacePositon2D = function(mjBgType, cardNode){
...
//Override 
majiang_panel_daYeKaiKouFan.prototype.getPutCardsLaiZiIconPosSpcae3D = function(cardNode){
...
//获取3d玩家吃碰杠手牌的起始位置
majiang_panel_daYeKaiKouFan.prototype.getEatAndHandCardsStartPos3D = function(node_name, firstCardType){
 ...
 **/
majiang_panel_daYeKaiKouFan.prototype.updateChiGangCards3D = function(cardNode, cardTag){
...
// 设置游戏中，结束位置的头像
majiang_panel_daYeKaiKouFan.prototype.setInGameHeadLayout = function(nodeName, layout_head){
...
//更新翻倍
majiang_panel_daYeKaiKouFan.prototype.updatePlayerBeiShu = function(node, data){
    if(!node) return;
...
//翻倍动画
majiang_panel_daYeKaiKouFan.prototype.showPlayerFanBeiAnim = function(node, data){
    node.visible = false;
    if(!node || !data) return;
...
//扩展的eat动画
majiang_panel_daYeKaiKouFan.prototype.showExpandEatActionAnim = function(playerNode, actType, param){
    param = param || {};
...
majiang_panel_daYeKaiKouFan.prototype.isSpecialGang = function(card){
...
//Override
majiang_panel_daYeKaiKouFan.prototype.dealSpecialGang = function(playerNode, gangType,card){
    //发财，红中，癞子杠
    if(gangType){
        switch (gangType) {
            case 1:
...
majiang_panel_daYeKaiKouFan.prototype.dealPut = function(playerNode, msg){
    var tData = MjClient.data.sData.tData;
...
majiang_panel_daYeKaiKouFan.prototype.putOutCard = function (cardNode, cardTag, autoput){
 ...
 *	处理结算
 **/
majiang_panel_daYeKaiKouFan.prototype.handleRoundEnd = function(){
    var tData = MjClient.data.sData.tData;
    ...
    var showEndCards = function(){
        if(winnerUid && fengDingPlayerCount == tData.maxPlayer - 1){//金顶
            ...
            projNode.setAnimation(0, this.ExpandEatActionType.JinDing, false);
...
//设置禁胡标记
majiang_panel_daYeKaiKouFan.prototype.setJinHuTip = function(node, msg){
    return;
    var sData = MjClient.data.sData;
...
//Override 
majiang_panel_daYeKaiKouFan.prototype.handlerWhenCardTouchEnded = function(cardNode, cardTag){
    var sData = MjClient.data.sData;
    var tData = sData.tData;
...
majiang_panel_daYeKaiKouFan.prototype.getHandAndEatCardSpcae3D = function(){
    return 1.7;
};

//Override
majiang_panel_daYeKaiKouFan.prototype.getAllTouchCards = function(){
...
majiang_panel_daYeKaiKouFan.prototype.getDisScaleOfFirstCutDownBetweenEatCard2D = function(){
    return 1;
};
/**
 *  吃碰杠胡动画
 **/
majiang_panel_daYeKaiKouFan.prototype.showEatActionAnim = function(playerNode, actType,is2DAni) {
    var delayTime = 2;
    var animateNode = playerNode.getChildByName("node_animation");
