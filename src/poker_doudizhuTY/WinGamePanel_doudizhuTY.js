...
function SetEndOneUserUI_doudizhuTY(node, off) {
        ...
        head: {
            ...
            stand: {
                ...
                _run: function () {
                    ...
                    CardLayoutRestoreForEndOne_doudizhuTY(node, pl);
                }
            },
            cardType: {
                _run:function()
...
function CardLayoutRestoreForEndOne_doudizhuTY(node, plNode) {
...
var EndOneView_doudizhuTY = cc.Layer.extend({
    jsBind: {
        block: {
        ...
        back: {
            ...
            head0: {
                ...
                _run: function () { SetEndOneUserUI_doudizhuTY(this, 0); },
    		...
    		, head1: {
    		    ...
    		    _run: function () { SetEndOneUserUI_doudizhuTY(this, 1); }
    		}
    		...
    		, head2: {
    		    ...
    		    _run: function () { SetEndOneUserUI_doudizhuTY(this, 2); }
            }
            , publicMutiple: {
                _run:function()
                {
    ...
    ctor: function (zhuang, rate) {
        ...
        var endoneui = ccs.load("endOne_doudizhuTY.json");
