...
var PlayLayer_doudizhuTongYong = cc.Layer.extend({
    ctor: function () {
        this._super();
        var playui = ccs.load(res.Play_doudizhuTongYong_json);
...
PlayLayer_doudizhuTongYong.prototype.isJD = function () {
...
PlayLayer_doudizhuTongYong.prototype.isRoundEnd = function () {
    var tState = MjClient.data.sData.tData.tState;
    return tState == TableState.waitReady || tState == TableState.roundFinish || tState == TableState.waitJoin || tState == TableState.isReady;
}

// 检查出牌是否合法
PlayLayer_doudizhuTongYong.prototype.isCanPutCards = function (putCards) {
...
//出牌提示
PlayLayer_doudizhuTongYong.prototype.showTipCards = function () {
...
// 处理斗地主智能提牌
PlayLayer_doudizhuTongYong.prototype.handleDoudizhuCardsAutoUp = function (bTouchMove) {
    if (!this.isSDataValid()) {
        return ;
    }
    var tData = MjClient.data.sData.tData;
...
PlayLayer_doudizhuTongYong.prototype.handleCardsTouchListener = function () {
    return {
...
// 处理点击
PlayLayer_doudizhuTongYong.prototype.handleTouchCards = function (touch, event, isBegan) {
...
// 处理玩家提起提起得牌，保留正确的牌
PlayLayer_doudizhuTongYong.prototype.handleUpRightCards = function (isFirst, off) {
    if (isFirst) {
        return;
    }
...
// =========================[[ 流程 ]] =========================
// 断线重连/初始化
PlayLayer_doudizhuTongYong.prototype.dealInitSceneData = function () {
    if (!this.isSDataValid()) {
        return ;
    }
    var tData = MjClient.data.sData.tData;
...
PlayLayer_doudizhuTongYong.prototype.dealChangePKImg = function () {
...
// 结算
PlayLayer_doudizhuTongYong.prototype.dealRoundEnd = function (eD) {
    if (!this.isSDataValid()) {
        return ;
    }
    ...
    function delayExe() {
        ...
        self.addChild(new EndOneView_doudizhuTY(zhuang, rate), 500);
    }
...
// 过、准备
PlayLayer_doudizhuTongYong.prototype.dealPKPass = function (eD) {
    MjClient.playui.killTimeClock();
...
// 出牌
PlayLayer_doudizhuTongYong.prototype.dealPKPut = function (msg) {
    cc.log("----------dealpkput");
    var tData = MjClient.data.sData.tData;
    tData.rate = msg.rate;
...
// 等待出牌
PlayLayer_doudizhuTongYong.prototype.dealWaitPut = function (eD) {
    var tData = MjClient.data.sData.tData;
...
// 等待叫地主
PlayLayer_doudizhuTongYong.prototype.dealWaitJiaodizhu = function (msg) {
    var sData = MjClient.data.sData;
    var tData = sData.tData;
...
// 抢地主
PlayLayer_doudizhuTongYong.prototype.dealQiangDizhu = function (msg) {
    var tData = MjClient.data.sData.tData;
    if (msg.qiang) {
        tData.rate = msg.rate;
        MjClient.playui.setTextMult(true);
...
// 等待准备
PlayLayer_doudizhuTongYong.prototype.dealAllReady = function (bAllReady) {
    for (var i = 0; i < this.headOffLen; i++) {
        var off = this.headOffArr[i];
...
// 加倍
PlayLayer_doudizhuTongYong.prototype.dealMJJiazhu = function (isSceneData, off, jiazhuNum, curPlayer) {
    var tData = MjClient.data.sData.tData;
...
// 等待加倍
PlayLayer_doudizhuTongYong.prototype.dealWaitJiazhu = function (eD) {
    var tData = MjClient.data.sData.tData;
...
// 处理手牌
PlayLayer_doudizhuTongYong.prototype.handleMjHand = function () {
...
// 处理底牌
PlayLayer_doudizhuTongYong.prototype.dealDiCards = function (zhuang, diCards, handCounts, isAddCards, isIconMove) {
    var tData = MjClient.data.sData.tData;
    tData.zhuang = zhuang;
...
PlayLayer_doudizhuTongYong.prototype.updateUserHeadPosition = function (off, bRoundEnd) {
...
PlayLayer_doudizhuTongYong.prototype.updateTimes = function () {
...
//设置地区信息
PlayLayer_doudizhuTongYong.prototype.showGameName = function () {
...
//添加还背景的功能
PlayLayer_doudizhuTongYong.prototype.addChangeBg = function () {
...
PlayLayer_doudizhuTongYong.prototype.showVoice = function () {
...
PlayLayer_doudizhuTongYong.prototype.addWaitNode = function () {
...
PlayLayer_doudizhuTongYong.prototype.setWaitNodeVisible = function (bVisible) {
...
PlayLayer_doudizhuTongYong.prototype.addAniLayer = function () {
    this.AniLayer = new Animature_doudizhu();
    this.AniLayer.setPosition(cc.p(0, 0));
    MjClient.playui.node.addChild(this.AniLayer, 450);
};

PlayLayer_doudizhuTongYong.prototype.showTableID = function (bShow) {
...
PlayLayer_doudizhuTongYong.prototype.showRoundNum = function () {
...
PlayLayer_doudizhuTongYong.prototype.setHLJiabeiVisible = function (bVisible) {
...
// 出牌按钮
PlayLayer_doudizhuTongYong.prototype.handlePutCardBtn = function (isVisible, isFirst) {
...
PlayLayer_doudizhuTongYong.prototype.enablePutCardBtn = function (bAble) {
    var btnPutCard = this.node.getChildByName("BtnPutCard");
...
//操作按钮(提示和不出) 
PlayLayer_doudizhuTongYong.prototype.handleHimtAndNoPutBtn = function (isVisible, isAble) {
...
//经典斗地主叫分按钮
PlayLayer_doudizhuTongYong.prototype.setJingDianBtnVisible = function (bVisible, buJiaoAble, score, bmustjiao) {
    ...
    if (bVisible) {
        ...
        if (!MjClient.data.sData.tData.hasJiao) {
            var _res = (MjClient.playui.isJD() && MjClient.getAppType() == MjClient.APP_TYPE.QXJSMJ) ?
...
//欢乐斗地主叫分按钮
PlayLayer_doudizhuTongYong.prototype.setHuanLeBtnVisible = function (bVisible) {
...
// 牌局信息
PlayLayer_doudizhuTongYong.prototype.showRoundInfo = function () {
    if (!this.isSDataValid()) {
        return ;
    }
...
// 局数
PlayLayer_doudizhuTongYong.prototype.updateGameRound = function () {
...
// 加倍
PlayLayer_doudizhuTongYong.prototype.setTextMult = function (bShow) {
...
//加倍
PlayLayer_doudizhuTongYong.prototype.handleJiabeiTag = function (off, type) {
    var node = getNode_cards(off);
...
// 底分
PlayLayer_doudizhuTongYong.prototype.handleDifen = function () {
    var textDifen = this._banner.getChildByName("Text_difen");
    var tData = MjClient.data.sData.tData;

    var difen = (MjClient.playui.isJD() && MjClient.getAppType() == MjClient.APP_TYPE.QXJSMJ)? tData.minJiaofen : tData.difen;
    var fenStr = difen > 0 ? difen : "";
    textDifen.setString(fenStr);
    textDifen.ignoreContentAdaptWithSize(true);
}

PlayLayer_doudizhuTongYong.prototype.setVisibleJiaoFenText = function () {
    if ( !(MjClient.playui.isJD() && MjClient.getAppType() == MjClient.APP_TYPE.QXJSMJ) || !this.isSDataValid()) {
        return ;
    }
    ...
    function showVisible(off){
        ...
        if (pl.qiang > 0) {
            ...
            var _png = (MjClient.playui.isJD() && MjClient.getAppType() == MjClient.APP_TYPE.QXJSMJ) ?
...
// 不抢/抢地主
PlayLayer_doudizhuTongYong.prototype.dealQiangDizhuText = function (off, visible, msg) {
    var node = getNode_cards(off);
    var diZhuTag = node.getChildByName("jiaodizhuTag");
    diZhuTag.visible = visible;
    if (!visible) {
    ...
    if (msg.qiang) {
        if (MjClient.playui.isJD()) {
            ...
            if( (MjClient.playui.isJD() && MjClient.getAppType() == MjClient.APP_TYPE.QXJSMJ) && msg && msg.qiang == -1 ){
                 diZhuTag.loadTexture("playing/doudizhu/bujiaofen.png");
            }
...
// 要不起
PlayLayer_doudizhuTongYong.prototype.handleNoPutTag = function (off, visible) {
    var node = getNode_cards(off);
...
// 没有大过上家
PlayLayer_doudizhuTongYong.prototype.handleNoPutTips = function (isVisible) {
...
// 没有大过上家
PlayLayer_doudizhuTongYong.prototype.handlePassBtn = function (isVisible) {
...
// =========================[[ 系统 ]] ==========================
PlayLayer_doudizhuTongYong.prototype.dealSendVoice = function (fullFilePath) {
    if (!fullFilePath) {
...
PlayLayer_doudizhuTongYong.prototype.dealDownAndPlayVoice = function (msg) {
...
PlayLayer_doudizhuTongYong.prototype.dealUploadRecord = function (filePath) {
    if (filePath) {
...
// 绘制手牌
PlayLayer_doudizhuTongYong.prototype.initUserHandUiDoudizhu = function (off) {
    var pl = getUIPlayer(off);
    if (pl == null) {
        return;
    }
...
//处理出牌,打牌动作
PlayLayer_doudizhuTongYong.prototype.dealPKPutcard = function (off, msg) {
    var sData = MjClient.data.sData;
    var tData = sData.tData;
...
PlayLayer_doudizhuTongYong.prototype.playAnimation = function (cards, off) {
    var pl = getUIPlayer(off);
    if (!pl) { return ; }
...
// 增加底牌
PlayLayer_doudizhuTongYong.prototype.addDiCardsToZhuang = function (zhuangOff) {
    var tData = MjClient.data.sData.tData;
...
// 处理准备字准备相关
PlayLayer_doudizhuTongYong.prototype.handleAboutReady = function (off, bAllReady) {
...
PlayLayer_doudizhuTongYong.prototype.startTimeClock = function (func) {
...
PlayLayer_doudizhuTongYong.prototype.killTimeClock = function () {
    MjClient.clockNode.getChildByName("number").stopAllActions();
    stopEffect(playTimeUpEff);
    playTimeUpEff = null;
};

PlayLayer_doudizhuTongYong.prototype.clockNumberUpdate = function (node, endFunc) {
    return arrowbkNumberUpdate(node, endFunc);
}

PlayLayer_doudizhuTongYong.prototype.checkRoomUiDelete = function () {
...
PlayLayer_doudizhuTongYong.prototype.showGps = function () {
...
// 地主的三张牌
PlayLayer_doudizhuTongYong.prototype.handleDoudizhuDiCards = function () {
...
PlayLayer_doudizhuTongYong.prototype.dealMJTick = function (eD) {
    for (var i = 0; i < this.headOffLen; i++) {
        var off = this.headOffArr[i];
        var pl = getUIPlayer(off);
        if (!pl) { continue ; }
...
PlayLayer_doudizhuTongYong.prototype.dealLogout = function () {
    if (MjClient.playui) {
...
PlayLayer_doudizhuTongYong.prototype.dealEndRoom = function (msg) {
...
PlayLayer_doudizhuTongYong.prototype.dealLeaveGame = function () {
    MjClient.playui.killTimeClock();
    MjClient.addHomeView();
    MjClient.playui.removeFromParent(true);
    delete MjClient.playui;
...
PlayLayer_doudizhuTongYong.prototype.dealLoadWxHead = function (eD) {
    for (var i = 0; i < this.headOffLen; i++) {
        var off = this.headOffArr[i];
...
PlayLayer_doudizhuTongYong.prototype.dealPlayVoice = function (msg) {
    for (var i = 0; i < this.headOffLen; i++) {
        var off = this.headOffArr[i];
...
PlayLayer_doudizhuTongYong.prototype.dealChangeGameBgEvent = function () {
...
PlayLayer_doudizhuTongYong.prototype.handlePlayerChange = function (action, uid) {
    if (!this.isSDataValid()) {
        return ;
    }
    var targetOff = -1;
...
PlayLayer_doudizhuTongYong.prototype.dealMoveHead = function () {
    var that = this;
    var fun1 = function () {
...
// =========================[[ 消息 ]] ===========================
// 加倍
PlayLayer_doudizhuTongYong.prototype.sendJiaBeiToServer = function (beishu) {
...
// 叫地主、不叫、叫分
PlayLayer_doudizhuTongYong.prototype.sendQiangdizhuToServer = function (bQiang) {
    MjClient.playui.setJingDianBtnVisible(false);
    MjClient.playui.setHuanLeBtnVisible(false);
    MjClient.gamenet.request("pkroom.handler.tableMsg", {
        cmd: "Qiangdizhu",
...
// 出牌
PlayLayer_doudizhuTongYong.prototype.sendPutCardsToServer = function () {
    if (this.isCardsSend) {
        return;
    }
    ;
...
// 准备-1， 提示过牌0， 不出 1
PlayLayer_doudizhuTongYong.prototype.sendPassToServer = function (isActivePass) {
    this.handCardsWgetArr[0].clearCardsUpStatus();
...
// =========================[[ 初始化 ]] ==========================
PlayLayer_doudizhuTongYong.prototype.initTagList = function () {
    this.btnTagList = {
        BtnPutCard: 1,
        BtnHimt: 2,
        BtnNoPut: 3,
...
PlayLayer_doudizhuTongYong.prototype.initData = function (isRoundEnd) {
    this.cardTipsArr = [];
    this.tipsIdx = 0;
...
PlayLayer_doudizhuTongYong.prototype.initOnce = function () {
    cc.log("=============initOnce=============");
    MjClient.playui.showRoundInfo();
...
PlayLayer_doudizhuTongYong.prototype.hideAllUI = function () {
...
PlayLayer_doudizhuTongYong.prototype.initUI = function () {
    ...
    if( MjClient.playui.isJD() && MjClient.getAppType() == MjClient.APP_TYPE.QXJSMJ ){
...
// 初始化节点
PlayLayer_doudizhuTongYong.prototype.initHeadWget = function () {
    this.headOffArr = [];
    this.headNode = {};
    this.AniMotion = [];
...
PlayLayer_doudizhuTongYong.prototype.newHeadAndCardsNode = function (off, cardScale) {
    var classCard = MjClient.getAppType() == MjClient.APP_TYPE.QXJSMJ ? PokerCardNode_Doudizhu : PokerCardNode_DoudizhuSpecial;
    if (MjClient.getAppType() == MjClient.APP_TYPE.QXJSMJ) {
...
//初始化玩家信息
PlayLayer_doudizhuTongYong.prototype.initMsgEvent = function () {
    // ================ 重连 =========================
    ...
    UIEventBind(null, this.node, "mjhand", function (eD) {
        if (MjClient.rePlayVideo != -1 && (MjClient.getAppType() == MjClient.APP_TYPE.HUNANWANGWANG || 
            MjClient.getAppType() == MjClient.APP_TYPE.QXSYDTZ || MjClient.getAppType() == MjClient.APP_TYPE.QXJSMJ)) {
...
PlayLayer_doudizhuTongYong.prototype.initClickEvent = function () {
...
PlayLayer_doudizhuTongYong.prototype.btnBindCallBack = function (parent, str, tag, callback) {
    var tmpNode = parent.getChildByName(str);
    tmpNode.tag = tag;
    tmpNode.addTouchEventListener(callback);
};

PlayLayer_doudizhuTongYong.prototype.btnEventListener = function (sender, type) {
    ...
    if (tag == this.btnTagList.BtnPutCard) { // 出牌
        ...
        var _default = (MjClient.playui.isJD() && MjClient.getAppType() == MjClient.APP_TYPE.QXJSMJ) ? -1 : 0;
...
// 初始化时钟节点
PlayLayer_doudizhuTongYong.prototype.initClockWget = function () {
    for (var off = 0; off < 4; off++) {
        var _node = getNode(off);
...
PlayLayer_doudizhuTongYong.prototype.isSDataValid = function() {
    var sData = MjClient.data.sData;
