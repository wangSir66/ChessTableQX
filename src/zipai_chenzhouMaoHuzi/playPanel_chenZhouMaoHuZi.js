// 郴州字牌
var playLayer_chenZhouMaoHuZi;
(function() {
    playLayer_chenZhouMaoHuZi = playLayer_ziPai.extend({
        getJsBind: function(){
            var jsBind = {
                text_roundInfo: {
                    _run: function () {
                ...
                btn_putCrad:{
                    ...
                    _run:function () {
                        if(MjClient.data.sData.tData.maxPlayer == 4){
                            ...
                            setWgtLayout(this, [0.185, 0.143], [0.75, isIPhoneX() ? 0.6 : 0.5], [0, 0], true)
                        }
                    },
                    _click: function() {
                ...
                img_banner:{
                    btn_setting: {
                        _click: function() {
                            cc.log("btn_setting");
                            MjClient.Scene.addChild(new setting_chenZhouMaoHuZi(), 6000);
        ...
        ctor: function() {
            this._super("Play_ZiPaiChenZhouMaoHuZi.json");
            if(MjClient.getAppType() == MjClient.APP_TYPE.YLHUNANMJ || MjClient.getAppType() == MjClient.APP_TYPE.QXYYQP){
...
playLayer_chenZhouMaoHuZi.prototype.initSettingData = function() {
...
//Override
playLayer_chenZhouMaoHuZi.prototype.createGameOverLayer = function(type) {
    return new GameOverLayer_chenZhouMaoHuZi();
};

//Override
playLayer_chenZhouMaoHuZi.prototype.createEndOneLayer = function(type) {
    return new EndOneView_chenZhouMaoHuZi();
};

//Override
playLayer_chenZhouMaoHuZi.prototype.getGameBgList = function() {
    return ["playing/anhuapaohuzi/bg/beijing_1.jpg", "playing/anhuapaohuzi/bg/beijing_2.jpg", "playing/anhuapaohuzi/bg/beijing_3.jpg"];
};

//Override
playLayer_chenZhouMaoHuZi.prototype.getGameBgIdx = function() {
    return util.localStorageEncrypt.getNumberItem(MjClient.KEY_ZI_PAI_GAME_BG_TYPE, 2);
};

//布局类型
playLayer_chenZhouMaoHuZi.prototype.getLayoutType = function() {
    return util.localStorageEncrypt.getNumberItem(MjClient.KEY_ZI_PAI_PLAY_UI_LAYOUT, 0);
};

playLayer_chenZhouMaoHuZi.prototype.getHuXiType = function() {
    return util.localStorageEncrypt.getNumberItem(MjClient.KEY_ZI_PAI_HU_XI_TYPE, 0);
};

//Override
playLayer_chenZhouMaoHuZi.prototype.setCardTouchHandler = function(card,off){
    var self = this;
...
playLayer_chenZhouMaoHuZi.prototype.changeEatBtnLayout = function(btnNode, len, idx) {
    setWgtLayout(btnNode, [0, 0.20], [0.88 - (len - 1 - idx) * 0.12, 0.11], [ 0, 1.8], false, false);
};

//出牌按钮
playLayer_chenZhouMaoHuZi.prototype.checkPutCardBtnVisible = function(node) {
...
//飘分
playLayer_chenZhouMaoHuZi.prototype.paioFenToServer = function(index) {
    var tData = MjClient.data.sData.tData;
...
//Override
playLayer_chenZhouMaoHuZi.prototype.isShowLongCard = function(){
    return true;
}

//飘风操作的提示显示
playLayer_chenZhouMaoHuZi.prototype.setChuiTips = function(node) {
    node.visible = false;
    var tData = MjClient.data.sData.tData;
...
//显示飘风按钮
playLayer_chenZhouMaoHuZi.prototype.showPiaoBtns = function(node) {
    node.visible = false;
    var tData = MjClient.data.sData.tData;
...
//Override
playLayer_chenZhouMaoHuZi.prototype.checkChuiFlagVisible = function(node) {
    node.visible = false;
    var tData = MjClient.data.sData.tData;
    var off = this.getUIOffByNode(node);
    var pl = this.getUIPlayer(off);
...
playLayer_chenZhouMaoHuZi.prototype.getInitDiPaiCount = function() {
    var tData = MjClient.data.sData.tData;
    return MjClient.majiang.getAllCardsTotal() -  tData.maxPlayer * 14;
};

//Override
playLayer_chenZhouMaoHuZi.prototype.doSelectEatAction = function(arr, isScale) {
    if (!arr || arr.length == 0) {
        return;
    }
    var gap = 5;
...
playLayer_chenZhouMaoHuZi.prototype.getResType = function () {
    return 0;
};

playLayer_chenZhouMaoHuZi.prototype.isCheckTingStats = function() {
    return true;
}

playLayer_chenZhouMaoHuZi.prototype.getTingStats = function(putCard) {
    var sData = MjClient.data.sData;
    var pl = sData.players[SelfUid()];
    return MjClient.majiang.getTingStats(sData, pl, putCard);
}

playLayer_chenZhouMaoHuZi.prototype.isPutCardLayout = function() {
    return true;
}