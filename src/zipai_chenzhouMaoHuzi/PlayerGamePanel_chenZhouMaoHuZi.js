...
function SetUserVisible_chenZhouMaoHuZi(node, off){
    ...
    if(pl){
        ...
        setUserOffline_chenZhouMaoHuZi(node, off);
...
function InitUserHandUI_chenZhouMaoHuZi(node, off){
    ...
    if (pl.jiazhuNum == 2 && MjClient.rePlayVideo == -1)
    {
        ...
        MjClient.majiang.setJiaZhuNum(node, getUIPlayer_chenZhouMaoHuZi(off));
    }
...
var PlayLayer_chenZhouMaoHuZi = cc.Layer.extend({
    jsBind: {
        _event: {
            ...
            endRoom: function(msg) {
                ...
                if (msg.showEnd){
                    this.addChild(new GameOverLayer_chenZhouMaoHuZi(),500);
                }else{
            ...
            roundEnd: function() {
                ...
                if(!MjClient.isDismiss && tData.hunCard && tData.hunCard != -1 && tData.areaSelectMode.xingType==2){
                    ...
                    ShowEatActionAnim_chenZhouMaoHuZi(MjClient.playui._downNode, ActionType_paohuzi.FANXING, 0);
                    DealFanXingNewCard_chenZhouMaoHuZi(hunCard);
                }
                ...
                function delayExe(){
                    ...
                    if (sData.tData.roundNum <= 0){
                        var layer = new GameOverLayer_chenZhouMaoHuZi();
                        layer.setVisible(false);
                        self.addChild(layer,500);
                    }
                    if(!MjClient.endoneui){
                        self.addChild(new EndOneView_chenZhouMaoHuZi(),500);
                    }
            ...
            moveHead: function() {
                ...
                //tableStartHeadMoveAction_chenZhouMaoHuZi(this);   //不涉及到头像移动动作
            },
            initSceneData: function() {
                ...
                reConectHeadLayout_chenZhouMaoHuZi(this);        //不涉及到头像移动动作
                CheckRoomUiDelete();
                tableStartHeadMoveAction_chenZhouMaoHuZi(this);   //不涉及到头像移动动作
            ...
            changeMJBgEvent: function() {
                changeMJBg_chenZhouMaoHuZi(this, ziPai.getZiPaiType());
            },
            MJPeng: function() {
                MjClient.playui.showAndHideHeadEffect();
            },
            ...
            EZP_layout : function(){
                if(MjClient.data.sData.tData.maxPlayer < 4){
                    ...
                    if(IsArrowVisible_chenZhouMaoHuZi()){
        ...
        cardNumImg: {
            ...
            _event: {
                initSceneData: function(eD) {
                    var sData = MjClient.data.sData;
                    var tData = sData.tData;
                    this.visible = IsArrowVisible_chenZhouMaoHuZi() && TableState.waitJiazhu != tData.tState;
                },
                mjhand: function(eD) {
                    var sData = MjClient.data.sData;
                    var tData = sData.tData;
        ...
        roundInfo:{
            ...
            _run:function(){
                ...
                if (tData.areaSelectMode.difen > 0){
                    infos.push("积分底分" + tData.areaSelectMode.difen);
                }
        ...
        banner: {
            ...
            _run: function() {
                    ...
                    if (MjClient.MaxPlayerNum_chenZhouMaoHuZi == 2){
            ...
            getRoomNum: {
                ...
                _click: function() {
                    ...
                    var sData = MjClient.data.sData;
                    var str7 = " ";
                    if (Object.keys(sData.players).length > 0 && MjClient.MaxPlayerNum_chenZhouMaoHuZi > Object.keys(sData.players).length){
                        str7 += ["一","二","三"][Object.keys(sData.players).length - 1] + "缺" + ["一","二","三"][MjClient.MaxPlayerNum_chenZhouMaoHuZi - Object.keys(sData.players).length - 1];
                    }
            ...
            gps_btn: {
                ...
                _click: function() {
                    if(MjClient.MaxPlayerNum_chenZhouMaoHuZi == 3){
                        MjClient.Scene.addChild(new showDistance3PlayerLayer());
                    }else if(MjClient.MaxPlayerNum_chenZhouMaoHuZi == 4){
            ...
            roundnumImg: {
                ...
                _event: {
                    initSceneData: function(eD) {
                        this.visible = IsArrowVisible_chenZhouMaoHuZi();
                    },
                    mjhand: function(eD) {
                        this.visible = IsArrowVisible_chenZhouMaoHuZi();
                    },
        ...
        wait: {
            ...
            backHomebtn: {
                ...
                _event: {
                    ...
                    initSceneData: function(eD) {
                        this.visible = isShowBackBtn_chenZhouMaoHuZi();
                    },
                    removePlayer: function(eD) {
                        this.visible = isShowBackBtn_chenZhouMaoHuZi();
                    },
        ...
        btns_piao:{
            ...
            btn_piao0: {
                _click:function() {
                    var pl = getUIPlayer_chenZhouMaoHuZi(0);
                    pl.piaoFen = -1;
                    paioFenToServer_chenZhouMaoHuZi(0);
                },
            },
            btn_piao1: {
                _click:function() {
                    var pl = getUIPlayer_chenZhouMaoHuZi(0);
                    pl.piaoFen = -1;
                    paioFenToServer_chenZhouMaoHuZi(1);
                },
            },
            btn_piao2: {
                _click:function() {
                    var pl = getUIPlayer_chenZhouMaoHuZi(0);
                    pl.piaoFen = -1;
                    paioFenToServer_chenZhouMaoHuZi(2);
                },
            },
            btn_piao3: {
                _click:function() {
                    var pl = getUIPlayer_chenZhouMaoHuZi(0);
                    pl.piaoFen = -1;
                    paioFenToServer_chenZhouMaoHuZi(3);
                },
            },
    },
        BtnReady:{
        ...
        down: {
            head: {
                chuizi_tips : {
                    _run: function(){
                        setJiachuiImgTips_chenZhouMaoHuZi(this, 0);
                    },
                    _event: {
                        initSceneData: function() {
                            setJiachuiImgTips_chenZhouMaoHuZi(this, 0);
                ...
                jiachuiText_tips : {
                    _run: function() {
                        setJiachuiTextTips_chenZhouMaoHuZi(this, 0);
                    },
                    _event:{
                        initSceneData: function() {
                            setJiachuiTextTips_chenZhouMaoHuZi(this, 0);
                ...
                zhuang: {
                    ...
                    _event: {
                        waitPut: function(){
                            showUserZhuangLogo_chenZhouMaoHuZi(this, 0);
                        },
                        initSceneData: function(){
                            if (IsArrowVisible_chenZhouMaoHuZi()) showUserZhuangLogo_chenZhouMaoHuZi(this, 0);
                        },
                        mjhand: function(){
                            if (IsArrowVisible_chenZhouMaoHuZi()) showUserZhuangLogo_chenZhouMaoHuZi(this, 0);
                        }
                    ...
                    chattext: {
                        _event: {
                            ...
                            MJChat: function(msg) {
                                ...
                                showUserChat_chenZhouMaoHuZi(this, 0, msg);
                            },
                            playVoice: function(voicePath) {
                                MjClient.data._tempMessage.msg = voicePath;
                                showUserChat_chenZhouMaoHuZi(this, 0, MjClient.data._tempMessage);
                            }
                        }
                    }
                },
                _click: function(btn) {
                    showPlayerInfo_chenZhouMaoHuZi(0, btn);
                },
                _event: {
                    loadWxHead: function(d) {
                        setWxHead_chenZhouMaoHuZi(this, d, 0);
                    },
                    addPlayer: function(eD) {
                        showFangzhuTagIcon_chenZhouMaoHuZi(this,0);
                    },
                    removePlayer: function(eD) {
                        showFangzhuTagIcon_chenZhouMaoHuZi(this,0);
                    }
                ...
                huxi:{
                    ...
                    _event:{
                        ...
                        initSceneData:function(){
                            this.visible = true;
                            var huXi = UpdateHuXi_chenZhouMaoHuZi(0);
                            if(!IsArrowVisible_chenZhouMaoHuZi()){
                                huXi = 0;
                                this.visible = false;
                            }
                ...
                timeImg:{
                    ...
                    // _event:{
                    //     initSceneData: function(eD) {
                    //         this.visible = curPlayerIsMe_chenZhouMaoHuZi(0);
                    //     },
                    //     mjhand: function(eD) {
                    //         this.visible = curPlayerIsMe_chenZhouMaoHuZi(0);
                    //     },
                    //     onlinePlayer: function(eD) {
                    //         this.visible = curPlayerIsMe_chenZhouMaoHuZi(0) && IsArrowVisible_chenZhouMaoHuZi();
                    //     },
                    //     waitPut: function(eD) {
                    //         this.visible = curPlayerIsMe_chenZhouMaoHuZi(0);
                    //     },
                    ...
                    //             stopEffect(playTimeUpEff);
                    //             playTimeUpEff = null;
                    //             if(curPlayerIsMe_chenZhouMaoHuZi(0)){
                    ...
                    //             playTimeUpEff = null;
                    //             var pl = getUIPlayer_chenZhouMaoHuZi(0);
                    //             if(pl && pl.onLine && curPlayerIsMe_chenZhouMaoHuZi(0)){
                    //                 arrowbkNumberUpdate(this);
                    //             }
                    //         },
                    //         roundEnd: function() {
            ...
            ready: {
                ...
                _run: function() {
                    GetReadyVisible_chenZhouMaoHuZi(this, 0);
                },
                _event: {
                    startShuffleCards:function (d) {
                        GetReadyVisible_chenZhouMaoHuZi(this, -1);
                    },
                    moveHead: function() {
                        GetReadyVisible_chenZhouMaoHuZi(this, -1);
                    },
                    ...
                    addPlayer: function() {
                        GetReadyVisible_chenZhouMaoHuZi(this, 0);//根据状态设置ready 是否可见 add by sking
                    },
                    removePlayer: function() {
                        GetReadyVisible_chenZhouMaoHuZi(this, 0);
                    },
            ...
            handNode: {
                ...
                _event:  {
                    initSceneData: function() {
                        calculateHintPutList_chenZhouMaoHuZi();
                    },
                    HZPickCard: function() {
                        calculateHintPutList_chenZhouMaoHuZi();
                    },
                    ...
                    MJPass: function() { // 天胡 提 偎 跑后过胡
                        calculateHintPutList_chenZhouMaoHuZi();
                        addTingSign_chenZhouMaoHuZi(MjClient.playui._downNode);
                    },
            ...
            _event: {
                clearCardUI: function() {
                    clearCardUI_chenZhouMaoHuZi(this, 0);
                },
                ...
                initSceneData: function(eD) {
                    SetUserVisible_chenZhouMaoHuZi(this, 0);
                    InitUserHandUI_chenZhouMaoHuZi(this, 0);
                    InitUserCoinAndName_chenZhouMaoHuZi(this, 0);
                    MjClient.hasPut = false; // 重连回来重置打掉牌标志（打牌时候断线)
                    ShowPutCardIcon_chenZhouMaoHuZi();
                    DealOffLineCard_chenZhouMaoHuZi(this,0);
                },
                addPlayer: function(eD) {
                    SetUserVisible_chenZhouMaoHuZi(this, 0);
                    InitUserCoinAndName_chenZhouMaoHuZi(this, 0);
                ...
                mjhand: function(eD) {
                    ...
                    var uid = getUIPlayer_chenZhouMaoHuZi(0).info.uid;
                    // if (eD.jiazhuNums)
                    // {
                ...
                HZNewCard: function(eD) {
                    ...
                    DealNewCard_chenZhouMaoHuZi(this,eD,0);
                },
                MJPut: function(eD) {
                    DealPutCard_chenZhouMaoHuZi(this,eD,0);
                },
                HZChiCard: function(eD) {
                    DealChiCard_chenZhouMaoHuZi(this, eD, 0);
                },
                HZWeiCard: function(eD){
                    DealWeiCard_chenZhouMaoHuZi(this,eD,0);
                },
                HZGangCard: function(eD) {
                    DealGangCard_chenZhouMaoHuZi(this, eD, 0);
                },
                MJPeng: function(eD) {
                    DealPengCard_chenZhouMaoHuZi(this, eD, 0);
                },
                MJHu: function(eD) {
                    DealHu_chenZhouMaoHuZi(this, eD, 0);
                },
                onlinePlayer: function(eD) {
                    resetHandAfterBegin_chenZhouMaoHuZi();
                    setUserOffline_chenZhouMaoHuZi(this, 0);
                },
                ...
                MJJiazhu: function(msg) {
                    ...
                    MjClient.majiang.setJiaZhuNum(MjClient.playui._downNode, getUIPlayer_chenZhouMaoHuZi(0));
                    MjClient.majiang.setJiaZhuNum(MjClient.playui._rightNode, getUIPlayer_chenZhouMaoHuZi(1));
                    MjClient.majiang.setJiaZhuNum(MjClient.playui._topNode, getUIPlayer_chenZhouMaoHuZi(2));
                },
                HZPickCard:function (eD) {
                    ...
                    DealShowLastCard_chenZhouMaoHuZi(this, eD, 0);
                },
                HZAddCards:function (eD) {
                    DealAddCard_chenZhouMaoHuZi(this,eD, 0);
                },
        ...
        right: {
            head: {
                chuizi_tips : {
                    _run: function(){
                        setJiachuiImgTips_chenZhouMaoHuZi(this, changeUIOff_chenZhouMaoHuZi(2));
                    },
                    _event: {
                        initSceneData: function() {
                            setJiachuiImgTips_chenZhouMaoHuZi(this, changeUIOff_chenZhouMaoHuZi(2));
                ...
                jiachuiText_tips : {
                    _run:function() {
                        setJiachuiTextTips_chenZhouMaoHuZi(this, changeUIOff_chenZhouMaoHuZi(2));
                    },
                    _event:{
                        initSceneData: function() {
                            setJiachuiTextTips_chenZhouMaoHuZi(this, changeUIOff_chenZhouMaoHuZi(2));
                        ...
                        MJJiazhu: function(msg) {
                            var pl = getUIPlayer_chenZhouMaoHuZi(changeUIOff_chenZhouMaoHuZi(2))
                            if (msg.uid == pl.info.uid) {
                                setJiachuiTextTips_chenZhouMaoHuZi(this, changeUIOff_chenZhouMaoHuZi(2));
                            }
                        },
                ...
                zhuang: {
                    ...
                    _event: {
                        waitPut: function() {
                            showUserZhuangLogo_chenZhouMaoHuZi(this, changeUIOff_chenZhouMaoHuZi(2));
                        },
                        initSceneData: function() {
                            if (IsArrowVisible_chenZhouMaoHuZi()) showUserZhuangLogo_chenZhouMaoHuZi(this, changeUIOff_chenZhouMaoHuZi(2));
                        },
                        mjhand: function(){
                            if (IsArrowVisible_chenZhouMaoHuZi()) showUserZhuangLogo_chenZhouMaoHuZi(this, changeUIOff_chenZhouMaoHuZi(2));
                        }
                ...
                chatbg: {
                    ...
                    chattext: {
                        _event: {
                            MJChat: function(msg) {
                                showUserChat_chenZhouMaoHuZi(this, changeUIOff_chenZhouMaoHuZi(2), msg);
                            },
                            playVoice: function(voicePath) {
                                MjClient.data._tempMessage.msg = voicePath;
                                showUserChat_chenZhouMaoHuZi(this, changeUIOff_chenZhouMaoHuZi(2), MjClient.data._tempMessage);
                            }
                        }
                    }
                },
                _click: function(btn) {
                    showPlayerInfo_chenZhouMaoHuZi(changeUIOff_chenZhouMaoHuZi(2), btn);
                },
                _event: {
                    loadWxHead: function(d) {
                        setWxHead_chenZhouMaoHuZi(this, d, changeUIOff_chenZhouMaoHuZi(2));
                    },
                    addPlayer: function(eD) {
                        showFangzhuTagIcon_chenZhouMaoHuZi(this,changeUIOff_chenZhouMaoHuZi(2));
                    },
                    removePlayer: function(eD) {
                        showFangzhuTagIcon_chenZhouMaoHuZi(this,changeUIOff_chenZhouMaoHuZi(2));
                    }
                ...
                huxi:{
                    ...
                    _event:{
                        ...
                        initSceneData:function(){
                            this.visible = true;
                            var huXi = UpdateHuXi_chenZhouMaoHuZi(changeUIOff_chenZhouMaoHuZi(2));
                            if(!IsArrowVisible_chenZhouMaoHuZi()){
                                huXi = 0;
                                this.visible = false;
                            }
                ...
                timeImg:{
                    ...
                    // _event:{
                    //     initSceneData: function(eD) {
                    //         this.visible = curPlayerIsMe_chenZhouMaoHuZi(1);
                    //     },
                    //     mjhand: function(eD) {
                    //         this.visible = curPlayerIsMe_chenZhouMaoHuZi(1);
                    //     },
                    //     onlinePlayer: function(eD) {
                    //         this.visible = curPlayerIsMe_chenZhouMaoHuZi(1) && IsArrowVisible_chenZhouMaoHuZi();
                    //     },
                    //     waitPut: function(eD) {
                    //         this.visible = curPlayerIsMe_chenZhouMaoHuZi(1);
                    //     },
                    ...
                    //             stopEffect(playTimeUpEff);
                    //             playTimeUpEff = null;
                    //             if(curPlayerIsMe_chenZhouMaoHuZi(1)){
                    //                 arrowbkNumberUpdate(this);
                    //                 this.setString("00");
                    //             }
                    //         },
                    ...
                    //             stopEffect(playTimeUpEff);
                    //             playTimeUpEff = null;
                    //             var pl = getUIPlayer_chenZhouMaoHuZi(1);
                    //             if(pl && pl.onLine && curPlayerIsMe_chenZhouMaoHuZi(1)){
                    //                 arrowbkNumberUpdate(this);
                    //             }
                    //         },
                    //         roundEnd: function() {
            ...
            ready: {
                _layout: [[0.07, 0.07],[0.5, 0.5],[2.5, 2.5]],
                _run: function() {
                    GetReadyVisible_chenZhouMaoHuZi(this, changeUIOff_chenZhouMaoHuZi(2));
                },
                _event: {
                    startShuffleCards:function (d) {
                        GetReadyVisible_chenZhouMaoHuZi(this, -1);
            ...
            _event: {
                clearCardUI: function() {
                    clearCardUI_chenZhouMaoHuZi(this, changeUIOff_chenZhouMaoHuZi(2));
                },
                clearCardArr: function(){
                    var eatNode = this.getChildByName("eatNode");
                    eatNode.removeAllChildren();
                ...
                initSceneData: function(eD) {
                    SetUserVisible_chenZhouMaoHuZi(this, changeUIOff_chenZhouMaoHuZi(2));
                    InitUserHandUI_chenZhouMaoHuZi(this, changeUIOff_chenZhouMaoHuZi(2));
                    InitUserCoinAndName_chenZhouMaoHuZi(this, changeUIOff_chenZhouMaoHuZi(2));
                    DealOffLineCard_chenZhouMaoHuZi(this,changeUIOff_chenZhouMaoHuZi(2));
                },
                addPlayer: function(eD) {
                    SetUserVisible_chenZhouMaoHuZi(this, changeUIOff_chenZhouMaoHuZi(2));
                    InitUserCoinAndName_chenZhouMaoHuZi(this, changeUIOff_chenZhouMaoHuZi(2));
                ...
                HZNewCard: function(eD) {
                    ...
                    DealNewCard_chenZhouMaoHuZi(this,eD,changeUIOff_chenZhouMaoHuZi(2));
                },
                roundEnd: function() {
                    InitUserCoinAndName_chenZhouMaoHuZi(this, changeUIOff_chenZhouMaoHuZi(2));
                    MjClient.playui.ResetOtherCard(this, changeUIOff_chenZhouMaoHuZi(2));
                },
                waitPut: function(eD) {
                    DealWaitPut(this, eD, 1);
                },
                MJPut: function(eD) {
                    DealPutCard_chenZhouMaoHuZi(this, eD, changeUIOff_chenZhouMaoHuZi(2));
                },
                HZChiCard: function(eD) {
                    DealChiCard_chenZhouMaoHuZi(this, eD, changeUIOff_chenZhouMaoHuZi(2));
                },
                HZGangCard: function(eD) {
                    DealGangCard_chenZhouMaoHuZi(this, eD, changeUIOff_chenZhouMaoHuZi(2));
                },
                MJPeng: function(eD) {
                    DealPengCard_chenZhouMaoHuZi(this, eD, changeUIOff_chenZhouMaoHuZi(2));
                },
                HZWeiCard: function(eD){
                    DealWeiCard_chenZhouMaoHuZi(this, eD, changeUIOff_chenZhouMaoHuZi(2));
                },
                MJHu: function(eD) {
                    DealHu_chenZhouMaoHuZi(this, eD, changeUIOff_chenZhouMaoHuZi(2));
                },
                onlinePlayer: function(eD) {
                    setUserOffline_chenZhouMaoHuZi(this, changeUIOff_chenZhouMaoHuZi(2));
                },
                playerStatusChange: function(eD) {
                    setUserOffline_chenZhouMaoHuZi(this, changeUIOff_chenZhouMaoHuZi(2));
                },
                MJFlower: function(eD) {
                    HandleMJFlower(this, eD, changeUIOff_chenZhouMaoHuZi(2));
                },
                MJTing: function (eD) {
                    HandleMJTing(this, eD, changeUIOff_chenZhouMaoHuZi(2));
                },
                HZPickCard:function (eD) {
                    if(MjClient.rePlayVideo != -1){
                        MjClient.playui._doPickResetHandCardForPlayBack(eD, changeUIOff_chenZhouMaoHuZi(2));
                    }

                    // RemovePutCardOut_chenZhouMaoHuZi(true);
                    // MjClient.playui.ResetHandCard(this,1);

                    DealShowLastCard_chenZhouMaoHuZi(this, eD, changeUIOff_chenZhouMaoHuZi(2));
                },
                HZAddCards:function (eD) {
                    DealAddCard_chenZhouMaoHuZi(this,eD, changeUIOff_chenZhouMaoHuZi(2));
                },
                HZCheckRaise:function (msg) {
                    ShowPutCardIcon_chenZhouMaoHuZi();
                    //MjClient.playui.EatVisibleCheck();
        ...
        left: {
            head: {
                chuizi_tips : {
                    _run: function(){
                        setJiachuiImgTips_chenZhouMaoHuZi(this, changeUIOff_chenZhouMaoHuZi(3));
                    },
                    _event: {
                        initSceneData: function() {
                            setJiachuiImgTips_chenZhouMaoHuZi(this, changeUIOff_chenZhouMaoHuZi(3));
                ...
                jiachuiText_tips : {
                    _visible:false,
                    _run:function() {
                        setJiachuiTextTips_chenZhouMaoHuZi(this, changeUIOff_chenZhouMaoHuZi(3));
                    },
                    _event:{
                        initSceneData: function() {
                            setJiachuiTextTips_chenZhouMaoHuZi(this, changeUIOff_chenZhouMaoHuZi(3));
                        ...
                        MJJiazhu: function(msg) {
                            var pl = getUIPlayer_chenZhouMaoHuZi(changeUIOff_chenZhouMaoHuZi(3))
                            if (msg.uid == pl.info.uid) {
                                setJiachuiTextTips_chenZhouMaoHuZi(this, changeUIOff_chenZhouMaoHuZi(3));
                            }
                        },
                ...
                zhuang: {
                    ...
                    _event: {
                        waitPut: function() {
                            showUserZhuangLogo_chenZhouMaoHuZi(this, changeUIOff_chenZhouMaoHuZi(3));
                        },
                        initSceneData: function() {
                            if (IsArrowVisible_chenZhouMaoHuZi()) showUserZhuangLogo_chenZhouMaoHuZi(this, changeUIOff_chenZhouMaoHuZi(3));
                        },
                        mjhand: function(){
                            if (IsArrowVisible_chenZhouMaoHuZi()) showUserZhuangLogo_chenZhouMaoHuZi(this, changeUIOff_chenZhouMaoHuZi(3));
                        }
                ...
                chatbg: {
                    ...
                    chattext: {
                        _event: {
                            MJChat: function(msg) {
                                showUserChat_chenZhouMaoHuZi(this, changeUIOff_chenZhouMaoHuZi(3), msg);
                            },
                            playVoice: function(voicePath) {
                                MjClient.data._tempMessage.msg = voicePath;
                                showUserChat_chenZhouMaoHuZi(this, changeUIOff_chenZhouMaoHuZi(3), MjClient.data._tempMessage);
                            }
                        }
                    }
                },
                _click: function(btn) {
                    showPlayerInfo_chenZhouMaoHuZi(changeUIOff_chenZhouMaoHuZi(3), btn);
                },
                _event: {
                    loadWxHead: function(d) {
                        setWxHead_chenZhouMaoHuZi(this, d, changeUIOff_chenZhouMaoHuZi(3));
                    },
                    addPlayer: function(eD) {
                        showFangzhuTagIcon_chenZhouMaoHuZi(this,changeUIOff_chenZhouMaoHuZi(3));
                    },
                    removePlayer: function(eD) {
                        showFangzhuTagIcon_chenZhouMaoHuZi(this,changeUIOff_chenZhouMaoHuZi(3));
                    }
                ...
                huxi:{
                    ...
                    _event:{
                        ...
                        initSceneData:function(){
                            this.visible = true;
                            var huXi = UpdateHuXi_chenZhouMaoHuZi(changeUIOff_chenZhouMaoHuZi(3));
                            if(!IsArrowVisible_chenZhouMaoHuZi()){
                                huXi = 0;
                                this.visible = false;
                            }
                ...
                timeImg:{
                    ...
                    // _event:{
                    //     initSceneData: function(eD) {
                    //         this.visible = curPlayerIsMe_chenZhouMaoHuZi(2);
                    //     },
                    //     mjhand: function(eD) {
                    //         this.visible = curPlayerIsMe_chenZhouMaoHuZi(2);
                    //     },
                    //     onlinePlayer: function(eD) {
                    //         this.visible = curPlayerIsMe_chenZhouMaoHuZi(2) && IsArrowVisible_chenZhouMaoHuZi();
                    //     },
                    //     waitPut: function(eD) {
                    //         this.visible = curPlayerIsMe_chenZhouMaoHuZi(2);
                    //     },
                    ...
                    //             stopEffect(playTimeUpEff);
                    //             playTimeUpEff = null;
                    //             if(curPlayerIsMe_chenZhouMaoHuZi(2)){
                    //                 arrowbkNumberUpdate(this);
                    //                 this.setString("00");
                    //             }
                    //         },
                    ...
                    //             stopEffect(playTimeUpEff);
                    //             playTimeUpEff = null;
                    //             var pl = getUIPlayer_chenZhouMaoHuZi(2);
                    //             if(pl && pl.onLine && curPlayerIsMe_chenZhouMaoHuZi(2)){
                    //                 arrowbkNumberUpdate(this);
                    //             }
                    //         },
                    //         roundEnd: function() {
            ...
            ready: {
                _layout: [[0.07, 0.07],[0.5, 0.5],[-2.5, 2.5]],
                _run: function() {
                    GetReadyVisible_chenZhouMaoHuZi(this, changeUIOff_chenZhouMaoHuZi(3));
                },
                _event: {
                    startShuffleCards:function (d) {
                        GetReadyVisible_chenZhouMaoHuZi(this, -1);
            ...
            _event: {
                clearCardUI: function() {
                    clearCardUI_chenZhouMaoHuZi(this, changeUIOff_chenZhouMaoHuZi(3));
                },
                clearCardArr: function(){
                    var eatNode = this.getChildByName("eatNode");
                    eatNode.removeAllChildren();
                ...
                initSceneData: function(eD) {
                    SetUserVisible_chenZhouMaoHuZi(this, changeUIOff_chenZhouMaoHuZi(3));
                    InitUserHandUI_chenZhouMaoHuZi(this, changeUIOff_chenZhouMaoHuZi(3));
                    InitUserCoinAndName_chenZhouMaoHuZi(this, changeUIOff_chenZhouMaoHuZi(3));
                    DealOffLineCard_chenZhouMaoHuZi(this,changeUIOff_chenZhouMaoHuZi(3));
                },
                addPlayer: function(eD) {
                    SetUserVisible_chenZhouMaoHuZi(this, changeUIOff_chenZhouMaoHuZi(3));
                    InitUserCoinAndName_chenZhouMaoHuZi(this, changeUIOff_chenZhouMaoHuZi(3));
                ...
                HZNewCard: function(eD) {
                    ...
                    DealNewCard_chenZhouMaoHuZi(this,eD,changeUIOff_chenZhouMaoHuZi(3));
                },
                roundEnd: function() {
                    InitUserCoinAndName_chenZhouMaoHuZi(this,changeUIOff_chenZhouMaoHuZi(3));
                    MjClient.playui.ResetOtherCard(this, changeUIOff_chenZhouMaoHuZi(3));
                },
                waitPut: function(eD) {
                    DealWaitPut(this, eD, changeUIOff_chenZhouMaoHuZi(3));
                },
                MJPut: function(eD) {
                    DealPutCard_chenZhouMaoHuZi(this, eD, changeUIOff_chenZhouMaoHuZi(3));
                },
                HZChiCard: function(eD) {
                    DealChiCard_chenZhouMaoHuZi(this, eD, changeUIOff_chenZhouMaoHuZi(3));
                },
                HZGangCard: function(eD) {
                    DealGangCard_chenZhouMaoHuZi(this, eD, changeUIOff_chenZhouMaoHuZi(3));
                },
                MJPeng: function(eD) {
                    DealPengCard_chenZhouMaoHuZi(this, eD, changeUIOff_chenZhouMaoHuZi(3));
                },
                HZWeiCard: function(eD){
                    DealWeiCard_chenZhouMaoHuZi(this, eD, changeUIOff_chenZhouMaoHuZi(3));
                },
                MJHu: function(eD) {
                    DealHu_chenZhouMaoHuZi(this, eD, changeUIOff_chenZhouMaoHuZi(3));
                },
                onlinePlayer: function(eD) {
                    setUserOffline_chenZhouMaoHuZi(this, changeUIOff_chenZhouMaoHuZi(3));
                },
                playerStatusChange: function(eD) {
                    setUserOffline_chenZhouMaoHuZi(this, changeUIOff_chenZhouMaoHuZi(3));
                },
                MJFlower: function(eD) {
                    HandleMJFlower(this, eD, changeUIOff_chenZhouMaoHuZi(3));
                },
                MJTing: function (eD) {
                    HandleMJTing(this, eD, changeUIOff_chenZhouMaoHuZi(3));
                },
                HZPickCard:function (eD) {
                    if(MjClient.rePlayVideo != -1) {
                        MjClient.playui._doPickResetHandCardForPlayBack(eD, changeUIOff_chenZhouMaoHuZi(3));
                    }
                    // RemovePutCardOut_chenZhouMaoHuZi(true);
                    // MjClient.playui.ResetHandCard(this,2);

                    DealShowLastCard_chenZhouMaoHuZi(this, eD, changeUIOff_chenZhouMaoHuZi(3));
                },
                HZAddCards:function (eD) {
                    DealAddCard_chenZhouMaoHuZi(this,eD, changeUIOff_chenZhouMaoHuZi(3));
                },
                HZCheckRaise:function (msg) {
                    ShowPutCardIcon_chenZhouMaoHuZi();
                    //MjClient.playui.EatVisibleCheck();
        ...
        xing: {
            _run:function () {
                if(MjClient.MaxPlayerNum_chenZhouMaoHuZi != 4){
                    this.setVisible(false);
                }
            },
            head: {
                chuizi_tips : {
                    _run: function(){
                        setJiachuiImgTips_chenZhouMaoHuZi(this, changeUIOff_chenZhouMaoHuZi(1));
                    },
                    _event: {
                        initSceneData: function() {
                            setJiachuiImgTips_chenZhouMaoHuZi(this, changeUIOff_chenZhouMaoHuZi(1));
                ...
                jiachuiText_tips : {
                    _run:function() {
                        setJiachuiTextTips_chenZhouMaoHuZi(this, changeUIOff_chenZhouMaoHuZi(1));
                    },
                    _event:{
                        initSceneData: function() {
                            setJiachuiTextTips_chenZhouMaoHuZi(this, changeUIOff_chenZhouMaoHuZi(1));
                        ...
                        MJJiazhu: function(msg) {
                            var pl = getUIPlayer_chenZhouMaoHuZi(changeUIOff_chenZhouMaoHuZi(1))
                            if (msg.uid == pl.info.uid) {
                                setJiachuiTextTips_chenZhouMaoHuZi(this, changeUIOff_chenZhouMaoHuZi(1));
                            }
                        },
                ...
                zhuang: {
                    ...
                    _event: {
                        waitPut: function() {
                            if(MjClient.MaxPlayerNum_chenZhouMaoHuZi == 4 ) {
                                showUserZhuangLogo_chenZhouMaoHuZi(this, changeUIOff_chenZhouMaoHuZi(1));
                            }
                        },
                        initSceneData: function() {
                            if(MjClient.MaxPlayerNum_chenZhouMaoHuZi == 4 ) {
                                if (IsArrowVisible_chenZhouMaoHuZi()) showUserZhuangLogo_chenZhouMaoHuZi(this, changeUIOff_chenZhouMaoHuZi(1));
                            }
                        },
                        mjhand: function(){
                            if(MjClient.MaxPlayerNum_chenZhouMaoHuZi == 4 ) {
                ...
                chatbg: {
                    ...
                    chattext: {
                        _event: {
                            MJChat: function(msg) {
                                if(MjClient.MaxPlayerNum_chenZhouMaoHuZi == 4) {
                                    showUserChat_chenZhouMaoHuZi(this, changeUIOff_chenZhouMaoHuZi(1), msg);
                                }
                            },
                            playVoice: function(voicePath) {
                                if(MjClient.MaxPlayerNum_chenZhouMaoHuZi == 4) {
                                    MjClient.data._tempMessage.msg = voicePath;
                                    showUserChat_chenZhouMaoHuZi(this, changeUIOff_chenZhouMaoHuZi(1), MjClient.data._tempMessage);
                                }
                            }
                        }
                    }
                ...
                _click: function(btn) {
                    if(MjClient.MaxPlayerNum_chenZhouMaoHuZi == 4) {
                        showPlayerInfo_chenZhouMaoHuZi(changeUIOff_chenZhouMaoHuZi(1), btn);
                    }
                },
                _event: {
                    loadWxHead: function(d) {
                        if(MjClient.MaxPlayerNum_chenZhouMaoHuZi == 4) {
                            setWxHead_chenZhouMaoHuZi(this, d, changeUIOff_chenZhouMaoHuZi(1));
                        }
                    },
                    addPlayer: function(eD) {
                        showFangzhuTagIcon_chenZhouMaoHuZi(this,changeUIOff_chenZhouMaoHuZi(1));
                    },
                    removePlayer: function(eD) {
                        showFangzhuTagIcon_chenZhouMaoHuZi(this,changeUIOff_chenZhouMaoHuZi(1));
                    }
                ...
                huxi:{
                    ...
                    _event:{
                        ...
                        initSceneData:function(){
                            if(MjClient.MaxPlayerNum_chenZhouMaoHuZi == 4) {
                                this.visible = true;
                                var huXi = UpdateHuXi_chenZhouMaoHuZi(changeUIOff_chenZhouMaoHuZi(1));
                                if (!IsArrowVisible_chenZhouMaoHuZi()) {
                                    huXi = 0;
                                    this.visible = false;
                                }
            ...
            ready: {
                ...
                _run: function() {
                    if(MjClient.MaxPlayerNum_chenZhouMaoHuZi == 4) {
                        GetReadyVisible_chenZhouMaoHuZi(this, changeUIOff_chenZhouMaoHuZi(1));
                    }
                },
                _event: {
                    startShuffleCards:function (d) {
            ...
            _event: {
                clearCardUI: function() {
                    if(MjClient.MaxPlayerNum_chenZhouMaoHuZi == 4) {
                        clearCardUI_chenZhouMaoHuZi(this, changeUIOff_chenZhouMaoHuZi(1));
                    }
                },
                clearCardArr: function(){
                    if(MjClient.MaxPlayerNum_chenZhouMaoHuZi == 4) {
                ...
                initSceneData: function(eD) {
                    if(MjClient.MaxPlayerNum_chenZhouMaoHuZi == 4) {
                        SetUserVisible_chenZhouMaoHuZi(this, changeUIOff_chenZhouMaoHuZi(1));
                        InitUserHandUI_chenZhouMaoHuZi(this, changeUIOff_chenZhouMaoHuZi(1));
                        InitUserCoinAndName_chenZhouMaoHuZi(this, changeUIOff_chenZhouMaoHuZi(1));
                        DealOffLineCard_chenZhouMaoHuZi(this, changeUIOff_chenZhouMaoHuZi(1));
                    }
                },
                addPlayer: function(eD) {
                    if(MjClient.MaxPlayerNum_chenZhouMaoHuZi == 4) {
                ...
                HZNewCard: function(eD) {
                    if(MjClient.MaxPlayerNum_chenZhouMaoHuZi == 4) {
                        ...
                        DealNewCard_chenZhouMaoHuZi(this, eD, changeUIOff_chenZhouMaoHuZi(1));
                    }
                },
                roundEnd: function() {
                    if(MjClient.MaxPlayerNum_chenZhouMaoHuZi == 4) {
                        InitUserCoinAndName_chenZhouMaoHuZi(this, changeUIOff_chenZhouMaoHuZi(1));
                        MjClient.playui.ResetOtherCard(this, changeUIOff_chenZhouMaoHuZi(1));
                    }
                },
                waitPut: function(eD) {
                    if(MjClient.MaxPlayerNum_chenZhouMaoHuZi == 4) {
                        DealWaitPut(this, eD, changeUIOff_chenZhouMaoHuZi(1));
                    }
                },
                MJPut: function(eD) {
                    if(MjClient.MaxPlayerNum_chenZhouMaoHuZi == 4) {
                        DealPutCard_chenZhouMaoHuZi(this, eD, changeUIOff_chenZhouMaoHuZi(1));
                    }
                },
                HZChiCard: function(eD) {
                    if(MjClient.MaxPlayerNum_chenZhouMaoHuZi == 4) {
                        DealChiCard_chenZhouMaoHuZi(this, eD, changeUIOff_chenZhouMaoHuZi(1));
                    }
                },
                HZGangCard: function(eD) {
                    if(MjClient.MaxPlayerNum_chenZhouMaoHuZi == 4) {
                        DealGangCard_chenZhouMaoHuZi(this, eD, changeUIOff_chenZhouMaoHuZi(1));
                    }
                },
                MJPeng: function(eD) {
                    if(MjClient.MaxPlayerNum_chenZhouMaoHuZi == 4) {
                        DealPengCard_chenZhouMaoHuZi(this, eD, changeUIOff_chenZhouMaoHuZi(1));
                    }
                },
                HZWeiCard: function(eD){
                    if(MjClient.MaxPlayerNum_chenZhouMaoHuZi == 4) {
                        DealWeiCard_chenZhouMaoHuZi(this, eD, changeUIOff_chenZhouMaoHuZi(1));
                    }
                },
                MJHu: function(eD) {
                    if(MjClient.MaxPlayerNum_chenZhouMaoHuZi == 4) {
                        DealHu_chenZhouMaoHuZi(this, eD, changeUIOff_chenZhouMaoHuZi(1));
                    }
                },
                onlinePlayer: function(eD) {
                    if(MjClient.MaxPlayerNum_chenZhouMaoHuZi == 4) {
                        setUserOffline_chenZhouMaoHuZi(this, changeUIOff_chenZhouMaoHuZi(1));
                    }
                },
                playerStatusChange: function(eD) {
                    if(MjClient.MaxPlayerNum_chenZhouMaoHuZi == 4) {
                ...
                MJFlower: function(eD) {
                    if(MjClient.MaxPlayerNum_chenZhouMaoHuZi == 4) {
                        HandleMJFlower(this, eD, changeUIOff_chenZhouMaoHuZi(1));
                    }
                },
                MJTing: function (eD) {
                    if(MjClient.MaxPlayerNum_chenZhouMaoHuZi == 4) {
                        HandleMJTing(this, eD, changeUIOff_chenZhouMaoHuZi(1));
                    }
                },
                HZPickCard:function (eD) {
                    if(MjClient.MaxPlayerNum_chenZhouMaoHuZi == 4) {
                        if (MjClient.rePlayVideo != -1 ) {
                            var pl = getUIPlayer_chenZhouMaoHuZi(changeUIOff_chenZhouMaoHuZi(1));
                            if (eD.uid == pl.info.uid) {
                                MjClient.OtherHandArr[changeUIOff_chenZhouMaoHuZi(1)] = MjClient.majiang.sortHandCardSpecial(pl.mjhand)
                            }
                        }
                        DealShowLastCard_chenZhouMaoHuZi(this, eD, changeUIOff_chenZhouMaoHuZi(1));
                    }
                },
                HZAddCards:function (eD) {
                    if(MjClient.MaxPlayerNum_chenZhouMaoHuZi == 4) {
                        DealAddCard_chenZhouMaoHuZi(this, eD, changeUIOff_chenZhouMaoHuZi(1));
                    }
                },
                HZCheckRaise:function (msg) {
                    if(MjClient.MaxPlayerNum_chenZhouMaoHuZi == 4) {
        ...
        eat: {
            chi: {
                ...
                _touch: function(btn, eT) {
                    if (eT == 2){
                        if(ziPai.getHasFastEat()){
                            ...
                            if (chiSet.length == 1) {
                                ...
                                if (pl.mjhand.indexOf(putCard) < 0 || copy.indexOf(putCard) >= 0) {
                                    ...
                                    commitEatCards_chenZhouMaoHuZi(eatCards, null);
                        ...
                        showSelectEatCards_chenZhouMaoHuZi(this,btn.tag);
                        ...
                        // MJChiCardchange_chenZhouMaoHuZi();
                    }
                }
            },
            noTing : {
                        ...
                        if (eT == 2){
                            if ((MjClient.data.sData.players[SelfUid()].eatFlag & 32) > 0) {
                                MjClient.showMsg("选择碰后视为过胡，确定碰吗？", function() {
                                    HZPengToServer_chenZhouMaoHuZi();
            ...
            hu: {
                ...
                _touch: function(btn, eT) {
                    if (eT == 2) {
                        MJHuToServer_chenZhouMaoHuZi();
                        setChiVisible_chenZhouMaoHuZi();//add by maoyu
                    }
                }
            },
            cancel: {
            ...
            wangDiao:{
                ...
                _touch: function(btn, eT) {
                    console.log(">>>> lf，点击碰按钮");
                    if (eT == 2) {
                        HZWangChuangToServer_chenZhouMaoHuZi(1);
                        setChiVisible_chenZhouMaoHuZi();//add by maoyu
                    }
                }
            },
            wangChuang:{
                ...
                _touch: function(btn, eT) {
                    console.log(">>>> lf，点击碰按钮");
                    if (eT == 2) {
                        HZWangChuangToServer_chenZhouMaoHuZi(2);
                        setChiVisible_chenZhouMaoHuZi();//add by maoyu
                    }
                }
            },
            wangZha:{
                ...
                _touch: function(btn, eT) {
                    console.log(">>>> lf，点击碰按钮");
                    if (eT == 2) {
                        HZWangChuangToServer_chenZhouMaoHuZi(4);
                        setChiVisible_chenZhouMaoHuZi();//add by maoyu
                    }
                }
            },
                    ...
                    this.adaptChiLayout = function() {
                        ...
                        if (cards_option.length == 0) { // 吃牌选好了
                            if ((MjClient.data.sData.players[SelfUid()].eatFlag & 32) > 0) {
                                MjClient.showMsg("选择吃后视为过胡，确定吃吗？", function() {
                                    ...
                                    HZChiToServer_chenZhouMaoHuZi(cards_select[0], biCards);
                                    this.visible = false;
                                }.bind(this), function() {
                                    cards_select.pop();
                                    this.adaptChiLayout();
                        ...
                        for (var i = 0; i < cards_select.length; i++) {
                            ...
                            for (var j = 0; j < row.length; j++) {
                                ...
                                chiCardImg.loadTexture(MjClient.cardPath_chenZhouMaoHuZi + "out" + row[j] + ".png");
        ...
        voice_btn: {
            ...
            _event: {
                ...
                downAndPlayVoice: function(msg) {
                    ...
                    downAndPlayVoice_chenZhouMaoHuZi(msg.uid, msg.msg);
                }
            }
        },
        cutLine:{
    ...
    ctor: function() {
        this._super();
        ziPai.initZiPaiData();
        var playui = ccs.load("Play_ChenZhouMaoHuZi.json");
        playMusic("bgFight");
        var tData = MjClient.data.sData.tData;
        MjClient.MaxPlayerNum_chenZhouMaoHuZi = tData.maxPlayer;
        ...
        //三人玩时恢复
            ...
            this.jsBind.left = PlayLayer_chenZhouMaoHuZi.jsBindLeftCopy;
        }
        ...
        this.tingLayer = new ChenZhouMaoHuZiTingLayer();
    ...
    resetJiaZhuTip: function()
    {
        ...
        for (var i = 0; i < MjClient.MaxPlayerNum_chenZhouMaoHuZi; i ++)
        {
            var pl = getUIPlayer_chenZhouMaoHuZi(i);
            if (!pl) 
                continue;
...
PlayLayer_chenZhouMaoHuZi.jsBindLeftCopy = PlayLayer_chenZhouMaoHuZi.prototype.jsBind.left;

//重置手牌的顺序
PlayLayer_chenZhouMaoHuZi.prototype.ResetHandCard = function(posNode,off, needAction, isDelay){

    needAction = needAction === undefined ? false : needAction;
    // needAction = false;

    if(off == 0){
        resetHandCard_chenZhouMaoHuZiEx(posNode,off, needAction, isDelay);
...
//回放时其他家补牌重置手牌的处理
PlayLayer_chenZhouMaoHuZi.prototype._doPickResetHandCardForPlayBack = function(msg, off){
    var pl = getUIPlayer_chenZhouMaoHuZi(off);
...
PlayLayer_chenZhouMaoHuZi.prototype._doMovetoAction = function(node,endP){
    node.stopAllActions();
    var ac = cc.moveTo(0.3,endP);
    node.runAction(ac);
};

PlayLayer_chenZhouMaoHuZi.prototype.ResetOtherCard = function(posNode, off) {
    //添加吃、碰、跑、偎、提
    var sData = MjClient.data.sData;
    var tData = null;
    if (sData) {
    ...
    if (mjSortArr) {
            ...
            for (var i = 0; i < childList.length; i++) {
                ...
                if(tData.maxPlayer == 4){
                    if((off <= 1 && i != childList.length - 1) ||
                        (off >= 2 && i != 0)){
                        child.loadTexture(MjClient.cardPath_chenZhouMaoHuZi + "huxiBG.png");
                    }
                }else{
        ...
        for (var k = 0; k < mjSortArr.length; k++) {
            ...
            if (name == "mjgang1") {
                ...
                for (var i = 0; i < 4; i++) {
                    addEatCard_chenZhouMaoHuZi(posNode, "mjgang1" + k, cardNum, off);
                }
            ...
            if (name == "mjwei") {
                var cardNum = pl.mjwei[pos];
                for (var i = 0; i < 3; i++) {
                    addEatCard_chenZhouMaoHuZi(posNode, "mjwei" + k, cardNum, off);
                }
            ...
            if (name == "mjgang0") {
                ...
                for (var i = 0; i < 4; i++) {
                    addEatCard_chenZhouMaoHuZi(posNode, "mjgang0" + k, cardNum, off);
                }
            }
            //碰
            if (name == "mjpeng") {
                ...
                for (var i = 0; i < 3; i++) {
                    addEatCard_chenZhouMaoHuZi(posNode, "mjpeng" + k, cardNum, off);
                }
            }
            //吃
            if (name == "mjchi") {
                ...
                for (var i = 0; i < eatCards.length; i++) {
                    addEatCard_chenZhouMaoHuZi(posNode, "mjchi" + k, eatCards[i], off);
                }
                ...
                if (biCards && biCards.length > 0) {
                    for (var i = 0; i < biCards.length; i++) {
                        ...
                        for (var m = 0; m < biArr.length; m++) {
                            addEatCard_chenZhouMaoHuZi(posNode, "mjbi" + k + i, biArr[m], off);
                        }
                    }
                }
    ...
    //    var outCard = getNewCard_chenZhouMaoHuZi(pl.mjput[i], 2, off);
    //    if(off == 0){
    //        outCard.anchorX = 1;
    //        outCard.anchorY = 0;
...
PlayLayer_chenZhouMaoHuZi.prototype.ResetPutCard = function(posNode,off){
    //添加打出的牌
    var pl = getUIPlayer_chenZhouMaoHuZi(off);
    if (!pl) return;
    var outNode = posNode.getChildByName("outNode");
    ...
    for (var i = 0; i < pl.mjput.length; i++) {
        ...
        setPutCardPos_chenZhouMaoHuZi(outNode, outCard, i, off);
...
//重置牌的顺序
PlayLayer_chenZhouMaoHuZi.prototype.CardLayoutRestore = function(posNode,off){
    if(MjClient.rePlayVideo == -1){
...
// 判断吃、碰、跑、偎、提、胡的状态
PlayLayer_chenZhouMaoHuZi.prototype.EatVisibleCheck = function(off){
    var eat = MjClient.playui.jsBind.eat;
    ...
    if(tData.tState != TableState.roundFinish && pl.mjState != TableState.roundFinish){
        if(IsTurnToMe()){
            ...
            if(pl.eatFlag & 4){
                ...
                if(!canHu){
                    // HZGangToServer_chenZhouMaoHuZi(2);
                    return;
                }
            }
            //吃
...
PlayLayer_chenZhouMaoHuZi.prototype.showAndHideHeadEffect = function(){
    ...
    else if (curPlayerIsMe_chenZhouMaoHuZi(1)){
        curPlayerNode = arr[1].getChildByName("head");
    }else if (curPlayerIsMe_chenZhouMaoHuZi(2)){
        curPlayerNode = arr[2].getChildByName("head");
    }else if (curPlayerIsMe_chenZhouMaoHuZi(3)){
