...
function addWxHeadToEndUI_chenZhouMaoHuZi(node,off)
{
    ...
    setRoundEndUserOffline_chenZhouMaoHuZi(frame, pl);
...
function reInitarrCardVisible_chenZhouMaoHuZi()
{
...
//添加手牌
function addWinMjHand_chenZhouMaoHuZi(_node,off) {
    var sData = MjClient.data.sData;
    var tData = sData.tData;
    ...
    for(var i = 0;i < sortArr.length;i++){
        ...
        for(var j = 0;j < childSort.length;j++){
            ...
            clone.visible = true;
            clone.loadTexture(MjClient.cardPath_chenZhouMaoHuZi+"out" + card +".png");
            var off_y = 0;
            if(_node.getName() == "rightPanel"){
                off_y = clone.height;
                clone.anchorX = 1;
...
var EndOneView_chenZhouMaoHuZi = cc.Layer.extend({
    _block:null,
    _endoneuiNode:null,
    jsBind:{
        block: {
        ...
        btn_ready:{
            ...
            _click: function(btn,eT){
                ...
                reInitarrCardVisible_chenZhouMaoHuZi();
            }
        },
        btn_logic: {
            _run: function(){
                ...
                _run:function(){
                    ...
                    if(tData.cardNext < cards.length){
                        ...
                        for(var i = tData.cardNext;i < cards.length;i++){
                            ...
                            cloneCard.loadTexture(MjClient.cardPath_chenZhouMaoHuZi+"out" + card +".png");
            ...
            leftPanel:{
                _run:function(){
                    ...
                    if(MjClient.data.sData.tData.maxPlayer == 2){
                        addWinMjHand_chenZhouMaoHuZi(this, changeUIOff_chenZhouZiPai(2));
                    }else{
                        addWinMjHand_chenZhouMaoHuZi(this, changeUIOff_chenZhouZiPai(3));
                    }
                }
            },
            rightPanel:{
                _run:function(){
                    ...
                    if(MjClient.rePlayVideo != -1 || MjClient.data.sData.tData.maxPlayer == 2){
                        this.visible = false;
                    }
                    addWinMjHand_chenZhouMaoHuZi(this, changeUIOff_chenZhouMaoHuZi(2));
                }
            },
            xingPanel:{
                _run:function(){
                    ...
                    addWinMjHand_chenZhouMaoHuZi(this, changeUIOff_chenZhouMaoHuZi(1));
                }
            }
        },
        uiNode: {
                ...
                _run: function(){
                    ...
                    var cloneFunc = function(cardNum){
                        if(cloneNum != 0){
                            ...
                            cloneCard.loadTexture(MjClient.cardPath_chenZhouMaoHuZi+"out" + cardNum + ".png");
                            cloneNum++;
                            return cloneCard;
                        }
                        cloneNum++;
                        var cardImg = self.getChildByName("card");
                        cardImg.loadTexture(MjClient.cardPath_chenZhouMaoHuZi+"out" + cardNum + ".png");
                        return cardImg;
                    }
                    ...
                    //安化暂时没有埋牌
                    if(tData.maxPlayer == 2 && tData.areaSelectMode.maiPaiNum){
                        // 两人有埋牌，最后20个为埋牌内容
                    ...
                    if(!oneLine && !(tData.maxPlayer == 2 && tData.areaSelectMode.maiPaiNum)) {
            ...
            uiBg:{
                headNode: {
                    _run: function(){
                        ...
                        if(tData.winner != -1)
                            winOff = getUiOffByUid_chenZhouMaoHuZi(pl.info.uid);

                        addWxHeadToEndUI_chenZhouMaoHuZi(this,winOff);
                        ...
                        for(var index = 0;index<playerCount;index++){
                            if(index != winOff){
                                ...
                                addWxHeadToEndUI_chenZhouMaoHuZi(cloneThis,index);
                                cloneNum++;
                            }
                        }
                    }
    ...
    ctor:function () {
        ...
        if (MjClient.playui.getCardFilePath) {
            //兼容新版
            MjClient.cardPath_chenZhouMaoHuZi = MjClient.playui.getCardFilePath();
        }
    ...
    setWinCard: function(){
        ...
        var cloneCardsSetData = function(cardNode,i,num){
            ...
            cardImg.loadTexture(MjClient.cardPath_chenZhouMaoHuZi+"out" + num + ".png");
            return cardImg;
        }
                ...
                var getHuXi = function(cards){
                    ...
                    for(var t = 0;t < normal.length;t++){
                        if(normal[t].toString() == cards.toString()){
                            var huxi = huXiScore_chenZhouMaoHuZi("chi",cards[0]);
                            return huxi;
                        }
                    }
                    return 0;
    ...
    setXingCardData: function(tData,num){
        ...
        card_img.loadTexture(MjClient.cardPath_chenZhouMaoHuZi+"out" + tData.hunCard +".png");
    ...
    setOverScore: function(name,num,index){
        ...
        if(name != "huXi"){
            ...
            uiNode.addChild(cloneNode);
            var posNum = {huXi: 0,totalTun: 1,totalFan: 2, piaoFen:3};
            cloneNode.setPositionY(node.getPositionY() - (posNum[name] * 40));

            node = cloneNode;
        }
        var cnName = {huXi: "胡息：",totalFan: "番数：", totalTun: "囤数：", piaoFen:"飘分:"};
