function addWxHeadToEndUI_chenZhouMaoHuZi_GO(node, off) {
...
function SetGameOverLayer_chenZhouMaoHuZi(node,off,isNewUi){
    ...
    addWxHeadToEndUI_chenZhouMaoHuZi_GO(wxNode,off);
...
var GameOverLayer_chenZhouMaoHuZi = cc.Layer.extend({
    sprite:null,
    jsBind:{
        back:{
            close :{
    ...
    ctor:function () {
        this._super();
        var endallui = ccs.load("endAll_ChenZhouMaoHuZi.json");
        ...
        for(var i = 0 ; i < playerCount ; i++){
            ...
            SetGameOverLayer_chenZhouMaoHuZi(clone,i, false);
