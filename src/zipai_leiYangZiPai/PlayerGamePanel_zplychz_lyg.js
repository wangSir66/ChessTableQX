...
function SetUserVisible_leiyang(node, off){
    ...
    if(pl){
        ...
        // InitUserHandUI_leiyang(node, off);
...
function InitUserHandUI_leiyang(node, off){
...
var PlayLayer_zplychz_lyg = cc.Layer.extend({
    jsBind: {
        _event: {
            ...
            endRoom: function(msg) {
                ...
                if (msg.showEnd){
                    this.addChild(new GameOverLayer_zplychz(),500);
                }else{
            ...
            roundEnd: function() {
                ...
                function delayExe(){
                    ...
                    if (sData.tData.roundNum <= 0){
                        var layer = new GameOverLayer_zplychz();
                        layer.setVisible(false);
                        self.addChild(layer,500);
                    }
                    if(!MjClient.endoneui){
                        self.addChild(new EndOneView_zplychz_lyg(),500);
                    }
                }
            ...
            changeMJBgEvent: function() {
                changeMJBg_leiyang(this, ziPai.getZiPaiType());
            },
            MJPeng: function() {
                MjClient.playui.showAndHideHeadEffect();
            },
        ...
        roundInfo:{
            ...
            _run:function(){
                if(MjClient.getAppType() == MjClient.APP_TYPE.YLHUNANMJ || MjClient.getAppType() == MjClient.APP_TYPE.QXYYQP) {
                    ...
                    str += (tData.areaSelectMode.jushou) ? "举手做声," : "" ;
                    str += (tData.areaSelectMode.budaihu) ? "不带无胡," : "带无胡," ;
                    str += (tData.areaSelectMode.budaiyihong) ? "不带一点红," : "带一点红," ;
        ...
        banner: {
            ...
            _run: function() {
                var btn_changeBg = this.getChildByName("changeBg");
                var btn_setting = this.getChildByName("setting");
                var btn_gps = this.getChildByName("gps_btn");
        ...
        wait: {
            ...
            delroom: {
                ...
                _event: {
                    initSceneData: function(eD) {
                        this.visible = false;//isShowBackBtn_leiyang();
                    },
                    removePlayer: function(eD) {
                        this.visible = false;//isShowBackBtn_leiyang();
                    },
            ...
            backHomebtn: {
                ...
                _event: {
                    ...
                    initSceneData: function(eD) {
                        this.visible = MjClient.playui.isShowBackBtn();
                    },
                    removePlayer: function(eD) {
                        this.visible = MjClient.playui.isShowBackBtn();
                    },
        ...
        down: {
            ...
            handNode: {
                ...
                _event:  {
                    ...
                    MJPass: function() { // 天胡 提 偎 跑后过胡
                        calculateHintPutList_leiyang();
                        addTingSign_leiyang(MjClient.playui._downNode);
                    },
            ...
            _event: {
                ...
                initSceneData: function(eD) {
                    SetUserVisible_leiyang(this, 0);
                    InitUserHandUI_leiyang(this, 0);
        ...
        right: {
            ...
            _event: {
                ...
                initSceneData: function(eD) {
                    SetUserVisible_leiyang(this, 1);
                    InitUserHandUI_leiyang(this, 1);
        ...
        left: {
            ...
            _event: {
                ...
                initSceneData: function(eD) {
                    SetUserVisible_leiyang(this, 2);
                    InitUserHandUI_leiyang(this, 2);
                        ...
                        if(ziPai.getHasFastEat()){
                            ...
                            if (chiSet.length == 1) {
                                ...
                                if (pl.mjhand.indexOf(putCard) < 0 || copy.indexOf(putCard) >= 0) {
                                    ...
                                    commitEatCards_leiyang(eatCards, null);
                    ...
                    this.adaptChiLayout = function() {
                        ...
                        for (var i = 0; i < cards_select.length; i++) {
                            ...
                            for (var j = 0; j < row.length; j++) {
                                ...
                                chiCardImg.loadTexture(MjClient.cardPath_leiyang + "out" + row[j] + ".png");
    ...
    ctor: function() {
        ...
        this.tingLayer = new zplychzPhzTingLayer();
        this.addChild(this.tingLayer, 98);
...
//重置手牌的顺序
PlayLayer_zplychz_lyg.prototype.ResetHandCard = function(posNode,off, needAction, isDelay){
...
PlayLayer_zplychz_lyg.prototype._doMovetoAction = function(node,endP){
    node.stopAllActions();
    var ac = cc.moveTo(0.3,endP);
    node.runAction(ac);
};

PlayLayer_zplychz_lyg.prototype.ResetOtherCard = function(posNode,off){
    //添加吃、碰、跑、偎、提
    var sData = MjClient.data.sData;
    var tData = null;
    if(sData){
...
PlayLayer_zplychz_lyg.prototype.ResetPutCard = function(posNode, off) {
    //添加打出的牌
    var pl = getUIPlayer_leiyang(off);
    if (!pl) return;
    var outNode = posNode.getChildByName("outNode");
...
//重置牌的顺序
PlayLayer_zplychz_lyg.prototype.CardLayoutRestore = function(posNode,off){
    if(MjClient.rePlayVideo == -1){
...
// 判断吃、碰、跑、偎、提、胡的状态
PlayLayer_zplychz_lyg.prototype.EatVisibleCheck = function(off){
    var eat = MjClient.playui.jsBind.eat;
...
// 退出房间按钮
PlayLayer_zplychz_lyg.prototype.isShowBackBtn = function() {
    var sData = MjClient.data.sData;
    var tData = sData.tData;
    if (!(Object.keys(sData.players).length == tData.maxPlayer)) {
        return true;
...
PlayLayer_zplychz_lyg.prototype.showAndHideHeadEffect = function(){
    ...
    else if (curPlayerIsMe_leiyang(1)){
        curPlayerNode = arr[1].getChildByName("head");
    }else if (curPlayerIsMe_leiyang(2)){
        curPlayerNode = arr[2].getChildByName("head");
    }else if (curPlayerIsMe_leiyang(3)){
    ...
    {   
        ...
        _armature.scale = curPlayerNode.getChildByName("nobody").width / _armature.width;
