function SetEndOneUserUI_hejinkunjin(node, off) {
...
var EndOneView_hejinkunjin = cc.Layer.extend({
	jsBind: {
		block: {
			_layout: [
				[1, 1],
		...
		back: {
			...
			share: {
				_click: function(btn, eT) {
					MjClient.native.umengEvent4CountWithProperty("Fangjiannei_Xiaojiesuanjiemian_Fenxiang", {
						uid: SelfUid()
					});
			...
			head0: {
				...
				winNum: {},
				_run: function() {
					SetEndOneUserUI_hejinkunjin(this, 0);
				},
			...
			head1: {
				...
				_run: function() {
					SetEndOneUserUI_hejinkunjin(this, 1);
				}
			}
			...
			head2: {
				...
				_run: function() {
					SetEndOneUserUI_hejinkunjin(this, 2);
				}
			},
			head3: {
				head: {
				...
				_run: function() {
					SetEndOneUserUI_hejinkunjin(this, 3);
				}
			},
			count_down: {
				_visible: function() {
	...
	ctor: function() {
		this._super();
		var endoneui = ccs.load("endOne_hejinkunjin.json");
