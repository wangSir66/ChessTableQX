...
//向服务器发送 过消息
MjClient.MJPass2NetForWangDiaoMJ = function()
{
   // console.log(">>>>>>>>>普通  过 <<<<<<<<");
    cc.log("====================send======pass=====");
...
function SetUserVisible_WangDiaoMJ(node, off)
{
    //var sData = MjClient.data.sData;
    //return;
    cc.log("====================off======================" + off);
...
function InitUserHandUI_WangDiaoMJ(node, off)
{
    var sData = MjClient.data.sData;
    var tData = sData.tData;
    var pl = getUIPlayer(off);
    // cc.log("=======off======:" + off + "=======pl.uid:" + pl.info.uid);
    if(!pl)
    {
        return;
    }
...
var PlayLayer_WangDiaoMJ = cc.Layer.extend({
    jsBind: {
        _event: {
            mjhand: function() {
            ...
            roundEnd: function() {
                ...
                function delayExe()
                {
                    ...
                    if (getUIPlayer(0).mjState == TableState.roundFinish) {
                        self.addChild(new EndOneView_WangDiaoMJ(),500);
                    }  
                }
                ...
                function showAllPlayersCards()
                {
                    ...
                    {
                        self.runAction(cc.sequence(cc.delayTime(0.1),cc.callFunc(showMjhandBeforeEndOne),cc.delayTime(1.7),cc.callFunc(delayExe)));
                    }
                    else
                    {
                        self.runAction(cc.sequence(cc.delayTime(0.1),cc.callFunc(delayExe)));
                    }
                }
        ...
        back: {
            back: {
                _run: function() {
                    changeGameBg_yongzhou(this, true);
                },
                _event: {
        ...
        roundInfo:{
            ...
            _run:function()
            {
                ...
                if(tData.matchId){
                    BSStr = ",10秒出牌";
                    this.setString(MjClient.playui.getGameInfoString("roundInfo") + BSStr);
                }
            }
        },
        jiazhuWait: {
        ...
        banner: {
            ...
            Button_1: {
                _visible : true,
                _click: function() {
                    MjClient.openWeb({url:MjClient.GAME_TYPE.LEI_YANG_GMJ,help:true});
                }
            },
            hunPai:{
                _run:function()
    ...
    //                         setCardSprite(this, shanGunCard, 4);
    ...
    //             }
        ...
        //     ],
        //     _run:function () {
        //         if (MjClient.MaxPlayerNum != 3 || MjClient.MaxPlayerNum != 2)
        ...
        wait: {
            ...
            wxinvite: {
                ...
                _click: function() {
                    ...
                    // var str3 = tData.roundNum + "局," + "点击立即加入牌局>>>";


                    // var chineseStrList = ["一", "二", "三"]
                    // var num = Object.keys(sData.players).length;
                    // var emptyNum = tData.maxPlayer - num;
                    // var str4 = chineseStrList[num - 1] + "缺" + chineseStrList[emptyNum - 1];

                    // var txt_club = tData.clubId ? " 亲友圈(" + tData.clubId + ")" : "";
                    // GLog(str1 + str2 + str3 + str4 + txt_club);
                    // MjClient.native.wxShareUrl(MjClient.remoteCfg.entreRoomUrl+"?vipTable="+tData.tableid, GameCnName[MjClient.gameType] + "  房间号:" + tData.tableid + str4 + txt_club,
                    //     str1+str2+str3);
        ...
        down: {
                ...
                _run: function() {
                    if (MjClient.size.width / MjClient.size.height >= 1.5) {
                        ...
                        if(MjClient.MaxPlayerNum == 2){
                            setWgtLayout(this, [0.0, 0.0763], [0.37, 0], [-7, 6.1]);
                        }
                    } else {

                        setWgtLayout(this, [0.0, 0.07], [0.53, 0], [-7, 6.1]);
                        if(MjClient.MaxPlayerNum == 2){
                            setWgtLayout(this, [0.0, 0.07], [0.37, 0], [-7, 6.1]);
                        }
                    }
                },
                _visible: false
            ...
            out1: {
                _run: function () {
                    if (MjClient.size.width / MjClient.size.height >= 1.5)
                    {
                        ...
                        if(MjClient.MaxPlayerNum == 2){
                            setWgtLayout(this, [0.0, 0.0763], [0.37, 0], [-7, 4.9]);
                        }
                    }
                    else
                    {   
                        ...
                        if(MjClient.MaxPlayerNum == 2){
                            setWgtLayout(this, [0.0, 0.07], [0.37, 0], [-7, 4.9]);
                        }
                    }
            ...
            out0: {
                _run: function () {
                    if (MjClient.size.width / MjClient.size.height >= 1.5)
                    {
                        ...
                        if(MjClient.MaxPlayerNum == 2){
                            setWgtLayout(this, [0.0, 0.0763], [0.37, 0], [-7, 3.7]);
                        }
                    }
                    else
                    {
                        ...
                        if(MjClient.MaxPlayerNum == 2){
                            setWgtLayout(this, [0.0, 0.07], [0.37, 0], [-7, 3.7]);
                        }
                    }
            ...
            _event: {
                ...
                initSceneData: function(eD) {
                    SetUserVisible_WangDiaoMJ(this, 0);
                ...
                mjhand: function(eD) {
                    InitUserHandUI_WangDiaoMJ(this, 0);
                },
                roundEnd: function(eD) {
                    InitUserCoinAndName(this, 0); 
                   
                    if(MjClient.majiang.getIsRunLiangPian(eD,0)){
                        ShowEatActionAnim(this, ActionType.LIANGPIAN, 0);
                    }
                ...
                MJPut: function(eD) {
                    ...
                    if (eD.uid == SelfUid())
                    {
                        // MjClient.majiang.checkSkipGang(pl);
                ...
                MJWangZhua: function(eD){ 
                    DealWangZhua(this, eD, 0);
                },
                MJGenZhuang : function(ed){  
                    ShowEatActionAnim(this,ActionType.GENGZHUANG);
                }
            }
        },
        right: {
            ...
            head: {
                tuoguan: {
                    ...
                    _event:{
                        beTrust:function (msg) {
                            if(getUIPlayer(1).info.uid == msg.uid){
                                this.visible = true;
                            }
                        },
                        cancelTrust:function (msg) {
            ...
            _event: {
                ...
                initSceneData: function(eD) {
                    SetUserVisible_WangDiaoMJ(this, 1);
                },
                addPlayer: function(eD) {
                    SetUserVisible_WangDiaoMJ(this, 1);
                },
                ...
                roundEnd: function(eD) {
                    ...
                    if(MjClient.majiang.getIsRunLiangPian(eD,1)){
                        ShowEatActionAnim(this, ActionType.LIANGPIAN, 1);
                    }
                },
                waitPut: function() {
                    var tData = MjClient.data.sData.tData;
                ...
                waitJiazhu:function (msg) {
                    ...
                    /*
                     弹窗加注
                     */
                    var layer = new jiaZhuDaoZhouLayer(function(){
                        //弹窗等待
                        MjClient.playui._jiazhuWait.visible = true;
                    });
                    MjClient.playui.addChild(layer,99);
        ...
        top: {
            ...
            head: {
                tuoguan: {
                    ...
                    _event:{
                        beTrust:function (msg) {
                            if(getUIPlayer(2).info.uid == msg.uid){
                                this.visible = true;
                            }
                        },
                        cancelTrust:function (msg) {
            ...
            _event: {
                ...
                initSceneData: function(eD) {
                    SetUserVisible_WangDiaoMJ(this, 2);
                },
                addPlayer: function(eD) {
                    SetUserVisible_WangDiaoMJ(this, 2);
                },
                ...
                roundEnd: function(eD) {
                    ...
                    if(MjClient.majiang.getIsRunLiangPian(eD,2)){
                        ShowEatActionAnim(this, ActionType.LIANGPIAN, 2);
                    }
        ...
        left: {
            ...
            head: {
                tuoguan: {
                    ...
                    _event:{
                        beTrust:function (msg) {
                            if(getUIPlayer(3).info.uid == msg.uid){
                                this.visible = true;
                            }
                        },
                        cancelTrust:function (msg) {
            ...
            _event: {
                ...
                initSceneData: function(eD) {
                    SetUserVisible_WangDiaoMJ(this, 3);
                },
                addPlayer: function(eD) {
                    SetUserVisible_WangDiaoMJ(this, 3);
                },
                ...
                roundEnd: function(eD) {
                    ...
                    if(MjClient.majiang.getIsRunLiangPian(eD,3)){
                        ShowEatActionAnim(this, ActionType.LIANGPIAN, 3);
                    }
                },
                waitPut: function() {
                    var tData = MjClient.data.sData.tData;
            ...
            changeui: {
                ...
                changeuibg: {
                    ...
                    guobg: {
                        guo: {
                            _touch: function(btn, eT) {
                                if (eT == 2) MjClient.MJPass2NetForWangDiaoMJ();
                            }
                        },
                        fanhui: {
                            _touch: function(btn, et) {
                                if (et == 2) {
                                    var node = btn.getParent().getParent()
                                    node.visible = false;
                                    MjClient.playui.EatVisibleCheck();
                                }
                            }
    ...
    ctor: function() {
        ...
        var playui = ccs.load("Play_wangDiao.json");
        playMusic("bgFight");
    ...
    getGameInfoString: function(param) {
        ...
        cc.log("------------------------------------------");
        cc.log(JSON.stringify(tData.areaSelectMode));       

         // {"maxPlayer":2,"payWay":0,"isLiangPian":true,"isQiangGangHu":false,"maPai":0}
        ...
        if(tData.areaSelectMode.maPai === 0)
            ...
            str +=  tData.areaSelectMode.maPai + "码,";
        ...
        // if (tData.areaSelectMode.hunyise)
        //     str += "混一色,";

        // if (tData.areaSelectMode.zuopiao > 0){
        //     str += "飘" + tData.areaSelectMode.zuopiao + ",";
        // }else{
        //     str += "不飘,";
        // }
            
        // if (tData.areaSelectMode.mingzhua){
        //     str += "明抓,";
        // }else{
        //     str += "暗抓,";
        // }
...
PlayLayer_WangDiaoMJ.prototype.CardLayoutRestore = function(node, off)
{
    ...
    var uistand = [];
    var uihun = [];//癞子牌在最左边
    // MjClient.data.sData.tData.hunCard = 71; // xw test 建议直接服务器给下来
    // var sData = MjClient.data.sData;
    // var tData = sData.tData;
    for(var i = 0; i < children.length; i++) //children 为 "down" 节点下的字节点
    {
        ...
        if(ci.name == "mjhand")
        {
            ...
            {
                cc.log(MjClient.data.sData.tData.hunCard);
            ...
            //耒阳鬼麻将添加打哪张牌可以听的标志
            // if(MjClient.majiang.getTingPutCards && MjClient.majiang.getTingPutCards(pl.mjhand).indexOf(ci.tag) != -1 && !(pl.eatFlag & 8)){
            //     var image = new ccui.ImageView("playing/other/sign_1.png")
            //     image.setPosition(ci.width/2, ci.height+10);
            //     image.setName("image");
            //     ci.addChild(image);
            // }else {
            //     ci.removeChildByName("image");
            // }
        }
...
PlayLayer_WangDiaoMJ.prototype.ShowAllTingTips = function(){ 
    if( !MjClient.majiang.getIsInTheGame())
        return;
    var downNode = MjClient.playui._downNode;
    var standUI = downNode.getChildByName("stand");
    var children = downNode.children;
...
// 判断是否显示听
PlayLayer_WangDiaoMJ.prototype.CheckTingIsShow = function(){ 
    if(!MjClient.majiang.getIsInTheGame())  
        return;  
    var eat = MjClient.playui.jsBind.eat;
    eat.ting._node.visible = false;
...
// 判断吃碰杠胡的状态
PlayLayer_WangDiaoMJ.prototype.EatVisibleCheck = function()
{
    var eat = MjClient.playui.jsBind.eat;
    ...
    eat.piao_0._node.visible = false;
    eat.piao_1._node.visible = false;
    eat.piao_2._node.visible = false;
    eat.piao_3._node.visible = false;
    ...
    eat.zhua._node.setTouchEnabled(true);
    ...
    // 王闯王钓更换按钮资源
    var wangType = pl.wangType;
    eat.hu._node.loadTextureNormal("playing/gameTable/youxizhong-2_53.png"); 
    if(wangType == 1){  
         eat.hu._node.loadTextureNormal("playing/paohuzi/youxizhong-299.png"); 
    }else if(wangType == 2){   
        eat.hu._node.loadTextureNormal("playing/paohuzi/youxizhong-298.png");  
    }  
    ...
    if(tData.tState == TableState.waitPut && pl.mjState == TableState.waitPut){
        if(IsTurnToMe()){
            ...
            if (!pl.isQiHu) { 
                ...
                for (var i = 0; i < pl.mjhand.length; i++) {
                    if(pl.mjhand[i] == tData.hunCard){
                        continue;
                    }
                    var cardsAfterPut = pl.mjhand.slice(0);
                    cardsAfterPut.splice(i,1); //依次去掉某张牌看能不能听
                    if (MjClient.majiang.canTing(cardsAfterPut,tData.hunCard)) {
            ...
            // 天听
            if (pl.mjput.length == 0 && pl.putCount == 0 && pl.mjhand.length >= 13) { 
                MjClient.canTingCards = {};
                for (var i = 0; i < pl.mjhand.length; i++) {
                    var cardsAfterPut = pl.mjhand.slice(0);
                    cardsAfterPut.splice(i,1); //依次去掉某张牌看能不能听
                ...
                cc.log(JSON.stringify(MjClient.canTingCards));

            }
            //碰后不能杠
            var rtn = MjClient.majiang.canGang1(pl.mjpeng, pl.mjhand, pl.isTing,tData.hunCard);
            cc.log(rtn.length);
            if(rtn.length > 0)//听牌也可以杠的，my
            {
