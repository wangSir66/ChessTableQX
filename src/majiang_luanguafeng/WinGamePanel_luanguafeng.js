...
function SetEndOneUserUI_luanguafeng(node,off)
{
...
var EndOneView_luanguafeng = cc.Layer.extend({
	jsBind:{
		block: {
		...
		head0:{
		   ...
		   _run:function(){ SetEndOneUserUI_luanguafeng(this,0); },
		...
		,head1:{ 
		  ...
		  _run:function(){ SetEndOneUserUI_luanguafeng(this,1); }
		}
		...
		,head2:{ 
		   ...
		   _run:function(){ SetEndOneUserUI_luanguafeng(this,2); }
		}
		,head3:{
			 head:
			 {
			...
			_run:function(){ SetEndOneUserUI_luanguafeng(this,3); }
			},
            count_down:{
                _visible :function()
                {
    ...
    ctor:function () {
        this._super();
        var endoneui = ccs.load("endOne_luanguafeng.json");
