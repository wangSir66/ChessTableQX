...
//向服务器发送 过消息
MjClient.MJPass2NetForxuzhoupeixian = function()
{
    cc.log("====================send======pass=====");
...
function SetUserVisible_xuzhoupeixian(node, off)
{
    cc.log("====================off======================" + off);
...
function InitUserHandUI_xuzhoupeixian(node, off)
{
    var sData = MjClient.data.sData;
    var tData = sData.tData;
    var pl = getUIPlayer(off);
...
function initFlower_xuzhoupeixian() {
...
var PlayLayer_xuzhoupeixian = cc.Layer.extend({
    _btnPutCard:null,
    jsBind: {
        _event: {
            mjhand: function() {
                ...
                function delayExe()
                {
                    ...
                    if ((tData.winner == -1) && (!MjClient.isDismiss)) {
                        ...
                        self.runAction(cc.sequence(cc.callFunc(function(){
                            ...
                            self.addChild(new EndOneView_xuzhoupeixian(),500);
                        })));
            ...
            moveHead: function() {
                ...
                initFlower_xuzhoupeixian();
            },
            initSceneData: function() {
                reConectHeadLayout(this);
                CheckRoomUiDelete();
                //TingVisibleCheckForxuzhoupeixian(MjClient.playui.eat._node);
            },
        ...
        down: {
            head: {
                ...
                skipHuIconTag: {
                    ...
                    _event: {
                        ...
                        {
                            var pl = getUIPlayer(0);
                            if (pl && cc.isArray(pl.skipHu) && pl.skipHu.length > 0) {
                                this.visible = true;
                            }
                        }
                    }
            ...
            _event: {
                ...
                initSceneData: function(eD) {
                    SetUserVisible_xuzhoupeixian(this, 0);
                    if(IsTurnToMe()){
                ...
                mjhand: function(eD) {
                    InitUserHandUI_xuzhoupeixian(this, 0);
                },
                roundEnd: function() {
                ...
                waitJiazhu:function (msg) {
                     ...
                     */
                    var pl = getUIPlayer(0);
                    var layer = new laZhangLayer(function(){
                        //弹窗等待
                        MjClient.playui._jiazhuWait.visible = true;
        ...
        right: {
            ...
            _event: {
                ...
                initSceneData: function(eD) {
                    SetUserVisible_xuzhoupeixian(this, 1);
                },
                addPlayer: function(eD) {
                    SetUserVisible_xuzhoupeixian(this, 1);
                },
                ...
                mjhand: function(eD) {
                    InitUserHandUI_xuzhoupeixian(this, 1);
                },
                roundEnd: function() {
        ...
        top: {
            ...
            _event: {
                ...
                initSceneData: function(eD) {
                    SetUserVisible_xuzhoupeixian(this, 2);
                },
                addPlayer: function(eD) {
                    SetUserVisible_xuzhoupeixian(this, 2);
                },
                ...
                mjhand: function(eD) {
                    InitUserHandUI_xuzhoupeixian(this, 2);
                },
                roundEnd: function() {
        ...
        left: {
            ...
            _event: {
                ...
                initSceneData: function(eD) {
                    SetUserVisible_xuzhoupeixian(this, 3);
                },
                addPlayer: function(eD) {
                    SetUserVisible_xuzhoupeixian(this, 3);
                },
                ...
                mjhand: function(eD) {
                    InitUserHandUI_xuzhoupeixian(this, 3);
                },
                roundEnd: function() {
        ...
        eat: {
            ...
            guo: {
                ...
                _touch: function(btn, eT) {
                    if (eT == 2)
                    {
                        //特殊处理：徐州沛县麻将，只显示能过胡-by Tom
                        MjClient.MJPass2NetForxuzhoupeixian();
                    }
                },
                bgimg: {
                    _run: function() {
            ...
            changeui: {
                ...
                changeuibg: {
                    ...
                    guobg: {
                        guo: {
                            _touch: function(btn, eT) {
                                if (eT == 2) MjClient.MJPass2NetForxuzhoupeixian();
                            }
                        },
                        fanhui: {
                            _touch: function(btn, et) {
    ...
    ctor: function() {
        this._super();
        var playui = ccs.load("Play_xuzhoupeixian.json");
        playMusic("bgFight");
...
PlayLayer_xuzhoupeixian.prototype.CardLayoutRestore = function(node, off)
{
...
PlayLayer_xuzhoupeixian.prototype.ShowAllTingTips = function()
{
    ...
    for(var i = 0; i < children.length; i++)
    {
        ...
        if(children[i].name == "mjhand")
        {
            ...
            // 可不可以显示箭头的条件
            if(!MjClient.majiang.getIsShowTingTips(tingCards,pl.mjhand))
                continue;
...
// 判断是否显示听
PlayLayer_xuzhoupeixian.prototype.CheckTingIsShow = function()
{
...
// 判断吃碰杠胡的状态
PlayLayer_xuzhoupeixian.prototype.EatVisibleCheck = function()
{
    var eat = MjClient.playui.jsBind.eat;
