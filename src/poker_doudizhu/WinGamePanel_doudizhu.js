...
function SetEndOneUserUI_doudizhu(node, off) {
        ...
        head: {
            ...
            stand: {
                ...
                _run: function () {
                    ...
                    CardLayoutRestoreForEndOne_doudizhu(node, pl);
                }
            },
            cardType: {
                _run:function()
...
function CardLayoutRestoreForEndOne_doudizhu(node, plNode) {
...
var EndOneView_doudizhu = cc.Layer.extend({
    jsBind: {
        block: {
        ...
        back: {
            ...
            head0: {
                ...
                _run: function () { SetEndOneUserUI_doudizhu(this, 0); },
    		...
    		, head1: {
    		    ...
    		    _run: function () { SetEndOneUserUI_doudizhu(this, 1); }
    		}
    		...
    		, head2: {
    		    ...
    		    _run: function () { SetEndOneUserUI_doudizhu(this, 2); }
    		}
        }
    },
    ctor: function (zhuang) {
        ...
        var endoneui = ccs.load(res.EndOne_doudizhu_json);
