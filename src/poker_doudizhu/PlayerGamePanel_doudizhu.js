...
var PlayLayer_doudizhu = cc.Layer.extend({
    ctor: function () {
        this._super();
        var playui = ccs.load(res.Play_doudizhu_json);
...
//出牌提示
PlayLayer_doudizhu.prototype.showTipCards = function () {
...
// 处理斗地主智能提牌
PlayLayer_doudizhu.prototype.handleDoudizhuCardsAutoUp = function (bTouchMove) {
    if (!this.isSDataValid()) {
        return ;
    }
    var tData = MjClient.data.sData.tData;
...
PlayLayer_doudizhu.prototype.handleCardsTouchListener = function () {
    return {
...
// 处理点击
PlayLayer_doudizhu.prototype.handleTouchCards = function (touch, event, isBegan) {
...
// 处理玩家提起提起得牌，保留正确的牌
PlayLayer_doudizhu.prototype.handleUpRightCards = function (isFirst, off) {
    if (isFirst) {
        return;
    }
...
// =========================[[ 流程 ]] =========================
// 断线重连/初始化
PlayLayer_doudizhu.prototype.dealInitSceneData = function () {
    if (!this.isSDataValid()) {
        return ;
    }
    var tData = MjClient.data.sData.tData;
...
PlayLayer_doudizhu.prototype.dealChangePKImg = function () {
...
// 结算
PlayLayer_doudizhu.prototype.dealRoundEnd = function (eD) {
    if (!this.isSDataValid()) {
        return ;
    }
    ...
    function delayExe() {
        ...
        cc.log("dealroundend--------");
        self.addChild(new EndOneView_doudizhu(zhuang), 500);
    }
...
// 过、准备
PlayLayer_doudizhu.prototype.dealPKPass = function (eD) {
    MjClient.playui.killTimeClock();
...
// 出牌
PlayLayer_doudizhu.prototype.dealPKPut = function (msg) {
    var tData = MjClient.data.sData.tData;
    tData.rate = msg.rate;
...
// 等待出牌
PlayLayer_doudizhu.prototype.dealWaitPut = function (eD, isSceneData) {
    var tData = MjClient.data.sData.tData;
...
// 等待叫地主
PlayLayer_doudizhu.prototype.dealWaitJiaodizhu = function (msg) {
    var sData = MjClient.data.sData;
    var tData = sData.tData;
...
// 抢地主
PlayLayer_doudizhu.prototype.dealQiangDizhu = function (msg) {
    var tData = MjClient.data.sData.tData;
...
// 等待准备
PlayLayer_doudizhu.prototype.dealAllReady = function (bAllReady) {
    for (var i = 0; i < this.headOffLen; i++) {
        var off = this.headOffArr[i];
...
// 加倍
PlayLayer_doudizhu.prototype.dealMJJiazhu = function (isSceneData, off, jiazhuNum, curPlayer) {
    var tData = MjClient.data.sData.tData;
...
// 等待加倍
PlayLayer_doudizhu.prototype.dealWaitJiazhu = function (eD, bSceneData) {
    var tData = MjClient.data.sData.tData;
...
// 处理手牌
PlayLayer_doudizhu.prototype.handleMjHand = function () {
...
// 处理底牌
PlayLayer_doudizhu.prototype.dealDiCards = function (zhuang, diCards, handCounts, isAddCards, isIconMove) {
    var tData = MjClient.data.sData.tData;
    tData.zhuang = zhuang;
...
PlayLayer_doudizhu.prototype.updateUserHeadPosition = function (off, bRoundEnd) {
...
PlayLayer_doudizhu.prototype.updateTimes = function () {
...
//设置地区信息
PlayLayer_doudizhu.prototype.showGameName = function () {
...
//添加还背景的功能
PlayLayer_doudizhu.prototype.addChangeBg = function () {
...
PlayLayer_doudizhu.prototype.showVoice = function () {
...
PlayLayer_doudizhu.prototype.addWaitNode = function () {
...
PlayLayer_doudizhu.prototype.setWaitNodeVisible = function (bVisible) {
    if (!MjClient.playui.waitNode) {
        return;
    }
    MjClient.playui.waitNode.setVisible(bVisible);
}
PlayLayer_doudizhu.prototype.addAniLayer = function () {
...
PlayLayer_doudizhu.prototype.showTableID = function (bShow) {
...
PlayLayer_doudizhu.prototype.setHLJiabeiVisible = function (bVisible) {
...
// 出牌按钮
PlayLayer_doudizhu.prototype.handlePutCardBtn = function (isVisible, isFirst) {
...
PlayLayer_doudizhu.prototype.enablePutCardBtn = function (bAble) {
    var btnPutCard = this.node.getChildByName("BtnPutCard");
...
//操作按钮(提示和不出)
PlayLayer_doudizhu.prototype.handleHimtAndNoPutBtn = function (isVisible, isAble) {
...
//经典斗地主叫分按钮
PlayLayer_doudizhu.prototype.setJingDianBtnVisible = function (bVisible, buJiaoAble, score, bmustjiao) {
...
//欢乐斗地主叫分按钮
PlayLayer_doudizhu.prototype.setHuanLeBtnVisible = function (bVisible, bMustJiao) {
...
// 牌局信息
PlayLayer_doudizhu.prototype.showRoundInfo = function () {
    if (!this.isSDataValid()) {
        return ;
    }
...
// 局数
PlayLayer_doudizhu.prototype.updateGameRound = function () {
...
// 加倍
PlayLayer_doudizhu.prototype.setTextMult = function (bShow) {
...
//踢
PlayLayer_doudizhu.prototype.handleTiTag = function (off, type) {
    var node = getNode_cards(off);
...
PlayLayer_doudizhu.prototype.setBtnTiVisible = function (bVisible, bFanTi) {
...
PlayLayer_doudizhu.prototype.sendTiToServer = function (TiNum) {
...
// 底分
PlayLayer_doudizhu.prototype.handleDifen = function () {
...
PlayLayer_doudizhu.prototype.hideAllUI = function () {
...
// 不抢/抢地主
PlayLayer_doudizhu.prototype.dealQiangDizhuText = function (off, visible, msg) {
    var node = getNode_cards(off);
    var diZhuTag = node.getChildByName("jiaodizhuTag");
...
// 要不起
PlayLayer_doudizhu.prototype.handleNoPutTag = function (off, visible) {
    var node = getNode_cards(off);
...
// 没有大过上家
PlayLayer_doudizhu.prototype.handleNoPutTips = function (isVisible) {
    var noPutTips = this.node.getChildByName("noPutTips");
...
// 没有大过上家
PlayLayer_doudizhu.prototype.handlePassBtn = function (isVisible) {
    var BtnPass = this.node.getChildByName("BtnPass");
...
// =========================[[ 系统 ]] ==========================
PlayLayer_doudizhu.prototype.dealSendVoice = function (fullFilePath) {
    if (!fullFilePath) {
...
PlayLayer_doudizhu.prototype.dealDownAndPlayVoice = function (msg) {
...
PlayLayer_doudizhu.prototype.dealUploadRecord = function (filePath) {
    if (filePath) {
...
// 绘制手牌
PlayLayer_doudizhu.prototype.initUserHandUiDoudizhu = function (off) {
    var pl = getUIPlayer(off);
    if (pl == null) {
        return;
    }
...
//处理出牌,打牌动作
PlayLayer_doudizhu.prototype.dealPKPutcard = function (off, msg) {
    var sData = MjClient.data.sData;
    var tData = sData.tData;
...
PlayLayer_doudizhu.prototype.playAnimation = function (cards, off) {
    var pl = getUIPlayer(off);
    if (!pl) { return ; }
...
// 增加底牌
PlayLayer_doudizhu.prototype.addDiCardsToZhuang = function (zhuangOff) {
    var tData = MjClient.data.sData.tData;
...
// 处理准备字准备相关
PlayLayer_doudizhu.prototype.handleAboutReady = function (off, bAllReady) {
...
PlayLayer_doudizhu.prototype.startTimeClock = function (func) {
...
PlayLayer_doudizhu.prototype.killTimeClock = function () {
    MjClient.clockNode.getChildByName("number").stopAllActions();
    stopEffect(playTimeUpEff);
    playTimeUpEff = null;
};

PlayLayer_doudizhu.prototype.clockNumberUpdate = function (node, endFunc) {
    return arrowbkNumberUpdate(node, endFunc);
}

PlayLayer_doudizhu.prototype.checkRoomUiDelete = function () {
...
PlayLayer_doudizhu.prototype.showGps = function () {
...
// 地主的三张牌
PlayLayer_doudizhu.prototype.handleDoudizhuDiCards = function () {
...
PlayLayer_doudizhu.prototype.dealMJTick = function (eD) {
    for (var i = 0; i < this.headOffLen; i++) {
        var off = this.headOffArr[i];
        var pl = getUIPlayer(off);
        if (!pl) { continue ; }
...
PlayLayer_doudizhu.prototype.dealLogout = function () {
    if (MjClient.playui) {
...
PlayLayer_doudizhu.prototype.dealEndRoom = function (msg) {
...
PlayLayer_doudizhu.prototype.dealLeaveGame = function () {
    MjClient.playui.killTimeClock();
    MjClient.addHomeView();
    MjClient.playui.removeFromParent(true);
    delete MjClient.playui;
...
PlayLayer_doudizhu.prototype.dealLoadWxHead = function (eD) {
    for (var i = 0; i < this.headOffLen; i++) {
        var off = this.headOffArr[i];
...
PlayLayer_doudizhu.prototype.dealPlayVoice = function (msg) {
    for (var i = 0; i < this.headOffLen; i++) {
        var off = this.headOffArr[i];
...
PlayLayer_doudizhu.prototype.dealChangeGameBgEvent = function () {
...
PlayLayer_doudizhu.prototype.handlePlayerChange = function (action, uid) {
    if (!this.isSDataValid()) {
        return ;
    }
    var targetOff = -1;
...
PlayLayer_doudizhu.prototype.dealMoveHead = function () {
    var that = this;
    var fun1 = function () {
...
// =========================[[ 消息 ]] ===========================
// 加倍
PlayLayer_doudizhu.prototype.sendJiaBeiToServer = function (beishu) {
...
// 叫地主、不叫、叫分
PlayLayer_doudizhu.prototype.sendQiangdizhuToServer = function (bQiang) {
    // MjClient.playui.setJingDianBtnVisible(false);
    MjClient.playui.setHuanLeBtnVisible(false);
    MjClient.gamenet.request("pkroom.handler.tableMsg", {
        cmd: "Qiangdizhu",
...
// 出牌
PlayLayer_doudizhu.prototype.sendPutCardsToServer = function () {
    if (this.isCardsSend) {
        return;
    }
    ;
...
// 准备-1， 提示过牌0， 不出 1
PlayLayer_doudizhu.prototype.sendPassToServer = function (isActivePass) {
    this.handCardsWgetArr[0].clearCardsUpStatus();
...
// =========================[[ 初始化 ]] ==========================
PlayLayer_doudizhu.prototype.initTagList = function () {
    this.btnTagList = {
        BtnPutCard: 1,
        BtnHimt: 2,
        BtnNoPut: 3,
...
PlayLayer_doudizhu.prototype.initData = function (isRoundEnd) {
    this.cardTipsArr = [];
    this.tipsIdx = 0;
...
PlayLayer_doudizhu.prototype.initOnce = function () {
...
PlayLayer_doudizhu.prototype.initUI = function () {
...
// 初始化节点
PlayLayer_doudizhu.prototype.initHeadWget = function () {
    this.headOffArr = [];
    this.headNode = {};
    this.AniMotion = [];
...
//初始化玩家信息
PlayLayer_doudizhu.prototype.initMsgEvent = function () {
    // ================ 重连 =========================
...
PlayLayer_doudizhu.prototype.initClickEvent = function () {
    ...
    var btnList1 = ["BtnPutCard", "BtnHimt", "BtnNoPut", "BtnJiaodizhu", "Btnbujiao", "BtnTi", "BtnBuTi",
        "gps_btn", "chat_btn", "BtnReady", "BtnPass"];
...
PlayLayer_doudizhu.prototype.btnBindCallBack = function (parent, str, tag, callback) {
    var tmpNode = parent.getChildByName(str);
    tmpNode.tag = tag;
    tmpNode.addTouchEventListener(callback);
};

PlayLayer_doudizhu.prototype.btnEventListener = function (sender, type) {
...
// 初始化时钟节点
PlayLayer_doudizhu.prototype.initClockWget = function () {
    for (var off = 0; off < 4; off++) {
        var _node = getNode(off);
...
PlayLayer_doudizhu.prototype.isSDataValid = function() {
    var sData = MjClient.data.sData;
