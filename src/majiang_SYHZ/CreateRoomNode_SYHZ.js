...
var CreateRoomNode_TYHZ = CreateRoomNode.extend({
    ...
    initPlayNode:function()
    {
        ...
        if(MjClient.getAppType() == MjClient.APP_TYPE.QXSYDTZ || MjClient.getAppType() == MjClient.APP_TYPE.HUNANWANGWANG){
            ...
            // 不中算全中
            this._playNode_wuHongZhongNiao = _play.getChildByName("wuHongZhongNiao");
        ...
        this._playNode_niaoFen_1.schedule(function() {
            ...
            if((MjClient.getAppType() == MjClient.APP_TYPE.HUNANWANGWANG || MjClient.getAppType() == MjClient.APP_TYPE.QXSYDTZ)
                && (this._playNode_niaoType_1.isSelected() || this._playNode_niaoType_5.isSelected()))
            {
                this._playNode_niaoFen_1.setVisible(true);
                this._playNode_niaoFen_2.setVisible(true);
            }
            if(MjClient.getAppType() == MjClient.APP_TYPE.HUNANWANGWANG || MjClient.getAppType() == MjClient.APP_TYPE.QXSYDTZ){
                this._playNode_zhongNiao.setVisible(this._playNode_niaoType_2.isSelected() || this._playNode_niaoType_3.isSelected() || this._playNode_niaoType_4.isSelected());
                this._playNode_quanZhongFanBei.setVisible(this._playNode_niaoType_2.isSelected() || this._playNode_niaoType_3.isSelected() || this._playNode_niaoType_4.isSelected());
                this._playNode_wuHongZhongNiao.setVisible(this._playNode_niaoType_2.isSelected() || this._playNode_niaoType_3.isSelected() || this._playNode_niaoType_4.isSelected());
            }
        ...
        if(MjClient.getAppType() == MjClient.APP_TYPE.HUNANWANGWANG || MjClient.getAppType() == MjClient.APP_TYPE.QXSYDTZ){
            ...
            cc.eventManager.addListener(this.setTextClick(),this._playNode_qiShouHongZhong.getChildByName("text"));
            this._playNode_qiShouHongZhong.addEventListener(this._clickCB, this._playNode_qiShouHongZhong);
            // 一炮多响
    ...
    setPlayNodeCurrentSelect:function(isClub)
    {
        ...
        if(this._playNode_niaoType_5){
            list.push(this._playNode_niaoType_5);
        }
        if(this._playNode_niaoType_6){
            list.push(this._playNode_niaoType_6);
        }
        var index = 0;
    ...
    getSelectedPara:function()
    {
        ...
        if(MjClient.getAppType() != MjClient.APP_TYPE.HUNANWANGWANG && MjClient.getAppType() != MjClient.APP_TYPE.QXSYDTZ && (para.zhuaniao == 1 || para.zhuaniao == 8)) para.niaofen = 1;
        ...
        if(MjClient.getAppType() == MjClient.APP_TYPE.HUNANWANGWANG || MjClient.getAppType() == MjClient.APP_TYPE.QXSYDTZ){
            var isShow = this._playNode_zhongNiao.isVisible();
