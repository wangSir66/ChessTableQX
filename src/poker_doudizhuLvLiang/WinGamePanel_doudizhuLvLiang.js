...
function SetEndOneUserUI_doudizhuLvLiang(node, off) {
        ...
        head: {
            ...
            stand: {
                ...
                _run: function () {
                    ...
                    CardLayoutRestoreForEndOne_doudizhuLvLiang(node, pl);
                }
            },
            cardType: {
                _run:function()
...
function CardLayoutRestoreForEndOne_doudizhuLvLiang(node, plNode) {
...
var EndOneView_doudizhuLvLiang = cc.Layer.extend({
    jsBind: {
        block: {
        ...
        back: {
            ...
            dir_0: {
                ...
                _text: function () {
                    ...
                    if (tData.areaSelectMode.zhafengding == -1)
                        text += "不封顶,";
                    else
            ...
            head0: {
                ...
                _run: function () { SetEndOneUserUI_doudizhuLvLiang(this, 0); },
    		...
    		, head1: {
    		    ...
    		    _run: function () { SetEndOneUserUI_doudizhuLvLiang(this, 1); }
    		}
    		...
    		, head2: {
    		    ...
    		    _run: function () { SetEndOneUserUI_doudizhuLvLiang(this, 2); }
    		},
            publicMutiple: {
                _run:function()
                {
    ...
    ctor: function (zhuang) {
        ...
        var endoneui = ccs.load("endOne_doudizhuLvLiang.json");
