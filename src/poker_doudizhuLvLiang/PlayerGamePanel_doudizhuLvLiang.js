...
var PlayLayer_doudizhuLvLiang = cc.Layer.extend({
    ctor: function () {
        this._super();
        var playui = ccs.load("Play_doudizhuLvLiang.json");
...
//出牌提示
PlayLayer_doudizhuLvLiang.prototype.showTipCards = function () {
...
// 处理斗地主智能提牌
PlayLayer_doudizhuLvLiang.prototype.handleDoudizhuCardsAutoUp = function (bTouchMove) {
    if (!this.isSDataValid()) {
        return ;
    }
    var tData = MjClient.data.sData.tData;
...
PlayLayer_doudizhuLvLiang.prototype.handleCardsTouchListener = function () {
    return {
...
// 处理点击
PlayLayer_doudizhuLvLiang.prototype.handleTouchCards = function (touch, event, isBegan) {
...
// 处理玩家提起提起得牌，保留正确的牌
PlayLayer_doudizhuLvLiang.prototype.handleUpRightCards = function (isFirst, off) {
    if (isFirst) {
        return;
    }
...
// =========================[[ 流程 ]] =========================
// 断线重连/初始化
PlayLayer_doudizhuLvLiang.prototype.dealInitSceneData = function () {
    if (!this.isSDataValid()) {
        return ;
    }
    var tData = MjClient.data.sData.tData;
...
PlayLayer_doudizhuLvLiang.prototype.dealChangePKImg = function () {
...
// 结算
PlayLayer_doudizhuLvLiang.prototype.dealRoundEnd = function (eD) {
    if (!this.isSDataValid()) {
        return ;
    }
    ...
    function delayExe() {
        ...
        self.addChild(new EndOneView_doudizhuLvLiang(zhuang), 500);
    }
...
// 过、准备
PlayLayer_doudizhuLvLiang.prototype.dealPKPass = function (eD) {
    MjClient.playui.killTimeClock();
    MjClient.clockNode.visible = false;
...
// 出牌
PlayLayer_doudizhuLvLiang.prototype.dealPKPut = function (msg) {
    var tData = MjClient.data.sData.tData;
    tData.rate = msg.rate;
...
// 等待出牌
PlayLayer_doudizhuLvLiang.prototype.dealWaitPut = function (eD) {
    var tData = MjClient.data.sData.tData;
...
// 等待叫地主
PlayLayer_doudizhuLvLiang.prototype.dealWaitJiaodizhu = function (msg) {
    var sData = MjClient.data.sData;
    var tData = sData.tData;
    ...
    if (tData.uids[msg.curPlayer] == SelfUid()) {//经典斗地主
...
// 抢地主
PlayLayer_doudizhuLvLiang.prototype.dealQiangDizhu = function (msg) {
    var tData = MjClient.data.sData.tData;
...
// 等待准备
PlayLayer_doudizhuLvLiang.prototype.dealAllReady = function (bAllReady) {
    for (var i = 0; i < this.headOffLen; i++) {
        var off = this.headOffArr[i];
...
// 加倍
PlayLayer_doudizhuLvLiang.prototype.dealMJJiazhu = function (isSceneData, off, jiazhuNum, curPlayer) {
    var tData = MjClient.data.sData.tData;
...
// 等待加倍
PlayLayer_doudizhuLvLiang.prototype.dealWaitJiazhu = function (eD, bSceneData) {
    var tData = MjClient.data.sData.tData;
    if (eD.zhuang != undefined) {
    ...
    if (tData.uids[tData.zhuang] == pl.info.uid) {
        ...
        MjClient.playui.setHLJiabeiVisible(bShow);
    } else {
        var hideFunc = function () {
            MjClient.playui.setHLJiabeiVisible(false);
        };
        MjClient.playui.node.runAction(cc.sequence(cc.callFunc(hideFunc), cc.DelayTime(0.9), cc.callFunc(function(){
...
// 处理手牌
PlayLayer_doudizhuLvLiang.prototype.handleMjHand = function () {
    if (!this.isSDataValid()) {
        return ;
    }
...
// 处理底牌
PlayLayer_doudizhuLvLiang.prototype.dealDiCards = function (zhuang, diCards, handCounts, isAddCards, isIconMove) {
    var tData = MjClient.data.sData.tData;
    tData.zhuang = zhuang;
...
PlayLayer_doudizhuLvLiang.prototype.updateUserHeadPosition = function (off, bRoundEnd) {
...
PlayLayer_doudizhuLvLiang.prototype.updateTimes = function () {
...
//设置地区信息
PlayLayer_doudizhuLvLiang.prototype.showGameName = function () {
...
//添加还背景的功能
PlayLayer_doudizhuLvLiang.prototype.addChangeBg = function () {
...
PlayLayer_doudizhuLvLiang.prototype.showVoice = function () {
...
PlayLayer_doudizhuLvLiang.prototype.addWaitNode = function () {
...
PlayLayer_doudizhuLvLiang.prototype.addAniLayer = function () {
...
PlayLayer_doudizhuLvLiang.prototype.setWaitNodeVisible = function (bVisible) {
    if (!MjClient.playui.waitNode) {
        return;
    }
    MjClient.playui.waitNode.setVisible(bVisible);
}
PlayLayer_doudizhuLvLiang.prototype.showTableID = function (bShow) {
...
PlayLayer_doudizhuLvLiang.prototype.setHLJiabeiVisible = function (bVisible) {
...
// 出牌按钮
PlayLayer_doudizhuLvLiang.prototype.handlePutCardBtn = function (isVisible, isFirst) {
...
PlayLayer_doudizhuLvLiang.prototype.enablePutCardBtn = function (bAble) {
    var btnPutCard = this.node.getChildByName("BtnPutCard");
...
//操作按钮(提示和不出)
PlayLayer_doudizhuLvLiang.prototype.handleHimtAndNoPutBtn = function (isVisible, isAble) {
...
//经典斗地主叫分按钮
PlayLayer_doudizhuLvLiang.prototype.setJingDianBtnVisible = function (bVisible, buJiaoAble, score, bmustjiao) {
...
// 牌局信息
PlayLayer_doudizhuLvLiang.prototype.showRoundInfo = function () {
    if (!this.isSDataValid()) {
        return ;
    }
...
// 局数
PlayLayer_doudizhuLvLiang.prototype.updateGameRound = function () {
...
// 加倍
PlayLayer_doudizhuLvLiang.prototype.setTextMult = function (bShow) {
...
//加倍
PlayLayer_doudizhuLvLiang.prototype.handleJiabeiTag = function (off, type) {
    var node = getNode_cards(off);
    ...
    if (off == 0) {
        ...
        setWgtLayout(jiabeiTag, [0.117, 0], [1.12, 0.696], [-2.5, 0.5]);
    } else if (off == 2) {
        var addx = isIPhoneX() ? 0.05 : 0;
        setWgtLayout(jiabeiTag, [0.117, 0], [0.17 + addx, 0.696], [0.05, 0.5]);
    }
    var jiabeistr;
...
// 底分
PlayLayer_doudizhuLvLiang.prototype.handleDifen = function () {
...
// 不抢/抢地主
PlayLayer_doudizhuLvLiang.prototype.dealQiangDizhuText = function (off, visible, msg) {
    var node = getNode_cards(off);
    var diZhuTag = node.getChildByName("jiaodizhuTag");
...
// 要不起
PlayLayer_doudizhuLvLiang.prototype.handleNoPutTag = function (off, visible) {
    var node = getNode_cards(off);
...
// 没有大过上家
PlayLayer_doudizhuLvLiang.prototype.handleNoPutTips = function (isVisible) {
...
// 没有大过上家
PlayLayer_doudizhuLvLiang.prototype.handlePassBtn = function (isVisible) {
...
// =========================[[ 系统 ]] ==========================
PlayLayer_doudizhuLvLiang.prototype.dealSendVoice = function (fullFilePath) {
    if (!fullFilePath) {
...
PlayLayer_doudizhuLvLiang.prototype.dealDownAndPlayVoice = function (msg) {
...
PlayLayer_doudizhuLvLiang.prototype.dealUploadRecord = function (filePath) {
    if (filePath) {
...
// 绘制手牌
PlayLayer_doudizhuLvLiang.prototype.initUserHandUiDoudizhu = function (off) {
    var pl = getUIPlayer(off);
    if (pl == null) {
        return;
    }
...
//处理出牌,打牌动作
PlayLayer_doudizhuLvLiang.prototype.dealPKPutcard = function (off, msg) {
    var sData = MjClient.data.sData;
    var tData = sData.tData;
...
PlayLayer_doudizhuLvLiang.prototype.playAnimation = function (cards, off) {
    var pl = getUIPlayer(off);
    if (!pl) { return ; }
...
// 增加底牌
PlayLayer_doudizhuLvLiang.prototype.addDiCardsToZhuang = function (zhuangOff) {
    var tData = MjClient.data.sData.tData;
...
PlayLayer_doudizhuLvLiang.prototype.hideAllUI = function () {
...
// 处理准备字准备相关
PlayLayer_doudizhuLvLiang.prototype.handleAboutReady = function (off, bAllReady) {
...
PlayLayer_doudizhuLvLiang.prototype.startTimeClock = function (func) {
...
PlayLayer_doudizhuLvLiang.prototype.killTimeClock = function () {
    MjClient.clockNode.getChildByName("number").stopAllActions();
    stopEffect(playTimeUpEff);
    playTimeUpEff = null;
};

PlayLayer_doudizhuLvLiang.prototype.clockNumberUpdate = function (node, endFunc) {
    return arrowbkNumberUpdate(node, endFunc);
}

PlayLayer_doudizhuLvLiang.prototype.checkRoomUiDelete = function () {
...
PlayLayer_doudizhuLvLiang.prototype.showGps = function () {
...
// 地主的三张牌
PlayLayer_doudizhuLvLiang.prototype.handleDoudizhuDiCards = function () {
...
PlayLayer_doudizhuLvLiang.prototype.dealMJTick = function (eD) {
    for (var i = 0; i < this.headOffLen; i++) {
        var off = this.headOffArr[i];
        var pl = getUIPlayer(off);
        if (!pl) { continue ; }
...
PlayLayer_doudizhuLvLiang.prototype.dealLogout = function () {
    if (MjClient.playui) {
...
PlayLayer_doudizhuLvLiang.prototype.dealEndRoom = function (msg) {
...
PlayLayer_doudizhuLvLiang.prototype.dealLeaveGame = function () {
    MjClient.playui.killTimeClock();
    MjClient.addHomeView();
    MjClient.playui.removeFromParent(true);
    delete MjClient.playui;
...
PlayLayer_doudizhuLvLiang.prototype.dealLoadWxHead = function (eD) {
    for (var i = 0; i < this.headOffLen; i++) {
        var off = this.headOffArr[i];
...
PlayLayer_doudizhuLvLiang.prototype.dealPlayVoice = function (msg) {
    for (var i = 0; i < this.headOffLen; i++) {
        var off = this.headOffArr[i];
...
PlayLayer_doudizhuLvLiang.prototype.dealChangeGameBgEvent = function () {
...
PlayLayer_doudizhuLvLiang.prototype.handlePlayerChange = function (action, uid) {
    if (!this.isSDataValid()) {
        return ;
    }
    var targetOff = -1;
...
PlayLayer_doudizhuLvLiang.prototype.dealMoveHead = function () {
    var that =this;
    var fun1 = function (){
...
// =========================[[ 消息 ]] ===========================
// 加倍
PlayLayer_doudizhuLvLiang.prototype.sendJiaBeiToServer = function (beishu) {
    MjClient.playui.setHLJiabeiVisible(false);
    MjClient.gamenet.request("pkroom.handler.tableMsg", {
        cmd: "MJJiazhu",
        jiazhuNum: beishu,
...
// 叫地主、不叫、叫分
PlayLayer_doudizhuLvLiang.prototype.sendQiangdizhuToServer = function (bQiang) {
    MjClient.playui.setJingDianBtnVisible(false);
    MjClient.gamenet.request("pkroom.handler.tableMsg", {
        cmd: "Qiangdizhu",
        qiang: bQiang
...
// 出牌
PlayLayer_doudizhuLvLiang.prototype.sendPutCardsToServer = function () {
    if (this.isCardsSend) {
        return;
    }
    ;
...
// 准备-1， 提示过牌0， 不出 1
PlayLayer_doudizhuLvLiang.prototype.sendPassToServer = function (isActivePass) {
    this.handCardsWgetArr[0].clearCardsUpStatus();
...
// =========================[[ 初始化 ]] ==========================
PlayLayer_doudizhuLvLiang.prototype.initData = function (isRoundEnd) {
    this.cardTipsArr = [];
    this.tipsIdx = 0;
...
PlayLayer_doudizhuLvLiang.prototype.initTagList = function () {
    this.btnTagList = {
        BtnPutCard: 1, BtnHimt: 2, BtnNoPut: 3, BtnReady: 4, BtnJiabei: 5, Btnbujiabei: 6, Btnbujiao_JD: 7,
        Btnfen1: 8, Btnfen2: 9, Btnfen3: 10, setting: 11, back_btn: 12, Button_1: 13, gps_btn: 18, chat_btn: 19, BtnPass:20
    };
}
PlayLayer_doudizhuLvLiang.prototype.initOnce = function () {
...
PlayLayer_doudizhuLvLiang.prototype.initUI = function () {
...
// 初始化节点
PlayLayer_doudizhuLvLiang.prototype.initHeadWget = function () {
    this.headOffArr = [];
    this.headNode = {};
    this.AniMotion = [];
...
//初始化玩家信息
PlayLayer_doudizhuLvLiang.prototype.initMsgEvent = function () {
    // ================ 重连 =========================
...
PlayLayer_doudizhuLvLiang.prototype.initClickEvent = function () {
    var btnCallback = function (sender, type) {
        if (type == ccui.Widget.TOUCH_ENDED) {
            MjClient.playui.btnEventListener(sender, type);
        }
    }
    var btnList1 = ["BtnPutCard", "BtnHimt", "BtnNoPut",
...
PlayLayer_doudizhuLvLiang.prototype.btnBindCallBack = function (parent, str, tag, callback) {
    var tmpNode = parent.getChildByName(str);
    tmpNode.tag = tag;
    tmpNode.addTouchEventListener(callback);
};

PlayLayer_doudizhuLvLiang.prototype.btnEventListener = function (sender, type) {
...
// 初始化时钟节点
PlayLayer_doudizhuLvLiang.prototype.initClockWget = function () {
    for (var off = 0; off < 4; off++) {
        var _node = getNode(off);
...
PlayLayer_doudizhuLvLiang.prototype.isSDataValid = function() {
    var sData = MjClient.data.sData;
