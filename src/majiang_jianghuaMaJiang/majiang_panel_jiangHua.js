//邵阳江华麻将
var majiang_panel_jiangHua;
(function() {
    majiang_panel_jiangHua = majiang_panel_shaoyang.extend({
        getJsBind: function(){
            var jsBind = {
                img_roomInfo2D: {
                    node_hunPai: {
        ...
        ctor: function() {
            this._super(majiang_panel_jiangHua, "Play_MaJiangJiangHua.json");
            return true;
        }
    });
    
    //Override
    majiang_panel_jiangHua.prototype.isCanAutoPut = function(){
        return false;
    };

    //Override 
    majiang_panel_jiangHua.prototype.getVoiceType = function(){ 
        return util.localStorageEncrypt.getNumberItem(MjClient.KEY_MJ_VOICE_TYPE, 0);
    };

    //Override
    majiang_panel_jiangHua.prototype.getCardSizeType = function(){ 
        return util.localStorageEncrypt.getNumberItem(MjClient.KEY_MJ_CARD_SIZE_TYPE, 0);
    };

    //Override
    majiang_panel_jiangHua.prototype.getEndallStatisticsName = function(cardTag, isLoop){
        return ["zimoTotal", "dianpaoTotal", "angangTotal", "minggangTotal"];
    };

    //Override
    majiang_panel_jiangHua.prototype.getEndallStatisticsKey = function(cardTag, isLoop){
        return ["自摸次数", "点炮次数", "暗杠次数", "明杠次数"];
    };

    //Override
    majiang_panel_jiangHua.prototype.getLaiZiIcon2D = function(){
    ...
    //Override
    majiang_panel_jiangHua.prototype.getPlayerEatNode = function() {
    ...
    //Override
    majiang_panel_jiangHua.prototype.checkGangBtn = function(player){
    ...
    //Override
    majiang_panel_jiangHua.prototype.getCardSortArray2D = function(node, newCardTag){
        var tData = MjClient.data.sData.tData;
    ...
    //Override
    majiang_panel_jiangHua.prototype.getCardSortArray3D = function(node, newCardTag){
        var tData = MjClient.data.sData.tData;
    ...
    //Override
    majiang_panel_jiangHua.prototype.getInsertCardPosIndex = function (handcardUI, index) {
