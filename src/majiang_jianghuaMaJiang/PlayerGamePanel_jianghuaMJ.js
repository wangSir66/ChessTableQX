...
//向服务器发送 过消息
MjClient.MJPass2NetForJianghuaMJ = function()
{
   // console.log(">>>>>>>>>普通  过 <<<<<<<<");
    cc.log("====================send======pass=====");
...
function SetUserVisible_JiangHuaMJ(node, off)
{
    //var sData = MjClient.data.sData;
    //return;
    cc.log("====================off======================" + off);
...
function InitUserHandUI_JiangHuaMJ(node, off)
{
    var sData = MjClient.data.sData;
    var tData = sData.tData;
    var pl = getUIPlayer(off);
...
var PlayLayer_jiangHuaMJ = cc.Layer.extend({
    jsBind: {
        _event: {
            mjhand: function() {
            ...
            roundEnd: function() {
                ...
                function delayExe()
                {
                    ...
                    self.addChild(new EndOneView_jiangHuaMJ(),500);
                }
        ...
        down: {
            ...
            _event: {
                ...
                initSceneData: function(eD) {
                    SetUserVisible_JiangHuaMJ(this, 0);
                },
                addPlayer: function(eD) {
                    SetUserVisible_JiangHuaMJ(this, 0);
                },
                ...
                mjhand: function(eD) {
                    InitUserHandUI_JiangHuaMJ(this, 0);
                },
                roundEnd: function() {
        ...
        right: {
            ...
            _event: {
                ...
                initSceneData: function(eD) {
                    SetUserVisible_JiangHuaMJ(this, 1);
                },
                addPlayer: function(eD) {
                    SetUserVisible_JiangHuaMJ(this, 1);
                },
        ...
        top: {
            ...
            _event: {
                ...
                initSceneData: function(eD) {
                    SetUserVisible_JiangHuaMJ(this, 2);
                },
                addPlayer: function(eD) {
                    SetUserVisible_JiangHuaMJ(this, 2);
                },
        ...
        left: {
            ...
            _event: {
                ...
                initSceneData: function(eD) {
                    SetUserVisible_JiangHuaMJ(this, 3);
                },
                addPlayer: function(eD) {
                    SetUserVisible_JiangHuaMJ(this, 3);
                },
        ...
        eat: {
            ...
            guo: {
                ...
                _touch: function(btn, eT) {
                    if (eT == 2)
                    {
                        MjClient.MJPass2NetForJianghuaMJ();
                    }
                },
                bgimg: {
                    _run: function() {
            ...
            changeui: {
                ...
                changeuibg: {
                    ...
                    guobg: {
                        guo: {
                            _touch: function(btn, eT) {
                                if (eT == 2) MjClient.MJPass2NetForJianghuaMJ();
                            }
                        },
                        fanhui: {
                            _touch: function(btn, et) {
...
PlayLayer_jiangHuaMJ.prototype.CardLayoutRestore = function(node, off)
{
...
// 判断吃碰杠胡的状态
PlayLayer_jiangHuaMJ.prototype.EatVisibleCheck = function()
{
    var eat = MjClient.playui.jsBind.eat;
