...
PokerYongLiSanDaHa.prototype.CARDTPYE = PDK_CARDTPYE;
var PDK_CARDCOUNT = {};
...
PokerYongLiSanDaHa.prototype.randomCards = function(areaSelectMode, tData) {
    var cards = [];
    // 去掉3、4
    for (var i = 1; i <= 54; i++) {
...
PokerYongLiSanDaHa.prototype.cardlog = function(cards, zhuColorType) {
 ...
 */
PokerYongLiSanDaHa.prototype.countWinType = function(jiaofen, PfenPaiArr, isTouXiang, Pkoudifen) {
...
PokerYongLiSanDaHa.prototype.isWuZhu = function(zhuColorType) {
...
PokerYongLiSanDaHa.prototype.calPoint = function(num) {
    if (!num) return -1;
...
PokerYongLiSanDaHa.prototype.calPointBySdh = function(num, zhuColorType) {
    if (!num) return -1;
...
// 牌的花色
PokerYongLiSanDaHa.prototype.calColor = function(num) {
    if (!num) return -1;
    // 0:方块  1:梅花  2:梅花  3:黑桃
...
PokerYongLiSanDaHa.prototype.calColorSdh = function(num, zhuColorType) {
    if (!num) return -1;
...
// 判断此牌是否是主花
PokerYongLiSanDaHa.prototype.isZhuCard = function(num, zhuColorType) {
    var point = this.calPoint(num);
    var color = this.calColor(num);
...
PokerYongLiSanDaHa.prototype.getChangZhuCount = function(oCards) {
...
PokerYongLiSanDaHa.prototype.getRoundFirstCards = function(putCardsRecord, uid, maxPlayNum) {
...
PokerYongLiSanDaHa.prototype.getRoundCardsByUid = function(putCardsRecord, uid, maxPlayNum) {
    if(!putCardsRecord || typeof putCardsRecord == 'undefined') {
        return null;
    }
...
// 获取本轮最大的牌， 同点数先出比后出的大
PokerYongLiSanDaHa.prototype.getMaxCardPlayerUid = function(roundPutCards, firstPutUid, uids, zhuColorType,bteshutuolaji,bchou6) {
    var frontUid = -1;
    if(!roundPutCards || typeof roundPutCards == 'undefined') {
        return frontUid;
    }
...
PokerYongLiSanDaHa.prototype.getAllCardFen = function( fenPaiArr ) {
    var fen = 0;
...
// 获得牌的分  非分牌返回0分 
PokerYongLiSanDaHa.prototype.getCardFen = function(num) {
...
// 获取所有对应牌数的拖拉机组合
PokerYongLiSanDaHa.prototype.getLianDuiCards = function(oCards, cardNum, zhuColorType,bteshutuolaji,bchou6) {
...
// 获取所有对应牌数的拖拉机组合
PokerYongLiSanDaHa.prototype.getDuiZis = function(oCards, zhuColorType) {
...
PokerYongLiSanDaHa.prototype.countDuiNum = function(oCards, zhuColorType) {
    var num = 0;
    var cardNumByValue = {};
    for(var i in oCards){
...
PokerYongLiSanDaHa.prototype.isChangZhu = function (num) {
    var point = this.calPoint(num);
 ...
 * @return {bool}
 */
PokerYongLiSanDaHa.prototype.isLiandui = function(oCards, zhuColorType,bteshutuolaji,bchou6) { //oCards有序
...
PokerYongLiSanDaHa.prototype.isDuizi = function(oCards) {
 ...
 */
PokerYongLiSanDaHa.prototype.calType = function(cards, zhuColorType,bteshutuolaji,bchou6) {
 ...
 * @return {number}
 */
PokerYongLiSanDaHa.prototype.calCardsValue = function(cards, zhuColorType) {
...
// // 牌点比较函数
PokerYongLiSanDaHa.prototype.cardValueCmp = function(a, b, zhuColorType) {
 ...
 */
PokerYongLiSanDaHa.prototype.isBigger = function(beiYaCards, oLastCards, zhuColorType,bteshutuolaji,bchou6) {
...
PokerYongLiSanDaHa.prototype.checkPut = function(oHands, cards) {
 ...
 */
PokerYongLiSanDaHa.prototype.checkPutSdh = function(oHands, pOutCards, oBeiYaCard, zhuColorType, isCanShuaiPai,tData) {
...
PokerYongLiSanDaHa.prototype.findCardByType = function(oHands, oBeiYaCard, zhuColorType) {
 ...
 * @return {array} 提示的牌
 */
PokerYongLiSanDaHa.prototype.tipCards = function(oHands, oBeiYaCard, zhuColorType,bteshutuolaji,bchou6) {
 ...
 */
PokerYongLiSanDaHa.prototype.sortHandCards = function(oCards, zhuColorType) {
 ...
 * @return {array}
 */
PokerYongLiSanDaHa.prototype.findNSameCard = function(hands, point, n, zhuColorType) {
...
// 删除相应牌值(不算花色)
PokerYongLiSanDaHa.prototype.delPoint = function(hands, points){
    var arr = hands.slice();
...
// 删除相同的牌(花色相同，牌值相同)
PokerYongLiSanDaHa.prototype.delCards = function(hands, cards) {
    var arr = hands.slice();
    for(var i=0; i < cards.length; i++){
        for (var j = 0; j < arr.length; j++) {
            if( arr[j] == cards[i] ){
...
// 从牌组中获取指定花色
PokerYongLiSanDaHa.prototype.getColorCards = function(cards, colors, zhuColorType) {
    var arr = [];
    for(var i=0; i < cards.length; i++) {
        var num = cards[i];
...
PokerYongLiSanDaHa.prototype.formatCards = function(oCards, zhuColorType) {
    var info = {};
...
PokerYongLiSanDaHa.prototype.isSameCards = function(cards1, cards2, zhuColorType) {
...
// 求出牌型
PokerYongLiSanDaHa.prototype.cardsType = function(oCards, zhuColorType,bteshutuolaji,bchou6) {
    if (oCards) {
...
PokerYongLiSanDaHa.prototype.isAllZhuCard = function(cards, zhuColorType) {
    for (var i = 0; i < cards.length; i++) {
...
if(typeof(module)!="undefined" && module.exports)    
    module.exports = PokerYongLiSanDaHa;

if(typeof(MjClient)!="undefined")
    MjClient.poker_YongLiSanDaHa = new PokerYongLiSanDaHa();
