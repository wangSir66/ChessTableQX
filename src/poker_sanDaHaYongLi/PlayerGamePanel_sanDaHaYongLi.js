...
function SetUserVisible_sanDaHaYongLi(node, off) {
    ...
    if (pl) {
        ...
        InitUserHandUI_sanDaHaYongLi(node, off);
    } else {
        name.visible = false;
        coin.visible = false;
...
function InitUserHandUI_sanDaHaYongLi(node, off) {
...
var PlayLayer_sanDaHaYongLi = cc.Layer.extend({
    _btnPutCard: null,
    jsBind: {
        _event: {
            mjhand: function() {
            ...
            roundEnd: function() {
                ...
                function delayExe() {
                    ...
                    self.addChild(new EndOneView_sanDaHaYongLi(), 500);
                }
        ...
        down: {
            ...
            _event: {
                ...
                initSceneData: function(eD) {
                    SetUserVisible_sanDaHaYongLi(this, 0);
                ...
                mjhand: function(eD) {
                    ...
                    InitUserHandUI_sanDaHaYongLi(this, 0);
        ...
        right: {
            ...
            _event: {
                ...
                initSceneData: function(eD) {
                    SetUserVisible_sanDaHaYongLi(this, 1);
                },
                addPlayer: function(eD) {
                    SetUserVisible_sanDaHaYongLi(this, 1);
                },
                ...
                mjhand: function(eD) {
                    InitUserHandUI_sanDaHaYongLi(this, 1);
                },
                roundEnd: function() {
        ...
        top: {
            ...
            _event: {
                ...
                initSceneData: function(eD) {
                    SetUserVisible_sanDaHaYongLi(this, 2);
                },
                addPlayer: function(eD) {
                    SetUserVisible_sanDaHaYongLi(this, 2);
                },
                ...
                mjhand: function(eD) {
                    InitUserHandUI_sanDaHaYongLi(this, 2);
                },
                roundEnd: function() {
        ...
        left: {
            ...
            _event: {
                ...
                initSceneData: function(eD) {
                    SetUserVisible_sanDaHaYongLi(this, 3);
                },
                addPlayer: function(eD) {
                    SetUserVisible_sanDaHaYongLi(this, 3);
                },
                ...
                mjhand: function(eD) {
                    InitUserHandUI_sanDaHaYongLi(this, 3);
                },
                roundEnd: function() {
    ...
    ctor: function() {
        this._super();
        var playui = ccs.load("Play_sanDaHaYongLi.json");
...
PlayLayer_sanDaHaYongLi.prototype.reConnectShowDeskCard = function() {
    var tData = MjClient.data.sData.tData;
...
PlayLayer_sanDaHaYongLi.prototype.cannotOutCardGrey = function() {
...
PlayLayer_sanDaHaYongLi.prototype.recoverCannotOutCard = function() {
    var children = this._downNode.children;
    for (var i = 0; i < children.length; i++) {
        if (children[i].name != "mjhand")
            continue;
...
PlayLayer_sanDaHaYongLi.prototype.clockNumberUpdate = function(node, endFunc) {
    return arrowbkNumberUpdate(node, endFunc);
}

PlayLayer_sanDaHaYongLi.prototype.updateClockPosition = function(arrowNode) {
    var tData = MjClient.data.sData.tData;
    var uids = tData.uids;
 ...
 * @return {String}
 */
PlayLayer_sanDaHaYongLi.prototype.getGameInfoString = function(param) {
    var tData = MjClient.data.sData.tData;
...
PlayLayer_sanDaHaYongLi.prototype.updateOperateBtnPosition = function() {
...
// 拖拉机动画
PlayLayer_sanDaHaYongLi.prototype.playCardAni_liandui = function() {
...
// 闲家得分达到条件时动画、投降
PlayLayer_sanDaHaYongLi.prototype.playWinAni = function(winType) {
...
// 刷新得分栏
PlayLayer_sanDaHaYongLi.prototype.refreshScoreBanner = function(shouldPlayAnim) {
    var tData = MjClient.data.sData.tData;
...
// 判断是否有不同意投降的玩家
PlayLayer_sanDaHaYongLi.prototype.haveNotAgreeTouXiang = function()
{
    var sData = MjClient.data.sData;
    var tData = MjClient.data.sData.tData;
...
// 重置玩家同意投降状态
PlayLayer_sanDaHaYongLi.prototype.initAgreeTouXiangStatus = function()
{
    var sData = MjClient.data.sData;
    var tData = MjClient.data.sData.tData;
    for (var i = 0; i < tData.uids.length; i++)
...
PlayLayer_sanDaHaYongLi.prototype.showWaitTip = function(isTouXiang) {
    var sData = MjClient.data.sData;
    var tData = sData.tData;
...
PlayLayer_sanDaHaYongLi.prototype.clearWaitTip = function() {
...
// 显示各玩家叫分
PlayLayer_sanDaHaYongLi.prototype.showJiaoFenTag = function(off) {
    var tData = MjClient.data.sData.tData;
...
// 隐藏各玩家叫分
PlayLayer_sanDaHaYongLi.prototype.hideJiaoFenTag = function() {
...
// 显示叫分面板
PlayLayer_sanDaHaYongLi.prototype.showJiaoFenPanel = function() {
    if (MjClient.rePlayVideo != -1)
    {
        MjClient.playui.jsBind.panel.jiaoFenPanel._node.setVisible(false);
        return;
...
// 把底牌添加到手牌中
PlayLayer_sanDaHaYongLi.prototype.addDiPaiToHand = function() {
    var tData = MjClient.data.sData.tData;
...
// 从手牌中移除埋的牌
PlayLayer_sanDaHaYongLi.prototype.removeMaiPaiFromHand = function() {
    var tData = MjClient.data.sData.tData;
    var off = getOffByIndex(tData.curPlayer);
...
// 显示投降同意选择框
PlayLayer_sanDaHaYongLi.prototype.showTouXuangDialog = function() {
     if (MjClient.rePlayVideo != -1)
        return;
...
// 显示叫主面板
PlayLayer_sanDaHaYongLi.prototype.showJiaoZhuPanel = function() {
    var tData = MjClient.data.sData.tData;
...
// 显示埋牌、投降按扭
PlayLayer_sanDaHaYongLi.prototype.showMaiPaiBtn = function() {
    var tData = MjClient.data.sData.tData;
...
// 显示上一轮面板
PlayLayer_sanDaHaYongLi.prototype.showShangYiLunPanel = function(shangYiLunPanel) {
    var tData = MjClient.data.sData.tData;
...
// 显示查看底牌面板
PlayLayer_sanDaHaYongLi.prototype.showDiPaiPanel = function(diPaiPanel) {
    var tData = MjClient.data.sData.tData;
...
// 显示查牌面板
PlayLayer_sanDaHaYongLi.prototype.showChaPaiPanel = function(chaPaiPanel) {
    var tData = MjClient.data.sData.tData;
    var records = tData.putCardsRecord;
...
// 显示得分栏上的具体分牌
PlayLayer_sanDaHaYongLi.prototype.showScoreCards = function(panel, cards) {
...
// 给手牌中的主牌设置角标
PlayLayer_sanDaHaYongLi.prototype.setCardSprite_ZhuTag = function(node) {
    var tData = MjClient.data.sData.tData;
...
// 计算各牌色数量
PlayLayer_sanDaHaYongLi.prototype.getCardNumByColor = function(cards, colorIndex) {
    var num = 0;
    var types = [1, 2, 3, 0, 4]
    for (var i = 0; i < cards.length; i++) {
...
// 清空桌面
PlayLayer_sanDaHaYongLi.prototype.clearDesk = function() {
    cc.log("clearDesk")
...
PlayLayer_sanDaHaYongLi.prototype.CardLayoutRestore = function(node, off) {
    cc.log("横向排序 off=" + off);
    MjClient.playui.horSort(node, off);
};

PlayLayer_sanDaHaYongLi.prototype.CardLayoutDesk = function(node, cards, off) {
    //if(off != 0) return;
    var children = node.children;
...
//横向摆放《正常》
PlayLayer_sanDaHaYongLi.prototype.horSort = function(node, off) {
    var pl; //player 信息
...
PlayLayer_sanDaHaYongLi.prototype.DealCardEffect = function(uid, off)
{
    var tData = MjClient.data.sData.tData;
