function SetEndOneUserUI_SanDaHaYongLi(node, off) {
...
var EndOneView_sanDaHaYongLi = cc.Layer.extend({
    jsBind: {
        block: {
            _layout: [
                [1, 1],
        ...
        back: {
            ...
            image_player_zhuang: {
                _run: function() {
                    SetEndOneUserUI_SanDaHaYongLi(this, MjClient.endoneui.offs[0]);
                }
            },
            image_player_0: {
                _run: function() {
                    SetEndOneUserUI_SanDaHaYongLi(this, MjClient.endoneui.offs[1]);
                },
            },
            image_player_1: {
                _run: function() {
                    SetEndOneUserUI_SanDaHaYongLi(this, MjClient.endoneui.offs[2]);
                }
            },
            image_player_2: {
                _run: function() {
                    SetEndOneUserUI_SanDaHaYongLi(this, MjClient.endoneui.offs[3]);
                }
            },
        }
    },
    ctor: function() {
        ...
        var endoneui = ccs.load("endOne_sanDaHaYongLi.json");
