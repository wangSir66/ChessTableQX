...
function addWxHeadToEndUI_changDePaoHuZi(node,off)
{
...
function reInitarrCardVisible_changDePaoHuZi()
{
...
//添加手牌
function addWinMjHand_changDePaoHuZi(_node,off) {
    var sData = MjClient.data.sData;
    var tData = sData.tData;
    if(MjClient.GAME_TYPE.PAO_HU_ZI_SR == MjClient.gameType){
        off = getOffByXing_changDePaoHuZi(off);
    }
    ...
    for(var i = 0;i < sortArr.length;i++){
        ...
        for(var j = 0;j < childSort.length;j++){
            ...
            clone.visible = true;
            clone.loadTexture(MjClient.cardPath_changDePaoHuZi+"out" + card +".png");
            var off_y = 0;
            if(_node.getName() == "rightPanel"){
                off_y = clone.height;
                clone.anchorX = 1;
...
var EndOneView_changDePaoHuZi = cc.Layer.extend({
    _block:null,
    _endoneuiNode:null,
    jsBind:{
        block: {
        ...
        btn_ready:{
            ...
            _click: function(btn,eT){
                ...
                reInitarrCardVisible_changDePaoHuZi();
            }
        },
        btn_logic: {
            _run: function(){
        ...
        main:{
                ...
                _run:function(){
                    ...
                    if(tData.cardNext < cards.length){
                        ...
                        for(var i = tData.cardNext;i < cards.length;i++){
                            ...
                            cloneCard.loadTexture(MjClient.cardPath_changDePaoHuZi+"out" + card +".png");
            ...
            leftPanel:{
                _run:function(){
                    addWinMjHand_changDePaoHuZi(this, 2);
                    if(MjClient.rePlayVideo != -1  || MjClient.MaxPlayerNum_changDePaoHuZi < 3){
                        this.visible = false;
                    }
                }
            },
            rightPanel:{
                _run:function(){
                    addWinMjHand_changDePaoHuZi(this,1);
                ...
                _run: function(){
                    ...
                    var cloneFunc = function(cardNum){
                        if(cloneNum != 0){
                            ...
                            cloneCard.loadTexture(MjClient.cardPath_changDePaoHuZi+"out" + cardNum + ".png");
                            cloneNum++;
                            return cloneCard;
                        }
                        cloneNum++;
                        var cardImg = self.getChildByName("card");
                        cardImg.loadTexture(MjClient.cardPath_changDePaoHuZi+"out" + cardNum + ".png");
                        return cardImg;
                    }
            ...
            uiBg:{
                headNode: {
                    _run: function(){
                        ...
                        if(tData.winner != -1)
                            winOff = getUiOffByUid_changDePaoHuZi(pl.info.uid);

                        addWxHeadToEndUI_changDePaoHuZi(this,winOff);
                        ...
                        for(var index = 0;index<playerCount;index++){
                            if(index != winOff){
                                ...
                                addWxHeadToEndUI_changDePaoHuZi(cloneThis,index);
                                cloneNum++;
                            }
                        }
                    }
    ...
    ctor:function () {
        ...
        var endoneui = ccs.load("endOne_changDePaoHuZi.json");
    ...
    setWinCard: function(){
        ...
        var cloneCardsSetData = function(cardNode,i,num){
            ...
            cardImg.loadTexture(MjClient.cardPath_changDePaoHuZi+"out" + num + ".png");
            return cardImg;
        }
            ...
            if(index == "huXi" || index == "totalFan" || index == "tunNum" ){
                ...
                var setHuItem = function(){
                    ...
                    if(index == "ziMoJiaYiTun")
                    {
                        ...
                        if(index == "daTuanYuan"){ 
                            // 常德跑胡子只有8 没有6
                            num.setString(infoData.icon + 8 + value);
                        }else{
                            num.setString(infoData.icon + pl.hzdesc[index] + value);
                        } 
                    }
                ...
                if(index == "daTuanYuan" && (pl.hzdesc[index] / 8) > 1){
                    for (var i = 0; i < pl.hzdesc[index] / 8; i++) {
                        setHuItem(); 
                    }
                }else{
                  setHuItem();  
    ...
    setXingCardData: function(tData,num){
        ...
        card_img.loadTexture(MjClient.cardPath_changDePaoHuZi+"out" + tData.hunCard +".png");
