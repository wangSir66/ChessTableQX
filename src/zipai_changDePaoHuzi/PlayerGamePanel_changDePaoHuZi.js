...
function SetUserVisible_changDePaoHuZi(node, off){
    ...
    if(pl){
        ...
        setUserOffline_changDePaoHuZi(node, off);
...
function InitUserHandUI_changDePaoHuZi(node, off){
    ...
    if (pl.jiazhuNum == 2 && MjClient.rePlayVideo == -1)
    {
        ...
        MjClient.majiang.setJiaZhuNum(node, getUIPlayer_changDePaoHuZi(off));
    }
...
var PlayLayer_changDePaoHuZi = cc.Layer.extend({
    jsBind: {
        _event: {
            ...
            endRoom: function(msg) {
                ...
                if (msg.showEnd){
                    this.addChild(new GameOverLayer_changDePaoHuZi(),500);
                }else{
            ...
            roundEnd: function() {
                ...
                if(!MjClient.isDismiss && tData.hunCard && tData.hunCard != -1 && tData.areaSelectMode.xingType==2){
                    ...
                    ShowEatActionAnim_changDePaoHuZi(MjClient.playui._downNode, ActionType_paohuzi.FANXING, 0);
                    DealFanXingNewCard_changDePaoHuZi(hunCard);
                }
                ...
                function delayExe(){
                    ...
                    if (sData.tData.roundNum <= 0){
                        var layer = new GameOverLayer_changDePaoHuZi();
                        layer.setVisible(false);
                        self.addChild(layer,500);
                    }
                    if(!MjClient.endoneui){
                        self.addChild(new EndOneView_changDePaoHuZi(),500);
                    }
            ...
            moveHead: function() {
                ...
                //tableStartHeadMoveAction_changDePaoHuZi(this);   //不涉及到头像移动动作
            },
            initSceneData: function() {
                ...
                reConectHeadLayout_changDePaoHuZi(this);        //不涉及到头像移动动作
                CheckRoomUiDelete();
                tableStartHeadMoveAction_changDePaoHuZi(this);   //不涉及到头像移动动作
            ...
            changeMJBgEvent: function() {
                changeMJBg_changDePaoHuZi(this, ziPai.getZiPaiType());
            },
            MJPeng: function() {
                MjClient.playui.showAndHideHeadEffect();
            },
            ...
            EZP_layout : function(){
                if(MjClient.data.sData.tData.maxPlayer < 4){
                    ...
                    if(IsArrowVisible_changDePaoHuZi()){
                        MjClient.playui.ResetPutCard(MjClient.playui._downNode, 0);
                        MjClient.playui.ResetPutCard(MjClient.playui._topNode, MjClient.MaxPlayerNum_changDePaoHuZi - 1);
                        MjClient.playui.ResetPutCard(MjClient.playui._rightNode, MjClient.MaxPlayerNum_changDePaoHuZi - 2);
                    }
                }
            }
        },
        cardNumImg: {
            ...
            _event: {
                initSceneData: function(eD) {
                    var sData = MjClient.data.sData;
                    var tData = sData.tData;
                    this.visible = IsArrowVisible_changDePaoHuZi() && TableState.waitJiazhu != tData.tState;
                },
                mjhand: function(eD) {
                    var sData = MjClient.data.sData;
                    var tData = sData.tData;
        ...
        banner: {
            ...
            getRoomNum: {
                ...
                _click: function() {
                    ...
                    var sData = MjClient.data.sData;
                    var str7 = " ";
                    if (Object.keys(sData.players).length > 0 && MjClient.MaxPlayerNum_changDePaoHuZi > Object.keys(sData.players).length){
                        str7 += ["一","二","三"][Object.keys(sData.players).length - 1] + "缺" + ["一","二","三"][MjClient.MaxPlayerNum_changDePaoHuZi - Object.keys(sData.players).length - 1];
                    }
            ...
            roundnumImg: {
                ...
                _event: {
                    initSceneData: function(eD) {
                        this.visible = IsArrowVisible_changDePaoHuZi();
                    },
                    mjhand: function(eD) {
                        this.visible = IsArrowVisible_changDePaoHuZi();
                    },
        ...
        wait: {
            ...
            backHomebtn: {
                ...
                _event: {
                    ...
                    initSceneData: function(eD) {
                        this.visible = isShowBackBtn_changDePaoHuZi();
                    },
                    removePlayer: function(eD) {
                        this.visible = isShowBackBtn_changDePaoHuZi();
                    },
        ...
        btns_piao:{
            ...
            btn_piao0: {
                _click:function() {
                    var pl = getUIPlayer_changDePaoHuZi(0);
                    pl.piaoFen = -1;
                    paioFenToServer_changDePaoHuZi(0);
                },
            },
            btn_piao1: {
                _click:function() {
                    var pl = getUIPlayer_changDePaoHuZi(0);
                    pl.piaoFen = -1;
                    paioFenToServer_changDePaoHuZi(1);
                },
            },
            btn_piao2: {
                _click:function() {
                    var pl = getUIPlayer_changDePaoHuZi(0);
                    pl.piaoFen = -1;
                    paioFenToServer_changDePaoHuZi(2);
                },
            },
            btn_piao3: {
                _click:function() {
                    var pl = getUIPlayer_changDePaoHuZi(0);
                    pl.piaoFen = -1;
                    paioFenToServer_changDePaoHuZi(3);
                },
            },
    },
        BtnReady:{
        ...
        down: {
            head: {
                chuizi_tips : {
                    _run: function(){
                        setJiachuiImgTips_changDePaoHuZi(this, 0);
                    },
                    _event: {
                        initSceneData: function() {
                            setJiachuiImgTips_changDePaoHuZi(this, 0);
                ...
                jiachuiText_tips : {
                    _run: function() {
                        setJiachuiTextTips_changDePaoHuZi(this, 0);
                    },
                    _event:{
                        initSceneData: function() {
                            setJiachuiTextTips_changDePaoHuZi(this, 0);
                ...
                zhuang: {
                    ...
                    _event: {
                        waitPut: function(){
                            showUserZhuangLogo_changDePaoHuZi(this, 0);
                        },
                        initSceneData: function(){
                            if (IsArrowVisible_changDePaoHuZi()) showUserZhuangLogo_changDePaoHuZi(this, 0);
                        },
                        mjhand: function(){
                            if (IsArrowVisible_changDePaoHuZi()) showUserZhuangLogo_changDePaoHuZi(this, 0);
                        }
                    ...
                    chattext: {
                        _event: {
                            ...
                            MJChat: function(msg) {
                                ...
                                showUserChat_changDePaoHuZi(this, 0, msg);
                            },
                            playVoice: function(voicePath) {
                                MjClient.data._tempMessage.msg = voicePath;
                                showUserChat_changDePaoHuZi(this, 0, MjClient.data._tempMessage);
                            }
                        }
                    }
                },
                _click: function(btn) {
                    showPlayerInfo_changDePaoHuZi(0, btn);
                },
                _event: {
                    loadWxHead: function(d) {
                        setWxHead_changDePaoHuZi(this, d, 0);
                    },
                    addPlayer: function(eD) {
                        showFangzhuTagIcon_changDePaoHuZi(this,0);
                    },
                    removePlayer: function(eD) {
                        showFangzhuTagIcon_changDePaoHuZi(this,0);
                    }
                ...
                huxi:{
                    ...
                    _event:{
                        ...
                        initSceneData:function(){
                            this.visible = true;
                            var huXi = UpdateHuXi_changDePaoHuZi(0);
                            if(!IsArrowVisible_changDePaoHuZi()){
                                huXi = 0;
                                this.visible = false;
                            }
                ...
                timeImg:{
                    ...
                    // _event:{
                    //     initSceneData: function(eD) {
                    //         this.visible = curPlayerIsMe_changDePaoHuZi(0);
                    //     },
                    //     mjhand: function(eD) {
                    //         this.visible = curPlayerIsMe_changDePaoHuZi(0);
                    //     },
                    //     onlinePlayer: function(eD) {
                    //         this.visible = curPlayerIsMe_changDePaoHuZi(0) && IsArrowVisible_changDePaoHuZi();
                    //     },
                    //     waitPut: function(eD) {
                    //         this.visible = curPlayerIsMe_changDePaoHuZi(0);
                    //     },
                    ...
                    //             playTimeUpEff = null;
                    //             var pl = getUIPlayer_changDePaoHuZi(0);
                    //             if(pl && pl.onLine && curPlayerIsMe_changDePaoHuZi(0)){
                    //                 arrowbkNumberUpdate(this);
                    //             }
                    //         },
                    //         roundEnd: function() {
            ...
            ready: {
                ...
                _run: function() {
                    GetReadyVisible_changDePaoHuZi(this, 0);
                },
                _event: {
                    startShuffleCards:function (d) {
                        GetReadyVisible_changDePaoHuZi(this, -1);
                    },
                    moveHead: function() {
                        GetReadyVisible_changDePaoHuZi(this, -1);
                    },
                    ...
                    addPlayer: function() {
                        GetReadyVisible_changDePaoHuZi(this, 0);//根据状态设置ready 是否可见 add by sking
                    },
                    removePlayer: function() {
                        GetReadyVisible_changDePaoHuZi(this, 0);
                    },
            ...
            handNode: {
                ...
                _event:  {
                    initSceneData: function() {
                        calculateHintPutList_changDePaoHuZi();
                    },
                    HZPickCard: function() {
                        calculateHintPutList_changDePaoHuZi();
                    },
                    ...
                    MJPass: function() { // 天胡 提 偎 跑后过胡
                        calculateHintPutList_changDePaoHuZi();
                        addTingSign_changDePaoHuZi(MjClient.playui._downNode);
                    },
            ...
            _event: {
                clearCardUI: function() {
                    clearCardUI_changDePaoHuZi(this, 0);
                },
                ...
                initSceneData: function(eD) {
                    SetUserVisible_changDePaoHuZi(this, 0);
                    InitUserHandUI_changDePaoHuZi(this, 0);
                    InitUserCoinAndName_changDePaoHuZi(this, 0);
                    MjClient.hasPut = false; // 重连回来重置打掉牌标志（打牌时候断线)
                    ShowPutCardIcon_changDePaoHuZi();
                    DealOffLineCard_changDePaoHuZi(this,0);
                },
                addPlayer: function(eD) {
                    SetUserVisible_changDePaoHuZi(this, 0);
                    InitUserCoinAndName_changDePaoHuZi(this, 0);
                ...
                mjhand: function(eD) {
                    ...
                    var uid = getUIPlayer_changDePaoHuZi(0).info.uid;
                    // if (eD.jiazhuNums)
                    // {
                ...
                HZNewCard: function(eD) {
                    ...
                    DealNewCard_changDePaoHuZi(this,eD,0);
                },
                MJPut: function(eD) {
                    DealPutCard_changDePaoHuZi(this,eD,0);
                },
                HZChiCard: function(eD) {
                    DealChiCard_changDePaoHuZi(this, eD, 0);
                },
                HZWeiCard: function(eD){
                    DealWeiCard_changDePaoHuZi(this,eD,0);
                },
                HZGangCard: function(eD) {
                    DealGangCard_changDePaoHuZi(this, eD, 0);
                },
                MJPeng: function(eD) {
                    DealPengCard_changDePaoHuZi(this, eD, 0);
                },
                MJHu: function(eD) {
                    DealHu_changDePaoHuZi(this, eD, 0);
                },
                onlinePlayer: function(eD) {
                    resetHandAfterBegin_changDePaoHuZi();
                    setUserOffline_changDePaoHuZi(this, 0);
                },
                ...
                MJJiazhu: function(msg) {
                    ...
                    MjClient.majiang.setJiaZhuNum(MjClient.playui._downNode, getUIPlayer_changDePaoHuZi(0));
                    MjClient.majiang.setJiaZhuNum(MjClient.playui._rightNode, getUIPlayer_changDePaoHuZi(1));
                    MjClient.majiang.setJiaZhuNum(MjClient.playui._topNode, getUIPlayer_changDePaoHuZi(2));
                },
                HZPickCard:function (eD) {
                    ...
                    DealShowLastCard_changDePaoHuZi(this, eD, 0);
                },
                HZAddCards:function (eD) {
                    DealAddCard_changDePaoHuZi(this,eD, 0);
                },
        ...
        right: {
            head: {
                chuizi_tips : {
                    _run: function(){
                        setJiachuiImgTips_changDePaoHuZi(this, changeUIOff_changDePaoHuZi(2));
                    },
                    _event: {
                        initSceneData: function() {
                            setJiachuiImgTips_changDePaoHuZi(this, changeUIOff_changDePaoHuZi(2));
                ...
                jiachuiText_tips : {
                    _run:function() {
                        setJiachuiTextTips_changDePaoHuZi(this, changeUIOff_changDePaoHuZi(2));
                    },
                    _event:{
                        initSceneData: function() {
                            setJiachuiTextTips_changDePaoHuZi(this, changeUIOff_changDePaoHuZi(2));
                        ...
                        MJJiazhu: function(msg) {
                            var pl = getUIPlayer_changDePaoHuZi(changeUIOff_changDePaoHuZi(2))
                            if (msg.uid == pl.info.uid) {
                                setJiachuiTextTips_changDePaoHuZi(this, changeUIOff_changDePaoHuZi(2));
                            }
                        },
                ...
                zhuang: {
                    ...
                    _event: {
                        waitPut: function() {
                            showUserZhuangLogo_changDePaoHuZi(this, changeUIOff_changDePaoHuZi(2));
                        },
                        initSceneData: function() {
                            if (IsArrowVisible_changDePaoHuZi()) showUserZhuangLogo_changDePaoHuZi(this, changeUIOff_changDePaoHuZi(2));
                        },
                        mjhand: function(){
                            if (IsArrowVisible_changDePaoHuZi()) showUserZhuangLogo_changDePaoHuZi(this, changeUIOff_changDePaoHuZi(2));
                        }
                ...
                chatbg: {
                    ...
                    chattext: {
                        _event: {
                            MJChat: function(msg) {
                                showUserChat_changDePaoHuZi(this, changeUIOff_changDePaoHuZi(2), msg);
                            },
                            playVoice: function(voicePath) {
                                MjClient.data._tempMessage.msg = voicePath;
                                showUserChat_changDePaoHuZi(this, changeUIOff_changDePaoHuZi(2), MjClient.data._tempMessage);
                            }
                        }
                    }
                },
                _click: function(btn) {
                    showPlayerInfo_changDePaoHuZi(changeUIOff_changDePaoHuZi(2), btn);
                },
                _event: {
                    loadWxHead: function(d) {
                        setWxHead_changDePaoHuZi(this, d, changeUIOff_changDePaoHuZi(2));
                    },
                    addPlayer: function(eD) {
                        showFangzhuTagIcon_changDePaoHuZi(this,changeUIOff_changDePaoHuZi(2));
                    },
                    removePlayer: function(eD) {
                        showFangzhuTagIcon_changDePaoHuZi(this,changeUIOff_changDePaoHuZi(2));
                    }
                ...
                huxi:{
                    ...
                    _event:{
                        ...
                        initSceneData:function(){
                            this.visible = true;
                            var huXi = UpdateHuXi_changDePaoHuZi(changeUIOff_changDePaoHuZi(2));
                            if(!IsArrowVisible_changDePaoHuZi()){
                                huXi = 0;
                                this.visible = false;
                            }
                ...
                timeImg:{
                    ...
                    // _event:{
                    //     initSceneData: function(eD) {
                    //         this.visible = curPlayerIsMe_changDePaoHuZi(1);
                    //     },
                    //     mjhand: function(eD) {
                    //         this.visible = curPlayerIsMe_changDePaoHuZi(1);
                    //     },
                    //     onlinePlayer: function(eD) {
                    //         this.visible = curPlayerIsMe_changDePaoHuZi(1) && IsArrowVisible_changDePaoHuZi();
                    //     },
                    //     waitPut: function(eD) {
                    //         this.visible = curPlayerIsMe_changDePaoHuZi(1);
                    //     },
                    ...
                    //             stopEffect(playTimeUpEff);
                    //             playTimeUpEff = null;
                    //             if(curPlayerIsMe_changDePaoHuZi(1)){
                    //                 arrowbkNumberUpdate(this);
                    //                 this.setString("00");
                    //             }
                    //         },
                    ...
                    //             stopEffect(playTimeUpEff);
                    //             playTimeUpEff = null;
                    //             var pl = getUIPlayer_changDePaoHuZi(1);
                    //             if(pl && pl.onLine && curPlayerIsMe_changDePaoHuZi(1)){
                    //                 arrowbkNumberUpdate(this);
                    //             }
                    //         },
                    //         roundEnd: function() {
            ...
            ready: {
                _layout: [[0.07, 0.07],[0.5, 0.5],[2.5, 2.5]],
                _run: function() {
                    GetReadyVisible_changDePaoHuZi(this, changeUIOff_changDePaoHuZi(2));
                },
                _event: {
                    startShuffleCards:function (d) {
                        GetReadyVisible_changDePaoHuZi(this, -1);
            ...
            _event: {
                clearCardUI: function() {
                    clearCardUI_changDePaoHuZi(this, changeUIOff_changDePaoHuZi(2));
                },
                clearCardArr: function(){
                    var eatNode = this.getChildByName("eatNode");
                    eatNode.removeAllChildren();
                ...
                initSceneData: function(eD) {
                    SetUserVisible_changDePaoHuZi(this, changeUIOff_changDePaoHuZi(2));
                    InitUserHandUI_changDePaoHuZi(this, changeUIOff_changDePaoHuZi(2));
                    InitUserCoinAndName_changDePaoHuZi(this, changeUIOff_changDePaoHuZi(2));
                    DealOffLineCard_changDePaoHuZi(this,changeUIOff_changDePaoHuZi(2));
                },
                addPlayer: function(eD) {
                    SetUserVisible_changDePaoHuZi(this, changeUIOff_changDePaoHuZi(2));
                    InitUserCoinAndName_changDePaoHuZi(this, changeUIOff_changDePaoHuZi(2));
                ...
                HZNewCard: function(eD) {
                    ...
                    DealNewCard_changDePaoHuZi(this,eD,changeUIOff_changDePaoHuZi(2));
                },
                roundEnd: function() {
                    InitUserCoinAndName_changDePaoHuZi(this, changeUIOff_changDePaoHuZi(2));
                    MjClient.playui.ResetOtherCard(this, changeUIOff_changDePaoHuZi(2));
                },
                waitPut: function(eD) {
                    DealWaitPut(this, eD, 1);
                },
                MJPut: function(eD) {
                    DealPutCard_changDePaoHuZi(this, eD, changeUIOff_changDePaoHuZi(2));
                },
                HZChiCard: function(eD) {
                    DealChiCard_changDePaoHuZi(this, eD, changeUIOff_changDePaoHuZi(2));
                },
                HZGangCard: function(eD) {
                    DealGangCard_changDePaoHuZi(this, eD, changeUIOff_changDePaoHuZi(2));
                },
                MJPeng: function(eD) {
                    DealPengCard_changDePaoHuZi(this, eD, changeUIOff_changDePaoHuZi(2));
                },
                HZWeiCard: function(eD){
                    DealWeiCard_changDePaoHuZi(this, eD, changeUIOff_changDePaoHuZi(2));
                },
                MJHu: function(eD) {
                    DealHu_changDePaoHuZi(this, eD, changeUIOff_changDePaoHuZi(2));
                },
                onlinePlayer: function(eD) {
                    setUserOffline_changDePaoHuZi(this, changeUIOff_changDePaoHuZi(2));
                },
                playerStatusChange: function(eD) {
                    setUserOffline_changDePaoHuZi(this, changeUIOff_changDePaoHuZi(2));
                },
                MJFlower: function(eD) {
                    HandleMJFlower(this, eD, changeUIOff_changDePaoHuZi(2));
                },
                MJTing: function (eD) {
                    HandleMJTing(this, eD, changeUIOff_changDePaoHuZi(2));
                },
                HZPickCard:function (eD) {
                    if(MjClient.rePlayVideo != -1){
                        MjClient.playui._doPickResetHandCardForPlayBack(eD, changeUIOff_changDePaoHuZi(2));
                    }

                    // RemovePutCardOut_changDePaoHuZi(true);
                    // MjClient.playui.ResetHandCard(this,1);

                    DealShowLastCard_changDePaoHuZi(this, eD, changeUIOff_changDePaoHuZi(2));
                },
                HZAddCards:function (eD) {
                    DealAddCard_changDePaoHuZi(this,eD, changeUIOff_changDePaoHuZi(2));
                },
                HZCheckRaise:function (msg) {
                    ShowPutCardIcon_changDePaoHuZi();
                    //MjClient.playui.EatVisibleCheck();
        ...
        left: {
            head: {
                chuizi_tips : {
                    _run: function(){
                        setJiachuiImgTips_changDePaoHuZi(this, MjClient.MaxPlayerNum_changDePaoHuZi - 1);
                    },
                    _event: {
                        initSceneData: function() {
                            setJiachuiImgTips_changDePaoHuZi(this, MjClient.MaxPlayerNum_changDePaoHuZi - 1);
                ...
                jiachuiText_tips : {
                    _visible:false,
                    _run:function() {
                        setJiachuiTextTips_changDePaoHuZi(this, MjClient.MaxPlayerNum_changDePaoHuZi - 1);
                    },
                    _event:{
                        initSceneData: function() {
                            setJiachuiTextTips_changDePaoHuZi(this, MjClient.MaxPlayerNum_changDePaoHuZi - 1);
                        ...
                        MJJiazhu: function(msg) {
                            var pl = getUIPlayer_changDePaoHuZi(MjClient.MaxPlayerNum_changDePaoHuZi - 1)
                            if (msg.uid == pl.info.uid) {
                                setJiachuiTextTips_changDePaoHuZi(this, MjClient.MaxPlayerNum_changDePaoHuZi - 1);
                            }
                        },
                ...
                zhuang: {
                    ...
                    _event: {
                        waitPut: function() {
                            showUserZhuangLogo_changDePaoHuZi(this, MjClient.MaxPlayerNum_changDePaoHuZi - 1);
                        },
                        initSceneData: function() {
                            if (IsArrowVisible_changDePaoHuZi()) showUserZhuangLogo_changDePaoHuZi(this, MjClient.MaxPlayerNum_changDePaoHuZi - 1);
                        },
                        mjhand: function(){
                            if (IsArrowVisible_changDePaoHuZi()) showUserZhuangLogo_changDePaoHuZi(this, MjClient.MaxPlayerNum_changDePaoHuZi - 1);
                        }
                ...
                chatbg: {
                    ...
                    chattext: {
                        _event: {
                            MJChat: function(msg) {
                                showUserChat_changDePaoHuZi(this, MjClient.MaxPlayerNum_changDePaoHuZi - 1, msg);
                            },
                            playVoice: function(voicePath) {
                                MjClient.data._tempMessage.msg = voicePath;
                                showUserChat_changDePaoHuZi(this, MjClient.MaxPlayerNum_changDePaoHuZi - 1, MjClient.data._tempMessage);
                            }
                        }
                    }
                },
                _click: function(btn) {
                    showPlayerInfo_changDePaoHuZi(MjClient.MaxPlayerNum_changDePaoHuZi - 1, btn);
                },
                _event: {
                    loadWxHead: function(d) {
                        setWxHead_changDePaoHuZi(this, d, MjClient.MaxPlayerNum_changDePaoHuZi - 1);
                    },
                    addPlayer: function(eD) {
                        showFangzhuTagIcon_changDePaoHuZi(this,MjClient.MaxPlayerNum_changDePaoHuZi - 1);
                    },
                    removePlayer: function(eD) {
                        showFangzhuTagIcon_changDePaoHuZi(this,MjClient.MaxPlayerNum_changDePaoHuZi - 1);
                    }
                ...
                huxi:{
                    ...
                    _event:{
                        ...
                        initSceneData:function(){
                            this.visible = true;
                            var huXi = UpdateHuXi_changDePaoHuZi(MjClient.MaxPlayerNum_changDePaoHuZi - 1);
                            if(!IsArrowVisible_changDePaoHuZi()){
                                huXi = 0;
                                this.visible = false;
                            }
                ...
                timeImg:{
                    ...
                    // _event:{
                    //     initSceneData: function(eD) {
                    //         this.visible = curPlayerIsMe_changDePaoHuZi(2);
                    //     },
                    //     mjhand: function(eD) {
                    //         this.visible = curPlayerIsMe_changDePaoHuZi(2);
                    //     },
                    //     onlinePlayer: function(eD) {
                    //         this.visible = curPlayerIsMe_changDePaoHuZi(2) && IsArrowVisible_changDePaoHuZi();
                    //     },
                    //     waitPut: function(eD) {
                    //         this.visible = curPlayerIsMe_changDePaoHuZi(2);
                    //     },
                    ...
                    //             stopEffect(playTimeUpEff);
                    //             playTimeUpEff = null;
                    //             if(curPlayerIsMe_changDePaoHuZi(2)){
                    //                 arrowbkNumberUpdate(this);
                    //                 this.setString("00");
                    //             }
                    //         },
                    ...
                    //             stopEffect(playTimeUpEff);
                    //             playTimeUpEff = null;
                    //             var pl = getUIPlayer_changDePaoHuZi(2);
                    //             if(pl && pl.onLine && curPlayerIsMe_changDePaoHuZi(2)){
                    //                 arrowbkNumberUpdate(this);
                    //             }
                    //         },
                    //         roundEnd: function() {
            ...
            ready: {
                _layout: [[0.07, 0.07],[0.5, 0.5],[-2.5, 2.5]],
                _run: function() {
                    GetReadyVisible_changDePaoHuZi(this, MjClient.MaxPlayerNum_changDePaoHuZi - 1);
                },
                _event: {
                    startShuffleCards:function (d) {
                        GetReadyVisible_changDePaoHuZi(this, -1);
            ...
            _event: {
                clearCardUI: function() {
                    clearCardUI_changDePaoHuZi(this, MjClient.MaxPlayerNum_changDePaoHuZi - 1);
                },
                clearCardArr: function(){
                    var eatNode = this.getChildByName("eatNode");
                    eatNode.removeAllChildren();
                ...
                initSceneData: function(eD) {
                    SetUserVisible_changDePaoHuZi(this, MjClient.MaxPlayerNum_changDePaoHuZi - 1);
                    InitUserHandUI_changDePaoHuZi(this, MjClient.MaxPlayerNum_changDePaoHuZi - 1);
                    InitUserCoinAndName_changDePaoHuZi(this, MjClient.MaxPlayerNum_changDePaoHuZi - 1);
                    DealOffLineCard_changDePaoHuZi(this,MjClient.MaxPlayerNum_changDePaoHuZi - 1);
                },
                addPlayer: function(eD) {
                    SetUserVisible_changDePaoHuZi(this, MjClient.MaxPlayerNum_changDePaoHuZi - 1);
                    InitUserCoinAndName_changDePaoHuZi(this, MjClient.MaxPlayerNum_changDePaoHuZi - 1);
                ...
                HZNewCard: function(eD) {
                    ...
                    DealNewCard_changDePaoHuZi(this,eD,MjClient.MaxPlayerNum_changDePaoHuZi - 1);
                },
                roundEnd: function() {
                    InitUserCoinAndName_changDePaoHuZi(this,MjClient.MaxPlayerNum_changDePaoHuZi - 1);
                    MjClient.playui.ResetOtherCard(this, MjClient.MaxPlayerNum_changDePaoHuZi - 1);
                },
                waitPut: function(eD) {
                    DealWaitPut(this, eD, MjClient.MaxPlayerNum_changDePaoHuZi - 1);
                },
                MJPut: function(eD) {
                    DealPutCard_changDePaoHuZi(this, eD, MjClient.MaxPlayerNum_changDePaoHuZi - 1);
                },
                HZChiCard: function(eD) {
                    DealChiCard_changDePaoHuZi(this, eD, MjClient.MaxPlayerNum_changDePaoHuZi - 1);
                },
                HZGangCard: function(eD) {
                    DealGangCard_changDePaoHuZi(this, eD, MjClient.MaxPlayerNum_changDePaoHuZi - 1);
                },
                MJPeng: function(eD) {
                    DealPengCard_changDePaoHuZi(this, eD, MjClient.MaxPlayerNum_changDePaoHuZi - 1);
                },
                HZWeiCard: function(eD){
                    DealWeiCard_changDePaoHuZi(this, eD, MjClient.MaxPlayerNum_changDePaoHuZi - 1);
                },
                MJHu: function(eD) {
                    DealHu_changDePaoHuZi(this, eD, MjClient.MaxPlayerNum_changDePaoHuZi - 1);
                },
                onlinePlayer: function(eD) {
                    setUserOffline_changDePaoHuZi(this, MjClient.MaxPlayerNum_changDePaoHuZi - 1);
                },
                playerStatusChange: function(eD) {
                    setUserOffline_changDePaoHuZi(this, MjClient.MaxPlayerNum_changDePaoHuZi - 1);
                },
                MJFlower: function(eD) {
                    HandleMJFlower(this, eD, MjClient.MaxPlayerNum_changDePaoHuZi - 1);
                },
                MJTing: function (eD) {
                    HandleMJTing(this, eD, MjClient.MaxPlayerNum_changDePaoHuZi - 1);
                },
                HZPickCard:function (eD) {
                    if(MjClient.rePlayVideo != -1) {
                        MjClient.playui._doPickResetHandCardForPlayBack(eD, MjClient.MaxPlayerNum_changDePaoHuZi - 1);
                    }
                    // RemovePutCardOut_changDePaoHuZi(true);
                    // MjClient.playui.ResetHandCard(this,2);

                    DealShowLastCard_changDePaoHuZi(this, eD, MjClient.MaxPlayerNum_changDePaoHuZi - 1);
                },
                HZAddCards:function (eD) {
                    DealAddCard_changDePaoHuZi(this,eD, MjClient.MaxPlayerNum_changDePaoHuZi - 1);
                },
                HZCheckRaise:function (msg) {
                    ShowPutCardIcon_changDePaoHuZi();
                    //MjClient.playui.EatVisibleCheck();
        ...
        xing: {
            ...
            head: {
                chuizi_tips : {
                    _run: function(){
                        setJiachuiImgTips_changDePaoHuZi(this, changeUIOff_changDePaoHuZi(1));
                    },
                    _event: {
                        initSceneData: function() {
                            setJiachuiImgTips_changDePaoHuZi(this, changeUIOff_changDePaoHuZi(1));
                ...
                jiachuiText_tips : {
                    _run:function() {
                        setJiachuiTextTips_changDePaoHuZi(this, changeUIOff_changDePaoHuZi(1));
                    },
                    _event:{
                        initSceneData: function() {
                            setJiachuiTextTips_changDePaoHuZi(this, changeUIOff_changDePaoHuZi(1));
                        ...
                        MJJiazhu: function(msg) {
                            var pl = getUIPlayer_changDePaoHuZi(changeUIOff_changDePaoHuZi(1))
                            if (msg.uid == pl.info.uid) {
                                setJiachuiTextTips_changDePaoHuZi(this, changeUIOff_changDePaoHuZi(1));
                            }
                        },
                ...
                zhuang: {
                    ...
                    _event: {
                        waitPut: function() {
                            if(MjClient.MaxPlayerNum_changDePaoHuZi == 4 ) {
                                showUserZhuangLogo_changDePaoHuZi(this, changeUIOff_changDePaoHuZi(1));
                            }
                        },
                        initSceneData: function() {
                            if(MjClient.MaxPlayerNum_changDePaoHuZi == 4 ) {
                                if (IsArrowVisible_changDePaoHuZi()) showUserZhuangLogo_changDePaoHuZi(this, changeUIOff_changDePaoHuZi(1));
                            }
                        },
                        mjhand: function(){
                            if(MjClient.MaxPlayerNum_changDePaoHuZi == 4 ) {
                ...
                chatbg: {
                    ...
                    chattext: {
                        _event: {
                            MJChat: function(msg) {
                                if(MjClient.MaxPlayerNum_changDePaoHuZi == 4) {
                                    showUserChat_changDePaoHuZi(this, changeUIOff_changDePaoHuZi(1), msg);
                                }
                            },
                            playVoice: function(voicePath) {
                                if(MjClient.MaxPlayerNum_changDePaoHuZi == 4) {
                                    MjClient.data._tempMessage.msg = voicePath;
                                    showUserChat_changDePaoHuZi(this, changeUIOff_changDePaoHuZi(1), MjClient.data._tempMessage);
                                }
                            }
                        }
                    }
                ...
                _click: function(btn) {
                    if(MjClient.MaxPlayerNum_changDePaoHuZi == 4) {
                        showPlayerInfo_changDePaoHuZi(changeUIOff_changDePaoHuZi(1), btn);
                    }
                },
                _event: {
                    loadWxHead: function(d) {
                        if(MjClient.MaxPlayerNum_changDePaoHuZi == 4) {
                            setWxHead_changDePaoHuZi(this, d, changeUIOff_changDePaoHuZi(1));
                        }
                    },
                    addPlayer: function(eD) {
                        showFangzhuTagIcon_changDePaoHuZi(this,changeUIOff_changDePaoHuZi(1));
                    },
                    removePlayer: function(eD) {
                        showFangzhuTagIcon_changDePaoHuZi(this,changeUIOff_changDePaoHuZi(1));
                    }
                ...
                huxi:{
                    ...
                    _event:{
                        ...
                        initSceneData:function(){
                            if(MjClient.MaxPlayerNum_changDePaoHuZi == 4) {
                                this.visible = true;
                                var huXi = UpdateHuXi_changDePaoHuZi(changeUIOff_changDePaoHuZi(1));
                                if (!IsArrowVisible_changDePaoHuZi()) {
                                    huXi = 0;
                                    this.visible = false;
                                }
            ...
            ready: {
                ...
                _run: function() {
                    if(MjClient.MaxPlayerNum_changDePaoHuZi == 4) {
                        GetReadyVisible_changDePaoHuZi(this, changeUIOff_changDePaoHuZi(1));
                    }
                },
                _event: {
                    startShuffleCards:function (d) {
            ...
            _event: {
                clearCardUI: function() {
                    if(MjClient.MaxPlayerNum_changDePaoHuZi == 4) {
                        clearCardUI_changDePaoHuZi(this, changeUIOff_changDePaoHuZi(1));
                    }
                },
                clearCardArr: function(){
                    if(MjClient.MaxPlayerNum_changDePaoHuZi == 4) {
                ...
                initSceneData: function(eD) {
                    if(MjClient.MaxPlayerNum_changDePaoHuZi == 4) {
                        SetUserVisible_changDePaoHuZi(this, changeUIOff_changDePaoHuZi(1));
                        InitUserHandUI_changDePaoHuZi(this, changeUIOff_changDePaoHuZi(1));
                        InitUserCoinAndName_changDePaoHuZi(this, changeUIOff_changDePaoHuZi(1));
                        DealOffLineCard_changDePaoHuZi(this, changeUIOff_changDePaoHuZi(1));
                    }
                },
                addPlayer: function(eD) {
                    if(MjClient.MaxPlayerNum_changDePaoHuZi == 4) {
                ...
                HZNewCard: function(eD) {
                    if(MjClient.MaxPlayerNum_changDePaoHuZi == 4) {
                        ...
                        DealNewCard_changDePaoHuZi(this, eD, changeUIOff_changDePaoHuZi(1));
                    }
                },
                roundEnd: function() {
                    if(MjClient.MaxPlayerNum_changDePaoHuZi == 4) {
                        InitUserCoinAndName_changDePaoHuZi(this, changeUIOff_changDePaoHuZi(1));
                        MjClient.playui.ResetOtherCard(this, changeUIOff_changDePaoHuZi(1));
                    }
                },
                waitPut: function(eD) {
                    if(MjClient.MaxPlayerNum_changDePaoHuZi == 4) {
                        DealWaitPut(this, eD, changeUIOff_changDePaoHuZi(1));
                    }
                },
                MJPut: function(eD) {
                    if(MjClient.MaxPlayerNum_changDePaoHuZi == 4) {
                        DealPutCard_changDePaoHuZi(this, eD, changeUIOff_changDePaoHuZi(1));
                    }
                },
                HZChiCard: function(eD) {
                    if(MjClient.MaxPlayerNum_changDePaoHuZi == 4) {
                        DealChiCard_changDePaoHuZi(this, eD, changeUIOff_changDePaoHuZi(1));
                    }
                },
                HZGangCard: function(eD) {
                    if(MjClient.MaxPlayerNum_changDePaoHuZi == 4) {
                        DealGangCard_changDePaoHuZi(this, eD, changeUIOff_changDePaoHuZi(1));
                    }
                },
                MJPeng: function(eD) {
                    if(MjClient.MaxPlayerNum_changDePaoHuZi == 4) {
                        DealPengCard_changDePaoHuZi(this, eD, changeUIOff_changDePaoHuZi(1));
                    }
                },
                HZWeiCard: function(eD){
                    if(MjClient.MaxPlayerNum_changDePaoHuZi == 4) {
                        DealWeiCard_changDePaoHuZi(this, eD, changeUIOff_changDePaoHuZi(1));
                    }
                },
                MJHu: function(eD) {
                    if(MjClient.MaxPlayerNum_changDePaoHuZi == 4) {
                        DealHu_changDePaoHuZi(this, eD, changeUIOff_changDePaoHuZi(1));
                    }
                },
                onlinePlayer: function(eD) {
                    if(MjClient.MaxPlayerNum_changDePaoHuZi == 4) {
                        setUserOffline_changDePaoHuZi(this, changeUIOff_changDePaoHuZi(1));
                    }
                },
                playerStatusChange: function(eD) {
                    if(MjClient.MaxPlayerNum_changDePaoHuZi == 4) {
                ...
                MJFlower: function(eD) {
                    if(MjClient.MaxPlayerNum_changDePaoHuZi == 4) {
                        HandleMJFlower(this, eD, changeUIOff_changDePaoHuZi(1));
                    }
                },
                MJTing: function (eD) {
                    if(MjClient.MaxPlayerNum_changDePaoHuZi == 4) {
                        HandleMJTing(this, eD, changeUIOff_changDePaoHuZi(1));
                    }
                },
                HZPickCard:function (eD) {
                    if(MjClient.MaxPlayerNum_changDePaoHuZi == 4) {
                        if (MjClient.rePlayVideo != -1 ) {
                            var pl = getUIPlayer_changDePaoHuZi(changeUIOff_changDePaoHuZi(1));
                            if (eD.uid == pl.info.uid) {
                                MjClient.OtherHandArr[changeUIOff_changDePaoHuZi(1)] = MjClient.majiang.sortHandCardSpecial(pl.mjhand)
                            }
                        }
                        DealShowLastCard_changDePaoHuZi(this, eD, changeUIOff_changDePaoHuZi(1));
                    }
                },
                HZAddCards:function (eD) {
                    if(MjClient.MaxPlayerNum_changDePaoHuZi == 4) {
                        DealAddCard_changDePaoHuZi(this, eD, changeUIOff_changDePaoHuZi(1));
                    }
                },
                HZCheckRaise:function (msg) {
                    if(MjClient.MaxPlayerNum_changDePaoHuZi == 4) {
        ...
        eat: {
            chi: {
                ...
                _touch: function(btn, eT) {
                    if (eT == 2){
                        if(ziPai.getHasFastEat()){
                            ...
                            if (chiSet.length == 1) {
                                ...
                                if (pl.mjhand.indexOf(putCard) < 0 || copy.indexOf(putCard) >= 0) {
                                    ...
                                    commitEatCards_changDePaoHuZi(eatCards, null);
                        ...
                        showSelectEatCards_changDePaoHuZi(this,btn.tag);
                        ...
                        // MJChiCardchange_changDePaoHuZi();
                    }
                }
            },
            noTing : {
            ...
            hu: {
                ...
                _touch: function(btn, eT) {
                    if (eT == 2) {
                        MJHuToServer_changDePaoHuZi();
                        setChiVisible_changDePaoHuZi();//add by maoyu
                    }
                }
            },
            cancel: {
            ...
            wangDiao:{
                ...
                _touch: function(btn, eT) {
                    console.log(">>>> lf，点击碰按钮");
                    if (eT == 2) {
                        HZWangChuangToServer_changDePaoHuZi(1);
                        setChiVisible_changDePaoHuZi();//add by maoyu
                    }
                }
            },
            wangChuang:{
                ...
                _touch: function(btn, eT) {
                    console.log(">>>> lf，点击碰按钮");
                    if (eT == 2) {
                        HZWangChuangToServer_changDePaoHuZi(2);
                        setChiVisible_changDePaoHuZi();//add by maoyu
                    }
                }
            },
            wangZha:{
                ...
                _touch: function(btn, eT) {
                    console.log(">>>> lf，点击碰按钮");
                    if (eT == 2) {
                        HZWangChuangToServer_changDePaoHuZi(4);
                        setChiVisible_changDePaoHuZi();//add by maoyu
                    }
                }
            },
                    ...
                    this.adaptChiLayout = function() {
                        ...
                        if (cards_option.length == 0) { // 吃牌选好了
                            if ((MjClient.data.sData.players[SelfUid()].eatFlag & 32) > 0) {
                                MjClient.showMsg("选择吃后视为过胡，确定吃吗？", function() {
                                    ...
                                    HZChiToServer_changDePaoHuZi(cards_select[0], biCards);
                                    this.visible = false;
                                }.bind(this), function() {
                                    cards_select.pop();
                                    this.adaptChiLayout();
                        ...
                        for (var i = 0; i < cards_select.length; i++) {
                            ...
                            for (var j = 0; j < row.length; j++) {
                                ...
                                chiCardImg.loadTexture(MjClient.cardPath_changDePaoHuZi + "out" + row[j] + ".png");
        ...
        voice_btn: {
            ...
            _event: {
                ...
                downAndPlayVoice: function(msg) {
                    ...
                    downAndPlayVoice_changDePaoHuZi(msg.uid, msg.msg);
                }
            }
        },
        cutLine:{
    ...
    ctor: function() {
        this._super();
        ziPai.initZiPaiData();
        var playui = ccs.load("Play_changDePaoHuZi.json");
        playMusic("bgFight");
        var tData = MjClient.data.sData.tData;
        MjClient.MaxPlayerNum_changDePaoHuZi = tData.maxPlayer;
        ...
        //三人玩时恢复
            ...
            this.jsBind.right = PlayLayer_changDePaoHuZi.jsBindrightCopy;
        }
        ...
        this.tingLayer = new changDePaoHuZiTingLayer();
    ...
    resetJiaZhuTip: function()
    {
        ...
        for (var i = 0; i < MjClient.MaxPlayerNum_changDePaoHuZi; i ++)
        {
            var pl = getUIPlayer_changDePaoHuZi(i);
            if (!pl) 
                continue;
...
PlayLayer_changDePaoHuZi.jsBindrightCopy = PlayLayer_changDePaoHuZi.prototype.jsBind.right;

//重置手牌的顺序
PlayLayer_changDePaoHuZi.prototype.ResetHandCard = function(posNode,off, needAction, isDelay){

    needAction = needAction === undefined ? false : needAction;
    // needAction = false;

    if(off == 0){
        resetHandCard_changDePaoHuZiEx(posNode,off, needAction, isDelay);
...
//回放时其他家补牌重置手牌的处理
PlayLayer_changDePaoHuZi.prototype._doPickResetHandCardForPlayBack = function(msg, off){
    var pl = getUIPlayer_changDePaoHuZi(off);
...
PlayLayer_changDePaoHuZi.prototype._doMovetoAction = function(node,endP){
    node.stopAllActions();
    var ac = cc.moveTo(0.3,endP);
    node.runAction(ac);
};

PlayLayer_changDePaoHuZi.prototype.ResetOtherCard = function(posNode, off) {
    //添加吃、碰、跑、偎、提
    var sData = MjClient.data.sData;
    var tData = null;
    if (sData) {
    ...
    if (mjSortArr) {
            ...
            for (var i = 0; i < childList.length; i++) {
                ...
                if(tData.maxPlayer == 4){
                    if((off <= 1 && i != childList.length - 1) ||
                        (off >= 2 && i != 0)){
                        child.loadTexture(MjClient.cardPath_changDePaoHuZi + "huxiBG.png");
                    }
                }else{
        ...
        for (var k = 0; k < mjSortArr.length; k++) {
            ...
            if (name == "mjgang1") {
                ...
                for (var i = 0; i < 4; i++) {
                    addEatCard_changDePaoHuZi(posNode, "mjgang1" + k, cardNum, off);
                }
            ...
            if (name == "mjwei") {
                var cardNum = pl.mjwei[pos];
                for (var i = 0; i < 3; i++) {
                    addEatCard_changDePaoHuZi(posNode, "mjwei" + k, cardNum, off);
                }
            ...
            if (name == "mjgang0") {
                ...
                for (var i = 0; i < 4; i++) {
                    addEatCard_changDePaoHuZi(posNode, "mjgang0" + k, cardNum, off);
                }
            }
            //碰
            if (name == "mjpeng") {
                ...
                for (var i = 0; i < 3; i++) {
                    addEatCard_changDePaoHuZi(posNode, "mjpeng" + k, cardNum, off);
                }
            }
            //吃
            if (name == "mjchi") {
                ...
                for (var i = 0; i < eatCards.length; i++) {
                    addEatCard_changDePaoHuZi(posNode, "mjchi" + k, eatCards[i], off);
                }
                ...
                if (biCards && biCards.length > 0) {
                    for (var i = 0; i < biCards.length; i++) {
                        ...
                        for (var m = 0; m < biArr.length; m++) {
                            addEatCard_changDePaoHuZi(posNode, "mjbi" + k + i, biArr[m], off);
                        }
                    }
                }
    ...
    //    var outCard = getNewCard_changDePaoHuZi(pl.mjput[i], 2, off);
    //    if(off == 0){
    //        outCard.anchorX = 1;
    //        outCard.anchorY = 0;
...
PlayLayer_changDePaoHuZi.prototype.ResetPutCard = function(posNode,off){
    //添加打出的牌
    var pl = getUIPlayer_changDePaoHuZi(off);
    if (!pl) return;
    var outNode = posNode.getChildByName("outNode");
    ...
    for (var i = 0; i < pl.mjput.length; i++) {
        ...
        setPutCardPos_changDePaoHuZi(outNode, outCard, i, off);
...
//重置牌的顺序
PlayLayer_changDePaoHuZi.prototype.CardLayoutRestore = function(posNode,off){
    if(MjClient.rePlayVideo == -1){
...
// 判断吃、碰、跑、偎、提、胡的状态
PlayLayer_changDePaoHuZi.prototype.EatVisibleCheck = function(off){
    var eat = MjClient.playui.jsBind.eat;
    ...
    if(tData.tState != TableState.roundFinish && pl.mjState != TableState.roundFinish){
        if(IsTurnToMe()){
            ...
            if(pl.eatFlag & 4){
                ...
                if(!canHu){
                    // HZGangToServer_changDePaoHuZi(2);
                    return;
                }
            }
            //吃
...
PlayLayer_changDePaoHuZi.prototype.showAndHideHeadEffect = function(){
    ...
    else if (curPlayerIsMe_changDePaoHuZi(1)){
        curPlayerNode = arr[1].getChildByName("head");
    }else if (curPlayerIsMe_changDePaoHuZi(2)){
        curPlayerNode = arr[2].getChildByName("head");
    }else if (curPlayerIsMe_changDePaoHuZi(3)){
