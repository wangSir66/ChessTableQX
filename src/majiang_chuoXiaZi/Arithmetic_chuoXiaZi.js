...
(function() {
    ...
    var allCardsArray = [1, 2, 3, 4, 5, 6, 7, 8, 9, 21, 22, 23, 24, 25, 26, 27, 28, 29];
    ...
    majiang.canGang1 = function (peng, hand, putCount) {
        ...
        var left = this.getAllCardsTotal() - tData.cardNext;
        // 最后一张牌不能杠 或 选择最后三张牌不能碰杠
        if (left == 0 || (tData.areaSelectMode.mosanzhangbupenggang && left <= 3)) {
            return rtn;
        }
    ...
    {
        MjClient.majiang_chuoXiaZi = majiang;
    }
    else
    {
