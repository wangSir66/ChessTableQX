...
function SetUserVisible_sanDaHaHengYang(node, off) {
    ...
    if (pl) {
        ...
        InitUserHandUI_sanDaHaHengYang(node, off);
    } else {
        name.visible = false;
        coin.visible = false;
...
function InitUserHandUI_sanDaHaHengYang(node, off) {
...
var PlayLayer_sanDaHaHengYang = cc.Layer.extend({
    _btnPutCard: null,
    jsBind: {
        _event: {
            mjhand: function() {
            ...
            roundEnd: function() {
                ...
                function delayExe() {
                    ...
                    self.addChild(new EndOneView_sanDaHaHengYang(), 500);
                }
        ...
        down: {
            ...
            _event: {
                ...
                initSceneData: function(eD) {
                    SetUserVisible_sanDaHaHengYang(this, 0);
                ...
                mjhand: function(eD) {
                    ...
                    InitUserHandUI_sanDaHaHengYang(this, 0);
        ...
        right: {
            ...
            _event: {
                ...
                initSceneData: function(eD) {
                    SetUserVisible_sanDaHaHengYang(this, 1);
                },
                addPlayer: function(eD) {
                    SetUserVisible_sanDaHaHengYang(this, 1);
                },
                ...
                mjhand: function(eD) {
                    InitUserHandUI_sanDaHaHengYang(this, 1);
                },
                roundEnd: function() {
        ...
        top: {
            ...
            _event: {
                ...
                initSceneData: function(eD) {
                    SetUserVisible_sanDaHaHengYang(this, 2);
                },
                addPlayer: function(eD) {
                    SetUserVisible_sanDaHaHengYang(this, 2);
                },
                ...
                mjhand: function(eD) {
                    InitUserHandUI_sanDaHaHengYang(this, 2);
                },
                roundEnd: function() {
        ...
        left: {
            ...
            _event: {
                ...
                initSceneData: function(eD) {
                    SetUserVisible_sanDaHaHengYang(this, 3);
                },
                addPlayer: function(eD) {
                    SetUserVisible_sanDaHaHengYang(this, 3);
                },
                ...
                mjhand: function(eD) {
                    InitUserHandUI_sanDaHaHengYang(this, 3);
                },
                roundEnd: function() {
...
PlayLayer_sanDaHaHengYang.prototype.reConnectShowDeskCard = function() {
    var tData = MjClient.data.sData.tData;
...
PlayLayer_sanDaHaHengYang.prototype.cannotOutCardGrey = function() {
...
PlayLayer_sanDaHaHengYang.prototype.recoverCannotOutCard = function() {
    var children = this._downNode.children;
    for (var i = 0; i < children.length; i++) {
        if (children[i].name != "mjhand")
            continue;
...
PlayLayer_sanDaHaHengYang.prototype.clockNumberUpdate = function(node, endFunc) {
    return arrowbkNumberUpdate(node, endFunc);
}

PlayLayer_sanDaHaHengYang.prototype.updateClockPosition = function(arrowNode) {
    var tData = MjClient.data.sData.tData;
    var uids = tData.uids;
 ...
 * @return {String}
 */
PlayLayer_sanDaHaHengYang.prototype.getGameInfoString = function(param) {
    var tData = MjClient.data.sData.tData;
...
PlayLayer_sanDaHaHengYang.prototype.updateOperateBtnPosition = function() {
...
// 拖拉机动画
PlayLayer_sanDaHaHengYang.prototype.playCardAni_liandui = function() {
...
// 闲家得分达到条件时动画、投降
PlayLayer_sanDaHaHengYang.prototype.playWinAni = function(winType) {
...
// 刷新得分栏
PlayLayer_sanDaHaHengYang.prototype.refreshScoreBanner = function(shouldPlayAnim) {
    var tData = MjClient.data.sData.tData;
...
// 判断是否有不同意投降的玩家
PlayLayer_sanDaHaHengYang.prototype.haveNotAgreeTouXiang = function()
{
    var sData = MjClient.data.sData;
    var tData = MjClient.data.sData.tData;
...
// 重置玩家同意投降状态
PlayLayer_sanDaHaHengYang.prototype.initAgreeTouXiangStatus = function()
{
    var sData = MjClient.data.sData;
    var tData = MjClient.data.sData.tData;
    for (var i = 0; i < tData.uids.length; i++)
...
PlayLayer_sanDaHaHengYang.prototype.showWaitTip = function(isTouXiang) {
    var sData = MjClient.data.sData;
    var tData = sData.tData;
...
PlayLayer_sanDaHaHengYang.prototype.clearWaitTip = function() {
...
// 显示各玩家叫分
PlayLayer_sanDaHaHengYang.prototype.showJiaoFenTag = function(off) {
    var tData = MjClient.data.sData.tData;
...
// 隐藏各玩家叫分
PlayLayer_sanDaHaHengYang.prototype.hideJiaoFenTag = function() {
...
// 显示叫分面板
PlayLayer_sanDaHaHengYang.prototype.showJiaoFenPanel = function() {
    if (MjClient.rePlayVideo != -1)
    {
        MjClient.playui.jsBind.panel.jiaoFenPanel._node.setVisible(false);
        return;
...
// 把底牌添加到手牌中
PlayLayer_sanDaHaHengYang.prototype.addDiPaiToHand = function() {
    var tData = MjClient.data.sData.tData;
...
// 从手牌中移除埋的牌
PlayLayer_sanDaHaHengYang.prototype.removeMaiPaiFromHand = function() {
    var tData = MjClient.data.sData.tData;
    var off = getOffByIndex(tData.curPlayer);
...
// 显示投降同意选择框
PlayLayer_sanDaHaHengYang.prototype.showTouXuangDialog = function() {
     if (MjClient.rePlayVideo != -1)
        return;
...
// 显示叫主面板
PlayLayer_sanDaHaHengYang.prototype.showJiaoZhuPanel = function() {
    var tData = MjClient.data.sData.tData;
...
// 显示埋牌、投降按扭
PlayLayer_sanDaHaHengYang.prototype.showMaiPaiBtn = function() {
    var tData = MjClient.data.sData.tData;
...
// 显示上一轮面板
PlayLayer_sanDaHaHengYang.prototype.showShangYiLunPanel = function(shangYiLunPanel) {
    var tData = MjClient.data.sData.tData;
...
// 显示查看底牌面板
PlayLayer_sanDaHaHengYang.prototype.showDiPaiPanel = function(diPaiPanel) {
    var tData = MjClient.data.sData.tData;
...
// 显示查牌面板
PlayLayer_sanDaHaHengYang.prototype.showChaPaiPanel = function(chaPaiPanel) {
    var tData = MjClient.data.sData.tData;
    var records = tData.putCardsRecord;
...
// 显示得分栏上的具体分牌
PlayLayer_sanDaHaHengYang.prototype.showScoreCards = function(panel, cards) {
...
// 给手牌中的主牌设置角标
PlayLayer_sanDaHaHengYang.prototype.setCardSprite_ZhuTag = function(node) {
    var tData = MjClient.data.sData.tData;
...
// 计算各牌色数量
PlayLayer_sanDaHaHengYang.prototype.getCardNumByColor = function(cards, colorIndex) {
    var num = 0;
    var types = [1, 2, 3, 0, 4]
    for (var i = 0; i < cards.length; i++) {
...
// 清空桌面
PlayLayer_sanDaHaHengYang.prototype.clearDesk = function() {
    cc.log("clearDesk")
...
PlayLayer_sanDaHaHengYang.prototype.CardLayoutRestore = function(node, off) {
    cc.log("横向排序 off=" + off);
    MjClient.playui.horSort(node, off);
};

PlayLayer_sanDaHaHengYang.prototype.CardLayoutDesk = function(node, cards, off) {
    //if(off != 0) return;
    var children = node.children;
...
//横向摆放《正常》
PlayLayer_sanDaHaHengYang.prototype.horSort = function(node, off) {
    var pl; //player 信息
