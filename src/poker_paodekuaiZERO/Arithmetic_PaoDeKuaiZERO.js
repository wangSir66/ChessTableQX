...
PaoDeKuaiZERO.prototype.CARDTPYE = PDK_CARDTPYE;
var PDK_CARDCOUNT = {};
...
PaoDeKuaiZERO.prototype.allTipsNoOrder = [
    [PDK_CARDTPYE.danpai, []],
    [PDK_CARDTPYE.duizi, []],
...
PaoDeKuaiZERO.prototype.randomCards = function(areaSelectMode, tData) {
    var cards = [];
...
*crdeNum:每个玩家发多少牌
*/
PaoDeKuaiZERO.prototype.noZhadan = function(randCards, plycnt, crdeNum) {
 ...
 * @return {number}
 */
PaoDeKuaiZERO.prototype.calPoint = function(num) {
    if (!num)
        return -1;
 ...
 * @return {boll} 
 */
PaoDeKuaiZERO.prototype.isSanShun = function(oCards){
...
// console.log( PaoDeKuaiZERO.prototype.isSanShun([3,3,3]) );
 ...
 */
PaoDeKuaiZERO.prototype.getSanShunAndSanPai = function(oCards, valueCompared){
    var countSanSame = 0;
    // 记录所有3张的数值
    var sanSameList = [];
    // 记录散牌
...
// console.log( PaoDeKuaiZERO.prototype.getSanShunAndSanPai(handCards) );


PaoDeKuaiZERO.prototype.countDuiNum = function(oCards){
    var num = 0;
    var cardNumByValue = {};
    for(var i in oCards){
...
PaoDeKuaiZERO.prototype.formatFeiJiType = function(oCards,areaSelectMode, valueCompared){
    // 记录所有3张的数值
    var sanSameList = [];
    // 记录散牌
    var sanPaiList = [];
 ...
 */
PaoDeKuaiZERO.prototype.isFeiJi = function(oCards,areaSelectMode){
 ...
 * @return {bool}
 */
PaoDeKuaiZERO.prototype.isShun = function(oCards) {
...
PaoDeKuaiZERO.prototype.isZhaDan = function(oCards, areaSelectMode) {
...
PaoDeKuaiZERO.prototype.isHadZhaDan = function(cards, areaSelectMode) {
...
//统计牌里有多少炸弹
PaoDeKuaiZERO.prototype.ZhadanCount = function(cards, areaSelectMode) {
    if (!cards) return 0;
    var ZhaDanAry = [];
    for(var i=0; i < cards.length; i++){
        var cardValue = this.calPoint(cards[i]);
...
// 是否拆散了炸弹牌型
PaoDeKuaiZERO.prototype.isChaiZhaDan = function(handCards, putCards, areaSelectMode){
 ...
 * @return {bool}
 */
PaoDeKuaiZERO.prototype.isLiandui = function(oCards) { //oCards有序
 ...
 */
PaoDeKuaiZERO.prototype.calType = function(pCards, areaSelectMode) {
...
PaoDeKuaiZERO.prototype.cardsType = function(cards, areaSelectMode) {
 ...
 * @return {number}
 */
PaoDeKuaiZERO.prototype.calCardsValue = function(cards, type, areaSelectMode) {
...
// 牌点比较函数
PaoDeKuaiZERO.prototype.cardValueCmp = function(a, b) {
...
PaoDeKuaiZERO.prototype.cardSortBigToSmall = function(a, b) {
    var pa = this.calPoint(a);
    var pb = this.calPoint(b);
    if (pa == pb)
        return b - a;
 ...
 * @return {number} 返回癞子数
 */
PaoDeKuaiZERO.prototype.transformAndGetLaizi = function(oCards, cards) {
    var laizi = 0;
    for (var i = 0; i < oCards.length; i++) {
 ...
 */
PaoDeKuaiZERO.prototype.canPut = function(oCards, oLastCards, handsNum, areaSelectMode) {

    var cardsType = this.calType(oCards, areaSelectMode);

    // cc.log("PaoDeKuaiZERO.prototype.canPut oCards:", oCards );
 ...
 */
PaoDeKuaiZERO.prototype.checkPut = function(oHands, cards, lastCards, areaSelectMode, isNextPlayerOneCard, isFirstRound) {
...
PaoDeKuaiZERO.prototype.getMaxDanPai = function(oCards) {
 ...
 */
PaoDeKuaiZERO.prototype.sortHandCards = function(oCards, sortType) {
 ...
 * @return {array}
 */
PaoDeKuaiZERO.prototype.findNSameCard = function(hands, point, n) {
...
// 删除相应牌值
PaoDeKuaiZERO.prototype.delPoint = function(hands, points){
    var arr = hands.slice();
 ...
 */
PaoDeKuaiZERO.prototype.lieju = function(parr, num){
    var tmps = [];
...
PaoDeKuaiZERO.prototype.formatCards = function(oCards) {
    var info = {};
...
PaoDeKuaiZERO.prototype.indexOfCards = function(cardList, cards) {
...
PaoDeKuaiZERO.prototype.isSameCards = function(cards1, cards2) {
...
PaoDeKuaiZERO.prototype.findCardByRole = function(oCards, findNum, ignoreCardValued) {
 ...
 * @param {array} 拼好的 
 */
PaoDeKuaiZERO.prototype.findCardByType = function(hands, laizi, type, lastCards, buChaiTypes, areaSelectMode) {
    var rets = [];
    var laizis = [];
...
PaoDeKuaiZERO.prototype.getAllMaxCard = function(oCards){
...
PaoDeKuaiZERO.prototype.sortByCardType = function(cardsList, areaSelectMode) {
...
PaoDeKuaiZERO.prototype.findDaiPai = function(oCards, type, findNum, same, buChaiTypes) {
    var ret = [];
...
// 此函数只供提示出牌调用
PaoDeKuaiZERO.prototype.findCardByType_fast = function(hands, laizi, type, lastCards, buChaiTypes, areaSelectMode) {
...
PaoDeKuaiZERO.prototype.initCanPutTypes = function(hands, includeCard, areaSelectMode) {
 ...
 * @return {array} 提示的牌
 */
PaoDeKuaiZERO.prototype.findPutTipCards = function(hands, lastCards, areaSelectMode, isNextPlayerOneCard, isFirstRound, putOrder, allBuChaiTypes) {
 ...
 * @return {Boolean} 
 */
PaoDeKuaiZERO.prototype.isMustPutCard3 = function(oHands, areaSelectMode, isFirstRound) {
 ...
 * @return {array} 提示的牌
 */
PaoDeKuaiZERO.prototype.tipCards = function(oHands, oLastCards, areaSelectMode, isNextPlayerOneCard, isFirstRound, isSmartTip) {
    if(isSmartTip) {
        this.canPutTypesCache = [];
 ...
 */
PaoDeKuaiZERO.prototype.IsSametipCards = function(tipscardsArray, areaSelectMode)
{
 ...
 * @param  {Boolean} areaSelectMode 创建房间的选项
 */
PaoDeKuaiZERO.prototype.delDaipai = function(Cards, areaSelectMode)
{
    var cardtype = this.calType(Cards, areaSelectMode);
...
if(typeof(module)!="undefined" && module.exports)    
    module.exports = PaoDeKuaiZERO;

if(typeof(MjClient)!="undefined")
    MjClient.majiang_PaoDeKuaiZERO = new PaoDeKuaiZERO();

/*
PaoDeKuaiZERO.prototype.shuffleArray_paodekuai = function(arr, playcnt) {
...
*/
PaoDeKuaiZERO.prototype.shuffleArray = function(arr) {
    for (var i = 0; i < arr.length; i++) {
        var randIndex = i + Math.floor(Math.random() * (arr.length - i));
        var temp = arr[i];
        arr[i] = arr[randIndex];
...
PaoDeKuaiZERO.prototype.randomCards__test = function(areaSelectMode, tData, bnew) {
    var cards = [];
    var handCardNum = 0 == areaSelectMode['cardNumIndex'] ? 16 : 15;
    this.handCount = handCardNum;   // GameCode runStartGame 发牌用到
    // 首出规则  
...
PaoDeKuaiZERO.prototype.doF = function(areaSelectMode, tData, bnew)
{
...
PaoDeKuaiZERO.prototype.checkshuffleArray = function(areaSelectMode, tData)
{
