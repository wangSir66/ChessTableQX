...
function SetUserVisible_PaoDeKuaiZERO(node, off)
{
    ...
    if(pl)
    {
        ...
        InitUserHandUI_PaoDeKuaiZERO(node, off);
    }
    else
    {
        name.visible = false;
...
function InitUserHandUI_PaoDeKuaiZERO(node, off, needSort)
{
...
function cardsSort_PaoDeKuaiZERO(cards)
{
    var pointCounts = {};
...
var PlayLayer_PaoDeKuaiZERO = cc.Layer.extend({
    _btnPutCard:null,
    jsBind: {
        _run: function() {
        ...
        _event: {
            ...
            roundEnd: function() {
                ...
                function delayExe()
                {
                    ...
                    if(MjClient.isInGoldFieldNormal()){//金币场普通场
                        ...
                        self.addChild(new EndOneView_PaoDeKuaiZERO(),500);
                    }
                }

                // 金币场普通场需要展示其他玩家剩余手牌
                if (MjClient.isInGoldFieldNormal() && MjClient.rePlayVideo == -1) {
                ...
                {
                    MjClient.playui.reConectHeadLayout_PaoDeKuaiZERO(this);
                }
            },
            moveHead: function() {
            ...
            initSceneData: function() {
                ...
                MjClient.playui.reConectHeadLayout_PaoDeKuaiZERO(this);
                MjClient.playui.showJiaZhu_PaoDeKuaiZERO()
                MjClient.playui.resetJiaZhuNum(this);
                CheckRoomUiDelete();
        ...
        BtnNoPut:{
            ...
            _click: function(btn) {
                cc.log("============mjhand=========== BtnNoPutBtnNoPutBtnNoPutBtnNoPutBtnNoPutBtnNoPutBtnNoPutBtnNoPutBtnNoPut");
        ...
        BtnPutCard:{
            ...
            _click: function(btn) {
                //cc.log("BtnPutCard");
				cardsSort_PaoDeKuaiZERO(MjClient.selectCards_card);
        ...
        down: {
            ...
            _event: {
                ...
                initSceneData: function(eD) {
                    SetUserVisible_PaoDeKuaiZERO(this, 0);
                ...
                mjhand: function(eD) {
                    InitUserHandUI_PaoDeKuaiZERO(this, 0);
                ...
                waitJiazhu: function(msg) {
                    var tData = MjClient.data.sData.tData;
                    var layer = new JiaZhu_PaoDeKuaiZERO(tData.areaSelectMode.piaofen,function(){
                        //弹窗等待
        ...
        right: {
            ...
            _event: {
                ...
                initSceneData: function(eD) {
                    SetUserVisible_PaoDeKuaiZERO(this, 1);
                },
                addPlayer: function(eD) {
                    SetUserVisible_PaoDeKuaiZERO(this, 1);
                },
                ...
                mjhand: function(eD) {
                    InitUserHandUI_PaoDeKuaiZERO(this, 1);
                },
                roundEnd: function() {
        ...
        top: {
            ...
            _event: {
                ...
                initSceneData: function(eD) {
                    SetUserVisible_PaoDeKuaiZERO(this, 2);
                },
                addPlayer: function(eD) {
                    SetUserVisible_PaoDeKuaiZERO(this, 2);
                },
                ...
                mjhand: function(eD) {
                    InitUserHandUI_PaoDeKuaiZERO(this, 2);
                },
                roundEnd: function() {
    ...
    ctor: function() {
        this._super();
        var playui = ccs.load(res.Play_PaoDeKuaiTY_json);
...
PlayLayer_PaoDeKuaiZERO.prototype.InitC_Data = function() {
...
PlayLayer_PaoDeKuaiZERO.prototype.cannotOutCardGrey = function()
{
...
PlayLayer_PaoDeKuaiZERO.prototype.recoverCannotOutCard = function()
{
    var children = this._downNode.children;
    for (var i = 0; i < children.length; i++)
    {
...
PlayLayer_PaoDeKuaiZERO.prototype.clockNumberUpdate = function(node, endFunc)
{
    return arrowbkNumberUpdate(node, endFunc);
}

PlayLayer_PaoDeKuaiZERO.prototype.updateClockPosition = function(arrowNode)
{
    var tData = MjClient.data.sData.tData;
    var uids = tData.uids;
 ...
 * @return {String}
 */
PlayLayer_PaoDeKuaiZERO.prototype.getGameInfoString = function(param)
{
    var tData = MjClient.data.sData.tData;
    var str = "";
    ...
    str += tData.areaSelectMode.PaoDeKuaiZERO_difen ? "底分X" + tData.areaSelectMode.PaoDeKuaiZERO_difen + ","  : "";
    ...
    if(MjClient.isInGoldField())
    {
        str = "";
        str += tData.areaSelectMode.cardNumIndex == 0 ? "16张" : "15张";
        str += tData.areaSelectMode.PaoDeKuaiZERO_difen ? ",底分X" + tData.fieldBase: "";
    }
    return str;
};

PlayLayer_PaoDeKuaiZERO.prototype.shwoFlyCardAnim = function(flyNode)
{
    var tData = MjClient.data.sData.tData;
...
// 播放先手标识动画
PlayLayer_PaoDeKuaiZERO.prototype.showOffenseAnim = function()
{
    var tData = MjClient.data.sData.tData;
    var off = getOffByIndex(tData.curPlayer);
    var playerNode = getNode_cards(off);
...
PlayLayer_PaoDeKuaiZERO.prototype.showHandCardBeiMian = function()
{
...
PlayLayer_PaoDeKuaiZERO.prototype.hideHandCardBeiMian = function()
{
...
//金币场每局获取分数的动画
PlayLayer_PaoDeKuaiZERO.prototype.showGetScoreAni_filedQuick = function (off)
{   
...
//处理金币场快速赛牌局结束时布局
PlayLayer_PaoDeKuaiZERO.prototype.cardLayoutRestore_endfiledQuick = function (off)
{
...
//处理金币场牌局结束时布局
PlayLayer_PaoDeKuaiZERO.prototype.cardLayoutRestore_endfiled = function (off)
{
    var node = getNode_cards(off);
    //隐藏牌数标记
    var tingCard = node.getChildByName('head').getChildByName("tingCard");
...
PlayLayer_PaoDeKuaiZERO.prototype.CardLayoutRestore = function(node, off, needSort)
{
    cc.log("PlayLayer_PaoDeKuaiZERO11==============");
    ...
    cc.log("PlayLayer_PaoDeKuaiZERO22==============");
...
PlayLayer_PaoDeKuaiZERO.prototype.CardLayoutDesk = function(node,cards,off)
{
    //if(off != 0) return;
    var children = node.children;
...
//横向摆放《正常》
PlayLayer_PaoDeKuaiZERO.prototype.horSort = function(node, off, needSort)
{
    var pl; //player 信息
...
//纵向摆放
PlayLayer_PaoDeKuaiZERO.prototype.verSort = function(node, off, needSort)
{
    if(off != 0)
    {
        return;
    ...
    */
    ...
    // && !MjClient.playui.getChildByName("JiaZhu")

PlayLayer_PaoDeKuaiZERO.prototype.showJiaZhu_PaoDeKuaiZERO = function()
{
    var sData = MjClient.data.sData;
    var tData = sData.tData;
    var pl = getUIPlayer(0);
 ...
 PlayLayer_PaoDeKuaiZERO.prototype.resetJiaZhuNum = function(node)
{
    ...
    this.setJiaZhuNum(down, getUIPlayer(0));
    this.setJiaZhuNum(right, getUIPlayer(1));
    this.setJiaZhuNum(top, getUIPlayer(2));
    this.setJiaZhuNum(left, getUIPlayer(3));
},

PlayLayer_PaoDeKuaiZERO.prototype.setJiaZhuNum = function (node, pl)
{
    if(!pl) return;
...
//头像位置
PlayLayer_PaoDeKuaiZERO.prototype.reConectHeadLayout_PaoDeKuaiZERO = function (node)
{
    var sData = MjClient.data.sData;
    if(MjClient.isInGoldField())
...
//时间节点设置
PlayLayer_PaoDeKuaiZERO.prototype.BgTime_run = function (node)
{
    var text = new ccui.Text();
...
//设置红包活动按钮位置
PlayLayer_PaoDeKuaiZERO.prototype.setHongBaoPos = function (hongbaoBtn)
{
...
//////////////////////////金币场UI调整//////////////////////////////////////////////////////////////////////////////////////
PlayLayer_PaoDeKuaiZERO.prototype.reConectHeadLayout_PaoDeKuai_fieldId= function (node)
{
...
PlayLayer_PaoDeKuaiZERO.prototype.initFieldIdUI = function (node)
{
    var sData = MjClient.data.sData;
    var tData = sData.tData;
...
PlayLayer_PaoDeKuaiZERO.prototype.BindFieldIdUI = function (node)
{
    var uibind = {
        bottonBG:
        {
...
// 更新wifi信号 3张图片
PlayLayer_PaoDeKuaiZERO.prototype.updateWifiState_field = function(node)
{
...
PlayLayer_PaoDeKuaiZERO.prototype.isUsingJiPaiQi = function()
{
    var jipaiqi = MjClient.data.sData.tData.jipaiqi;
    return jipaiqi && jipaiqi.indexOf(SelfUid()) >= 0;
}

PlayLayer_PaoDeKuaiZERO.prototype.createJiPaiQiPanel = function()
{
...
// 记牌器购买面板
PlayLayer_PaoDeKuaiZERO.prototype.showJiPaiQiBuyingPanel = function(commoditys,purchaseCallback) {
...
PlayLayer_PaoDeKuaiZERO.prototype.setJiPaiQiEnabled = function(node) {
    var tData = MjClient.data.sData.tData;
...
PlayLayer_PaoDeKuaiZERO.prototype.setJiPaiQiNum = function(node) {
...
PlayLayer_PaoDeKuaiZERO.prototype.checkJiPaiQiListValid = function(commoditys) {
...
PlayLayer_PaoDeKuaiZERO.prototype.checkJiPaiQiButtonVisible = function(node) {
