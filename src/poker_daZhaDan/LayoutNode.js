 ...
 */
daZhaDan.LayoutNode = ccui.Layout.extend({
    _childArr : null,
    _alignType: null,
    _gap : 0,
    ctor: function () {
    ...
    _setNodePosition:function(node, preNode){
        ...
        switch (this._alignType){
            case daZhaDan.LayoutNodeAlignType.LEFT:
                node.x = 0;
                break;
            case daZhaDan.LayoutNodeAlignType.RIGHt:
                node.x = this.width;
                break;
            case daZhaDan.LayoutNodeAlignType.CENTER:
