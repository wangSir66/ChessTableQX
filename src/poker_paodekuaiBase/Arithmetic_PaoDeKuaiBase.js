...
//========================================牌值相关========================================
    ...
    this.PDK_KPOINT = 13;
    this.PDK_APOINT = 14;
    this.PDK_2POINT = 16;// 2，和A必须分开
    this.PDK_MAXPOINT = this.PDK_2POINT; 
//========================================牌型相关========================================
    // 牌型排序优先级 和 id this.CARDTPYE
    this.CARDTPYE= {
        sidaisan: 14,
        sandaier: 13,
    ...
    this.PDK_CARDCOUNT = {};
    this.PDK_CARDCOUNT[this.CARDTPYE.feiji] = 8;
    this.PDK_CARDCOUNT[this.CARDTPYE.sanshun] = 6;
    this.PDK_CARDCOUNT[this.CARDTPYE.sidaier] = 6;
    this.PDK_CARDCOUNT[this.CARDTPYE.sidaisan] = 5;
    this.PDK_CARDCOUNT[this.CARDTPYE.sangeA] = 3;
    this.PDK_CARDCOUNT[this.CARDTPYE.sange3] = 3;
    this.PDK_CARDCOUNT[this.CARDTPYE.sizha] = 4;
    this.PDK_CARDCOUNT[this.CARDTPYE.sandaier] = 5;
    this.PDK_CARDCOUNT[this.CARDTPYE.sandaiyi] = 4;
    this.PDK_CARDCOUNT[this.CARDTPYE.liandui] = 4;
    this.PDK_CARDCOUNT[this.CARDTPYE.shunzi] = 5;
    this.PDK_CARDCOUNT[this.CARDTPYE.sanzhang] = 3;
    this.PDK_CARDCOUNT[this.CARDTPYE.duizi] = 2;
    this.PDK_CARDCOUNT[this.CARDTPYE.danpai] = 1;
...
//========================================智能提示相关========================================
    ...
    带3顺子最长的顺子 不拆炸弹
    */
    this.pdk_putOrder[99] = [
        [PDK_CARDTPYE.danpai, []],
        [PDK_CARDTPYE.duizi, [this.pdk_allZhaDan]],
        [PDK_CARDTPYE.sandaier, [this.pdk_allZhaDan]],
        [PDK_CARDTPYE.sandaiyi, [this.pdk_allZhaDan]],
        [PDK_CARDTPYE.liandui, [this.pdk_allZhaDan]],
        [PDK_CARDTPYE.shunzi, [this.pdk_allZhaDan]],
    ];
    ...
    */
    this.pdk_putOrder[0] = [
        ...
        [PDK_CARDTPYE.shunzi, this.pdk_allBuChaiType],
    ...
    7.  单牌
    */
    this.pdk_putOrder[PDK_CARDTPYE.danpai] = [
        [PDK_CARDTPYE.danpai, this.pdk_allBuChaiType],
        [PDK_CARDTPYE.danpai, [this.pdk_allZhaDan, PDK_CARDTPYE.sanzhang, PDK_CARDTPYE.duizi, PDK_CARDTPYE.shunzi]],
        [PDK_CARDTPYE.danpai, [this.pdk_allZhaDan, PDK_CARDTPYE.sanzhang, PDK_CARDTPYE.duizi]],
        [PDK_CARDTPYE.danpai, [this.pdk_allZhaDan, PDK_CARDTPYE.sanzhang]],
        [PDK_CARDTPYE.danpai, [this.pdk_allZhaDan]],
        [this.pdk_allZhaDan, []],
        [PDK_CARDTPYE.danpai, []],
    ];
    ...
    7.  对子，
    */
    this.pdk_putOrder[PDK_CARDTPYE.duizi] = [
        // [PDK_CARDTPYE.duizi, this.pdk_allBuChaiType],
        // [PDK_CARDTPYE.duizi, [this.pdk_allZhaDan, PDK_CARDTPYE.feiji, PDK_CARDTPYE.sanzhang, PDK_CARDTPYE.shunzi]],
        // [PDK_CARDTPYE.duizi, [this.pdk_allZhaDan, PDK_CARDTPYE.feiji, PDK_CARDTPYE.sanzhang]],
        // [PDK_CARDTPYE.duizi, [this.pdk_allZhaDan, PDK_CARDTPYE.feiji]],
        [PDK_CARDTPYE.duizi, [this.pdk_allZhaDan]],
        [this.pdk_allZhaDan, []],
        [PDK_CARDTPYE.duizi, []],
    ];
    ...
    3.连对
    */
    this.pdk_putOrder[PDK_CARDTPYE.liandui] = [
        [PDK_CARDTPYE.liandui, this.pdk_allBuChaiType],
        [PDK_CARDTPYE.liandui, [this.pdk_allZhaDan,PDK_CARDTPYE.sanzhang]],    
        [PDK_CARDTPYE.liandui, [this.pdk_allZhaDan]],
        [this.pdk_allZhaDan, []],
        [PDK_CARDTPYE.liandui, []],
    ];
    ...
    6.  炸弹
    */
    this.pdk_putOrder[PDK_CARDTPYE.shunzi] = [
        [PDK_CARDTPYE.shunzi, this.pdk_allBuChaiType],
        [PDK_CARDTPYE.shunzi, [this.pdk_allZhaDan, PDK_CARDTPYE.feiji, PDK_CARDTPYE.duizi]],
        [PDK_CARDTPYE.shunzi, [this.pdk_allZhaDan, PDK_CARDTPYE.feiji]],
        [PDK_CARDTPYE.shunzi, [this.pdk_allZhaDan]],
        [PDK_CARDTPYE.shunzi, []],
        [this.pdk_allZhaDan, []],
    ];
    ...
    */
    ...
    var pdk_get_sandaiyi_sandaier_putOrder = function(type) {
        return [
            [type, _this.pdk_allBuChaiType],
            [type, [_this.pdk_allZhaDan, PDK_CARDTPYE.feiji]],
            [type, [_this.pdk_allZhaDan]],
            [_this.pdk_allZhaDan, []],
            [type, []],
        ];
    }
    this.pdk_putOrder[PDK_CARDTPYE.sandaiyi] = pdk_get_sandaiyi_sandaier_putOrder(PDK_CARDTPYE.sandaiyi);
    this.pdk_putOrder[PDK_CARDTPYE.sandaier] = pdk_get_sandaiyi_sandaier_putOrder(PDK_CARDTPYE.sandaier);

    // 三带一 带牌顺序
    this.pdk_daiPaiOrder[PDK_CARDTPYE.sandaiyi] = [
        [PDK_CARDTPYE.danpai, this.pdk_allBuChaiType],
        [PDK_CARDTPYE.danpai, [this.pdk_allZhaDan, PDK_CARDTPYE.sanzhang, PDK_CARDTPYE.duizi, PDK_CARDTPYE.shunzi]],
        [PDK_CARDTPYE.danpai, [this.pdk_allZhaDan, PDK_CARDTPYE.sanzhang, PDK_CARDTPYE.duizi]],
        [PDK_CARDTPYE.danpai, [this.pdk_allZhaDan, PDK_CARDTPYE.sanzhang]],
    ...
    10. 选择二张，拆三张不拆/炸弹
    */
    this.pdk_daiPaiOrder[PDK_CARDTPYE.sandaier] = [
        [PDK_CARDTPYE.danpai, [this.pdk_allBuChaiType]],
        [PDK_CARDTPYE.duizi, [this.pdk_allBuChaiType]],
        [PDK_CARDTPYE.danpai, [this.pdk_allZhaDan, PDK_CARDTPYE.sanzhang, PDK_CARDTPYE.shunzi]],
        [PDK_CARDTPYE.duizi, [this.pdk_allZhaDan, PDK_CARDTPYE.feiji, PDK_CARDTPYE.sanzhang, PDK_CARDTPYE.shunzi]],
        [PDK_CARDTPYE.duizi, [this.pdk_allZhaDan, PDK_CARDTPYE.feiji, PDK_CARDTPYE.sanzhang]],
        [PDK_CARDTPYE.duizi, [this.pdk_allZhaDan, PDK_CARDTPYE.feiji]],
        [PDK_CARDTPYE.duizi, [this.pdk_allZhaDan]],
        [PDK_CARDTPYE.danpai, [this.pdk_allZhaDan, PDK_CARDTPYE.feiji]],
        [PDK_CARDTPYE.danpai, [this.pdk_allZhaDan]],
    ];
    ...
    */
    this.pdk_putOrder[PDK_CARDTPYE.sidaier] = [
        [this.pdk_allZhaDan, []],
        [PDK_CARDTPYE.sidaier, []],
    ];

    // 四带二 带牌顺序
    this.pdk_daiPaiOrder[PDK_CARDTPYE.sidaier] = [
        [PDK_CARDTPYE.danpai, [this.pdk_allBuChaiType]],
        [PDK_CARDTPYE.danpai, [this.pdk_allZhaDan, PDK_CARDTPYE.sanzhang, PDK_CARDTPYE.shunzi]],
        [PDK_CARDTPYE.danpai, [this.pdk_allZhaDan, PDK_CARDTPYE.sanzhang]],
        [PDK_CARDTPYE.danpai, [this.pdk_allZhaDan]],
    ...
    提示最小的三张牌
    */
    this.pdk_putOrder[PDK_CARDTPYE.sidaisan] = [
        [this.pdk_allZhaDan, []],
        [PDK_CARDTPYE.sidaisan, []],
    ];

    // 四带三 带牌顺序
    this.pdk_daiPaiOrder[PDK_CARDTPYE.sidaisan] = [
        [PDK_CARDTPYE.danpai, [this.pdk_allBuChaiType]],
        [PDK_CARDTPYE.danpai, [this.pdk_allZhaDan, PDK_CARDTPYE.sanzhang, PDK_CARDTPYE.shunzi]],
        [PDK_CARDTPYE.danpai, [this.pdk_allZhaDan]],
        [PDK_CARDTPYE.danpai, []],
    ...
    需要拆炸弹的飞机
    */
    this.pdk_putOrder[PDK_CARDTPYE.feiji] = [
        [PDK_CARDTPYE.feiji, [this.pdk_allZhaDan]],
        [this.pdk_allZhaDan, []],
        [PDK_CARDTPYE.feiji, []],
    ];
    ...
    提示最小的三张张牌
    */
    this.pdk_daiPaiOrder[PDK_CARDTPYE.feiji] = [
        [PDK_CARDTPYE.danpai, [this.pdk_allBuChaiType]],
...
PaodekuaiBase.prototype.randomCards = function(areaSelectMode, tData) {
    var cards = [];
...
*crdeNum:每个玩家发多少牌
*/
PaodekuaiBase.prototype.noZhadan = function(randCards, plycnt, crdeNum) {
 ...
 * @return {number}
 */
PaodekuaiBase.prototype.calPoint = function(num, justValue) {
    if (!num)
        return -1;
    
    var ceilNum = Math.ceil(num / 4);
    if (ceilNum == 1 && !justValue)
        return this.PDK_APOINT; // A记为14
    
    if (ceilNum == 2 && !justValue)
        return this.PDK_MAXPOINT; // 2记为16
 ...
 * @return {boll} 
 */
PaodekuaiBase.prototype.isSanShun = function(oCards){
...
// console.log( PaodekuaiBase.prototype.isSanShun([3,3,3]) );
 ...
 */
PaodekuaiBase.prototype.getSanShunAndSanPai = function(oCards, valueCompared){
    var countSanSame = 0;
    // 记录所有3张的数值
    var sanSameList = [];
    // 记录散牌
...
PaodekuaiBase.prototype.countDuiNum = function(oCards){
    var num = 0;
    var cardNumByValue = {};
    for(var i in oCards){
...
PaodekuaiBase.prototype.formatFeiJiType = function(oCards,areaSelectMode, valueCompared){
    // 记录所有3张的数值
    var sanSameList = [];
    // 记录散牌
    var sanPaiList = [];
 ...
 */
PaodekuaiBase.prototype.isFeiJi = function(oCards,areaSelectMode){
 ...
 * @return {bool}
 */
PaodekuaiBase.prototype.isShun = function(oCards) {
...
PaodekuaiBase.prototype.isZhaDan = function(oCards, areaSelectMode) {
...
PaodekuaiBase.prototype.isHadZhaDan = function(cards, areaSelectMode) {
...
//统计牌里有多少炸弹
PaodekuaiBase.prototype.ZhadanCount = function(cards, areaSelectMode) {
    if (!cards) return 0;
    var ZhaDanAry = [];
    for(var i=0; i < cards.length; i++){
        var cardValue = this.calPoint(cards[i]);
    ...
    // this.CARDTPYE.sangeA
    if( areaSelectMode.can3aZhaDan && ZhaDanAry.indexOf(this.PDK_APOINT) < 0) {
        var isSanA = this.findNSameCard(cards, this.PDK_APOINT, 3);
        if(isSanA && cards.length > 3) ZhaDanAry.push(this.PDK_APOINT);
    }

    // this.CARDTPYE.sange3
    if( areaSelectMode.can3ge3ZhaDan && ZhaDanAry.indexOf(this.PDK_MINPOINT) < 0 ) {
        var isSan3 = this.findNSameCard(cards, this.PDK_MINPOINT, 3);
        if(isSan3 && cards.length > 3) ZhaDanAry.push(this.PDK_MINPOINT);
    }
...
// 是否拆散了炸弹牌型
PaodekuaiBase.prototype.isChaiZhaDan = function(handCards, putCards, areaSelectMode){
 ...
 * @return {bool}
 */
PaodekuaiBase.prototype.isLiandui = function(oCards) { //oCards有序
 ...
 */
PaodekuaiBase.prototype.calType = function(pCards, areaSelectMode) {
    ...
    // 三个3算炸弹   带黑桃3不算炸弹
    if (cardCount == this.PDK_CARDCOUNT[this.CARDTPYE.sange3] && allSame && this.calPoint(cards[0]) == this.PDK_MINPOINT && cards.indexOf(this.cardCfg.firstOutCard) < 0 && areaSelectMode.can3ge3ZhaDan)
...
PaodekuaiBase.prototype.cardsType = function(cards, areaSelectMode) {
 ...
 * @return {number}
 */
PaodekuaiBase.prototype.calCardsValue = function(cards, type, areaSelectMode) {
...
// 牌点比较函数
PaodekuaiBase.prototype.cardValueCmp = function(a, b) {
...
PaodekuaiBase.prototype.cardSortBigToSmall = function(a, b) {
    var pa = this.calPoint(a);
    var pb = this.calPoint(b);
    if (pa == pb)
        return b - a;
 ...
 * @return {number} 返回癞子数
 */
PaodekuaiBase.prototype.transformAndGetLaizi = function(oCards, cards) {
    var laizi = 0;
    for (var i = 0; i < oCards.length; i++) {
 ...
 */
PaodekuaiBase.prototype.canPut = function(oCards, oLastCards, handsNum, areaSelectMode) {
 ...
 */
PaodekuaiBase.prototype.checkPut = function(oHands, cards, lastCards, areaSelectMode, isNextPlayerOneCard, isFirstRound) {
    ...
    if (isFirstRound && areaSelectMode && areaSelectMode.firstHeiTao3 && cards.indexOf(this.cardCfg.firstOutCard)<0 && oHands.indexOf(this.cardCfg.firstOutCard)>=0){
        return null;
    }
...
PaodekuaiBase.prototype.getMaxDanPai = function(oCards) {
 ...
 */
PaodekuaiBase.prototype.sortHandCards = function(oCards, sortType) {
 ...
 * @return {array}
 */
PaodekuaiBase.prototype.findNSameCard = function(hands, point, n) {
 ...
 */
PaodekuaiBase.prototype.delPoint = function(hands, points, values){
    var arr = hands.slice();
 ...
 */
PaodekuaiBase.prototype.lieju = function(parr, num){
    var tmps = [];
...
PaodekuaiBase.prototype.lieju2 = function(parr, num){
    var tmps = [];
    var arrRet = [];

    function getZuHe(parr, n, m)
    {
        if(m > 0){
            for(var i = n; i >= m; i--)
            {
                ...
                getZuHe(parr, i-1, m-1);
            }
        } 
        else{
            arrRet.push(tmps.slice());
        }
    }

    getZuHe(parr, parr.length, num);

    return arrRet;
}

PaodekuaiBase.prototype.formatCards = function(oCards) {
    var info = {};
...
PaodekuaiBase.prototype.indexOfCards = function(cardList, cards) {
...
PaodekuaiBase.prototype.isSameCards = function(cards1, cards2) {
...
PaodekuaiBase.prototype.findCardByRole = function(oCards, findNum, ignoreCardValued) {
 ...
 * @param {array} 拼好的 
 */
PaodekuaiBase.prototype.findCardByType = function(hands, laizi, type, lastCards, buChaiTypes, areaSelectMode) {
    var rets = [];
    var laizis = [];
    ...
    if (type == this.CARDTPYE.feiji && hands.length >= cardCount) {
        ...
        if (laizi == 0)
        {
            ...
            var idxht3 = newHands.indexOf(this.cardCfg.firstOutCard);
    ...
    else if(type == this.CARDTPYE.sanshun)
    {
        for (var i = this.PDK_MINPOINT; i <= this.PDK_MAXPOINT - cardCount/3 + 1; i++) // 连对首张
        {
            var ldCount = 0;
            var ret = laizis.slice();
...
PaodekuaiBase.prototype.getAllMaxCard = function(oCards){
...
PaodekuaiBase.prototype.sortByCardType = function(cardsList, areaSelectMode) {
    ...
    var sfun = function(a, b) {
        ...
        if(aType != bType) {
            ...
            // 炸弹优先
            if(aValue == bValue) {
                if(aType == this.CARDTPYE.sizha) return -1;
                if(aType != this.CARDTPYE.sizha) return 1;
            }
        }
    }
...
PaodekuaiBase.prototype.findDaiPai = function(oCards, type, findNum, same, buChaiTypes) {
    var ret = [];
    var daiPaiOrder = this.pdk_daiPaiOrder[type];
    ...
    if (same) {
        for (var i = daiPaiOrder.length - 1; i >= 0; i--) {
            if (daiPaiOrder[i][0] == this.CARDTPYE.danpai)
...
// 此函数只供提示出牌调用
PaodekuaiBase.prototype.findCardByType_fast = function(hands, laizi, type, lastCards, buChaiTypes, areaSelectMode) {
...
PaodekuaiBase.prototype.initCanPutTypes = function(hands, includeCard, areaSelectMode) {
 ...
 * @return {array} 提示的牌
 */
PaodekuaiBase.prototype.findPutTipCards = function(hands, lastCards, areaSelectMode, isNextPlayerOneCard, isFirstRound, putOrder, allBuChaiTypes) {
    ...
    //this.deleteChaiZhanDanArr(hands, rets, areaSelectMode);
    return rets;
}
 ...
 * @return {Boolean} 
 */
PaodekuaiBase.prototype.isMustPutCard3 = function(oHands, areaSelectMode, isFirstRound) {
    isFirstRound = areaSelectMode.isPreRoundFirstRule? true : isFirstRound;
...
PaodekuaiBase.prototype.tipCards = function(oHands, oLastCards, areaSelectMode, isNextPlayerOneCard, isFirstRound, isSmartTip) {
    if(isSmartTip) {
        this.canPutTypesCache = [];
        ...
        this.deleteChaiZhanDanArr(oHands, ret, areaSelectMode);
    ...
    if (this.isMustPutCard3(oHands, areaSelectMode, isFirstRound) && isFirstPlayerPut) {
    ...
    if (areaSelectMode.can3ge3ZhaDan) {
        var cardtypes = this.findCardByType(hands, 0, this.CARDTPYE.sange3, null, null, areaSelectMode);
    ...
    var booms = this.findCardByType(hands, 0, this.CARDTPYE.sizha, null, null, areaSelectMode);
    // 不是压三带二的时候， 最后提示炸弹
    ...
    if(areaSelectMode.can3aZhaDan){
        rets = rets.concat(this.findCardByType(hands, 0, this.CARDTPYE.sangeA, null, null, areaSelectMode) );
    }

    this.deleteChaiZhanDanArr(oHands, rets, areaSelectMode);
 ...
 */
PaodekuaiBase.prototype.IsSametipCards = function(tipscardsArray, areaSelectMode)
{
 ...
 * @param  {Boolean} areaSelectMode 创建房间的选项
 */
PaodekuaiBase.prototype.delDaipai = function(Cards, areaSelectMode)
{
    var cardtype = this.calType(Cards, areaSelectMode);
...
if(typeof(module)!="undefined" && module.exports)    
    module.exports = PaodekuaiBase;

    // if(typeof(MjClient)!="undefined")
    //     MjClient.majiang_PaodekuaiBase = new PaodekuaiBase();
