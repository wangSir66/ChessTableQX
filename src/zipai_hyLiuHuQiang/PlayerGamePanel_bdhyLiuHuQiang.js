...
function SetUserVisible_bdhyLiuHuQiang(node, off){
    ...
    if(pl){
        ...
        // InitUserHandUI_bdhyLiuHuQiang(node, off);
...
function InitUserHandUI_bdhyLiuHuQiang(node, off){
...
var PlayLayer_bdhyLiuHuQiang = cc.Layer.extend({
    jsBind: {
        _event: {
            ...
            cardnumAtlas: {
                ...
                _event: {
                    mjhand: function() {
                        ...
                        var sData = MjClient.data.sData;
                        var tData = sData.tData;
                        var next = (MjClient.majiang.getAllCardsTotal() - tData.cardNext) - this.maiPaiNum;
                        this.y = 40 + next * 0.8
        ...
        down: {
            ...
            _event: {
                ...
                initSceneData: function(eD) {
                    SetUserVisible_bdhyLiuHuQiang(this, 0);
                    InitUserHandUI_bdhyLiuHuQiang(this, 0);
        ...
        xing: {
            ...
            _event: {
                ...
                initSceneData: function(eD) {
                    if(MjClient.MaxPlayerNum_leiyang == 4) {
                        SetUserVisible_bdhyLiuHuQiang(this, 1);
                        InitUserHandUI_bdhyLiuHuQiang(this, 1);
        ...
        right: {
            head: {
                ...
                _event: {
                    ...
                    addPlayer: function(eD) {
                        // showFangzhuTagIcon_hengYang(this,getRightNodeOff_ER());
                    },
                    removePlayer: function(eD) {
                        // showFangzhuTagIcon_hengYang(this,getRightNodeOff_ER());
                    }
            ...
            _event: {
                ...
                initSceneData: function(eD) {
                    SetUserVisible_bdhyLiuHuQiang(this, getRightNodeOff_ER());
                    InitUserHandUI_bdhyLiuHuQiang(this, getRightNodeOff_ER());
                    InitUserCoinAndName_hengYang(this, getRightNodeOff_ER());
                    DealOffLineCard_hengYang(this,getRightNodeOff_ER());
                    MjClient.playui.showAndHideTrust(this, getRightNodeOff_ER());
                },
                addPlayer: function(eD) {
                    SetUserVisible_bdhyLiuHuQiang(this, getRightNodeOff_ER());
                    InitUserCoinAndName_hengYang(this, getRightNodeOff_ER());
                ...
                HZPickCard:function (eD) {
                    ...
                    DealShowLastCard_hengYang(this, eD, getRightNodeOff_ER());
                },
                HZAddCards:function (eD) {
        ...
        left: {
            ...
            head: {
                ...
                _event: {
                    ...
                    addPlayer: function(eD) {
                        // showFangzhuTagIcon_hengYang(this,MjClient.MaxPlayerNum_leiyang - 1);
                    },
                    removePlayer: function(eD) {
                        // showFangzhuTagIcon_hengYang(this,MjClient.MaxPlayerNum_leiyang - 1);
                    }
            ...
            _event: {
                ...
                initSceneData: function(eD) {
                    ...
                    SetUserVisible_bdhyLiuHuQiang(this, MjClient.MaxPlayerNum_leiyang - 1);
                    InitUserHandUI_bdhyLiuHuQiang(this, MjClient.MaxPlayerNum_leiyang - 1);
                    ...
                    MjClient.playui.showAndHideTrust(this, MjClient.MaxPlayerNum_leiyang - 1);
                },
                addPlayer: function(eD) {
                    if(MjClient.MaxPlayerNum_leiyang == 2){
                        return;
                ...
                HZPickCard:function (eD) {
                    ...
                    DealShowLastCard_hengYang(this, eD, MjClient.MaxPlayerNum_leiyang - 1);
                },
                HZAddCards:function (eD) {
                    if(MjClient.MaxPlayerNum_leiyang == 2){
                        return;
    ...
    ctor: function() {
        this._super();
        var playui = ccs.load("Play_hyLiuHuQiang.json");
        playMusic("bgFight");
        var tData = MjClient.data.sData.tData;
...
//重置手牌的顺序
PlayLayer_bdhyLiuHuQiang.prototype.ResetHandCard = function(posNode,off, needAction, isDelay){
...
PlayLayer_bdhyLiuHuQiang.prototype._doMovetoAction = function(node,endP){
    node.stopAllActions();
    var ac = cc.moveTo(0.3,endP);
    node.runAction(ac);
};

PlayLayer_bdhyLiuHuQiang.prototype.ResetOtherCard = function(posNode, off) {
    // 添加吃、碰、跑、偎、提
    var sData = MjClient.data.sData;
    var tData = null;
    if (sData) {
...
PlayLayer_bdhyLiuHuQiang.prototype.ResetPutCard = function(posNode,off){
    //添加打出的牌
    var pl = getUIPlayer_hengYang(off);
    if (!pl) return;
    var outNode = posNode.getChildByName("outNode");
...
//重置牌的顺序
PlayLayer_bdhyLiuHuQiang.prototype.CardLayoutRestore = function(posNode,off){
    if(MjClient.rePlayVideo == -1){
...
// 判断吃、碰、跑、偎、提、胡的状态
PlayLayer_bdhyLiuHuQiang.prototype.EatVisibleCheck = function(off){
    var eat = MjClient.playui.jsBind.eat;
...
PlayLayer_bdhyLiuHuQiang.prototype.showAndHideHeadEffect = function(){
    ...
    if(MjClient.MaxPlayerNum_leiyang == 2){
        arr = [this._downNode, this._rightNode];
    }
    var tData = MjClient.data.sData.tData;
    var uids = tData.uids;
...
PlayLayer_bdhyLiuHuQiang.prototype.addHeadEffect = function(head){
    console.log("addHeadEffect....");
    var tag = 2018322;
...
PlayLayer_bdhyLiuHuQiang.prototype.showAndHideTrust = function(node, uiOff){
    var tData = MjClient.data.sData.tData;
...
PlayLayer_bdhyLiuHuQiang.prototype.showCountdown = function(node){
    ...
    timeTxt.setString("");
    timeTxt.unscheduleAllCallbacks();
    timeTxt = this._xingNode.getChildByName("head").getChildByName("trustTime");
    timeTxt.setString("");
    timeTxt.unscheduleAllCallbacks();
