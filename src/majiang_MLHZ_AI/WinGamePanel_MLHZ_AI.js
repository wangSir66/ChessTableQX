...
function SetEndOneUserUI_MLHZ_AI(node,off)
{
...
var EndOneView_MLHZ_AI = cc.Layer.extend({
	jsBind:{
		block: {
		...
		head0:{
		   ...
		   _run:function(){ SetEndOneUserUI_MLHZ_AI(this,0); },
		...
		,head1:{ 
		  ...
		  _run:function(){ SetEndOneUserUI_MLHZ_AI(this,1); }
		}
		...
		,head2:{ 
		   ...
		   _run:function(){ SetEndOneUserUI_MLHZ_AI(this,2); }
		}
		,head3:{
			 head:
			 {
			...
			_run:function(){ SetEndOneUserUI_MLHZ_AI(this,3); }
			},
            count_down:{
                _visible :function()
                {
