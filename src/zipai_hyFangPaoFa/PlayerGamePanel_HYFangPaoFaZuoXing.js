...
function SetUserVisible_HYFangPaoFaZuoXing (node, off){
    ...
    if(pl){
        ...
        // InitUserHandUI_HYFangPaoFaZuoXing (node, off);
...
function InitUserHandUI_HYFangPaoFaZuoXing (node, off){
...
var PlayLayer_HYFangPaoFaZuoXing = cc.Layer.extend({
    jsBind: {
        _event: {
        ...
        // },
        roundInfo:{
            _layout: [[0.11, 0.11],[0.5, 0.7],[0, -3.4]],
            _run:function(){
                if(isIPhoneX()){
                    setWgtLayout(this, [0.11, 0.11],[0.5, 0.62],[0, -2.8]);
                }else{
                    setWgtLayout(this, [0.11, 0.11],[0.5, 0.62],[0, -3.4]);
                }
                var tData = MjClient.data.sData.tData;
        ...
        down: {
            ...
            _event: {
                ...
                initSceneData: function(eD) {
                    SetUserVisible_HYFangPaoFaZuoXing (this, 0);
                    InitUserHandUI_HYFangPaoFaZuoXing (this, 0);
        ...
        xing: {
                ...
                zhuang: {
                    _run: function() {
                        ...
                        if(MjClient.data.sData.tData.areaSelectMode.zuoXing){
                            this.loadTexture("playing/ziPaiBanner/xing.png");
                        }
                    },
                    _event: {
                        waitPut: function() {
            ...
            _event: {
                ...
                initSceneData: function(eD) {
                    SetUserVisible_HYFangPaoFaZuoXing (this, 1);
                    InitUserHandUI_HYFangPaoFaZuoXing (this, 1);
        ...
        right: {
            ...
            _event: {
                ...
                initSceneData: function(eD) {
                    SetUserVisible_HYFangPaoFaZuoXing (this, 2);
                    InitUserHandUI_HYFangPaoFaZuoXing (this, 2);
        ...
        left: {
            head: {
                ...
                _event: {
                    ...
                    addPlayer: function(eD) {
                        showFangzhuTagIcon_xiangxiang(this,3);
                    },
                    removePlayer: function(eD) {
                        showFangzhuTagIcon_xiangxiang(this,3);
                    }
            ...
            _event: {
                ...
                initSceneData: function(eD) {
                    SetUserVisible_HYFangPaoFaZuoXing (this, 3);
                    InitUserHandUI_HYFangPaoFaZuoXing (this, 3);
...
//庄家打出第一张牌之后，刷新提垅的牌
PlayLayer_HYFangPaoFaZuoXing.prototype.UpdateEatCardsAfterFirst = function(posNode,off){
    var sData = MjClient.data.sData;
    var tData = MjClient.data.sData.tData;
...
//重置手牌的顺序
PlayLayer_HYFangPaoFaZuoXing.prototype.ResetHandCard = function(posNode,off, needAction, isDelay){
...
PlayLayer_HYFangPaoFaZuoXing.prototype._doMovetoAction = function(node,endP){
    node.stopAllActions();
    var ac = cc.moveTo(0.3,endP);
    node.runAction(ac);
};

PlayLayer_HYFangPaoFaZuoXing.prototype.ResetOtherCard = function(posNode,off){
    //添加吃、碰、跑、偎、提
    var sData = MjClient.data.sData;
    var tData = null;
    if(sData){
...
PlayLayer_HYFangPaoFaZuoXing.prototype.ResetPutCard = function(posNode,off){
    //添加打出的牌
    var pl = getUIPlayer_xiangxiang(off);
...
//重置牌的顺序
PlayLayer_HYFangPaoFaZuoXing.prototype.CardLayoutRestore = function(posNode,off){
    if(MjClient.rePlayVideo == -1){
...
// 判断吃、碰、跑、偎、提、胡的状态
PlayLayer_HYFangPaoFaZuoXing.prototype.EatVisibleCheck = function(off){
    var eat = MjClient.playui.jsBind.eat;
...
PlayLayer_HYFangPaoFaZuoXing.prototype.showAndHideHeadEffect = function(){
    var tData = MjClient.data.sData.tData;
