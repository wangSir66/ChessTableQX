...
function SetEndOneUserUI_datongguaisanjiao(node,off)
{
...
var EndOneView_datongguaisanjiao = cc.Layer.extend({
	jsBind:{
		block: {
		...
		head0:{
		   ...
		   _run:function(){ SetEndOneUserUI_datongguaisanjiao(this,0); },
		...
		head1:{
		  ...
		  _run:function(){ SetEndOneUserUI_datongguaisanjiao(this,1); }
		},
		head2:{
		   head:{
			   zhuang:{_visible:false}
		   ...
		   _run:function(){ SetEndOneUserUI_datongguaisanjiao(this,2); }
		},
		head3:{
			 head:
			 {
			...
			_run:function(){ SetEndOneUserUI_datongguaisanjiao(this,3); }
			},
		count_down:{
                _visible :function()
                {
    ...
    ctor:function () {
        this._super();
        var endoneui = ccs.load("endOne_datongguaisanjiao.json");
