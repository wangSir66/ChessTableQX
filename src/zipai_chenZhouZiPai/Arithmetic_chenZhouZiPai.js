var majiang_chenZhouZiPaiLink = function(majiang) {
...
(function() {
    ...
    huzi.prototype.maxHu = function(tb, pl, card, allHuMatrix) {
        ...
        for (var m = 0; m < allHuMatrix.length; m++) {
            ...
            if(winOne == 0 && tb.tData.areaSelectMode.isMaoHu){
                winOne = 15;
            }
    ...
    if (typeof(MjClient) != "undefined") {
        MjClient.majiang_chenzhouzipai = new huzi();
        majiang_chenZhouZiPaiLink(MjClient.majiang_chenzhouzipai);
    }
}());
