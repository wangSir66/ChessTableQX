//郴州字牌
var CreateRoomNode_chenZhouZiPai = CreateRoomNode.extend({
    onExit:function()
    {
        this._super();
    },
    initAll:function()
    {
        ...
        this.localStorageKey.KEY_PAO_HU_ZI_ChenZhou_maxPlayer       = "_ChenZhouZiPai_maxPlayer";          //几人玩
        this.localStorageKey.KEY_PAO_HU_ZI_ChenZhou_minHuXi      = "_ChenZhouZiPai_minHuXi";         //0 9息起胡， 1 6息起胡，2 3息起胡
        this.localStorageKey.KEY_PAO_HU_ZI_ChenZhou_xiToTun     = "_ChenZhouZiPai_xiToTun";         // 0 三息一囤，1 一息一囤
        this.localStorageKey.KEY_PAO_HU_ZI_ChenZhou_minXiToTun     ="_ChenZhouZiPai_minXiToTun";    //0 9/6/3息一囤，1 9/6/3息三囤
        this.localStorageKey.KEY_PAO_HU_ZI_ChenZhou_biHu     ="_ChenZhouZiPai_biHu";    //0 无，1 点炮必胡，2 有胡必胡
        this.localStorageKey.KEY_PAO_HU_ZI_ChenZhou_wanFa     ="_ChenZhouZiPai_wanFa";    //0 无，1 红黑点，2 红黑点2倍
        this.localStorageKey.KEY_PAO_HU_ZI_ChenZhou_ziMoFanBei     ="_ChenZhouZiPai_ziMoFanBei";    //true/false 自摸翻倍
        this.localStorageKey.KEY_PAO_HU_ZI_ChenZhou_maoHu     ="_ChenZhouZiPai_maoHu";    //true/false 毛胡
        this.localStorageKey.KEY_PAO_HU_ZI_ChenZhou_shiWuZhang     ="_ChenZhouZiPai_shiWuZhang";    //true/false 15张玩法
        this.localStorageKey.KEY_PAO_HU_ZI_ChenZhou_piaoFen     ="_ChenZhouZiPai_piaoFen";    //0 不飘， 1 飘1/2/3, 2 飘2/3/5
        this.localStorageKey.KEY_PAO_HU_ZI_ChenZhou_mingLong     ="_ChenZhouZiPai_mingLong";    //0 发牌明龙， 1 出牌明龙
        this.localStorageKey.KEY_PAO_HU_ZI_ChenZhou_zuoZhuang     ="_ChenZhouZiPai_zuoZhuang";    //0 随机， 1 房主
        this.localStorageKey.KEY_PAO_HU_ZI_ChenZhou_fanBei     ="_ChenZhouZiPai_fanBei";    //0 不翻倍 1 ≤10分翻倍 2 ≤20分翻倍 3 ≤30分翻倍 4 不限分翻倍

        this.localStorageKey.KEY_PAO_HU_ZI_ChenZhou_qiePai     = "_ChenZhouZiPai_qiePai";       //切牌
        this.localStorageKey.KEY_PAO_HU_ZI_ChenZhou_difen                 =  "_ChenZhouZiPai_difen"; //底分
        this.localStorageKey.KEY_PAO_HU_ZI_ChenZhou_tuoGuan                 =  "_ChenZhouZiPai_tuoGuan"; //底分
        this.localStorageKey.KEY_PAO_HU_ZI_ChenZhou_maiPaiNum     =  "_ChenZhouZiPai_maiPaiNum"; //埋牌

        this.roundNumObj = {roundNum1:8, roundNum2:12, roundNum3:20};

        this.bg_node = ccs.load("bg_chenZhouZiPai.json").node;
    ...
    setPlayNodeCurrentSelect:function(atClub)
    {
        ...
        if (atClub){
            ...
            _wanFa = util.localStorageEncrypt.getNumberItem(this.localStorageKey.KEY_PAO_HU_ZI_ChenZhou_wanFa, 0);
        }
        ...
        if (atClub){
            ...
            _zuoZhuang = util.localStorageEncrypt.getNumberItem(this.localStorageKey.KEY_PAO_HU_ZI_ChenZhou_zuoZhuang, 0);
        }
        ...
        if (atClub){
            ...
            _fanBei = util.localStorageEncrypt.getNumberItem(this.localStorageKey.KEY_PAO_HU_ZI_ChenZhou_fanBei, 0);
        }
        ...
        // else
        //     this._zhuIdx = util.localStorageEncrypt.getNumberItem(this.localStorageKey.KEY_PAO_HU_ZI_ChenZhou_difen, 1);
        // if (this._ZhuNum)
        //     this._ZhuNum.setString(this._zhuIdx + "");
    ...
    getSelectedPara:function()
    {
        ...
        para.gameType = MjClient.GAME_TYPE.CHEN_ZHOU_ZI_PAI;
    ...
    savePara : function(para){
        if (!this._isFriendCard){
            ...
            util.localStorageEncrypt.setNumberItem(this.localStorageKey.KEY_PAO_HU_ZI_ChenZhou_wanFa, para.wanFa);
            ...
            util.localStorageEncrypt.setNumberItem(this.localStorageKey.KEY_PAO_HU_ZI_ChenZhou_zuoZhuang, para.zuoZhuang);
            util.localStorageEncrypt.setNumberItem(this.localStorageKey.KEY_PAO_HU_ZI_ChenZhou_fanBei, para.fanBei);
