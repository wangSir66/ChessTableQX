...
function SetUserVisible_chenZhouZiPai(node, off){
    ...
    if(pl){
        ...
        setUserOffline_chenZhouZiPai(node, off);
...
function InitUserHandUI_chenZhouZiPai(node, off){
    ...
    if (pl.jiazhuNum == 2 && MjClient.rePlayVideo == -1)
    {
        ...
        MjClient.majiang.setJiaZhuNum(node, getUIPlayer_chenZhouZiPai(off));
    }
...
var PlayLayer_chenZhouZiPai = cc.Layer.extend({
    jsBind: {
        _event: {
            ...
            endRoom: function(msg) {
                ...
                if (msg.showEnd){
                    this.addChild(new GameOverLayer_chenZhouZiPai(),500);
                }else{
            ...
            roundEnd: function() {
                ...
                if(!MjClient.isDismiss && tData.hunCard && tData.hunCard != -1 && tData.areaSelectMode.xingType==2){
                    ...
                    ShowEatActionAnim_chenZhouZiPai(MjClient.playui._downNode, ActionType_paohuzi.FANXING, 0);
                    DealFanXingNewCard_chenZhouZiPai(hunCard);
                }
                ...
                function delayExe(){
                    ...
                    if (sData.tData.roundNum <= 0){
                        var layer = new GameOverLayer_chenZhouZiPai();
                        layer.setVisible(false);
                        self.addChild(layer,500);
                    }
                    if(!MjClient.endoneui){
                        self.addChild(new EndOneView_chenZhouZiPai(),500);
                    }
            ...
            moveHead: function() {
                ...
                //tableStartHeadMoveAction_chenZhouZiPai(this);   //不涉及到头像移动动作
            },
            initSceneData: function() {
                ...
                reConectHeadLayout_chenZhouZiPai(this);        //不涉及到头像移动动作
                CheckRoomUiDelete();
                tableStartHeadMoveAction_chenZhouZiPai(this);   //不涉及到头像移动动作
            ...
            changeMJBgEvent: function() {
                changeMJBg_chenZhouZiPai(this, ziPai.getZiPaiType());
            },
            MJPeng: function() {
                MjClient.playui.showAndHideHeadEffect();
            },
            ...
            EZP_layout : function(){
                if(MjClient.data.sData.tData.maxPlayer < 4){
                    ...
                    if(IsArrowVisible_chenZhouZiPai()){
        ...
        roundInfo:{
            ...
            _run:function(){
                ...
                if (MjClient.GAME_TYPE.CHEN_ZHOU_ZI_PAI == MjClient.gameType){
                ...
                // if (item = ["首局随机坐庄", "首局房主坐庄"][tData.areaSelectMode.zuoZhuang]){
                //     infos.push(item);
                // }

                if (item = ["不翻倍", "≤10分翻倍", "≤20分翻倍", "≤30分翻倍", "不限分翻倍"][tData.areaSelectMode.fanBei]){
                    infos.push(item);
                }
        ...
        banner: {
            ...
            getRoomNum: {
                ...
                _click: function() {
                    ...
                    var sData = MjClient.data.sData;
                    var str7 = " ";
                    if (Object.keys(sData.players).length > 0 && MjClient.MaxPlayerNum_chenZhouZiPai > Object.keys(sData.players).length){
                        str7 += ["一","二","三"][Object.keys(sData.players).length - 1] + "缺" + ["一","二","三"][MjClient.MaxPlayerNum_chenZhouZiPai - Object.keys(sData.players).length - 1];
                    }
            ...
            gps_btn: {
                ...
                _click: function() {
                    if(MjClient.MaxPlayerNum_chenZhouZiPai == 3){
            ...
            roundnumImg: {
                ...
                _event: {
                    initSceneData: function(eD) {
                        this.visible = IsArrowVisible_chenZhouZiPai();
                    },
                    mjhand: function(eD) {
                        this.visible = IsArrowVisible_chenZhouZiPai();
                    },
        ...
        wait: {
            ...
            backHomebtn: {
                ...
                _event: {
                    ...
                    initSceneData: function(eD) {
                        this.visible = isShowBackBtn_chenZhouZiPai();
                    },
                    removePlayer: function(eD) {
                        this.visible = isShowBackBtn_chenZhouZiPai();
                    },
        ...
        btns_piao:{
            ...
            btn_piao0: {
                _click:function() {
                    var pl = getUIPlayer_chenZhouZiPai(0);
                    pl.piaoFen = -1;
                    paioFenToServer_chenZhouZiPai(0);
                },
            },
            btn_piao1: {
                _click:function() {
                    var pl = getUIPlayer_chenZhouZiPai(0);
                    pl.piaoFen = -1;
                    paioFenToServer_chenZhouZiPai(1);
                },
            },
            btn_piao2: {
                _click:function() {
                    var pl = getUIPlayer_chenZhouZiPai(0);
                    pl.piaoFen = -1;
                    paioFenToServer_chenZhouZiPai(2);
                },
            },
            btn_piao3: {
                _click:function() {
                    var pl = getUIPlayer_chenZhouZiPai(0);
                    pl.piaoFen = -1;
                    paioFenToServer_chenZhouZiPai(3);
                },
            },
    },
        BtnReady:{
        ...
        down: {
            head: {
                chuizi_tips : {
                    _run: function(){
                        setJiachuiImgTips_chenZhouZiPai(this, 0);
                    },
                    _event: {
                        initSceneData: function() {
                            setJiachuiImgTips_chenZhouZiPai(this, 0);
                ...
                jiachuiText_tips : {
                    _run: function() {
                        setJiachuiTextTips_chenZhouZiPai(this, 0);
                    },
                    _event:{
                        initSceneData: function() {
                            setJiachuiTextTips_chenZhouZiPai(this, 0);
                ...
                zhuang: {
                    ...
                    _event: {
                        waitPut: function(){
                            showUserZhuangLogo_chenZhouZiPai(this, 0);
                        },
                        initSceneData: function(){
                            if (IsArrowVisible_chenZhouZiPai()) showUserZhuangLogo_chenZhouZiPai(this, 0);
                        },
                        mjhand: function(){
                            if (IsArrowVisible_chenZhouZiPai()) showUserZhuangLogo_chenZhouZiPai(this, 0);
                        }
                    ...
                    chattext: {
                        _event: {
                            ...
                            MJChat: function(msg) {
                                ...
                                showUserChat_chenZhouZiPai(this, 0, msg);
                            },
                            playVoice: function(voicePath) {
                                MjClient.data._tempMessage.msg = voicePath;
                                showUserChat_chenZhouZiPai(this, 0, MjClient.data._tempMessage);
                            }
                        }
                    }
                },
                _click: function(btn) {
                    showPlayerInfo_chenZhouZiPai(0, btn);
                },
                _event: {
                    loadWxHead: function(d) {
                        setWxHead_chenZhouZiPai(this, d, 0);
                    },
                    addPlayer: function(eD) {
                        showFangzhuTagIcon_chenZhouZiPai(this,0);
                    },
                    removePlayer: function(eD) {
                        showFangzhuTagIcon_chenZhouZiPai(this,0);
                    }
                ...
                huxi:{
                    ...
                    _event:{
                        ...
                        initSceneData:function(){
                            this.visible = true;
                            var huXi = UpdateHuXi_chenZhouZiPai(0);
                            if(!IsArrowVisible_chenZhouZiPai()){
                                huXi = 0;
                                this.visible = false;
                            }
                ...
                timeImg:{
                    ...
                    // _event:{
                    //     initSceneData: function(eD) {
                    //         this.visible = curPlayerIsMe_chenZhouZiPai(0);
                    //     },
                    //     mjhand: function(eD) {
                    //         this.visible = curPlayerIsMe_chenZhouZiPai(0);
                    //     },
                    //     onlinePlayer: function(eD) {
                    //         this.visible = curPlayerIsMe_chenZhouZiPai(0) && IsArrowVisible_chenZhouZiPai();
                    //     },
                    //     waitPut: function(eD) {
                    //         this.visible = curPlayerIsMe_chenZhouZiPai(0);
                    //     },
                    ...
                    //             playTimeUpEff = null;
                    //             var pl = getUIPlayer_chenZhouZiPai(0);
                    //             if(pl && pl.onLine && curPlayerIsMe_chenZhouZiPai(0)){
                    //                 arrowbkNumberUpdate(this);
                    //             }
                    //         },
                    //         roundEnd: function() {
            ...
            ready: {
                ...
                _run: function() {
                    GetReadyVisible_chenZhouZiPai(this, 0);
                },
                _event: {
                    startShuffleCards:function (d) {
                        GetReadyVisible_chenZhouZiPai(this, -1);
                    },
                    moveHead: function() {
                        GetReadyVisible_chenZhouZiPai(this, -1);
                    },
                    ...
                    addPlayer: function() {
                        GetReadyVisible_chenZhouZiPai(this, 0);//根据状态设置ready 是否可见 add by sking
                    },
                    removePlayer: function() {
                        GetReadyVisible_chenZhouZiPai(this, 0);
                    },
            ...
            handNode: {
                ...
                _event:  {
                    initSceneData: function() {
                        calculateHintPutList_chenZhouZiPai();
                    },
                    HZPickCard: function() {
                        calculateHintPutList_chenZhouZiPai();
                    },
                    ...
                    MJPass: function() { // 天胡 提 偎 跑后过胡
                        calculateHintPutList_chenZhouZiPai();
                        addTingSign_chenZhouZiPai(MjClient.playui._downNode);
                    },
            ...
            _event: {
                clearCardUI: function() {
                    clearCardUI_chenZhouZiPai(this, 0);
                },
                ...
                initSceneData: function(eD) {
                    SetUserVisible_chenZhouZiPai(this, 0);
                    InitUserHandUI_chenZhouZiPai(this, 0);
                    InitUserCoinAndName_chenZhouZiPai(this, 0);
                    MjClient.hasPut = false; // 重连回来重置打掉牌标志（打牌时候断线)
                    ShowPutCardIcon_chenZhouZiPai();
                    DealOffLineCard_chenZhouZiPai(this,0);
                },
                addPlayer: function(eD) {
                    SetUserVisible_chenZhouZiPai(this, 0);
                    InitUserCoinAndName_chenZhouZiPai(this, 0);
                ...
                mjhand: function(eD) {
                    ...
                    var uid = getUIPlayer_chenZhouZiPai(0).info.uid;
                    // if (eD.jiazhuNums)
                    // {
                ...
                HZNewCard: function(eD) {
                    ...
                    DealNewCard_chenZhouZiPai(this,eD,0);
                },
                MJPut: function(eD) {
                    DealPutCard_chenZhouZiPai(this,eD,0);
                },
                HZChiCard: function(eD) {
                    DealChiCard_chenZhouZiPai(this, eD, 0);
                },
                HZWeiCard: function(eD){
                    DealWeiCard_chenZhouZiPai(this,eD,0);
                },
                HZGangCard: function(eD) {
                    DealGangCard_chenZhouZiPai(this, eD, 0);
                },
                MJPeng: function(eD) {
                    DealPengCard_chenZhouZiPai(this, eD, 0);
                },
                MJHu: function(eD) {
                    DealHu_chenZhouZiPai(this, eD, 0);
                },
                onlinePlayer: function(eD) {
                    resetHandAfterBegin_chenZhouZiPai();
                    setUserOffline_chenZhouZiPai(this, 0);
                },
                ...
                MJJiazhu: function(msg) {
                    ...
                    MjClient.majiang.setJiaZhuNum(MjClient.playui._downNode, getUIPlayer_chenZhouZiPai(0));
                    MjClient.majiang.setJiaZhuNum(MjClient.playui._rightNode, getUIPlayer_chenZhouZiPai(1));
                    MjClient.majiang.setJiaZhuNum(MjClient.playui._topNode, getUIPlayer_chenZhouZiPai(2));
                },
                HZPickCard:function (eD) {
                    ...
                    DealShowLastCard_chenZhouZiPai(this, eD, 0);
                },
                HZAddCards:function (eD) {
                    DealAddCard_chenZhouZiPai(this,eD, 0);
                },
        ...
        right: {
            head: {
                chuizi_tips : {
                    _run: function(){
                        setJiachuiImgTips_chenZhouZiPai(this, changeUIOff_chenZhouZiPai(2));
                    },
                    _event: {
                        initSceneData: function() {
                            setJiachuiImgTips_chenZhouZiPai(this, changeUIOff_chenZhouZiPai(2));
                ...
                jiachuiText_tips : {
                    _run:function() {
                        setJiachuiTextTips_chenZhouZiPai(this, changeUIOff_chenZhouZiPai(2));
                    },
                    _event:{
                        initSceneData: function() {
                            setJiachuiTextTips_chenZhouZiPai(this, changeUIOff_chenZhouZiPai(2));
                        ...
                        MJJiazhu: function(msg) {
                            var pl = getUIPlayer_chenZhouZiPai(changeUIOff_chenZhouZiPai(2))
                            if (msg.uid == pl.info.uid) {
                                setJiachuiTextTips_chenZhouZiPai(this, changeUIOff_chenZhouZiPai(2));
                            }
                        },
                ...
                zhuang: {
                    ...
                    _event: {
                        waitPut: function() {
                            showUserZhuangLogo_chenZhouZiPai(this, changeUIOff_chenZhouZiPai(2));
                        },
                        initSceneData: function() {
                            if (IsArrowVisible_chenZhouZiPai()) showUserZhuangLogo_chenZhouZiPai(this, changeUIOff_chenZhouZiPai(2));
                        },
                        mjhand: function(){
                            if (IsArrowVisible_chenZhouZiPai()) showUserZhuangLogo_chenZhouZiPai(this, changeUIOff_chenZhouZiPai(2));
                        }
                ...
                chatbg: {
                    ...
                    chattext: {
                        _event: {
                            MJChat: function(msg) {
                                showUserChat_chenZhouZiPai(this, changeUIOff_chenZhouZiPai(2), msg);
                            },
                            playVoice: function(voicePath) {
                                MjClient.data._tempMessage.msg = voicePath;
                                showUserChat_chenZhouZiPai(this, changeUIOff_chenZhouZiPai(2), MjClient.data._tempMessage);
                            }
                        }
                    }
                },
                _click: function(btn) {
                    showPlayerInfo_chenZhouZiPai(changeUIOff_chenZhouZiPai(2), btn);
                },
                _event: {
                    loadWxHead: function(d) {
                        setWxHead_chenZhouZiPai(this, d, changeUIOff_chenZhouZiPai(2));
                    },
                    addPlayer: function(eD) {
                        showFangzhuTagIcon_chenZhouZiPai(this,changeUIOff_chenZhouZiPai(2));
                    },
                    removePlayer: function(eD) {
                        showFangzhuTagIcon_chenZhouZiPai(this,changeUIOff_chenZhouZiPai(2));
                    }
                ...
                huxi:{
                    ...
                    _event:{
                        ...
                        initSceneData:function(){
                            this.visible = true;
                            var huXi = UpdateHuXi_chenZhouZiPai(changeUIOff_chenZhouZiPai(2));
                            if(!IsArrowVisible_chenZhouZiPai()){
                                huXi = 0;
                                this.visible = false;
                            }
                ...
                timeImg:{
                    ...
                    // _event:{
                    //     initSceneData: function(eD) {
                    //         this.visible = curPlayerIsMe_chenZhouZiPai(1);
                    //     },
                    //     mjhand: function(eD) {
                    //         this.visible = curPlayerIsMe_chenZhouZiPai(1);
                    //     },
                    //     onlinePlayer: function(eD) {
                    //         this.visible = curPlayerIsMe_chenZhouZiPai(1) && IsArrowVisible_chenZhouZiPai();
                    //     },
                    //     waitPut: function(eD) {
                    //         this.visible = curPlayerIsMe_chenZhouZiPai(1);
                    //     },
                    ...
                    //             stopEffect(playTimeUpEff);
                    //             playTimeUpEff = null;
                    //             if(curPlayerIsMe_chenZhouZiPai(1)){
                    //                 arrowbkNumberUpdate(this);
                    //                 this.setString("00");
                    //             }
                    //         },
                    ...
                    //             stopEffect(playTimeUpEff);
                    //             playTimeUpEff = null;
                    //             var pl = getUIPlayer_chenZhouZiPai(1);
                    //             if(pl && pl.onLine && curPlayerIsMe_chenZhouZiPai(1)){
                    //                 arrowbkNumberUpdate(this);
                    //             }
                    //         },
                    //         roundEnd: function() {
            ...
            ready: {
                _layout: [[0.07, 0.07],[0.5, 0.5],[2.5, 2.5]],
                _run: function() {
                    GetReadyVisible_chenZhouZiPai(this, changeUIOff_chenZhouZiPai(2));
                },
                _event: {
                    startShuffleCards:function (d) {
                        GetReadyVisible_chenZhouZiPai(this, -1);
            ...
            _event: {
                clearCardUI: function() {
                    clearCardUI_chenZhouZiPai(this, changeUIOff_chenZhouZiPai(2));
                },
                clearCardArr: function(){
                    var eatNode = this.getChildByName("eatNode");
                    eatNode.removeAllChildren();
                ...
                initSceneData: function(eD) {
                    SetUserVisible_chenZhouZiPai(this, changeUIOff_chenZhouZiPai(2));
                    InitUserHandUI_chenZhouZiPai(this, changeUIOff_chenZhouZiPai(2));
                    InitUserCoinAndName_chenZhouZiPai(this, changeUIOff_chenZhouZiPai(2));
                    DealOffLineCard_chenZhouZiPai(this,changeUIOff_chenZhouZiPai(2));
                },
                addPlayer: function(eD) {
                    SetUserVisible_chenZhouZiPai(this, changeUIOff_chenZhouZiPai(2));
                    InitUserCoinAndName_chenZhouZiPai(this, changeUIOff_chenZhouZiPai(2));
                ...
                HZNewCard: function(eD) {
                    ...
                    DealNewCard_chenZhouZiPai(this,eD,changeUIOff_chenZhouZiPai(2));
                },
                roundEnd: function() {
                    InitUserCoinAndName_chenZhouZiPai(this, changeUIOff_chenZhouZiPai(2));
                    MjClient.playui.ResetOtherCard(this, changeUIOff_chenZhouZiPai(2));
                },
                waitPut: function(eD) {
                    DealWaitPut(this, eD, 1);
                },
                MJPut: function(eD) {
                    DealPutCard_chenZhouZiPai(this, eD, changeUIOff_chenZhouZiPai(2));
                },
                HZChiCard: function(eD) {
                    DealChiCard_chenZhouZiPai(this, eD, changeUIOff_chenZhouZiPai(2));
                },
                HZGangCard: function(eD) {
                    DealGangCard_chenZhouZiPai(this, eD, changeUIOff_chenZhouZiPai(2));
                },
                MJPeng: function(eD) {
                    DealPengCard_chenZhouZiPai(this, eD, changeUIOff_chenZhouZiPai(2));
                },
                HZWeiCard: function(eD){
                    DealWeiCard_chenZhouZiPai(this, eD, changeUIOff_chenZhouZiPai(2));
                },
                MJHu: function(eD) {
                    DealHu_chenZhouZiPai(this, eD, changeUIOff_chenZhouZiPai(2));
                },
                onlinePlayer: function(eD) {
                    setUserOffline_chenZhouZiPai(this, changeUIOff_chenZhouZiPai(2));
                },
                playerStatusChange: function(eD) {
                    setUserOffline_chenZhouZiPai(this, changeUIOff_chenZhouZiPai(2));
                },
                MJFlower: function(eD) {
                    HandleMJFlower(this, eD, changeUIOff_chenZhouZiPai(2));
                },
                MJTing: function (eD) {
                    HandleMJTing(this, eD, changeUIOff_chenZhouZiPai(2));
                },
                HZPickCard:function (eD) {
                    if(MjClient.rePlayVideo != -1){
                        MjClient.playui._doPickResetHandCardForPlayBack(eD, changeUIOff_chenZhouZiPai(2));
                    }

                    // RemovePutCardOut_chenZhouZiPai(true);
                    // MjClient.playui.ResetHandCard(this,1);

                    DealShowLastCard_chenZhouZiPai(this, eD, changeUIOff_chenZhouZiPai(2));
                },
                HZAddCards:function (eD) {
                    DealAddCard_chenZhouZiPai(this,eD, changeUIOff_chenZhouZiPai(2));
                },
                HZCheckRaise:function (msg) {
                    ShowPutCardIcon_chenZhouZiPai();
                    //MjClient.playui.EatVisibleCheck();
        ...
        left: {
            head: {
                chuizi_tips : {
                    _run: function(){
                        setJiachuiImgTips_chenZhouZiPai(this, changeUIOff_chenZhouZiPai(3));
                    },
                    _event: {
                        initSceneData: function() {
                            setJiachuiImgTips_chenZhouZiPai(this, changeUIOff_chenZhouZiPai(3));
                ...
                jiachuiText_tips : {
                    _visible:false,
                    _run:function() {
                        setJiachuiTextTips_chenZhouZiPai(this, changeUIOff_chenZhouZiPai(3));
                    },
                    _event:{
                        initSceneData: function() {
                            setJiachuiTextTips_chenZhouZiPai(this, changeUIOff_chenZhouZiPai(3));
                        ...
                        MJJiazhu: function(msg) {
                            var pl = getUIPlayer_chenZhouZiPai(changeUIOff_chenZhouZiPai(3))
                            if (msg.uid == pl.info.uid) {
                                setJiachuiTextTips_chenZhouZiPai(this, changeUIOff_chenZhouZiPai(3));
                            }
                        },
                ...
                zhuang: {
                    ...
                    _event: {
                        waitPut: function() {
                            showUserZhuangLogo_chenZhouZiPai(this, changeUIOff_chenZhouZiPai(3));
                        },
                        initSceneData: function() {
                            if (IsArrowVisible_chenZhouZiPai()) showUserZhuangLogo_chenZhouZiPai(this, changeUIOff_chenZhouZiPai(3));
                        },
                        mjhand: function(){
                            if (IsArrowVisible_chenZhouZiPai()) showUserZhuangLogo_chenZhouZiPai(this, changeUIOff_chenZhouZiPai(3));
                        }
                ...
                chatbg: {
                    ...
                    chattext: {
                        _event: {
                            MJChat: function(msg) {
                                showUserChat_chenZhouZiPai(this, changeUIOff_chenZhouZiPai(3), msg);
                            },
                            playVoice: function(voicePath) {
                                MjClient.data._tempMessage.msg = voicePath;
                                showUserChat_chenZhouZiPai(this, changeUIOff_chenZhouZiPai(3), MjClient.data._tempMessage);
                            }
                        }
                    }
                },
                _click: function(btn) {
                    showPlayerInfo_chenZhouZiPai(changeUIOff_chenZhouZiPai(3), btn);
                },
                _event: {
                    loadWxHead: function(d) {
                        setWxHead_chenZhouZiPai(this, d, changeUIOff_chenZhouZiPai(3));
                    },
                    addPlayer: function(eD) {
                        showFangzhuTagIcon_chenZhouZiPai(this,changeUIOff_chenZhouZiPai(3));
                    },
                    removePlayer: function(eD) {
                        showFangzhuTagIcon_chenZhouZiPai(this,changeUIOff_chenZhouZiPai(3));
                    }
                ...
                huxi:{
                    ...
                    _event:{
                        ...
                        initSceneData:function(){
                            this.visible = true;
                            var huXi = UpdateHuXi_chenZhouZiPai(changeUIOff_chenZhouZiPai(3));
                            if(!IsArrowVisible_chenZhouZiPai()){
                                huXi = 0;
                                this.visible = false;
                            }
                ...
                timeImg:{
                    ...
                    // _event:{
                    //     initSceneData: function(eD) {
                    //         this.visible = curPlayerIsMe_chenZhouZiPai(2);
                    //     },
                    //     mjhand: function(eD) {
                    //         this.visible = curPlayerIsMe_chenZhouZiPai(2);
                    //     },
                    //     onlinePlayer: function(eD) {
                    //         this.visible = curPlayerIsMe_chenZhouZiPai(2) && IsArrowVisible_chenZhouZiPai();
                    //     },
                    //     waitPut: function(eD) {
                    //         this.visible = curPlayerIsMe_chenZhouZiPai(2);
                    //     },
                    ...
                    //             stopEffect(playTimeUpEff);
                    //             playTimeUpEff = null;
                    //             if(curPlayerIsMe_chenZhouZiPai(2)){
                    //                 arrowbkNumberUpdate(this);
                    //                 this.setString("00");
                    //             }
                    //         },
                    ...
                    //             stopEffect(playTimeUpEff);
                    //             playTimeUpEff = null;
                    //             var pl = getUIPlayer_chenZhouZiPai(2);
                    //             if(pl && pl.onLine && curPlayerIsMe_chenZhouZiPai(2)){
                    //                 arrowbkNumberUpdate(this);
                    //             }
                    //         },
                    //         roundEnd: function() {
            ...
            ready: {
                _layout: [[0.07, 0.07],[0.5, 0.5],[-2.5, 2.5]],
                _run: function() {
                    GetReadyVisible_chenZhouZiPai(this, changeUIOff_chenZhouZiPai(3));
                },
                _event: {
                    startShuffleCards:function (d) {
                        GetReadyVisible_chenZhouZiPai(this, -1);
            ...
            _event: {
                clearCardUI: function() {
                    clearCardUI_chenZhouZiPai(this, changeUIOff_chenZhouZiPai(3));
                },
                clearCardArr: function(){
                    var eatNode = this.getChildByName("eatNode");
                    eatNode.removeAllChildren();
                ...
                initSceneData: function(eD) {
                    SetUserVisible_chenZhouZiPai(this, changeUIOff_chenZhouZiPai(3));
                    InitUserHandUI_chenZhouZiPai(this, changeUIOff_chenZhouZiPai(3));
                    InitUserCoinAndName_chenZhouZiPai(this, changeUIOff_chenZhouZiPai(3));
                    DealOffLineCard_chenZhouZiPai(this,changeUIOff_chenZhouZiPai(3));
                },
                addPlayer: function(eD) {
                    SetUserVisible_chenZhouZiPai(this, changeUIOff_chenZhouZiPai(3));
                    InitUserCoinAndName_chenZhouZiPai(this, changeUIOff_chenZhouZiPai(3));
                ...
                HZNewCard: function(eD) {
                    ...
                    DealNewCard_chenZhouZiPai(this,eD,changeUIOff_chenZhouZiPai(3));
                },
                roundEnd: function() {
                    InitUserCoinAndName_chenZhouZiPai(this,changeUIOff_chenZhouZiPai(3));
                    MjClient.playui.ResetOtherCard(this, changeUIOff_chenZhouZiPai(3));
                },
                waitPut: function(eD) {
                    DealWaitPut(this, eD, changeUIOff_chenZhouZiPai(3));
                },
                MJPut: function(eD) {
                    DealPutCard_chenZhouZiPai(this, eD, changeUIOff_chenZhouZiPai(3));
                },
                HZChiCard: function(eD) {
                    DealChiCard_chenZhouZiPai(this, eD, changeUIOff_chenZhouZiPai(3));
                },
                HZGangCard: function(eD) {
                    DealGangCard_chenZhouZiPai(this, eD, changeUIOff_chenZhouZiPai(3));
                },
                MJPeng: function(eD) {
                    DealPengCard_chenZhouZiPai(this, eD, changeUIOff_chenZhouZiPai(3));
                },
                HZWeiCard: function(eD){
                    DealWeiCard_chenZhouZiPai(this, eD, changeUIOff_chenZhouZiPai(3));
                },
                MJHu: function(eD) {
                    DealHu_chenZhouZiPai(this, eD, changeUIOff_chenZhouZiPai(3));
                },
                onlinePlayer: function(eD) {
                    setUserOffline_chenZhouZiPai(this, changeUIOff_chenZhouZiPai(3));
                },
                playerStatusChange: function(eD) {
                    setUserOffline_chenZhouZiPai(this, changeUIOff_chenZhouZiPai(3));
                },
                MJFlower: function(eD) {
                    HandleMJFlower(this, eD, changeUIOff_chenZhouZiPai(3));
                },
                MJTing: function (eD) {
                    HandleMJTing(this, eD, changeUIOff_chenZhouZiPai(3));
                },
                HZPickCard:function (eD) {
                    if(MjClient.rePlayVideo != -1) {
                        MjClient.playui._doPickResetHandCardForPlayBack(eD, changeUIOff_chenZhouZiPai(3));
                    }
                    // RemovePutCardOut_chenZhouZiPai(true);
                    // MjClient.playui.ResetHandCard(this,2);

                    DealShowLastCard_chenZhouZiPai(this, eD, changeUIOff_chenZhouZiPai(3));
                },
                HZAddCards:function (eD) {
                    DealAddCard_chenZhouZiPai(this,eD, changeUIOff_chenZhouZiPai(3));
                },
                HZCheckRaise:function (msg) {
                    ShowPutCardIcon_chenZhouZiPai();
                    //MjClient.playui.EatVisibleCheck();
        ...
        xing: {
            ...
            head: {
                chuizi_tips : {
                    _run: function(){
                        setJiachuiImgTips_chenZhouZiPai(this, changeUIOff_chenZhouZiPai(1));
                    },
                    _event: {
                        initSceneData: function() {
                            setJiachuiImgTips_chenZhouZiPai(this, changeUIOff_chenZhouZiPai(1));
                ...
                jiachuiText_tips : {
                    _run:function() {
                        setJiachuiTextTips_chenZhouZiPai(this, changeUIOff_chenZhouZiPai(1));
                    },
                    _event:{
                        initSceneData: function() {
                            setJiachuiTextTips_chenZhouZiPai(this, changeUIOff_chenZhouZiPai(1));
                        ...
                        MJJiazhu: function(msg) {
                            var pl = getUIPlayer_chenZhouZiPai(changeUIOff_chenZhouZiPai(1))
                            if (msg.uid == pl.info.uid) {
                                setJiachuiTextTips_chenZhouZiPai(this, changeUIOff_chenZhouZiPai(1));
                            }
                        },
                ...
                zhuang: {
                    ...
                    _event: {
                        waitPut: function() {
                            if(MjClient.MaxPlayerNum_chenZhouZiPai == 4 ) {
                                showUserZhuangLogo_chenZhouZiPai(this, changeUIOff_chenZhouZiPai(1));
                            }
                        },
                        initSceneData: function() {
                            if(MjClient.MaxPlayerNum_chenZhouZiPai == 4 ) {
                                if (IsArrowVisible_chenZhouZiPai()) showUserZhuangLogo_chenZhouZiPai(this, changeUIOff_chenZhouZiPai(1));
                            }
                        },
                        mjhand: function(){
                            if(MjClient.MaxPlayerNum_chenZhouZiPai == 4 ) {
                ...
                chatbg: {
                    ...
                    chattext: {
                        _event: {
                            MJChat: function(msg) {
                                if(MjClient.MaxPlayerNum_chenZhouZiPai == 4) {
                                    showUserChat_chenZhouZiPai(this, changeUIOff_chenZhouZiPai(1), msg);
                                }
                            },
                            playVoice: function(voicePath) {
                                if(MjClient.MaxPlayerNum_chenZhouZiPai == 4) {
                                    MjClient.data._tempMessage.msg = voicePath;
                                    showUserChat_chenZhouZiPai(this, changeUIOff_chenZhouZiPai(1), MjClient.data._tempMessage);
                                }
                            }
                        }
                    }
                ...
                _click: function(btn) {
                    if(MjClient.MaxPlayerNum_chenZhouZiPai == 4) {
                        showPlayerInfo_chenZhouZiPai(changeUIOff_chenZhouZiPai(1), btn);
                    }
                },
                _event: {
                    loadWxHead: function(d) {
                        if(MjClient.MaxPlayerNum_chenZhouZiPai == 4) {
                            setWxHead_chenZhouZiPai(this, d, changeUIOff_chenZhouZiPai(1));
                        }
                    },
                    addPlayer: function(eD) {
                        showFangzhuTagIcon_chenZhouZiPai(this,changeUIOff_chenZhouZiPai(1));
                    },
                    removePlayer: function(eD) {
                        showFangzhuTagIcon_chenZhouZiPai(this,changeUIOff_chenZhouZiPai(1));
                    }
                ...
                huxi:{
                    ...
                    _event:{
                        ...
                        initSceneData:function(){
                            if(MjClient.MaxPlayerNum_chenZhouZiPai == 4) {
                                this.visible = true;
                                var huXi = UpdateHuXi_chenZhouZiPai(changeUIOff_chenZhouZiPai(1));
                                if (!IsArrowVisible_chenZhouZiPai()) {
                                    huXi = 0;
                                    this.visible = false;
                                }
            ...
            ready: {
                ...
                _run: function() {
                    if(MjClient.MaxPlayerNum_chenZhouZiPai == 4) {
                        GetReadyVisible_chenZhouZiPai(this, changeUIOff_chenZhouZiPai(1));
                    }
                },
                _event: {
                    startShuffleCards:function (d) {
            ...
            _event: {
                clearCardUI: function() {
                    if(MjClient.MaxPlayerNum_chenZhouZiPai == 4) {
                        clearCardUI_chenZhouZiPai(this, changeUIOff_chenZhouZiPai(1));
                    }
                },
                clearCardArr: function(){
                    if(MjClient.MaxPlayerNum_chenZhouZiPai == 4) {
                ...
                initSceneData: function(eD) {
                    if(MjClient.MaxPlayerNum_chenZhouZiPai == 4) {
                        SetUserVisible_chenZhouZiPai(this, changeUIOff_chenZhouZiPai(1));
                        InitUserHandUI_chenZhouZiPai(this, changeUIOff_chenZhouZiPai(1));
                        InitUserCoinAndName_chenZhouZiPai(this, changeUIOff_chenZhouZiPai(1));
                        DealOffLineCard_chenZhouZiPai(this, changeUIOff_chenZhouZiPai(1));
                    }
                },
                addPlayer: function(eD) {
                    if(MjClient.MaxPlayerNum_chenZhouZiPai == 4) {
                ...
                HZNewCard: function(eD) {
                    if(MjClient.MaxPlayerNum_chenZhouZiPai == 4) {
                        ...
                        DealNewCard_chenZhouZiPai(this, eD, changeUIOff_chenZhouZiPai(1));
                    }
                },
                roundEnd: function() {
                    if(MjClient.MaxPlayerNum_chenZhouZiPai == 4) {
                        InitUserCoinAndName_chenZhouZiPai(this, changeUIOff_chenZhouZiPai(1));
                        MjClient.playui.ResetOtherCard(this, changeUIOff_chenZhouZiPai(1));
                    }
                },
                waitPut: function(eD) {
                    if(MjClient.MaxPlayerNum_chenZhouZiPai == 4) {
                        DealWaitPut(this, eD, changeUIOff_chenZhouZiPai(1));
                    }
                },
                MJPut: function(eD) {
                    if(MjClient.MaxPlayerNum_chenZhouZiPai == 4) {
                        DealPutCard_chenZhouZiPai(this, eD, changeUIOff_chenZhouZiPai(1));
                    }
                },
                HZChiCard: function(eD) {
                    if(MjClient.MaxPlayerNum_chenZhouZiPai == 4) {
                        DealChiCard_chenZhouZiPai(this, eD, changeUIOff_chenZhouZiPai(1));
                    }
                },
                HZGangCard: function(eD) {
                    if(MjClient.MaxPlayerNum_chenZhouZiPai == 4) {
                        DealGangCard_chenZhouZiPai(this, eD, changeUIOff_chenZhouZiPai(1));
                    }
                },
                MJPeng: function(eD) {
                    if(MjClient.MaxPlayerNum_chenZhouZiPai == 4) {
                        DealPengCard_chenZhouZiPai(this, eD, changeUIOff_chenZhouZiPai(1));
                    }
                },
                HZWeiCard: function(eD){
                    if(MjClient.MaxPlayerNum_chenZhouZiPai == 4) {
                        DealWeiCard_chenZhouZiPai(this, eD, changeUIOff_chenZhouZiPai(1));
                    }
                },
                MJHu: function(eD) {
                    if(MjClient.MaxPlayerNum_chenZhouZiPai == 4) {
                        DealHu_chenZhouZiPai(this, eD, changeUIOff_chenZhouZiPai(1));
                    }
                },
                onlinePlayer: function(eD) {
                    if(MjClient.MaxPlayerNum_chenZhouZiPai == 4) {
                        setUserOffline_chenZhouZiPai(this, changeUIOff_chenZhouZiPai(1));
                    }
                },
                playerStatusChange: function(eD) {
                    if(MjClient.MaxPlayerNum_chenZhouZiPai == 4) {
                ...
                MJFlower: function(eD) {
                    if(MjClient.MaxPlayerNum_chenZhouZiPai == 4) {
                        HandleMJFlower(this, eD, changeUIOff_chenZhouZiPai(1));
                    }
                },
                MJTing: function (eD) {
                    if(MjClient.MaxPlayerNum_chenZhouZiPai == 4) {
                        HandleMJTing(this, eD, changeUIOff_chenZhouZiPai(1));
                    }
                },
                HZPickCard:function (eD) {
                    if(MjClient.MaxPlayerNum_chenZhouZiPai == 4) {
                        if (MjClient.rePlayVideo != -1 ) {
                            var pl = getUIPlayer_chenZhouZiPai(changeUIOff_chenZhouZiPai(1));
                            if (eD.uid == pl.info.uid) {
                                MjClient.OtherHandArr[changeUIOff_chenZhouZiPai(1)] = MjClient.majiang.sortHandCardSpecial(pl.mjhand)
                            }
                        }
                        DealShowLastCard_chenZhouZiPai(this, eD, changeUIOff_chenZhouZiPai(1));
                    }
                },
                HZAddCards:function (eD) {
                    if(MjClient.MaxPlayerNum_chenZhouZiPai == 4) {
                        DealAddCard_chenZhouZiPai(this, eD, changeUIOff_chenZhouZiPai(1));
                    }
                },
                HZCheckRaise:function (msg) {
                    if(MjClient.MaxPlayerNum_chenZhouZiPai == 4) {
        ...
        eat: {
            chi: {
                ...
                _touch: function(btn, eT) {
                    if (eT == 2){
                        if(ziPai.getHasFastEat()){
                            ...
                            if (chiSet.length == 1) {
                                ...
                                if (pl.mjhand.indexOf(putCard) < 0 || copy.indexOf(putCard) >= 0) {
                                    ...
                                    commitEatCards_chenZhouZiPai(eatCards, null);
                        ...
                        showSelectEatCards_chenZhouZiPai(this,btn.tag);
            ...
            hu: {
                ...
                _touch: function(btn, eT) {
                    if (eT == 2) {
                        MJHuToServer_chenZhouZiPai();
                        setChiVisible_chenZhouZiPai();//add by maoyu
                    }
                }
            },
            cancel: {
            ...
            wangDiao:{
                ...
                _touch: function(btn, eT) {
                    console.log(">>>> lf，点击碰按钮");
                    if (eT == 2) {
                        HZWangChuangToServer_chenZhouZiPai(1);
                        setChiVisible_chenZhouZiPai();//add by maoyu
                    }
                }
            },
            wangChuang:{
                ...
                _touch: function(btn, eT) {
                    console.log(">>>> lf，点击碰按钮");
                    if (eT == 2) {
                        HZWangChuangToServer_chenZhouZiPai(2);
                        setChiVisible_chenZhouZiPai();//add by maoyu
                    }
                }
            },
            wangZha:{
                ...
                _touch: function(btn, eT) {
                    console.log(">>>> lf，点击碰按钮");
                    if (eT == 2) {
                        HZWangChuangToServer_chenZhouZiPai(4);
                        setChiVisible_chenZhouZiPai();//add by maoyu
                    }
                }
            },
                    ...
                    this.adaptChiLayout = function() {
                        ...
                        if (cards_option.length == 0) { // 吃牌选好了
                            if ((MjClient.data.sData.players[SelfUid()].eatFlag & 32) > 0) {
                                MjClient.showMsg("选择吃后视为过胡，确定吃吗？", function() {
                                    ...
                                    HZChiToServer_chenZhouZiPai(cards_select[0], biCards);
                                    this.visible = false;
                                }.bind(this), function() {
                                    cards_select.pop();
                                    this.adaptChiLayout();
                        ...
                        for (var i = 0; i < cards_select.length; i++) {
                            ...
                            for (var j = 0; j < row.length; j++) {
                                ...
                                chiCardImg.loadTexture(MjClient.cardPath_chenZhouZiPai + "out" + row[j] + ".png");
        ...
        voice_btn: {
            ...
            _event: {
                ...
                downAndPlayVoice: function(msg) {
                    ...
                    downAndPlayVoice_chenZhouZiPai(msg.uid, msg.msg);
                }
            }
        },
        cutLine:{
    ...
    ctor: function() {
        this._super();
        ziPai.initZiPaiData();
        var playui = ccs.load("Play_ChenZhouZiPai.json");
        playMusic("bgFight");
        var tData = MjClient.data.sData.tData;
        MjClient.MaxPlayerNum_chenZhouZiPai = tData.maxPlayer;
        ...
        //三人玩时恢复
            ...
            this.jsBind.left = PlayLayer_chenZhouZiPai.jsBindLeftCopy;
        }
        ...
        this.tingLayer = new ChenZhouZiPaiTingLayer();
    ...
    resetJiaZhuTip: function()
    {
        ...
        for (var i = 0; i < MjClient.MaxPlayerNum_chenZhouZiPai; i ++)
        {
            var pl = getUIPlayer_chenZhouZiPai(i);
            if (!pl) 
                continue;
...
PlayLayer_chenZhouZiPai.jsBindLeftCopy = PlayLayer_chenZhouZiPai.prototype.jsBind.left;

//重置手牌的顺序
PlayLayer_chenZhouZiPai.prototype.ResetHandCard = function(posNode,off, needAction, isDelay){

    needAction = needAction === undefined ? false : needAction;
    // needAction = false;

    if(off == 0){
        resetHandCard_chenZhouZiPaiEx(posNode,off, needAction, isDelay);
...
//回放时其他家补牌重置手牌的处理
PlayLayer_chenZhouZiPai.prototype._doPickResetHandCardForPlayBack = function(msg, off){
    var pl = getUIPlayer_chenZhouZiPai(off);
...
PlayLayer_chenZhouZiPai.prototype._doMovetoAction = function(node,endP){
    node.stopAllActions();
    var ac = cc.moveTo(0.3,endP);
    node.runAction(ac);
};

PlayLayer_chenZhouZiPai.prototype.ResetOtherCard = function(posNode, off) {
    //添加吃、碰、跑、偎、提
    var sData = MjClient.data.sData;
    var tData = null;
    if (sData) {
    ...
    if (mjSortArr) {
            ...
            for (var i = 0; i < childList.length; i++) {
                ...
                if(tData.maxPlayer == 4){
                    if((off <= 1 && i != childList.length - 1) ||
                        (off >= 2 && i != 0)){
                        child.loadTexture(MjClient.cardPath_chenZhouZiPai + "huxiBG.png");
                    }
                }else{
        ...
        for (var k = 0; k < mjSortArr.length; k++) {
            ...
            if (name == "mjgang1") {
                ...
                for (var i = 0; i < 4; i++) {
                    addEatCard_chenZhouZiPai(posNode, "mjgang1" + k, cardNum, off);
                }
            ...
            if (name == "mjwei") {
                var cardNum = pl.mjwei[pos];
                for (var i = 0; i < 3; i++) {
                    addEatCard_chenZhouZiPai(posNode, "mjwei" + k, cardNum, off);
                }
            ...
            if (name == "mjgang0") {
                ...
                for (var i = 0; i < 4; i++) {
                    addEatCard_chenZhouZiPai(posNode, "mjgang0" + k, cardNum, off);
                }
            }
            //碰
            if (name == "mjpeng") {
                ...
                for (var i = 0; i < 3; i++) {
                    addEatCard_chenZhouZiPai(posNode, "mjpeng" + k, cardNum, off);
                }
            }
            //吃
            if (name == "mjchi") {
                ...
                for (var i = 0; i < eatCards.length; i++) {
                    addEatCard_chenZhouZiPai(posNode, "mjchi" + k, eatCards[i], off);
                }
                ...
                if (biCards && biCards.length > 0) {
                    for (var i = 0; i < biCards.length; i++) {
                        ...
                        for (var m = 0; m < biArr.length; m++) {
                            addEatCard_chenZhouZiPai(posNode, "mjbi" + k + i, biArr[m], off);
                        }
                    }
                }
    ...
    //    var outCard = getNewCard_chenZhouZiPai(pl.mjput[i], 2, off);
    //    if(off == 0){
    //        outCard.anchorX = 1;
    //        outCard.anchorY = 0;
...
PlayLayer_chenZhouZiPai.prototype.ResetPutCard = function(posNode,off){
    //添加打出的牌
    var pl = getUIPlayer_chenZhouZiPai(off);
    if (!pl) return;
    var outNode = posNode.getChildByName("outNode");
    ...
    for (var i = 0; i < pl.mjput.length; i++) {
        ...
        setPutCardPos_chenZhouZiPai(outNode, outCard, i, off);
...
//重置牌的顺序
PlayLayer_chenZhouZiPai.prototype.CardLayoutRestore = function(posNode,off){
    if(MjClient.rePlayVideo == -1){
...
// 判断吃、碰、跑、偎、提、胡的状态
PlayLayer_chenZhouZiPai.prototype.EatVisibleCheck = function(off){
    var eat = MjClient.playui.jsBind.eat;
    ...
    if(tData.tState != TableState.roundFinish && pl.mjState != TableState.roundFinish){
        if(IsTurnToMe()){
            ...
            if(pl.eatFlag & 4){
                ...
                if(!canHu){
                    // HZGangToServer_chenZhouZiPai(2);
                    return;
                }
            }
            //吃
...
PlayLayer_chenZhouZiPai.prototype.showAndHideHeadEffect = function(){
    ...
    else if (curPlayerIsMe_chenZhouZiPai(1)){
        curPlayerNode = arr[1].getChildByName("head");
    }else if (curPlayerIsMe_chenZhouZiPai(2)){
        curPlayerNode = arr[2].getChildByName("head");
    }else if (curPlayerIsMe_chenZhouZiPai(3)){
