...
function SetEndOneUserUI_xiangshui(node,off)
{
    ...
    cc.log("pl花牌数据 ！！！！！！！！！！ ",JSON.stringify(pl),"DirType",DirType)
    //对应方位的风牌分数加一
    ...
    changeAtalsForLabel(huaCount, pl.mjflower.length + fengnum);
...
var EndOneView_xiangshui = cc.Layer.extend({
	jsBind:{
		block: {
		...
		head0:{
		   ...
		   _run:function(){ SetEndOneUserUI_xiangshui(this,0); },
		...
		,head1:{ 
		  ...
		  _run:function(){ SetEndOneUserUI_xiangshui(this,1); }
		}
		...
		,head2:{ 
		   ...
		   _run:function(){ SetEndOneUserUI_xiangshui(this,2); }
		}
		,head3:{
			 head:
			 {
			...
			_run:function(){ SetEndOneUserUI_xiangshui(this,3); }
			},
            count_down:{
                _visible :function()
                {
    ...
    ctor:function () {
        this._super();
        var endoneui = ccs.load("endOne_xiangshui.json");
