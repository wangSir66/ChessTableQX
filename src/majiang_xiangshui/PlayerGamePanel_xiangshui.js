...
//向服务器发送 过消息
MjClient.MJPass2NetForxiangshui = function()
{
    // console.log(">>>>>>>>>普通  过 <<<<<<<<");
    cc.log("====================send======pass=====");
    ...
    if(IsTurnToMe() && tData.tState == TableState.waitPut)
    {
        ...
        if(eat.gang0._node.visible && eat.hu._node.visible){
            ...
            if(eat.gang0._node.visible){
                cc.log(" roomMsgValue   ",roomMsgValue, "       saveRoomMsgValueG",saveRoomMsgValueG);
...
function SetUserVisible_xiangshui(node, off)
{
    //var sData = MjClient.data.sData;
    //return;
    cc.log("====================off======================" + off);
...
function InitUserHandUI_xiangshui(node, off)
{
    var sData = MjClient.data.sData;
    var tData = sData.tData;
    var pl = getUIPlayer(off);
    ...
    for(var i = 0; i < pl.mjgang1.length; i++)
    {
        for(var j = 0; j < 4; j++)
        {
            if (off == 0 ) 
            {
                ...
                {
                    getNewCard(node, "down", "gang1", 0, off);
                }
            }
            else
            {   
...
function initFlower_xiangshui() {
    initFlower(false, false);
}


var PlayLayer_xiangshui = cc.Layer.extend({
    jsBind: {
        _event: {
            mjhand: function() {
            ...
            roundEnd: function() {
                ...
                function delayExe()
                {
                    ...
                    self.addChild(new EndOneView_xiangshui(),500);
                }
        ...
        banner: {
            ...
            Button_1: {
                _visible : true,
                _click: function() {
                    MjClient.openWeb({url:MjClient.GAME_TYPE.GUAN_YUN,help:true});
                }
            },
            hunPai:{
                baidaBg:{
            ...
            fengquan:{
                _run:function () {
                    this.visible = false;
                    setWgtLayout(this,[0.6,0.6],[0,1],[-1.4,-2],false,true);
                },
                _event:{
                    mjhand:function () {
                        this.visible = true;
                        var pl = getUIPlayer(0);
                        var strArray = ["东风圈","南风圈","西风圈","北风圈"];
                        if (typeof (pl.dirNumber) != "undefined"){
                            this.getChildByName("Text").setString(strArray[pl.dirNumber]);
                        }
                    },
                    initSceneData:function () {
        ...
        down: {
            ...
            _event: {
                ...
                initSceneData: function(eD) {
                    SetUserVisible_xiangshui(this, 0);
                },
                addPlayer: function(eD) {
                    SetUserVisible_xiangshui(this, 0);
                },
                ...
                mjhand: function(eD) {
                    InitUserHandUI_xiangshui(this, 0);
                },
                roundEnd: function() {
                ...
                MJPut: function(eD) {
                    ...
                    MjClient.majiang.setFlowerImg(this, pl);
        ...
        right: {
            ...
            _event: {
                ...
                initSceneData: function(eD) {
                    SetUserVisible_xiangshui(this, 1);
                },
                addPlayer: function(eD) {
                    SetUserVisible_xiangshui(this, 1);
                },
                ...
                mjhand: function(eD) {
                    InitUserHandUI_xiangshui(this, 1);
                },
                roundEnd: function() {
        ...
        top: {
            ...
            _event: {
                ...
                initSceneData: function(eD) {
                    SetUserVisible_xiangshui(this, 2);
                },
                addPlayer: function(eD) {
                    SetUserVisible_xiangshui(this, 2);
                },
                ...
                mjhand: function(eD) {
                    InitUserHandUI_xiangshui(this, 2);
                },
                roundEnd: function() {
        ...
        left: {
            ...
            _event: {
                ...
                initSceneData: function(eD) {
                    SetUserVisible_xiangshui(this, 3);
                },
                addPlayer: function(eD) {
                    SetUserVisible_xiangshui(this, 3);
                },
                ...
                mjhand: function(eD) {
                    InitUserHandUI_xiangshui(this, 3);
                },
                roundEnd: function() {
        ...
        eat: {
            ...
            ting: {
                ...
                _touch: function(btn, eT) {
                    if (eT == 2)
                    {
                        ...
                        cc.log("----------------tingCards = " + JSON.stringify(tingCards_self));
                    ...
                    if (eT == 2) 
                        {
                            if(MjClient.playui.jsBind.eat.hu._node.visible)
                            {
                                MjClient.showMsg("确认不胡吗?", MJPengToServer, function() {}, "1");
                            }
                            else
                            {
                                MJPengToServer();
            ...
            guo: {
                ...
                _touch: function(btn, eT) {
                    if (eT == 2)
                    {
                        MjClient.MJPass2NetForxiangshui();
                    }
                },
                bgimg: {
                    _run: function() {
            ...
            changeui: {
                ...
                changeuibg: {
                    ...
                    guobg: {
                        guo: {
                            _touch: function(btn, eT) {
                                if (eT == 2) MjClient.MJPass2NetForxiangshui();
                            }
                        },
                        fanhui: {
                            _touch: function(btn, et) {
    ...
    ctor: function() {
        this._super();
        var playui = ccs.load("Play_xiangshui.json");
        playMusic("bgFight");
    ...
    */
    setTingCardInfo:function(node,eD,off)
    {
        ...
        if(pl == null) return;
        var tData = MjClient.data.sData.tData;
        cc.log("(((((((((((( set card))))))))))))))))) == pl.mjState  " + pl.mjState,JSON.stringify(pl));
...
PlayLayer_xiangshui.prototype.CardLayoutRestore = function(node, off)
{
    ...
    for(var i = 0; i < orders.length; i++)
    {
        ...
        if(off % 2 == 0)//自己或者对家
        {
            ...
            else
            {
                ...
                if (ci.name == "mjhand" && (pl.isTing || MjClient.clickTing && !MjClient.canBaoTingCards[ci.tag]))
                    ci.setColor(cc.color(190, 190, 190));
                else
            ...
            if(off == 0)
            {
                ...
                if(MjClient.clickTing)
                {
                    if (ci.name == "mjhand")
                    {
                        if(MjClient.canBaoTingCards[ci.tag])
                        {
                            ci.setColor(cc.color(255, 255, 255));
                            if (!hasUp) {
                                ci.y += 20;
...
// 判断吃碰杠胡的状态
PlayLayer_xiangshui.prototype.EatVisibleCheck = function()
{
    var eat = MjClient.playui.jsBind.eat;
    ...
    {
        cc.log("-----------起手----------pl.putCount = " + pl.putCount);
        cc.log("-----------起手----------pl.isTing = " + pl.isTing);
        cc.log("-----------起手----------tData.tState = " + tData.tState);
        cc.log("-----------起手----------pl.isTianting = " + pl.isTianting);
        if(!pl.isTing &&  pl.putCount <= 0 && tData.tState == TableState.waitPut ) //起手听牌 && tData.tState == TableState.waitPut
        {
            cc.log("-----------起手----------pl.putCount = " + pl.putCount);
            _isQiShow = true;
        }
    ...
    if(tData.tState == TableState.waitPut && pl.mjState == TableState.waitPut || _isQiShow)
    {
        //if(IsTurnToMe())
        {
            ...
            cc.log("555555 pl.eatFlag = " + pl.eatFlag);
            if ( pl.eatFlag & 8) {
            ...
            var rtn =  [];
            if(pl.gangList && pl.gangList.length > 0)
            {
                rtn = pl.gangList.slice();
            }
            ...
            MjClient.canBaoTingCards = {};
            if (pl.tingLists) 
            {
                for (var i in pl.tingLists) {
                    if (pl.tingLists[i].length == 1 && pl.eatFlag != 8) {
                        MjClient.canBaoTingCards[i] = 1;
                        if (!pl.isTing && vnode.indexOf(eat.ting._node) < 0) 
                        {
            ...
            if(rtn.length > 0 )
            {
                MjClient.gangCards = rtn.slice();
            }

            for (var i = 0; i < rtn.length; i++) {
                if (pl.mjpeng.indexOf(rtn[i]) >= 0 )
                {
                    MjClient.BuGangCards.push(rtn[i]);
                    MjClient.gangCards.splice(i,1);
                    if (vnode.indexOf(eat.gang1._node) < 0) 
                    {
            ...
            cc.log("MjClient.BuGangCards ",MjClient.BuGangCards,JSON.stringify(pl));
            if(vnode.length > 0)
            {
                if(vnode.indexOf(eat.hu._node) >= 0 && pl.isTing )
                {
    ...
    if(vnode.length > 0)
    {
        ...
        for(var i = 0; i < vnode.length; i++)
        {
            ...
            if(i == 0)
            {
                ...
                {
                    if(MjClient.BuGangCards.length == 1)
                    {
                        cardVal = MjClient.BuGangCards[0];
                    }
                }
                else if(btnName == "hu")
                {
...
PlayLayer_xiangshui.prototype.willHuShowArrow = function()
{
    COMMON_UI.cleanTingSign();
    var pl = getUIPlayer(0);
    if(!pl.mjhand || !IsTurnToMe()) return;
...
PlayLayer_xiangshui.prototype.MJGangCardchange = function(tag)
{
    var tData = MjClient.data.sData.tData;

    var gangCards = MjClient.BuGangCards;
    cc.log("MjClient.BuGangCards; ",MjClient.BuGangCards);
