...
function SetUserVisible_ylShiHuKa(node, off){
    ...
    if(pl){
        ...
        // InitUserHandUI_ylShiHuKa(node, off);
...
function InitUserHandUI_ylShiHuKa(node, off){
...
var PlayLayer_ylShiHuKa = cc.Layer.extend({
    jsBind: {
        _event: {
            ...
            endRoom: function(msg) {
                ...
                if (msg.showEnd){
                    this.addChild(new GameOverLayer_ylShiHuKa(),500);
            ...
            roundEnd: function() {
                ...
                function delayExe(){
                    ...
                    if (sData.tData.roundNum <= 0 && !sData.tData.fieldId){
                        var layer = new GameOverLayer_ylShiHuKa();
                        layer.setVisible(false);
                        self.addChild(layer,500);
                    }
                    if(!MjClient.endoneui){
                        self.addChild(new EndOneView_ylShiHuKa(),500);
                    }
        ...
        down: {
            ...
            _event: {
                ...
                initSceneData: function(eD) {
                    SetUserVisible_ylShiHuKa(this, 0);
                    InitUserHandUI_ylShiHuKa(this, 0);
        ...
        right: {
            ...
            _event: {
                ...
                initSceneData: function(eD) {
                    SetUserVisible_ylShiHuKa(this, 1);
                    InitUserHandUI_ylShiHuKa(this, 1);
        ...
        left: {
            ...
            _event: {
                ...
                initSceneData: function(eD) {
                    SetUserVisible_ylShiHuKa(this, 2);
                    InitUserHandUI_ylShiHuKa(this, 2);
    ...
    ctor: function() {
        this._super();
        ziPai.initZiPaiData();
        var playui = ccs.load("Play_ylShiHuKa.json");
        playMusic("bgFight");
        var tData = MjClient.data.sData.tData;
        ...
        this.tingLayer = new YlShiHuKaPhzTingLayer();
...
//重置手牌的顺序
PlayLayer_ylShiHuKa.prototype.ResetHandCard = function(posNode,off, needAction, isDelay){
...
PlayLayer_ylShiHuKa.prototype._doMovetoAction = function(node,endP){
    node.stopAllActions();
    var ac = cc.moveTo(0.3,endP);
    node.runAction(ac);
};

PlayLayer_ylShiHuKa.prototype.ResetOtherCard = function(posNode, off) {
    //添加吃、碰、跑、偎、提
    var sData = MjClient.data.sData;
    var tData = null;
    if (sData) {
...
PlayLayer_ylShiHuKa.prototype.ResetPutCard = function(posNode, off) {
    //添加打出的牌
    var pl = getUIPlayer_hengYang(off);
    if (!pl) return;
    var outNode = posNode.getChildByName("outNode");
...
//重置牌的顺序
PlayLayer_ylShiHuKa.prototype.CardLayoutRestore = function(posNode,off){
    if(MjClient.rePlayVideo == -1){
...
// 判断吃、碰、跑、偎、提、胡的状态
PlayLayer_ylShiHuKa.prototype.EatVisibleCheck = function(off){
    var eat = MjClient.playui.jsBind.eat;
...
PlayLayer_ylShiHuKa.prototype.showAndHideHeadEffect = function(){
...
PlayLayer_ylShiHuKa.prototype.addHeadEffect = function(head){
    var tag = 2018322;
...
PlayLayer_ylShiHuKa.prototype.showAndHideTrust = function(node, uiOff){
    var tData = MjClient.data.sData.tData;
    ...
    if(this.trustLayer && tData.tState != TableState.roundFinish){
        var pl = getUIPlayer_hengYang(0);
        if(pl.trust){
...
PlayLayer_ylShiHuKa.prototype.showCountdown = function(node){
