...
var EndOneView_TYHZ = cc.Layer.extend({
	jsBind:{
		...
		},pingju:
		{
			...
			},_run:function()
			{
				...
				{
					if(isRealHuangZhuang() && (MjClient.majiang.getAllCardsTotal(tData) - tData.cardNext) == 0) this.loadTexture("gameOver/huangzhuan_35.png");
				}
    ...
    ctor:function () {
        this._super();
        var endoneui = ccs.load(res.EndOne_TYHZ_json);
