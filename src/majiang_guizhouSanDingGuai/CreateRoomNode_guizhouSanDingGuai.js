...
var CreateRoomNode_guizhouSanDingGuai = CreateRoomNode.extend({
    setKey:function(){
        this.localStorageKey.KEY_guizhouSanDingGuai_shangxiaji  = "_guizhouSanDingGuai_SHANG_XIA_JI";   //上下鸡
        this.localStorageKey.KEY_guizhouSanDingGuai_wuguji      = "_guizhouSanDingGuai_WU_GU_JI";       // 乌骨鸡
        this.localStorageKey.KEY_guizhouSanDingGuai_mantangji   = "_guizhouSanDingGuai_MAN_TANG_JI";    // 满堂鸡
        this.localStorageKey.KEY_guizhouSanDingGuai_difen       = "_guizhouSanDingGuai_DI_FEN";         // 底分
        this.localStorageKey.KEY_guizhouSanDingGuai_gps         = "_guizhouSanDingGuai_GPS";            // 防作弊
        this.localStorageKey.KEY_guizhouSanDingGuai_qgshaoji    = "_guizhouSanDingGuai_QG_SHAO_JI";     // 抢杠烧鸡
        this.localStorageKey.KEY_guizhouSanDingGuai_qgshaodou   = "_guizhouSanDingGuai_QG_SHAO_DOU";    // 抢杠烧豆
        this.localStorageKey.KEY_guizhouSanDingGuai_yuanque     = "_guizhouSanDingGuai_YUAN_QUE";       // 原缺
        this.localStorageKey.KEY_guizhouSanDingGuai_lianzhuang  = "_guizhouSanDingGuai_LIAN_ZHUANG";    // 连庄
        this.localStorageKey.KEY_guizhouSanDingGuai_tuoguan     = "_guizhouSanDingGuai_TUOGUAN";        // 托管
    },
    ...
    setPlayNodeCurrentSelect: function(isClub) {
        ...
        if (isClub)
            ...
            _shangxiaji = util.localStorageEncrypt.getBoolItem(this.localStorageKey.KEY_guizhouSanDingGuai_shangxiaji, true);
        ...
        if (isClub)
            ...
            _play_wuguji = util.localStorageEncrypt.getBoolItem(this.localStorageKey.KEY_guizhouSanDingGuai_wuguji, true);
        ...
        if (isClub)
            ...
            _mantangji = util.localStorageEncrypt.getBoolItem(this.localStorageKey.KEY_guizhouSanDingGuai_mantangji, true);
        ...
        if (isClub)
            ...
            _qianggangshaoji = util.localStorageEncrypt.getBoolItem(this.localStorageKey.KEY_guizhouSanDingGuai_qgshaoji, true);
        ...
        if (isClub)
            ...
            _qianggangshaodou = util.localStorageEncrypt.getBoolItem(this.localStorageKey.KEY_guizhouSanDingGuai_qgshaodou, true);
        ...
        if (isClub)
            ...
            _yuanque = util.localStorageEncrypt.getBoolItem(this.localStorageKey.KEY_guizhouSanDingGuai_yuanque, true);
        ...
        if (isClub)
            ...
            _lianzhuang = util.localStorageEncrypt.getBoolItem(this.localStorageKey.KEY_guizhouSanDingGuai_lianzhuang, false);
        ...
        if (isClub) {
            ...
            _beiCount = util.localStorageEncrypt.getNumberItem(this.localStorageKey.KEY_guizhouSanDingGuai_difen, 1);
        ...
        if (isClub)
            ...
            _gps = util.localStorageEncrypt.getBoolItem(this.localStorageKey.KEY_guizhouSanDingGuai_gps, false);
        ...
        if (isClub)
            ...
            _trustTime = util.localStorageEncrypt.getNumberItem(this.localStorageKey.KEY_guizhouSanDingGuai_tuoguan, 0);
    ...
    getSelectedPara:function()
    {
        ...
        para.gameType = MjClient.GAME_TYPE.GUI_ZHOU_SAN_DING_GUAI;
        para.maxPlayer = 3; // 人数固定三人
        ...
        if (!this._isFriendCard) {
            util.localStorageEncrypt.setBoolItem(this.localStorageKey.KEY_guizhouSanDingGuai_shangxiaji,  para.yaobaiji);
            util.localStorageEncrypt.setBoolItem(this.localStorageKey.KEY_guizhouSanDingGuai_wuguji,  para.wuguji);
            util.localStorageEncrypt.setBoolItem(this.localStorageKey.KEY_guizhouSanDingGuai_mantangji,  para.mantangji);
            util.localStorageEncrypt.setBoolItem(this.localStorageKey.KEY_guizhouSanDingGuai_qgshaoji,  para.qianggangshaoji);
            util.localStorageEncrypt.setBoolItem(this.localStorageKey.KEY_guizhouSanDingGuai_qgshaodou,  para.qianggangshaodou);
            util.localStorageEncrypt.setBoolItem(this.localStorageKey.KEY_guizhouSanDingGuai_yuanque,  para.yuanque);
            util.localStorageEncrypt.setBoolItem(this.localStorageKey.KEY_guizhouSanDingGuai_lianzhuang,  para.lianzhuang);
            util.localStorageEncrypt.setNumberItem(this.localStorageKey.KEY_guizhouSanDingGuai_difen, para.beishu);
            util.localStorageEncrypt.setNumberItem(this.localStorageKey.KEY_guizhouSanDingGuai_tuoguan, para.trustTime);
