//贵州，三丁拐麻将
var PlayLayer_guizhouSanDingGuai;
(function() {
    PlayLayer_guizhouSanDingGuai = PlayLayer_guizhou.extend({
        getJsBind: function(){
            var jsBind = {
                node_down: {
                    layout_head: {
        ...
        ctor: function() {
            this._super("Play_guizhouSanDingGuai.json");
...
PlayLayer_guizhouSanDingGuai.prototype.getQueTypeArr = function() {
...
// override 是否添加定缺提示特效
PlayLayer_guizhouSanDingGuai.prototype.hasDingQueTip = function() {
    return true;
};