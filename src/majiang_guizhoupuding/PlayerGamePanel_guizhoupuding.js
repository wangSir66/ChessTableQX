//贵州，普定麻将
var PlayLayer_guizhoupuding;
(function() {
    PlayLayer_guizhoupuding = PlayLayer_guizhou.extend({
        getJsBind: function(){
            var jsBind = {
                node_down: {
                    layout_head: {
        ...
        ctor: function() {
            this._super("Play_guizhoupuding.json");
        ...
        checkGangBtn: function (player) {
            ...
            // if(this.isNewTing() && this.isTianTing(player))
            // {
            //     return false;
            // }
            // var tData = MjClient.data.sData.tData;
            ...
            //     MjClient.majiang.gangWhenZimo(player.mjhand, _gangCardArray, tData.hunCard);
        ...
        getPlayerEatNode: function () {
            ...
            if(this.isTurnMe()){
                ...
                if(!player.isTing && MjClient.playui.checkTingBtn(player)){
                    cc.log("================================player.isDoTianTing = " + player.isDoTianTing);
...
PlayLayer_guizhoupuding.prototype.getQueTypeArr = function() {
...
// override  缺牌门数
PlayLayer_guizhoupuding.prototype.getQueNum = function() {
    return 2;
};

// override 是否添加定缺提示特效
PlayLayer_guizhoupuding.prototype.hasDingQueTip = function() {
    return true;
};