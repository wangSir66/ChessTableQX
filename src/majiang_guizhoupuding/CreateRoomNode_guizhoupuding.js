...
var CreateRoomNode_guizhoupuding = CreateRoomNode.extend({
    setKey:function(){
        this.localStorageKey.KEY_guizhoupuding_benji        = "_guizhoupuding_BEN_JI";          // 本鸡
        this.localStorageKey.KEY_guizhoupuding_wuguji       = "_guizhoupuding_WU_GU_JI";        // 乌骨鸡
        this.localStorageKey.KEY_guizhoupuding_mantangji    = "_guizhoupuding_MAN_TANG_JI";     // 满堂鸡
        this.localStorageKey.KEY_guizhoupuding_difen        = "_guizhoupuding_DI_FEN";          // 底分
        this.localStorageKey.KEY_guizhoupuding_gps          = "_guizhoupuding_GPS";             // 防作弊
        this.localStorageKey.KEY_guizhoupuding_count        = "_guizhoupuding_COUNT";           // 人数
        this.localStorageKey.KEY_guizhoupuding_gameType     = "_guizhoupuding_gameType";        // 游戏类型
        this.localStorageKey.KEY_guizhoupuding_tuoguan      = "_guizhoupuding_TUOGUAN";         // 托管
        this.localStorageKey.KEY_guizhoupuding_zhipaixing   = "_guizhoupuding_ZHI_PAI_XING";    // 只牌型分
        this.localStorageKey.KEY_guizhoupuding_gangkaiadd   = "_guizhoupuding_GANG_KAI_ADD";    // 杠开加10分
    },
    setPlayNodeCurrentSelect: function(isClub) {
        ...
        if (isClub)
            ...
            _benji = util.localStorageEncrypt.getBoolItem(this.localStorageKey.KEY_guizhoupuding_benji, true);
        ...
        if (isClub)
            ...
            _play_wuguji = util.localStorageEncrypt.getBoolItem(this.localStorageKey.KEY_guizhoupuding_wuguji, true);
        ...
        if (isClub)
            ...
            _mantangji = util.localStorageEncrypt.getBoolItem(this.localStorageKey.KEY_guizhoupuding_mantangji, true);
        ...
        if (isClub)
            ...
            _zhipaixingfenfanbei = util.localStorageEncrypt.getBoolItem(this.localStorageKey.KEY_guizhoupuding_zhipaixing, false);
        ...
        var _gangkaiadd;
        if (isClub)
            _gangkaiadd = this.getBoolItem("gangkaiadd", false);
        else
            _gangkaiadd = util.localStorageEncrypt.getBoolItem(this.localStorageKey.KEY_guizhoupuding_gangkaiadd, false);
        this._playNode_gangkaiadd.setSelected(_gangkaiadd);
        var text = this._playNode_gangkaiadd.getChildByName("text");
        this.selectedCB(text, _gangkaiadd);
        ...
        if (isClub) {
            ...
            _currentCount = util.localStorageEncrypt.getNumberItem(this.localStorageKey.KEY_guizhoupuding_count, 0);
        ...
        if (isClub) {
            ...
            _beiCount = util.localStorageEncrypt.getNumberItem(this.localStorageKey.KEY_guizhoupuding_difen, 1);
        ...
        if (isClub)
            ...
            _gps = util.localStorageEncrypt.getBoolItem(this.localStorageKey.KEY_guizhoupuding_gps, false);
        ...
        if (isClub)
            ...
            _trustTime = util.localStorageEncrypt.getNumberItem(this.localStorageKey.KEY_guizhoupuding_tuoguan, 0);
    ...
    initAll:function(IsFriendCard)
    {
        ...
        this.bg_node = ccs.load("bg_guizhoupuding.json").node;
    ...
    initPlayNode:function()
    {
        ...
        this.addListenerText(nodeCountList1, this._playNode_player_count_radio, function () {
            this.changePayForPlayerNum();
            this.addSpecialProcess();
        }.bind(this));
        ...
        //杠开加10分
        this._playNode_gangkaiadd = _play.getChildByName("play_gangkaiadd");
        this.addListenerText(this._playNode_gangkaiadd);
        this._playNode_gangkaiadd.addEventListener(this.clickCB, this._playNode_gangkaiadd);
    ...
    {
        var para = {};
        para.gameType = MjClient.GAME_TYPE.GUI_ZHOU_PU_DING_MJ;
        para.maxPlayer = 4;
        ...
        //杠开加10分
        para.gangkaiadd = this._playNode_gangkaiadd.isSelected();
        ...
        if (!this._isFriendCard) {
            util.localStorageEncrypt.setNumberItem(this.localStorageKey.KEY_guizhoupuding_count, _countIdx);

            util.localStorageEncrypt.setBoolItem(this.localStorageKey.KEY_guizhoupuding_benji,  para.benji);
            util.localStorageEncrypt.setBoolItem(this.localStorageKey.KEY_guizhoupuding_wuguji,  para.wuguji);
            util.localStorageEncrypt.setBoolItem(this.localStorageKey.KEY_guizhoupuding_mantangji,  para.mantangji);
            util.localStorageEncrypt.setBoolItem(this.localStorageKey.KEY_guizhoupuding_zhipaixing, para.paiXinScoreOnly);
            util.localStorageEncrypt.setBoolItem(this.localStorageKey.KEY_guizhoupuding_gangkaiadd, para.gangkaiadd);
            util.localStorageEncrypt.setNumberItem(this.localStorageKey.KEY_guizhoupuding_tuoguan, para.trustTime);

            util.localStorageEncrypt.setNumberItem(this.localStorageKey.KEY_guizhoupuding_difen, para.beishu);
