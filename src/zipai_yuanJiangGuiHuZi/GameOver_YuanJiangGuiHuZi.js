function SetGameOverLayer_YuanJiangGuiHuZi(node,off,isNewUi){
    ...
    setOfflineShow_YuanJiangGuiHuZi(head, pl);
...
var GameOverLayer_YuanJiangGuiHuZi = cc.Layer.extend({
    sprite:null,
    jsBind:{
        back:{
            share:{
    ...
    ctor:function () {
        ...
        var endallui = ccs.load("endAll_yuanJiangGuiHuZi.json");
        ...
        function _infoText(){
            ...
            text += "房间号:" + roomID + "," + getRoundInfo_YuanJiangGuiHuZi();
        ...
        for(var i = 0 ; i < playerCount ; i++){
            ...
            SetGameOverLayer_YuanJiangGuiHuZi(clone,i, isNewUi);
