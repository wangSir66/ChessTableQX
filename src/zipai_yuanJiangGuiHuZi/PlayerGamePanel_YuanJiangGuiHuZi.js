...
//     }else{
//         HZPassConfirmToServer_YuanJiangGuiHuZi();
//     }
// };

// 这个没看懂干嘛的
// off 是四个位置，根据off 显示四个位置的信息 by sking
function SetUserVisible_YuanJiangGuiHuZi(node, off){
    ...
    if(pl){
        ...
        setUserOffline_YuanJiangGuiHuZi(node, off);
        // InitUserHandUI_YuanJiangGuiHuZi(node, off);
...
function InitUserHandUI_YuanJiangGuiHuZi(node, off){
    ...
    if (pl.jiazhuNum == 2 && MjClient.rePlayVideo == -1)
    {
        ...
        MjClient.majiang.setJiaZhuNum(node, getUIPlayer_YuanJiangGuiHuZi(off));
    }
...
var PlayLayer_YuanJiangGuiHuZi = cc.Layer.extend({
    jsBind: {
        _event: {
            mjhand: function() {
            ...
            endRoom: function(msg) {
                ...
                if (msg.showEnd){
                    this.addChild(new GameOverLayer_YuanJiangGuiHuZi(),500);
                }else{
            ...
            roundEnd: function() {
                ...
                if(!MjClient.isDismiss && tData.hunCard && tData.hunCard != -1 && tData.areaSelectMode.xingType==2){
                    ...
                    ShowEatActionAnim_YuanJiangGuiHuZi(MjClient.playui._downNode, ActionType_paohuzi.FANXING, 0);
                    DealFanXingNewCard_YuanJiangGuiHuZi(hunCard);
                }
                ...
                function delayExe(){
                    ...
                    if (sData.tData.roundNum <= 0){
                        var layer = new GameOverLayer_YuanJiangGuiHuZi();
                        layer.setVisible(false);
                        self.addChild(layer,500);
                    }
                    if(!MjClient.endoneui){
                        self.addChild(new EndOneView_YuanJiangGuiHuZi(),500);
                    }
            ...
            moveHead: function() {
                ...
                //tableStartHeadMoveAction_YuanJiangGuiHuZi(this);   //不涉及到头像移动动作
            },
            initSceneData: function() {
                ...
                reConectHeadLayout_YuanJiangGuiHuZi(this);        //不涉及到头像移动动作
                CheckRoomUiDelete();
                tableStartHeadMoveAction_YuanJiangGuiHuZi(this);   //不涉及到头像移动动作
            ...
            changeMJBgEvent: function() {
                changeMJBg_YuanJiangGuiHuZi(this, ziPai.getZiPaiType());
            },
            MJPeng: function() {
                MjClient.playui.showAndHideHeadEffect();
            },
            ...
            EZP_layout : function(){
                if(MjClient.data.sData.tData.maxPlayer < 4){
                    ...
                    if(IsArrowVisible_YuanJiangGuiHuZi()){
                        ...
                        MjClient.playui.ResetPutCard(MjClient.playui._rightNode, MjClient.MaxPlayerNum_YuanJiangGuiHuZi - 2);
                        MjClient.playui.ResetPutCard(MjClient.playui._topNode, MjClient.MaxPlayerNum_YuanJiangGuiHuZi - 1);
                    }
                }
        ...
        cardNumImg: {
            ...
            _event: {
                initSceneData: function(eD) {
                    this.visible = IsArrowVisible_YuanJiangGuiHuZi();
                },
                mjhand: function(eD) {
                    this.visible = IsArrowVisible_YuanJiangGuiHuZi();
                },
            ...
            cardNumImg:{
                _event:{
                    initSceneData:function(){
                        setCardNumImage_YuanJiangGuiHuZi(this);
                    },
                    mjhand:function(){
                        setCardNumImage_YuanJiangGuiHuZi(this);
                    },
        ...
        operateWait: {
            ...
            _event: {
                initSceneData: function (eD) {
                    if (MjClient.playui.jsBind.left.head.timeImg.time._node.getString() == "0" && curPlayerIsMe_YuanJiangGuiHuZi(MjClient.MaxPlayerNum_YuanJiangGuiHuZi - 1) ||
                        MjClient.playui.jsBind.right.head.timeImg.time._node.getString() == "0" && curPlayerIsMe_YuanJiangGuiHuZi(MjClient.MaxPlayerNum_YuanJiangGuiHuZi - 2) && MjClient.MaxPlayerNum_YuanJiangGuiHuZi != 2) {
                        //this.visible = true;
                    }
                },
                mjhand: function (eD) {
        ...
        banner: {
            ...
            getRoomNum: {
                ...
                _click: function() {
                    ...
                    str += tData.areaSelectMode.maiPai19 ? "埋牌19张," : "";
                    if (!tData.areaSelectMode.maiPai19) {
                        str += tData.areaSelectMode.maiPaiNum == 1 ? "埋牌10张," : tData.areaSelectMode.maiPaiNum == 2 ? "埋牌19张," : "不埋牌";
                    }
                    
                    // str += tData.areaSelectMode.diaoDiaoShou ? ",吊吊手" : "";


                    str += tData.areaSelectMode.anWaiLiu ? ",暗歪/暗溜" : "";
                    str += tData.areaSelectMode.wuXiPing ? ",无息平" : "";
                    str += tData.areaSelectMode.huaHuZi ? ",花胡子" : "";
                    str += tData.areaSelectMode.jiuDuiBan ? ",九对半" : "";
                    str += tData.areaSelectMode.chiPai ? ",吃牌无限制" : "自揭自吃";
                    if(tData.areaSelectMode.fengDing == 100)
                    {
                        str += "封顶100息";
                    }
                    else {
                    ...
                    if(MjClient.MaxPlayerNum_YuanJiangGuiHuZi == 3){
                        if((MjClient.MaxPlayerNum_YuanJiangGuiHuZi - Object.keys(sData.players).length) == 2){
                            str7 = "  一缺二";
                        }
                    }else if(MjClient.MaxPlayerNum_YuanJiangGuiHuZi == 4){
                        if((MjClient.MaxPlayerNum_YuanJiangGuiHuZi - Object.keys(sData.players).length) == 3){
                            str7 = "  一缺三";
                        }else if((MjClient.MaxPlayerNum_YuanJiangGuiHuZi - Object.keys(sData.players).length) == 2){
                            str7 = "二缺二";
                        }else  if((MjClient.MaxPlayerNum_YuanJiangGuiHuZi - Object.keys(sData.players).length) == 1){
                            str7 = "三缺一";
                        }
                    }
            ...
            gps_btn: {
                ...
                _run:function () {
                    //this.visible = MjClient.MaxPlayerNum_YuanJiangGuiHuZi >= 3 ? true : false;
                    this.setVisible(MjClient.MaxPlayerNum_YuanJiangGuiHuZi >= 3);
                },
                _click: function() {
                    if(MjClient.MaxPlayerNum_YuanJiangGuiHuZi == 3){
        ...
        wait: {
            ...
            delroom: {
                ...
                _event: {
                    initSceneData: function(eD) {
                        //this.visible = isShowBackBtn_YuanJiangGuiHuZi();
                    },
                    removePlayer: function(eD) {
                        //this.visible = isShowBackBtn_YuanJiangGuiHuZi();
                    },
        ...
        down: {
            head: {
                siShou:{
                    ...
                    _event:{
                        initSceneData:function () {
                            setSiShou_YuanJiangGuiHuZi(this, 0);
                        },
                        MJPeng: function(eD) {
                            setSiShou_YuanJiangGuiHuZi(this, 0);
                        },
                ...
                zhuang: {
                    ...
                    _event: {
                        waitPut: function(){
                            showUserZhuangLogo_YuanJiangGuiHuZi(this, 0);
                        },
                        initSceneData: function(){
                            if (IsArrowVisible_YuanJiangGuiHuZi()) showUserZhuangLogo_YuanJiangGuiHuZi(this, 0);
                        },
                        mjhand: function(){
                            if (IsArrowVisible_YuanJiangGuiHuZi()) showUserZhuangLogo_YuanJiangGuiHuZi(this, 0);
                        }
                    ...
                    chattext: {
                        _event: {
                            ...
                            MJChat: function(msg) {
                                ...
                                showUserChat_YuanJiangGuiHuZi(this, 0, msg);
                            },
                            playVoice: function(voicePath) {
                                MjClient.data._tempMessage.msg = voicePath;
                                showUserChat_YuanJiangGuiHuZi(this, 0, MjClient.data._tempMessage);
                            }
                        }
                    }
                },
                _click: function(btn) {
                    showPlayerInfo_YuanJiangGuiHuZi(0, btn);
                },
                _event: {
                    loadWxHead: function(d) {
                        setWxHead_YuanJiangGuiHuZi(this, d, 0);
                    },
                    addPlayer: function(eD) {
                        showFangzhuTagIcon_YuanJiangGuiHuZi(this,0);
                    },
                    removePlayer: function(eD) {
                        showFangzhuTagIcon_YuanJiangGuiHuZi(this,0);
                    }
                ...
                huxi:{
                    ...
                    _event:{
                        ...
                        initSceneData:function(){
                            this.visible = true;
                            var huXi = UpdateHuXi_YuanJiangGuiHuZi(0);
                            if(!IsArrowVisible_YuanJiangGuiHuZi()){
                                huXi = 0;
                                this.visible = false;
                            }
                ...
                timeImg:{
                    ...
                    _event:{
                        initSceneData: function(eD) {
                            //this.visible = curPlayerIsMe_YuanJiangGuiHuZi(0);
                        },
                        onlinePlayer: function(eD) {
                            //this.visible = curPlayerIsMe_YuanJiangGuiHuZi(0) && IsArrowVisible_YuanJiangGuiHuZi();
                        },
                        waitPut: function(eD) {
                            //this.visible = curPlayerIsMe_YuanJiangGuiHuZi(0);
                        },
                    ...
                    time:{
                        ...
                        _event: {
                            ...
                            onlinePlayer: function(){
                                ...
                                if(pl && pl.onLine && curPlayerIsMe_YuanJiangGuiHuZi(0)){
                                    arrowbkNumberUpdate(this);
                                }
                            },
                            roundEnd: function() {
            ...
            ready: {
                ...
                _run: function() {
                    GetReadyVisible_YuanJiangGuiHuZi(this, 0);
                },
                _event: {
                    startShuffleCards:function () {
                        GetReadyVisible_YuanJiangGuiHuZi(this, 0);
                    ...
                    moveHead: function() {
                        GetReadyVisible_YuanJiangGuiHuZi(this, -1);
                    },
                    addPlayer: function() {
                        GetReadyVisible_YuanJiangGuiHuZi(this, 0);//根据状态设置ready 是否可见 add by sking
                    },
                    removePlayer: function() {
                        GetReadyVisible_YuanJiangGuiHuZi(this, 0);
                    },
            ...
            handNode: {
                ...
                _event:  {
                    initSceneData: function() {
                        calculateHintPutList_YuanJiangGuiHuZi();
                    },
                    mjhand:function () {
                        calculateHintPutList_YuanJiangGuiHuZi();
                    },
                    ...
                    MJPass: function() { // 天胡 提 偎 跑后过胡
                        calculateHintPutList_YuanJiangGuiHuZi();
                        addTingSign_YuanJiangGuiHuZi(MjClient.playui._downNode);
                    },
            ...
            put: {
                ...
                _event:{
                    MJPut: function(eD) {
                        this.loadTexture("playing/paohuzi/mopai_bj_new.png");
                    },
                    HZNewCard: function(eD){
            ...
            _event: {
                clearCardUI: function() {
                    clearCardUI_YuanJiangGuiHuZi(this, 0);
                },
                ...
                initSceneData: function(eD) {
                    SetUserVisible_YuanJiangGuiHuZi(this, 0);
                    InitUserHandUI_YuanJiangGuiHuZi(this, 0);
                    InitUserCoinAndName_YuanJiangGuiHuZi(this, 0);
                    MjClient.hasPut = false; // 重连回来重置打掉牌标志（打牌时候断线)
                    ShowPutCardIcon_YuanJiangGuiHuZi();
                    DealOffLineCard_YuanJiangGuiHuZi(this,0);
                    resetHandAfterBegin_YuanJiangGuiHuZi();
                },
                addPlayer: function(eD) {
                    SetUserVisible_YuanJiangGuiHuZi(this, 0);
                    InitUserCoinAndName_YuanJiangGuiHuZi(this, 0);
                ...
                mjhand: function(eD) {
                    ...
                    var uid = getUIPlayer_YuanJiangGuiHuZi(0).info.uid;
                    if (eD.jiazhuNums)
                    {
                ...
                HZNewCard: function(eD) {
                    ...
                    DealNewCard_YuanJiangGuiHuZi(this,eD,0);
                },
                MJPassWei:function(eD){
                    DealPassWeiCard(this,eD,0);
                },
                MJPut: function(eD) {
                    DealPutCard_YuanJiangGuiHuZi(this,eD,0);
                },
                HZChiCard: function(eD) {
                    DealChiCard_YuanJiangGuiHuZi(this, eD, 0);
                    ShowPutCardIcon_YuanJiangGuiHuZi();
                },
                HZWeiCard: function(eD){
                    DealWeiCard_YuanJiangGuiHuZi(this,eD,0);
                },
                HZLiuCard: function(eD) {
                    DealGangCard_YuanJiangGuiHuZi(this, eD, 0);
                },
                MJPeng: function(eD) {
                    DealPengCard_YuanJiangGuiHuZi(this, eD, 0);
                    ShowPutCardIcon_YuanJiangGuiHuZi();
                },
                MJHu: function(eD) {
                    DealHu_YuanJiangGuiHuZi(this, eD, 0);
                },
                onlinePlayer: function(eD) {
                    resetHandAfterBegin_YuanJiangGuiHuZi();
                    setUserOffline_YuanJiangGuiHuZi(this, 0);
                },
                ...
                MJJiazhu: function(msg) {
                    ...
                    MjClient.majiang.setJiaZhuNum(MjClient.playui._downNode, getUIPlayer_YuanJiangGuiHuZi(0));
                    MjClient.majiang.setJiaZhuNum(MjClient.playui._rightNode, getUIPlayer_YuanJiangGuiHuZi(1));
                    MjClient.majiang.setJiaZhuNum(MjClient.playui._topNode, getUIPlayer_YuanJiangGuiHuZi(2));
                },
                ...
                HZAddCards:function (eD) {
                    DealAddCard_YuanJiangGuiHuZi(this,eD, 0);
                },
        ...
        xing: {
            _run:function () {
                if(MjClient.MaxPlayerNum_YuanJiangGuiHuZi == 3 || MjClient.MaxPlayerNum_YuanJiangGuiHuZi == 2){
                    this.setVisible(false);
                }
            },
            head: {
                    ...
                    _event:{
                        initSceneData:function () {
                            if(MjClient.MaxPlayerNum_YuanJiangGuiHuZi == 4) {
                                setSiShou_YuanJiangGuiHuZi(this, 1);
                            }
                        },
                        MJPeng: function(eD) {
                            if(MjClient.MaxPlayerNum_YuanJiangGuiHuZi == 4) {
                ...
                zhuang: {
                    ...
                    _event: {
                        waitPut: function() {
                            if(MjClient.MaxPlayerNum_YuanJiangGuiHuZi == 4) {
                                showUserZhuangLogo_YuanJiangGuiHuZi(this, 1);
                            }
                        },
                        initSceneData: function() {
                            if(MjClient.MaxPlayerNum_YuanJiangGuiHuZi == 4) {
                                if (IsArrowVisible_YuanJiangGuiHuZi()) showUserZhuangLogo_YuanJiangGuiHuZi(this, 1);
                            }
                        },
                        mjhand: function(){
                            if(MjClient.MaxPlayerNum_YuanJiangGuiHuZi == 4) {
                ...
                chatbg: {
                    ...
                    chattext: {
                        _event: {
                            MJChat: function(msg) {
                                if(MjClient.MaxPlayerNum_YuanJiangGuiHuZi == 4) {
                                    showUserChat_YuanJiangGuiHuZi(this, 1, msg);
                                }
                            },
                            playVoice: function(voicePath) {
                                if(MjClient.MaxPlayerNum_YuanJiangGuiHuZi == 4) {
                                    MjClient.data._tempMessage.msg = voicePath;
                                    showUserChat_YuanJiangGuiHuZi(this, 1, MjClient.data._tempMessage);
                                }
                            }
                        }
                    }
                ...
                _click: function(btn) {
                    if(MjClient.MaxPlayerNum_YuanJiangGuiHuZi == 4) {
                        showPlayerInfo_YuanJiangGuiHuZi(1, btn);
                    }
                },
                _event: {
                    loadWxHead: function(d) {
                        if(MjClient.MaxPlayerNum_YuanJiangGuiHuZi == 4) {
                            setWxHead_YuanJiangGuiHuZi(this, d, 1);
                        }
                    },
                    addPlayer: function(eD) {
                        if(MjClient.MaxPlayerNum_YuanJiangGuiHuZi == 4) {
                            showFangzhuTagIcon_YuanJiangGuiHuZi(this, 1);
                        }
                    },
                    removePlayer: function(eD) {
                        if(MjClient.MaxPlayerNum_YuanJiangGuiHuZi == 4) {
                ...
                huxi:{
                    ...
                    _event:{
                        ...
                        initSceneData:function(){
                            if(MjClient.MaxPlayerNum_YuanJiangGuiHuZi == 4) {
                                // this.visible = true;
                                var huXi = UpdateHuXi_YuanJiangGuiHuZi(1);
                                if (!IsArrowVisible_YuanJiangGuiHuZi()) {
                                    huXi = 0;
                                }
                ...
                timeImg:{
                    ...
                    _event:{
                        initSceneData: function(eD) {
                            if(MjClient.MaxPlayerNum_YuanJiangGuiHuZi == 4) {
                                //this.visible = curPlayerIsMe_YuanJiangGuiHuZi(1);
                            }
                            // MjClient.playui.refreshHeadLight(true);
                        },
                        onlinePlayer: function(eD) {
                            if(MjClient.MaxPlayerNum_YuanJiangGuiHuZi == 4) {
                                //this.visible = curPlayerIsMe_YuanJiangGuiHuZi(1) && IsArrowVisible_YuanJiangGuiHuZi();
                            }
                        },
                        waitPut: function(eD) {
                            if(MjClient.MaxPlayerNum_YuanJiangGuiHuZi == 4) {
                        ...
                        _event: {
                            initSceneData: function(eD) {
                                if(MjClient.MaxPlayerNum_YuanJiangGuiHuZi == 4) {
                                    ...
                                    stopEffect(playTimeUpEff);
                                    playTimeUpEff = null;
                                    if (curPlayerIsMe_YuanJiangGuiHuZi(1)) {
                                        arrowbkNumberUpdate(this);
                                        this.setString("0");
                                    }
                                }
                            ...
                            onlinePlayer: function(){
                                if(MjClient.MaxPlayerNum_YuanJiangGuiHuZi == 4) {
                                    ...
                                    stopEffect(playTimeUpEff);
                                    playTimeUpEff = null;
                                    var pl = getUIPlayer_YuanJiangGuiHuZi(1);
                                    if (pl && pl.onLine && curPlayerIsMe_YuanJiangGuiHuZi(1)) {
                                        arrowbkNumberUpdate(this);
                                    }
                                }
                            },
            ...
            _event: {
                clearCardUI: function() {
                    if(MjClient.MaxPlayerNum_YuanJiangGuiHuZi == 4) {
                        clearCardUI_YuanJiangGuiHuZi(this, 1);
                    }
                },
                clearCardArr: function(){
                    if(MjClient.MaxPlayerNum_YuanJiangGuiHuZi == 4) {
                ...
                initSceneData: function(eD) {
                    if(MjClient.MaxPlayerNum_YuanJiangGuiHuZi == 4) {
                        SetUserVisible_YuanJiangGuiHuZi(this, 1);
                        InitUserHandUI_YuanJiangGuiHuZi(this, 1);
                        InitUserCoinAndName_YuanJiangGuiHuZi(this, 1);
                        DealOffLineCard_YuanJiangGuiHuZi(this, 1);
                    }
                },
                addPlayer: function(eD) {
                    if(MjClient.MaxPlayerNum_YuanJiangGuiHuZi == 4) {
                ...
                HZNewCard: function(eD) {
                    if(MjClient.MaxPlayerNum_YuanJiangGuiHuZi == 4) {
                        ...
                        DealNewCard_YuanJiangGuiHuZi(this, eD, 1);
                    }
                },
                roundEnd: function() {
                    if(MjClient.MaxPlayerNum_YuanJiangGuiHuZi == 4) {
                ...
                MJPut: function(eD) {
                    if(MjClient.MaxPlayerNum_YuanJiangGuiHuZi == 4) {
                        DealPutCard_YuanJiangGuiHuZi(this, eD, 1);
                    }
                },
                HZChiCard: function(eD) {
                    if(MjClient.MaxPlayerNum_YuanJiangGuiHuZi == 4) {
                        DealChiCard_YuanJiangGuiHuZi(this, eD, 1);
                    }
                },
                HZLiuCard: function(eD) {
                    if(MjClient.MaxPlayerNum_YuanJiangGuiHuZi == 4) {
                        DealGangCard_YuanJiangGuiHuZi(this, eD, 1);
                    }
                },
                MJPeng: function(eD) {
                    if(MjClient.MaxPlayerNum_YuanJiangGuiHuZi == 4) {
                        DealPengCard_YuanJiangGuiHuZi(this, eD, 1);
                    }
                },
                MJPassWei:function(eD){
                    DealPassWeiCard(this,eD,1);
                },
                HZWeiCard: function(eD){
                    if(MjClient.MaxPlayerNum_YuanJiangGuiHuZi == 4) {
                        DealWeiCard_YuanJiangGuiHuZi(this, eD, 1);
                    }
                },
                MJHu: function(eD) {
                    if(MjClient.MaxPlayerNum_YuanJiangGuiHuZi == 4) {
                        DealHu_YuanJiangGuiHuZi(this, eD, 1);
                    }
                },
                onlinePlayer: function(eD) {
                    if(MjClient.MaxPlayerNum_YuanJiangGuiHuZi == 4) {
                        setUserOffline_YuanJiangGuiHuZi(this, 1);
                    }
                },
                playerStatusChange: function(eD) {
                    if(MjClient.MaxPlayerNum_YuanJiangGuiHuZi == 4) {
                ...
                HZAddCards:function (eD) {
                    if(MjClient.MaxPlayerNum_YuanJiangGuiHuZi == 4) {
                        DealAddCard_YuanJiangGuiHuZi(this, eD, 1);
                    }
                },
                HZCheckRaise:function (msg) {
                    if(MjClient.MaxPlayerNum_YuanJiangGuiHuZi == 4) {
        ...
        right: {
            ...
            head: {
                siShou:{
                    ...
                    _event:{
                        initSceneData:function () {
                            setSiShou_YuanJiangGuiHuZi(this, MjClient.MaxPlayerNum_YuanJiangGuiHuZi - 2);
                        },
                        MJPeng: function(eD) {
                            setSiShou_YuanJiangGuiHuZi(this, MjClient.MaxPlayerNum_YuanJiangGuiHuZi - 2);
                        },
                ...
                zhuang: {
                    ...
                    _event: {
                        waitPut: function() {
                            showUserZhuangLogo_YuanJiangGuiHuZi(this, MjClient.MaxPlayerNum_YuanJiangGuiHuZi - 2);
                        },
                        initSceneData: function() {
                            if (IsArrowVisible_YuanJiangGuiHuZi()) showUserZhuangLogo_YuanJiangGuiHuZi(this, MjClient.MaxPlayerNum_YuanJiangGuiHuZi - 2);
                        },
                        mjhand: function(){
                            if (IsArrowVisible_YuanJiangGuiHuZi()) showUserZhuangLogo_YuanJiangGuiHuZi(this, MjClient.MaxPlayerNum_YuanJiangGuiHuZi - 2);
                        }
                ...
                chatbg: {
                    ...
                    chattext: {
                        _event: {
                            MJChat: function(msg) {
                                showUserChat_YuanJiangGuiHuZi(this, MjClient.MaxPlayerNum_YuanJiangGuiHuZi - 2, msg);
                            },
                            playVoice: function(voicePath) {
                                MjClient.data._tempMessage.msg = voicePath;
                                showUserChat_YuanJiangGuiHuZi(this, MjClient.MaxPlayerNum_YuanJiangGuiHuZi - 2, MjClient.data._tempMessage);
                            }
                        }
                    }
                },
                _click: function(btn) {
                    showPlayerInfo_YuanJiangGuiHuZi(MjClient.MaxPlayerNum_YuanJiangGuiHuZi - 2, btn);
                },
                _event: {
                    loadWxHead: function(d) {
                        setWxHead_YuanJiangGuiHuZi(this, d, MjClient.MaxPlayerNum_YuanJiangGuiHuZi - 2);
                    },
                    addPlayer: function(eD) {
                        showFangzhuTagIcon_YuanJiangGuiHuZi(this,MjClient.MaxPlayerNum_YuanJiangGuiHuZi - 2);
                    },
                    removePlayer: function(eD) {
                        showFangzhuTagIcon_YuanJiangGuiHuZi(this,MjClient.MaxPlayerNum_YuanJiangGuiHuZi - 2);
                    }
                ...
                huxi:{
                    ...
                    _event:{
                        ...
                        initSceneData:function(){
                            this.visible = true;
                            var huXi = UpdateHuXi_YuanJiangGuiHuZi(MjClient.MaxPlayerNum_YuanJiangGuiHuZi - 2);
                            if(!IsArrowVisible_YuanJiangGuiHuZi()){
                                huXi = 0;
                                this.visible = false;
                            }
                ...
                timeImg:{
                    ...
                    _event:{
                        initSceneData: function(eD) {
                            //this.visible = curPlayerIsMe_YuanJiangGuiHuZi(MjClient.MaxPlayerNum_YuanJiangGuiHuZi - 2);
                        },
                        onlinePlayer: function(eD) {
                            //this.visible = curPlayerIsMe_YuanJiangGuiHuZi(MjClient.MaxPlayerNum_YuanJiangGuiHuZi - 2) && IsArrowVisible_YuanJiangGuiHuZi();
                        },
                        waitPut: function(eD) {
                            //this.visible = curPlayerIsMe_YuanJiangGuiHuZi(MjClient.MaxPlayerNum_YuanJiangGuiHuZi - 2);
                        },
                    ...
                    time:{
                        ...
                        _event: {
                            initSceneData: function(eD) {
                                ...
                                stopEffect(playTimeUpEff);
                                playTimeUpEff = null;
                                if(curPlayerIsMe_YuanJiangGuiHuZi(MjClient.MaxPlayerNum_YuanJiangGuiHuZi - 2)){
                                    arrowbkNumberUpdate(this);
                                    this.setString("0");
                                }
                            },
                            ...
                            onlinePlayer: function(){
                                ...
                                stopEffect(playTimeUpEff);
                                playTimeUpEff = null;
                                var pl = getUIPlayer_YuanJiangGuiHuZi(MjClient.MaxPlayerNum_YuanJiangGuiHuZi - 2);
                                if(pl && pl.onLine && curPlayerIsMe_YuanJiangGuiHuZi(MjClient.MaxPlayerNum_YuanJiangGuiHuZi - 2)){
                                    arrowbkNumberUpdate(this);
                                }
                            },
                            roundEnd: function() {
            ...
            ready: {
                _layout: [[0.07, 0.07],[0.5, 0.5],[2.5, 2.5]],
                _run: function() {
                    GetReadyVisible_YuanJiangGuiHuZi(this, MjClient.MaxPlayerNum_YuanJiangGuiHuZi - 2);
                },
                _event: {
                    startShuffleCards:function () {
                        GetReadyVisible_YuanJiangGuiHuZi(this, MjClient.MaxPlayerNum_YuanJiangGuiHuZi - 2);
            ...
            _event: {
                clearCardUI: function() {
                    clearCardUI_YuanJiangGuiHuZi(this, MjClient.MaxPlayerNum_YuanJiangGuiHuZi - 2);
                },
                clearCardArr: function(){
                    var eatNode = this.getChildByName("eatNode");
                    eatNode.removeAllChildren();
                ...
                initSceneData: function(eD) {
                    SetUserVisible_YuanJiangGuiHuZi(this, MjClient.MaxPlayerNum_YuanJiangGuiHuZi - 2);
                    InitUserHandUI_YuanJiangGuiHuZi(this, MjClient.MaxPlayerNum_YuanJiangGuiHuZi - 2);
                    InitUserCoinAndName_YuanJiangGuiHuZi(this, MjClient.MaxPlayerNum_YuanJiangGuiHuZi - 2);
                    DealOffLineCard_YuanJiangGuiHuZi(this,MjClient.MaxPlayerNum_YuanJiangGuiHuZi - 2);
                },
                addPlayer: function(eD) {
                    SetUserVisible_YuanJiangGuiHuZi(this, MjClient.MaxPlayerNum_YuanJiangGuiHuZi - 2);
                    InitUserCoinAndName_YuanJiangGuiHuZi(this, MjClient.MaxPlayerNum_YuanJiangGuiHuZi - 2);
                ...
                HZNewCard: function(eD) {
                    ...
                    DealNewCard_YuanJiangGuiHuZi(this,eD,MjClient.MaxPlayerNum_YuanJiangGuiHuZi - 2);
                },
                roundEnd: function() {
                    InitUserCoinAndName_YuanJiangGuiHuZi(this, MjClient.MaxPlayerNum_YuanJiangGuiHuZi - 2);
                    MjClient.playui.ResetOtherCard(this, MjClient.MaxPlayerNum_YuanJiangGuiHuZi - 2);
                },
                waitPut: function(eD) {
                    //DealWaitPut(this, eD, MjClient.MaxPlayerNum_YuanJiangGuiHuZi - 2);
                },
                MJPut: function(eD) {
                    DealPutCard_YuanJiangGuiHuZi(this, eD, MjClient.MaxPlayerNum_YuanJiangGuiHuZi - 2);
                },
                HZChiCard: function(eD) {
                    DealChiCard_YuanJiangGuiHuZi(this, eD, MjClient.MaxPlayerNum_YuanJiangGuiHuZi - 2);
                },
                MJPassWei:function(eD){
                    DealPassWeiCard(this,eD,MjClient.MaxPlayerNum_YuanJiangGuiHuZi - 2);
                },
                HZLiuCard: function(eD) {
                    DealGangCard_YuanJiangGuiHuZi(this, eD, MjClient.MaxPlayerNum_YuanJiangGuiHuZi - 2);
                },
                MJPeng: function(eD) {
                    DealPengCard_YuanJiangGuiHuZi(this, eD, MjClient.MaxPlayerNum_YuanJiangGuiHuZi - 2);
                },
                HZWeiCard: function(eD){
                    DealWeiCard_YuanJiangGuiHuZi(this, eD, MjClient.MaxPlayerNum_YuanJiangGuiHuZi - 2);
                },
                MJHu: function(eD) {
                    DealHu_YuanJiangGuiHuZi(this, eD, MjClient.MaxPlayerNum_YuanJiangGuiHuZi - 2);
                },
                onlinePlayer: function(eD) {
                    setUserOffline_YuanJiangGuiHuZi(this, MjClient.MaxPlayerNum_YuanJiangGuiHuZi - 2);
                },
                playerStatusChange: function(eD) {
                    setUserOffline_YuanJiangGuiHuZi(this, MjClient.MaxPlayerNum_YuanJiangGuiHuZi - 2);
                },
                MJFlower: function(eD) {
                    HandleMJFlower(this, eD, MjClient.MaxPlayerNum_YuanJiangGuiHuZi - 2);
                },
                MJTing: function (eD) {
                    HandleMJTing(this, eD, MjClient.MaxPlayerNum_YuanJiangGuiHuZi - 2);
                },
                waitJiazhu:function (msg) {
                    postEvent("returnPlayerLayer");
                    /*
                ...
                HZPickCard:function (eD) {
                    if(MjClient.rePlayVideo != -1){
                        var pl = getUIPlayer_YuanJiangGuiHuZi(MjClient.MaxPlayerNum_YuanJiangGuiHuZi - 2);
                        if(eD.uid == pl.info.uid) {
                            MjClient.OtherHandArr[MjClient.MaxPlayerNum_YuanJiangGuiHuZi - 2] = MjClient.majiang.sortCard3(pl.mjhand, 2)
                        }
                    }

                    RemovePutCardOut_YuanJiangGuiHuZi(true);
                    MjClient.playui.ResetHandCard(this,MjClient.MaxPlayerNum_YuanJiangGuiHuZi - 2);
                },
                HZAddCards:function (eD) {
                    DealAddCard_YuanJiangGuiHuZi(this,eD, MjClient.MaxPlayerNum_YuanJiangGuiHuZi - 2);
                },
                HZCheckRaise:function (msg) {
                    ShowPutCardIcon_YuanJiangGuiHuZi();
                    //MjClient.playui.EatVisibleCheck();
        ...
        left: {
            head: {
                siShou:{
                    ...
                    _event:{
                        initSceneData:function () {
                            setSiShou_YuanJiangGuiHuZi(this, MjClient.MaxPlayerNum_YuanJiangGuiHuZi - 1);
                        },
                        MJPeng: function(eD) {
                            setSiShou_YuanJiangGuiHuZi(this, MjClient.MaxPlayerNum_YuanJiangGuiHuZi - 1);
                        },
                ...
                zhuang: {
                    ...
                    _event: {
                        waitPut: function() {
                            showUserZhuangLogo_YuanJiangGuiHuZi(this, MjClient.MaxPlayerNum_YuanJiangGuiHuZi - 1);
                        },
                        initSceneData: function() {
                            if (IsArrowVisible_YuanJiangGuiHuZi()) showUserZhuangLogo_YuanJiangGuiHuZi(this, MjClient.MaxPlayerNum_YuanJiangGuiHuZi - 1);
                        },
                        mjhand: function(){
                            if (IsArrowVisible_YuanJiangGuiHuZi()) showUserZhuangLogo_YuanJiangGuiHuZi(this, MjClient.MaxPlayerNum_YuanJiangGuiHuZi - 1);
                        }
                ...
                chatbg: {
                    ...
                    chattext: {
                        _event: {
                            MJChat: function(msg) {
                                showUserChat_YuanJiangGuiHuZi(this, MjClient.MaxPlayerNum_YuanJiangGuiHuZi - 1, msg);
                            },
                            playVoice: function(voicePath) {
                                MjClient.data._tempMessage.msg = voicePath;
                                showUserChat_YuanJiangGuiHuZi(this, MjClient.MaxPlayerNum_YuanJiangGuiHuZi - 1, MjClient.data._tempMessage);
                            }
                        }
                    }
                },
                _click: function(btn) {
                    showPlayerInfo_YuanJiangGuiHuZi(MjClient.MaxPlayerNum_YuanJiangGuiHuZi - 1, btn);
                },
                _event: {
                    loadWxHead: function(d) {
                        setWxHead_YuanJiangGuiHuZi(this, d, MjClient.MaxPlayerNum_YuanJiangGuiHuZi - 1);
                    },
                    addPlayer: function(eD) {
                        showFangzhuTagIcon_YuanJiangGuiHuZi(this,MjClient.MaxPlayerNum_YuanJiangGuiHuZi - 1);
                    },
                    removePlayer: function(eD) {
                        showFangzhuTagIcon_YuanJiangGuiHuZi(this,MjClient.MaxPlayerNum_YuanJiangGuiHuZi - 1);
                    }
                ...
                huxi:{
                    ...
                    _event:{
                        ...
                        initSceneData:function(){
                            this.visible = true;
                            var huXi = UpdateHuXi_YuanJiangGuiHuZi(MjClient.MaxPlayerNum_YuanJiangGuiHuZi - 1);
                            if(!IsArrowVisible_YuanJiangGuiHuZi()){
                                huXi = 0;
                                this.visible = false;
                            }
                ...
                timeImg:{
                    ...
                    _event:{
                        initSceneData: function(eD) {
                            //this.visible = curPlayerIsMe_YuanJiangGuiHuZi(MjClient.MaxPlayerNum_YuanJiangGuiHuZi - 1);
                        },
                        onlinePlayer: function(eD) {
                            //this.visible = curPlayerIsMe_YuanJiangGuiHuZi(MjClient.MaxPlayerNum_YuanJiangGuiHuZi - 1) && IsArrowVisible_YuanJiangGuiHuZi();
                        },
                        waitPut: function(eD) {
                            //this.visible = curPlayerIsMe_YuanJiangGuiHuZi(MjClient.MaxPlayerNum_YuanJiangGuiHuZi - 1);
                        },
                    ...
                    time:{
                        ...
                        _event: {
                            initSceneData: function(eD) {
                                ...
                                stopEffect(playTimeUpEff);
                                playTimeUpEff = null;
                                if(curPlayerIsMe_YuanJiangGuiHuZi(MjClient.MaxPlayerNum_YuanJiangGuiHuZi - 1)){
                                    arrowbkNumberUpdate(this);
                                    this.setString("0");
                                }
                            },
                            ...
                            onlinePlayer: function(){
                                ...
                                stopEffect(playTimeUpEff);
                                playTimeUpEff = null;
                                var pl = getUIPlayer_YuanJiangGuiHuZi(MjClient.MaxPlayerNum_YuanJiangGuiHuZi - 1);
                                if(pl && pl.onLine && curPlayerIsMe_YuanJiangGuiHuZi(MjClient.MaxPlayerNum_YuanJiangGuiHuZi - 1)){
                                    arrowbkNumberUpdate(this);
                                }
                            },
                            roundEnd: function() {
            ...
            ready: {
                _layout: [[0.07, 0.07],[0.5, 0.5],[-2.5, 2.5]],
                _run: function() {
                    GetReadyVisible_YuanJiangGuiHuZi(this, MjClient.MaxPlayerNum_YuanJiangGuiHuZi - 1);
                },
                _event: {
                    startShuffleCards:function () {
                        GetReadyVisible_YuanJiangGuiHuZi(this, MjClient.MaxPlayerNum_YuanJiangGuiHuZi - 1);
            ...
            _event: {
                clearCardUI: function() {
                    clearCardUI_YuanJiangGuiHuZi(this, MjClient.MaxPlayerNum_YuanJiangGuiHuZi - 1);
                },
                clearCardArr: function(){
                    var eatNode = this.getChildByName("eatNode");
                    eatNode.removeAllChildren();
                ...
                initSceneData: function(eD) {
                    SetUserVisible_YuanJiangGuiHuZi(this, MjClient.MaxPlayerNum_YuanJiangGuiHuZi - 1);
                    InitUserHandUI_YuanJiangGuiHuZi(this, MjClient.MaxPlayerNum_YuanJiangGuiHuZi - 1);
                    InitUserCoinAndName_YuanJiangGuiHuZi(this, MjClient.MaxPlayerNum_YuanJiangGuiHuZi - 1);
                    DealOffLineCard_YuanJiangGuiHuZi(this,MjClient.MaxPlayerNum_YuanJiangGuiHuZi - 1);
                },
                addPlayer: function(eD) {
                    SetUserVisible_YuanJiangGuiHuZi(this, MjClient.MaxPlayerNum_YuanJiangGuiHuZi - 1);
                    InitUserCoinAndName_YuanJiangGuiHuZi(this, MjClient.MaxPlayerNum_YuanJiangGuiHuZi - 1);
                ...
                HZNewCard: function(eD) {
                    ...
                    DealNewCard_YuanJiangGuiHuZi(this,eD,MjClient.MaxPlayerNum_YuanJiangGuiHuZi - 1);
                },
                MJPassWei:function(eD){
                    DealPassWeiCard(this,eD,MjClient.MaxPlayerNum_YuanJiangGuiHuZi - 1);
                },
                roundEnd: function() {
                    InitUserCoinAndName_YuanJiangGuiHuZi(this, MjClient.MaxPlayerNum_YuanJiangGuiHuZi - 1);
                    MjClient.playui.ResetOtherCard(this, MjClient.MaxPlayerNum_YuanJiangGuiHuZi - 1);
                },
                waitPut: function(eD) {
                    //DealWaitPut(this, eD, MjClient.MaxPlayerNum_YuanJiangGuiHuZi - 1);
                },
                MJPut: function(eD) {
                    DealPutCard_YuanJiangGuiHuZi(this, eD, MjClient.MaxPlayerNum_YuanJiangGuiHuZi - 1);
                },
                HZChiCard: function(eD) {
                    DealChiCard_YuanJiangGuiHuZi(this, eD, MjClient.MaxPlayerNum_YuanJiangGuiHuZi - 1);
                },
                HZPaoCard: function(eD) {
                    DealPaoCard_YuanJiangGuiHuZi(this, eD, MjClient.MaxPlayerNum_YuanJiangGuiHuZi - 1);
                },
                HZLiuCard: function(eD) {
                    DealGangCard_YuanJiangGuiHuZi(this, eD, MjClient.MaxPlayerNum_YuanJiangGuiHuZi - 1);
                },
                MJPeng: function(eD) {
                    DealPengCard_YuanJiangGuiHuZi(this, eD, MjClient.MaxPlayerNum_YuanJiangGuiHuZi - 1);
                },
                HZWeiCard: function(eD){
                    DealWeiCard_YuanJiangGuiHuZi(this, eD, MjClient.MaxPlayerNum_YuanJiangGuiHuZi - 1);
                },
                MJHu: function(eD) {
                    DealHu_YuanJiangGuiHuZi(this, eD, MjClient.MaxPlayerNum_YuanJiangGuiHuZi - 1);
                },
                onlinePlayer: function(eD) {
                    setUserOffline_YuanJiangGuiHuZi(this, MjClient.MaxPlayerNum_YuanJiangGuiHuZi - 1);
                },
                playerStatusChange: function(eD) {
                    setUserOffline_YuanJiangGuiHuZi(this, MjClient.MaxPlayerNum_YuanJiangGuiHuZi - 1);
                },
                MJFlower: function(eD) {
                    HandleMJFlower(this, eD, MjClient.MaxPlayerNum_YuanJiangGuiHuZi - 1);
                },
                MJTing: function (eD) {
                    HandleMJTing(this, eD, MjClient.MaxPlayerNum_YuanJiangGuiHuZi - 1);
                },
                HZPickCard:function (eD) {
                    if(MjClient.rePlayVideo != -1) {
                        var pl = getUIPlayer_YuanJiangGuiHuZi(MjClient.MaxPlayerNum_YuanJiangGuiHuZi - 1);
                        if(eD.uid == pl.info.uid){
                            MjClient.OtherHandArr[MjClient.MaxPlayerNum_YuanJiangGuiHuZi - 1] = MjClient.majiang.sortCard3(pl.mjhand, 2)
                        }
                    }
                    RemovePutCardOut_YuanJiangGuiHuZi(true);
                    MjClient.playui.ResetHandCard(this,MjClient.MaxPlayerNum_YuanJiangGuiHuZi - 1);
                },
                HZAddCards:function (eD) {
                    DealAddCard_YuanJiangGuiHuZi(this,eD, MjClient.MaxPlayerNum_YuanJiangGuiHuZi - 1);
                },
                HZCheckRaise:function (msg) {
                    ShowPutCardIcon_YuanJiangGuiHuZi();
                    //MjClient.playui.EatVisibleCheck();
        ...
        eat: {
                ...
                _touch: function(btn, eT) {
                    if (eT == 2){
                        ...
                        if(ziPai.getHasFastEat()){
                            ...
                            if (chiList.length == 1) {
                                commitEatCards_YuanJiangGuiHuZi(chiList[0], null);
                                return;
                            }
                        }
                        
                        showSelectEatCards_YuanJiangGuiHuZi(this,btn.tag);
                        ...
                        // MJChiCardchange_YuanJiangGuiHuZi();
                    }
                }
            },
            noTing : {
                    ...
                    if (eT == 2){
                        if ((MjClient.data.sData.players[SelfUid()].eatFlag & 32) > 0) {
                            MjClient.showMsg("选择碰后视为过胡，确定碰吗？", function() {
                                HZPengToServer_YuanJiangGuiHuZi();
                    ...
                    if (eT == 2){
                        /*if ((MjClient.data.sData.players[SelfUid()].eatFlag & 32) > 0) {
                            MjClient.showMsg("选择歪后视为过胡，确定歪吗？", function() {
                                HZWaiToServer_YuanJiangGuiHuZi();
                                setChiVisible_YuanJiangGuiHuZi();
                            }, function() {}, "1");
                        } else {
                            HZWaiToServer_YuanJiangGuiHuZi();
            ...
            liu:{
                ...
                _touch: function(btn, eT) {
                    ...
                    if (eT == 2){
                        showSelectLiuCards_YuanJiangGuiHuZi(this, 0);
                    }
                }
            },
            piao:{
                ...
                _touch: function(btn, eT) {
                    ...
                    if (eT == 2){
                        if ((MjClient.data.sData.players[SelfUid()].eatFlag & 32) > 0) {
                            MjClient.showMsg("飘牌后视为过胡，确定吃吗？", function() {
                                setChiVisible_YuanJiangGuiHuZi();
                                HZLiuToServer_YuanJiangGuiHuZi(pl.piaoCards[0], 1);
                            }, function() {}, "1");
                        } else {
                            setChiVisible_YuanJiangGuiHuZi();
                            HZLiuToServer_YuanJiangGuiHuZi(pl.piaoCards[0], 1);
            ...
            zha:{
                ...
                _touch: function(btn, eT) {
                    console.log("mdz，点击炸按钮");
                    var pl = MjClient.data.sData.players[SelfUid()];
                    if (eT == 2){
                        setChiVisible_YuanJiangGuiHuZi();
                        HZLiuToServer_YuanJiangGuiHuZi(pl.zhaCards[0], 2);
                    }
                }
            },
            guo: {
                    ...
                    if (eT == 2){
                        if ((MjClient.data.sData.players[SelfUid()].eatFlag & 32) > 0) {
                            MjClient.showMsg("确定过胡吗？", function() {
                                HZPassConfirmToServer_YuanJiangGuiHuZi(); // todo 
                                setChiVisible_YuanJiangGuiHuZi();//add by maoyu
                            }, function() {}, "1");
                        } else {
                            HZPassConfirmToServer_YuanJiangGuiHuZi(); // todo 
                            setChiVisible_YuanJiangGuiHuZi();//add by maoyu
            ...
            cancel: {
                ...
                _touch: function(btn, eT) {
                    if (eT == 2) {
                        ...
                        resetChiParam_YuanJiangGuiHuZi();
                        MjClient.playui.EatVisibleCheck();
            ...
            wangDiao:{
                ...
                _touch: function(btn, eT) {
                    console.log(">>>> lf，点击碰按钮");
                    if (eT == 2) {
                        HZWangChuangToServer_YuanJiangGuiHuZi(1);
                        setChiVisible_YuanJiangGuiHuZi();//add by maoyu
                    }
                }
            },
            wangChuang:{
                ...
                _touch: function(btn, eT) {
                    console.log(">>>> lf，点击碰按钮");
                    if (eT == 2) {
                        HZWangChuangToServer_YuanJiangGuiHuZi(2);
                        setChiVisible_YuanJiangGuiHuZi();//add by maoyu
                    }
                }
            },
            wangZha:{
                ...
                _touch: function(btn, eT) {
                    console.log(">>>> lf，点击碰按钮");
                    if (eT == 2) {
                        HZWangChuangToServer_YuanJiangGuiHuZi(4);
                        setChiVisible_YuanJiangGuiHuZi();//add by maoyu
                    }
                }
            },
                    ...
                    this.adaptChiLayout = function() {
                        ...
                        if (cards_option.length == 0) { // 吃牌选好了
                            if ((MjClient.data.sData.players[SelfUid()].eatFlag & 32) > 0) {
                                MjClient.showMsg("选择吃后视为过胡，确定吃吗？", function() {
                                    ...
                                    HZChiToServer_YuanJiangGuiHuZi(cards_select[0], biCards);
                                    this.visible = false;
                                }.bind(this), function() {
                                    cards_select.pop();
                                    this.adaptChiLayout();
                        ...
                        for (var i = 0; i < cards_select.length; i++) {
                            ...
                            for (var j = 0; j < row.length; j++) {
                                ...
                                chiCardImg.loadTexture(MjClient.cardPath_YuanJiangGuiHuZi + "out" + row[j] + ".png");
            ...
            _event: {
                ...
                HZNewCard: function(eD) {
                    ...
                    if(eD.isCommon && eD.newCard){
                        MjClient.playui.EatVisibleCheck(eD);
                    }
                },
                MJPassWei:function(){
                    MjClient.playui.EatVisibleCheck();
        ...
        chat_btn: {
            ...
            _click: function() {
                ...
                // MjClient.Scene.addChild(new EndOneView_YuanJiangGuiHuZi(),500);
                // MjClient.Scene.addChild(new GameOverLayer_YuanJiangGuiHuZi(),500);
            }
        },
        voice_btn: {
            ...
            _event: {
                ...
                downAndPlayVoice: function(msg) {
                    ...
                    // downAndPlayVoice_YuanJiangGuiHuZi(msg.uid, msg.msg);
    ...
    ctor: function() {
        this._super();
        ziPai.initZiPaiData();
        var playui = ccs.load("Play_yuanJiangGuiHuZi.json");
        playMusic("bgHongZi");
        var tData = MjClient.data.sData.tData;
        MjClient.MaxPlayerNum_YuanJiangGuiHuZi = tData.maxPlayer;
        cc.log(MjClient.MaxPlayerNum_YuanJiangGuiHuZi);
        ...
        this.newTingLayer = new YuanJiangGuiHuZiNewTingLayer();
        playui.node.addChild(this.newTingLayer);

        this.tingLayer = new YuanJiangGuiHuZiPhzTingLayer();
    ...
    resetJiaZhuTip: function()
    {
        ...
        for (var i = 0; i < MjClient.MaxPlayerNum_YuanJiangGuiHuZi; i ++)
        {
...
//重置手牌的顺序
PlayLayer_YuanJiangGuiHuZi.prototype.ResetHandCard = function(posNode,off, needAction, isDelay){
    ...
    if(MjClient.rePlayVideo == -1){
        if(off == 0) {
            ...
            checkCard_YuanJiangGuiHuZi(posNode, off);
            // if(!needAction && !isDelay && MjClient.addGroupIndex != 0){
            //     refreshNode_YuanJiangGuiHuZi(posNode,off,needAction);
            //
            ...
            cleanCardNode_YuanJiangGuiHuZi(off);
            handNode.removeAllChildren();
            ...
            for (var k = 0; k < cardArr.length; k++) {
                ...
                for (var j = 0; j < groupList.length; j++) {
                    addOrAdjustHandCard_YuanJiangGuiHuZi(k, j, groupList[j], off);
                }
            }
            resetCardNode_YuanJiangGuiHuZi(off)
            addTingSign_YuanJiangGuiHuZi(posNode); // 添加听牌角标
            ...
            for (var i = 0; i < cardArr.length; i++) {
                ...
                if(addNode.lastPosition){
                    ...
                    doMovetoAction(addNode, cc.p((winSize.width - totalWidth) / 2 + i * width * scale_x, 0));
                } else {
                    addNode.setPosition(cc.p((winSize.width - totalWidth) / 2 + i * width * scale_x, 0));
                }
            }
        ...
        //if(MjClient.movingCard_YuanJiangGuiHuZi && MjClient.movingCard_YuanJiangGuiHuZi.getParent()){
        //    MjClient.movingCard_YuanJiangGuiHuZi.removeFromParent(true);
        ...
        for(var k = 0;k < cardArr.length;k++){
            ...
            for(var j = 0;j < groupList.length;j++){
                if(off == 0){
                    if(MjClient.MaxPlayerNum_YuanJiangGuiHuZi == 3 || MjClient.MaxPlayerNum_YuanJiangGuiHuZi == 2){
                        addHandCard_YuanJiangGuiHuZi(k,j,groupList[j],off);
                    }else if(MjClient.MaxPlayerNum_YuanJiangGuiHuZi == 4){
                        addHandCardReplay_YuanJiangGuiHuZi(k,j,groupList[j],off);
                    }
                }else {
                    addHandCardReplay_YuanJiangGuiHuZi(k,j,groupList[j],off);
                }
        ...
        if(off == 0 && (MjClient.MaxPlayerNum_YuanJiangGuiHuZi == 3 || MjClient.MaxPlayerNum_YuanJiangGuiHuZi == 2)) {
            var type = ziPai.getZiPaiType();
            var sizeArr = [98,84,100,103];
            var width =sizeArr[type] * changeCardSize; // handCard.getVirtualRendererSize().width;
...
PlayLayer_YuanJiangGuiHuZi.prototype._doMovetoAction = function(node,endP){
    node.stopAllActions();
    var ac = cc.moveTo(0.3,endP);
    node.runAction(ac);
};

PlayLayer_YuanJiangGuiHuZi.prototype.ResetOtherCard = function(posNode, off) {
    // 添加吃、碰、跑、偎、提
    var sData = MjClient.data.sData;
    var tData = null;
    if (sData) {
    ...
    if (mjSortArr) {
        ...
        // 提/偎牌的特殊处理
         var callback = function(childList) {
             ...
             for (var i = 0; i < childList.length; i++) {
                 ...
                 // } else {
                 //     child.loadTexture(MjClient.cardPath_YuanJiangGuiHuZi + "huxiBG.png");
                 // }
                 if(tData.areaSelectMode["anWaiLiu"])
                 {
                     if (off == 0)
                     {
                         ...
                         if (i != getShowCardIdx_YuanJiangGuiHuZi(posNode, chiTip)) {
                             child.loadTexture(MjClient.cardPath_YuanJiangGuiHuZi + "huxiBG.png");
                         }
                     } else {
                         child.loadTexture(MjClient.cardPath_YuanJiangGuiHuZi + "huxiBG.png");
         ...
         var callback1 = function(childList, isQiShouLiu) {
             var cardNum = pl.mjwei[pos];
             var skipPeng = pl.skipPeng;
             for (var i = 0; i < childList.length; i++) {
                 var child = childList[i];
        ...
        for (var k = 0; k < mjSortArr.length; k++) {
            ...
            var isQiShouLiu = false;
                //提
             if (name == "mjgang1") {
                 var cardNum = pl.mjgang1[pos];
                 for (var i = 0; i < 4; i++) {
                     addEatCard_YuanJiangGuiHuZi(posNode, "mjgang1" + k, cardNum, off);
                 }
            ...
            if (name == "mjgang2") {
                var cardNum = pl.mjgang2[pos];
                if(tData.qiShouLiuList[pl.info.uid].indexOf(cardNum != -1))
                {
                    isQiShouLiu = true;
                }
                for (var i = 0; i < 4; i++) {
                    addEatCard_YuanJiangGuiHuZi(posNode, "mjgang2" + k, cardNum, off);
                }

                var tiParentNode = eatNode.getChildByName("mjgang2" + k);
                var childArr = tiParentNode.children;
                callback1(childArr, isQiShouLiu);
            }

            if (name == "mjgang3") {
                var cardNum = pl.mjgang3[pos];
                for (var i = 0; i < 4; i++) {
                    addEatCard_YuanJiangGuiHuZi(posNode, "mjgang3" + k, cardNum, off);
                }
            }
            ...
            //偎
             if (name == "mjwei") {
                 var cardNum = pl.mjwei[pos];
                 for (var i = 0; i < 3; i++) {
                     addEatCard_YuanJiangGuiHuZi(posNode, "mjwei" + k, cardNum, off);
                 }
            ...
            if (name == "mjgang0") {
                ...
                for (var i = 0; i < 4; i++) {
                    addEatCard_YuanJiangGuiHuZi(posNode, "mjgang0" + k, cardNum, off);
                }
            ...
            if (name == "mjpeng") {
                ...
                for (var i = 0; i < 3; i++) {
                    addEatCard_YuanJiangGuiHuZi(posNode, "mjpeng" + k, cardNum, off);
                }
            }
            //吃
            if (name == "mjchi") {
                ...
                for (var i = 0; i < eatCards.length; i++) {
                    addEatCard_YuanJiangGuiHuZi(posNode, "mjchi" + k, eatCards[i], off);
                }
                ...
                if (biCards && biCards.length > 0) {
                    for (var i = 0; i < biCards.length; i++) {
                        ...
                        for (var m = 0; m < biArr.length; m++) {
                            addEatCard_YuanJiangGuiHuZi(posNode, "mjbi" + k + i, biArr[m], off);
                        }
                    }
                }
    ...
    //    var outCard = getNewCard_YuanJiangGuiHuZi(pl.mjput[i], 2, off);
    //    if(off == 0){
    //        outCard.anchorX = 1;
    //        outCard.anchorY = 0;
...
PlayLayer_YuanJiangGuiHuZi.prototype.ResetPutCard = function(posNode,off){
    ...
    if(type == 0 && MjClient.data.sData.tData.maxPlayer < 4){
        ...
        for(var i = 0; i < pl.mjput.length; i++){
            ...
            outNode.addChild(outCard);
            addPutFrame_YuanJiangGuiHuZi(outCard, pl.mjputType[i]);
        }
    }else{
        for(var i = 0; i < pl.mjput.length; i++){
            if(curUId == pl.info.uid && i == pl.mjput.length - 1 && tData.currCard == pl.mjput[i]){
...
//重置牌的顺序
PlayLayer_YuanJiangGuiHuZi.prototype.CardLayoutRestore = function(posNode,off){
    if(MjClient.rePlayVideo == -1){
...
PlayLayer_YuanJiangGuiHuZi.prototype.ShowHuTypeText = function(){
    var pl = getUIPlayer_YuanJiangGuiHuZi(0);
    cc.log("test . log ----------------------");   
...
// 判断吃、碰、跑、偎、提、胡的状态
PlayLayer_YuanJiangGuiHuZi.prototype.EatVisibleCheck = function(msg){
    var eat = MjClient.playui.jsBind.eat;
    ...
    //吃碰杠胡node
    var vnode = [];
    //自摸getUIPlayer_YuanJiangGuiHuZi
    if(tData.tState != TableState.roundFinish && pl.mjState != TableState.roundFinish){
        if(IsTurnToMe()){
            ...
            //飘
            if(pl.eatFlag & 4){
                vnode.push(eat.piao._node);
            }
            //炸
            if (pl.eatFlag & 64) {
                vnode.push(eat.zha._node);
            }
    ...
    if(vnode.length > 0){
        ...
        for(var i = 0; i < vnode.length; i++){
            ...
            if(ziPai.getUiLayoutType() == 0){
                ...
                setWgtLayout(vnode[i], [0, 0.20 - scale], [0.95, 0.11 + (scale * 1.8)], [ (i - (vnode.length - 1)) * 1.2, 1.8], false, false);
            }
        }
    }
};
PlayLayer_YuanJiangGuiHuZi.prototype.showAndHideHeadEffect = function(){
    var arr = [this._downNode, this._rightNode, this._topNode];
    if (MjClient.MaxPlayerNum_YuanJiangGuiHuZi == 4)
    {
        arr = [this._downNode, this._xingNode, this._rightNode, this._topNode];
    }else if (MjClient.MaxPlayerNum_YuanJiangGuiHuZi == 2)
    {
    ...
    else if (curPlayerIsMe_YuanJiangGuiHuZi(1)){
        curPlayerNode = arr[1].getChildByName("head");
    }else if (curPlayerIsMe_YuanJiangGuiHuZi(2)){
        curPlayerNode = arr[2].getChildByName("head");
    }else if (curPlayerIsMe_YuanJiangGuiHuZi(3)){
