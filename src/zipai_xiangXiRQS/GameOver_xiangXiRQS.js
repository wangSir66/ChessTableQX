function addWxHeadToEndUI_xiangXiRQS_GO(node, off) {
...
function SetGameOverLayer_xiangXiRQS(node,off,isNewUi){
    ...
    addWxHeadToEndUI_xiangXiRQS_GO(wxNode,off);
    ...
    //
    showRoomStatistics(textNode,["huNum","ziNum","jiePaoNum"],pl.roomStatistics);
}

var GameOverLayer_xiangXiRQS = cc.Layer.extend({
    sprite:null,
    jsBind:{
        back:{
            close :{
    ...
    ctor:function () {
        this._super();
        var endallui = ccs.load("endAll_xiangXiRQS.json");
        ...
        for(var i = 0 ; i < playerCount ; i++){
            ...
            SetGameOverLayer_xiangXiRQS(clone,i, false);
