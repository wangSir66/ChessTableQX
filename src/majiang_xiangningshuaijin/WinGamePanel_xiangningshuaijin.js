...
function CardLayoutRestoreForEndOne_xiangningshuaijin(node, endonepl)
{
...
function SetEndOneUserUI_xiangningshuaijin(node,off)
{
	var sData=MjClient.data.sData;
	var tData=sData.tData;
...
var EndOneView_xiangningshuaijin = cc.Layer.extend({
	jsBind:{
		block: {
		...
		btnShowHeap:{
                ...
                _click:function()
                {
                	if(MjClient.endoneui){
                        var CardsHeap = new PopupShowCardsHeap();
                        CardsHeap.setName("CardsHeap");
                        MjClient.endoneui.addChild(CardsHeap);
                    }
                },
            },
        dir: {
		...
		head0:{
		   ...
		   _run:function(){ SetEndOneUserUI_xiangningshuaijin(this,0); },
		...
		head1:{
		  ...
		  _run:function(){ SetEndOneUserUI_xiangningshuaijin(this,1); }
		},
		head2:{
		   head:{
			   zhuang:{_visible:false}
		   ...
		   _run:function(){ SetEndOneUserUI_xiangningshuaijin(this,2); }
		},
		head3:{
			 head:
			 {
			...
			_run:function(){ SetEndOneUserUI_xiangningshuaijin(this,3); }
			},
		count_down:{
                _visible :function()
                {
    ...
    ctor:function () {
        this._super();
        var endoneui = ccs.load("endOne_xiangningshuaijin.json");
