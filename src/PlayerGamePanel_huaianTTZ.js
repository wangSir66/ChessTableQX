...
//向服务器发送 过消息
MjClient.MJPass2NetForHuaianTTZ = function()
{
   // console.log(">>>>>>>>>普通  过 <<<<<<<<");
    cc.log("====================send======pass=====");
...
function SetUserVisible_huaianTTZ(node, off)
{
    //var sData = MjClient.data.sData;
    //return;
    cc.log("====================off======================" + off);
...
function InitUserHandUI_huaianTTZ(node, off)
{
    var sData = MjClient.data.sData;
    var tData = sData.tData;
    var pl = getUIPlayer(off);
...
function initFlower_huaianTTZ() {
    initFlower(false, false);
}


var PlayLayer_huaianTTZ = cc.Layer.extend({
    jsBind: {
        _event: {
            mjhand: function() {
            ...
            roundEnd: function() {
                ...
                function delayExe()
                {
                    ...
                    self.addChild(new EndOneView_huaianTTZ(),500);
                }
        ...
        banner: {
            ...
            Button_1: {
                _visible : true,
                _click: function() {
                    MjClient.openWeb({url:MjClient.GAME_TYPE.HUAI_AN_TTZ,help:true});
                }
            },
            hunPai:{
                baidaBg:{
        ...
        down: {
            ...
            _event: {
                ...
                initSceneData: function(eD) {
                    SetUserVisible_huaianTTZ(this, 0);
                },
                addPlayer: function(eD) {
                    SetUserVisible_huaianTTZ(this, 0);
                },
                ...
                mjhand: function(eD) {
                    InitUserHandUI_huaianTTZ(this, 0);
                },
                roundEnd: function() {
        ...
        right: {
            ...
            _event: {
                ...
                initSceneData: function(eD) {
                    SetUserVisible_huaianTTZ(this, 1);
                },
                addPlayer: function(eD) {
                    SetUserVisible_huaianTTZ(this, 1);
                },
                ...
                mjhand: function(eD) {
                    InitUserHandUI_huaianTTZ(this, 1);
                },
                roundEnd: function() {
        ...
        top: {
            ...
            _event: {
                ...
                initSceneData: function(eD) {
                    SetUserVisible_huaianTTZ(this, 2);
                },
                addPlayer: function(eD) {
                    SetUserVisible_huaianTTZ(this, 2);
                },
                ...
                mjhand: function(eD) {
                    InitUserHandUI_huaianTTZ(this, 2);
                },
                roundEnd: function() {
        ...
        left: {
            ...
            _event: {
                ...
                initSceneData: function(eD) {
                    SetUserVisible_huaianTTZ(this, 3);
                },
                addPlayer: function(eD) {
                    SetUserVisible_huaianTTZ(this, 3);
                },
                ...
                mjhand: function(eD) {
                    InitUserHandUI_huaianTTZ(this, 3);
                },
                roundEnd: function() {
        ...
        eat: {
            ...
            guo: {
                ...
                _touch: function(btn, eT) {
                    if (eT == 2)
                    {
                        MjClient.MJPass2NetForHuaianTTZ();
                    }
                },
                bgimg: {
                    _run: function() {
            ...
            changeui: {
                ...
                changeuibg: {
                    ...
                    guobg: {
                        guo: {
                            _touch: function(btn, eT) {
                                if (eT == 2) MjClient.MJPass2NetForHuaianTTZ();
                            }
                        },
                        fanhui: {
                            _touch: function(btn, et) {
    ...
    ctor: function() {
        ...
        var playui = ccs.load(res.Play_huaianTTZ_json);
        playMusic("bgFight");
...
PlayLayer_huaianTTZ.prototype.CardLayoutRestore = function(node, off)
{
...
// 判断吃碰杠胡的状态
PlayLayer_huaianTTZ.prototype.EatVisibleCheck = function()
{
    var eat = MjClient.playui.jsBind.eat;
    ...
    if(tData.tState == TableState.waitPut && pl.mjState == TableState.waitPut)
    {
        if(IsTurnToMe())
        {
            ...
            //杠
            if (typeof(pl.skipGang) == "undefined")
                pl.skipGang = [];

            var rtn = MjClient.majiang.canGang1(pl.mjpeng, pl.mjhand, pl.isTing, pl.skipGang);
