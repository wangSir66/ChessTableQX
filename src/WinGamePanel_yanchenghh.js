...
function SetEndOneUserUI_yanchenghh(node,off)
{
...
var EndOneView_yanchenghh = cc.Layer.extend({
    jsBind:{
        block: {
        ...
        back:{
            ...
            head0:{
                ...
                _run:function(){ SetEndOneUserUI_yanchenghh(this,0); },
            ...
            ,head1:{
                ...
                _run:function(){ SetEndOneUserUI_yanchenghh(this,1); }
            }
            ...
            ,head2:{
                ...
                _run:function(){ SetEndOneUserUI_yanchenghh(this,2); }
            }
            ,head3:{
                head:
                    {
                ...
                _run:function(){ SetEndOneUserUI_yanchenghh(this,3); }
			},
            count_down:{
                _visible :function()
                {
    ...
    ctor:function () {
        this._super();
        var endoneui = ccs.load(res.EndOne_yanchenghh_json);
