...
PaodekuaiLyg.prototype.CARDTPYE = PDK_CARDTPYE;
var PDK_CARDCOUNT = {};
...
PaodekuaiLyg.prototype.allTipsNoOrder = [
    [PDK_CARDTPYE.danpai, []],
    [PDK_CARDTPYE.duizi, []],
...
PaodekuaiLyg.prototype.randomCards = function(areaSelectMode, tData) {
    var cards = [];
 ...
 * @return {number}
 */
PaodekuaiLyg.prototype.calPoint = function(num, justValue) {
    if (!num)
        return -1;
...
PaodekuaiLyg.prototype.calFlower = function(num) {
    return (num + 3) % 4;
}
 ...
 * @return {boll} 
 */
PaodekuaiLyg.prototype.isSanShun = function(oCards){
...
// console.log( PaodekuaiLyg.prototype.isSanShun([3,3,3]) );
 ...
 */
PaodekuaiLyg.prototype.getSanShunAndSanPai = function(oCards){
    var countSanSame = 0;
    // 记录所有3张的数值
    var sanSameList = [];
    // 记录散牌
...
PaodekuaiLyg.prototype.countDuiNum = function(oCards){
    var num = 0;
    var cardNumByValue = {};
    for(var i in oCards){
...
PaodekuaiLyg.prototype.formatFeiJiType = function(oCards){
    // 记录所有3张的数值
    var sanSameList = [];
    // 记录散牌
    var sanPaiList = [];
 ...
 */
PaodekuaiLyg.prototype.isFeiJi = function(oCards){
 ...
 * @return {bool}
 */
PaodekuaiLyg.prototype.isShun = function(oCards) {
...
PaodekuaiLyg.prototype.isZhaDan = function(oCards, areaSelectMode) {
...
PaodekuaiLyg.prototype.isHadZhaDan = function(cards, areaSelectMode) {
...
// 是否拆散了炸弹牌型
PaodekuaiLyg.prototype.isChaiZhaDan = function(handCards, putCards, areaSelectMode){
 ...
 * @return {bool}
 */
PaodekuaiLyg.prototype.isLiandui = function(oCards) { //oCards有序
 ...
 */
PaodekuaiLyg.prototype.findShunZi = function(oCards, cardNum, isNeedSameFlower) {
 ...
 */
PaodekuaiLyg.prototype.calType = function(pCards, areaSelectMode, skipSzdaipai) {
...
PaodekuaiLyg.prototype.cardsType = function(cards, areaSelectMode) {
 ...
 * @return {number}
 */
PaodekuaiLyg.prototype.calCardsValue = function(cards, type, areaSelectMode) {
...
// 牌点比较函数
PaodekuaiLyg.prototype.cardValueCmp = function(a, b) {
...
// 排掉从大到小排序
PaodekuaiLyg.prototype.cardSortBigToSmall = function(a, b) {
    var pa = this.calPoint(a);
    var pb = this.calPoint(b);
    if (pa == pb)
        return b - a;
...
PaodekuaiLyg.prototype.sortBigCardValue = function(a, b) {
 ...
 * @return {number} 返回癞子数
 */
PaodekuaiLyg.prototype.transformAndGetLaizi = function(oCards, cards) {
    var laizi = 0;
    for (var i = 0; i < oCards.length; i++) {
 ...
 */
PaodekuaiLyg.prototype.canPut = function(oCards, oLastCards, handsNum, areaSelectMode) {

    var cardsType = this.calType(oCards, areaSelectMode);

    // cc.log("PaodekuaiLyg.prototype.canPut oCards:", oCards );
 ...
 */
PaodekuaiLyg.prototype.checkPut = function(oHands, cards, lastCards, areaSelectMode, isNextPlayerOneCard, isFirstRound) {
...
PaodekuaiLyg.prototype.getMaxDanPai = function(oCards) {
 ...
 */
PaodekuaiLyg.prototype.sortHandCards = function(oCards, sortType) {
    var cards = oCards.slice();
 ...
 * @return {array}
 */
PaodekuaiLyg.prototype.findNSameCard = function(hands, point, n) {
...
// 删除相应牌值
PaodekuaiLyg.prototype.delPoint = function(hands, points, values){
    var arr = hands.slice();
 ...
 */
PaodekuaiLyg.prototype.lieju = function(parr, num){
    var tmps = [];
...
PaodekuaiLyg.prototype.formatCards = function(oCards) {
    var info = {};
...
PaodekuaiLyg.prototype.indexOfCards = function(cardList, cards) {
...
PaodekuaiLyg.prototype.isSameCards = function(cards1, cards2) {
 ...
 */
PaodekuaiLyg.prototype.findCardByRole = function(oCards, findNum, ignoreCardValued) {
 ...
 * @param {array} 拼好的 
 */
PaodekuaiLyg.prototype.findCardByType = function(hands, laizi, type, lastCards, buChaiTypes) {
    var rets = [];
    var laizis = [];
...
// var fc = PaodekuaiLyg.prototype.findCardByType([19,19,19,15,15], 0, PDK_CARDTPYE.sandaier, [9,9,9,15,15])
// console.log( fc )

PaodekuaiLyg.prototype.getAllMaxCard = function(oCards){
...
PaodekuaiLyg.prototype.sortByCardType = function(cardsList, areaSelectMode) {
...
PaodekuaiLyg.prototype.findDaiPai = function(oCards, type, findNum, same, buChaiTypes) {
    var ret = [];
...
// 此函数只供提示出牌调用
PaodekuaiLyg.prototype.findCardByType_fast = function(hands, laizi, type, lastCards, buChaiTypes) {
...
PaodekuaiLyg.prototype.initCanPutTypes = function(hands, includeCard, areaSelectMode) {
 ...
 * @return {array} 提示的牌
 */
PaodekuaiLyg.prototype.findPutTipCards = function(hands, lastCards, areaSelectMode, isNextPlayerOneCard, isFirstRound, putOrder, allBuChaiTypes) {
 ...
 * @return {Boolean} 
 */
PaodekuaiLyg.prototype.isMustPutCard3 = function(oHands, areaSelectMode, isFirstRound) {
 ...
 * @return {array} 提示的牌
 */
PaodekuaiLyg.prototype.tipCards = function(oHands, oLastCards, areaSelectMode, isNextPlayerOneCard, isFirstRound, isSmartTip) {
    if(isSmartTip) {
        this.canPutTypesCache = [];
 ...
 */
PaodekuaiLyg.prototype.IsSametipCards = function(tipscardsArray, areaSelectMode)
{
 ...
 * @param  {Boolean} areaSelectMode 创建房间的选项
 */
PaodekuaiLyg.prototype.delDaipai = function(Cards, areaSelectMode)
{
    var cardtype = this.calType(Cards, areaSelectMode);
...
if(typeof(module)!="undefined" && module.exports)    
    module.exports = PaodekuaiLyg;

if(typeof(MjClient)!="undefined")
    MjClient.majiang_PaodekuaiLYG = new PaodekuaiLyg();
...
// console.log('PaodekuaiLyg.prototype.checkPut', pdk.checkPut(handCards, putCards, lastCards) );
