var EndOneView_PaodekuaiLYG= EndOneView_PaoDeKuai.extend({
	
	ctor: function() {
	    this._super(res.EndOne_PaoDeKuaiLYG_json);
	    return true;
	},
});

EndOneView_PaodekuaiLYG.prototype.getPlayUIDirNodeData = function() {
...
EndOneView_PaodekuaiLYG.prototype.showAllCardItem_PaoDeKuai = function(node, pl) {
...
EndOneView_PaodekuaiLYG.prototype.setHeadUIZhaDanFanBei = function(node, pl) {
