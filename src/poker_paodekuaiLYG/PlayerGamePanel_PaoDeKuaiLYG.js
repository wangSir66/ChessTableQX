...
function SetUserVisible_PaodekuaiLYG(node, off)
{
    ...
    if(pl)
    {
        ...
        InitUserHandUI_PaodekuaiLYG(node, off);
    }
    else
    {
        name.visible = false;
...
function InitUserHandUI_PaodekuaiLYG(node, off, needSort)
{
...
function cardsSort_PaodekuaiLYG(cards)
{
    var pointCounts = {};
...
var PlayLayer_PaoDeKuaiLYG = cc.Layer.extend({
    ...
    jsBind: {
        ...
        BtnPutCard:{
            ...
            _click: function(btn) {
                //cc.log("BtnPutCard");
				cardsSort_PaodekuaiLYG(MjClient.selectCards_card);
        ...
        down: {
            ...
            _event: {
                ...
                initSceneData: function(eD) {
                    SetUserVisible_PaodekuaiLYG(this, 0);
                ...
                mjhand: function(eD) {
                    InitUserHandUI_PaodekuaiLYG(this, 0);
        ...
        right: {
            ...
            _event: {
                ...
                initSceneData: function(eD) {
                    SetUserVisible_PaodekuaiLYG(this, 1);
                },
                addPlayer: function(eD) {
                    SetUserVisible_PaodekuaiLYG(this, 1);
                },
                ...
                mjhand: function(eD) {
                    InitUserHandUI_PaodekuaiLYG(this, 1);
                },
                roundEnd: function() {
        ...
        top: {
            ...
            _event: {
                ...
                initSceneData: function(eD) {
                    SetUserVisible_PaodekuaiLYG(this, 2);
                },
                addPlayer: function(eD) {
                    SetUserVisible_PaodekuaiLYG(this, 2);
                },
                ...
                mjhand: function(eD) {
                    InitUserHandUI_PaodekuaiLYG(this, 2);
                },
                roundEnd: function() {
