...
function SetEndOneUserUI_doudizhuHA(node, off) {
    ...
    cc.log('tDatatDatatData:' + JSON.stringify(pl))
        ...
        head: {
            ...
            stand: {
                ...
                _run: function () {
                    ...
                    CardLayoutRestoreForEndOne_doudizhuHA(node, pl);
                }
            },
            cardType: {
                _run: function () {
            ...
            Image_dizhu: {
                _run: function () {
                    ...
                    if (tData.uids[MjClient.playui.zhuang] == pl.info.uid) {
                       cc.log("lijm===========",MjClient.playui.zhuang);
                        this.visible = true;
                    }
                }
            },
...
function CardLayoutRestoreForEndOne_doudizhuHA(node, plNode) {
...
var EndOneView_doudizhuHA = cc.Layer.extend({
    jsBind: {
        block: {
        ...
        back: {
            ...
            head0: {
                ...
                _run: function () { SetEndOneUserUI_doudizhuHA(this, 0); },
            ...
            , head1: {
                ...
                _run: function () { SetEndOneUserUI_doudizhuHA(this, 1); }
            }
            ...
            , head2: {
                ...
                _run: function () { SetEndOneUserUI_doudizhuHA(this, 2); }
            }
        }
    },
    ctor: function (zhuang) {
        ...
        cc.log("lijm=========ctor",zhuang);
        var endoneui = ccs.load(res.EndOne_doudizhuHA_json);
