...
function SetUserVisible_PaoDeKuaiTY(node, off)
{
    ...
    if(pl)
    {
        ...
        InitUserHandUI_PaoDeKuaiTY(node, off);
    }
    else
    {
        name.visible = false;
...
function InitUserHandUI_PaoDeKuaiTY(node, off, needSort)
{
...
function cardsSort_PaoDeKuaiTY(cards)
{
    var pointCounts = {};
...
var PlayLayer_PaoDeKuaiTY = cc.Layer.extend({
    _btnPutCard:null,
    jsBind: {
        _run: function() {
            ...
            roundEnd: function() {
                ...
                function delayExe()
                {
                    ...
                    if(MjClient.isInGoldFieldNormal()){//金币场普通场
                        ...
                        self.addChild(new EndOneView_PaoDeKuaiTY(),500);
                    }
                }
        ...
        BtnPutCard:{
            ...
            _click: function(btn) {
                //cc.log("BtnPutCard");
				cardsSort_PaoDeKuaiTY(MjClient.selectCards_card);
        ...
        down: {
            ...
            _event: {
                ...
                initSceneData: function(eD) {
                    SetUserVisible_PaoDeKuaiTY(this, 0);
                ...
                mjhand: function(eD) {
                    InitUserHandUI_PaoDeKuaiTY(this, 0);
        ...
        right: {
            ...
            _event: {
                ...
                initSceneData: function(eD) {
                    SetUserVisible_PaoDeKuaiTY(this, 1);
                },
                addPlayer: function(eD) {
                    SetUserVisible_PaoDeKuaiTY(this, 1);
                },
                ...
                mjhand: function(eD) {
                    InitUserHandUI_PaoDeKuaiTY(this, 1);
                },
                roundEnd: function() {
        ...
        top: {
            ...
            _event: {
                ...
                initSceneData: function(eD) {
                    SetUserVisible_PaoDeKuaiTY(this, 2);
                },
                addPlayer: function(eD) {
                    SetUserVisible_PaoDeKuaiTY(this, 2);
                },
                ...
                mjhand: function(eD) {
                    InitUserHandUI_PaoDeKuaiTY(this, 2);
                },
                roundEnd: function() {
    ...
    ctor: function() {
        ...
        cc.log("MjClient.data.pinfo 1111100 sking = " + JSON.stringify(MjClient.data.pinfo));
...
PlayLayer_PaoDeKuaiTY.prototype.cannotOutCardGrey = function()
{
...
PlayLayer_PaoDeKuaiTY.prototype.recoverCannotOutCard = function()
{
    var children = this._downNode.children;
    for (var i = 0; i < children.length; i++)
    {
...
PlayLayer_PaoDeKuaiTY.prototype.clockNumberUpdate = function(node, endFunc)
{
...
PlayLayer_PaoDeKuaiTY.prototype.showHandCardBeiMian = function()
{
...
PlayLayer_PaoDeKuaiTY.prototype.hideHandCardBeiMian = function()
{
...
PlayLayer_PaoDeKuaiTY.prototype.CardLayoutRestore = function(node, off, needSort)
{
    cc.log("PlayLayer_PaoDeKuaiTY11==============");
    ...
    cc.log("PlayLayer_PaoDeKuaiTY22==============");
...
//横向摆放《正常》
PlayLayer_PaoDeKuaiTY.prototype.horSort = function(node, off, needSort)
{
    var pl; //player 信息
...
//纵向摆放
PlayLayer_PaoDeKuaiTY.prototype.verSort = function(node, off, needSort)
{
    if(off != 0)
    {
        return;
...
PlayLayer_PaoDeKuaiTY.prototype.showJiaZhu_PaodekuaiTY = function()
{
    var sData = MjClient.data.sData;
    var tData = sData.tData;
    var pl = getUIPlayer(0);
 ...
 PlayLayer_PaoDeKuaiTY.prototype.resetJiaZhuNum = function(node)
{
...
PlayLayer_PaoDeKuaiTY.prototype.setJiaZhuNum = function (node, pl)
{
    if(!pl) return;
