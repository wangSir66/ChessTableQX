function SetEndOneUserUI_sanDaHaXiangXiang(node, off) {
...
var EndOneView_sanDaHaXiangXiang = cc.Layer.extend({
    jsBind: {
        block: {
            _layout: [
                [1, 1],
        ...
        back: {
            ...
            text_rule: {
                _run: function() {
                    ...
                    rule += tData.areaSelectMode.touXiangJia10Fen ? "投降加10分," : "";
                    ...
                    {
                        rule += tData.areaSelectMode.countScore ? "级数算分," : "";
                    }
                    else {
                        rule += tData.areaSelectMode.countScore ? "分数算分," : "";
                    }
            ...
            image_player_zhuang: {
                _run: function() {
                    SetEndOneUserUI_sanDaHaXiangXiang(this, MjClient.endoneui.offs[0]);
                }
            },
            image_player_0: {
                _run: function() {
                    if(MjClient.data.sData.tData.maxPlayer == 3) {
                        SetEndOneUserUI_sanDaHaXiangXiang(this, MjClient.endoneui.offs[1]);
                    }
                    else {
                        this.visible = false;
                    }
            ...
            image_player_1: {
                _run: function() {
                    if(MjClient.data.sData.tData.maxPlayer == 3) {
                        SetEndOneUserUI_sanDaHaXiangXiang(this, MjClient.endoneui.offs[2]);
                    }
                    else {
                        this.visible = false;
                    }
            ...
            image_player_2_1: {
                _run: function() {
                    if(MjClient.data.sData.tData.maxPlayer == 4) {
                        SetEndOneUserUI_sanDaHaXiangXiang(this, MjClient.endoneui.offs[3]);
                    }
                    else {
                        this.visible = false;
                    }
    ...
    ctor: function() {
        ...
        var endoneui = ccs.load("endOne_sanDaHaXiangXiang.json");
