...
function SetUserVisible_sanDaHaXiangXiang(node, off) {
    ...
    if (pl) {
        ...
        InitUserHandUI_sanDaHaXiangXiang(node, off);
    } else {
        name.visible = false;
        coin.visible = false;
...
function InitUserHandUI_sanDaHaXiangXiang(node, off) {
...
function cardsSort_sanDaHaXiangXiang(cards) {
    var pointCounts = {};
...
var PlayLayer_sanDaHaXiangXiang = cc.Layer.extend({
    _btnPutCard: null,
    jsBind: {
        _event: {
            mjhand: function() {
            ...
            roundEnd: function() {
                ...
                function delayExe() {
                    ...
                    self.addChild(new EndOneView_sanDaHaXiangXiang(), 500);
                }
        ...
        BtnPutCard: {
            ...
            _click: function(btn) {
                ...
                //cc.log("BtnPutCard");
                cardsSort_sanDaHaXiangXiang(MjClient.selectCards_card);
            ...
            _event: {
                ...
                PKPut: function(eD) {
                    ...
                    var cardType = MjClient.majiang.cardsType(eD.card, MjClient.data.sData.tData.zhuPaiType,MjClient.data.sData.tData);
        ...
        BtnRenShu:{
            _run: function() {
                this.visible = false;
                setWgtLayout(this, [0.135, 0.128], [0.4, 0.40], [-1.2, 0.42]);
                MjClient.playui.BtnRenShu = this;
            },
            _click:function(){
                MjClient.showMsg("你确定要认输吗？", function() {
                    {
                        ...
                        MjClient.playui.BtnRenShu.setVisible(false);
                    };
                }, function() {}, "1");
            },
            _event:{
                waitPut:function()
                {
                    ...
                    var winType = MjClient.majiang.countWinType(tData.jiaoFen, tData.fenPaiArr, false);
                    var pl = getUIPlayer(0);
                    if(winType > 0 && winType < 4 && IsTurnToMe() && tData.uids[tData.zhuang] == pl.info.uid)
                    {
                        this.visible = true;
                    }
                    else {
                ...
                initSceneData:function () {
                    ...
                    var winType = MjClient.majiang.countWinType(tData.jiaoFen, tData.fenPaiArr, false);
                    var pl = getUIPlayer(0);
                    if(winType > 0 && winType < 4 && IsTurnToMe()
                        && tData.uids[tData.zhuang] == pl.info.uid
        ...
        down: {
            ...
            stand: {
                ...
                _run: function() {
                    if (MjClient.rePlayVideo == -1)
                        setWgtLayout(this, [0.090, 0], [0.5, 0.15], [0, 0]);
                    else
                        setWgtLayout(this, [0.052, 0], [0.5, 0.15], [0, 0]);
                    this.zIndex = 600;
                },
            },
            deskCard: {
            ...
            _event: {
                ...
                initSceneData: function(eD) {
                    SetUserVisible_sanDaHaXiangXiang(this, 0);
                ...
                mjhand: function(eD) {
                    InitUserHandUI_sanDaHaXiangXiang(this, 0);
                },
                roundEnd: function() {
        ...
        right: {
            ...
            jiaoFenTag: {
                _run: function() {
                    this.setScale(MjClient.size.width / 1280);
                    this.setPosition(MjClient.playui.jsBind.right.deskCard._node.getPositionX()+15,MjClient.playui.jsBind.right.deskCard._node.getPositionY());
                },
                _visible: false,
                _event: {
            ...
            _event: {
                ...
                initSceneData: function(eD) {
                    SetUserVisible_sanDaHaXiangXiang(this, 1);
                },
                addPlayer: function(eD) {
                    SetUserVisible_sanDaHaXiangXiang(this, 1);
                },
                ...
                mjhand: function(eD) {
                    InitUserHandUI_sanDaHaXiangXiang(this, 1);
                },
                roundEnd: function() {
        ...
        top: {
            ...
            _event: {
                ...
                initSceneData: function(eD) {
                    SetUserVisible_sanDaHaXiangXiang(this, 2);
                },
                addPlayer: function(eD) {
                    SetUserVisible_sanDaHaXiangXiang(this, 2);
                },
                ...
                mjhand: function(eD) {
                    InitUserHandUI_sanDaHaXiangXiang(this, 2);
                },
                roundEnd: function() {
        ...
        left: {
            ...
            _event: {
                ...
                initSceneData: function(eD) {
                    SetUserVisible_sanDaHaXiangXiang(this, 3);
                },
                addPlayer: function(eD) {
                    SetUserVisible_sanDaHaXiangXiang(this, 3);
                },
                ...
                mjhand: function(eD) {
                    InitUserHandUI_sanDaHaXiangXiang(this, 3);
                },
                roundEnd: function() {
        ...
        panel: {
            ...
            _run: function() {
                ...
                if (isIPhoneX()) {
                    setWgtLayout(this, [1, 1], [0.5, -0.1], [0, 0], true);
                }
                else {
            ...
            chaPaiPanel: {
                ...
                _run: function() {
                    ...
                    if (MjClient.rePlayVideo != -1)
                    {
                        ...
                        MjClient.playui.jsBind.BtnRenShu._node.y -= 50;
    ...
    ctor: function() {
        this._super();
        var playui = ccs.load("Play_sanDaHaXiangXiang.json");
        ...
        if(isIPhoneX())
        {
            this._btnChaPai.y = 50;
            this._btnDiPai.y = 50;
            this._btnShangYiLun.y = 35;
        }
        //this._back  = playui.node.getChildByName("back");

        //触摸事件监听注册
        cc.eventManager.addListener(cc.EventListener.create(this.getTouchListener_card()), this._rightNode);
        ...
        // 俱乐部返回大厅功能：by_jcw
        addClub_BackHallBtn("back_btn","left","setting");
...
PlayLayer_sanDaHaXiangXiang.prototype.getTouchListener_card=function()
{
    return{
        ...
        onTouchBegan: function (touch, event) {
            ...
            bTouchMove = false;
            if(MjClient.gameType == MjClient.GAME_TYPE.XIANG_XIANG_SAN_DA_HA)
            {
                for(var i = _childrens.length-1; i > 0; i--)
                {
                        ...
                        if(MjClient.sortClassType == 0)
                        {
                            if (getLashCardX(_childrens) != parseInt(_childrens[i].x)) {
                                if (MjClient.gameType == MjClient.GAME_TYPE.SAN_DA_HA||
                                    ...
                                    MjClient.gameType == MjClient.GAME_TYPE.LV_LIANG_DA_QI)
                                {
                                    if(_childrens[i]&&_childrens[i].isUp)
                                    {
                                        _boundingBox.y+= _childrens[i].showHeight/2;
                                        _boundingBox.height = _childrens[i].showHeight/2;
                                    }
                ...
                if(_childrens[i].name == "mjhand")
                {
                    ...
                    if (cc.rectContainsPoint(_boundingBox, locationInNode))
                    {
                        if(!checkIsHave(_childrens[i]))
                        {
                            cc.log("选中了");
                            bTouchMove = true;
                            if(MjClient.gameType == MjClient.GAME_TYPE.LV_LIANG_DA_QI && _childrens[i].cannotOut && _childrens[i].cannotOut == true){
                                //打七中置灰的牌不可提起
                            }else{
                                _childrens[i].setColor(MjClient.grayColor);
                                MjClient.touchMoveSelcetCardArray.push(_childrens[i]);
...
PlayLayer_sanDaHaXiangXiang.prototype.reConnectShowDeskCard = function() {
    var tData = MjClient.data.sData.tData;
...
PlayLayer_sanDaHaXiangXiang.prototype.cannotOutCardGrey = function() {
...
PlayLayer_sanDaHaXiangXiang.prototype.recoverCannotOutCard = function() {
    var children = this._downNode.children;
    for (var i = 0; i < children.length; i++) {
        if (children[i].name != "mjhand")
            continue;
...
PlayLayer_sanDaHaXiangXiang.prototype.clockNumberUpdate = function(node, endFunc) {
    return arrowbkNumberUpdate(node, endFunc);
}

PlayLayer_sanDaHaXiangXiang.prototype.updateClockPosition = function(arrowNode) {
    var tData = MjClient.data.sData.tData;
    var uids = tData.uids;
 ...
 * @return {String}
 */
PlayLayer_sanDaHaXiangXiang.prototype.getGameInfoString = function(param) {
    var tData = MjClient.data.sData.tData;
    var str = "";

    // str += tData.areaSelectMode.SAN_DA_HA_allowCheckCard ? "允许查牌," : "";
    str += tData.areaSelectMode.touXiangJia10Fen ? "投降加10分," : "";
    // str += tData.areaSelectMode.SAN_DA_HA_touXiangXuXunWen ? "投降需询问," : "";
    str += tData.areaSelectMode.SAN_DA_HA_daDaoTiQianOver ? "大倒提前结束," : "";

    str += tData.areaSelectMode.biChangZhu ? "比常主," : "";
    str += tData.areaSelectMode.SAN_DA_HA_doubleInSingleOut ? "双进单出," : "";
    str += tData.areaSelectMode.baoFuLiuShou ? "报副留守," : "";
    str += tData.areaSelectMode.qiJiaoFen60 ? "60分起叫," : "";
    str += tData.areaSelectMode.quDiao6 ? "去掉6," : "";
    if(tData.areaSelectMode.countScore ==1)
    {
        str += "级数算分,";
    }
    else {
...
PlayLayer_sanDaHaXiangXiang.prototype.updateOperateBtnPosition = function() {
    ...
    // var renShuBtn = this.jsBind.BtnRenShu._node;
...
// 拖拉机动画
PlayLayer_sanDaHaXiangXiang.prototype.playCardAni_liandui = function() {
...
// 闲家得分达到条件时动画、投降
PlayLayer_sanDaHaXiangXiang.prototype.playWinAni = function(winType) {
    ...
    switch (winType) {
        ...
        case 4:	// 投降
            ...
            break;
        case 5:	// 认输
            file = "gameOver_sanDaHa/renshu.png";
            break;
        default:
            return;
    }
...
// 刷新得分栏
PlayLayer_sanDaHaXiangXiang.prototype.refreshScoreBanner = function() {
    var tData = MjClient.data.sData.tData;
	...
	// 得分
    if (tData.tState == TableState.waitPut || tData.tState == TableState.roundFinish) {
...
// 判断是否有不同意投降的玩家
PlayLayer_sanDaHaXiangXiang.prototype.haveNotAgreeTouXiang = function()
{
    var sData = MjClient.data.sData;
    var tData = MjClient.data.sData.tData;
...
// 重置玩家同意投降状态
PlayLayer_sanDaHaXiangXiang.prototype.initAgreeTouXiangStatus = function()
{
    var sData = MjClient.data.sData;
    var tData = MjClient.data.sData.tData;
    for (var i = 0; i < tData.uids.length; i++)
...
PlayLayer_sanDaHaXiangXiang.prototype.showWaitTip = function(bMaiPai) {
    var sData = MjClient.data.sData;
    var tData = sData.tData;
...
// 显示各玩家叫分
PlayLayer_sanDaHaXiangXiang.prototype.showJiaoFenTag = function(off) {
    var tData = MjClient.data.sData.tData;
    ...
    var pl = getUIPlayer(off);
    if (!playerNode || !pl || tData.jiaoFenPlayer == -1)
        return;
    cc.log('pl.jiaoFenpl.jiaoFen:'+pl.jiaoFen)
    var jiaoFenTagNode = playerNode.getChildByName("jiaoFenTag");
    if (typeof(pl.jiaoFen) != "undefined" && pl.jiaoFen != 100 && pl.jiaoFen != -1) {
...
// 隐藏各玩家叫分
PlayLayer_sanDaHaXiangXiang.prototype.hideJiaoFenTag = function() {
...
// 显示叫分面板
PlayLayer_sanDaHaXiangXiang.prototype.showJiaoFenPanel = function() {
    if (MjClient.rePlayVideo != -1)
    {
        MjClient.playui.jsBind.panel.jiaoFenPanel._node.setVisible(false);
        return;
    ...
    var jiaoFenBg = jiaoFenPanel.getChildByName("bg");

    var func = function(isPaiFen) {
        var max = tData.jiaoFen > 0 ? tData.jiaoFen : 100 + 1;
        var fen = tData.areaSelectMode.qiJiaoFen60 == true ? 60 : 80;
        var position;
        for (var i = 80; i >= 5; i -= 5) {
            var btn = jiaoFenPanel.getChildByName("Btn_" + i);
            if(fen == 60)
            {
                jiaoFenBg.setContentSize(700,250);
                btnBuJiao.setPosition(cc.p(372.47,60))
                if(i == 30)
                {
                    btn.setPosition(cc.p(91,130));
                    position = btn.getPosition();
                }
                else if(i <60) {
                    btn.setPosition(cc.p(position.x+110,position.y));
                    position = btn.getPosition();
                }
                else if(i == 60)
                {
                    btn.setPosition(cc.p(91,210));
                    position = btn.getPosition();
                }
                else {
        ...
        btnPai_select.setEnabled(!tData.isPaiFen);
        btnPai_unselect.setVisible(!tData.isPaiFen && !isPaiFen);
        btnPai_unselect.setEnabled(getUIPlayer(0).jiaoFen == -1);
    }
    var zhuNum = MjClient.majiang.zhuNumSdh(0,true);
    func(tData.isPaiFen);
    ...
    cc.log("tData.mustJiaotData.mustJiao:"+tData.mustJiao)
    btnBuJiao.addTouchEventListener(function(sender, type) {
        if (type != 2)
            return;
        if(tData.maxPlayer == 3 &&  tData.mustJiao == true)
        {
            MjClient.showToast("6个常主必须叫分");
        }
        else if(tData.mustJiao == true)
        {
            MjClient.showToast("7个常主必须叫分");
        }
        else {
            MjClient.gamenet.request("pkroom.handler.tableMsg", {
                cmd: "c2s_sdhJiaoFen",
...
// 把底牌添加到手牌中
PlayLayer_sanDaHaXiangXiang.prototype.addDiPaiToHand = function() {
    var tData = MjClient.data.sData.tData;
    ...
    var playerNode = getNode_cards(off);
    var pl = getUIPlayer(off);
    if((pl.mjhand.length == 36 && tData.maxPlayer == 3) ||
        (tData.maxPlayer == 4 && pl.mjhand.length == 29) ||
        (tData.maxPlayer == 4 && pl.mjhand.length == 28 && tData.areaSelectMode.quDiao6))
    {
        return;
    }
...
// 从手牌中移除埋的牌
PlayLayer_sanDaHaXiangXiang.prototype.removeMaiPaiFromHand = function() {
    var tData = MjClient.data.sData.tData;
    var off = getOffByIndex(tData.curPlayer);
...
// 显示投降同意选择框
PlayLayer_sanDaHaXiangXiang.prototype.showTouXuangDialog = function() {
     if (MjClient.rePlayVideo != -1)
        return;
...
// 显示叫主面板
PlayLayer_sanDaHaXiangXiang.prototype.showJiaoZhuPanel = function() {
    var tData = MjClient.data.sData.tData;
...
// 显示埋牌、投降按扭
PlayLayer_sanDaHaXiangXiang.prototype.showMaiPaiBtn = function() {
    var tData = MjClient.data.sData.tData;
    ...
    var funcTouXiang = function(cards, isTouXiang) {
        MjClient.gamenet.request("pkroom.handler.tableMsg", {
            cmd: "c2s_sdhTouXiang",
            action:1
        });
    ...
    maiPaiBtn.addTouchEventListener(function(sender, type) {
        if (type != 2)
            return;
        if(tData.areaSelectMode.quDiao6 && MjClient.MaxPlayerNum == 3 )
        {
            if(MjClient.selectCards_card.length != 9)
            {
                return;
            }
        }
    ...
    maiPaiBtn.runAction(cc.repeatForever(cc.callFunc(function() {
        if(tData.areaSelectMode.quDiao6 && MjClient.MaxPlayerNum == 3)
        {
            maiPaiBtn.setEnabled(MjClient.selectCards_card.length == 9);
        }
        else {
...
// 显示上一轮面板
PlayLayer_sanDaHaXiangXiang.prototype.showShangYiLunPanel = function(shangYiLunPanel) {
    var tData = MjClient.data.sData.tData;
...
// 显示查看底牌面板
PlayLayer_sanDaHaXiangXiang.prototype.showDiPaiPanel = function(diPaiPanel) {
    var tData = MjClient.data.sData.tData;
    ...
    for (var i = 0; i < cards.length; i++) {
        var card = diPaiPanel.getChildByName("card_" + i);
        setCardSprite_card(card, cards[i], true);
        if(cards.length == 8)
        {
            card.x+=18;
            diPaiPanel.getChildByName("card_8").visible =false;
        }
    }
}

// 显示查牌面板
PlayLayer_sanDaHaXiangXiang.prototype.showChaPaiPanel = function(chaPaiPanel) {
    var tData = MjClient.data.sData.tData;
    var records = tData.putCardsRecord;
    ...
    for (var i = 0; i < 4; i++) {
        ...
        var uids = tData.uids;
        var pl = MjClient.data.sData.players[uids[i]]
        if (!pl) {
            player.setVisible(false);
            continue;
        }
        ...
        if(strlen >= 10)
        {
            _newName =  name.substring(0,9);
            _newName += "...";
        }
        else _newName= name;
        player.getChildByName("name").setString(_newName);
...
// 显示得分栏上的具体分牌
PlayLayer_sanDaHaXiangXiang.prototype.showScoreCards = function(panel, cards) {
...
// 给手牌中的主牌设置角标
PlayLayer_sanDaHaXiangXiang.prototype.setCardSprite_ZhuTag = function(node) {
    var tData = MjClient.data.sData.tData;
...
// 计算各牌色数量
PlayLayer_sanDaHaXiangXiang.prototype.getCardNumByColor = function(cards, colorIndex) {
    var num = 0;
    var types = [1, 2, 3, 0, 4]
    for (var i = 0; i < cards.length; i++) {
...
// 清空桌面
PlayLayer_sanDaHaXiangXiang.prototype.clearDesk = function() {
    cc.log("clearDesk")
...
PlayLayer_sanDaHaXiangXiang.prototype.CardLayoutRestore = function(node, off) {
    cc.log("横向排序 off=" + off);
...
PlayLayer_sanDaHaXiangXiang.prototype.CardLayoutDesk = function(node, cards, off) {
    //if(off != 0) return;
    var children = node.children;
    ...
    var cardType = MjClient.majiang.cardsType(cards,null,MjClient.data.sData.tData);
    ...
    var maxUid = MjClient.majiang.getMaxCardPlayerUid(roundCards, tData.firstPutCardUid, tData.uids, tData.zhuPaiType,tData);
...
//横向摆放《正常》
PlayLayer_sanDaHaXiangXiang.prototype.horSort = function(node, off) {
    var pl; //player 信息
    ...
    if (off == 0 || off == 2) //自己或者对家
    {
        ...
        var width;
        if(orders.length <= 21) width = (areaWidth - cardWidth) / (orders.length - 1);
        else width=(areaWidth - cardWidth) / 21;
        // if(orders.length <= 21)  width = (areaWidth - cardWidth) / (orders.length - 1);
        // else width = (areaWidth - cardWidth) / (orders.length - 3);

        if (width > cardWidth / 2)
            width = cardWidth / 2;
        var startX;
        if(orders.length <= 21) startX = MjClient.size.width / 2 - width * (orders.length - 1) / 2;
        else
        {
            if(isIPhoneX())
            {
                startX = MjClient.size.width / 2 - width * 21 / 2+20;
            }
            else {
                startX = MjClient.size.width / 2 - width * 21 / 2
            }
        }
        ...
        {
            cardWidth = orders[0] ? orders[0].width * orders[0].scale : 0;
            screenScale = MjClient.size.width / 1280;
            areaWidth = MjClient.rePlayVideo == -1 ? MjClient.size.width - screenScale * 20 : MjClient.size.width*2/3;
            width = (areaWidth - cardWidth) / (orders.length - 1);
            if (width > cardWidth / 2)
                width = cardWidth / 2;
...
function DealCardEffect(uid, off)
{
    ...
    //接牌
    var maxCardUid = MjClient.majiang.getMaxCardPlayerUid(roundPutCards, tData.firstPutCardUid, tData.uids, tData.zhuPaiType, tData);
