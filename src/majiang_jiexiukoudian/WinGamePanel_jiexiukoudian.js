...
function SetEndOneUserUI_jiexiukoudian(node,off)
{
...
var EndOneView_jiexiukoudian = cc.Layer.extend({
	jsBind:{
		block: {
		...
		head0:{
		   ...
		   _run:function(){ SetEndOneUserUI_jiexiukoudian(this,0); },
		...
		,head1:{ 
		  ...
		  _run:function(){ SetEndOneUserUI_jiexiukoudian(this,1); }
		}
		...
		,head2:{ 
		   ...
		   _run:function(){ SetEndOneUserUI_jiexiukoudian(this,2); }
		}
		,head3:{
			 head:
			 {
			...
			_run:function(){ SetEndOneUserUI_jiexiukoudian(this,3); }
			},
            count_down:{
                _visible :function()
                {
    ...
    ctor:function () {
        this._super();
        var endoneui = ccs.load(res.EndOne_jiexiukoudian_json);
