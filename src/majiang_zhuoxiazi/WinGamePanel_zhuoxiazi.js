...
function SetEndOneUserUI_zhuoxiazi(node,off)
{
...
var EndOneView_zhuoxiazi = cc.Layer.extend({
	jsBind:{
		block: {
		...
		head0:{
		   ...
		   _run:function(){ SetEndOneUserUI_zhuoxiazi(this,0); },
		...
		,head1:{ 
		  ...
		  _run:function(){ SetEndOneUserUI_zhuoxiazi(this,1); }
		}
		...
		,head2:{ 
		   ...
		   _run:function(){ SetEndOneUserUI_zhuoxiazi(this,2); }
		}
		,head3:{
			 head:
			 {
			...
			_run:function(){ SetEndOneUserUI_zhuoxiazi(this,3); }
			},
            count_down:{
                _visible :function()
                {
    ...
    ctor:function () {
        this._super();
        var endoneui = ccs.load("endOne_zhuoxiazi.json");
        ...
        if(zhongCount == 0){
            ...
            if(cards.length >= 6){
                ...
                shareBtn.setPosition(cc.p(sharePos.x + 90,sharePos.y));
                var readyBtn = _back.getChildByName("ready");
                var readyPos = readyBtn.getPosition();
                readyBtn.setPosition(cc.p(readyPos.x + 70,readyPos.y));
            }
        }
