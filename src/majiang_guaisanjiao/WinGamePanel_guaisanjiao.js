...
function SetEndOneUserUI_guaisanjiao(node,off)
{
...
var EndOneView_guaisanjiao = cc.Layer.extend({
	jsBind:{
		block: {
		...
		dir: {
			...
			_text: function () {
				...
				var str1 = arr[1];
                var str = str1.replace(GameCnName[MjClient.GAME_TYPE.JIN_ZHONG_GUAI_SAN_JIAO]+",", "");
				return (str);
			}
		},
		dir_0: {
		...
		head0:{
		   ...
		   _run:function(){ SetEndOneUserUI_guaisanjiao(this,0); },
		...
		head1:{
		  ...
		  _run:function(){ SetEndOneUserUI_guaisanjiao(this,1); }
		},
		head2:{
		   head:{
			   zhuang:{_visible:false}
		   ...
		   _run:function(){ SetEndOneUserUI_guaisanjiao(this,2); }
		},
		head3:{
			 head:
			 {
			...
			_run:function(){ SetEndOneUserUI_guaisanjiao(this,3); }
			},
		count_down:{
                _visible :function()
                {
    ...
    ctor:function () {
        this._super();
        var endoneui = ccs.load("endOne_guaisanjiao.json");
