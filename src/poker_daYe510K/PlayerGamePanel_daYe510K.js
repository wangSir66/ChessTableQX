...
function SetUserVisible_DaYe510K(node, off)
{
    var pl = getUIPlayer(off);
    ...
    if(pl)
    {
        ...
        InitUserHandUI_DaYe510K(node, off);
    }
    else
    {
        name.visible = false;
...
function InitUserHandUI_DaYe510K(node, off)
{
...
var PlayLayer_DaYe510K = cc.Layer.extend({
    _btnPutCard:null,
    jsBind: {
        _event: {
            mjhand: function() {
            ...
            endRoom: function(msg) {
                ...
                if (msg.showEnd) this.addChild(new GameOverLayer_DaYe510K(),500);
                else
            ...
            roundEnd: function() {
                ...
                function delayExe()
                {
                        ...
                        if (sData.tData.roundNum <= 0) {
                            if(!tData.matchId) {
                                ...
                                self.runAction(cc.sequence(cc.delayTime(3),cc.callFunc(function(){
                                    self.addChild(new GameOverLayer_DaYe510K(),500);
                                })))
                            }
                        }
                    }
                    ...
                    self.addChild(new EndOneView_daYe510K(),500,650);
            ...
            initSceneData: function() {
                ...
                //     pi.winOrLose  = -3007;
                // }
                // MjClient.playui.addChild(new EndOneView_daYe510K(),500,650);
            },
        ...
        down: {
            ...
            _event: {
                ...
                initSceneData: function(eD) {
                    ...
                    SetUserVisible_DaYe510K(this, 0);
                ...
                mjhand: function(eD) {
                    InitUserHandUI_DaYe510K(this, 0);
        ...
        right: {
            ...
            _event: {
                ...
                initSceneData: function(eD) {
                    SetUserVisible_DaYe510K(this, 1);
                ...
                mjhand: function(eD) {
                    InitUserHandUI_DaYe510K(this, 1);
                },
                roundEnd: function() {
        ...
        top: {
            ...
            _event: {
                ...
                initSceneData: function(eD) {
                    SetUserVisible_DaYe510K(this, 2);
                ...
                mjhand: function(eD) {
                    InitUserHandUI_DaYe510K(this, 2);
                },
                roundEnd: function() {
        ...
        left: {
            ...
            _event: {
                ...
                initSceneData: function(eD) {
                    SetUserVisible_DaYe510K(this, 3);
                ...
                mjhand: function(eD) {
                    InitUserHandUI_DaYe510K(this, 3);
                },
                roundEnd: function() {
...
PlayLayer_DaYe510K.prototype.InitC_Data = function() {
...
PlayLayer_DaYe510K.prototype.clockNumberUpdate = function(node, endFunc)
{
...
PlayLayer_DaYe510K.prototype.updateClockPosition = function(arrowNode)
{
    var tData = MjClient.data.sData.tData;
    var uids = tData.uids;
 ...
 * @return {String}
 */
PlayLayer_DaYe510K.prototype.getGameInfoString = function(param)
{
    var tData = MjClient.data.sData.tData;
    var str = "";
    ...
    if(tData.areaSelectMode.laiziOption == 0){
        str += ("无癞子,") ;
    }else if(tData.areaSelectMode.laiziOption == 1){
        str += ("有癞子（不讲硬炸）,") ;
    }else if(tData.areaSelectMode.laiziOption == 2){
        str += ("有癞子（讲硬炸）,") ;
    }
    ...
    str += tData.areaSelectMode.useJiPaiQi ? "使用记牌器," : "" ;
    str += tData.areaSelectMode.fangHeShou ? "防合手," : "" ;
...
PlayLayer_DaYe510K.prototype.isChickenPlayer = function(){

};

PlayLayer_DaYe510K.prototype.showQiangZhuangTag = function(off, eD){
    var tData = MjClient.data.sData.tData;
...
PlayLayer_DaYe510K.prototype.checkPartnerIsConfirm = function(){
    var tData = MjClient.data.sData.tData;
    var ret = true;
...
PlayLayer_DaYe510K.prototype.addJiPaiTag = function(node){
    var tData = MjClient.data.sData.tData;
...
PlayLayer_DaYe510K.prototype.addChickenCardIcon = function(off){
    var pl = getUIPlayer(off);
...
PlayLayer_DaYe510K.prototype.setChickenCardIcon = function(eD)
{
    if(true){
...
PlayLayer_DaYe510K.prototype.showJieFengAnim = function(msg)
{
...
//身份识别后播鸡的动画
PlayLayer_DaYe510K.prototype.showChickenAnim = function(index){
    var tData = MjClient.data.sData.tData;
...
//亮身份
PlayLayer_DaYe510K.prototype.showIdentityIcon = function(eD){
    var tData = MjClient.data.sData.tData;
...
PlayLayer_DaYe510K.prototype.showPartnerTips = function(){
    var tData = MjClient.data.sData.tData;
    var pl = getUIPlayer(0);
...
PlayLayer_DaYe510K.prototype.showYouPai = function(){
    var tData = MjClient.data.sData.tData;
...
PlayLayer_DaYe510K.prototype.showYouPaiAnim = function(flyNode, cardValue ){
...
//重连
PlayLayer_DaYe510K.prototype.dealZhuangMing = function(){
    var tData = MjClient.data.sData.tData;
...
//明抢了
PlayLayer_DaYe510K.prototype.showMingAnim = function(msg){
...
PlayLayer_DaYe510K.prototype.showZhuangIcon = function (UIoff, isMing) {
    var tData = MjClient.data.sData.tData;
...
PlayLayer_DaYe510K.prototype.showFlyCardAnim = function(flyNode,cardValue,UIoff)
{
    var playerNode = getNode_cards(UIoff);
    if (!playerNode)
        return;
...
PlayLayer_DaYe510K.prototype.showHandCardBeiMian = function()
{
...
PlayLayer_DaYe510K.prototype.hideHandCardBeiMian = function()
{
...
PlayLayer_DaYe510K.prototype.CardLayoutRestore = function(node, off)
{
    cc.log("PlayLayer_DaYe510K11==============");
    
    // 如果正在发牌 不排序
    if (MjClient.playui.isFaPai) return;
    
    cc.log("PlayLayer_DaYe510K22==============");
...
PlayLayer_DaYe510K.prototype.CardLayoutDesk = function(node,cards,off)
{
    var tData = MjClient.data.sData.tData;
...
PlayLayer_DaYe510K.prototype.getJokerCardsFromRet = function(ret) {
        if (!ret || ret.length <= 0)
            return [];
...
//横向摆放《正常》
PlayLayer_DaYe510K.prototype.horSort = function(node, off)
{
    var pl; //player 信息
...
//纵向摆放
PlayLayer_DaYe510K.prototype.verSort = function(node, off)
{
    if(off != 0)
    {
        return;
...
PlayLayer_DaYe510K.prototype.changePosition = function(msg,flyNode,oldUids)
{
    if (!msg)return;
...
PlayLayer_DaYe510K.prototype.showXiFenAnim = function(msg){
    if(msg == null){
        return;
    }
    var sData = MjClient.data.sData;
...
//处理明牌
PlayLayer_DaYe510K.prototype.dealMingPai = function(node, msgary, UIOff, needSound)
{   
    // 回放情形下，不需展示明牌
    if (MjClient.rePlayVideo != -1)
        return;
...
PlayLayer_DaYe510K.prototype.showWatchPanel = function(node, cards){
...
PlayLayer_DaYe510K.prototype.dealSwitchWatch = function(watch, cards){
    if(!watch){
...
//展示队友手牌
PlayLayer_DaYe510K.prototype.showPartnerHandCards = function(node, cards)
{   
    // 回放情形下，不需展示
    if (MjClient.rePlayVideo != -1 || !MjClient.playui.checkPartnerIsConfirm() || cards == null){
        node.setVisible(false);
...
PlayLayer_DaYe510K.prototype.dealPartnerPutCards = function(node, putCards)
{   
...
PlayLayer_DaYe510K.prototype.dealPKPutCards = function(node, msg)
{
...
PlayLayer_DaYe510K.prototype.CardLayoutPartnerCards = function(node)
{
    if(MjClient.rePlayVideo != -1)// 表示回放
    {
        MjClient.sortClassType = 0;
...
PlayLayer_DaYe510K.prototype.clearPartnerUI = function(node)
{
    // 回放情形下，不需处理
    if (MjClient.rePlayVideo != -1)
        return;
...
PlayLayer_DaYe510K.prototype.showFlyZhuaFenAnim = function(msg){
    var UIoff =  getUiOffByUid(msg.uid);
...
PlayLayer_DaYe510K.prototype.setPlayerZhuaFen = function(node,off_1,off_2)
{
...
PlayLayer_DaYe510K.prototype.UpdataDaMaZiTips = function(){
    var sData = MjClient.data.sData;
    var tData = sData.tData;
...
PlayLayer_DaYe510K.prototype.clearDeskCard = function(node)
{
    var children = node.children;
    for (var i = 0; i < children.length; i++)
    {
...
PlayLayer_DaYe510K.prototype.putDaMaZiTips = function(cardType){
...
PlayLayer_DaYe510K.prototype.onClickLiPai = function()
{
...
PlayLayer_DaYe510K.prototype._sortS2B = function(oCards){
...
PlayLayer_DaYe510K.prototype._sortCardByType = function(){
...
PlayLayer_DaYe510K.prototype.resetRoundData = function()
{
    var sData = MjClient.data.sData;
    var tData = sData.tData;
...
PlayLayer_DaYe510K.prototype.ClearLiPai = function(uid, putcards)
{
...
PlayLayer_DaYe510K.prototype.setDownMenusEnabled = function()
{
    var tData = MjClient.data.sData.tData;
...
// 展示报喜动画
PlayLayer_DaYe510K.prototype.showBaoxiAnimation = function(msg)
{   
    ...
    MjClient.playui.addChild(new PiaoFenView_DaYe510K(msg.score,uiOff),500);
}

// 设置己方喜牌数据
PlayLayer_DaYe510K.prototype.setMajiangXiCard = function()
{   
...
// 创建投降UI
PlayLayer_DaYe510K.prototype.createTouXiangView = function(touXiangData)
{   
    //回放的时候，不弹投降窗口
    // if(MjClient.rePlayVideo != -1) 
    //     return;
...
PlayLayer_DaYe510K.prototype.reLoadOptBtnRes = function() {
    //出牌按钮
...
//弹出选择的牌
PlayLayer_DaYe510K.prototype.selectUICards = function(_tipsCardArray)
{
...
PlayLayer_DaYe510K.prototype.checkPut = function (oHands, oCards, lastPutCard, areaSelectMode) {
    var tData = MjClient.data.sData.tData;
...
PlayLayer_DaYe510K.prototype.RemoveNodeBack = function(node, name, num, tag) {
...
PlayLayer_DaYe510K.prototype.findNodesBack = function(node, name, tags) {
    tags = tags.slice();
...
PlayLayer_DaYe510K.prototype.cardsSort = function(cards)
{
    var pointCounts = {};
    for (var i = 0; i < cards.length; i++) {
...
PlayLayer_DaYe510K.prototype.isUsingJiPaiQi = function()
{
    var jipaiqi = MjClient.data.sData.tData.jipaiqi;
    return jipaiqi && jipaiqi.indexOf(SelfUid()) >= 0;
}

PlayLayer_DaYe510K.prototype.createJiPaiQiPanel = function()
{
...
// 记牌器购买面板
PlayLayer_DaYe510K.prototype.showJiPaiQiBuyingPanel = function(commoditys,purchaseCallback) {
...
PlayLayer_DaYe510K.prototype.setJiPaiQiEnabled = function(node) {
    var tData = MjClient.data.sData.tData;
    var enabled = tData.tState != TableState.waitJoin && 
        tData.tState != TableState.roundFinish && 
        tData.tState != TableState.waitReady && 
...
PlayLayer_DaYe510K.prototype.setJiPaiQiNum = function(node) {
...
PlayLayer_DaYe510K.prototype.checkJiPaiQiListValid = function(commoditys) {
...
PlayLayer_DaYe510K.prototype.checkJiPaiQiButtonVisible = function(node) {
