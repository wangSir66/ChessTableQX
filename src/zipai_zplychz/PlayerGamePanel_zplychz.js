...
var PlayLayer_zplychz = cc.Layer.extend({
    jsBind: {
        _event: {
        ...
        roundInfo:{
            ...
            _run:function(){
                ...
                if (tData.areaSelectMode.maiPaiNum && tData.areaSelectMode.maiPaiNum>0) {
            ...
            outNode: {
                ...
                _run : function(){
                    if(MjClient.data.sData.tData.maxPlayer == 2){
                        setWgtLayout(this, [0.14, 0.14], [0.30, 0.82], [0, 0]);
                    }
                }
            },
            put: {
...
//重置手牌的顺序
PlayLayer_zplychz.prototype.ResetHandCard = function(posNode,off, needAction, isDelay){
...
PlayLayer_zplychz.prototype._doMovetoAction = function(node,endP){
    node.stopAllActions();
    var ac = cc.moveTo(0.3,endP);
    node.runAction(ac);
};

PlayLayer_zplychz.prototype.ResetOtherCard = function(posNode,off){
    //添加吃、碰、跑、偎、提
    var sData = MjClient.data.sData;
    var tData = null;
    if(sData){
...
PlayLayer_zplychz.prototype.ResetPutCard = function(posNode, off) {
    //添加打出的牌
    var pl = getUIPlayer_leiyang(off);
    if (!pl) return;
    var outNode = posNode.getChildByName("outNode");
...
//重置牌的顺序
PlayLayer_zplychz.prototype.CardLayoutRestore = function(posNode,off){
    if(MjClient.rePlayVideo == -1){
...
// 判断吃、碰、跑、偎、提、胡的状态
PlayLayer_zplychz.prototype.EatVisibleCheck = function(off){
    var eat = MjClient.playui.jsBind.eat;
...
PlayLayer_zplychz.prototype.checkTrustFlagVisible = function(node, off) {
    var pl = getUIPlayer_leiyang(off);
    if (!pl) {
        return;
    }
...
PlayLayer_zplychz.prototype.checkTrustCountDownVisible = function(node, off) {
    node.setString("");
...
PlayLayer_zplychz.prototype.isHasTrust = function() {
