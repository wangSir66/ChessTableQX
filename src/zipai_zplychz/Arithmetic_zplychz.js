...
(function() {
    ...
    majiang.getAllCardsTotal = function (){
        ...
        if(MjClient.gameType === MjClient.GAME_TYPE.HENG_YANG_FANG_PAO_FA && MjClient.MaxPlayerNum_leiyang == 2 &&
            tData.areaSelectMode.maiPaiNum && tData.areaSelectMode.maiPaiNum>0){
            return 80-tData.areaSelectMode.maiPaiNum;
        }
        if (MjClient.gameType === MjClient.GAME_TYPE.ZP_LY_CHZ &&
            tData.areaSelectMode.maiPaiNum && tData.areaSelectMode.maiPaiNum>0 && tData.maxPlayer == 2) {
            return 80-tData.areaSelectMode.maiPaiNum;
        }
        //可以选择埋牌20张的玩法
    ...
    if (typeof(MjClient) != "undefined") {
        MjClient.majiang_zplychz = majiang;
        // DoTest();
    } else {
    ...
    // var mjhand = [4,5,6,24,24,7,7,7];
    // var card = 4;
    // var MjClient = {GAME_TYPE: {ZP_LY_CHZ: 2017001}};
    // MjClient.gameType =2017002;
