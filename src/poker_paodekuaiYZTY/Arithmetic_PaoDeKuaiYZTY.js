...
PaoDeKuaiYZTY.prototype.CARDTPYE = PDK_CARDTPYE;
var PDK_CARDCOUNT = {};
...
PaoDeKuaiYZTY.prototype.allTipsNoOrder = [
    [PDK_CARDTPYE.danpai, []],
    [PDK_CARDTPYE.duizi, []],
...
PaoDeKuaiYZTY.prototype.randomCards = function(areaSelectMode, tData) {
    var cards = [];
...
*crdeNum:每个玩家发多少牌
*/
PaoDeKuaiYZTY.prototype.noZhadan = function(randCards, plycnt, crdeNum) {
 ...
 * @return {number}
 */
PaoDeKuaiYZTY.prototype.calPoint = function(num) {
    if (!num)
        return -1;
 ...
 * @return {boll} 
 */
PaoDeKuaiYZTY.prototype.isSanShun = function(oCards){
...
// console.log( PaoDeKuaiYZTY.prototype.isSanShun([3,3,3]) );
 ...
 */
PaoDeKuaiYZTY.prototype.getSanShunAndSanPai = function(oCards){
    var countSanSame = 0;
    // 记录所有3张的数值
    var sanSameList = [];
    // 记录散牌
...
// console.log( PaoDeKuaiYZTY.prototype.getSanShunAndSanPai(handCards) );


PaoDeKuaiYZTY.prototype.countDuiNum = function(oCards){
    var num = 0;
    var cardNumByValue = {};
    for(var i in oCards){
...
PaoDeKuaiYZTY.prototype.formatFeiJiType = function(oCards,areaSelectMode){
    // 记录所有3张的数值
    var sanSameList = [];
    // 记录散牌
    var sanPaiList = [];
 ...
 */
PaoDeKuaiYZTY.prototype.isFeiJi = function(oCards,areaSelectMode){
 ...
 * @return {bool}
 */
PaoDeKuaiYZTY.prototype.isShun = function(oCards) {
...
PaoDeKuaiYZTY.prototype.isZhaDan = function(oCards, areaSelectMode) {
...
PaoDeKuaiYZTY.prototype.isHadZhaDan = function(cards, areaSelectMode) {
...
// 是否拆散了炸弹牌型
PaoDeKuaiYZTY.prototype.isChaiZhaDan = function(handCards, putCards, areaSelectMode){
 ...
 * @return {bool}
 */
PaoDeKuaiYZTY.prototype.isLiandui = function(oCards) { //oCards有序
 ...
 */
PaoDeKuaiYZTY.prototype.calType = function(pCards, areaSelectMode) {
...
PaoDeKuaiYZTY.prototype.cardsType = function(cards, areaSelectMode) {
 ...
 * @return {number}
 */
PaoDeKuaiYZTY.prototype.calCardsValue = function(cards, type, areaSelectMode) {
...
// 牌点比较函数
PaoDeKuaiYZTY.prototype.cardValueCmp = function(a, b) {
...
PaoDeKuaiYZTY.prototype.cardSortBigToSmall = function(a, b) {
    var pa = this.calPoint(a);
    var pb = this.calPoint(b);
    if (pa == pb)
        return b - a;
 ...
 * @return {number} 返回癞子数
 */
PaoDeKuaiYZTY.prototype.transformAndGetLaizi = function(oCards, cards) {
    var laizi = 0;
    for (var i = 0; i < oCards.length; i++) {
 ...
 */
PaoDeKuaiYZTY.prototype.canPut = function(oCards, oLastCards, handsNum, areaSelectMode) {

    var cardsType = this.calType(oCards, areaSelectMode);

    // cc.log("PaoDeKuaiYZTY.prototype.canPut oCards:", oCards );
 ...
 */
PaoDeKuaiYZTY.prototype.checkPut = function(oHands, cards, lastCards, areaSelectMode, isNextPlayerOneCard, isFirstRound) {
...
PaoDeKuaiYZTY.prototype.getMaxDanPai = function(oCards) {
 ...
 */
PaoDeKuaiYZTY.prototype.sortHandCards = function(oCards, sortType) {
 ...
 * @return {array}
 */
PaoDeKuaiYZTY.prototype.findNSameCard = function(hands, point, n) {
...
// 删除相应牌值
PaoDeKuaiYZTY.prototype.delPoint = function(hands, points){
    var arr = hands.slice();
 ...
 */
PaoDeKuaiYZTY.prototype.lieju = function(parr, num){
    var tmps = [];
...
PaoDeKuaiYZTY.prototype.formatCards = function(oCards) {
    var info = {};
...
PaoDeKuaiYZTY.prototype.indexOfCards = function(cardList, cards) {
...
PaoDeKuaiYZTY.prototype.isSameCards = function(cards1, cards2) {
...
PaoDeKuaiYZTY.prototype.findCardByRole = function(oCards, findNum, ignoreCardValued) {
...
PaoDeKuaiYZTY.prototype.getAllMaxCard = function(oCards){
...
PaoDeKuaiYZTY.prototype.sortByCardType = function(cardsList, areaSelectMode) {
...
PaoDeKuaiYZTY.prototype.findDaiPai = function(oCards, type, findNum, same, buChaiTypes) {
    var ret = [];
...
// 此函数只供提示出牌调用
PaoDeKuaiYZTY.prototype.findCardByType_fast = function(hands, laizi, type, lastCards, buChaiTypes, areaSelectMode) {
...
PaoDeKuaiYZTY.prototype.initCanPutTypes = function(hands, includeCard, areaSelectMode) {
 ...
 * @return {array} 提示的牌
 */
PaoDeKuaiYZTY.prototype.findPutTipCards = function(hands, lastCards, areaSelectMode, isNextPlayerOneCard, isFirstRound, putOrder, allBuChaiTypes) {
 ...
 * @return {Boolean} 
 */
PaoDeKuaiYZTY.prototype.isMustPutCard3 = function(oHands, areaSelectMode, isFirstRound) {
    isFirstRound = areaSelectMode.isPreRoundFirstRule? true : isFirstRound;
 ...
 * @return {array} 提示的牌
 */
PaoDeKuaiYZTY.prototype.tipCards = function(oHands, oLastCards, areaSelectMode, isNextPlayerOneCard, isFirstRound, isSmartTip) {
    if(isSmartTip) {
        this.canPutTypesCache = [];
 ...
 */
PaoDeKuaiYZTY.prototype.IsSametipCards = function(tipscardsArray, areaSelectMode)
{
 ...
 * @param  {Boolean} areaSelectMode 创建房间的选项
 */
PaoDeKuaiYZTY.prototype.delDaipai = function(Cards, areaSelectMode)
{
    var cardtype = this.calType(Cards, areaSelectMode);
...
//     
/**测试 * / 
var pdk = new PaoDeKuaiYZTY()
// console.log(pdk.cardCfg);
var c = pdk.cardCfg;
var cards = pdk.randomCards({handCardNum:0}, {maxPlayer:3});
// console.log(cards.length);
// console.log(cards.toString());
    var handCards = [c.mh[10], c.hx[10], c.fk[10], c.mh[9], c.hx[9], c.fk[9], c.hx[8], c.fk[8], c.hx[5], c.hx[5], c.hx[5]];
// var putCards = [c.ht[10], c.ht[10], c.hx[8], c.hx[8], c.hx[8], c.hx[7], c.hx[7], c.hx[7], c.hx[4], c.hx[4]];
var lastCards = [c.ht[3], c.mh[3], c.fk[3], c.hx[4], c.mh[4], c.fk[4], c.fk[5], c.mh[5], c.fk[6], c.mh[6] ];
// console.log('PaoDeKuaiYZTY.prototype.checkPut', pdk.checkPut(handCards, putCards, lastCards) );
...
areaSelectMode.canPutAnyFeiji = false;
areaSelectMode.canPutAnySanZhang = true;
var isNextPlayerOneCard = false;
var isFirstRound = false;

lastCards = [c.mh[9], c.hx[9], c.fk[9],c.mh[8], c.hx[8],c.mh[8], c.hx[1], c.fk[2], c.mh[3],c.mh[4]];
handCards = [c.ht[11], c.mh[11], c.fk[11], c.hx[4], c.mh[4],c.ht[10], c.mh[10], c.fk[10],c.ht[9], c.mh[9], c.fk[9], c.hx[6], c.mh[6] ];
// console.log(pdk.checkPut(handCards, handCards, lastCards, areaSelectMode) )

var tipcards = pdk.tipCards(handCards, lastCards, areaSelectMode, isNextPlayerOneCard, isFirstRound);
console.log(handCards)
console.log(JSON.stringify(tipcards));
for(var i in tipcards) {
    var tipc = tipcards[i];
    change(tipc)
    // console.log(pdk.checkPut(handCards, tipc, lastCards, areaSelectMode) )
}
// 
// var feijis = []
