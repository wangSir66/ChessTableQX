...
var CreateRoomNode_changSha = CreateRoomNode.extend({
    ...
    initPlayNode:function()
    {
        ...
        zhuaNiaoNumList.push(_play.getChildByName("zhuaniaoNum8"));
    ...
    getSelectedPara:function()
    {
        ...
        para.maiPai40zhang  = false;   // 埋牌40张  
        if(para.maxPlayer == 2)    para.maiPai40zhang  = this.maiPai40zhang.isSelected();
