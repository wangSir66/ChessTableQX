 ...
 * 长沙麻将：配置地区有 岳阳 by cyc 20191023
 * 二人缺门长麻：配置地区有 岳阳 by cyc 20191023
 * 
 */
...
var CreateRoomNode_changSha = CreateRoomNode.extend({
    ...
    setKey:function()
    {
        ...
        this.localStorageKey.KEY_CSMJ_buKeChongFu                   = "_CSMJ_buKeChongFu";       //不可重复(组成六六顺的牌，不会重复计算)
        ...
        this.localStorageKey.KEY_CSMJ_trustWay                      = "_CSMJ_TRUST_WAY"; // 托管方式
        this.localStorageKey.KEY_CSMJ_maiPai40zhang                     = "_CSMJ_maiPai40zhang";     //埋牌40张 
        this.localStorageKey.KEY_CSMJ_zhongNiao159                   = "_CSMJ_zhongNiao159";     //159中鸟
        this.localStorageKey.KEY_CSMJ_duiWeiZhongNiao                   = "_CSMJ_duiWeiZhongNiao";     //对位中鸟
    ...
    setKey_ER:function()
    {
        ...
        this.localStorageKey.KEY_CSMJ_buKeChongFu                   = "_CSMJ_ER_buKeChongFu";          //不可重复(组成六六顺的牌，不会重复计算)
        ...
        this.localStorageKey.KEY_CSMJ_trustWay                      = "_CSMJ_ER_TRUST_WAY"; // 托管方式
        this.localStorageKey.KEY_CSMJ_maiPai40zhang                     = "_CSMJ_ER_maiPai40zhang";     //埋牌40张
        this.localStorageKey.KEY_CSMJ_zhongNiao159                   = "_CSMJ_ER_zhongNiao159";     //159中鸟
        this.localStorageKey.KEY_CSMJ_duiWeiZhongNiao                   = "_CSMJ_ER_duiWeiZhongNiao";     //对位中鸟 
    },
    ...
    initPlayNode:function()
    {
        ...
        var zhongNiaoFunc = function (type) {
            if (type == 1 || type == 2) {
                this.zhuaNiaoBuLunKong.setSelected(false);
                this.selectedCBForYZ(this.zhuaNiaoBuLunKong.getChildByName("text"), false);
                this.play_anzhuang.setSelected(false);
                this.selectedCBForYZ(this.play_anzhuang.getChildByName("text"), false);
            }
            
            this.zhongNiao159.setSelected(type == 1);
            this.selectedCBForYZ(this.zhongNiao159.getChildByName("text"), type == 1);
            this.duiWeiZhongNiao.setSelected(type == 2);
            this.selectedCBForYZ(this.duiWeiZhongNiao.getChildByName("text"), type == 2);

        }.bind(this);
        this.zhuaNiaoBuLunKong = _play.getChildByName("zhuaNiaoBuLunKong");
        this.zhongNiao159   = _play.getChildByName("zhongNiao159");
        this.play_anzhuang = _play.getChildByName("play_anzhuang");
        this.duiWeiZhongNiao        = _play.getChildByName("duiWeiZhongNiao");
        this.addListenerText(this.zhuaNiaoBuLunKong, null, zhongNiaoFunc.bind(this,3));
        this.zhuaNiaoBuLunKong.addEventListener(function(sender,type)
        {
            switch (type) {
                case ccui.CheckBox.EVENT_SELECTED:
                    zhongNiaoFunc(3);
                    this.zhuaNiaoBuLunKong.setSelected(true);
                    this.selectedCBForYZ(this.zhuaNiaoBuLunKong.getChildByName("text"), true);
                    break;
        ...
        this.addListenerText(this.play_anzhuang, null, zhongNiaoFunc.bind(this,3));
        this.play_anzhuang.addEventListener(function(sender,type)
        {
            switch (type) {
                case ccui.CheckBox.EVENT_SELECTED:
                    zhongNiaoFunc(3);
                    this.play_anzhuang.setSelected(true);
                    this.selectedCBForYZ(this.play_anzhuang.getChildByName("text"), true);
                    break;
                case ccui.CheckBox.EVENT_UNSELECTED:
                    this.play_anzhuang.setSelected(false);
                    this.selectedCBForYZ(this.play_anzhuang.getChildByName("text"), false);
        ...
        this.addListenerText(this.zhongNiao159, null, zhongNiaoFunc.bind(this,1));
        this.zhongNiao159.addEventListener(function(sender,type)
        {
            switch (type) {
                case ccui.CheckBox.EVENT_SELECTED:
                    zhongNiaoFunc(1)
                    break;
                case ccui.CheckBox.EVENT_UNSELECTED:
                    this.zhongNiao159.setSelected(false);
                    this.selectedCBForYZ(this.zhongNiao159.getChildByName("text"), false);
                    break;
            }
        },this);
        
        this.addListenerText(this.duiWeiZhongNiao, null, zhongNiaoFunc.bind(this,2));
        this.duiWeiZhongNiao.addEventListener(function(sender,type)
        {
            switch (type) {
                case ccui.CheckBox.EVENT_SELECTED:
                    zhongNiaoFunc(2)
                    break;
                case ccui.CheckBox.EVENT_UNSELECTED:
                    this.duiWeiZhongNiao.setSelected(false);
                    this.selectedCBForYZ(this.duiWeiZhongNiao.getChildByName("text"), false);
                    break;
            }
        },this);
        ...
        this.buKeChongFu        = _play.getChildByName("buKeChongFu");
        this.addListenerText(this.buKeChongFu);
        this.buKeChongFu.addEventListener(this.clickCB, this.buKeChongFu);

        this.buKeChongFu.schedule(function() {
            var isShowBuKeChongFu = this.zhongTuCanAgain.isSelected();
            this.buKeChongFu.setVisible(isShowBuKeChongFu);
            btn_buKeChongFuTip.setVisible(isShowBuKeChongFu);
        }.bind(this));
        ...
        var huChiCheckBoxs = function(list) {
            ...
            for (var i = 0; i < list.length; i++) {
                ...
                if(this.queYiMen.isSelected()){
                    this.maiPai40zhang.setSelected(false);
                    this.selectedCBForYZ(this.maiPai40zhang.getChildByName("text"), false);
                }
            }
            }.bind(this));
            for (var i = 0; i < list.length; i++) {
        ...
        // this.maiPai40zhang    = _play.getChildByName("maiPai40zhang");
        queYiList.push(this.queYiSe);
        queYiList.push(this.queYiMen);
        // queYiList.push(this.maiPai40zhang);
        ...
        var maiPai = function(){
            if(this.maiPai40zhang.isSelected()){
                this.queYiMen.setSelected(false);
                this.selectedCBForYZ(this.queYiMen.getChildByName("text"), false);
            }
        }.bind(this);
        this.maiPai40zhang = _play.getChildByName("maiPai40zhang");
        this.addListenerText(this.maiPai40zhang,null, maiPai);
        this.maiPai40zhang.addEventListener(function(sender,type)
        {
            switch (type) {
                case ccui.CheckBox.EVENT_SELECTED:
                    this.queYiMen.setSelected(false);
                    this.selectedCBForYZ(this.queYiMen.getChildByName("text"), false);
                    this.maiPai40zhang.setSelected(true);
                    this.selectedCBForYZ(this.maiPai40zhang.getChildByName("text"), true);
                    break;
                case ccui.CheckBox.EVENT_UNSELECTED:
                    this.maiPai40zhang.setSelected(false);
                    this.selectedCBForYZ(this.maiPai40zhang.getChildByName("text"), false);
        ...
        this.queYiMen.schedule(function() {
            ...
            this.maiPai40zhang.setVisible(isPlayer2);

            if (this.menQing.isSelected() && isPlayer2) {
            ...
            if (this._data.isErRen) {
                var _select = !this.maiPai40zhang.isSelected();
                this.queYiMen.setSelected(_select);
                this.selectedCBForYZ(this.queYiMen.getChildByName("text"), _select);
            }
            if (this.zhuaNiaoTypeList_radio.getSelectIndex() == 0) {

                this.duiWeiZhongNiao.setVisible(isPlayer2);
            } else if (this.zhuaNiaoTypeList_radio.getSelectIndex() == 1 || this.zhuaNiaoTypeList_radio.getSelectIndex() == 3) {

                this.duiWeiZhongNiao.setVisible(isPlayer2);
            } else {
                this.duiWeiZhongNiao.setVisible(false);
            }
        }.bind(this));
        ...
        var btn_buKeChongFuTip = _play.getChildByName("btn_buKeChongFuTip");
        var image_buKeChongFuTip = _play.getChildByName("image_buKeChongFuTip");
        btn_buKeChongFuTip.addTouchEventListener(function(sender, type) {
            if (type == 2) {
                image_buKeChongFuTip.setVisible(true);
            }
        }, btn_buKeChongFuTip);
        ...
        cc.eventManager.addListener({
            ...
            onTouchBegan: function(touch, event) {
                ...
                else if (image_buKeChongFuTip.isVisible()) {
                    image_buKeChongFuTip.setVisible(false);
                    return true;
                } else {
                    return false;
                }
    ...
    refreshZhuaNiao:function()
    {
        ...
        if (this.zhuaNiaoTypeList_radio.getSelectIndex() == 0)
        {
            ...
            this.zhongNiao159.setVisible(true);
        }
        else if (this.zhuaNiaoTypeList_radio.getSelectIndex() == 1 || this.zhuaNiaoTypeList_radio.getSelectIndex() == 3)
        {
            ...
            this.zhongNiao159.setVisible(false);
    ...
    setPlayNodeCurrentSelect:function(isClub)
    {
        ...
        var buKeChongFu;
        if (isClub)
            buKeChongFu = this.getBoolItem("buKeChongFu", false);
        else
            buKeChongFu = util.localStorageEncrypt.getBoolItem(this.localStorageKey.KEY_CSMJ_buKeChongFu, false);
        this.buKeChongFu.setSelected(buKeChongFu);
        var text = this.buKeChongFu.getChildByName("text");
        this.selectedCBForYZ(text,buKeChongFu);
        ...
        var maiPai40zhang;
        if (isClub)
            maiPai40zhang = this.getBoolItem("maiPai40zhang", false);
        else
            maiPai40zhang = util.localStorageEncrypt.getBoolItem(this.localStorageKey.KEY_CSMJ_maiPai40zhang, false);
        this.maiPai40zhang.setSelected(maiPai40zhang);
        var text = this.maiPai40zhang.getChildByName("text");
        this.selectedCBForYZ(text, this.maiPai40zhang)
        ...
        this.maiPai40zhang.setSelected(maiPai40zhang);
        var text = this.maiPai40zhang.getChildByName("text");
        this.selectedCBForYZ(text, maiPai40zhang);
        if(maiPai40zhang){
            this.queYiMen.setSelected(false);
            var text = this.queYiMen.getChildByName("text");
            this.selectedCBForYZ(text, false);
        }
        ...
        var zhongNiao159;
        if (isClub)
            zhongNiao159 = this.getBoolItem("zhongNiao159", false);
        else
            zhongNiao159 = util.localStorageEncrypt.getBoolItem(this.localStorageKey.KEY_CSMJ_zhongNiao159, false);
        this.zhongNiao159.setSelected(zhongNiao159);
        var text = this.zhongNiao159.getChildByName("text");
        this.selectedCBForYZ(text, zhongNiao159);

        var duiWeiZhongNiao;
        if (isClub)
            duiWeiZhongNiao = this.getBoolItem("duiWeiZhongNiao", false);
        else
            duiWeiZhongNiao = util.localStorageEncrypt.getBoolItem(this.localStorageKey.KEY_CSMJ_duiWeiZhongNiao, false);
        this.duiWeiZhongNiao.setSelected(duiWeiZhongNiao);
        var text = this.duiWeiZhongNiao.getChildByName("text");
        this.selectedCBForYZ(text, duiWeiZhongNiao)
        ...
        if(MjClient.APP_TYPE.QXYYQP == MjClient.getAppType() &&  this.tuoguanWayNodeList){
            ...
            if(isClub){
                ...
                trustWay = util.localStorageEncrypt.getNumberItem(this.localStorageKey.KEY_CSMJ_trustWay, 0);
            }
    ...
    getSelectedPara:function()
    {
        ...
        para.buKeChongFu    = this.buKeChongFu.isVisible() && this.buKeChongFu.isSelected(); // 不可重复(组成六六顺的牌，不会重复计算)
        ...
        para.maiPai40zhang  = para.maxPlayer == 2 && this.maiPai40zhang.isSelected();  // 埋牌40张  
        para.duiWeiZhongNiao  = para.maxPlayer == 2 && this.duiWeiZhongNiao.isSelected();   // 对位中鸟  
        para.zhongNiao159       = this.zhongNiao159.isSelected();
        ...
        if (!this._isFriendCard) {
            ...
            util.localStorageEncrypt.setBoolItem(this.localStorageKey.KEY_CSMJ_buKeChongFu, para.buKeChongFu);
            ...
            util.localStorageEncrypt.setBoolItem(this.localStorageKey.KEY_CSMJ_maiPai40zhang, para.maiPai40zhang);
            util.localStorageEncrypt.setBoolItem(this.localStorageKey.KEY_CSMJ_zhongNiao159, para.zhongNiao159);
            util.localStorageEncrypt.setBoolItem(this.localStorageKey.KEY_CSMJ_duiWeiZhongNiao, para.duiWeiZhongNiao);
            // 大结算翻倍
            if (this.fanbei_radio) {
            ...
            util.localStorageEncrypt.setNumberItem(this.localStorageKey.KEY_CSMJ_trustWay, para.trustWay);
        }
    ...
    selectedCBForYZ: function(text, isSelected) {
        if (this.isUseUIV3)
            return this.selectedCB(text, isSelected);
