...
PaoDeKuai11.prototype.CARDTPYE = PDK_CARDTPYE;
var PDK_CARDCOUNT = {};
...
PaoDeKuai11.prototype.allTipsNoOrder = [
    [PDK_CARDTPYE.danpai, []],
    [PDK_CARDTPYE.duizi, []],
...
*crdeNum:每个玩家发多少牌
*/
PaoDeKuai11.prototype.noZhadan = function(randCards, plycnt, crdeNum) {
 ...
 * @return {number}
 */
PaoDeKuai11.prototype.calPoint = function(num) {
    if (!num)
        return -1;
 ...
 * @return {boll} 
 */
PaoDeKuai11.prototype.isSanShun = function(oCards){
...
// console.log( PaoDeKuai11.prototype.isSanShun([3,3,3]) );
 ...
 */
PaoDeKuai11.prototype.getSanShunAndSanPai = function(oCards, valueCompared){
    var countSanSame = 0;
    // 记录所有3张的数值
    var sanSameList = [];
    // 记录散牌
...
// console.log( PaoDeKuai11.prototype.getSanShunAndSanPai(handCards) );


PaoDeKuai11.prototype.countDuiNum = function(oCards){
    var num = 0;
    var cardNumByValue = {};
    for(var i in oCards){
...
PaoDeKuai11.prototype.formatFeiJiType = function(oCards,areaSelectMode, valueCompared){
    // 记录所有3张的数值
    var sanSameList = [];
    // 记录散牌
    var sanPaiList = [];
 ...
 */
PaoDeKuai11.prototype.isFeiJi = function(oCards,areaSelectMode){
 ...
 * @return {bool}
 */
PaoDeKuai11.prototype.isShun = function(oCards) {
...
PaoDeKuai11.prototype.isZhaDan = function(oCards, areaSelectMode) {
...
PaoDeKuai11.prototype.isHadZhaDan = function(cards, areaSelectMode) {
...
//统计牌里有多少炸弹
PaoDeKuai11.prototype.ZhadanCount = function(cards, areaSelectMode) {
    if (!cards) return 0;
    var ZhaDanAry = [];
    for(var i=0; i < cards.length; i++){
        var cardValue = this.calPoint(cards[i]);
...
// 是否拆散了炸弹牌型
PaoDeKuai11.prototype.isChaiZhaDan = function(handCards, putCards, areaSelectMode){
 ...
 * @return {bool}
 */
PaoDeKuai11.prototype.isLiandui = function(oCards) { //oCards有序
 ...
 */
PaoDeKuai11.prototype.calType = function(pCards, areaSelectMode) {
...
PaoDeKuai11.prototype.cardsType = function(cards, areaSelectMode) {
 ...
 * @return {number}
 */
PaoDeKuai11.prototype.calCardsValue = function(cards, type, areaSelectMode) {
...
// 牌点比较函数
PaoDeKuai11.prototype.cardValueCmp = function(a, b) {
...
PaoDeKuai11.prototype.cardSortBigToSmall = function(a, b) {
    var pa = this.calPoint(a);
    var pb = this.calPoint(b);
    if (pa == pb)
        return b - a;
 ...
 * @return {number} 返回癞子数
 */
PaoDeKuai11.prototype.transformAndGetLaizi = function(oCards, cards) {
    var laizi = 0;
    for (var i = 0; i < oCards.length; i++) {
 ...
 */
PaoDeKuai11.prototype.canPut = function(oCards, oLastCards, handsNum, areaSelectMode) {

    var cardsType = this.calType(oCards, areaSelectMode);

    // cc.log("PaoDeKuai11.prototype.canPut oCards:", oCards );
 ...
 */
PaoDeKuai11.prototype.checkPut = function(oHands, cards, lastCards, areaSelectMode, isNextPlayerOneCard, isFirstRound) {
...
PaoDeKuai11.prototype.getMaxDanPai = function(oCards) {
 ...
 */
PaoDeKuai11.prototype.sortHandCards = function(oCards, sortType) {
 ...
 * @return {array}
 */
PaoDeKuai11.prototype.findNSameCard = function(hands, point, n) {
...
// 删除相应牌值
PaoDeKuai11.prototype.delPoint = function(hands, points){
    var arr = hands.slice();
 ...
 */
PaoDeKuai11.prototype.lieju = function(parr, num){
    var tmps = [];
...
PaoDeKuai11.prototype.formatCards = function(oCards) {
    var info = {};
...
PaoDeKuai11.prototype.indexOfCards = function(cardList, cards) {
...
PaoDeKuai11.prototype.isSameCards = function(cards1, cards2) {
...
PaoDeKuai11.prototype.findCardByRole = function(oCards, findNum, ignoreCardValued) {
 ...
 * @param {array} 拼好的 
 */
PaoDeKuai11.prototype.findCardByType = function(hands, laizi, type, lastCards, buChaiTypes, areaSelectMode) {
    var rets = [];
    var laizis = [];
...
PaoDeKuai11.prototype.getAllMaxCard = function(oCards){
...
PaoDeKuai11.prototype.sortByCardType = function(cardsList, areaSelectMode) {
...
PaoDeKuai11.prototype.findDaiPai = function(oCards, type, findNum, same, buChaiTypes) {
    var ret = [];
...
// 此函数只供提示出牌调用
PaoDeKuai11.prototype.findCardByType_fast = function(hands, laizi, type, lastCards, buChaiTypes, areaSelectMode) {
...
PaoDeKuai11.prototype.initCanPutTypes = function(hands, includeCard, areaSelectMode) {
 ...
 * @return {array} 提示的牌
 */
PaoDeKuai11.prototype.findPutTipCards = function(hands, lastCards, areaSelectMode, isNextPlayerOneCard, isFirstRound, putOrder, allBuChaiTypes) {
 ...
 * @return {Boolean} 
 */
PaoDeKuai11.prototype.isMustPutCard3 = function(oHands, areaSelectMode, isFirstRound) {
    isFirstRound = areaSelectMode.isPreRoundFirstRule? true : isFirstRound;
 ...
 * @return {array} 提示的牌
 */
PaoDeKuai11.prototype.tipCards = function(oHands, oLastCards, areaSelectMode, isNextPlayerOneCard, isFirstRound, isSmartTip) {
    if(isSmartTip) {
        this.canPutTypesCache = [];
 ...
 */
PaoDeKuai11.prototype.IsSametipCards = function(tipscardsArray, areaSelectMode)
{
 ...
 * @param  {Boolean} areaSelectMode 创建房间的选项
 */
PaoDeKuai11.prototype.delDaipai = function(Cards, areaSelectMode)
{
    var cardtype = this.calType(Cards, areaSelectMode);
