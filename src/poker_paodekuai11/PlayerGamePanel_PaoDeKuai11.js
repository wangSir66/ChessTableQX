...
function SetUserVisible_PaoDeKuai11(node, off)
{
    ...
    if(pl)
    {
        ...
        InitUserHandUI_PaoDeKuai11(node, off);
    }
    else
    {
        name.visible = false;
...
function InitUserHandUI_PaoDeKuai11(node, off, needSort)
{
...
function cardsSort_PaoDeKuai11(cards)
{
    var pointCounts = {};
...
var PlayLayer_PaoDeKuai11 = cc.Layer.extend({
    _btnPutCard:null,
    jsBind: {
        _run: function() {
        ...
        _event: {
            ...
            roundEnd: function() {
                ...
                function delayExe()
                {
                    ...
                    if(MjClient.isInGoldFieldNormal()){//金币场普通场
                        ...
                        self.addChild(new EndOneView_PaoDeKuai11(),500);
                    }
                }
                ...
                {
                    MjClient.playui.reConectHeadLayout_PaoDeKuai11(this);
                }
            },
            moveHead: function() {
            ...
            initSceneData: function() {
                ...
                MjClient.playui.reConectHeadLayout_PaoDeKuai11(this);
                MjClient.playui.showJiaZhu_PaoDeKuai11()
                MjClient.playui.resetJiaZhuNum(this);
                CheckRoomUiDelete();
        ...
        banner: {
            ...
            gps_btn: {
                _run: function() {
                    ...
                    //this.setColor(cc.color(0,225,0));
        ...
        BtnPutCard:{
            ...
            _click: function(btn) {
                //cc.log("BtnPutCard");
				cardsSort_PaoDeKuai11(MjClient.selectCards_card);
        ...
        down: {
            ...
            _event: {
                ...
                initSceneData: function(eD) {
                    SetUserVisible_PaoDeKuai11(this, 0);
                ...
                mjhand: function(eD) {
                    InitUserHandUI_PaoDeKuai11(this, 0);
        ...
        right: {
            ...
            _event: {
                ...
                initSceneData: function(eD) {
                    SetUserVisible_PaoDeKuai11(this, 1);
                },
                addPlayer: function(eD) {
                    SetUserVisible_PaoDeKuai11(this, 1);
                },
                ...
                mjhand: function(eD) {
                    InitUserHandUI_PaoDeKuai11(this, 1);
                },
                roundEnd: function() {
        ...
        top: {
            ...
            _event: {
                ...
                initSceneData: function(eD) {
                    SetUserVisible_PaoDeKuai11(this, 2);
                },
                addPlayer: function(eD) {
                    SetUserVisible_PaoDeKuai11(this, 2);
                },
                ...
                mjhand: function(eD) {
                    InitUserHandUI_PaoDeKuai11(this, 2);
                },
                roundEnd: function() {
    ...
    ctor: function() {
        this._super();
        var playui = ccs.load(res.Play_PaoDeKuai11_json);
        ...
        cc.log("=======11111111111111112222======sfasdf==gps  sking =======adfljlkj");
...
PlayLayer_PaoDeKuai11.prototype.InitC_Data = function() {
...
PlayLayer_PaoDeKuai11.prototype.cannotOutCardGrey = function()
{
...
PlayLayer_PaoDeKuai11.prototype.recoverCannotOutCard = function()
{
    var children = this._downNode.children;
    for (var i = 0; i < children.length; i++)
    {
...
PlayLayer_PaoDeKuai11.prototype.clockNumberUpdate = function(node, endFunc)
{
    return arrowbkNumberUpdate(node, endFunc);
}

PlayLayer_PaoDeKuai11.prototype.updateClockPosition = function(arrowNode)
{
    var tData = MjClient.data.sData.tData;
    var uids = tData.uids;
...
// 播放先手标识动画
PlayLayer_PaoDeKuai11.prototype.showOffenseAnim = function()
{
    var tData = MjClient.data.sData.tData;
    var off = getOffByIndex(tData.curPlayer);
    var playerNode = getNode_cards(off);
...
PlayLayer_PaoDeKuai11.prototype.showHandCardBeiMian = function()
{
...
PlayLayer_PaoDeKuai11.prototype.hideHandCardBeiMian = function()
{
...
//金币场每局获取分数的动画
PlayLayer_PaoDeKuai11.prototype.showGetScoreAni_filedQuick = function (off)
{   
...
//处理金币场快速赛牌局结束时布局
PlayLayer_PaoDeKuai11.prototype.cardLayoutRestore_endfiledQuick = function (off)
{
...
//处理金币场牌局结束时布局
PlayLayer_PaoDeKuai11.prototype.cardLayoutRestore_endfiled = function (off)
{
    var node = getNode_cards(off);
    //隐藏牌数标记
    var tingCard = node.getChildByName('head').getChildByName("tingCard");
...
PlayLayer_PaoDeKuai11.prototype.CardLayoutRestore = function(node, off, needSort)
{
    cc.log("PlayLayer_PaoDeKuai1111==============");
    ...
    cc.log("PlayLayer_PaoDeKuai1122==============");
...
PlayLayer_PaoDeKuai11.prototype.CardLayoutDesk = function(node,cards,off)
{
    //if(off != 0) return;
    var children = node.children;
...
//横向摆放《正常》
PlayLayer_PaoDeKuai11.prototype.horSort = function(node, off, needSort)
{
    var pl; //player 信息
...
//纵向摆放
PlayLayer_PaoDeKuai11.prototype.verSort = function(node, off, needSort)
{
    if(off != 0)
    {
        return;
...
PlayLayer_PaoDeKuai11.prototype.showJiaZhu_PaoDeKuai11 = function()
{
    var sData = MjClient.data.sData;
    var tData = sData.tData;
    var pl = getUIPlayer(0);
 ...
 PlayLayer_PaoDeKuai11.prototype.resetJiaZhuNum = function(node)
{
...
PlayLayer_PaoDeKuai11.prototype.setJiaZhuNum = function (node, pl)
{
    if(!pl) return;
...
//头像位置
PlayLayer_PaoDeKuai11.prototype.reConectHeadLayout_PaoDeKuai11 = function (node)
{
    var sData = MjClient.data.sData;
    if(MjClient.isInGoldField())
...
//时间节点设置
PlayLayer_PaoDeKuai11.prototype.BgTime_run = function (node)
{
    var text = new ccui.Text();
...
//设置红包活动按钮位置
PlayLayer_PaoDeKuai11.prototype.setHongBaoPos = function (hongbaoBtn)
{
...
//////////////////////////金币场UI调整//////////////////////////////////////////////////////////////////////////////////////
PlayLayer_PaoDeKuai11.prototype.reConectHeadLayout_PaoDeKuai_fieldId= function (node)
{
...
PlayLayer_PaoDeKuai11.prototype.initFieldIdUI = function (node)
{
    var sData = MjClient.data.sData;
    var tData = sData.tData;
...
PlayLayer_PaoDeKuai11.prototype.BindFieldIdUI = function (node)
{
    var uibind = {
        bottonBG:
        {
...
// 更新wifi信号 3张图片
PlayLayer_PaoDeKuai11.prototype.updateWifiState_field = function(node)
{
...
PlayLayer_PaoDeKuai11.prototype.isUsingJiPaiQi = function()
{
    var jipaiqi = MjClient.data.sData.tData.jipaiqi;
    return jipaiqi && jipaiqi.indexOf(SelfUid()) >= 0;
}

PlayLayer_PaoDeKuai11.prototype.createJiPaiQiPanel = function()
{
...
// 记牌器购买面板
PlayLayer_PaoDeKuai11.prototype.showJiPaiQiBuyingPanel = function(commoditys,purchaseCallback) {
...
PlayLayer_PaoDeKuai11.prototype.setJiPaiQiEnabled = function(node) {
    var tData = MjClient.data.sData.tData;
...
PlayLayer_PaoDeKuai11.prototype.setJiPaiQiNum = function(node) {
...
PlayLayer_PaoDeKuai11.prototype.checkJiPaiQiListValid = function(commoditys) {
...
PlayLayer_PaoDeKuai11.prototype.checkJiPaiQiButtonVisible = function(node) {
...
PlayLayer_PaoDeKuai11.prototype.reLoadOptBtnRes = function() {
    //出牌按钮
