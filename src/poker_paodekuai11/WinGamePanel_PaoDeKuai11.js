...
function SetEndOneUserUI_PaoDeKuai11(node, off) {
...
function CardLayoutRestoreForEndOne_PaoDeKuai11(node, plNode) {
...
var EndOneView_PaoDeKuai11 = cc.Layer.extend({
    jsBind: {
        block: {
...
//                    text += tData.areaSelectMode.cardNumIndex == 0 ? "16张," : "15张,";
            ...
            , head0: {
                ...
                _run: function () { SetEndOneUserUI_PaoDeKuai11(this, 0); },
    		...
    		, head1: {
    		    ...
    		    _run: function () { SetEndOneUserUI_PaoDeKuai11(this, 1); }
    		}
    		...
    		, head2: {
    		    ...
    		    _run: function () { SetEndOneUserUI_PaoDeKuai11(this, 2); }
    		}
        }
    },
    ctor: function () {
        ...
        var endoneui = ccs.load(res.EndOne_PaoDeKuaiTY_json);
